...
.method public static c(Ljava/lang/String;)I
    ...
    :cond_6
    invoke-virtual {v0}, Lea/c;->j()[Ljava/lang/Integer;
    ...
    :cond_b
    iget-object p0, v0, Lea/c;->i5:Ljava/util/ArrayList;

    if-nez p0, :cond_c

    sget-object p0, Lra/f;->b4:Lra/e;

    invoke-virtual {v0, p0}, Lea/c;->J0(Lra/e;)Ljava/util/ArrayList;

    move-result-object p0

    iput-object p0, v0, Lea/c;->i5:Ljava/util/ArrayList;
    ...
    :cond_e
    iget-object p0, v0, Lea/c;->u9:Ljava/util/ArrayList;

    if-nez p0, :cond_f

    sget-object p0, Lra/f;->p2:Lra/e;

    invoke-virtual {v0, p0}, Lea/c;->J0(Lra/e;)Ljava/util/ArrayList;

    move-result-object p0

    iput-object p0, v0, Lea/c;->u9:Ljava/util/ArrayList;
...
.method public static g()Z
    ...
    invoke-static {v0}, Lea/d;->h1(Lea/c;)Z
...
.method public final b()La0/v6;
    ...
    :cond_2
    invoke-virtual {p0, v2}, Le1/b;->m(I)Z
    ...
    invoke-virtual {p0, v1}, Le1/b;->m(I)Z
    ...
    invoke-static {v1}, Lea/d;->b4(Lea/c;)Z

    move-result v1

    if-nez v1, :cond_8

    iput-boolean v3, v0, La0/v6;->a:Z
    ...
    :goto_3
    :try_start_0
    iget-object v4, p0, Le1/b;->e:Landroid/util/SparseBooleanArray;
    ...
    :cond_a
    :try_start_5
    iget-object v5, p0, Le1/b;->f:Landroid/util/SparseBooleanArray;
    ...
    iget-object v5, p0, Le1/b;->e:Landroid/util/SparseBooleanArray;
    ...
    :cond_e
    :try_start_a
    iget-object v1, p0, Le1/b;->f:Landroid/util/SparseBooleanArray;
...
.method public final d()La0/v6;
    ...
    iget-boolean v1, p0, Le1/d;->d:Z

    if-nez v1, :cond_3

    iget-boolean v1, p0, Le1/d;->c:Z
...
.method public final e()La0/v6;
    ...
    invoke-virtual {v5}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->r2()Z
    ...
    :cond_7
    iget-boolean p0, p0, Lu5/f;->b:Z

    iget-object v1, v4, Luc/b;->e:L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;

    if-eqz p0, :cond_8

    invoke-virtual {v1}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->d4()Z

    move-result p0

    iput-boolean p0, v0, La0/v6;->a:Z

    goto :goto_2

    :cond_8
    invoke-virtual {v1}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->x5()Z
