...
.field public final f:La0/n5$a;

.field public final g:Landroidx/activity/l;

.field public final h:La0/r1;
...
.method public constructor <init>(Lcom/android/camera/Camera;)V
    ...
    iput-boolean v0, p0, La0/n5;->c:Z

    new-instance v0, La0/n5$a;

    invoke-direct {v0, p0}, La0/n5$a;-><init>(La0/n5;)V

    iput-object v0, p0, La0/n5;->f:La0/n5$a;
    ...
    iput-object v0, p0, La0/n5;->g:Landroidx/activity/l;

    new-instance v0, La0/r1;

    const/4 v1, 0x1

    invoke-direct {v0, p0, v1}, La0/r1;-><init>(La0/n5;I)V

    iput-object v0, p0, La0/n5;->h:La0/r1;

    new-instance v0, Ljava/lang/ref/WeakReference;

    invoke-direct {v0, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, La0/n5;->a:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static a(Lcom/android/camera/Camera;La0/h7;Landroid/net/Uri;)Landroid/content/Intent;
    .locals 8
    ...
    sget-object p2, La0/u4$a;->a:La0/u4;

    iget p2, p2, La0/u4;->g:F
    ...
    invoke-static {v1, v2}, Lck/c;->x(Landroid/content/Intent;Z)V
    ...
    invoke-static {p2}, Llk/a;->a(Landroid/content/Context;)Z
    ...
    iget-boolean p2, p1, La0/h7;->e:Z

    if-eqz p2, :cond_9

    iget p2, p1, La0/h7;->i:I
    ...
    const-string p2, "using_deputy_screen"
    ...
    invoke-virtual {p0}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->b2()Z
...
.method public static b(Lcom/android/camera/Camera;Landroid/net/Uri;)V
    ...
    invoke-virtual {v0, v2}, Lq1/c;->l(Ljava/lang/Long;)Lo1/b;
    ...
    invoke-static {p0, p1}, Lo8/y;->w(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static {p0, p1}, Lck/p;->j(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    invoke-static {p1, v0, v2, p0}, La0/a0;->e(Ljava/lang/String;ZLjava/lang/String;Z)Ljava/lang/String;
...
# virtual methods
.method public final c(Lcom/android/camera/Camera;La0/h7;)V
    .locals 8
    .param p2    # La0/h7;
    ...
    iget-object v3, p1, Lcom/android/camera/ActivityBase;->k0:Lg9/f;
    ...
    invoke-virtual {v4}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->m5()Z
    ...
    sget-object v4, Lpo/a;->h:Lpo/a;

    invoke-virtual {v3, v4, p1}, Lg9/f;->B(Lpo/a;Z)V

    goto :goto_1

    :cond_2
    sget-object p1, Lpo/a;->h:Lpo/a;

    invoke-virtual {v3, p1}, Lg9/f;->A(Lpo/a;)V

    goto :goto_1

    :cond_3
    :goto_0
    sget-object p1, Lpo/a;->a:Lpo/a;

    invoke-virtual {v3, p1}, Lg9/f;->A(Lpo/a;)V

    :cond_4
    :goto_1
    iget-object p1, p0, La0/n5;->b:Landroid/os/Messenger;
    ...
    :cond_7
    sget-object p1, La0/w6;->f:La0/w6$a;

    invoke-virtual {p1}, Lbk/g;->b()Ljava/lang/Object;

    move-result-object p1

    check-cast p1, La0/w6;

    monitor-enter p1

    :try_start_0
    iget-object v4, p2, La0/h7;->a:Landroid/net/Uri;

    iget-object v5, p2, La0/h7;->b:Landroid/graphics/Bitmap;

    invoke-virtual {p1, v4, v5}, La0/w6;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;)Z
    ...
    :cond_8
    :try_start_1
    invoke-virtual {p1}, La0/w6;->c()Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v2, p0, La0/n5;->b:Landroid/os/Messenger;
    ...
    :try_start_3
    iget-object v7, p1, La0/w6;->e:Landroid/net/Uri;
    :try_end_3
    ...
    iget-object p2, p2, La0/h7;->o:Ljava/lang/Boolean;
    ...
    iget-object p2, p0, La0/n5;->b:Landroid/os/Messenger;
    ...
    iget-object p0, p0, La0/n5;->b:Landroid/os/Messenger;
