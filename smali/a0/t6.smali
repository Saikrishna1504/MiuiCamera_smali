...
.method public static a(Landroidx/fragment/app/FragmentActivity;Ljava/lang/Runnable;)V
    ...
    new-instance p0, La0/o6;

    const/4 v1, 0x0

    invoke-direct {p0, p1, v1}, La0/o6;-><init>(Ljava/lang/Object;I)V

    const p1, 0x7f140c58

    invoke-virtual {v0, p1, p0}, Lmiuix/appcompat/app/AlertDialog$a;->A(ILandroid/content/DialogInterface$OnClickListener;)V

    new-instance p0, La0/p6;

    invoke-direct {p0}, La0/p6;-><init>()V
...
.method public static b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/Runnable;Ljava/lang/CharSequence;Lml/a;Ljava/lang/String;Ljava/lang/Runnable;)Lmiuix/appcompat/app/AlertDialog;
    .locals 12
    ...
    invoke-static/range {v0 .. v11}, La0/t6;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/Runnable;Ljava/lang/CharSequence;Lml/a;Ljava/lang/String;Ljava/lang/Runnable;Ljava/lang/String;ZLjava/lang/Runnable;)Lmiuix/appcompat/app/AlertDialog;
...
.method public static c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/Runnable;Ljava/lang/CharSequence;Lml/a;Ljava/lang/String;Ljava/lang/Runnable;Ljava/lang/String;ZLjava/lang/Runnable;)Lmiuix/appcompat/app/AlertDialog;
    .locals 1

    new-instance v0, La0/l6;

    invoke-direct {v0, p4, p8, p6}, La0/l6;-><init>(Ljava/lang/Runnable;Ljava/lang/Runnable;Lml/a;)V

    new-instance p4, La0/m6;

    invoke-direct {p4, p11}, La0/m6;-><init>(Ljava/lang/Runnable;)V

    new-instance p6, Lea/e0;

    invoke-direct {p6, v0, p4}, Lea/e0;-><init>(Landroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    :cond_0
    new-instance p0, La0/n6;

    invoke-direct {p0}, La0/n6;-><init>()V
    ...
    new-instance p2, Lea/d0;

    invoke-direct {p2, p6}, Lea/d0;-><init>(Lea/e0;)V
