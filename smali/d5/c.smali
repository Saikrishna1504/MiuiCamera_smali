...
.method public constructor <init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V
    ...
    iput v0, p0, Ld5/c;->h:I

    const/4 v1, 0x1

    iput-boolean v1, p0, Ld5/c;->i:Z

    iput-object p2, p0, Ld5/c;->a:Landroid/widget/LinearLayout;
    ...
    iput-object v2, p0, Ld5/c;->d:Landroid/widget/FrameLayout;
    ...
    iput-object v1, p0, Ld5/c;->d:Landroid/widget/FrameLayout;
    ...
    iput-object p2, p0, Ld5/c;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object p2, p0, Ld5/c;->f:Lcom/android/camera/fragment/beauty/LinearLayoutManagerWrapper;

    iget-object v0, p0, Ld5/c;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p2, p0, Ld5/c;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object p2, p0, Ld5/c;->b:Lh1/j;
    ...
    iput-object v0, p0, Ld5/c;->c:Lcom/android/camera2/compat/theme/custom/cv/cvlens/CvLensAdapter;
...
.method public final M()V
    ...
    iget-object v0, p0, Ld5/c;->d:Landroid/widget/FrameLayout;

    invoke-static {v0}, Lp0/b;->d(Landroid/view/View;)V

    iget-object p0, p0, Ld5/c;->e:Landroidx/recyclerview/widget/RecyclerView;
...
.method public final S(Landroid/content/Context;)V
    ...
    iget-object v0, p0, Ld5/c;->a:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Ld5/c;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object v0, p0, Ld5/c;->f:Lcom/android/camera/fragment/beauty/LinearLayoutManagerWrapper;
...
.method public final T(Landroid/content/Context;)V
    ...
    iput-boolean p1, p0, Ld5/c;->i:Z

    iget-object p1, p0, Ld5/c;->d:Landroid/widget/FrameLayout;

    invoke-static {p1}, Lp0/a;->d(Landroid/view/View;)V

    iget-object p1, p0, Ld5/c;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput p1, p0, Ld5/c;->g:I

    iget-object v0, p0, Ld5/c;->c:Lcom/android/camera2/compat/theme/custom/cv/cvlens/CvLensAdapter;
    ...
    invoke-direct {p1, p0, v1}, Ld5/a;-><init>(Ljava/lang/Object;I)V
...
.method public final a(I)V
    ...
    iput v1, p0, Ld5/c;->h:I

    iput p1, p0, Ld5/c;->g:I

    iget-object v1, p0, Ld5/c;->c:Lcom/android/camera2/compat/theme/custom/cv/cvlens/CvLensAdapter;

    invoke-virtual {v1, p1}, Lcom/android/camera/fragment/beauty/BaseImageTextAdapter;->scrollIfNeed(I)Z

    iget p1, p0, Ld5/c;->h:I

    iget v2, p0, Ld5/c;->g:I
    ...
    new-instance v5, Lcom/android/camera/fragment/EffectItemAdapter$a;

    const/4 v6, 0x1

    invoke-direct {v5, v6, v2}, Lcom/android/camera/fragment/EffectItemAdapter$a;-><init>(ZI)V

    iget-object v7, p0, Ld5/c;->b:Lh1/j;
    ...
    invoke-virtual {v7}, Lh1/j;->getItems()Ljava/util/List;
    ...
    iget-object v9, p0, Ld5/c;->e:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v9, p1}, Landroidx/recyclerview/widget/RecyclerView;->findViewHolderForAdapterPosition(I)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    iget-object v10, p0, Ld5/c;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-virtual {v1, p0, v0, v6}, Lcom/android/camera/fragment/beauty/BaseImageTextAdapter;->setAccessible(Landroid/view/View;IZ)V

    :cond_4
    invoke-virtual {v1, v2, v5}, Landroidx/recyclerview/widget/RecyclerView$Adapter;->notifyItemChanged(ILjava/lang/Object;)V
    ...
    invoke-direct {v0, v2, p1, v4}, Ld5/b;-><init>(III)V
...
.method public final provideRotateItem(Ljava/util/List;I)V
    ...
    iget-object p2, p0, Ld5/c;->c:Lcom/android/camera2/compat/theme/custom/cv/cvlens/CvLensAdapter;
    ...
    :goto_0
    iget-object v2, p0, Ld5/c;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :cond_1
    iget-object p1, p0, Ld5/c;->f:Lcom/android/camera/fragment/beauty/LinearLayoutManagerWrapper;

    invoke-virtual {p1}, Landroidx/recyclerview/widget/LinearLayoutManager;->findFirstVisibleItemPosition()I

    move-result p1

    iget-object p0, p0, Ld5/c;->f:Lcom/android/camera/fragment/beauty/LinearLayoutManagerWrapper;
