...
.method public static a(IZZ)Lcom/android/camera/ui/zoom/ZoomRatioToggleView$e;
    ...
    invoke-static {p0, v0, p1, p2}, La5/s;->e(ILa5/s$a;ZZ)V

    new-instance p0, Lcom/android/camera/ui/zoom/ZoomRatioToggleView$e;

    iget p1, v0, La5/s$a;->a:I

    iget-boolean p2, v0, La5/s$a;->b:Z

    iget-boolean v1, v0, La5/s$a;->c:Z

    iget-boolean v0, v0, La5/s$a;->d:Z
...
.method public static c(ILa5/s$a;Lea/c;Z)V
    .locals 4
    ...
    :cond_2
    invoke-static {}, La5/s;->b()Z

    move-result v0

    :goto_1
    iput-boolean v0, p1, La5/s$a;->b:Z
    ...
    :goto_3
    iput-boolean v1, p1, La5/s$a;->d:Z

    return-void
.end method

.method public static d(ILa5/s$a;)V
    .locals 11
    ...
    invoke-static {v3, v0}, La0/k0;->e(ILjava/util/Optional;)Ljava/util/Optional;
    ...
    invoke-static {v4, v3}, La0/z;->h(ILjava/util/Optional;)Ljava/util/Optional;
    ...
    invoke-static {p1, p0, v0}, La0/v;->b(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v4, p0}, Ld1/n0;->getComponentValue(I)Ljava/lang/String;
    ...
    check-cast v7, Ld1/u0;

    invoke-virtual {v7, p0}, Ld1/u0;->getPreferComponentValue(I)Ljava/lang/String;
    ...
    :cond_e
    iput-boolean v1, p1, La5/s$a;->b:Z

    :cond_f
    iget p0, p1, La5/s$a;->a:I

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-boolean v2, p1, La5/s$a;->d:Z

    return-void
.end method

.method public static e(ILa5/s$a;ZZ)V
    .locals 12
    ...
    invoke-static {v5, v8}, Lea/f0;->e(ZZ)Z

    move-result p2

    if-eqz p2, :cond_3

    iput v5, p1, La5/s$a;->a:I

    invoke-static {v5}, Lea/f0;->c(Z)[F
    ...
    :goto_0
    iput-boolean v5, p1, La5/s$a;->b:Z

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-boolean v8, p1, La5/s$a;->d:Z
    ...
    :cond_7
    :goto_2
    iput-boolean p2, p1, La5/s$a;->b:Z
    ...
    :goto_3
    iput-boolean v5, p1, La5/s$a;->d:Z
    ...
    invoke-virtual {v10, v0}, Ldh/b;->v(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v10

    check-cast v10, Ld1/u0;

    invoke-virtual {v10, p0}, Ld1/u0;->getPreferComponentValue(I)Ljava/lang/String;
    ...
    invoke-virtual {v10, v2}, Ldh/b;->v(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lh1/t;

    iget v2, v2, Lh1/t;->c:F
    ...
    invoke-virtual {v1, p0, v8}, Lh1/h1;->D(IZ)Z
    ...
    invoke-virtual {v2, v0}, Ldh/b;->v(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    iput-boolean v10, p1, La5/s$a;->d:Z
    ...
    :sswitch_0
    invoke-static {p0, p1, v2, v1}, La5/s;->c(ILa5/s$a;Lea/c;Z)V

    invoke-virtual {v7}, Luc/b;->q()Landroid/util/SparseArray;
    ...
    invoke-virtual {p2}, Li7/e;->e()I

    move-result p2

    invoke-virtual {p0, p2}, Li7/e;->N(I)Lea/c;
    ...
    :sswitch_2
    invoke-static {p0, p1}, La5/s;->d(ILa5/s$a;)V
    ...
    invoke-static {p0, p1}, La5/s;->f(ILa5/s$a;)V
    ...
    invoke-virtual {p0}, Lh1/v1;->C()Z

    move-result p0

    iput-boolean p0, p1, La5/s$a;->b:Z
    ...
    :goto_1b
    iput-boolean p0, p1, La5/s$a;->d:Z
    ...
    :cond_32
    :goto_1c
    iput-boolean v8, p1, La5/s$a;->b:Z
    ...
    :goto_1d
    iput-boolean v0, p1, La5/s$a;->d:Z
    ...
    iget-boolean v0, p1, La5/s$a;->d:Z
    ...
    iput-boolean v5, p1, La5/s$a;->c:Z
    ...
    invoke-virtual {v7, v4}, Luc/b;->O1(I)Z
    ...
    :cond_3c
    invoke-static {v2}, Lea/d;->M2(Lea/c;)Z

    move-result p0

    if-eqz p0, :cond_3d

    invoke-static {v2}, Lea/d;->M3(Lea/c;)Z
    ...
    invoke-virtual {v0, p0}, Ld1/u0;->getPreferComponentValue(I)Ljava/lang/String;
    ...
    :cond_4c
    invoke-static {p0, v2}, Lcom/android/camera/data/data/n;->Y(ILea/c;)Z
    ...
    :goto_2a
    iput-boolean v3, p1, La5/s$a;->b:Z
    ...
    iget-boolean v0, p1, La5/s$a;->b:Z

    iput-boolean v0, p1, La5/s$a;->c:Z
    ...
    const-class v2, Ly7/j3;

    invoke-virtual {v1, v2}, Lv7/e;->d(Ljava/lang/Class;)Ljava/util/Optional;
...
.method public static f(ILa5/s$a;)V
    .locals 9
    ...
    invoke-virtual {v1, p0}, Ld1/n0;->getComponentValue(I)Ljava/lang/String;
    ...
    invoke-virtual {v5, v8}, Ldh/b;->v(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Ld1/u0;

    invoke-virtual {v5, p0}, Ld1/u0;->getPreferComponentValue(I)Ljava/lang/String;
    ...
    :cond_8
    iput-boolean v6, p1, La5/s$a;->b:Z
    ...
    iput-boolean v7, p1, La5/s$a;->d:Z
