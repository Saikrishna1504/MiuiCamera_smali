...
.method public constructor <init>(Lt0/m1;)V
    ...
    invoke-direct {v0, p1, p0}, Lt0/g0;-><init>(Lt0/m1;Lt0/e0;)V

    iput-object v0, p0, Lt0/e0;->e:Lt0/g0;

    new-instance v0, Lt0/f0;

    invoke-direct {v0, p1, p0}, Lt0/f0;-><init>(Lt0/m1;Lt0/e0;)V
...
.method public final B(Ljava/util/List;Ljava/util/List;Lt0/e0$c;Ljava/util/List;ILcom/android/camera2/f;)V
    ...
    invoke-static {p6, p2, v0}, Lcom/android/camera2/g;->q5(Lcom/android/camera2/f;II)Z
    ...
    invoke-static {p6}, Lcom/android/camera2/g;->K8(Lcom/android/camera2/f;)Z
...
.method public final C(Ljava/util/List;Ljava/util/List;Lt0/e0$c;Ljava/util/List;ILcom/android/camera2/f;)V
    ...
    new-instance p6, Lcom/android/camera/f3;

    const/16 v0, 0x500

    const/16 v1, 0x2d0

    invoke-direct {p6, v0, v1}, Lcom/android/camera/f3;-><init>(II)V
...
.method public final D(Ljava/util/List;Ljava/util/List;Lt0/e0$c;Ljava/util/List;ILcom/android/camera2/f;)V
    ...
    invoke-static {p6, p5, p2}, Lcom/android/camera2/g;->q5(Lcom/android/camera2/f;II)Z
...
.method public final F(Lt0/e0$c;Ljava/util/List;ILcom/android/camera2/f;II)V
    ...
    invoke-static/range {p6 .. p6}, Lcom/android/camera/e3;->R2(I)Z
    ...
    :cond_0
    invoke-static/range {p6 .. p6}, Lcom/android/camera/e3;->E2(I)Z
    ...
    invoke-virtual {v6}, Lbb/c;->I()[Ljava/lang/String;
    ...
    :cond_2
    invoke-static {v3, v4}, Lcom/android/camera/e3;->Q6(Lcom/android/camera2/f;I)Z
    ...
    :goto_2
    invoke-static/range {p6 .. p6}, Lcom/android/camera/e3;->O5(I)Z
    ...
    invoke-static {v3, v6}, Lcom/android/camera/e3;->j2(Lcom/android/camera2/f;I)Z
    ...
    :cond_6
    invoke-static/range {p6 .. p6}, Lcom/android/camera/e3;->l0(I)Ljava/lang/String;
    ...
    :cond_7
    invoke-static/range {p6 .. p6}, Lcom/android/camera/e3;->D4(I)Z
    ...
    invoke-static/range {p4 .. p4}, Lcom/android/camera2/g;->D9(Lcom/android/camera2/f;)Ljava/util/List;
    ...
    invoke-static {v4, v12}, Lcom/android/camera/e3;->N3(ILcom/android/camera/fragment/beauty/c0;)Z
    ...
    invoke-static/range {p4 .. p4}, Lcom/android/camera2/g;->n1(Lcom/android/camera2/f;)[Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lbb/c;->o8()Z

    move-result v5

    if-eqz v5, :cond_13

    invoke-static/range {p4 .. p4}, Lcom/android/camera2/g;->q8(Lcom/android/camera2/f;)Z
    ...
    :cond_13
    :goto_7
    invoke-static/range {p6 .. p6}, Lcom/android/camera/e3;->n5(I)Z

    move-result v5

    if-eqz v5, :cond_15

    invoke-static/range {p4 .. p4}, Lcom/android/camera2/g;->L6(Lcom/android/camera2/f;)Z
    ...
    invoke-static {v2}, Lcom/android/camera/e3;->b0(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_18
    invoke-static/range {p4 .. p4}, Lcom/android/camera/e3;->V5(Lcom/android/camera2/f;)Z
...
.method public O(IILcom/android/camera2/f;I)V
    ...
    invoke-virtual {v0, v9, v1}, Li6/g;->I(II)Lcom/android/camera2/f;
    ...
    :cond_3
    invoke-static/range {p3 .. p3}, Lcom/android/camera/e3;->V5(Lcom/android/camera2/f;)Z

    move-result v1

    if-eqz v1, :cond_4

    invoke-static/range {p3 .. p3}, Lcom/android/camera2/g;->I9(Lcom/android/camera2/f;)Ljava/util/List;
    ...
    :cond_6
    invoke-static/range {p1 .. p1}, Lcom/android/camera/e3;->n5(I)Z
    ...
    invoke-static/range {p3 .. p3}, Lcom/android/camera2/g;->j1(Lcom/android/camera2/f;)Ljava/util/List;
    ...
    invoke-static/range {p3 .. p3}, Lcom/android/camera2/g;->B9(Lcom/android/camera2/f;)Ljava/util/List;
    ...
    invoke-static/range {p1 .. p1}, Lcom/android/camera/e3;->u6(I)Z
    ...
    invoke-static/range {p3 .. p3}, Lcom/android/camera2/g;->o9(Lcom/android/camera2/f;)Z
    ...
    invoke-static {v0}, Lcom/android/camera2/g;->K9(Lcom/android/camera2/f;)Ljava/util/List;
    ...
    invoke-static {v10, v1}, Lcom/android/camera2/g;->B1(Lcom/android/camera2/f;Ljava/lang/Class;)Ljava/util/List;
    ...
    invoke-static {v10, v0, v1}, Lcom/android/camera2/g;->C1(Lcom/android/camera2/f;Ljava/lang/Class;I)Ljava/util/List;
...
.method public final d(ILjava/util/List;Lt0/e0$c;)V
    ...
    :cond_0
    invoke-static {v7}, Lcom/android/camera2/g;->i6(Lcom/android/camera2/f;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {v7}, Lcom/android/camera2/g;->B9(Lcom/android/camera2/f;)Ljava/util/List;
    ...
    invoke-static {v7, v0, v1}, Lcom/android/camera2/g;->C1(Lcom/android/camera2/f;Ljava/lang/Class;I)Ljava/util/List;
...
.method public getKey(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/android/camera/e3;->V5(Lcom/android/camera2/f;)Z
...
.method public final z()V
    ...
    invoke-static {v4}, Lcom/android/camera2/g;->M9(Lcom/android/camera2/f;)Ljava/util/List;
