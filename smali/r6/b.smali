...
.method public static a(Lorg/xmlpull/v1/XmlSerializer;JII)V
    ...
    sget-object p2, Lr6/b;->a:Ljava/lang/String;
...
.method public static b(Ljava/lang/String;)Lr6/a;
    .locals 9
    ...
    sget-object v3, Lr6/b;->a:Ljava/lang/String;
...
.method public static c(Landroid/content/Context;Landroid/net/Uri;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1}, Lr6/b;->g(Landroid/content/Context;Landroid/net/Uri;)[B
    ...
    :try_start_1
    invoke-virtual {v6}, Li/j;->b()Ljava/lang/String;

    move-result-object v6

    invoke-static {v6}, Lr6/b;->b(Ljava/lang/String;)Lr6/a;
    ...
    .catch Lh/c; {:try_start_3 .. :try_end_3} :catch_3
    ...
    .catch Lh/c; {:try_start_5 .. :try_end_5} :catch_3
    ...
    .catch Lh/c; {:try_start_7 .. :try_end_7} :catch_3
    ...
    :try_end_8
    .catch Lh/c; {:try_start_8 .. :try_end_8} :catch_3
...
.method public static g(Landroid/content/Context;Landroid/net/Uri;)[B
    ...
    invoke-static {p0}, Lr6/b;->e(Ljava/io/InputStream;)S
    ...
    invoke-static {v2, v1}, Lr6/b;->i(I[B)Ljava/util/ArrayList;
...
.method public static h(Ljava/io/File;Lr6/c;[B[B)V
    .locals 16
    ...
    sget-object v2, Lr6/b;->a:Ljava/lang/String;
    ...
    invoke-static {v9}, Lr6/b;->e(Ljava/io/InputStream;)S
    ...
    invoke-static {v13, v6}, Lr6/b;->i(I[B)Ljava/util/ArrayList;
    ...
    invoke-static {v6, v7, v4, v1}, Lr6/b;->k(Ljava/util/ArrayList;I[BLr6/c;)V
    ...
    invoke-static {v6, v1}, Lr6/b;->j(Ljava/util/ArrayList;Lr6/c;)V
    ...
    invoke-static {v0}, Lr6/b;->f(S)[B

    move-result-object v0

    invoke-virtual {v1, v0}, Ljava/io/FileOutputStream;->write([B)V

    invoke-static {v1, v6}, Lr6/b;->l(Ljava/io/FileOutputStream;Ljava/util/ArrayList;)V
...
.method public static i(I[B)Ljava/util/ArrayList;
    ...
    iput v3, v2, Lr6/c;->a:I

    invoke-virtual {p1}, Ljava/nio/ByteBuffer;->getShort()S

    move-result v3

    iput v3, v2, Lr6/c;->b:I

    invoke-virtual {p1}, Ljava/nio/ByteBuffer;->getInt()I

    move-result v3

    iput v3, v2, Lr6/c;->c:I

    invoke-virtual {p1}, Ljava/nio/ByteBuffer;->getInt()I

    move-result v3

    iput v3, v2, Lr6/c;->d:I
...
.method public static j(Ljava/util/ArrayList;Lr6/c;)V
    .locals 6
    ...
    iget v2, v1, Lr6/c;->a:I

    const/16 v3, 0x111

    if-ne v2, v3, :cond_1

    iget v2, v1, Lr6/c;->d:I

    invoke-virtual {p1}, Lr6/c;->a()I
    ...
    iput v3, v1, Lr6/c;->d:I

    goto :goto_0

    :cond_1
    invoke-virtual {v1}, Lr6/c;->a()I
    ...
    invoke-static {p0, v0}, La0/w3;->i(Ljava/util/ArrayList;I)Ljava/lang/Object;
    ...
    sget-object v5, Lr6/b;->a:Ljava/lang/String;

    invoke-static {v5, v2, v4}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget v0, v0, Lr6/c;->d:I
...
.method public static k(Ljava/util/ArrayList;I[BLr6/c;)V
    .locals 4
    ...
    invoke-virtual {p0}, Lr6/c;->a()I

    move-result v0

    iget p0, p0, Lr6/c;->d:I
    ...
    invoke-static {p1, p0, v1, v0}, La0/c0;->g(Ljava/lang/String;ILjava/lang/String;I)Ljava/lang/String;
...
.method public static l(Ljava/io/FileOutputStream;Ljava/util/ArrayList;)V
    ...
    iget v1, v0, Lr6/c;->a:I

    int-to-short v1, v1

    invoke-static {v1}, Lr6/b;->f(S)[B

    move-result-object v1

    invoke-virtual {p0, v1}, Ljava/io/FileOutputStream;->write([B)V

    iget v1, v0, Lr6/c;->b:I
    ...
    iget v1, v0, Lr6/c;->c:I

    invoke-static {v1}, Lr6/b;->d(I)[B
