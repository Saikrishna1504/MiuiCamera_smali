...
.method public final registerLayoutStateChangeCallback(Landroid/app/Activity;)V
    ...
    iget-object v0, p0, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;->job:Lbq/g1;
    ...
    :cond_1
    new-instance v2, Lbq/z0;

    invoke-direct {v2, v0}, Lbq/z0;-><init>(Ljava/util/concurrent/Executor;)V

    invoke-static {v2}, Lbq/b0;->a(Lkp/f;)Lgq/e;

    move-result-object v0

    new-instance v2, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver$registerLayoutStateChangeCallback$1;

    invoke-direct {v2, p0, p1, v1}, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver$registerLayoutStateChangeCallback$1;-><init>(Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;Landroid/app/Activity;Lkp/d;)V

    const/4 p1, 0x3

    invoke-static {v0, v1, v2, p1}, Lbq/e;->a(Lbq/a0;Lkp/f;Lsp/p;I)Lbq/u1;

    move-result-object p1

    iput-object p1, p0, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;->job:Lbq/g1;
...
.method public final unregisterLayoutStateChangeCallback()V
    ...
    iget-object p0, p0, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;->job:Lbq/g1;
