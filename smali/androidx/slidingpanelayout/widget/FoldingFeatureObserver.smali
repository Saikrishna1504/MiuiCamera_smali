...
.method public final registerLayoutStateChangeCallback(Landroid/app/Activity;)V
    ...
    iget-object v0, p0, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;->job:Lxk/r1;
    ...
    invoke-static {v0, v1, v2, v1}, Lxk/r1$a;->a(Lxk/r1;Ljava/util/concurrent/CancellationException;ILjava/lang/Object;)V

    :goto_0
    iget-object v0, p0, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;->executor:Ljava/util/concurrent/Executor;

    invoke-static {v0}, Lxk/j1;->a(Ljava/util/concurrent/Executor;)Lxk/f0;

    move-result-object v0

    invoke-static {v0}, Lxk/k0;->a(Lgk/g;)Lxk/j0;
    ...
    invoke-direct {v5, p0, p1, v1}, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver$registerLayoutStateChangeCallback$1;-><init>(Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;Landroid/app/Activity;Lgk/d;)V

    const/4 v6, 0x3

    const/4 v7, 0x0

    invoke-static/range {v2 .. v7}, Lxk/h;->b(Lxk/j0;Lgk/g;Lxk/l0;Lok/p;ILjava/lang/Object;)Lxk/r1;

    move-result-object p1

    iput-object p1, p0, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;->job:Lxk/r1;
...
.method public final unregisterLayoutStateChangeCallback()V
    ...
    iget-object p0, p0, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;->job:Lxk/r1;
    ...
    invoke-static {p0, v1, v0, v1}, Lxk/r1$a;->a(Lxk/r1;Ljava/util/concurrent/CancellationException;ILjava/lang/Object;)V
