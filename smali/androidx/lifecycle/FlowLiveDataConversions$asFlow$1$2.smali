...
.method public final invoke()V
    ...
    invoke-direct {v1, v2, p0, v3}, Landroidx/lifecycle/FlowLiveDataConversions$asFlow$1$2$1;-><init>(Landroidx/lifecycle/LiveData;Landroidx/lifecycle/Observer;Lkp/d;)V
    ...
    .line 6
    :goto_0
    invoke-static {v4, v0, v2}, Lbq/v;->a(Lkp/f;Lkp/f;Z)Lkp/f;

    move-result-object v0

    .line 7
    sget-object v4, Lbq/o0;->a:Lhq/c;

    if-eq v0, v4, :cond_2

    .line 8
    sget-object v7, Lkp/e$a;->a:Lkp/e$a;

    invoke-interface {v0, v7}, Lkp/f;->get(Lkp/f$c;)Lkp/f$b;
    ...
    .line 9
    invoke-interface {v0, v4}, Lkp/f;->plus(Lkp/f;)Lkp/f;
    ...
    .line 10
    new-instance p0, Lbq/n1;

    invoke-direct {p0, v0, v1}, Lbq/n1;-><init>(Lkp/f;Lsp/p;)V

    goto :goto_1

    .line 11
    :cond_4
    new-instance p0, Lbq/u1;

    invoke-direct {p0, v0, v2}, Lbq/u1;-><init>(Lkp/f;Z)V

    .line 12
    :goto_1
    invoke-virtual {p0, v5, p0, v1}, Lbq/a;->c0(ILbq/a;Lsp/p;)V
