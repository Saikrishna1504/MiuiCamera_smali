...
# direct methods
.method public constructor <init>(Lkp/f;JLsp/p;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v0}, Lbq/v1;-><init>(Lbq/g1;)V
    ...
    invoke-virtual {v0, p1}, Lkp/a;->plus(Lkp/f;)Lkp/f;
    ...
    invoke-static {p1}, Lbq/b0;->a(Lkp/f;)Lgq/e;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/lifecycle/BlockRunner;-><init>(Landroidx/lifecycle/CoroutineLiveData;Lsp/p;JLbq/a0;Lsp/a;)V
...
.method public synthetic constructor <init>(Lkp/f;JLsp/p;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0
    ...
    .line 2
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/lifecycle/CoroutineLiveData;-><init>(Lkp/f;JLsp/p;)V
...
# virtual methods
.method public final clearSource$lifecycle_livedata_release(Lkp/d;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Landroidx/lifecycle/CoroutineLiveData$clearSource$1;-><init>(Landroidx/lifecycle/CoroutineLiveData;Lkp/d;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/lifecycle/EmittedSource;->disposeNow(Lkp/d;)Ljava/lang/Object;
...
.method public final emitSource$lifecycle_livedata_release(Landroidx/lifecycle/LiveData;Lkp/d;)Ljava/lang/Object;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p2}, Landroidx/lifecycle/CoroutineLiveData$emitSource$1;-><init>(Landroidx/lifecycle/CoroutineLiveData;Lkp/d;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/lifecycle/CoroutineLiveData;->clearSource$lifecycle_livedata_release(Lkp/d;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1, v0}, Landroidx/lifecycle/CoroutineLiveDataKt;->addDisposableSource(Landroidx/lifecycle/MediatorLiveData;Landroidx/lifecycle/LiveData;Lkp/d;)Ljava/lang/Object;
