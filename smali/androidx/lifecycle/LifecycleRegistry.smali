...
# instance fields
.field private final _currentStateFlow:Leq/i;
...
.method private constructor <init>(Landroidx/lifecycle/LifecycleOwner;Z)V
    ...
    :cond_0
    invoke-direct {p1, p2}, Leq/n;-><init>(Ljava/lang/Object;)V

    .line 8
    iput-object p1, p0, Landroidx/lifecycle/LifecycleRegistry;->_currentStateFlow:Leq/i;
...
.method private final calculateTargetState(Landroidx/lifecycle/LifecycleObserver;)Landroidx/lifecycle/Lifecycle$State;
    ...
    invoke-static {v0, v1}, La0/w3;->i(Ljava/util/ArrayList;I)Ljava/lang/Object;
...
.method private final sync()V
    ...
    iget-object v0, p0, Landroidx/lifecycle/LifecycleRegistry;->_currentStateFlow:Leq/i;

    invoke-virtual {p0}, Landroidx/lifecycle/LifecycleRegistry;->getCurrentState()Landroidx/lifecycle/Lifecycle$State;

    move-result-object p0

    invoke-interface {v0, p0}, Leq/i;->setValue(Ljava/lang/Object;)V
...
.method public getCurrentStateFlow()Leq/m;
    ...
    iget-object p0, p0, Landroidx/lifecycle/LifecycleRegistry;->_currentStateFlow:Leq/i;

    new-instance v0, Leq/j;

    invoke-direct {v0, p0}, Leq/j;-><init>(Leq/m;)V
