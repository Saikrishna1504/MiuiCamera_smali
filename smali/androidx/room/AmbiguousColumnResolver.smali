...
.method private final dfs(Ljava/util/List;Ljava/util/List;ILsp/l;)V
    .locals 2
    ...
    invoke-static {p2}, Lhp/s;->j0(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object p0

    invoke-interface {p4, p0}, Lsp/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1, p2, v1, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILsp/l;)V
    ...
    invoke-static {p2}, Lbq/t;->o(Ljava/util/List;)I
...
.method public static synthetic dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILsp/l;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILsp/l;)V

    return-void
.end method

.method private final rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lsp/q;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3, p2, v3, v4}, Lsp/q;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final resolve([Ljava/lang/String;[[Ljava/lang/String;)[[I
    ...
    :cond_3
    new-instance v2, Lip/f;

    invoke-direct {v2}, Lip/f;-><init>()V
    ...
    invoke-static {v2, v7}, Lhp/o;->T(Ljava/util/Collection;[Ljava/lang/Object;)V
    ...
    :cond_4
    invoke-static {v2}, La0/m5;->c(Lip/f;)Lip/f;

    new-instance v4, Lip/a;

    invoke-direct {v4}, Lip/a;-><init>()V
    ...
    invoke-virtual {v2, v9}, Lip/f;->contains(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v4, v11}, Lip/a;->add(Ljava/lang/Object;)Z
    ...
    :cond_6
    invoke-static {v4}, Lbq/t;->g(Lip/a;)Lip/a;
    ...
    invoke-direct {v10, v4, v8, v11}, Landroidx/room/AmbiguousColumnResolver;->rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lsp/q;)V
    ...
    invoke-direct {v13}, Lip/a;-><init>()V

    invoke-virtual {v4}, Lip/a;->iterator()Ljava/util/Iterator;
    ...
    check-cast v15, Lip/a$a;

    invoke-virtual {v15}, Lip/a$a;->hasNext()Z

    move-result v16

    if-eqz v16, :cond_9

    invoke-virtual {v15}, Lip/a$a;->next()Ljava/lang/Object;
    ...
    invoke-virtual {v13, v5}, Lip/a;->add(Ljava/lang/Object;)Z
    ...
    :cond_9
    invoke-static {v13}, Lbq/t;->g(Lip/a;)Lip/a;

    invoke-virtual {v13}, Lip/a;->isEmpty()Z
    ...
    invoke-static {v0, v11, v1}, La0/d0;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v11 .. v17}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILsp/l;ILjava/lang/Object;)V
    ...
    invoke-static/range {v6 .. v12}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILsp/l;ILjava/lang/Object;)V
