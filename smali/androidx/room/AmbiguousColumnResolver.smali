...
.method private final dfs(Ljava/util/List;Ljava/util/List;ILok/l;)V
    .locals 2
    ...
    invoke-static {p2}, Ldk/w;->W(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object p0

    invoke-interface {p4, p0}, Lok/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1, p2, v1, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILok/l;)V

    invoke-static {p2}, Ldk/t;->x(Ljava/util/List;)Ljava/lang/Object;
...
.method public static synthetic dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILok/l;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILok/l;)V

    return-void
.end method

.method private final rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lok/q;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3, p2, v3, v4}, Lok/q;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final resolve([Ljava/lang/String;[[Ljava/lang/String;)[[I
    ...
    :cond_3
    invoke-static {}, Ldk/h0;->b()Ljava/util/Set;
    ...
    invoke-static {v2, v6}, Ldk/t;->w(Ljava/util/Collection;[Ljava/lang/Object;)Z
    ...
    :cond_4
    invoke-static {v2}, Ldk/h0;->a(Ljava/util/Set;)Ljava/util/Set;

    move-result-object v2

    invoke-static {}, Ldk/n;->c()Ljava/util/List;
    ...
    :cond_6
    invoke-static {v4}, Ldk/n;->a(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v10, v0, v6, v11}, Landroidx/room/AmbiguousColumnResolver;->rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lok/q;)V
    ...
    :cond_9
    invoke-static {v14}, Ldk/n;->a(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static/range {v11 .. v17}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILok/l;ILjava/lang/Object;)V
    ...
    invoke-static/range {v8 .. v14}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILok/l;ILjava/lang/Object;)V
