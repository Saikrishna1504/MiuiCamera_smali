...
# instance fields
.field final synthetic $$this$flow:Leq/f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Leq/f<",
            "TR;>;"
...
# direct methods
.method public constructor <init>(ZLandroidx/room/RoomDatabase;Leq/f;[Ljava/lang/String;Ljava/util/concurrent/Callable;Lkp/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    iput-object p3, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->$$this$flow:Leq/f;
    ...
    invoke-direct {p0, p1, p6}, Lmp/i;-><init>(ILkp/d;)V
...
.method public final create(Ljava/lang/Object;Lkp/d;)Lkp/d;
    ...
    iget-object v3, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->$$this$flow:Leq/f;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;-><init>(ZLandroidx/room/RoomDatabase;Leq/f;[Ljava/lang/String;Ljava/util/concurrent/Callable;Lkp/d;)V
...
.method public final invoke(Lbq/a0;Lkp/d;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->create(Ljava/lang/Object;Lkp/d;)Lkp/d;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->invoke(Lbq/a0;Lkp/d;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v1, v3, v4}, Ldq/i;->a(ILdq/a;I)Ldq/b;
    ...
    invoke-direct {v7, v1, v8}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$observer$1;-><init>([Ljava/lang/String;Ldq/f;)V

    sget-object v1, Lgp/l;->a:Lgp/l;

    invoke-interface {v8, v1}, Ldq/t;->i(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v4, v5}, Lkp/f;->get(Lkp/f$c;)Lkp/f$b;
    ...
    invoke-virtual {v4}, Landroidx/room/TransactionElement;->getTransactionDispatcher$room_ktx_release()Lkp/e;
    ...
    invoke-static {v4}, Landroidx/room/CoroutinesRoomKt;->getTransactionDispatcher(Landroidx/room/RoomDatabase;)Lbq/x;
    ...
    invoke-static {v4}, Landroidx/room/CoroutinesRoomKt;->getQueryDispatcher(Landroidx/room/RoomDatabase;)Lbq/x;
    ...
    invoke-static {v5, v3, v6}, Ldq/i;->a(ILdq/a;I)Ldq/b;
    ...
    invoke-direct/range {v5 .. v11}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;-><init>(Landroidx/room/RoomDatabase;Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$observer$1;Ldq/f;Ljava/util/concurrent/Callable;Ldq/f;Lkp/d;)V

    const/4 v5, 0x2

    invoke-static {p1, v4, v12, v5}, Lbq/e;->a(Lbq/a0;Lkp/f;Lsp/p;I)Lbq/u1;

    iget-object p1, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->$$this$flow:Leq/f;

    iput v2, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->label:I

    invoke-static {p1, v3, v2, p0}, Lbk/e;->j(Leq/f;Ldq/f;ZLkp/d;)Ljava/lang/Object;
