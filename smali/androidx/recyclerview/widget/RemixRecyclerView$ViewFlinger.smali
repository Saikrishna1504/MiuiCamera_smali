...
.field private mHapticFeedbackCompat:Lxn/b;
...
.method public constructor <init>(Landroidx/recyclerview/widget/RemixRecyclerView;)V
    ...
    invoke-direct {v1, p1, v0}, Lym/c;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object v1, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lym/c;
...
.method private getHapticFeedbackCompat()Lxn/b;
    .locals 2

    iget-object v0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lxn/b;
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lxn/b;

    :cond_0
    iget-object p0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lxn/b;
...
.method public fling(II)V
    ...
    invoke-direct {v2, v4, v3}, Lym/c;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object v2, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lym/c;
    ...
    :cond_9
    :goto_4
    iget-object v3, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lym/c;
    ...
    invoke-virtual/range {v3 .. v11}, Lym/c;->c(IIIIIIII)V
...
.method public resetFlingPosition()V
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lym/c;
...
.method public run()V
    ...
    iget-object v1, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lym/c;

    invoke-virtual {v1}, Lym/c;->b()Z

    move-result v4

    if-eqz v4, :cond_21

    invoke-virtual {v1}, Lym/c;->h()I

    move-result v4

    invoke-virtual {v1}, Lym/c;->i()I

    move-result v5

    iget-object v6, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lym/c;

    invoke-virtual {v6}, Lym/c;->l()I

    move-result v6

    if-ne v6, v3, :cond_1

    invoke-virtual {v1}, Lym/c;->f()F
    ...
    iget-object v4, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lym/c;

    invoke-virtual {v4}, Lym/c;->l()I
    ...
    iget-object v8, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lym/c;

    invoke-virtual {v8}, Lym/c;->f()F

    move-result v8

    iget-object v9, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lym/c;

    invoke-virtual {v9}, Lym/c;->g()F

    move-result v9

    invoke-interface {v7, v8, v9}, Ldm/c;->b(FF)Z
    ...
    iget-object v5, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lym/c;

    invoke-virtual {v5}, Lym/c;->n()I
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->getHapticFeedbackCompat()Lxn/b;

    move-result-object v1

    const/16 v4, 0xc9

    invoke-virtual {v1, v4}, Lxn/b;->e(I)V
...
.method public smoothScrollBy(IIILandroid/view/animation/Interpolator;)V
    ...
    :cond_2
    iget-object p3, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lym/c;

    invoke-virtual {p3}, Lym/c;->l()I
    ...
    invoke-direct {p3, v2, p4}, Lym/c;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object p3, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lym/c;
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lym/c;
    ...
    invoke-virtual/range {v1 .. v7}, Lym/c;->w(IIIIII)V
