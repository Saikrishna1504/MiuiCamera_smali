...
.method public notifyHorizontalEdgeReached(I)V
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lks/d;
    ...
    iget-object v1, v0, Lks/d;->b:Lks/b;

    const/4 v2, 0x0

    iget p0, v1, Lks/d$a;->h:I

    if-nez p0, :cond_1

    iget-object p0, v1, Lks/b;->r:Lks/b$b;

    if-eqz p0, :cond_0

    invoke-virtual {v1}, Lks/b;->h()V

    :cond_0
    iget-wide p0, v1, Lks/d$a;->d:D
    ...
    invoke-virtual/range {v1 .. v6}, Lks/b;->j(IIIII)V
...
.method public notifyVerticalEdgeReached(I)V
    ...
    iget-object v1, v0, Lks/d;->c:Lks/b;
...
.method public overFling(IIII)V
    ...
    invoke-virtual/range {v6 .. v15}, Lks/d;->b(IIIIIIIII)V
...
.method public springBack(II)V
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lks/d;

    neg-int p1, p1

    neg-int p2, p2

    iput v0, v1, Lks/d;->a:I

    iget-object v0, v1, Lks/d;->b:Lks/b;

    const/4 v2, 0x0

    invoke-virtual {v0, v2, p1, p1}, Lks/b;->i(III)Z

    move-result p1

    iget-object v0, v1, Lks/d;->c:Lks/b;

    invoke-virtual {v0, v2, p2, p2}, Lks/b;->i(III)Z
