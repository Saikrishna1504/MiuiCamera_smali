...
.method public static c(I)Ljava/util/ArrayList;
    ...
    :cond_0
    sget-object v2, Lh0/b;->a:Ljava/util/ArrayList;

    if-nez v2, :cond_2

    sget-object v2, Lh0/b;->b:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    sget-object v4, Lh0/b;->a:Ljava/util/ArrayList;

    if-nez v4, :cond_1

    new-instance v4, Ll0/a;

    invoke-direct {v4, v3}, Ll0/a;-><init>(I)V

    new-instance v5, Ljava/util/ArrayList;

    invoke-virtual {v4}, Ll0/a;->d()Ljava/util/ArrayList;

    move-result-object v4

    invoke-direct {v5, v4}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    sput-object v5, Lh0/b;->a:Ljava/util/ArrayList;
    ...
    sget-object v0, Lh0/b;->a:Ljava/util/ArrayList;
