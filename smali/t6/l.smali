...
.method public final d(Landroidx/fragment/app/FragmentActivity;Landroidx/fragment/app/Fragment;Ly7/b1;Landroidx/fragment/app/FragmentTransaction;)V
    ...
    iget p3, p2, Ls6/i;->b:I

    iget v0, p2, Ls6/i;->c:I

    iget p2, p2, Ls6/i;->e:I

    invoke-virtual {p0, p3}, Lt6/d;->a(I)Ljava/util/List;
    ...
    invoke-virtual {p0, p2, v0}, Lt6/d;->b(Landroidx/fragment/app/FragmentManager;I)Landroidx/fragment/app/Fragment;

    move-result-object p2

    if-eqz p2, :cond_2

    instance-of v1, p2, Ly7/c1;

    if-eqz v1, :cond_1

    move-object v1, p2

    check-cast v1, Ly7/c1;

    const/4 v2, 0x0

    invoke-interface {v1, v2}, Ly7/c1;->pendingGone(Z)V
    ...
    invoke-direct {v1, v0}, Lt6/k;-><init>(I)V
    ...
    new-instance v0, Lcom/android/camera/data/data/k;

    const/4 v1, 0x1

    invoke-direct {v0, p3, v1}, Lcom/android/camera/data/data/k;-><init>(II)V
    ...
    invoke-virtual {p0, p1, p2}, Lt6/d;->b(Landroidx/fragment/app/FragmentManager;I)Landroidx/fragment/app/Fragment;
