...
.method public final c(Ljava/lang/Object;)V
    ...
    iget-object v2, v1, Lcom/android/camera/data/data/c0;->c:Lea/c;

    iput-object v2, v0, Lcom/android/camera/data/data/c;->mCapabilities:Lea/c;

    invoke-static {v2}, Lea/d;->M(Lea/c;)Ljava/util/Map;

    move-result-object v2

    check-cast v2, Ljava/util/HashMap;

    iget-object v3, v0, Lcom/android/camera/data/data/c;->mCapabilities:Lea/c;

    invoke-static {v3}, Lea/d;->M(Lea/c;)Ljava/util/Map;
    ...
    invoke-static {v3}, Lea/d;->F1(Lea/c;)Z
    ...
    :cond_1
    invoke-static {v3}, Lea/d;->M2(Lea/c;)Z

    move-result v5

    if-eqz v5, :cond_2

    invoke-static {v3}, Lea/d;->m(Lea/c;)F
    ...
    :cond_4
    invoke-static {v3}, Lea/d;->L(Lea/c;)F
    ...
    :cond_6
    iget-object v11, v3, Lea/c;->c9:Ljava/util/HashMap;
    ...
    iget-object v12, v3, Lea/c;->b9:[B

    const-string v13, "CameraCapabilities"

    if-nez v12, :cond_9

    sget-object v12, Lra/f;->v1:Lra/e;

    invoke-virtual {v12}, Lra/e;->c()Ljava/lang/String;

    move-result-object v14

    invoke-virtual {v3, v14}, Lea/c;->D0(Ljava/lang/String;)Z

    move-result v14

    if-eqz v14, :cond_7

    iget-object v14, v3, Lea/c;->c:Landroid/hardware/camera2/CameraCharacteristics;

    invoke-static {v14, v12}, Lra/b0;->b(Landroid/hardware/camera2/CameraCharacteristics;Lra/e;)Ljava/lang/Object;
    ...
    new-instance v5, Ld1/p2;

    aget v8, v11, v6

    invoke-direct {v5, v8, v7}, Ld1/p2;-><init>(FLjava/util/ArrayList;)V
    ...
    :goto_c
    iput-object v11, v3, Lea/c;->c9:Ljava/util/HashMap;
    ...
    :goto_d
    iget-object v3, v3, Lea/c;->c9:Ljava/util/HashMap;
    ...
    iget-object v4, v0, Lcom/android/camera/data/data/c;->mCapabilities:Lea/c;

    invoke-static {v4}, Lea/d;->F1(Lea/c;)Z
    ...
    :cond_12
    iget v1, v1, Lcom/android/camera/data/data/c0;->b:I
    ...
    invoke-virtual {v1}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->d0()Ljava/lang/String;
    ...
    invoke-static {v1}, Ld1/p2;->a(F)Ljava/lang/String;
    ...
    iget-object v1, v0, Lcom/android/camera/data/data/c;->mCapabilities:Lea/c;
    ...
    iget-object v1, v1, Ld1/p2;->a:Ljava/lang/String;
    ...
    invoke-virtual {v1}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->E()Ljava/lang/String;
    ...
    iget-object v1, v1, Ld1/p2;->b:[Ljava/lang/String;
    ...
    invoke-virtual {v4, v7}, Ld1/z0;->getKey(I)Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v4, v7}, Ld1/z0;->k(Ljava/lang/String;)Z
    ...
    invoke-static {v4, v7}, Lkg/c;->h(FZ)F
    ...
    invoke-virtual {v1, v4, v2}, Ldh/a;->g(Ljava/lang/String;Z)Z
    ...
    iget-object v1, v4, Ld1/p2;->a:Ljava/lang/String;
    ...
    iget-object v1, v1, Lkg/a;->h:Ljava/util/ArrayList;
    ...
    iget-object v1, v1, Lkg/b;->h:Ljava/util/ArrayList;
    ...
    invoke-direct {v2, v3}, Ld1/c1;-><init>(I)V
...
.method public final g()Lea/c;
    .locals 0

    iget-object p0, p0, Lcom/android/camera/data/data/c;->mCapabilities:Lea/c;
...
.method public final h()I
    ...
    iget-object v1, p0, Lcom/android/camera/data/data/c;->mParentDataItem:Ldh/a;

    const-string v2, "pref_f_number_progress"

    invoke-virtual {v1, v2, v0}, Ldh/a;->i(Ljava/lang/String;I)I
...
.method public final k(I)V
    ...
    iget-object v0, p0, Lcom/android/camera/data/data/c;->mCapabilities:Lea/c;
    ...
    iget-object v1, p0, Lcom/android/camera/data/data/c;->mCapabilities:Lea/c;
    ...
    invoke-virtual {v2, p1}, Ld1/z0;->getKey(I)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v2, p1}, Ld1/z0;->k(Ljava/lang/String;)Z
    ...
    iget v5, v4, Lkg/b;->a:F

    iget v4, v4, Lkg/b;->b:F
    ...
    invoke-virtual {v4, v1}, Lkg/c;->g(F)F
    ...
    iget-object v0, p1, Lkg/b;->i:Ljava/util/HashMap;
    ...
    iget-object p1, p1, Lkg/b;->h:Ljava/util/ArrayList;
    ...
    invoke-static {p1, v2}, Lbk/j;->c(Ljava/lang/String;Z)Z
