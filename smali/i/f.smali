...
# direct methods
.method public static a(Li/j;Li/l;Lorg/w3c/dom/Node;Ljava/lang/String;Z)Li/l;
    .locals 7
    ...
    :cond_0
    invoke-virtual {v0, v1}, Li/o;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    invoke-virtual {v0, v1, v3}, Li/o;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p1, p0, Li/j;->a:Li/l;

    invoke-static {p1, v1, v4, v6}, Li/m;->e(Li/l;Ljava/lang/String;Ljava/lang/String;Z)Li/l;

    move-result-object p1

    iput-boolean v5, p1, Li/l;->g:Z

    monitor-enter v0

    :try_start_0
    iget-object v1, v0, Li/o;->c:Ljava/util/HashMap;
    ...
    iget-object p0, p0, Li/j;->a:Li/l;

    iput-boolean v6, p0, Li/l;->h:Z

    iput-boolean v6, p1, Li/l;->h:Z
    ...
    invoke-direct {v1, p2, p3, v3}, Li/l;-><init>(Ljava/lang/String;Ljava/lang/String;Lk/d;)V

    iput-boolean v5, v1, Li/l;->i:Z

    if-nez v0, :cond_4

    invoke-virtual {p1, v1}, Li/l;->a(Li/l;)V

    goto :goto_2

    :cond_4
    invoke-virtual {p1, v1}, Li/l;->b(Li/l;)V
    ...
    invoke-virtual {p2, p3}, Lk/b;->c(I)Z

    move-result p2

    if-eqz p2, :cond_5

    iput-boolean v6, p1, Li/l;->j:Z
    ...
    iput-object p0, v1, Li/l;->a:Ljava/lang/String;
...
.method public static b(Li/l;Ljava/lang/String;Ljava/lang/String;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lh/c;
    ...
    invoke-direct {v1, p1, p2, v0}, Li/l;-><init>(Ljava/lang/String;Ljava/lang/String;Lk/d;)V

    invoke-virtual {p0, v1}, Li/l;->c(Li/l;)V

    return-void
.end method

.method public static c(Li/l;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lh/c;
    ...
    invoke-virtual {p0, v0}, Li/l;->g(I)Li/l;

    move-result-object v1

    invoke-virtual {v1}, Li/l;->j()Lk/d;

    move-result-object v2

    invoke-virtual {v2}, Lk/d;->f()Z
    ...
    invoke-virtual {v1, v0}, Li/l;->k(I)Li/l;

    move-result-object v2

    invoke-virtual {v1, v2}, Li/l;->q(Li/l;)V

    invoke-virtual {p0, v2}, Li/l;->c(Li/l;)V
    ...
    :cond_1
    :goto_0
    iget-object v2, v1, Li/l;->e:Ljava/util/ArrayList;
    ...
    :cond_4
    iput-boolean v3, p0, Li/l;->j:Z

    invoke-virtual {p0}, Li/l;->j()Lk/d;

    move-result-object v0

    invoke-virtual {v0, v3}, Lk/d;->j(Z)V
    ...
    :goto_3
    iget-object v0, v1, Li/l;->b:Ljava/lang/String;

    iput-object v0, p0, Li/l;->b:Ljava/lang/String;

    const/4 v0, 0x0

    iput-object v0, p0, Li/l;->d:Ljava/util/ArrayList;

    invoke-virtual {v1}, Li/l;->o()Ljava/util/Iterator;
    ...
    invoke-virtual {p0, v1}, Li/l;->a(Li/l;)V
...
.method public static f(Li/j;Li/l;Lorg/w3c/dom/Node;Z)V
    .locals 16
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lh/c;
    ...
    invoke-static {v0, v8, v9, v4, v10}, Li/f;->a(Li/j;Li/l;Lorg/w3c/dom/Node;Ljava/lang/String;Z)Li/l;
    ...
    invoke-virtual {v8}, Li/l;->j()Lk/d;

    move-result-object v4

    const/4 v6, 0x1

    invoke-virtual {v4, v6}, Lk/d;->j(Z)V
    ...
    :cond_e
    iput-object v4, v8, Li/l;->b:Ljava/lang/String;
    ...
    invoke-virtual {v4, v15, v6}, Lk/b;->e(IZ)V
    ...
    invoke-static {v8, v6, v5}, Li/f;->b(Li/l;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v8, v14, v5}, Li/f;->b(Li/l;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v8, v5, v6, v7}, Li/f;->a(Li/j;Li/l;Lorg/w3c/dom/Node;Ljava/lang/String;Z)Li/l;
...
.method public static g(Li/j;Li/l;Lorg/w3c/dom/Node;Z)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lh/c;
    ...
    invoke-static {p0, p1, p2, v0, p3}, Li/f;->a(Li/j;Li/l;Lorg/w3c/dom/Node;Ljava/lang/String;Z)Li/l;
    ...
    invoke-static {p0, v5, v0}, Li/f;->b(Li/l;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p3}, La0/x3;->d(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :cond_6
    iput-object p3, p0, Li/l;->b:Ljava/lang/String;

    return-void
.end method

.method public static h(Li/j;Li/l;Lorg/w3c/dom/Node;Z)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lh/c;
    ...
    iget-object v5, p1, Li/l;->a:Ljava/lang/String;
    ...
    iput-object v4, p1, Li/l;->a:Ljava/lang/String;
    ...
    invoke-static {p0, p1, v4, v5, p3}, Li/f;->a(Li/j;Li/l;Lorg/w3c/dom/Node;Ljava/lang/String;Z)Li/l;
    ...
    :cond_c
    invoke-static {p0, p1, p2, p3}, Li/f;->i(Li/j;Li/l;Lorg/w3c/dom/Node;Z)V

    return-void
.end method

.method public static i(Li/j;Li/l;Lorg/w3c/dom/Node;Z)V
    .locals 16
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lh/c;
    ...
    invoke-static {v0, v1, v5, v2}, Li/f;->g(Li/j;Li/l;Lorg/w3c/dom/Node;Z)V
    ...
    invoke-static {v0, v1, v5, v14, v2}, Li/f;->a(Li/j;Li/l;Lorg/w3c/dom/Node;Ljava/lang/String;Z)Li/l;

    move-result-object v3

    invoke-virtual {v3}, Li/l;->j()Lk/d;

    move-result-object v7

    const/4 v8, 0x1

    invoke-virtual {v7, v8}, Lk/d;->j(Z)V
    ...
    invoke-static {v3, v10, v8}, Li/f;->b(Li/l;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v3, v5, v7}, Li/f;->i(Li/j;Li/l;Lorg/w3c/dom/Node;Z)V

    iget-boolean v5, v3, Li/l;->j:Z

    if-eqz v5, :cond_1a

    invoke-static {v3}, Li/f;->c(Li/l;)V
    ...
    :cond_18
    :goto_b
    invoke-static {v0, v1, v5, v2}, Li/f;->f(Li/j;Li/l;Lorg/w3c/dom/Node;Z)V
    ...
    invoke-static {v3, v10, v6}, Li/f;->b(Li/l;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v10, v9}, Lk/b;->e(IZ)V
    ...
    invoke-virtual {v8, v10, v14}, Lk/b;->e(IZ)V

    invoke-virtual {v8, v12, v14}, Lk/b;->e(IZ)V
    ...
    invoke-virtual {v8, v11, v14}, Lk/b;->e(IZ)V
    ...
    invoke-virtual {v10, v14}, Lk/d;->j(Z)V
    ...
    invoke-static {v3, v9, v8}, Li/f;->b(Li/l;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v3, v6, v10}, Li/f;->h(Li/j;Li/l;Lorg/w3c/dom/Node;Z)V

    iget-boolean v6, v3, Li/l;->j:Z
    ...
    invoke-virtual {v6, v8, v11}, Lk/b;->e(IZ)V

    invoke-static {v3}, Li/m;->h(Li/l;)V
