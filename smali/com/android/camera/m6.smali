.class public Lcom/android/camera/m6;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/camera/m6$c;,
        Lcom/android/camera/m6$b;
    }
.end annotation
...
.method public static b(Ljava/io/InputStream;[Lcom/android/camera/m6$c;)Lc/d;
    .locals 8

    const/4 v0, 0x0

    invoke-static {p0, v0}, Lcom/android/camera/m6;->g(Ljava/io/InputStream;Z)Ljava/util/List;
    ...
    check-cast v5, Lcom/android/camera/m6$b;

    iget-object v6, v5, Lcom/android/camera/m6$b;->c:[B

    invoke-static {v6}, Lcom/android/camera/m6;->e([B)Z

    move-result v6

    if-eqz v6, :cond_1

    iget-object v4, v5, Lcom/android/camera/m6$b;->c:[B

    invoke-static {v4}, Lcom/android/camera/m6;->d([B)I
    ...
    iget-object v5, v5, Lcom/android/camera/m6$b;->c:[B
    ...
    :cond_3
    invoke-static {p0, v4, p1}, Lcom/android/camera/m6;->c(Ljava/util/List;Lc/d;[Lcom/android/camera/m6$c;)V
...
.method public static c(Ljava/util/List;Lc/d;[Lcom/android/camera/m6$c;)V
    .locals 8
    ...
    invoke-interface {p1, v2, v3}, Lc/d;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v5, v5, Lcom/android/camera/m6$c;->a:Ljava/lang/String;
    ...
    iput v6, v5, Lcom/android/camera/m6$c;->b:I
    ...
    iput v6, v5, Lcom/android/camera/m6$c;->c:I
    ...
    check-cast p1, Lcom/android/camera/m6$b;

    iget v0, p1, Lcom/android/camera/m6$b;->a:I
    ...
    iget v3, v2, Lcom/android/camera/m6$c;->c:I

    new-array v3, v3, [B

    iput-object v3, v2, Lcom/android/camera/m6$c;->d:[B

    iget-object v4, p1, Lcom/android/camera/m6$b;->c:[B

    array-length v5, v4

    iget v2, v2, Lcom/android/camera/m6$c;->b:I
...
.method public static f(Ljava/util/List;Lc/d;)Ljava/util/List;
    ...
    new-instance p1, Lcom/android/camera/m6$b;

    invoke-direct {p1, v0}, Lcom/android/camera/m6$b;-><init>(Lcom/android/camera/m6$a;)V

    const/16 v0, 0xe1

    iput v0, p1, Lcom/android/camera/m6$b;->a:I

    add-int/lit8 v3, v3, 0x2

    iput v3, p1, Lcom/android/camera/m6$b;->b:I

    iput-object v5, p1, Lcom/android/camera/m6$b;->c:[B
    ...
    check-cast v4, Lcom/android/camera/m6$b;

    iget v4, v4, Lcom/android/camera/m6$b;->a:I
    ...
    iget-object v4, v4, Lcom/android/camera/m6$b;->c:[B

    invoke-static {v4}, Lcom/android/camera/m6;->e([B)Z
...
.method public static g(Ljava/io/InputStream;Z)Ljava/util/List;
    ...
    invoke-direct {p1, v2}, Lcom/android/camera/m6$b;-><init>(Lcom/android/camera/m6$a;)V

    iput v5, p1, Lcom/android/camera/m6$b;->a:I

    iput v6, p1, Lcom/android/camera/m6$b;->b:I
    ...
    iput-object v4, p1, Lcom/android/camera/m6$b;->c:[B
    ...
    :cond_8
    :goto_2
    new-instance v7, Lcom/android/camera/m6$b;

    invoke-direct {v7, v2}, Lcom/android/camera/m6$b;-><init>(Lcom/android/camera/m6$a;)V

    iput v5, v7, Lcom/android/camera/m6$b;->a:I

    iput v6, v7, Lcom/android/camera/m6$b;->b:I

    add-int/lit8 v6, v6, -0x2

    new-array v5, v6, [B

    iput-object v5, v7, Lcom/android/camera/m6$b;->c:[B
...
.method public static h(Ljava/io/OutputStream;Ljava/util/List;)V
    ...
    check-cast v1, Lcom/android/camera/m6$b;

    invoke-virtual {p0, v0}, Ljava/io/OutputStream;->write(I)V

    iget v2, v1, Lcom/android/camera/m6$b;->a:I

    invoke-virtual {p0, v2}, Ljava/io/OutputStream;->write(I)V

    iget v2, v1, Lcom/android/camera/m6$b;->b:I
    ...
    :cond_0
    iget-object v1, v1, Lcom/android/camera/m6$b;->c:[B
...
.method public static i(Ljava/io/InputStream;Ljava/io/OutputStream;Lc/d;)Z
    ...
    invoke-static {p0, p2}, Lcom/android/camera/m6;->f(Ljava/util/List;Lc/d;)Ljava/util/List;
    ...
    :cond_0
    :try_start_0
    invoke-static {p1, p0}, Lcom/android/camera/m6;->h(Ljava/io/OutputStream;Ljava/util/List;)V
    :try_end_0
