...
.method public static synthetic b(Lcom/android/camera/Camera$u;La7/g2;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/Camera$u;->d(La7/g2;)V
...
.method private synthetic d(La7/g2;)V
    .locals 0
    ...
    invoke-interface {p1, p0}, La7/g2;->o3(I)V
...
.method public final e(IIZI)V
    ...
    invoke-static {p1, v0}, Lcom/android/camera/g6;->c3(II)Z
    ...
    iget-object v1, v1, Lcom/android/camera/ActivityBase;->p0:Lcom/android/camera/ui/CameraRootView;

    const/16 v2, 0x7d0

    invoke-virtual {v0, v1, v2}, Lud/c;->k(Landroid/view/View;I)V
    ...
    iget-object p4, p3, Lcom/android/camera/ActivityBase;->d:Lcom/android/camera/module/b5;

    iget v0, p3, Lcom/android/camera/ActivityBase;->l:I
    ...
    iget-object p3, p1, Lcom/android/camera/ActivityBase;->i0:Lcom/android/camera/h5;

    if-eqz p3, :cond_3

    iget p1, p1, Lcom/android/camera/ActivityBase;->n:I

    invoke-virtual {p3, p1}, Lcom/android/camera/h5;->w(I)V
    ...
    invoke-virtual {p3, p1}, Lcom/android/camera/h5;->v(I)V

    :cond_3
    iget-object p1, p0, Lcom/android/camera/Camera$u;->a:Lcom/android/camera/Camera;

    invoke-static {p1}, Lcom/android/camera/Camera;->qj(Lcom/android/camera/Camera;)Lcom/android/camera/fragment/v;
    ...
    invoke-static {p1}, Lcom/android/camera/Camera;->rj(Lcom/android/camera/Camera;)Ls4/v;

    move-result-object p1

    invoke-virtual {p1}, Ls4/v;->b3()Z
    ...
    iget-object p1, p1, Lcom/android/camera/Camera;->Y0:Lcom/android/camera/ui/V9SuspendShutterButton;
    ...
    invoke-direct {p2, p0}, Lcom/android/camera/p2;-><init>(Lcom/android/camera/Camera$u;)V
    ...
    iget p2, p2, Lcom/android/camera/ActivityBase;->l:I
...
.method public onOrientationChanged(I)V
    ...
    iget v1, v0, Lcom/android/camera/ActivityBase;->l:I

    invoke-static {p1, v1}, Lcom/android/camera/g6;->i4(II)I

    move-result v2

    iput v2, v0, Lcom/android/camera/ActivityBase;->l:I
    ...
    iget v5, v5, Lcom/android/camera/ActivityBase;->l:I
    ...
    iget-object v6, v5, Lcom/android/camera/ActivityBase;->h0:Lcom/android/camera/ui/h1;
    ...
    invoke-static {v5}, Lcom/android/camera/Camera;->oj(Lcom/android/camera/Camera;)Z
    ...
    invoke-static {v5, v3}, Lcom/android/camera/Camera;->pj(Lcom/android/camera/Camera;Z)Z
    ...
    invoke-virtual {v2}, Lcom/android/camera/ActivityBase;->tc()I

    move-result v2

    iget-object v3, p0, Lcom/android/camera/Camera$u;->a:Lcom/android/camera/Camera;

    iget v5, v3, Lcom/android/camera/ActivityBase;->n:I
