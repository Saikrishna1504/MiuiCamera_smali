...
# interfaces
.implements Lcom/android/camera/c5$m;


# annotations
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/camera/Camera;->am()V
.end annotation
...
.method private synthetic d(I)V
    ...
    invoke-interface {p0, p1}, Lcom/android/camera/c5$m;->a(I)V
...
.method public a(I)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/camera/m2;-><init>(Lcom/android/camera/Camera$i;I)V
...
.method public b(I)V
    ...
    iget-object v0, v0, Lcom/android/camera/ActivityBase;->H0:Lcom/android/camera/display/manager/CamLayoutManager;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1}, Lcom/android/camera/c5$m;->b(I)V

    :cond_0
    invoke-static {p1}, Lcom/android/camera/g6;->z1(I)I
    ...
    iput p1, v0, Lcom/android/camera/ActivityBase;->l:I
    ...
    invoke-virtual {p1}, Lcom/android/camera/ActivityBase;->tc()I

    move-result p1

    iget-object v0, p0, Lcom/android/camera/Camera$i;->a:Lcom/android/camera/Camera;

    iget v1, v0, Lcom/android/camera/ActivityBase;->n:I

    if-eq p1, v1, :cond_1

    iput p1, v0, Lcom/android/camera/ActivityBase;->n:I

    :cond_1
    iget p1, v0, Lcom/android/camera/ActivityBase;->l:I
    ...
    iput v1, v0, Lcom/android/camera/ActivityBase;->m:I

    iget-object v0, v0, Lcom/android/camera/ActivityBase;->d:Lcom/android/camera/module/b5;
