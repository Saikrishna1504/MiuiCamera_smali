...
.method public a(Lh6/h;)V
    ...
    invoke-static {v0}, Lcom/android/camera/Camera;->kj(Lcom/android/camera/Camera;)Ljava/lang/String;
    ...
    invoke-static {v0, v4}, Lcom/android/camera/Camera;->zj(Lcom/android/camera/Camera;I)V

    iget-object v0, p0, Lcom/android/camera/Camera$g;->a:Lcom/android/camera/Camera;

    iput-object v3, v0, Lcom/android/camera/ActivityBase;->d:Lcom/android/camera/module/b5;

    iput-object v3, v0, Lcom/android/camera/ActivityBase;->e:Lz4/e;
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera/ActivityBase;->Uh(Z)V

    iget-object v0, p0, Lcom/android/camera/Camera$g;->a:Lcom/android/camera/Camera;

    iget-object v0, v0, Lcom/android/camera/ActivityBase;->h0:Lcom/android/camera/ui/h1;

    if-eqz v0, :cond_1

    invoke-interface {v0}, Lcom/android/camera/ui/h1;->V()V
    ...
    invoke-static {v0, v3}, Lcom/android/camera/Camera;->Aj(Lcom/android/camera/Camera;Lio/reactivex/disposables/Disposable;)Lio/reactivex/disposables/Disposable;
    ...
    invoke-interface {v0}, La7/b2;->init()V

    iget-object v0, p0, Lcom/android/camera/Camera$g;->a:Lcom/android/camera/Camera;

    iget-object v0, v0, Lcom/android/camera/ActivityBase;->w0:Landroid/os/Handler;
    ...
    invoke-static {v0}, Lcom/android/camera/Camera;->Bj(Lcom/android/camera/Camera;)Lp5/f;
    ...
    invoke-static {p0}, Lcom/android/camera/Camera;->kj(Lcom/android/camera/Camera;)Ljava/lang/String;
