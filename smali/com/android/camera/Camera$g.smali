...
.method public constructor <init>(Ljava/lang/ref/WeakReference;Ljava/lang/ref/WeakReference;)V
    ...
    iput-object p1, p0, Lcom/android/camera/Camera$g;->a:Ljava/lang/ref/WeakReference;

    iput-object p2, p0, Lcom/android/camera/Camera$g;->c:Ljava/lang/ref/WeakReference;
...
.method public final run()V
    ...
    iget-object v0, p0, Lcom/android/camera/Camera$g;->a:Ljava/lang/ref/WeakReference;
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/camera/Camera$g;->c:Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {v1, v2}, Lcom/android/camera/module/j0;->release(Z)V

    :cond_1
    sget-object v3, Lcom/android/camera/Camera;->Q1:Ljava/util/concurrent/atomic/AtomicBoolean;

    sget-object v3, Lig/a;->a:Ljava/util/Stack;

    new-instance v3, Ljava/util/Stack;

    invoke-direct {v3}, Ljava/util/Stack;-><init>()V

    sget-object v4, Lig/a;->a:Ljava/util/Stack;
    ...
    invoke-direct {v4, v5}, La0/z1;-><init>(I)V

    invoke-interface {v3, v4}, Ljava/util/stream/Stream;->anyMatch(Ljava/util/function/Predicate;)Z

    move-result v3

    iget-boolean v4, p0, Lcom/android/camera/Camera$g;->b:Z
    ...
    iget-object v2, v0, Lcom/android/camera/ActivityBase;->k0:Lg9/f;
    ...
    invoke-static {v4, v2}, La0/x;->l(ILjava/util/Optional;)V
    ...
    invoke-direct {v0, p0, v5}, La0/v2;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-interface {v1}, Lcom/android/camera/module/j0;->getHandler()Landroid/os/Handler;
    ...
    invoke-virtual {p0, v0}, Li7/i;->e(La0/v2;)V
    ...
    iget-object v0, v0, Lcom/android/camera/Camera;->m1:Lcom/android/camera/module/loader/base/StartControl;
    ...
    invoke-virtual {v1, v2}, Lea/a;->B1(Z)Lio/reactivex/Completable;

    move-result-object v0

    new-instance v1, La0/l4;

    invoke-direct {v1, p0}, La0/l4;-><init>(Lcom/android/camera/Camera$g;)V
