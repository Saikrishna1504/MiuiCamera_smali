...
# static fields
.field public static volatile l:Lcom/android/camera/g4;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object v0, p0, Lcom/android/camera/g4;->j:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/camera/g4;->k:Landroid/media/SoundPool$OnLoadCompleteListener;
    ...
    iput-object p1, p0, Lcom/android/camera/g4;->i:Landroid/media/AudioManager;
    ...
    invoke-virtual {p1}, Lbb/c;->L2()Z

    move-result p1

    iput-boolean p1, p0, Lcom/android/camera/g4;->g:Z

    .line 8
    iput-boolean p2, p0, Lcom/android/camera/g4;->h:Z
    ...
    .line 10
    iget-object v1, p0, Lcom/android/camera/g4;->k:Landroid/media/SoundPool$OnLoadCompleteListener;

    invoke-virtual {p0, v0, v0, v1}, Lcom/android/camera/g4;->k(IILandroid/media/SoundPool$OnLoadCompleteListener;)Landroid/media/SoundPool;
    ...
    .line 11
    iget-object p2, p0, Lcom/android/camera/g4;->k:Landroid/media/SoundPool$OnLoadCompleteListener;

    const/16 v0, 0x14

    invoke-virtual {p0, v0, p1, p2}, Lcom/android/camera/g4;->k(IILandroid/media/SoundPool$OnLoadCompleteListener;)Landroid/media/SoundPool;
...
.method public static synthetic a(Lcom/android/camera/g4;Lio/reactivex/CompletableEmitter;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/g4;->m(Lio/reactivex/CompletableEmitter;)V
...
.method public static synthetic b(Landroid/content/Context;I)V
    ...
    invoke-static {p0, p1}, Lcom/android/camera/g4;->l(Landroid/content/Context;I)V

    return-void
.end method

.method public static synthetic d(Lcom/android/camera/g4;Lio/reactivex/FlowableEmitter;)Lio/reactivex/FlowableEmitter;
    .locals 0

    iput-object p1, p0, Lcom/android/camera/g4;->f:Lio/reactivex/FlowableEmitter;

    return-object p1
.end method

.method public static synthetic e(Lcom/android/camera/g4;)I
    .locals 0
...
.method public static synthetic f(Lcom/android/camera/g4;I)I
    .locals 0
...
.method public static synthetic g(Lcom/android/camera/g4;)Ljava/util/ArrayList;
    .locals 0

    iget-object p0, p0, Lcom/android/camera/g4;->j:Ljava/util/ArrayList;
...
.method public static j(Landroid/content/Context;)Lcom/android/camera/g4;
    .locals 2

    sget-object v0, Lcom/android/camera/g4;->l:Lcom/android/camera/g4;
    ...
    :try_start_0
    sget-object v1, Lcom/android/camera/g4;->l:Lcom/android/camera/g4;
    ...
    sput-object v1, Lcom/android/camera/g4;->l:Lcom/android/camera/g4;
    ...
    :cond_1
    :goto_0
    sget-object p0, Lcom/android/camera/g4;->l:Lcom/android/camera/g4;
...
.method public static synthetic l(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/g4;->n(I)V
...
.method private synthetic m(Lio/reactivex/CompletableEmitter;)V
    ...
    iget-object v2, p0, Lcom/android/camera/g4;->a:Landroid/media/SoundPool;
...
.method public static s(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/g4;->u(I)V
...
.method public static t(Landroid/content/Context;IF)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/camera/g4;->v(IF)V
...
.method public static y(Landroid/content/Context;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/g4;->z()V
...
.method public bridge synthetic accept(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/g4;->c(Lcom/android/camera/g4$e;)V

    return-void
.end method

.method public c(Lcom/android/camera/g4$e;)V
    .locals 6
    ...
    invoke-virtual {p0, v0, v3, v5}, Lcom/android/camera/g4;->w(IFI)V
...
.method public i()V
    ...
    iget-boolean v1, p0, Lcom/android/camera/g4;->g:Z
...
.method public final k(IILandroid/media/SoundPool$OnLoadCompleteListener;)Landroid/media/SoundPool;
    ...
    invoke-static {p1, p2}, Lif/a;->a(Landroid/media/AudioAttributes$Builder;I)Landroid/media/AudioAttributes$Builder;
...
.method public declared-synchronized n(I)V
    ...
    :cond_0
    :try_start_1
    invoke-virtual {p0, p1}, Lcom/android/camera/g4;->q(I)Z
...
.method public final q(I)Z
    ...
    :cond_0
    iget-boolean p0, p0, Lcom/android/camera/g4;->g:Z
...
.method public final declared-synchronized r(ILandroid/media/SoundPool;FI)V
    ...
    iget-object v6, p0, Lcom/android/camera/g4;->j:Ljava/util/ArrayList;
...
.method public u(I)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/camera/g4;->v(IF)V
...
.method public v(IF)V
    ...
    iget-object v0, p0, Lcom/android/camera/g4;->f:Lio/reactivex/FlowableEmitter;
    ...
    iget-object p0, p0, Lcom/android/camera/g4;->f:Lio/reactivex/FlowableEmitter;
...
.method public final w(IFI)V
    ...
    iget-boolean v0, p0, Lcom/android/camera/g4;->h:Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/camera/g4;->i:Landroid/media/AudioManager;
    ...
    invoke-virtual {p0, p1, v0, p2, p3}, Lcom/android/camera/g4;->r(ILandroid/media/SoundPool;FI)V
...
.method public x()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/camera/g4;->e:Lio/reactivex/disposables/Disposable;
    ...
    iput-object v1, p0, Lcom/android/camera/g4;->e:Lio/reactivex/disposables/Disposable;
...
.method public z()V
    ...
    invoke-direct {v0, p0}, Lcom/android/camera/e4;-><init>(Lcom/android/camera/g4;)V
    ...
    iput-object v0, p0, Lcom/android/camera/g4;->e:Lio/reactivex/disposables/Disposable;
