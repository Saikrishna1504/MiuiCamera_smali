...
.field public final synthetic h:Lcom/android/camera/y3;
...
.method public constructor <init>(Lcom/android/camera/y3;)V
    ...
    iput-object p1, p0, Lcom/android/camera/y3$b;->h:Lcom/android/camera/y3;
    ...
    iput-object p1, p0, Lcom/android/camera/y3$b;->f:Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/android/camera/y3$b;->Q()V
...
.method public static synthetic b(Lcom/android/camera/y3$b;Lud/d0;)V
    .locals 0

    invoke-virtual {p0, p1}, Lcom/android/camera/y3$b;->A(Lud/d0;)V

    return-void
.end method

.method public static synthetic c(Lcom/android/camera/y3$b;)V
    .locals 0

    invoke-virtual {p0}, Lcom/android/camera/y3$b;->D()V

    return-void
.end method

.method public static synthetic d(Lcom/android/camera/y3$b;J)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lcom/android/camera/y3$b;->E(J)V
...
# virtual methods
.method public final A(Lud/d0;)V
    .locals 3
...
.method public B(Lcom/xiaomi/engine/PreProcessData;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/y3$b;->j()Lud/d0;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Lud/d0;->j0()Lud/d0$h;

    move-result-object p0

    invoke-virtual {p0, p1}, Lud/d0$h;->f(Lcom/xiaomi/engine/PreProcessData;)V
...
.method public C()V
    ...
    invoke-virtual {p0}, Lud/d0$h;->g()V
...
.method public final E(J)V
    ...
    invoke-virtual {v0, p1, p2}, Lud/d0;->J0(J)Z
...
.method public I(Lr7/h;)V
    ...
    invoke-virtual {p0, p1}, Lud/d0;->S0(Lr7/h;)V
...
.method public J(Lcom/android/camera/y3$c;)V
    .locals 1

    iget-object p0, p0, Lcom/android/camera/y3$b;->h:Lcom/android/camera/y3;

    new-instance v0, Ljava/lang/ref/WeakReference;

    invoke-direct {v0, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    invoke-static {p0, v0}, Lcom/android/camera/y3;->b(Lcom/android/camera/y3;Ljava/lang/ref/WeakReference;)Ljava/lang/ref/WeakReference;
...
.method public K(Lcom/xiaomi/protocol/ISessionStatusCallBackListener;)V
    ...
    invoke-virtual {p0, p1}, Lud/d0;->U0(Lcom/xiaomi/protocol/ISessionStatusCallBackListener;)V
...
.method public M(Lud/j;)V
    ...
    invoke-virtual {p0, p1}, Lud/d0;->W0(Lud/j;)V
...
.method public N(Z)V
    ...
    iget-object v0, p0, Lcom/android/camera/y3$b;->h:Lcom/android/camera/y3;

    invoke-static {v0, p1}, Lcom/android/camera/y3;->g(Lcom/android/camera/y3;Z)Z
    ...
    invoke-virtual {p0, p1}, Lud/d0;->X0(Z)V
...
.method public Q()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/camera/y3$b;->R(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final e()V
    ...
    iget-object v0, p0, Lcom/android/camera/y3$b;->f:Ljava/lang/Object;

    monitor-enter v0

    :goto_0
    :try_start_0
    iget-boolean v1, p0, Lcom/android/camera/y3$b;->g:Z
    ...
    :try_start_1
    iget-object v1, p0, Lcom/android/camera/y3$b;->f:Ljava/lang/Object;
...
.method public f(Landroid/util/SparseArray;II)Landroid/util/SparseArray;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/camera/y3$b;->e:Landroid/util/SparseArray;
    ...
    iget-object v0, p0, Lcom/android/camera/y3$b;->d:Lud/d0;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lud/d0;->Q()Z
    ...
    iget-object v3, p0, Lcom/android/camera/y3$b;->d:Lud/d0;
    ...
    iget-object p1, p0, Lcom/android/camera/y3$b;->d:Lud/d0;

    invoke-virtual {p1, p2}, Lud/d0;->V0(I)V

    iget-object p1, p0, Lcom/android/camera/y3$b;->d:Lud/d0;

    invoke-virtual {p1, p3}, Lud/d0;->R0(I)V

    iget-object p1, p0, Lcom/android/camera/y3$b;->d:Lud/d0;

    invoke-virtual {p1}, Lud/d0;->q0()Landroid/util/SparseArray;
    ...
    check-cast v3, Lud/d0;

    invoke-virtual {v3}, Lud/d0;->A0()Z
    ...
    :cond_1
    invoke-virtual {v3}, Lud/d0;->q0()Landroid/util/SparseArray;
    ...
    invoke-virtual {v3, p2}, Lud/d0;->V0(I)V

    invoke-virtual {v3, p3}, Lud/d0;->R0(I)V
    ...
    :cond_2
    iput-object p1, p0, Lcom/android/camera/y3$b;->e:Landroid/util/SparseArray;

    iput-object v3, p0, Lcom/android/camera/y3$b;->d:Lud/d0;
    ...
    invoke-virtual {p0}, Lcom/android/camera/y3$b;->q()Lud/d0;

    move-result-object v1

    invoke-virtual {v1, p2}, Lud/d0;->V0(I)V

    invoke-virtual {v1, p3}, Lud/d0;->R0(I)V
    ...
    iget-object p2, p0, Lcom/android/camera/y3$b;->d:Lud/d0;
    ...
    iput-object v1, p0, Lcom/android/camera/y3$b;->d:Lud/d0;

    invoke-virtual {v1, p1}, Lud/d0;->Y(Landroid/util/SparseArray;)Landroid/util/SparseArray;
...
.method public g(Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-virtual {v3, v4, v5}, Lud/c;->h(II)Z

    invoke-virtual {p0, p1}, Lud/d0;->W(Lcom/xiaomi/engine/BufferFormat;)V
...
.method public h(I)V
    ...
    invoke-static {v0, p1}, Lcom/android/camera/y3;->e(Lcom/android/camera/y3;I)I
    ...
    invoke-static {p0}, Lcom/android/camera/y3;->d(Lcom/android/camera/y3;)I

    move-result p0

    invoke-virtual {p1, p0}, Lud/d0;->T0(I)V
...
.method public final m(I)Ljava/util/List;
    ...
    check-cast v2, Lud/d0;

    invoke-virtual {v2}, Lud/d0;->i0()I
...
.method public final p()V
    ...
    iput-boolean v1, p0, Lcom/android/camera/y3$b;->g:Z

    iget-object p0, p0, Lcom/android/camera/y3$b;->f:Ljava/lang/Object;
...
.method public final q()Lud/d0;
    ...
    iget-object v2, p0, Lcom/android/camera/y3$b;->h:Lcom/android/camera/y3;

    invoke-static {v2}, Lcom/android/camera/y3;->h(Lcom/android/camera/y3;)Lud/d0$j;

    move-result-object v2

    invoke-direct {v0, v1, v2}, Lud/d0;-><init>(Landroid/content/Context;Lud/d0$j;)V

    iget-object v1, p0, Lcom/android/camera/y3$b;->h:Lcom/android/camera/y3;

    invoke-static {v1}, Lcom/android/camera/y3;->d(Lcom/android/camera/y3;)I

    move-result v1

    invoke-virtual {v0, v1}, Lud/d0;->T0(I)V

    iget-object v1, p0, Lcom/android/camera/y3$b;->h:Lcom/android/camera/y3;

    invoke-static {v1}, Lcom/android/camera/y3;->f(Lcom/android/camera/y3;)Z

    move-result v1

    invoke-virtual {v0, v1}, Lud/d0;->X0(Z)V
    ...
    invoke-static {v2}, Lcom/android/camera/y3;->d(Lcom/android/camera/y3;)I
    ...
    invoke-static {p0}, Lcom/android/camera/y3;->f(Lcom/android/camera/y3;)Z
...
.method public v()Z
    ...
    invoke-virtual {p0}, Lud/d0;->H0()Z

    move-result v1

    if-nez v1, :cond_0

    invoke-virtual {p0}, Lud/d0;->G0()Z
...
.method public x(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    invoke-virtual {p0, p1, p2}, Lud/d0$h;->c(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
...
.method public y(JI)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lud/d0$h;->d(JI)V
...
.method public z(Lud/w;)V
    ...
    invoke-virtual {p0, p1}, Lud/d0$h;->e(Lud/w;)V
