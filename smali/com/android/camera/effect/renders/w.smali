...
.method public constructor <init>(Lta/g;)V
    ...
    invoke-direct {v2, p1}, Lcom/android/camera/effect/renders/k;-><init>(Lta/g;)V

    new-instance v3, Lcom/android/camera/effect/renders/t;

    invoke-direct {v3, p1}, Lcom/android/camera/effect/renders/t;-><init>(Lta/g;)V
    ...
    invoke-virtual {v6}, Lcom/android/camera/effect/r;->isKaleidoscopeEnable()Z
    ...
    invoke-virtual {v7}, Lcom/android/camera/effect/r;->isCinematicEnable()Z
    ...
    iget-object v6, p0, Lcom/android/camera/effect/renders/o;->mGLCanvas:Lta/g;

    invoke-virtual {v0, v6, v8}, Lcom/android/camera/effect/r;->getEffectGroup(Lta/g;I)Lcom/android/camera/effect/renders/p;
    ...
    iget-object v1, p0, Lcom/android/camera/effect/renders/o;->mGLCanvas:Lta/g;

    check-cast v1, Lta/a;

    iget-object v1, v1, Lta/a;->a:Lcom/android/camera/effect/renders/p;
    ...
    invoke-virtual {v1, v6, v3}, Lcom/android/camera/effect/r;->getEffectGroup(Lta/g;I)Lcom/android/camera/effect/renders/p;
    ...
    iget-object v3, v3, Lta/a;->a:Lcom/android/camera/effect/renders/p;
    ...
    invoke-virtual {v3, v6, v4}, Lcom/android/camera/effect/r;->getEffectGroup(Lta/g;I)Lcom/android/camera/effect/renders/p;
    ...
    invoke-virtual {v4}, Lcom/android/camera/effect/r;->getCurrentKaleidoscope()Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/camera/effect/renders/o;->mGLCanvas:Lta/g;

    check-cast v4, Lta/a;

    iget-object v4, v4, Lta/a;->a:Lcom/android/camera/effect/renders/p;
    ...
    iget-object v7, p0, Lcom/android/camera/effect/renders/o;->mGLCanvas:Lta/g;

    invoke-virtual {v4, v7, v6}, Lcom/android/camera/effect/r;->getEffectGroup(Lta/g;I)Lcom/android/camera/effect/renders/p;
    ...
    invoke-direct {v0, p1}, Lcom/android/camera/effect/renders/b;-><init>(Lta/g;)V
    ...
    invoke-direct {p1, v0}, Lcom/android/camera/effect/renders/e0;-><init>(Lta/g;)V
    ...
    invoke-direct {p1, v0}, Lsl/a;-><init>(Lta/g;)V
...
.method public final draw(Lr2/b;)Z
    ...
    invoke-direct {v7, v2, v3, v8}, Lu2/a;-><init>(III)V
    ...
    :cond_2
    iput-object v7, v0, Lcom/android/camera/effect/renders/j;->e:Lu2/a;

    :cond_3
    monitor-enter p0

    :try_start_0
    invoke-super {p0, p1}, Lcom/android/camera/effect/renders/p;->draw(Lr2/b;)Z
...
.method public final j()Lcom/android/camera/effect/renders/j;
    ...
    invoke-direct {v0, v1}, Lcom/android/camera/effect/renders/j;-><init>(Lta/g;)V
