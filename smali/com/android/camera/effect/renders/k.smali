...
.method public constructor <init>(Lta/g;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lcom/android/camera/effect/renders/p;-><init>(Lta/g;)V
    ...
    iput-object p1, p0, Lcom/android/camera/effect/renders/k;->g:Lr2/e;
    ...
    iput-object p1, p0, Lcom/android/camera/effect/renders/k;->h:Lr2/c;
...
.method public constructor <init>(Lta/g;ILcom/android/camera/effect/renders/o;Lcom/android/camera/effect/renders/o;)V
    .locals 0

    .line 24
    invoke-direct {p0, p1, p2}, Lcom/android/camera/effect/renders/p;-><init>(Lta/g;I)V
...
.method public constructor <init>(Lta/g;Lcom/android/camera/effect/renders/o;Lcom/android/camera/effect/renders/o;)V
    .locals 1
...
.method public static k(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    invoke-static {p0}, La0/x3;->d(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v7, p2, p3, p1}, Lck/b;->b(Ljava/nio/ByteBuffer;IILandroid/graphics/ColorSpace;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p0, p2, p3, v0}, Lck/b;->j(Landroid/graphics/Bitmap;Ljava/lang/String;ILandroid/graphics/Bitmap$CompressFormat;I)Z
...
.method public final deleteBuffer()V
    ...
    iget-object v0, p0, Lcom/android/camera/effect/renders/k;->n:Lu2/c;
    ...
    iput-object v1, p0, Lcom/android/camera/effect/renders/k;->n:Lu2/c;
    ...
    iput-object v1, p0, Lcom/android/camera/effect/renders/k;->e:Lu2/c;

    iput-object v1, p0, Lcom/android/camera/effect/renders/k;->f:Lu2/c;

    return-void
.end method

.method public final draw(Lr2/b;)Z
    .locals 18
    ...
    iget-object v7, v0, Lcom/android/camera/effect/renders/k;->h:Lr2/c;
    ...
    invoke-static {v13, v5}, Lv2/b;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v5, v14}, Lcom/android/camera/effect/renders/k;->l(II)Lu2/c;

    move-result-object v5

    iput-object v5, v0, Lcom/android/camera/effect/renders/k;->e:Lu2/c;

    invoke-virtual {v0, v5}, Lcom/android/camera/effect/renders/p;->b(Lu2/d;)V

    iget-object v5, v0, Lcom/android/camera/effect/renders/k;->g:Lr2/e;

    iget-object v14, v2, Lr2/e;->d:Lta/f;

    iget-object v15, v2, Lr2/e;->c:[F

    new-instance v3, Landroid/graphics/Rect;

    iget-object v4, v0, Lcom/android/camera/effect/renders/k;->e:Lu2/c;

    iget-object v4, v4, Lu2/c;->b:Lta/j;

    move-object/from16 v16, v9

    iget v9, v4, Lta/b;->c:I

    iget v4, v4, Lta/b;->d:I
    ...
    invoke-virtual {v5, v14, v15, v3}, Lr2/e;->a(Lta/f;[FLandroid/graphics/Rect;)V

    iget-object v3, v2, Lr2/e;->g:Lso/a;

    iput-object v3, v5, Lr2/e;->g:Lso/a;

    iget-object v3, v0, Lcom/android/camera/effect/renders/k;->i:Lcom/android/camera/effect/renders/o;

    invoke-virtual {v3, v5}, Lcom/android/camera/effect/renders/o;->draw(Lr2/b;)Z

    if-eqz v6, :cond_2

    const/4 v3, 0x1

    invoke-virtual {v0, v1, v3}, Lcom/android/camera/effect/renders/k;->j(Lr2/b;Z)V
    ...
    invoke-static {v13, v1}, Lv2/b;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v3, v0, Lcom/android/camera/effect/renders/k;->e:Lu2/c;

    iget-object v4, v3, Lu2/c;->a:[I

    const/4 v6, 0x0

    aget v4, v4, v6

    iget-object v3, v3, Lu2/c;->b:Lta/j;

    iget v6, v3, Lta/b;->c:I
    ...
    invoke-virtual {v0, v1, v3}, Lcom/android/camera/effect/renders/k;->l(II)Lu2/c;

    move-result-object v1

    iput-object v1, v0, Lcom/android/camera/effect/renders/k;->f:Lu2/c;

    invoke-virtual {v0, v1}, Lcom/android/camera/effect/renders/p;->b(Lu2/d;)V

    iget-object v1, v0, Lcom/android/camera/effect/renders/k;->i:Lcom/android/camera/effect/renders/o;

    iget-object v3, v2, Lr2/e;->d:Lta/f;

    iget-object v4, v2, Lr2/e;->c:[F
    ...
    invoke-virtual {v5, v3, v4, v6}, Lr2/e;->a(Lta/f;[FLandroid/graphics/Rect;)V

    invoke-virtual {v1, v5}, Lcom/android/camera/effect/renders/o;->draw(Lr2/b;)Z
    ...
    invoke-virtual {v1}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->o2()Z
    ...
    invoke-virtual {v1}, Lcom/android/camera/effect/r;->isBackGroundBlur()Z
    ...
    iget-object v1, v0, Lcom/android/camera/effect/renders/k;->n:Lu2/c;

    if-eqz v1, :cond_6

    iget-object v1, v1, Lu2/c;->b:Lta/j;

    iget v1, v1, Lta/b;->c:I

    iget-object v3, v2, Lr2/n;->b:Landroid/graphics/Rect;
    ...
    iget-object v3, v0, Lcom/android/camera/effect/renders/o;->mGLCanvas:Lta/g;

    iget-object v4, v2, Lr2/n;->b:Landroid/graphics/Rect;

    invoke-virtual {v4}, Landroid/graphics/Rect;->width()I

    move-result v4

    iget-object v5, v2, Lr2/n;->b:Landroid/graphics/Rect;
    ...
    invoke-direct {v1, v3, v4, v5, v6}, Lu2/c;-><init>(Lta/g;III)V

    iput-object v1, v0, Lcom/android/camera/effect/renders/k;->n:Lu2/c;
    ...
    iget-object v3, v0, Lcom/android/camera/effect/renders/k;->f:Lu2/c;
    ...
    iget-object v5, v7, Lr2/n;->b:Landroid/graphics/Rect;

    invoke-virtual {v5, v4}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iput-object v3, v7, Lr2/c;->c:Lta/b;

    const/4 v3, 0x0

    iput-boolean v3, v7, Lr2/c;->d:Z

    invoke-virtual {v1, v7}, Lcom/android/camera/effect/renders/o;->draw(Lr2/b;)Z
    ...
    iget-object v1, v0, Lcom/android/camera/effect/renders/o;->mGLCanvas:Lta/g;

    new-instance v3, Lr2/c;

    iget-object v0, v0, Lcom/android/camera/effect/renders/k;->n:Lu2/c;

    iget-object v0, v0, Lu2/c;->b:Lta/j;

    iget-object v2, v2, Lr2/n;->b:Landroid/graphics/Rect;

    invoke-direct {v3, v0, v2}, Lr2/c;-><init>(Lta/b;Landroid/graphics/Rect;)V

    invoke-interface {v1, v3}, Lta/g;->a(Lr2/b;)V

    const-string v0, "after drawBlurTexture draw"

    invoke-static {v13, v0}, Lv2/b;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v13, v2}, Lv2/b;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v6, v1, Lr2/g;->b:Landroid/graphics/Rect;

    invoke-virtual {v6}, Landroid/graphics/Rect;->height()I

    move-result v6

    invoke-virtual {v0, v2, v6}, Lcom/android/camera/effect/renders/k;->l(II)Lu2/c;

    move-result-object v2

    iput-object v2, v0, Lcom/android/camera/effect/renders/k;->e:Lu2/c;

    invoke-virtual {v0, v2}, Lcom/android/camera/effect/renders/p;->b(Lu2/d;)V

    iget-object v2, v0, Lcom/android/camera/effect/renders/k;->i:Lcom/android/camera/effect/renders/o;

    new-instance v6, Lr2/g;

    iget v8, v1, Lr2/g;->c:I

    iget v9, v0, Lcom/android/camera/effect/renders/o;->mParentFrameBufferId:I

    iget-object v10, v0, Lcom/android/camera/effect/renders/k;->e:Lu2/c;

    iget-object v10, v10, Lu2/c;->b:Lta/j;

    iget v12, v10, Lta/b;->c:I

    iget v10, v10, Lta/b;->d:I

    invoke-static {v12, v10}, Lfk/e;->l(II)Landroid/graphics/Rect;

    move-result-object v10

    iget-boolean v12, v1, Lr2/g;->d:Z

    invoke-direct {v6, v8, v9, v10, v12}, Lr2/g;-><init>(IILandroid/graphics/Rect;Z)V

    invoke-virtual {v2, v6}, Lcom/android/camera/effect/renders/o;->draw(Lr2/b;)Z
    ...
    iget-object v6, v0, Lcom/android/camera/effect/renders/k;->e:Lu2/c;

    iget-object v8, v6, Lu2/c;->a:[I

    const/4 v9, 0x0

    aget v8, v8, v9

    iget-object v6, v6, Lu2/c;->b:Lta/j;

    iget v9, v6, Lta/b;->c:I

    iget v6, v6, Lta/b;->d:I
    ...
    iget-boolean v1, v1, Lr2/g;->d:Z

    iget-object v8, v7, Lr2/n;->b:Landroid/graphics/Rect;

    invoke-virtual {v8, v6}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iput-object v3, v7, Lr2/c;->c:Lta/b;

    iput-boolean v1, v7, Lr2/c;->d:Z

    invoke-virtual {v2, v7}, Lcom/android/camera/effect/renders/o;->draw(Lr2/b;)Z
    ...
    iget-object v5, v1, Lr2/n;->b:Landroid/graphics/Rect;
    ...
    iget-object v6, v1, Lr2/c;->c:Lta/b;

    iget v8, v0, Lcom/android/camera/effect/renders/o;->mParentFrameBufferId:I

    iget-object v9, v0, Lcom/android/camera/effect/renders/k;->e:Lu2/c;

    iget-object v9, v9, Lu2/c;->b:Lta/j;

    iget v10, v9, Lta/b;->c:I

    iget v9, v9, Lta/b;->d:I

    invoke-static {v10, v9}, Lfk/e;->l(II)Landroid/graphics/Rect;

    move-result-object v9

    iget-object v10, v7, Lr2/n;->b:Landroid/graphics/Rect;

    invoke-virtual {v10, v9}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iput-object v6, v7, Lr2/c;->c:Lta/b;

    iput v8, v7, Lr2/c;->g:I

    const/4 v6, 0x0

    iput-boolean v6, v7, Lr2/c;->d:Z
    ...
    iget-object v6, v7, Lr2/n;->b:Landroid/graphics/Rect;
    ...
    invoke-virtual {v2, v1}, Lcom/android/camera/effect/renders/o;->draw(Lr2/b;)Z
...
.method public final j(Lr2/b;Z)V
    .locals 7
    .annotation build Lcom/android/camera/jacoco/JacocoForceIgnore;
    .end annotation
    ...
    iget-object v2, p1, Lr2/e;->d:Lta/f;

    iget-object p1, p1, Lr2/e;->c:[F
    ...
    invoke-direct {p2, v2, p1, v3}, Lr2/e;-><init>(Lta/f;[FLandroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, p1, v2}, Lcom/android/camera/effect/renders/k;->l(II)Lu2/c;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/p;->b(Lu2/d;)V

    invoke-virtual {p0}, Lcom/android/camera/effect/renders/p;->g()Lcom/android/camera/effect/renders/o;

    move-result-object p1

    invoke-virtual {p1, p2}, Lcom/android/camera/effect/renders/o;->draw(Lr2/b;)Z
...
.method public final l(II)Lu2/c;
    .locals 11
    ...
    :cond_1
    invoke-static {v3}, Lta/p;->a(I)I

    move-result v3

    invoke-static {p1}, Lta/p;->a(I)I

    move-result v5

    if-ne v3, v5, :cond_2

    invoke-static {v4}, Lta/p;->a(I)I

    move-result v3

    invoke-static {p2}, Lta/p;->a(I)I
    ...
    iget-object v3, p0, Lcom/android/camera/effect/renders/o;->mGLCanvas:Lta/g;

    iget p0, p0, Lcom/android/camera/effect/renders/o;->mParentFrameBufferId:I

    invoke-direct {v1, v3, p1, p2, p0}, Lu2/c;-><init>(Lta/g;III)V
