...
.method public constructor <init>(Lta/g;ILx2/c;Landroid/app/Application;)V
    .locals 0
    ...
    iput-object p3, p0, Lcom/android/camera/effect/renders/x;->c:Lx2/f;

    if-eqz p3, :cond_0

    iget-boolean p1, p3, Lx2/f;->h:Z

    if-nez p1, :cond_0

    invoke-virtual {p3, p4}, Lx2/f;->a(Landroid/content/Context;)V
...
.method public final checkRenderRect(Landroid/graphics/Rect;)V
    ...
    iget-object v8, v0, Lcom/android/camera/effect/v;->e:[F
...
.method public final destroy()V
    ...
    iget-object v1, p0, Lcom/android/camera/effect/renders/x;->c:Lx2/f;

    if-eqz v1, :cond_0

    iget-boolean v2, v1, Lx2/f;->h:Z

    if-eqz v2, :cond_0

    iput-boolean v0, v1, Lx2/f;->h:Z

    iget v2, v1, Lx2/f;->d:I

    const-string v3, "GPUImageFilter"

    invoke-static {v2, v3}, Lcom/xiaomi/gl/MIGL;->glDeleteProgram(ILjava/lang/String;)V

    iput v0, v1, Lx2/f;->d:I

    check-cast v1, Lx2/c;

    iget v2, v1, Lx2/c;->p:I
...
.method public final draw(Lr2/b;)Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/camera/effect/renders/x;->c:Lx2/f;
    ...
    iget v1, p1, Lr2/g;->c:I

    iget-object p1, p1, Lr2/g;->b:Landroid/graphics/Rect;

    sget-object v3, Leg/b;->a:Landroid/content/Context;
    ...
    invoke-virtual {v0, v1, p1, p0, v3}, Lx2/f;->b(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)V
    ...
    iget-object v1, p1, Lr2/c;->c:Lta/b;
    ...
    :cond_5
    iget-object v5, p0, Lcom/android/camera/effect/renders/o;->mGLCanvas:Lta/g;

    invoke-virtual {v1, v5}, Lta/b;->f(Lta/g;)Z
    ...
    :cond_6
    invoke-virtual {p0, v1, v4}, Lcom/android/camera/effect/renders/s;->bindTexture(Lta/b;I)Z
    ...
    invoke-virtual {v0, p1, v1, p0, v3}, Lx2/f;->b(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)V
...
.method public final setViewportSize(II)V
    ...
    iget-object p0, p0, Lcom/android/camera/effect/renders/x;->c:Lx2/f;
