...
.method public final draw(Lr2/b;)Z
    ...
    iget-object v2, v1, Lr2/a;->e:Lcp/b;

    if-eqz v2, :cond_11

    iget-object v5, v2, Lcp/b;->c:Lcp/b$a;

    iget-object v14, v5, Lcp/b$a;->a:Ljava/nio/ByteBuffer;

    iget-object v15, v5, Lcp/b$a;->b:Ljava/nio/ByteBuffer;

    iget-object v5, v5, Lcp/b$a;->c:Ljava/nio/ByteBuffer;

    iget v13, v2, Lcp/b;->a:I

    iget v2, v2, Lcp/b;->b:I
    ...
    iget v5, v1, Lr2/a;->c:I

    int-to-float v5, v5

    iget v6, v1, Lr2/a;->d:I

    int-to-float v6, v6

    iget-object v7, v1, Lr2/a;->f:Landroid/util/Size;
    ...
    iget-object v8, v1, Lr2/a;->f:Landroid/util/Size;
    ...
    invoke-virtual {v9, v5, v6}, Lcom/android/camera/effect/v;->g(FF)V
    ...
    invoke-virtual {v5, v7, v8}, Lcom/android/camera/effect/v;->f(FF)V
    ...
    invoke-static {v1}, Lea/d;->p0(Lea/c;)I
