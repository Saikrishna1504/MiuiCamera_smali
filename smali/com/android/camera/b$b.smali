...
.method public static j(Landroid/util/SparseArray;Landroid/util/SparseArray;)Z
    ...
    invoke-virtual {v4, v3}, Lna/e;->equals(Ljava/lang/Object;)Z
...
.method public final a(Landroid/util/SparseArray;II)Landroid/util/SparseArray;
    ...
    iget-object v0, p0, Lcom/android/camera/b$b;->b:Lyg/t;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lyg/t;->k()Z
    ...
    iget-object v3, p0, Lcom/android/camera/b$b;->b:Lyg/t;
    ...
    iget-object p1, p0, Lcom/android/camera/b$b;->b:Lyg/t;

    iget-object v0, p1, Lyg/t;->j:Ljava/lang/Object;
    ...
    iget-object p2, p1, Lyg/t;->j:Ljava/lang/Object;
    ...
    :try_start_8
    iget-object p1, p1, Lyg/t;->e:Landroid/util/SparseArray;
    ...
    :try_start_9
    invoke-static {p1}, Lna/d;->b(Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    iget-object v4, v3, Lyg/t;->j:Ljava/lang/Object;
    ...
    :try_start_12
    iget-object v5, v3, Lyg/t;->e:Landroid/util/SparseArray;
    ...
    iget-object v0, v3, Lyg/t;->j:Ljava/lang/Object;
    ...
    iput-object v3, p0, Lcom/android/camera/b$b;->b:Lyg/t;
    ...
    :try_start_18
    iget-object v3, v3, Lyg/t;->e:Landroid/util/SparseArray;
    ...
    :try_start_19
    invoke-static {v3}, Lna/d;->b(Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    invoke-virtual {p0}, Lcom/android/camera/b$b;->f()Lyg/t;

    move-result-object v1

    iget-object v3, v1, Lyg/t;->j:Ljava/lang/Object;
    ...
    :try_start_25
    iget-object p2, v1, Lyg/t;->j:Ljava/lang/Object;
    ...
    iget-object p2, p0, Lcom/android/camera/b$b;->b:Lyg/t;
    ...
    iput-object v1, p0, Lcom/android/camera/b$b;->b:Lyg/t;

    invoke-virtual {v1, p1}, Lyg/t;->m(Landroid/util/SparseArray;)Landroid/util/SparseArray;
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)V
    ...
    iget-object v5, p0, Lyg/t;->j:Ljava/lang/Object;

    monitor-enter v5

    :try_start_1
    iget-object v6, p0, Lyg/t;->c:Ljava/util/HashMap;
    ...
    invoke-virtual {v6}, Lyg/n;->n()Z

    move-result v7

    if-nez v7, :cond_4

    invoke-virtual {v6}, Lyg/n;->x()Z

    move-result v7

    if-eqz v7, :cond_4

    iget-object p1, p0, Lyg/t;->b:Lyg/n;

    if-eq p1, v6, :cond_3

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lyg/n;->w()V

    :cond_2
    iput-object v6, p0, Lyg/t;->b:Lyg/n;
    ...
    :cond_4
    iget-object v4, p0, Lyg/t;->b:Lyg/n;

    if-eqz v4, :cond_5

    invoke-virtual {v4}, Lyg/n;->w()V

    :cond_5
    iget-object v4, p0, Lyg/t;->c:Ljava/util/HashMap;
    ...
    iget-object v6, p0, Lyg/t;->C:Lyg/t$e;

    invoke-direct {v4, v6, p1}, Lyg/h;-><init>(Lyg/t$e;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    :cond_7
    new-instance v4, Lyg/b0;

    iget-object v6, p0, Lyg/t;->C:Lyg/t$e;

    invoke-direct {v4, v6, p1}, Lyg/b0;-><init>(Lyg/t$e;Lcom/xiaomi/engine/BufferFormat;)V

    :goto_1
    iget v6, p0, Lyg/t;->a:I

    if-lez v6, :cond_8

    iput v6, v4, Lyg/n;->a:I

    :cond_8
    iput v6, v4, Lyg/n;->e:I

    invoke-virtual {v4}, Lyg/b;->J()V

    invoke-virtual {v4, p1}, Lyg/n;->b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;

    move-result-object v6

    iget-object v7, p0, Lyg/t;->y:Lyg/t$a;
    ...
    invoke-virtual {p0, v3}, Lyg/c;->i(I)V
...
.method public final f()Lyg/t;
    ...
    invoke-direct {v0, v1}, Lyg/t;-><init>(Lcom/android/camera/b$a;)V
...
.method public final k()Z
    ...
    invoke-virtual {v1}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->D6()Z

    move-result v1

    if-eqz v1, :cond_5

    iget-object v1, p0, Lyg/t;->b:Lyg/n;

    iget-object v3, p0, Lyg/t;->l:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    iget-object v4, p0, Lyg/t;->k:Ljava/util/HashMap;
    ...
    iget-object v7, v6, Lyg/q;->P:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v5}, Lyg/n;->o(I)Z
...
.method public final l(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    invoke-virtual {p0, p1, p2}, Lyg/p;->f(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
...
.method public final m(IJ)V
    ...
    iget-object p0, p0, Lyg/t;->z:Lyg/t$b;

    const/4 v2, 0x1

    invoke-direct {v1, p2, p3, p0, v2}, Lyg/v;-><init>(JLyg/t$b;Z)V
    ...
    iget-object p0, p1, Lyg/p;->a:Landroid/os/HandlerThread;
    ...
    iget-object p0, p1, Lyg/p;->b:Lyg/p$a;
    ...
    iget-object p2, p1, Lyg/p;->b:Lyg/p$a;
    ...
    invoke-virtual {p1, v1}, Lyg/p;->i(Lyg/v;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final n(Lyg/q;)V
    .locals 17

    move-object/from16 v0, p1

    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/b$b;->c()Lyg/t;
    ...
    iget-object v1, v1, Lyg/t;->m:Lyg/t$g;

    iget-object v3, v1, Lyg/t$g;->a:Lyg/t;
    ...
    invoke-virtual {v4, v5, v6}, Lyg/c;->f(II)I

    move-result v4

    iput v4, v3, Lyg/t;->x:I

    iget-wide v11, v0, Lyg/q;->e:J

    iget-object v3, v0, Lyg/q;->L:Ljg/d;

    iget-object v4, v0, Lyg/q;->p:Ljava/lang/String;
    ...
    iget-boolean v4, v0, Lyg/q;->G:Z

    const/4 v15, 0x1

    if-nez v4, :cond_2

    iget-object v4, v1, Lyg/t$g;->a:Lyg/t;

    invoke-static {v4, v11, v12, v0}, Lyg/t;->i(Lyg/t;JLyg/q;)V

    iget-object v4, v0, Lyg/q;->s0:Lyg/q$a;
    ...
    :cond_0
    iget v4, v0, Lyg/q;->A:I

    const/4 v7, 0x4

    if-eq v4, v7, :cond_1

    iput-boolean v15, v0, Lyg/q;->x:Z

    :cond_1
    iget-object v4, v1, Lyg/t$g;->a:Lyg/t;

    iget-object v4, v4, Lyg/t;->b:Lyg/n;

    iput-object v4, v0, Lyg/q;->P:Ljava/lang/Object;
    ...
    :goto_0
    iget v10, v0, Lyg/q;->B:I

    iget-boolean v14, v0, Lyg/q;->G:Z

    new-instance v6, Ljg/b;

    iget v8, v0, Lyg/q;->A:I

    iget-object v13, v0, Lyg/q;->Z:Ljava/lang/String;
    ...
    invoke-direct/range {v7 .. v15}, Ljg/b;-><init>(IIIJLjava/lang/String;ZLyg/n;)V

    iget v4, v0, Lyg/q;->h0:I

    iput v4, v6, Ljg/b;->x:I

    iget-object v4, v1, Lyg/t$g;->a:Lyg/t;

    iget-object v4, v4, Lyg/t;->z:Lyg/t$b;

    iput-object v4, v6, Ljg/b;->q:Lyg/p$e;

    iget-boolean v4, v0, Lyg/q;->J:Z

    iput-boolean v4, v6, Ljg/b;->l:Z

    iput-object v3, v6, Ljg/b;->o:Ljg/d;

    iget-object v3, v0, Lyg/q;->f0:Ljg/a;

    iput-object v3, v6, Ljg/b;->v:Ljg/a;

    iget-boolean v3, v0, Lyg/q;->O:Z

    iput-boolean v3, v6, Ljg/b;->m:Z
    ...
    invoke-static {v3, v15}, La0/v3;->e(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    iput-boolean v15, v6, Ljg/b;->s:Z

    :cond_5
    sget-object v3, Lyg/p$f;->a:Lyg/p;

    iget-object v3, v3, Lyg/p;->b:Lyg/p$a;
    ...
    invoke-direct {v2, v4, v1, v6, v0}, Lh3/e;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
