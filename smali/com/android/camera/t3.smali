.class public Lcom/android/camera/t3;
...
.method public constructor <init>(Lcom/android/camera/Camera;)V
    ...
    iput-boolean v0, p0, Lcom/android/camera/t3;->c:Z

    new-instance v0, Lcom/android/camera/t3$a;

    invoke-direct {v0, p0}, Lcom/android/camera/t3$a;-><init>(Lcom/android/camera/t3;)V

    iput-object v0, p0, Lcom/android/camera/t3;->f:Landroid/content/ServiceConnection;

    new-instance v0, Lcom/android/camera/r3;

    invoke-direct {v0, p0}, Lcom/android/camera/r3;-><init>(Lcom/android/camera/t3;)V

    iput-object v0, p0, Lcom/android/camera/t3;->g:Ljava/lang/Runnable;

    new-instance v0, Lcom/android/camera/s3;

    invoke-direct {v0, p0}, Lcom/android/camera/s3;-><init>(Lcom/android/camera/t3;)V

    iput-object v0, p0, Lcom/android/camera/t3;->h:Ljava/lang/Runnable;

    new-instance v0, Ljava/lang/ref/WeakReference;

    invoke-direct {v0, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Lcom/android/camera/t3;->a:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static synthetic a(Lcom/android/camera/t3;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/camera/t3;->u()V

    return-void
.end method

.method public static synthetic b(Lcom/android/camera/t3;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/camera/t3;->t()V
...
.method public static l(Lcom/android/camera/Camera;Landroid/net/Uri;)V
    ...
    invoke-static {p1, p0}, Lcom/android/camera/g6;->s3(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
...
.method private synthetic t()V
    ...
    iget-object v0, p0, Lcom/android/camera/t3;->a:Ljava/lang/ref/WeakReference;
    ...
    iget-boolean v2, p0, Lcom/android/camera/t3;->c:Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/t3;->k()V

    iget-boolean v1, p0, Lcom/android/camera/t3;->c:Z
    ...
    invoke-virtual {v1, v2, v4}, Lud/c;->h(II)Z
...
.method private synthetic u()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/camera/t3;->f:Landroid/content/ServiceConnection;
    ...
    :goto_0
    iput-boolean v2, p0, Lcom/android/camera/t3;->c:Z
...
.method public A(Z)V
    ...
    iget-object v0, p0, Lcom/android/camera/t3;->h:Ljava/lang/Runnable;

    const-wide/16 v1, 0x2710

    invoke-static {p1, v0, v1, v2}, Lze/j;->c(Lio/reactivex/Scheduler;Ljava/lang/Runnable;J)Lio/reactivex/disposables/Disposable;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/t3;->e:Lio/reactivex/disposables/Disposable;
    ...
    iget-object p0, p0, Lcom/android/camera/t3;->h:Ljava/lang/Runnable;

    invoke-static {p1, p0}, Lze/j;->b(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;

    :goto_0
    return-void
.end method

.method public final B(Lcom/android/camera/Camera;Lcom/android/camera/o5;Landroid/net/Uri;)Z
    .locals 5
    ...
    invoke-virtual {p2}, Lcom/android/camera/o5;->J()Z
    ...
    invoke-virtual {p0, p3}, Lcom/android/camera/t3;->h(Landroid/net/Uri;)Z
    ...
    invoke-static {p3, p0}, Lcom/android/camera/g6;->s3(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
...
.method public final c(Lcom/android/camera/Camera;Landroid/content/Intent;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/t3;->o()Lcom/android/camera/z2;

    move-result-object v0

    invoke-virtual {v0}, Lcom/android/camera/z2;->d()F
    ...
    invoke-virtual {p0}, Lcom/android/camera/z2;->d()F
    ...
    invoke-virtual {p1, p0}, Lcom/android/camera/ActivityBase;->Oh(I)V

    :cond_1
    invoke-virtual {p1}, Lcom/android/camera/ActivityBase;->ec()I
...
.method public final d(Lcom/android/camera/o5;Landroid/content/Intent;)V
    .locals 5

    invoke-virtual {p1}, Lcom/android/camera/o5;->H()Z

    move-result p0

    if-eqz p0, :cond_2

    invoke-virtual {p1}, Lcom/android/camera/o5;->p()I
    ...
    invoke-virtual {p1}, Lcom/android/camera/o5;->o()I
...
.method public final e(Lcom/android/camera/Camera;Landroid/content/Intent;)V
    ...
    invoke-virtual {p1}, Lcom/android/camera/ActivityBase;->Ae()Z
    ...
    :cond_0
    invoke-static {p2, v0}, Lcom/android/camera/b3;->b0(Landroid/content/Intent;Z)V
    ...
    invoke-static {p0, p1}, Lcom/android/camera/g6;->v2(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public final f(Lcom/android/camera/Camera;Landroid/content/Intent;)V
    ...
    iget-object v0, p1, Lcom/android/camera/ActivityBase;->r:Ljava/util/ArrayList;
    ...
    iget-object p1, p1, Lcom/android/camera/ActivityBase;->r:Ljava/util/ArrayList;

    invoke-virtual {p0, p1}, Lcom/android/camera/t3;->p(Ljava/util/ArrayList;)[J
...
.method public g(J)V
    ...
    iget-object v1, p0, Lcom/android/camera/t3;->g:Ljava/lang/Runnable;

    invoke-static {v0, v1, p1, p2}, Lze/j;->c(Lio/reactivex/Scheduler;Ljava/lang/Runnable;J)Lio/reactivex/disposables/Disposable;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/t3;->d:Lio/reactivex/disposables/Disposable;
    ...
    iget-object p0, p0, Lcom/android/camera/t3;->g:Ljava/lang/Runnable;
...
.method public final i(Lcom/android/camera/Camera;Lcom/android/camera/o5;Landroid/net/Uri;)Landroid/content/Intent;
    .locals 3

    invoke-virtual {p0, p1, p3}, Lcom/android/camera/t3;->n(Lcom/android/camera/Camera;Landroid/net/Uri;)Landroid/content/Intent;

    move-result-object p3

    invoke-virtual {p0, p1, p3}, Lcom/android/camera/t3;->c(Lcom/android/camera/Camera;Landroid/content/Intent;)V

    invoke-virtual {p0, p1, p3}, Lcom/android/camera/t3;->e(Lcom/android/camera/Camera;Landroid/content/Intent;)V

    if-eqz p2, :cond_0

    invoke-virtual {p0, p2, p3}, Lcom/android/camera/t3;->d(Lcom/android/camera/o5;Landroid/content/Intent;)V

    :cond_0
    invoke-virtual {p0, p1, p3}, Lcom/android/camera/t3;->f(Lcom/android/camera/Camera;Landroid/content/Intent;)V
    ...
    invoke-virtual {p2}, Lcom/android/camera/o5;->n()J
    ...
    iget p1, p1, Lcom/android/camera/ActivityBase;->l:I
...
.method public final j()V
    ...
    iget-object v0, p0, Lcom/android/camera/t3;->d:Lio/reactivex/disposables/Disposable;
    ...
    iput-object v0, p0, Lcom/android/camera/t3;->d:Lio/reactivex/disposables/Disposable;
...
.method public k()V
    ...
    iget-object v0, p0, Lcom/android/camera/t3;->e:Lio/reactivex/disposables/Disposable;
    ...
    iput-object v0, p0, Lcom/android/camera/t3;->e:Lio/reactivex/disposables/Disposable;
...
.method public final m(Lcom/android/camera/Camera;)V
    ...
    sget-boolean v0, Lcom/android/camera/g6;->j:Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/t3;->x(Lcom/android/camera/Camera;)V
...
.method public final o()Lcom/android/camera/z2;
    .locals 0
...
.method public q(Z)V
    ...
    invoke-virtual {v1}, Lcom/android/camera/ThumbnailUpdater;->n()Lcom/android/camera/o5;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-virtual {p0, v0, v1}, Lcom/android/camera/t3;->z(Lcom/android/camera/Camera;Lcom/android/camera/o5;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/t3;->m(Lcom/android/camera/Camera;)V
...
.method public r(Lcom/android/camera/Camera;Landroid/net/Uri;)V
    ...
    invoke-virtual {p0, p1, v2, p2}, Lcom/android/camera/t3;->i(Lcom/android/camera/Camera;Lcom/android/camera/o5;Landroid/net/Uri;)Landroid/content/Intent;
    ...
    invoke-virtual {p1, p0}, Lcom/android/camera/ActivityBase;->Rh(I)V
...
.method public final s(Landroid/content/ActivityNotFoundException;Landroid/net/Uri;Lcom/android/camera/Camera;Lcom/android/camera/o5;)V
    .locals 2
    ...
    invoke-virtual {p4}, Lcom/android/camera/o5;->r()Z
    ...
    invoke-virtual {p4}, Lcom/android/camera/o5;->E()Ljava/lang/String;
    ...
    invoke-virtual {p4}, Lcom/android/camera/o5;->D()Ljava/lang/String;
...
.method public final v(Lcom/android/camera/o5;)V
    .locals 2
    ...
    invoke-virtual {p1}, Lcom/android/camera/o5;->B()Z
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/android/camera/o5;->G()Landroid/net/Uri;
...
.method public final w(Lcom/android/camera/o5;Lcom/android/camera/Camera;)V
    .locals 6
    .param p1    # Lcom/android/camera/o5;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param

    iget-object v0, p2, Lcom/android/camera/ActivityBase;->h0:Lcom/android/camera/ui/h1;

    if-eqz v0, :cond_4

    invoke-virtual {p2}, Lcom/android/camera/ActivityBase;->eg()Z
    ...
    invoke-interface {v0, v1, p2}, Lcom/android/camera/ui/h1;->j(Lkj/a;Z)V

    goto :goto_1

    :cond_2
    sget-object p2, Lkj/a;->g:Lkj/a;

    invoke-interface {v0, p2, v2}, Lcom/android/camera/ui/h1;->g(Lkj/a;Ljava/lang/Object;)V

    goto :goto_1

    :cond_3
    :goto_0
    sget-object p2, Lkj/a;->a:Lkj/a;

    invoke-interface {v0, p2, v2}, Lcom/android/camera/ui/h1;->g(Lkj/a;Ljava/lang/Object;)V

    :cond_4
    :goto_1
    iget-object p2, p0, Lcom/android/camera/t3;->b:Landroid/os/Messenger;
    ...
    invoke-virtual {p1}, Lcom/android/camera/o5;->I()Z
    ...
    :cond_6
    invoke-static {}, Lcom/android/camera/e5;->e()Lcom/android/camera/e5;
    ...
    invoke-virtual {p2, v1, v2}, Lcom/android/camera/e5;->i(Landroid/net/Uri;Landroid/graphics/Bitmap;)Z
    ...
    :cond_7
    :try_start_1
    invoke-virtual {p2}, Lcom/android/camera/e5;->f()Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v4, p0, Lcom/android/camera/t3;->b:Landroid/os/Messenger;
    ...
    invoke-virtual {p2}, Lcom/android/camera/e5;->g()Landroid/net/Uri;
    ...
    invoke-virtual {p2}, Lcom/android/camera/e5;->c()I
    ...
    invoke-virtual {p2}, Lcom/android/camera/e5;->h()I
    ...
    invoke-virtual {p2}, Lcom/android/camera/e5;->d()I

    move-result v5

    invoke-virtual {v3, v4, v5}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    invoke-virtual {p1}, Lcom/android/camera/o5;->q()Ljava/lang/Boolean;
    ...
    iget-object p1, p0, Lcom/android/camera/t3;->b:Landroid/os/Messenger;
    ...
    iget-object p0, p0, Lcom/android/camera/t3;->b:Landroid/os/Messenger;
...
.method public y(Landroid/os/Messenger;)V
    ...
    iput-object p1, p0, Lcom/android/camera/t3;->b:Landroid/os/Messenger;

    return-void
.end method

.method public final z(Lcom/android/camera/Camera;Lcom/android/camera/o5;)V
    .locals 5

    invoke-virtual {p2}, Lcom/android/camera/o5;->G()Landroid/net/Uri;

    move-result-object v0

    invoke-virtual {p0, p1, p2, v0}, Lcom/android/camera/t3;->B(Lcom/android/camera/Camera;Lcom/android/camera/o5;Landroid/net/Uri;)Z
    ...
    invoke-virtual {p0, p2, p1}, Lcom/android/camera/t3;->w(Lcom/android/camera/o5;Lcom/android/camera/Camera;)V

    invoke-static {p1, v0}, Lcom/android/camera/t3;->l(Lcom/android/camera/Camera;Landroid/net/Uri;)V

    invoke-virtual {p0, p1, p2, v0}, Lcom/android/camera/t3;->i(Lcom/android/camera/Camera;Lcom/android/camera/o5;Landroid/net/Uri;)Landroid/content/Intent;
    ...
    invoke-virtual {p1, v1}, Lcom/android/camera/ActivityBase;->Rh(I)V
    ...
    invoke-virtual {p0, v1, v0, p1, p2}, Lcom/android/camera/t3;->s(Landroid/content/ActivityNotFoundException;Landroid/net/Uri;Lcom/android/camera/Camera;Lcom/android/camera/o5;)V

    :cond_2
    :goto_0
    invoke-virtual {p0, p2}, Lcom/android/camera/t3;->v(Lcom/android/camera/o5;)V
