...
.field private mASDHanlder:Li0/d;

.field private mChain:Lg0/a;

.field private mFullHanlder:Li0/d;

.field protected mWatermarkItem:Lh0/q;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->mChain:Lg0/a;

    iput-object v0, p0, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->mFullHanlder:Li0/d;

    iput-object v0, p0, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->mASDHanlder:Li0/d;

    return-void
.end method

.method public static synthetic access$000(Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;Lh0/q;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->updateWatermarkUI(Lh0/q;)V
...
.method private findBestWatermarkItem(I)V
    ...
    invoke-direct {p0, p1}, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->getAIWatermarkItem(I)Lh0/q;
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule$a;-><init>(Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;Lh0/q;)V
...
.method private getAIWatermarkItem(I)Lh0/q;
    .locals 3

    iget-object v0, p0, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->mChain:Lg0/a;
    ...
    iget-object p1, p0, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->mFullHanlder:Li0/d;

    if-nez p1, :cond_3

    iget-object p1, p0, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->mChain:Lg0/a;
    ...
    invoke-virtual {p1, v1, v0}, Lg0/a;->b(ILandroid/content/Context;)Li0/d;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->mFullHanlder:Li0/d;

    :cond_3
    iget-object p0, p0, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->mFullHanlder:Li0/d;

    goto :goto_1

    :cond_4
    iget-object p1, p0, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->mASDHanlder:Li0/d;
    ...
    invoke-virtual {p1, v0}, Lg0/a;->a(Landroid/content/Context;)Li0/d;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->mASDHanlder:Li0/d;

    :cond_5
    iget-object p0, p0, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->mASDHanlder:Li0/d;

    :goto_1
    invoke-virtual {p0}, Li0/d;->b()Lh0/q;
...
.method private updateAIWatermark()V
    ...
    invoke-direct {v1, p0, v3}, Lea/p;-><init>(Lea/w;I)V
...
.method private updateWatermarkUI(Lh0/q;)V
    .locals 0
    ...
    invoke-interface {p0, p1}, Ly7/a;->n1(Lh0/q;)V
...
.method public consumeWatermarkCoordinate(J)V
    ...
    iget-object v0, p0, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->mWatermarkItem:Lh0/q;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p1, p2}, Lh0/q;->a(J)[I

    iget-object p0, p0, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->mWatermarkItem:Lh0/q;

    iget-object p0, p0, Lh0/q;->o:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public getJpegRotation()I
    ...
    invoke-interface {v0}, Ly7/a;->Nh()I
    ...
    invoke-static {p0, v0}, Lgq/c;->k(II)I
...
.method public onASDChange(I)V
    ...
    invoke-interface {p0, p1}, Ly7/b;->onASDChange(I)V
...
.method public onTiltShiftSwitched(Z)V
    ...
    invoke-virtual {p0, v4, v1}, Lg9/f;->h(Lpo/d;Z)V
    ...
    :goto_1
    sget-object p1, Lpo/d;->k:Lpo/d;

    invoke-virtual {p0, p1, v2}, Lg9/f;->h(Lpo/d;Z)V
...
.method public prepareAIWatermark(J)V
    ...
    iput-object v0, p0, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->mWatermarkItem:Lh0/q;
    ...
    invoke-virtual {v1, v0}, Lh1/a;->h(I)Z
    ...
    iget-object v2, p0, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->mWatermarkItem:Lh0/q;

    iget-object v2, v2, Lh0/q;->k:Landroid/graphics/Rect;
    ...
    invoke-static {v4, v0, v3, v1}, La0/m0;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-object v1, p0, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->mWatermarkItem:Lh0/q;

    iget-object v1, v1, Lh0/q;->i:[I
    ...
    :cond_0
    iget-object v1, v0, Lh0/q;->i:[I

    invoke-virtual {v0, p1, p2, v1, v2}, Lh0/q;->b(J[IZ)V

    iget-object p0, p0, Lcom/android/camera/features/mode/aiwatermark/AIWaterModule;->mWatermarkItem:Lh0/q;

    iget-object v0, p0, Lh0/q;->k:Landroid/graphics/Rect;
...
.method public supportAnchorFrameAsThumbnail(Z)Z
    ...
    invoke-static {p1, p0, v0}, Lea/d;->D0(IILea/c;)Z
    ...
    :cond_1
    invoke-static {v1, p1, v0}, Lea/d;->D0(IILea/c;)Z
...
.method public updateAiScene()V
    ...
    iget-boolean v1, v0, Lea/x;->g1:Z

    if-eq v1, p0, :cond_2

    iput-boolean p0, v0, Lea/x;->g1:Z
