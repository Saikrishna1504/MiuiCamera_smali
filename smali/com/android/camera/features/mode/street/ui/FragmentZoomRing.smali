...
.method public static synthetic Ah(ZLa7/r1;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Mh(ZLa7/r1;)V

    return-void
.end method

.method public static synthetic Bh(FILa7/r1;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Nh(FILa7/r1;)V

    return-void
.end method

.method public static synthetic Ch(Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;Z)V
    .locals 0

    invoke-virtual {p0, p1}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Rh(Z)V

    return-void
.end method

.method public static synthetic Dh(Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;F)V
    .locals 0

    invoke-virtual {p0, p1}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->jb(F)V

    return-void
.end method

.method public static synthetic Eh(Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;)Landroid/animation/ValueAnimator;
    .locals 0
...
.method public static synthetic Fh(Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;ZIFI)V
    .locals 0

    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Sh(ZIFI)V

    return-void
.end method

.method private synthetic Lh(ZFLandroid/animation/ValueAnimator;)V
    .locals 6
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Gh(ZFFFF)Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Hh()I

    move-result p2

    invoke-virtual {p0, p1, p2}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Th(FI)V
    ...
    invoke-virtual {p0, p3, p1}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Th(FI)V

    :goto_0
    return-void
.end method

.method public static synthetic Mh(ZLa7/r1;)V
    .locals 0

    invoke-interface {p1, p0}, La7/r1;->g9(Z)V

    return-void
.end method

.method public static synthetic Nh(FILa7/r1;)V
    .locals 0
...
.method private synthetic Oh(FILandroid/animation/ValueAnimator;)V
    .locals 1
    ...
    :cond_0
    invoke-virtual {p0, p3, p2}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Th(FI)V
...
.method public static synthetic Ph(ILa7/j3;)V
    .locals 0

    invoke-interface {p1, p0}, La7/j3;->c8(I)V

    return-void
.end method

.method private synthetic Qh(ZLa7/l0;)V
    .locals 1

    iget v0, p0, Lcom/android/camera/fragment/BaseFragment;->mCurrentMode:I

    invoke-static {v0}, Lcom/android/camera/g6;->D0(I)I
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->uf(II)V

    :cond_0
    return-void
.end method

.method public static synthetic wh(Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;FILandroid/animation/ValueAnimator;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Oh(FILandroid/animation/ValueAnimator;)V

    return-void
.end method

.method public static synthetic xh(ILa7/j3;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Ph(ILa7/j3;)V

    return-void
.end method

.method public static synthetic yh(Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;ZLa7/l0;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Qh(ZLa7/l0;)V

    return-void
.end method

.method public static synthetic zh(Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;ZFLandroid/animation/ValueAnimator;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Lh(ZFLandroid/animation/ValueAnimator;)V
...
# virtual methods
.method public final Gh(ZFFFF)Z
    .locals 7
...
.method public final Ih()[F
    ...
    invoke-virtual {p0}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Jh()I
...
.method public Mb(I)Landroid/util/SparseArray;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",
...
.method public final Sh(ZIFI)V
    ...
    invoke-virtual {p0, p3, p4}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Th(FI)V
    ...
    invoke-virtual {p0, p2}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->c8(I)V

    :cond_1
    return-void
.end method

.method public final Th(FI)V
    .locals 1
...
.method public final Wh(I)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Mb(I)Landroid/util/SparseArray;
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Ih()[F
...
.method public fa(IIIZ)V
    ...
    invoke-virtual {p1}, Lt0/m1;->Z()Lt0/i0;
    ...
    :cond_3
    invoke-virtual {p0, p2, v0, p3}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Vh(IFI)V
    ...
    invoke-static {v3, v1, v2}, Lz8/a;->i(IIZ)F

    move-result v1

    invoke-virtual {p0, p1, v1}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Uh(FF)V
    ...
    invoke-static {p1, v0, p2, p0}, Lq7/a;->N4(Ljava/lang/String;FII)V
...
.method public o9()V
    ...
    invoke-static {v0}, Lcom/android/camera/g6;->i2(F)F
...
.method public provideAnimateElement(ILjava/util/List;I)V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->o9()V

    invoke-virtual {p0, p1}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Wh(I)V

    invoke-virtual {p0}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->Kh()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/features/mode/street/ui/FragmentZoomRing;->a1()V
