...
.field private mStreamMetadata:Lsd/o;
...
.method public static synthetic C8(Ljava/lang/String;ILa7/t;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->lambda$onCineMonitorStateChanged$2(Ljava/lang/String;ILa7/t;)V

    return-void
.end method

.method public static synthetic E8(Lcom/android/camera/features/mode/cinemaster/CinemasterModule;)V
    .locals 0
...
.method public static synthetic P7(La7/t;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->lambda$setVideoCastStateImpl$4(La7/t;)V

    return-void
.end method

.method public static synthetic Q7(La7/t;)Ljava/lang/Boolean;
    .locals 0

    invoke-static {p0}, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->lambda$onBackPressed$6(La7/t;)Ljava/lang/Boolean;
...
.method public static synthetic R7(Lcom/android/camera/features/mode/cinemaster/CinemasterModule;Landroid/os/Bundle;)V
    .locals 0
...
.method public static synthetic S7(Lcom/android/camera/features/mode/cinemaster/CinemasterModule;Landroid/os/Bundle;)V
    .locals 0
...
.method public static synthetic W7(Ljava/lang/String;Lcom/android/camera2/a;)V
    .locals 0
...
.method private initStreamMetadata()V
    ...
    invoke-direct {v3}, Lsd/o;-><init>()V

    iput-object v3, p0, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->mStreamMetadata:Lsd/o;

    invoke-virtual {v3, v0, v1}, Lsd/o;->g(II)V
...
.method private static synthetic lambda$new$7(La7/g3;)V
    .locals 2
...
.method private synthetic lambda$new$9()V
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->mStreamMetadata:Lsd/o;

    if-eqz v2, :cond_0

    invoke-virtual {v2, v0}, Lsd/o;->j(Z)V

    iget-object v0, p0, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->mStreamMetadata:Lsd/o;

    invoke-direct {p0, v0}, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->sendStreamMetadata(Lsd/o;)V
...
.method private static synthetic lambda$onBackPressed$6(La7/t;)Ljava/lang/Boolean;
    .locals 1

    const/4 v0, 0x0

    invoke-interface {p0, v0}, La7/t;->handleExitRequest(Z)Z
    ...
    :cond_0
    invoke-interface {p0}, La7/t;->isBottomShow()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-interface {p0}, La7/t;->hidePopupBottom()V
    ...
    :cond_1
    invoke-interface {p0}, La7/t;->hideGuide()Z
...
.method private static synthetic lambda$onCineMonitorStateChanged$2(Ljava/lang/String;ILa7/t;)V
    .locals 0

    invoke-interface {p2, p0, p1}, La7/t;->onRemoteMonitorStateChanged(Ljava/lang/String;I)V
...
.method private synthetic lambda$onCineMonitorStateChanged$3(Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, Lke/e;->g(Landroid/os/Bundle;)I

    move-result v0

    invoke-static {p1}, Lke/e;->f(Landroid/os/Bundle;)Ljava/lang/String;
...
.method private static synthetic lambda$setVideoCastStateImpl$4(La7/t;)V
    .locals 1

    invoke-interface {p0}, La7/t;->getMonitorCount()I

    move-result p0

    const/4 v0, 0x0

    invoke-static {v0, p0}, Lq7/a;->t2(II)V
...
.method public static synthetic r8(Lcom/android/camera/features/mode/cinemaster/CinemasterModule;Lcom/android/camera/module/VideoBase$f;Ljava/util/List;)V
    .locals 0
...
.method private registerWifiState()V
    ...
    invoke-virtual {v0}, Lcom/android/camera/ActivityBase;->gc()Lcom/android/camera/CameraAppImpl;
...
.method private sendStreamMetadata(Lsd/o;)V
    .locals 1
    ...
    invoke-virtual {p1}, Lsd/o;->f()[B

    move-result-object p1

    invoke-static {v0, p1}, Lke/f;->e(Landroid/os/Bundle;[B)V

    const-string p1, "com.xiaomi.camera.rcs.setHdrExtData"

    invoke-virtual {p0, p1, v0}, Lcom/android/camera/h5;->h(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method private setVideoCastStateImpl(Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, Lke/e;->e(Landroid/os/Bundle;)I
...
.method public static synthetic u8(La7/g3;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->lambda$new$7(La7/g3;)V
...
.method public static synthetic w8(Lcom/android/camera/features/mode/cinemaster/CinemasterModule;)V
    .locals 0
...
.method public isInTapableRect(II)Z
    ...
    invoke-static {p0, v0, v1}, Lcom/android/camera/g6;->V1(ZLandroid/graphics/Rect;Landroid/content/Context;)Landroid/graphics/Rect;
...
.method public isRecording()Z
    ...
    invoke-interface {v1}, La7/t;->isClientVisible()Z
    ...
    invoke-interface {p0}, La7/t;->isRemoteRecoding()Z
...
.method public onCameraOpened()V
    ...
    invoke-static {v0, v1, v2}, Lcom/android/camera/e3;->S7(Landroid/content/Context;IZ)V
...
.method public onCineMonitorHandleCameraParamRequest()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->mStreamMetadata:Lsd/o;

    if-eqz v1, :cond_0

    invoke-direct {p0, v1}, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->sendStreamMetadata(Lsd/o;)V
...
.method public onCreate(II)V
    ...
    invoke-static {p1, v0}, Lcom/android/camera/e3;->f0(ILcom/android/camera2/f;)[F
    ...
    invoke-direct {v1, v2, p1}, Lmj/j;-><init>(FF)V

    invoke-interface {p2, v0, v1}, Lcom/android/camera/ui/h1;->A(Lkj/e;Lmj/d;)V

    goto :goto_0

    :cond_0
    sget-object p1, Lkj/e;->w:Lkj/e;

    invoke-interface {p2, p1}, Lcom/android/camera/ui/h1;->e(Lkj/e;)V

    :goto_0
    sget-object p1, Lkj/e;->x:Lkj/e;

    invoke-interface {p2, p1}, Lcom/android/camera/ui/h1;->e(Lkj/e;)V

    sget-object p1, Lkj/e;->e:Lkj/e;

    invoke-interface {p2, p1}, Lcom/android/camera/ui/h1;->i(Lkj/e;)Lrj/s;
...
.method public onDestroy()V
    ...
    sget-object v1, Lkj/e;->w:Lkj/e;

    invoke-interface {v0, v1}, Lcom/android/camera/ui/h1;->T(Lkj/e;)V

    sget-object v1, Lkj/e;->x:Lkj/e;

    invoke-interface {v0, v1}, Lcom/android/camera/ui/h1;->T(Lkj/e;)V

    sget-object v1, Lkj/e;->e:Lkj/e;

    invoke-interface {v0, v1}, Lcom/android/camera/ui/h1;->z(Lkj/e;)V
...
.method public onStartRecorderFail()V
    ...
    invoke-virtual {v1, v3}, Lsd/o;->j(Z)V
...
.method public onStartRecorderSucceed()V
    ...
    invoke-virtual {v1, v2}, Lsd/o;->j(Z)V
...
.method public setGainValue(F)V
    ...
    :cond_2
    invoke-static {p1}, Lcom/android/camera/e3;->F8(F)V
    ...
    invoke-static {p0, p1}, Lcom/android/camera/g5;->k(Landroid/content/Context;Ljava/lang/String;)V
...
.method public updateAutoHibernation(Z)V
    ...
    invoke-interface {p1}, La7/t;->isScreenPrompt()Z
