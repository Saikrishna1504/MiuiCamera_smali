...
.field private mStreamMetadata:Llg/g;
...
.method public static synthetic Bi(Ljava/lang/String;Lea/a;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera/features/mode/pro/rec/ProRecModule;->lambda$updateExposureTime$4(Ljava/lang/String;Lea/a;)V

    return-void
.end method

.method public static synthetic Ci(Lcom/android/camera/features/mode/pro/rec/ProRecModule;Landroid/os/Bundle;)V
    .locals 0
...
.method private initStreamMetadata()V
    ...
    invoke-static {v1}, Lcom/android/camera/module/video/a0;->i(I)I
    ...
    iput-object v3, p0, Lcom/android/camera/features/mode/pro/rec/ProRecModule;->mStreamMetadata:Llg/g;

    invoke-virtual {v3, v0, v1}, Llg/g;->b(II)V
...
.method private synthetic lambda$getTagsListener$9(Lcom/android/camera/module/VideoBase$e;Ljava/util/List;)V
    ...
    invoke-direct {v0, v2, v3, v1}, Ln6/b$a;-><init>(Ljava/lang/String;Ljava/lang/String;[B)V
    ...
    invoke-static {p0}, Lcom/android/camera/data/data/f0;->C(I)V
...
.method private lambda$new$0()V
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/camera/features/mode/pro/rec/ProRecModule;->mStreamMetadata:Llg/g;

    if-eqz v2, :cond_0

    iput-boolean v0, v2, Llg/g;->d:Z

    invoke-direct {p0, v2}, Lcom/android/camera/features/mode/pro/rec/ProRecModule;->sendStreamMetadata(Llg/g;)V
...
.method private static synthetic lambda$onActive$1(FLy7/c0;)V
    .locals 0
...
.method private static synthetic lambda$onBackPressed$10(Ly7/v;)Ljava/lang/Boolean;
    .locals 1

    const/4 v0, 0x0

    invoke-interface {p0, v0}, Ly7/v;->handleExitRequest(Z)Z
    ...
    :cond_0
    invoke-interface {p0}, Ly7/v;->isBottomShow()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-interface {p0}, Ly7/v;->hidePopupBottom()V
    ...
    :cond_1
    invoke-interface {p0}, Ly7/v;->hideGuide()Z
...
.method private static synthetic lambda$onCineMonitorStateChanged$6(Ljava/lang/String;ILy7/v;)V
    .locals 0

    invoke-interface {p2, p0, p1}, Ly7/v;->onRemoteMonitorStateChanged(Ljava/lang/String;I)V
...
.method private lambda$onCineMonitorStateChanged$7(Landroid/os/Bundle;)V
    ...
    sget-object v0, Lcj/h;->a:Ljava/lang/String;
    ...
    invoke-direct {v2, p1, v0}, Lcom/android/camera/features/mode/pro/rec/b;-><init>(Ljava/lang/String;I)V
...
.method private synthetic lambda$onDoubleTap$12(Landroid/graphics/Rect;Lea/a;)V
    .locals 1
    ...
    invoke-virtual {p2, p1, p0, v0}, Lea/a;->j1(Landroid/graphics/Rect;IB)V

    return-void
.end method

.method private synthetic lambda$onDoubleTap$13(Landroid/graphics/Rect;Lea/a;)V
    .locals 0
...
.method private synthetic lambda$onSingleTapUp$11(Landroid/graphics/Rect;ZLea/a;)V
    .locals 0
    ...
    invoke-virtual {p3, p1, p0, p2}, Lea/a;->j1(Landroid/graphics/Rect;IB)V
...
.method private static synthetic lambda$setVideoCastStateImpl$8(Ly7/v;)V
    .locals 1

    invoke-interface {p0}, Ly7/v;->getMonitorCount()I

    move-result p0

    const/4 v0, 0x0

    invoke-static {v0, p0}, Ln8/a;->Y(II)V

    return-void
.end method

.method private static synthetic lambda$stopVideoRecording$2(Ly7/q1;)V
    .locals 1

    const/4 v0, 0x0

    invoke-interface {p0, v0, v0}, Ly7/q1;->K9(ZZ)V

    return-void
.end method

.method private static synthetic lambda$updateExposureTime$3(Ld1/p1;)Ljava/lang/String;
    .locals 1
...
.method private static lambda$updateExposureTime$4(Ljava/lang/String;Lea/a;)V
    .locals 2
...
.method public static synthetic ri(Lcom/android/camera/features/mode/pro/rec/ProRecModule;)V
    .locals 0
...
.method private sendStreamMetadata(Llg/g;)V
    .locals 2
    ...
    invoke-interface {p0, v0}, Lcom/android/camera/module/k0;->E9(Landroid/os/Bundle;)V
...
.method public static synthetic si(Lcom/android/camera/features/mode/pro/rec/ProRecModule;Landroid/graphics/Rect;Lea/a;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/features/mode/pro/rec/ProRecModule;->lambda$onDoubleTap$13(Landroid/graphics/Rect;Lea/a;)V

    return-void
.end method

.method public static synthetic ti(Ly7/v;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/features/mode/pro/rec/ProRecModule;->lambda$setVideoCastStateImpl$8(Ly7/v;)V

    return-void
.end method

.method public static synthetic ui(Ld1/p1;)Ljava/lang/String;
    .locals 0

    invoke-static {p0}, Lcom/android/camera/features/mode/pro/rec/ProRecModule;->lambda$updateExposureTime$3(Ld1/p1;)Ljava/lang/String;
...
.method public static synthetic vi(Lcom/android/camera/features/mode/pro/rec/ProRecModule;Lcom/android/camera/module/VideoBase$e;Ljava/util/List;)V
    .locals 0
...
.method public static synthetic wi(Ly7/v;)Ljava/lang/Boolean;
    .locals 0

    invoke-static {p0}, Lcom/android/camera/features/mode/pro/rec/ProRecModule;->lambda$onBackPressed$10(Ly7/v;)Ljava/lang/Boolean;
...
.method public static synthetic xi(Ly7/q1;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/features/mode/pro/rec/ProRecModule;->lambda$stopVideoRecording$2(Ly7/q1;)V

    return-void
.end method

.method public static synthetic yi(Ljava/lang/String;ILy7/v;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/android/camera/features/mode/pro/rec/ProRecModule;->lambda$onCineMonitorStateChanged$6(Ljava/lang/String;ILy7/v;)V

    return-void
.end method

.method public static synthetic zi(Lcom/android/camera/features/mode/pro/rec/ProRecModule;)V
    .locals 0
...
.method public appendModuleExternalASD(Lf7/b;)V
    ...
    invoke-super {p0, p1}, Lcom/android/camera/module/video/ProVideoModule;->appendModuleExternalASD(Lf7/b;)V
...
.method public enableResetTouchAf(Z)V
    ...
    invoke-interface {p0, p1}, Li7/o;->u(Z)V
...
.method public getNextUpdateDelay(Ljava/lang/String;)J
    ...
    invoke-virtual {v2}, Lcom/android/camera/module/video/y;->k()Z
    ...
    iget-object v2, v2, Lcom/android/camera/module/video/y;->e:Ljava/lang/String;
...
.method public isRecording()Z
    ...
    invoke-interface {v1}, Ly7/v;->isClientVisible()Z
    ...
    invoke-interface {p0}, Ly7/v;->isRemoteRecoding()Z
...
.method public lockAEAF()V
    ...
    invoke-static {v0}, Lcom/android/camera/data/data/f0;->C(I)V
...
.method public onCineMonitorHandleCameraParamRequest()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/camera/features/mode/pro/rec/ProRecModule;->mStreamMetadata:Llg/g;

    if-eqz v1, :cond_0

    invoke-direct {p0, v1}, Lcom/android/camera/features/mode/pro/rec/ProRecModule;->sendStreamMetadata(Llg/g;)V
...
.method public onPreviewSessionSuccess(Landroid/hardware/camera2/CameraCaptureSession;)V
    ...
    iget-object v0, p0, Lcom/android/camera/features/mode/pro/rec/ProRecModule;->mStreamMetadata:Llg/g;

    invoke-direct {p0, v0}, Lcom/android/camera/features/mode/pro/rec/ProRecModule;->sendStreamMetadata(Llg/g;)V
...
.method public releaseCinemaster()V
    ...
    iput-object v1, p0, Lcom/android/camera/features/mode/pro/rec/ProRecModule;->mStreamMetadata:Llg/g;
...
.method public setOrientationParameter()V
    ...
    invoke-direct {v2, p0, v1}, Landroidx/room/c;-><init>(Ljava/lang/Object;I)V
...
.method public stopVideoRecording(Z)Z
    ...
    invoke-static {v3, v1, v2}, Ln8/a;->A(ILjava/lang/String;Ljava/lang/String;)V
...
.method public unlockAEAF()V
    ...
    invoke-interface {v0, v1}, Li7/o;->i(Z)V
...
.method public updateAutoHibernationState()V
    ...
    invoke-interface {v0}, Ly7/v;->getMonitorCount()I
