...
.method public static synthetic E8(Lcom/android/camera/features/mode/doc/DocModule;)V
    .locals 0
...
.method public static synthetic F8(Landroid/net/Uri;)V
    .locals 0
...
.method public static synthetic I8(Lcom/android/camera/Camera;)V
    .locals 0
...
.method public static synthetic S7(Landroid/net/Uri;)V
    .locals 0
...
.method public static synthetic V8(Lcom/android/camera/Camera;)V
    .locals 0
...
.method public static synthetic W7(La7/e0;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/features/mode/doc/DocModule;->lambda$showDocumentPreview$3(La7/e0;)V

    return-void
.end method

.method public static synthetic Y8(Lcom/android/camera/features/mode/doc/DocModule;Landroid/graphics/Bitmap;[FLq9/c;)V
    .locals 0
...
.method private callGalleryDocumentPage(Ljava/lang/String;Ljava/lang/String;Lcom/android/camera/Camera;)V
    ...
    :cond_0
    invoke-static {p1}, Lcom/android/camera/g6;->b4(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-virtual {p3}, Lcom/android/camera/ActivityBase;->ei()Z
    ...
    invoke-static {p3, v0, p1}, Lcom/android/camera/g6;->S4(Landroid/app/Activity;Landroid/content/Intent;I)Z
    ...
    invoke-virtual {p3, p0}, Lcom/android/camera/ActivityBase;->Rh(I)V
...
.method public static synthetic k9(Lcom/android/camera/features/mode/doc/DocModule;Lcom/android/camera2/w5;)V
    .locals 0
...
.method private static synthetic lambda$showDocumentPreview$3(La7/e0;)V
    .locals 1
...
.method private synthetic lambda$showDocumentPreview$5(Landroid/graphics/Bitmap;[FLq9/c;La7/d;)V
    ...
    invoke-interface {p4, p1, p2, v0, p3}, La7/d;->Fg(Landroid/graphics/Bitmap;[FLandroid/util/Size;Ljava/lang/Runnable;)V
...
.method private synthetic lambda$showDocumentPreview$7(Ljava/lang/String;Landroid/graphics/Bitmap;)V
    ...
    invoke-static {p2, v1, v2}, Lze/b;->n(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    invoke-static {p2, p1, v3, v1}, Lcom/android/camera/g6;->q4(Landroid/graphics/Bitmap;Ljava/lang/String;ILandroid/graphics/Bitmap$CompressFormat;)Z
...
.method private static synthetic lambda$updateEnablePreviewThumbnail$9(Lcom/android/camera/Camera;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/ActivityBase;->Th(Z)V

    return-void
.end method

.method private static synthetic lambda$updateFace$0(La7/o1;)V
    .locals 1
    ...
    invoke-interface {p0, v0}, La7/f1;->F5(Z)V
...
.method public static synthetic r8(Lcom/android/camera/features/mode/doc/DocModule;Lr9/g;)V
    .locals 0
...
.method private showDocumentPreview(Lr9/g$a;)V
    ...
    invoke-static {v2, v4}, Lze/j;->b(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;

    :cond_1
    sget-object v2, Lcom/android/camera/n3;->d:Lcom/android/camera/n3;

    invoke-virtual {v2, v1}, Lcom/android/camera/n3;->b(Z)I

    move-result v2

    invoke-static {v3, v2}, Lze/b;->g(Landroid/graphics/Bitmap;I)[B
    ...
    invoke-direct/range {v12 .. v17}, Lud/w;-><init>(IJILjava/lang/String;)V

    invoke-virtual {v6, v5}, Lud/w;->d1(Z)V
    ...
    invoke-virtual {v6, v2, v1}, Lud/w;->a([BI)V
    ...
    invoke-direct {v1, v2, v7, v8, v3}, Lud/x$b;-><init>(Landroid/util/Size;Landroid/util/Size;Landroid/util/Size;I)V
    ...
    invoke-virtual {v1, v2}, Lud/x$b;->C(I)Lud/x$b;
    ...
    invoke-virtual {v6, v1}, Lud/w;->b(Lud/x;)V
    ...
    invoke-virtual {v6, v5}, Lud/w;->p1(Z)V
    ...
    invoke-virtual {v0, v6, v1, v1, v1}, Lr7/h;->j(Lud/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method public static synthetic u8(Lcom/android/camera/features/mode/doc/DocModule;Ljava/lang/String;Landroid/graphics/Bitmap;)V
    .locals 0
...
.method private updateSessionParams()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/camera2/z5;->h(Ll9/ds;Ljava/lang/Object;)V
...
.method public static synthetic w8(La7/o1;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/features/mode/doc/DocModule;->lambda$updateFace$0(La7/o1;)V
...
.method public clampQuality(I)I
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/n3;->b(Z)I
...
.method public generateDocumentBean()V
    ...
    invoke-interface {v0, v1}, La7/e0;->V7(Z)V
...
.method public handleSaveFinishIfNeed(Landroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-virtual {p2}, Lw0/k1;->O()Lw0/q;
    ...
    invoke-static {p0, p2}, Lze/j;->b(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
...
.method public updateFlawDetect()V
    ...
    invoke-static {v1, p0}, Lz8/a;->v(FZ)Z
