...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/camera/b3;->d:Ljava/util/WeakHashMap;
...
.method public constructor <init>(Landroid/content/Intent;)V
    ...
    iput-object v0, p0, Lcom/android/camera/b3;->c:Ljava/lang/Boolean;

    iput-object p1, p0, Lcom/android/camera/b3;->a:Landroid/content/Intent;

    invoke-virtual {p0, p1}, Lcom/android/camera/b3;->X(Landroid/content/Intent;)Landroid/net/Uri;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/b3;->b:Landroid/net/Uri;
...
.method public static Y()V
    ...
    sget-object v0, Lcom/android/camera/b3;->d:Ljava/util/WeakHashMap;
...
.method public static b0(Landroid/content/Intent;Z)V
    .locals 1
...
.method public static n(Landroid/content/Intent;)Lcom/android/camera/b3;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lcom/android/camera/b3;-><init>(Landroid/content/Intent;)V

    sget-object v1, Lcom/android/camera/b3;->d:Ljava/util/WeakHashMap;

    invoke-virtual {v1, p0, v0}, Ljava/util/WeakHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CameraIntentManager"

    invoke-static {v1, p0}, Lcom/android/camera/b3$a;->a(Ljava/lang/String;Landroid/content/Intent;)V
...
.method public final A(Landroid/app/Activity;)Z
    ...
    invoke-static {}, Lcom/android/camera/x3;->b()Lcom/android/camera/x3;

    move-result-object p1

    invoke-virtual {p1}, Lcom/android/camera/x3;->a()I

    move-result p1

    iget-object v0, p0, Lcom/android/camera/b3;->a:Landroid/content/Intent;
    ...
    iget-object p0, p0, Lcom/android/camera/b3;->a:Landroid/content/Intent;
...
.method public F(Landroid/app/Activity;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/b3;->M(Landroid/app/Activity;)Z
...
.method public K(Landroid/app/Activity;)Z
    ...
    :pswitch_0
    invoke-virtual {p0}, Lcom/android/camera/b3;->d()Ljava/lang/String;
    ...
    :cond_5
    iget-object v5, p0, Lcom/android/camera/b3;->a:Landroid/content/Intent;
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/b3;->A(Landroid/app/Activity;)Z
    ...
    :cond_6
    invoke-virtual {p0}, Lcom/android/camera/b3;->J()Z
    ...
    :cond_8
    iget-object p1, p0, Lcom/android/camera/b3;->a:Landroid/content/Intent;
...
.method public M(Landroid/app/Activity;)Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/b3;->Q()Z
...
.method public final X(Landroid/content/Intent;)Landroid/net/Uri;
    .locals 2
    .annotation build Lcom/android/camera/jacoco/JacocoForceIgnore;
    .end annotation
...
.method public a()Z
    ...
    iget-object v0, p0, Lcom/android/camera/b3;->c:Ljava/lang/Boolean;
    ...
    :cond_9
    :goto_1
    iget-object p0, p0, Lcom/android/camera/b3;->c:Ljava/lang/Boolean;
...
.method public b(Landroid/app/Activity;)Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/b3;->C()Z
...
.method public c()V
    ...
    iget-object v1, p0, Lcom/android/camera/b3;->a:Landroid/content/Intent;

    invoke-virtual {v0, v1}, Ljava/util/WeakHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/camera/b3;->b:Landroid/net/Uri;
...
.method public d()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/camera/b3;->b:Landroid/net/Uri;

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/android/camera/b3;->a:Landroid/content/Intent;

    invoke-virtual {p0, v0}, Lcom/android/camera/b3;->X(Landroid/content/Intent;)Landroid/net/Uri;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/camera/b3;->b:Landroid/net/Uri;
...
.method public g()I
    ...
    invoke-virtual {p0}, Lcom/android/camera/b3;->f()Ljava/lang/String;
...
.method public z()Ljava/lang/Boolean;
    ...
    invoke-virtual {p0}, Lcom/android/camera/b3;->e()I
