...
.method public constructor <init>(Lcom/android/camera/ActivityBase;ILh5/a;Lcom/android/camera/display/manager/CamLayoutManager$a;)V
    .locals 2
    ...
    iput-object p3, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->k:Ly7/b1;
    ...
    invoke-static {p1, p2, p3, p4}, Lrt/c;->d(Lcom/android/camera/ActivityBase;ILy7/b1;I)Lo6/h;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->e:Lo6/h;

    invoke-static {p1}, Lrt/c;->c(Lo6/h;)Lo6/a;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->f:Lo6/a;

    iget-object p2, p0, Lcom/android/camera/display/manager/ExtraModuleManagerImpl;->a:Lcom/android/camera/ActivityBase;

    invoke-static {p2, p1}, Lu1/b;->H(Landroid/content/Context;Lo6/g;)V
    ...
    iget-object p0, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->f:Lo6/a;
...
.method public final G(I)V
    ...
    invoke-static {v2}, Lcom/android/camera/data/data/b0;->h(Z)V
    ...
    invoke-static {v0}, Lq4/d;->b(I)Ljava/lang/String;
    ...
    invoke-static {v6}, Lq4/d;->b(I)Ljava/lang/String;
    ...
    sget-object p1, Lo6/k;->c:Lo6/k;

    invoke-virtual {p0, p1}, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->u0(Lo6/k;)Z
...
.method public final H(I)V
    ...
    iget-object v0, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->e:Lo6/h;

    iget v0, v0, Lo6/h;->d:I

    invoke-static {p1}, Lu1/d;->f(I)I
    ...
    invoke-static {v1, v0, v2, p1}, La0/c0;->g(Ljava/lang/String;ILjava/lang/String;I)Ljava/lang/String;
...
.method public final b(Lo6/a;)V
    ...
    iget-object v2, p1, Lo6/a;->c:[I

    invoke-virtual {p1, v0, v2, v1}, Lo6/a;->n(Lcom/android/camera/ActivityBase;[ILandroid/graphics/Rect;)V

    iget-object v1, p1, Lo6/a;->d:[I

    invoke-interface {p1}, Lo6/g;->f()Landroid/graphics/Rect;

    move-result-object v2

    invoke-virtual {p1, v0, v1, v2}, Lo6/a;->n(Lcom/android/camera/ActivityBase;[ILandroid/graphics/Rect;)V

    invoke-virtual {p1, v0}, Lo6/a;->m(Lcom/android/camera/ActivityBase;)V

    invoke-virtual {p1, v0}, Lo6/a;->l(Lcom/android/camera/ActivityBase;)V
    ...
    iget-object v2, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->f:Lo6/a;
    ...
    :cond_1
    iget v4, v2, Lo6/a;->h:I

    iget v5, p1, Lo6/a;->h:I

    sget v6, Lu1/d;->g:I

    sget v7, Lu1/d;->f:I

    invoke-static {v1, v6, v7, p1}, Lu1/d;->a(Landroid/content/Context;IILo6/g;)Lu1/e;

    move-result-object v6

    iget-object v7, p1, Lo6/a;->k:Lu1/h;

    invoke-interface {v7, v6}, Lu1/h;->m2(Lu1/e;)Lu1/a;

    move-result-object v7

    instance-of v8, v7, Lu1/a;

    if-eqz v8, :cond_2

    invoke-virtual {v7, v6}, Lu1/a;->J(Lu1/e;)V
    ...
    check-cast v8, Lh1/x1;

    invoke-virtual {v8}, Lh1/x1;->b()I

    move-result v8

    iget-object v6, v6, Lu1/e;->h:Lo6/g;

    invoke-interface {v7, v8}, Lu1/g;->i(I)Landroid/graphics/Rect;
    ...
    iget-object v6, v6, Lo6/a;->l:Lt7/a;

    if-eqz v6, :cond_3

    invoke-interface {v6, v8, v7}, Lt7/a;->c(ILandroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-virtual {v3, v4, v5}, Lcom/android/camera/ActivityBase;->Ei(II)Landroid/graphics/Rect;

    move-result-object v6

    new-instance v9, Lcom/android/camera/display/manager/b$a;

    invoke-direct {v9, v1, v2, p1}, Lcom/android/camera/display/manager/b$a;-><init>(Lcom/android/camera/ActivityBase;Lo6/a;Lo6/a;)V
    ...
    invoke-virtual {v3, v8}, Lcom/android/camera/ActivityBase;->dj(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v3, v4, v6}, Lcom/android/camera/ActivityBase;->ej(II)V

    invoke-virtual {v9, v5}, Lcom/android/camera/display/manager/b$a;->onAnimationEnd(Landroid/animation/Animator;)V
    ...
    :cond_6
    invoke-virtual {v2, p1}, Lo6/a;->equals(Ljava/lang/Object;)Z
    ...
    invoke-direct {v12, v6, v8}, Lp6/h;-><init>(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-direct {v3, v0, v2, v9}, Lh2/b;-><init>(Lcom/android/camera/display/manager/b;Lo6/a;Lcom/android/camera/display/manager/b$a;)V
    ...
    invoke-direct/range {v3 .. v9}, Lcom/android/camera/display/manager/a;-><init>(Lcom/android/camera/display/manager/b;Lo6/a;Landroid/graphics/Rect;Lcom/android/camera/ActivityBase;Landroid/graphics/Rect;Lcom/android/camera/display/manager/b$a;)V
    ...
    iput-object v12, v0, Lcom/android/camera/display/manager/b;->a:Landroid/animation/ValueAnimator;

    invoke-virtual {v12}, Landroid/animation/ValueAnimator;->start()V

    :goto_1
    invoke-static {v2, p1}, Lcom/android/camera/display/manager/b;->a(Lo6/g;Lo6/g;)Z
    ...
    invoke-static {v3}, La0/m0;->f(Landroid/animation/ValueAnimator;)V
    ...
    invoke-direct {v4, v1, v2, p1}, Lh2/a;-><init>(Lcom/android/camera/ActivityBase;Lo6/a;Lo6/a;)V
    ...
    invoke-direct {v4, p1, v1, v2}, Lh2/c;-><init>(Lo6/a;Lcom/android/camera/ActivityBase;Lo6/a;)V
    ...
    invoke-interface {v0, p0, p1}, Lcom/android/camera/display/manager/CamLayoutManager$a;->onLayoutChange(Lo6/g;Lo6/g;)V
...
.method public final getLayout()Lo6/a;
    .locals 0
...
.method public final onCreate()V
    ...
    iget-object v0, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->f:Lo6/a;

    invoke-virtual {p0, v0}, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->b(Lo6/a;)V
...
.method public final onDestroy()V
    ...
    invoke-static {v0, v1}, Lu1/b;->H(Landroid/content/Context;Lo6/g;)V
    ...
    iput-object v1, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->e:Lo6/h;
...
.method public final onFoldStateChange(IZ)V
    ...
    invoke-static {p1}, Lq4/d;->b(I)Ljava/lang/String;
...
.method public final onStart()V
    ...
    iget-object v0, v0, Lq4/d;->b:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput-boolean v1, v0, Lf1/j;->m:Z

    invoke-static {}, La1/a;->i()Lf1/j;

    move-result-object v0

    iput-boolean v1, v0, Lf1/j;->n:Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->u0(Lo6/k;)Z
...
.method public final onStop()V
    ...
    invoke-static {v0}, Lcom/android/camera/data/data/b0;->h(Z)V
...
.method public final u0(Lo6/k;)Z
    .locals 11
    ...
    iget-object v4, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->k:Ly7/b1;

    iget v5, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->i:I

    invoke-static {v1, v0, v4, v5}, Lrt/c;->d(Lcom/android/camera/ActivityBase;ILy7/b1;I)Lo6/h;

    move-result-object v0

    iget-object v1, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->e:Lo6/h;

    invoke-virtual {v0, v1}, Lo6/h;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v5, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->e:Lo6/h;
    ...
    sget-object v1, Lo6/k;->b:Lo6/k;

    if-eq p1, v1, :cond_4

    sget-object v1, Lo6/k;->g:Lo6/k;
    ...
    :cond_4
    :goto_1
    invoke-static {v0}, Lrt/c;->c(Lo6/h;)Lo6/a;

    move-result-object v1

    iget-object v4, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->e:Lo6/h;

    iget v5, v4, Lo6/h;->g:I

    iget v7, v0, Lo6/h;->g:I
    ...
    :goto_2
    iget v4, v4, Lo6/h;->d:I

    iget v7, v0, Lo6/h;->d:I
    ...
    const-string v4, "updateLayout s.2 "
    ...
    iget-object v5, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->f:Lo6/a;
    ...
    iget v8, v5, Lo6/a;->h:I

    iget v9, v1, Lo6/a;->h:I

    check-cast v7, Lcom/android/camera/ActivityBase;

    invoke-virtual {v7, v8, v9}, Lcom/android/camera/ActivityBase;->Ei(II)Landroid/graphics/Rect;

    move-result-object v8

    invoke-virtual {v7, v8}, Lcom/android/camera/ActivityBase;->dj(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v7, v9, v8}, Lcom/android/camera/ActivityBase;->ej(II)V

    :cond_7
    invoke-static {v5, v1}, Lcom/android/camera/display/manager/b;->a(Lo6/g;Lo6/g;)Z
    ...
    invoke-virtual {v1, v4, v3, v7, v5}, Lo6/a;->k(Landroid/app/Activity;IFLo6/g;)V

    :cond_8
    iget-object v1, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->e:Lo6/h;

    iget v4, v0, Lo6/h;->d:I

    iput v4, v1, Lo6/h;->d:I

    iget-object v1, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->f:Lo6/a;

    iget v4, v0, Lo6/h;->d:I

    iput v4, v1, Lo6/a;->h:I
    ...
    iget-object v4, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->f:Lo6/a;

    invoke-virtual {v4, v1}, Lo6/a;->e(Lo6/g;)Z
    ...
    const-string v7, "updateLayout s.3 layout "
    ...
    invoke-static {v5, v1}, Lu1/b;->H(Landroid/content/Context;Lo6/g;)V

    iget-object v5, p0, Lcom/android/camera/display/manager/ExtraModuleManagerImpl;->a:Lcom/android/camera/ActivityBase;

    invoke-virtual {v5}, Lcom/android/camera/ActivityBase;->Ih()I
    ...
    invoke-direct {v7, v5, v8}, Lh7/g;-><init>(II)V

    :try_start_0
    iget-object v5, p0, Lcom/android/camera/display/manager/ExtraModuleManagerImpl;->a:Lcom/android/camera/ActivityBase;

    invoke-virtual {v5}, Lcom/android/camera/ActivityBase;->l()Lcom/android/camera/module/j0;
    ...
    invoke-direct {v8, v5, v9}, Lh7/k;-><init>(Lcom/android/camera/module/j0;I)V
    ...
    const-string v8, "updateLayout: "

    invoke-direct {v7, v8}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-static {v5, v7}, La0/k0;->a(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    :cond_c
    :goto_6
    invoke-virtual {p0, v1}, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->b(Lo6/a;)V

    if-eqz v4, :cond_17

    iget v5, v0, Lo6/h;->g:I

    iget-object v6, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->e:Lo6/h;

    iget v6, v6, Lo6/h;->g:I

    if-ne v5, v6, :cond_17

    iget-object v5, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->f:Lo6/a;

    invoke-interface {v5}, Lo6/g;->z()Lo6/j;

    move-result-object v5

    invoke-interface {v1}, Lo6/g;->z()Lo6/j;

    move-result-object v6

    sget-object v7, Lo6/j;->d:Lo6/j;

    sget-object v8, Lo6/j;->j:Lo6/j;

    sget-object v9, Lo6/j;->i:Lo6/j;

    sget-object v10, Lo6/j;->e:Lo6/j;
    ...
    invoke-static {v5}, Lv8/b;->a(Lo6/j;)Ljava/lang/String;
    ...
    invoke-static {v6, v2, v5}, Ltj/a;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    sget-object v5, Lo6/k;->k:Lo6/k;
    ...
    :goto_b
    invoke-static {p1, v2, v3}, Ltj/a;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    :cond_17
    iput-object v0, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->e:Lo6/h;

    iput-object v1, p0, Lcom/android/camera/display/manager/CamLayoutManagerImpl;->f:Lo6/a;
