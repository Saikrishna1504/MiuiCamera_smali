...
.field public b:Ld5/j;

.field public c:Ld5/c;

.field public d:Ld5/g;

.field public e:Ld5/e;

.field public f:Ld5/g;
...
.method public final H1(Landroid/view/MotionEvent;)V
    .locals 0

    iget-object p0, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->b:Ld5/j;

    if-eqz p0, :cond_0

    invoke-interface {p0, p1}, Ld5/j;->O(Landroid/view/MotionEvent;)V
...
.method public final L(Z)V
    ...
    invoke-interface {p0, p1}, Ld5/j;->L(Z)V
...
.method public final getSeekbarView()Landroid/view/View;
    ...
    invoke-interface {p0}, Ld5/j;->P()Landroid/view/View;
...
.method public final gh(Z)Z
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->c:Ld5/c;
    ...
    :goto_0
    iget-object v2, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->d:Ld5/g;
    ...
    :goto_1
    iget-object v3, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->b:Ld5/j;
    ...
    :goto_2
    iget-object v4, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->e:Ld5/e;
    ...
    :goto_3
    iget-object v5, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->f:Ld5/g;
    ...
    invoke-interface {v2, v1, p1}, Ly7/a2;->wh(IZ)V
    ...
    invoke-static {v1, p1}, La0/j0;->h(ILjava/util/Optional;)V
...
.method public final initView(Landroid/view/View;)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->b:Ld5/j;

    const-string v0, "bokeh panels haven\'t been loaded"

    if-nez p1, :cond_1

    iget-object v1, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->c:Ld5/c;
    ...
    iget-object v1, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->d:Ld5/g;
    ...
    iget-object p1, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->e:Ld5/e;
    ...
    iget-object p1, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->c:Ld5/c;
    ...
    invoke-virtual {p1, v0}, Ld5/c;->T(Landroid/content/Context;)V

    goto :goto_0

    :cond_4
    iget-object p1, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->d:Ld5/g;
    ...
    invoke-virtual {p1, v0}, Ld5/g;->T(Landroid/content/Context;)V
    ...
    invoke-virtual {p1, v0}, Ld5/e;->T(Landroid/content/Context;)V

    goto :goto_0

    :cond_6
    iget-object p1, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->f:Ld5/g;
    ...
    invoke-interface {p1, v0}, Ld5/j;->T(Landroid/content/Context;)V
...
.method public final isOnlySlideBar()Z
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->d:Ld5/g;
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->f:Ld5/g;

    if-nez v0, :cond_0

    iget-object p0, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->e:Ld5/e;
...
.method public final jf(II)V
    ...
    invoke-interface {p1, p2}, Ld5/j;->T(Landroid/content/Context;)V
    ...
    iget-object v0, p2, Lkg/c;->a:Lkg/a;

    if-eqz v0, :cond_2

    iget-object v0, v0, Lkg/a;->h:Ljava/util/ArrayList;
    ...
    :cond_1
    invoke-virtual {p2}, Lkg/c;->f()Ljava/util/ArrayList;
...
.method public final jh(Z)Z
    .locals 0

    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->gh(Z)Z
...
.method public final mapItemsToStringList()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lh1/w;->getItems()Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->c:Ld5/c;
    ...
    invoke-virtual {p0}, Lh1/j;->getItems()Ljava/util/List;
...
.method public final mh()V
    ...
    invoke-virtual {v0, v1}, Ld5/g;->S(Landroid/content/Context;)V

    :cond_0
    iget-object v0, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->e:Ld5/e;
    ...
    invoke-virtual {v0, v1}, Ld5/e;->S(Landroid/content/Context;)V
    ...
    :cond_2
    iget-object v0, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->b:Ld5/j;
    ...
    invoke-interface {v0, p0}, Ld5/j;->S(Landroid/content/Context;)V
...
.method public final notifyThemeChanged(II)V
    ...
    invoke-interface {p1, p2}, Ld5/j;->Q(Landroid/content/Context;)V
    ...
    invoke-interface {p1, p2}, Ld5/j;->S(Landroid/content/Context;)V
    ...
    invoke-virtual {p1, p0}, Ld5/g;->S(Landroid/content/Context;)V
...
.method public final og()V
    ...
    iput-object v0, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->c:Ld5/c;

    iput-object v0, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->d:Ld5/g;

    iput-object v0, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->e:Ld5/e;
    ...
    invoke-direct {v0, v1, v3, v4}, Ld5/g;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;Lcom/android/camera/data/data/c;)V

    iput-object v0, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->f:Ld5/g;
    ...
    invoke-direct {v0, v1, v3, v4}, Ld5/n;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;I)V

    iput-object v0, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->b:Ld5/j;

    iget-object v0, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->f:Ld5/g;

    iput-boolean v2, v0, Ld5/g;->h:Z
    ...
    invoke-direct {v0, v1, v3}, Ld5/e;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V
    ...
    invoke-direct {v0, v1, v4}, Ld5/c;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V
    ...
    invoke-direct {v0, v1, v4, v3}, Ld5/g;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;Lcom/android/camera/data/data/c;)V
    ...
    invoke-direct {v0, v1, v3}, Ld5/l;-><init>(Landroid/widget/LinearLayout;I)V
    ...
    invoke-interface {v0}, Ld5/j;->M()V

    iget-object v0, p0, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->c:Ld5/c;

    if-eqz v0, :cond_9

    invoke-virtual {v0}, Ld5/c;->M()V
...
.method public final onBackEvent(I)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->gh(Z)Z
...
.method public final provideAnimateElement(ILjava/util/List;I)V
    ...
    check-cast p2, Ld1/j0;

    invoke-virtual {p2, p1}, Ld1/j0;->getComponentValue(I)Ljava/lang/String;
    ...
    invoke-interface {p1, p0}, Ld5/j;->Q(Landroid/content/Context;)V
...
.method public final provideRotateItem(Ljava/util/List;I)V
    ...
    invoke-virtual {v0, p1, p2}, Ld5/c;->provideRotateItem(Ljava/util/List;I)V
    ...
    invoke-interface {p0, p1, p2}, Ld5/j;->provideRotateItem(Ljava/util/List;I)V
...
.method public final updateLayout4GalleryMode(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-static {p2, p1}, Li9/c;->c(ILandroid/view/View;)V
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/android/camera/fragment/fnumber/FragmentFNumberAdjust;->mh()V
...
.method public final updateView4Flip(Landroid/view/View;Landroid/os/Bundle;Z)V
    ...
    invoke-static {p0, p1}, Li9/c;->c(ILandroid/view/View;)V
...
.method public final xb()V
    ...
    iget-object v1, v0, Ld5/g;->a:Lcom/android/camera/data/data/c;
    ...
    invoke-virtual {v0, p0}, Ld5/g;->a(I)V
