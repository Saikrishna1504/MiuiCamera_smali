...
.method public constructor <init>(Lcom/android/camera/fragment/FragmentWideSelfie;)V
    ...
    iput-object p1, p0, Lcom/android/camera/fragment/FragmentWideSelfie$b;->a:Lr2/e;
    ...
    iput-object p1, p0, Lcom/android/camera/fragment/FragmentWideSelfie$b;->c:Lr2/l;
    ...
    invoke-direct {p1, v1, v0}, Lta/h;-><init>(FI)V

    iput-object p1, p0, Lcom/android/camera/fragment/FragmentWideSelfie$b;->d:Lta/h;
...
.method public final onDrawFrame(Ljavax/microedition/khronos/opengles/GL10;)V
    ...
    invoke-static {v0}, Lcom/android/camera/fragment/FragmentWideSelfie;->jd(Lcom/android/camera/fragment/FragmentWideSelfie;)Ljava/lang/String;
    ...
    iget-object v3, v1, Lcom/android/camera/ActivityBase;->k0:Lg9/f;

    if-nez v3, :cond_1

    iget-object v0, v0, Lcom/android/camera/fragment/FragmentWideSelfie$b;->f:Lcom/android/camera/fragment/FragmentWideSelfie;

    invoke-static {v0}, Lcom/android/camera/fragment/FragmentWideSelfie;->sd(Lcom/android/camera/fragment/FragmentWideSelfie;)Ljava/lang/String;
    ...
    :cond_1
    iget-object v4, v3, Lg9/f;->p:Lno/e;

    iget-object v4, v4, Lno/e;->o:Ljava/lang/Object;

    monitor-enter v4

    :try_start_0
    invoke-virtual {v3}, Lg9/f;->j()Lta/f;

    move-result-object v5

    iget-object v3, v3, Lg9/f;->o:Lta/l;

    invoke-virtual {v1}, Lcom/android/camera/ActivityBase;->getSurfaceTexture()Lap/a;

    move-result-object v6

    invoke-virtual {v6}, Lap/a;->d()Z
    ...
    iget v6, v3, Lta/a;->i:I

    iget v7, v3, Lta/a;->j:I

    iget-object v8, v3, Lta/a;->c:Lcom/android/camera/effect/v;

    invoke-virtual {v8}, Lcom/android/camera/effect/v;->d()V
    ...
    invoke-virtual {v3, v8, v9}, Lta/a;->f(II)V
    ...
    invoke-virtual {v1, v10}, Lap/a;->b([F)V
    ...
    :cond_3
    iget-object v1, v0, Lcom/android/camera/fragment/FragmentWideSelfie$b;->a:Lr2/e;
    ...
    invoke-virtual {v1, v5, v11, v12}, Lr2/e;->a(Lta/f;[FLandroid/graphics/Rect;)V

    invoke-virtual {v3, v1}, Lta/l;->a(Lr2/b;)V

    iget-object v1, v0, Lcom/android/camera/fragment/FragmentWideSelfie$b;->c:Lr2/l;

    int-to-float v5, v8

    int-to-float v8, v9

    iget-object v9, v0, Lcom/android/camera/fragment/FragmentWideSelfie$b;->d:Lta/h;

    iput v10, v1, Lr2/l;->b:F

    iput v10, v1, Lr2/l;->c:F

    iput v5, v1, Lr2/l;->d:F

    iput v8, v1, Lr2/l;->e:F

    iput-object v9, v1, Lr2/l;->f:Lta/h;

    const/4 v5, 0x1

    iput v5, v1, Lr2/b;->a:I

    invoke-virtual {v3, v1}, Lta/l;->a(Lr2/b;)V

    invoke-virtual {v3, v6, v7}, Lta/a;->f(II)V

    iget-object v1, v3, Lta/a;->c:Lcom/android/camera/effect/v;

    invoke-virtual {v1}, Lcom/android/camera/effect/v;->c()V

    invoke-virtual {v3}, Lta/a;->e()V
