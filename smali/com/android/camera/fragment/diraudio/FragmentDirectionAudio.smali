...
.method public static Ch(Lcom/android/camera/fragment/diraudio/FragmentDirectionAudio;IZ)V
    .locals 4
    ...
    :cond_1
    iget-object p2, p0, Lcom/android/camera/fragment/diraudio/FragmentDirectionAudio;->m:Ld1/c;

    invoke-virtual {p2}, Ld1/c;->h()I

    move-result p2

    iget-object v1, p0, Lcom/android/camera/fragment/diraudio/FragmentDirectionAudio;->m:Ld1/c;

    invoke-virtual {v1, p1}, Ld1/c;->m(I)V

    invoke-interface {v0}, Ly7/c0;->Te()V

    const/4 v0, 0x1

    if-nez p1, :cond_2

    iget-object v1, p0, Lcom/android/camera/fragment/diraudio/FragmentAudioGain;->c:Landroid/widget/LinearLayout;
    ...
    invoke-static {v1, v2}, La0/y6;->c(IZ)V

    goto :goto_0

    :cond_2
    iget-object v1, p0, Lcom/android/camera/fragment/diraudio/FragmentAudioGain;->f:Lcom/android/camera/fragment/diraudio/FragmentAudioGain$a;
    ...
    invoke-static {v1, v0}, La0/y6;->c(IZ)V
    ...
    invoke-virtual {v1}, Ld1/c;->getItems()Ljava/util/List;
    ...
    invoke-virtual {p2}, Ld1/c;->getItems()Ljava/util/List;
...
.method public final initView(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/diraudio/FragmentDirectionAudio;->m:Ld1/c;
    ...
    iput-object v0, p0, Lcom/android/camera/fragment/diraudio/FragmentDirectionAudio;->m:Ld1/c;
    ...
    :cond_1
    invoke-virtual {v0}, Ld1/c;->initItems()Ljava/util/List;

    :goto_0
    iget-object v0, p0, Lcom/android/camera/fragment/diraudio/FragmentDirectionAudio;->m:Ld1/c;

    invoke-virtual {v0}, Ld1/c;->h()I
    ...
    iget-object v3, p0, Lcom/android/camera/fragment/diraudio/FragmentDirectionAudio;->m:Ld1/c;

    invoke-virtual {v3}, Ld1/c;->getItems()Ljava/util/List;

    move-result-object v3

    new-instance v4, La0/r3;

    invoke-direct {v4, p0}, La0/r3;-><init>(Ljava/lang/Object;)V

    invoke-direct {v0, v1, v2, v3, v4}, Lcom/android/camera/fragment/diraudio/DirectionAudioItemAdapter;-><init>(Landroid/content/Context;ILjava/util/List;La0/r3;)V
...
.method public final mapItemsToStringList()Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/diraudio/FragmentDirectionAudio;->m:Ld1/c;

    invoke-virtual {p0}, Ld1/c;->getItems()Ljava/util/List;
