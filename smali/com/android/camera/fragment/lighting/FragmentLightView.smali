...
.field public u:Lcom/android/camera/c3;
...
.method public static synthetic Ah(Lcom/android/camera/fragment/lighting/FragmentLightView;)Lcom/android/camera/ui/LightingView;
    .locals 0
...
.method public static synthetic Bh(Lcom/android/camera/fragment/lighting/FragmentLightView;)Z
    .locals 0
...
.method private synthetic Hh(Z)V
    .locals 4
    ...
    invoke-interface {v0, v2, v1}, La7/z2;->alertFaceDetect(ZI)V

    goto :goto_0

    :pswitch_1
    invoke-virtual {p0}, Lcom/android/camera/fragment/lighting/FragmentLightView;->Fh()Z
    ...
    invoke-interface {v1, p1}, Ldg/d;->u9(Z)V
    ...
    invoke-interface {v0, v2, p0}, La7/z2;->alertFaceDetect(ZI)V
...
.method public static synthetic wh(Lcom/android/camera/fragment/lighting/FragmentLightView;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/fragment/lighting/FragmentLightView;->Hh(Z)V

    return-void
.end method

.method public static synthetic xh(Lcom/android/camera/fragment/lighting/FragmentLightView;I)I
    .locals 0
...
.method public static synthetic yh(Lcom/android/camera/fragment/lighting/FragmentLightView;II)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lcom/android/camera/fragment/lighting/FragmentLightView;->Ih(II)V

    return-void
.end method

.method public static synthetic zh(Lcom/android/camera/fragment/lighting/FragmentLightView;)I
    .locals 0
...
.method public final Ch(I)V
    ...
    invoke-interface {v0, p1}, La7/z2;->isContainAlertLightingTip(I)Z
...
.method public final Dh(IZ)V
    ...
    invoke-virtual {p0, p2, p1}, Lcom/android/camera/fragment/lighting/FragmentLightView;->Ih(II)V

    goto :goto_1

    :cond_2
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/lighting/FragmentLightView;->Ch(I)V
...
.method public final Eh(Landroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
    .locals 4
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isSupportMimoji"
...
.method public final Gh(Landroid/graphics/RectF;Landroid/graphics/RectF;)Z
    .locals 1
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isSupportMimoji"
...
.method public final declared-synchronized Ih(II)V
    .locals 4
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isSupportMimoji"
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/lighting/FragmentLightView;->Kh()V
...
.method public final Jh(Landroid/view/View;)V
    .locals 11
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isSupportMimoji"
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/lighting/FragmentLightView;->u:Lcom/android/camera/c3;
...
.method public final Lh(Landroid/graphics/Rect;Landroid/graphics/RectF;)V
    .locals 0
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isSupportMimoji"
...
.method public d2([Lcom/android/camera2/o3;Landroid/graphics/Rect;Landroid/graphics/Rect;Z)V
    .locals 5
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isSupportMimoji"
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/fragment/lighting/FragmentLightView;->Jh(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1, p4}, Lcom/android/camera/fragment/lighting/FragmentLightView;->Dh(IZ)V
    ...
    invoke-virtual {p0, p1, p3}, Lcom/android/camera/fragment/lighting/FragmentLightView;->Lh(Landroid/graphics/Rect;Landroid/graphics/RectF;)V
    ...
    invoke-virtual {p0, p1, p3}, Lcom/android/camera/fragment/lighting/FragmentLightView;->Gh(Landroid/graphics/RectF;Landroid/graphics/RectF;)Z

    move-result v0

    if-eqz v0, :cond_a

    invoke-virtual {p0, p1, p3}, Lcom/android/camera/fragment/lighting/FragmentLightView;->Eh(Landroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
    ...
    :cond_a
    :goto_3
    invoke-virtual {p0, p2, p4}, Lcom/android/camera/fragment/lighting/FragmentLightView;->Dh(IZ)V
...
.method public initView(Landroid/view/View;)V
    ...
    iput-object p1, p0, Lcom/android/camera/fragment/lighting/FragmentLightView;->u:Lcom/android/camera/c3;
...
.method public provideAnimateElement(ILjava/util/List;I)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/lighting/FragmentLightView;->J3()Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-virtual {p0}, Lcom/android/camera/fragment/lighting/FragmentLightView;->Ud()Z
