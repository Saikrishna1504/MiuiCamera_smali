...
.method public static synthetic Rh(Lcom/android/camera/fragment/FragmentSuperMoon;Lb0/v;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/fragment/FragmentSuperMoon;->bi(Lb0/v;)V

    return-void
.end method

.method public static synthetic Sh(Lcom/android/camera/fragment/FragmentSuperMoon;Landroid/widget/FrameLayout$LayoutParams;Landroid/util/Size;II)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/camera/fragment/FragmentSuperMoon;->ai(Landroid/widget/FrameLayout$LayoutParams;Landroid/util/Size;II)V
...
.method public static synthetic Th(La7/z2;)V
    ...
    invoke-static {p0}, Lcom/android/camera/fragment/FragmentSuperMoon;->Zh(La7/z2;)V
...
.method private synthetic ai(Landroid/widget/FrameLayout$LayoutParams;Landroid/util/Size;II)V
    .locals 2
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/camera/fragment/FragmentSuperMoon;->Jh(Landroid/view/View;I)V

    return-void
.end method

.method private synthetic bi(Lb0/v;)V
    .locals 0

    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/FragmentWatermarkBase;->if(Lb0/v;)V
...
.method public Dh(ILjava/lang/String;)Ld0/e;
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentSuperMoon;->Xh()Ld0/e;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/camera/fragment/FragmentSuperMoon;->Jh(Landroid/view/View;I)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentSuperMoon;->Yh()Ld0/e;
    ...
    :pswitch_0
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentSuperMoon;->Wh()Ld0/e;
    ...
    :pswitch_1
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentSuperMoon;->Vh()Ld0/e;
    ...
    :pswitch_2
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentSuperMoon;->Uh()Ld0/e;
...
.method public Nh(Lw0/e;Lb0/v;)V
    ...
    invoke-virtual {p0, p2, v0}, Lcom/android/camera/fragment/FragmentSuperMoon;->ci(Lb0/v;Lb0/v;)V

    invoke-super {p0, p1, p2}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Nh(Lw0/e;Lb0/v;)V
...
.method public Qh()V
    ...
    invoke-virtual {p0, v3, v0, v1, v8}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Ph(Landroid/graphics/Rect;Lw0/e;Lb0/v;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v8, v6}, Lcom/android/camera/fragment/FragmentSuperMoon;->Jh(Landroid/view/View;I)V
    ...
    invoke-virtual {p0, v3, v0, v2, v5}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Ph(Landroid/graphics/Rect;Lw0/e;Lb0/v;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v6}, Lcom/android/camera/fragment/FragmentSuperMoon;->Jh(Landroid/view/View;I)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/camera/fragment/FragmentSuperMoon;->di(Lb0/v;)V

    invoke-virtual {p0, v4}, Lcom/android/camera/fragment/FragmentWatermarkBase;->H3(I)V

    goto :goto_2

    :cond_4
    invoke-virtual {p0, v6}, Lcom/android/camera/fragment/FragmentWatermarkBase;->H3(I)V
...
.method public final ci(Lb0/v;Lb0/v;)V
    .locals 1
...
.method public de(Lb0/v;Z)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/android/camera/fragment/e4;-><init>(Lcom/android/camera/fragment/FragmentSuperMoon;Lb0/v;)V
...
.method public final di(Lb0/v;)V
    .locals 9
    ...
    invoke-static {p1, v1}, Lze/b;->d(Landroid/content/Context;I)Landroid/util/Size;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/android/camera/fragment/f4;-><init>(Lcom/android/camera/fragment/FragmentSuperMoon;Landroid/widget/FrameLayout$LayoutParams;Landroid/util/Size;II)V
...
.method public notifyLayoutChange()V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/android/camera/fragment/FragmentSuperMoon;->Jh(Landroid/view/View;I)V
