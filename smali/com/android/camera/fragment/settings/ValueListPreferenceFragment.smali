...
.method public final fc()V
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/settings/ValueListPreferenceFragment;->V:Lu5/h;

    iget-object v2, v0, Lu5/h;->a:Ljava/lang/String;

    iget-object v3, v0, Lu5/h;->b:[Ljava/lang/String;

    iget-object v4, v0, Lu5/h;->c:[Ljava/lang/String;

    iget-boolean v5, v0, Lu5/h;->f:Z

    move-object v0, p0

    invoke-virtual/range {v0 .. v5}, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->Wc(Landroidx/preference/PreferenceScreen;Ljava/lang/String;[Ljava/lang/CharSequence;[Ljava/lang/CharSequence;Z)Lmiuix/preference/SingleChoicePreferenceCategory;
...
.method public final onPause()V
    ...
    invoke-static {v0, p0}, La0/y;->k(ILjava/util/Optional;)V
...
.method public final onPreferenceClick(Landroidx/preference/Preference;)Z
    ...
    invoke-virtual {p0, v1, v0}, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->gh(Ljava/lang/Object;Ljava/lang/String;)V

    iget-object p0, p0, Lcom/android/camera/fragment/settings/ValueListPreferenceFragment;->V:Lu5/h;

    iget-object p0, p0, Lu5/h;->h:Lu5/i;

    if-eqz p0, :cond_0

    check-cast p1, Lmiuix/preference/SingleChoicePreferenceCategory;

    invoke-interface {p0, p1}, Lu5/i;->c(Lmiuix/preference/SingleChoicePreferenceCategory;)V
...
.method public final onResume()V
    ...
    iget-object v1, v0, Lu5/h;->a:Ljava/lang/String;

    iget-object v0, v0, Lu5/h;->e:Ljava/lang/String;
    ...
    :goto_2
    iget-object v3, p0, Lcom/android/camera/fragment/settings/ValueListPreferenceFragment;->V:Lu5/h;

    iget-object v4, v3, Lu5/h;->b:[Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/android/camera/fragment/settings/ValueListPreferenceFragment;->V:Lu5/h;

    iget-object v5, v5, Lu5/h;->c:[Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/camera/fragment/settings/ValueListPreferenceFragment;->V:Lu5/h;

    iget-object v4, v4, Lu5/h;->c:[Ljava/lang/String;
    ...
    invoke-virtual {v4, v3}, Lmiuix/preference/SingleChoicePreferenceCategory;->g(Landroidx/preference/Preference;)V
    ...
    :cond_6
    iget-object v0, v3, Lu5/h;->d:[Ljava/lang/String;
    ...
    iget-object v0, v0, Lu5/h;->d:[Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/camera/fragment/settings/ValueListPreferenceFragment;->V:Lu5/h;

    iget-object v1, v1, Lu5/h;->d:[Ljava/lang/String;
...
.method public final setArguments(Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, Lu5/g;->a(Ljava/lang/String;)Lu5/h;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/fragment/settings/ValueListPreferenceFragment;->V:Lu5/h;
