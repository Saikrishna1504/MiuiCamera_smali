...
.method public constructor <init>(Landroid/view/ViewGroup;ZLcom/android/camera/fragment/bottom/action/f;)V
    ...
    invoke-direct {v0, p0, v1}, Lh4/e;-><init>(Ljava/lang/Object;I)V

    iput-object v0, p0, Lcom/android/camera/fragment/bottom/action/c;->f:Lh4/e;
    ...
    invoke-direct {v7, v6}, Lr5/n;-><init>(Lr5/n$a;)V
    ...
    invoke-static {}, Lcom/android/camera2/compat/theme/custom/mm/top/TopBarUtils;->getMasterFilterItemBuilder()Lr5/n$a;
    ...
    invoke-static {}, Lcom/android/camera2/compat/theme/custom/mm/top/TopBarUtils;->getShineItemBuilder()Lr5/n$a;
    ...
    invoke-direct {v4}, Lr5/n$a;-><init>()V

    const/16 v5, 0x210

    iput v5, v4, Lr5/n$a;->a:I

    new-instance v5, Lv4/k;

    invoke-direct {v5, v3}, Lv4/k;-><init>(I)V

    iput-object v5, v4, Lr5/n$a;->c:Lr5/n$c;

    new-instance v5, Ld3/p;

    invoke-direct {v5, v1}, Ld3/p;-><init>(I)V

    iput-object v5, v4, Lr5/n$a;->e:Landroid/view/View$OnClickListener;
    ...
    invoke-direct {v5, v3}, Lv4/h;-><init>(I)V

    iput-object v5, v4, Lr5/n$a;->c:Lr5/n$c;

    new-instance v5, Lv4/i;

    invoke-direct {v5, v3}, Lv4/i;-><init>(I)V
    ...
    invoke-direct {v5, v3}, Lv4/j;-><init>(I)V
    ...
    iget-object v8, p0, Lcom/android/camera/fragment/bottom/action/c;->f:Lh4/e;
    ...
    invoke-static {v8, v6, v7}, Ln0/i;->l(IFLandroid/view/View;)V
    ...
    invoke-static {v6, v7}, Lcom/android/camera/fragment/bottom/action/c;->a(Lr5/n;Landroid/widget/ImageView;)V
...
.method public static a(Lr5/n;Landroid/widget/ImageView;)V
    .locals 7
    ...
    invoke-virtual {v1, v4}, Ld1/q;->v(I)Z

    move-result v1

    xor-int/lit8 v1, v1, 0x1

    iput-boolean v1, p0, Lr5/n;->d:Z

    :cond_0
    const/4 v1, 0x0

    iget-object v5, p0, Lr5/n;->g:Lr5/n$c;
    ...
    iget-boolean v1, v4, Lr5/o;->i:Z

    const/4 v5, 0x0

    iget-boolean v6, v4, Lr5/o;->h:Z
    ...
    :cond_7
    iget-object p0, v4, Lr5/o;->g:Ljava/lang/String;
...
.method public final c(I)V
    ...
    invoke-static {v1, v0}, Lcom/android/camera/fragment/bottom/action/c;->a(Lr5/n;Landroid/widget/ImageView;)V
    ...
    invoke-static {p0, p1}, Lcom/android/camera/fragment/bottom/action/c;->a(Lr5/n;Landroid/widget/ImageView;)V
