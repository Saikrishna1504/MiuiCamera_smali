...
.implements Lcom/android/camera/c3$b;
...
.field protected mComponentRunningFilter:Lw0/q0;

.field protected mCoverRenderEngine:Llj/b;

.field protected mCubicEaseOut:Lyn/f;
...
.field protected mFilterGLThread:Lnj/l;
...
.method private drawRealTimeItem(Landroid/view/View;Lcom/android/camera/ui/h1;)V
    ...
    :try_start_0
    invoke-virtual {p1}, Lcom/android/camera/fragment/EffectItemAdapter$EffectItemHolder;->getEglSurface()Lnj/e;
    ...
    iget-object v2, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lw0/q0;

    invoke-virtual {v2}, Lw0/q0;->getItems()Ljava/util/List;
    ...
    invoke-virtual {p0, v1, v0, p2}, Lcom/android/camera/fragment/FragmentFilter;->drawRealTimeEngine(ILnj/e;Lcom/android/camera/ui/h1;)V
...
.method public static final getFilterInfo()Ljava/util/ArrayList;
    ...
    invoke-direct {v1}, Lcom/android/camera/fragment/c3;-><init>()V
...
.method private synthetic lambda$drawRealtimeFilterOnGLThread$2()V
    ...
    iget-object v1, p0, Lcom/android/camera/fragment/FragmentFilter;->mCoverRenderEngine:Llj/b;

    invoke-virtual {v1}, Llj/b;->d()Lij/h0;

    move-result-object v1

    sget-object v2, Lij/h0;->b:Lij/h0;
    ...
    invoke-interface {v1}, Lcom/android/camera/ui/h1;->q()Ljava/lang/Object;
...
.method private synthetic lambda$releaseGL$1()V
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/FragmentFilter;->mCoverRenderEngine:Llj/b;

    invoke-virtual {v0}, Llj/b;->j()V

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/camera/fragment/FragmentFilter;->mFilterGLThread:Lnj/l;

    iput-object v0, p0, Lcom/android/camera/fragment/FragmentFilter;->mCoverRenderEngine:Llj/b;
...
.method public static synthetic qh(Lcom/android/camera/fragment/FragmentFilter;)V
    .locals 0
...
.method private releaseGL()V
    ...
    iget-object v1, p0, Lcom/android/camera/fragment/FragmentFilter;->mFilterGLThread:Lnj/l;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lnj/l;->e()Landroid/os/Handler;
    ...
    new-instance v3, Lcom/android/camera/fragment/e3;

    invoke-direct {v3, p0}, Lcom/android/camera/fragment/e3;-><init>(Lcom/android/camera/fragment/FragmentFilter;)V
...
.method public static synthetic rh(Lcom/android/camera/fragment/FragmentFilter;)V
    .locals 0
...
.method public static synthetic sh(I)Z
    .locals 0
...
# virtual methods
.method public drawRealTimeEngine(ILnj/e;Lcom/android/camera/ui/h1;)V
    .locals 11

    invoke-interface {p3}, Lcom/android/camera/ui/h1;->q()Ljava/lang/Object;

    move-result-object v0

    invoke-interface {p3}, Lcom/android/camera/ui/h1;->Z()Lcom/android/gallery3d/ui/f;
    ...
    invoke-interface {p3}, Lcom/android/camera/ui/h1;->b()Lij/a;

    move-result-object v5

    invoke-virtual {p2}, Lnj/d;->d()I

    move-result v7

    invoke-virtual {p2}, Lnj/d;->c()I
    ...
    iget-object v2, p0, Lcom/android/camera/fragment/FragmentFilter;->mCoverRenderEngine:Llj/b;

    iget v3, p0, Lcom/android/camera/fragment/FragmentFilter;->mTextureWidth:I

    invoke-virtual {v2, v3, p3}, Llj/b;->f(II)V

    sget p3, Lcom/android/camera/effect/q;->x:I
    ...
    :try_start_0
    iget-object p3, p0, Lcom/android/camera/fragment/FragmentFilter;->mCoverRenderEngine:Llj/b;
    ...
    invoke-virtual {p3, v2, v3, v9, v10}, Llj/b;->l(IIII)V
    ...
    invoke-virtual {p3, v1, v6, v5}, Llj/b;->m(I[FLij/a;)V
    ...
    invoke-virtual {p3, p1}, Lcom/android/camera/effect/o;->getFilterRendererAttribute(I)Lmj/b;
    ...
    invoke-virtual {p3, v8}, Llj/b;->n(I)V

    iget-object v2, p0, Lcom/android/camera/fragment/FragmentFilter;->mCoverRenderEngine:Llj/b;

    move v3, p1

    invoke-virtual/range {v2 .. v9}, Llj/b;->h(IZLij/a;[FIILmj/b;)V

    invoke-virtual {p2}, Lnj/e;->j()Z
...
.method public drawRealtimeFilterOnGLThread()V
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/FragmentFilter;->mFilterGLThread:Lnj/l;
    ...
    invoke-direct {v0, p0}, Lcom/android/camera/fragment/d3;-><init>(Lcom/android/camera/fragment/FragmentFilter;)V
    ...
    invoke-virtual {v0, p0}, Lnj/l;->j(Ljava/lang/Runnable;)Z
...
.method public initGL()V
    ...
    invoke-interface {v1}, Lcom/android/camera/ui/h1;->e0()Lnj/l;

    move-result-object v1

    iput-object v1, p0, Lcom/android/camera/fragment/FragmentFilter;->mFilterGLThread:Lnj/l;
    ...
    iget-object v4, p0, Lcom/android/camera/fragment/FragmentFilter;->mFilterGLThread:Lnj/l;

    invoke-direct {v1, v3, v4}, Llj/b;-><init>(Landroid/content/Context;Lnj/l;)V

    iput-object v1, p0, Lcom/android/camera/fragment/FragmentFilter;->mCoverRenderEngine:Llj/b;
...
.method public initView(Landroid/view/View;)V
    ...
    invoke-virtual {v0}, Lw0/k1;->W()Lw0/q0;

    move-result-object v0

    iput-object v0, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lw0/q0;
    ...
    :goto_0
    iget-object v0, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lw0/q0;

    iget v2, p0, Lcom/android/camera/fragment/FragmentFilter;->mCurrentMode:I

    invoke-virtual {v0, p1, v2}, Lw0/q0;->d(Ljava/util/ArrayList;I)V

    iget-object p1, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lw0/q0;
    ...
    iget-object v2, p0, Lcom/android/camera/fragment/FragmentFilter;->mFilterGLThread:Lnj/l;
    ...
    invoke-virtual {v2}, Lnj/l;->d()Lnj/b;

    move-result-object v2

    invoke-direct {v3, v0, p1, v4, v2}, Lcom/android/camera/fragment/EffectItemAdapter;-><init>(Landroid/content/Context;Lcom/android/camera/data/data/a;ZLnj/b;)V
    ...
    iput-object p1, p0, Lcom/android/camera/fragment/FragmentFilter;->mCubicEaseOut:Lyn/f;
...
.method public isMutexOther()Z
    ...
    invoke-virtual {v0}, Lw0/q0;->getItems()Ljava/util/List;
...
.method public measure()V
    ...
    invoke-virtual {v0}, Lcom/android/camera/i5;->r()I

    move-result v1

    invoke-virtual {v0}, Lcom/android/camera/i5;->h()I
...
.method public notifyItemChanged(II)V
    ...
    iget-object v4, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lw0/q0;

    if-eqz v4, :cond_1

    invoke-virtual {v4}, Lw0/q0;->getItems()Ljava/util/List;
    ...
    invoke-virtual {p1}, Lw0/q0;->getItems()Ljava/util/List;
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-interface {p1}, Lc7/g;->G7()V
...
.method public onItemSelected(IZ)V
    ...
    iget-object v5, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lw0/q0;

    invoke-virtual {v5}, Lw0/q0;->getItems()Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lw0/q0;

    invoke-virtual {v6, v3, v5}, Lw0/q0;->e(ZI)V
    ...
    invoke-static {v4, p2}, Lq7/a;->G1(IZ)V
    ...
    invoke-virtual {p2}, Li6/g;->J()Lcom/android/camera2/f;

    move-result-object p2

    invoke-static {p2}, Lcom/android/camera2/g;->M3(Lcom/android/camera2/f;)Z
    ...
    invoke-interface {v1, v3, v0, v0, v3}, La7/b0;->ea(ZLjava/lang/String;Ljava/lang/String;Z)V

    :cond_3
    invoke-interface {v1, v4}, La7/b0;->cg(I)V
    :try_end_0
...
.method public onPause()V
    ...
    invoke-interface {v0, p0}, Lcom/android/camera/ui/h1;->t(Lcom/android/camera/c3$b;)V
...
.method public onResume()V
    ...
    invoke-interface {v0, p0}, Lcom/android/camera/ui/h1;->c0(Lcom/android/camera/c3$b;)V
...
.method public reInit()V
    ...
    invoke-virtual {v0, v1}, Lw0/q0;->getComponentValue(I)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lw0/q0;
...
.method public updateCurrentIndex()V
    ...
    invoke-virtual {v1, v0}, Lw0/q0;->getComponentValue(I)Ljava/lang/String;
