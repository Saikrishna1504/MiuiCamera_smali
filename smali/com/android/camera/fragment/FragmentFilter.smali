...
.field public c:Lso/j;

.field public d:Z

.field public e:Z

.field public f:Landroidx/core/widget/a;

.field public g:Lqo/a;
...
.method public static Yh(Lcom/android/camera/fragment/FragmentFilter;)V
    .locals 8
    ...
    iget-object v1, p0, Lcom/android/camera/fragment/FragmentFilter;->g:Lqo/a;

    if-eqz v1, :cond_a

    iget v1, v1, Lqo/a;->g:I
    ...
    iget-object v3, v1, Lg9/f;->p:Lno/e;
    ...
    invoke-virtual {v0}, Lcom/android/camera/ActivityBase;->getSurfaceTexture()Lap/a;
    ...
    invoke-direct {v5, v3, v4}, Loo/b;-><init>(II)V

    iput-object v5, v0, Lqo/a;->e:Loo/b;
    ...
    iget-object v0, v0, Lqo/a;->e:Loo/b;
    ...
    :try_start_0
    invoke-virtual {v3}, Lcom/android/camera2/compat/theme/custom/cv/RealtimeEffectItemAdapter$EffectRealtimeItemHolderCV;->getEglSurface()Lso/f;
    ...
    invoke-virtual {p0, v5, v4, v1}, Lcom/android/camera/fragment/FragmentFilter;->bi(ILso/f;Lg9/f;)V
    ...
    iget-object v0, v0, Lcom/android/camera2/compat/theme/custom/cv/RealtimeEffectItemAdapter$SurfaceRealTimeTextureListener;->mEglSurface:Lso/f;

    if-eqz v0, :cond_a

    const v2, 0x10200

    invoke-virtual {p0, v2, v0, v1}, Lcom/android/camera/fragment/FragmentFilter;->bi(ILso/f;Lg9/f;)V
...
.method public static ai(Lcom/android/camera/fragment/FragmentFilter;)V
    ...
    iput-object v1, v0, Lqo/a;->e:Loo/b;

    :cond_0
    iget-object v3, v0, Lqo/a;->j:Ljava/util/HashMap;
    ...
    invoke-virtual {v5}, Lyo/h;->d()V

    goto :goto_0

    :cond_2
    iget-object v4, v0, Lqo/a;->d:Lwo/a;
    ...
    :cond_3
    iget-object v4, v0, Lqo/a;->c:Lwo/a;
    ...
    :cond_5
    iput-object v1, p0, Lcom/android/camera/fragment/FragmentFilter;->c:Lso/j;

    iput-object v1, p0, Lcom/android/camera/fragment/FragmentFilter;->g:Lqo/a;
...
.method public final A()V
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/FragmentFilter;->c:Lso/j;
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/camera/fragment/FragmentFilter;->f:Landroidx/core/widget/a;
    ...
    iput-object v1, p0, Lcom/android/camera/fragment/FragmentFilter;->f:Landroidx/core/widget/a;

    :cond_1
    iget-object p0, p0, Lcom/android/camera/fragment/FragmentFilter;->f:Landroidx/core/widget/a;

    invoke-virtual {v0, p0}, Lso/j;->b(Ljava/lang/Runnable;)V
...
.method public final bi(ILso/f;Lg9/f;)V
    .locals 23
    ...
    invoke-virtual/range {p3 .. p3}, Lg9/f;->s()Lso/a;

    move-result-object v3

    invoke-virtual/range {p3 .. p3}, Lg9/f;->c()[F

    move-result-object v4

    invoke-virtual/range {p2 .. p2}, Lso/e;->b()I

    move-result v5

    invoke-virtual/range {p2 .. p2}, Lso/e;->a()I
    ...
    iget-object v11, v10, Lg9/f;->p:Lno/e;

    iget-object v11, v11, Lno/e;->o:Ljava/lang/Object;

    invoke-virtual/range {p3 .. p3}, Lg9/f;->j()Lta/f;
    ...
    iget-object v13, v0, Lcom/android/camera/fragment/FragmentFilter;->g:Lqo/a;
    ...
    iget-object v13, v13, Lqo/a;->h:Landroid/graphics/Rect;

    invoke-virtual {v13, v14, v15, v8, v9}, Landroid/graphics/Rect;->set(IIII)V

    iget-object v8, v0, Lcom/android/camera/fragment/FragmentFilter;->g:Lqo/a;
    ...
    invoke-static {v12, v9, v10}, Lso/i;->g(II[F)V

    iget-object v13, v8, Lqo/a;->c:Lwo/a;

    iget-object v9, v8, Lqo/a;->e:Loo/b;

    iget-object v12, v9, Loo/b;->c:[I
    ...
    iget-object v9, v8, Lqo/a;->h:Landroid/graphics/Rect;

    iget-object v8, v8, Lqo/a;->f:Lso/h;
    ...
    invoke-virtual/range {v13 .. v22}, Lwo/a;->a(ILso/a;ILso/a;II[FLandroid/graphics/Rect;Lso/h;)V
    ...
    invoke-virtual {v10, v1, v8}, Lcom/android/camera/effect/r;->getFilterRendererAttribute(IZ)Lro/c;
    ...
    invoke-direct {v10}, Lro/b;-><init>()V

    iput v1, v10, Lro/b;->a:I

    iput-boolean v7, v10, Lro/b;->f:Z

    const/4 v1, 0x1

    iput-boolean v1, v10, Lro/b;->c:Z

    iput-object v3, v10, Lro/b;->i:Lso/a;

    iput-object v3, v10, Lro/b;->j:Lso/a;

    iput-object v4, v10, Lro/b;->k:[F

    iput v5, v10, Lro/b;->p:I

    iput v6, v10, Lro/b;->q:I

    iput-object v8, v10, Lro/b;->r:Lro/c;

    iget-object v3, v2, Lso/f;->f:Ljava/lang/Object;

    monitor-enter v3

    :try_start_2
    iget-boolean v4, v2, Lso/f;->e:Z

    if-eqz v4, :cond_5

    iget-object v4, v2, Lso/e;->b:Landroid/opengl/EGLSurface;

    iget-object v7, v2, Lso/e;->a:Lso/c;

    iget-object v7, v7, Lso/c;->b:Landroid/opengl/EGLContext;
    ...
    iget-object v8, v7, Lso/c;->a:Landroid/opengl/EGLDisplay;
    ...
    :cond_7
    iget-object v0, v0, Lcom/android/camera/fragment/FragmentFilter;->g:Lqo/a;

    invoke-virtual {v0, v10}, Lqo/a;->a(Lro/b;)V

    monitor-exit v3
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_2

    invoke-virtual/range {p2 .. p2}, Lso/f;->g()Z
...
.method public final ci()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentFilter;->gi()Z
    ...
    iget-object v2, v0, Lg9/f;->s:Lso/j;

    if-nez v2, :cond_0

    new-instance v2, Lso/j;

    iget-object v3, v0, Lg9/f;->p:Lno/e;

    iget-object v3, v3, Lno/e;->h:Landroid/opengl/EGLContext;

    sget-object v4, Lcom/xiaomi/gl/core/MIEGL;->EGL_CONFIG_R8G8B8A8S0D0:[I

    const-string v5, "ExternalGLThread"

    invoke-direct {v2, v5, v3, v4}, Lso/j;-><init>(Ljava/lang/String;Landroid/opengl/EGLContext;[I)V

    iput-object v2, v0, Lg9/f;->s:Lso/j;

    :cond_0
    iget-object v0, v0, Lg9/f;->s:Lso/j;

    iput-object v0, p0, Lcom/android/camera/fragment/FragmentFilter;->c:Lso/j;
    ...
    iget-object v3, p0, Lcom/android/camera/fragment/FragmentFilter;->c:Lso/j;

    iget-object v3, v3, Lso/j;->b:Landroid/os/Handler;

    invoke-direct {v0, v2, v3}, Lqo/a;-><init>(Landroid/content/Context;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/android/camera/fragment/FragmentFilter;->g:Lqo/a;
...
.method public final di(Landroid/view/View;Ld1/a;)V
    .locals 3
    ...
    iget-object p1, p0, Lcom/android/camera/fragment/FragmentFilter;->c:Lso/j;

    if-eqz p1, :cond_2

    new-instance v1, Lcom/android/camera2/compat/theme/custom/cv/RealtimeEffectItemAdapter$SurfaceRealTimeTextureListener;

    invoke-virtual {p1}, Lso/j;->a()Lso/c;

    move-result-object p1

    invoke-direct {v1, p1}, Lcom/android/camera2/compat/theme/custom/cv/RealtimeEffectItemAdapter$SurfaceRealTimeTextureListener;-><init>(Lso/c;)V
...
.method public final ei()V
    ...
    invoke-virtual {v0}, Lcom/android/camera/ActivityBase;->C()La0/y4;

    move-result-object v0

    iget v1, v0, La0/c7;->a:I

    iget v0, v0, La0/c7;->b:I
...
.method public final getComponentConfigFilter()Ld1/a;
    ...
    sget-object p0, Ld1/n;->e:Ljava/util/List;
...
.method public final getEffectItemAdapter()Lcom/android/camera/fragment/BaseHeaderFilterItemAdapter;
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/FragmentFilter;->c:Lso/j;

    invoke-virtual {p0}, Lso/j;->a()Lso/c;

    move-result-object p0

    invoke-direct {v0, v1, v2, v3, p0}, Lcom/android/camera2/compat/theme/custom/cv/RealtimeEffectItemAdapter;-><init>(Landroid/content/Context;Lcom/android/camera/data/data/c;ZLso/c;)V
...
.method public final gi()Z
    ...
    invoke-virtual {v0}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->L7()Z
...
.method public final initView(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentFilter;->ci()V
    ...
    :goto_0
    invoke-virtual {p0, p1, v2}, Lcom/android/camera/fragment/FragmentFilter;->di(Landroid/view/View;Ld1/a;)V
...
.method public final onFilterItemSelected(IZ)V
    ...
    invoke-interface {p1, p2}, Ly7/c0;->Cg(I)V
...
.method public final onPause()V
    ...
    invoke-virtual {v0, p0}, Lg9/f;->x(Lno/g;)V
    ...
    iget-object v2, p0, Lcom/android/camera/fragment/FragmentFilter;->f:Landroidx/core/widget/a;
    ...
    invoke-direct {v2, p0, v3}, La0/i0;-><init>(Ljava/lang/Object;I)V
...
.method public final onResume()V
    ...
    iget-object v1, v0, Lg9/f;->j:La0/y4;

    if-eqz v1, :cond_0

    invoke-virtual {v1, p0}, La0/y4;->f(Lno/g;)V

    :cond_0
    iget-object v1, v0, Lg9/f;->q:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v0, v0, Lg9/f;->w:Ljava/util/ArrayList;
...
.method public final onViewCreatedAndVisibleToUser(Z)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentFilter;->ei()V
...
.method public final setFilter(Ljava/lang/String;IZ)V
    ...
    invoke-virtual {p2}, Luc/b;->t2()Z

    move-result p2

    if-eqz p2, :cond_2

    invoke-static {p1}, Lpa/b;->a(I)V
    ...
    :cond_3
    invoke-interface {p2, p1}, Ly7/c0;->Cg(I)V
...
.method public final trackCloudFilterChanged(Ljava/lang/String;Z)V
    ...
    invoke-static {p1, p2}, Ln8/a;->E(Ljava/lang/String;Z)V
...
.method public final trackFilterChanged(IZ)V
    ...
    invoke-static {p1, p2}, Ln8/a;->M(IZ)V
