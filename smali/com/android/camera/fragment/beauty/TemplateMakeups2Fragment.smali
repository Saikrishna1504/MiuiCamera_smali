...
.method public static synthetic hi(Lcom/android/camera/fragment/beauty/TemplateMakeups2Fragment;Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lcom/android/camera/fragment/beauty/TemplateMakeups2Fragment;->ji(Landroid/widget/AdapterView;Landroid/view/View;IJ)V

    return-void
.end method

.method private synthetic ji(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    .locals 0
    ...
    iput-object p1, p0, Lcom/android/camera/fragment/beauty/TemplateMakeups2Fragment;->q0:Ljava/lang/String;
    ...
    invoke-interface {p0}, Lc7/g;->G7()V
...
.method public F1()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/beauty/TemplateMakeups2Fragment;->q0:Ljava/lang/String;
...
.method public Kh()Landroid/widget/AdapterView$OnItemClickListener;
    ...
    invoke-direct {v0, p0}, Lcom/android/camera/fragment/beauty/s0;-><init>(Lcom/android/camera/fragment/beauty/TemplateMakeups2Fragment;)V
...
.method public handleMutex(Z)V
    ...
    invoke-static {p1}, Lcom/android/camera/e3;->W7(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/TemplateMakeups2Fragment;->ii()Ljava/lang/String;

    move-result-object p0

    invoke-interface {p1, p0, v0}, Lc7/g;->m4(Ljava/lang/String;Z)V
...
.method public isMutexOther()Z
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/beauty/TemplateMakeups2Fragment;->q0:Ljava/lang/String;
...
.method public oneKeyCloseMutex()V
    ...
    iput-object v0, p0, Lcom/android/camera/fragment/beauty/TemplateMakeups2Fragment;->q0:Ljava/lang/String;
...
.method public r8()Ljava/util/List;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Ljava/util/List<",
            "Lcom/android/camera/fragment/beauty/r0;",
            ">;"
        }
    .end annotation
    ...
    invoke-direct {v1}, Lcom/android/camera/fragment/beauty/r0;-><init>()V

    const-string v2, "sub_makeup"

    iput-object v2, v1, Lcom/android/camera/fragment/beauty/r0;->a:Ljava/lang/String;

    const v3, 0x7f080315

    iput v3, v1, Lcom/android/camera/fragment/beauty/r0;->b:I

    const v3, 0x7f080310

    iput v3, v1, Lcom/android/camera/fragment/beauty/r0;->c:I

    iget-object v4, p0, Lcom/android/camera/fragment/beauty/TemplateMakeups2Fragment;->q0:Ljava/lang/String;
    ...
    :goto_0
    iput-boolean v2, v1, Lcom/android/camera/fragment/beauty/r0;->d:Z

    const v2, 0x7f13020f

    iput v2, v1, Lcom/android/camera/fragment/beauty/r0;->e:I
    ...
    iput v4, v1, Lcom/android/camera/fragment/beauty/r0;->b:I
    ...
    :goto_1
    iput-boolean p0, v1, Lcom/android/camera/fragment/beauty/r0;->d:Z

    const p0, 0x7f13020e

    iput p0, v1, Lcom/android/camera/fragment/beauty/r0;->e:I
