...
# direct methods
.method public constructor <init>(ZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/o5;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    .line 1
    invoke-direct/range {v0 .. v5}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;-><init>(ZZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/o5;)V

    return-void
.end method

.method public constructor <init>(ZZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/o5;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
...
.method public bridge synthetic k([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;->w([Ljava/lang/Void;)Lcom/android/camera/o5;
...
.method public bridge synthetic u(Ljava/lang/Object;)V
    ...
    check-cast p1, Lcom/android/camera/o5;

    invoke-virtual {p0, p1}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;->x(Lcom/android/camera/o5;)V

    return-void
.end method

.method public varargs w([Ljava/lang/Void;)Lcom/android/camera/o5;
    .locals 17
    ...
    invoke-static {v6}, Lcom/android/camera/o5;->s(Landroid/content/ContentResolver;)Lcom/android/camera/o5$b;
    ...
    :cond_2
    iget-object v0, v7, Lcom/android/camera/o5$b;->d:Landroid/net/Uri;
    ...
    check-cast v0, Lcom/android/camera/o5;
    ...
    invoke-static {v11, v6}, Lcom/android/camera/g6;->s3(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
    ...
    :cond_3
    iget-wide v13, v7, Lcom/android/camera/o5$b;->j:J

    :goto_1
    invoke-virtual {v0, v13, v14}, Lcom/android/camera/o5;->M(J)V
    ...
    invoke-virtual {v3}, Lcom/android/camera/ActivityBase;->F9()Z
    ...
    invoke-static {v3, v6}, Lcom/android/camera/o5;->v(Landroid/content/Context;Landroid/content/ContentResolver;)Lcom/android/camera/o5;
    ...
    :cond_d
    new-array v8, v10, [Lcom/android/camera/o5;

    const/4 v11, 0x2

    iput v11, v1, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;->n:I

    invoke-virtual {v3}, Lcom/android/camera/ActivityBase;->y9()Z
    ...
    invoke-static {v3, v8, v6, v7}, Lcom/android/camera/o5;->u(Landroid/content/Context;[Lcom/android/camera/o5;Landroid/net/Uri;Lcom/android/camera/o5$b;)I
    ...
    invoke-virtual {v3}, Lcom/android/camera/ActivityBase;->od()Ljava/util/ArrayList;

    move-result-object v9

    invoke-static {v3, v8, v9, v6}, Lcom/android/camera/o5;->w(Landroid/content/Context;[Lcom/android/camera/o5;Ljava/util/ArrayList;Landroid/net/Uri;)I
    ...
    :cond_13
    iget-wide v12, v7, Lcom/android/camera/o5$b;->c:J

    :goto_8
    invoke-virtual {v0, v12, v13}, Lcom/android/camera/o5;->T(J)V
    ...
    :cond_14
    iget-boolean v2, v7, Lcom/android/camera/o5$b;->i:Z

    :goto_9
    invoke-virtual {v0, v2}, Lcom/android/camera/o5;->R(Z)V
    ...
    :cond_18
    iget-boolean v1, v7, Lcom/android/camera/o5$b;->i:Z

    :goto_b
    invoke-virtual {v0, v1}, Lcom/android/camera/o5;->R(Z)V
...
.method public x(Lcom/android/camera/o5;)V
    .locals 6
    ...
    invoke-static {v0, p1, v2, v1, p0}, Lcom/android/camera/ThumbnailUpdater;->e(Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/o5;ZZZ)V
