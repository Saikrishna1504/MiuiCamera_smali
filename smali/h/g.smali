...
# direct methods
.method public static a(Ljava/lang/String;)Li/i;
    .locals 13
    ...
    invoke-direct {v2, p0}, Li/g;-><init>(Ljava/lang/String;)V

    const/4 p0, 0x0

    invoke-virtual {v2, p0}, Li/g;->b(I)C
    ...
    invoke-virtual {v2, v5, v3}, Li/g;->c(ILjava/lang/String;)I

    move-result v3

    invoke-virtual {v2}, Li/g;->d()Z

    move-result v5

    if-eqz v5, :cond_3

    invoke-virtual {v2}, Li/g;->a()C
    ...
    :cond_4
    invoke-virtual {v1, v3}, Li/i;->i(I)V
    ...
    :cond_7
    :goto_1
    invoke-virtual {v1, v3}, Li/i;->d(I)V
    ...
    :cond_a
    :goto_2
    invoke-virtual {v1, v3}, Li/i;->a(I)V
    ...
    invoke-virtual {v2, v3, v5}, Li/g;->c(ILjava/lang/String;)I

    move-result v5

    invoke-virtual {v1, v5}, Li/i;->b(I)V
    ...
    invoke-virtual {v2, v6, v5}, Li/g;->c(ILjava/lang/String;)I
    ...
    :cond_e
    :goto_3
    invoke-virtual {v1, v5}, Li/i;->c(I)V
    ...
    :cond_12
    :goto_4
    invoke-virtual {v1, v5}, Li/i;->g(I)V
    ...
    invoke-virtual {v2, v11, v10}, Li/g;->c(ILjava/lang/String;)I
    ...
    :cond_16
    invoke-virtual {v1, v10}, Li/i;->f(I)V
    ...
    invoke-virtual {v2, v6, p0}, Li/g;->c(ILjava/lang/String;)I
    ...
    invoke-virtual {v1, p0}, Li/i;->h(Ljava/util/SimpleTimeZone;)V
