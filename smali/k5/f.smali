...
.method public constructor <init>(Lcom/android/camera/fragment/mode/more/EditDragLayout;)V
    ...
    iput-object v0, p0, Lk5/f;->a:Lk5/i;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lk5/f;->d:Z

    const-string v0, "edit_mode_invalid_tag"

    iput-object v0, p0, Lk5/f;->e:Ljava/lang/String;
    ...
    iput-object v0, p0, Lk5/f;->l:Lk5/f$a;

    iput-object p1, p0, Lk5/f;->b:Lcom/android/camera/fragment/mode/more/EditDragLayout;
    ...
    invoke-direct {v0, p1}, Lk5/c;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lk5/f;->c:Lk5/c;
...
.method public static b(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-static {v3}, Lk5/f;->b(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView;
...
.method public final d(FF)Z
    ...
    iget-object v0, p0, Lk5/f;->b:Lcom/android/camera/fragment/mode/more/EditDragLayout;

    invoke-static {v0, p1, p2}, Lk5/f;->c(Landroid/view/ViewGroup;FF)[F
    ...
    :cond_3
    invoke-static {v8}, Lk5/f;->b(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-static {v3, v5}, La0/k0;->a(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v6, p0, Lk5/f;->e:Ljava/lang/String;
    ...
    invoke-static {v9, v10}, La0/k0;->a(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lk5/f;->a:Lk5/i;
    ...
    :cond_f
    :goto_a
    iget-object p1, p0, Lk5/f;->a:Lk5/i;
    ...
    iget-object p2, p0, Lk5/f;->e:Ljava/lang/String;
    ...
    iget v1, p0, Lk5/f;->g:I

    const-string v5, " to rv_"

    invoke-static {p1, v1, v5, v3, p2}, La0/k0;->i(Ljava/lang/StringBuilder;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p2, p0, Lk5/f;->f:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-static {v5, v6, v2}, La0/l7;->b(Landroid/content/Context;IZ)V
    ...
    invoke-static {v6, v5}, Ln8/b;->b(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-interface {v5, v8}, Lj5/a;->getItem(I)Lcom/android/camera/data/data/d;
    ...
    :cond_1a
    iget-object v6, p1, Lk5/i;->a:Lcom/android/camera/data/data/d;

    iget-object v6, v6, Lcom/android/camera/data/data/d;->n:Ljava/lang/String;

    invoke-interface {v5, v6}, Lj5/a;->d(Ljava/lang/String;)V

    iget-object p1, p1, Lk5/i;->a:Lcom/android/camera/data/data/d;

    invoke-interface {v5, v8, p1}, Lj5/a;->a(ILcom/android/camera/data/data/d;)V
    ...
    :cond_1b
    invoke-interface {p1, v1}, Lj5/a;->c(I)V
    ...
    invoke-virtual {p1}, Lgk/d;->c()V

    iput-object v3, p0, Lk5/f;->e:Ljava/lang/String;

    iput-object v0, p0, Lk5/f;->f:Landroidx/recyclerview/widget/RecyclerView;

    iput v8, p0, Lk5/f;->g:I
    ...
    iget-object v8, p0, Lk5/f;->a:Lk5/i;
    ...
    iget-object v12, p0, Lk5/f;->a:Lk5/i;
    ...
    :cond_28
    invoke-interface {p1, p2, v9}, Lj5/a;->b(II)Z
    ...
    invoke-static {p1, p2, v1, v9, v2}, La0/k0;->h(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    iget-boolean p1, p0, La0/n4;->d:Z

    if-eqz p1, :cond_2a

    iget-object p0, p0, La0/n4;->c:Landroid/view/accessibility/AccessibilityManager;

    invoke-virtual {p0}, Landroid/view/accessibility/AccessibilityManager;->interrupt()V

    invoke-static {v9, v0}, Lk5/f;->a(ILandroidx/recyclerview/widget/RecyclerView;)[I
...
.method public final e()Z
    ...
    iget-object p0, p0, Lk5/f;->b:Lcom/android/camera/fragment/mode/more/EditDragLayout;
    ...
    invoke-virtual {p0, v0, v2}, Ldh/a;->i(Ljava/lang/String;I)I
