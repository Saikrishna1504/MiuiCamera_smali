...
# virtual methods
.method public final a(Lw2/e;Z)V
    .locals 19
    ...
    iget-object v2, v0, Lw2/e;->b:Lw2/f;

    if-eqz p2, :cond_0

    iget-object v3, v2, Lw2/f;->o:Lh0/q;

    goto :goto_0

    :cond_0
    iget-object v3, v2, Lw2/f;->n:Lh0/q;
    ...
    iget-object v4, v3, Lh0/q;->o:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    iget-object v4, v3, Lh0/q;->k:Landroid/graphics/Rect;

    :goto_1
    const-string v6, "applyAIWatermark -> "

    invoke-static {v6, v4}, La0/c0;->h(Ljava/lang/String;Landroid/graphics/Rect;)Ljava/lang/String;
    ...
    :cond_3
    iget-object v6, v0, Lw2/e;->n:Landroid/graphics/Rect;

    :goto_2
    iget v4, v3, Lh0/q;->b:I
    ...
    :goto_4
    iget-wide v11, v2, Lw2/f;->a:J

    invoke-static {v11, v12, v3}, Lu9/d;->b(JLh0/q;)[I
    ...
    :cond_6
    invoke-static {v7, v8, v6}, Lu9/d;->d(IILandroid/graphics/Rect;)[F
    ...
    invoke-static {v6, v2}, La0/z;->e([ILjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v6, v1}, La0/z;->e([ILjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v6}, Lfk/e;->n([I)Landroid/graphics/Rect;
    ...
    invoke-static {v0, v2, v1}, Lw2/g;->c(Lw2/e;Lcom/android/camera/effect/renders/q;Landroid/graphics/Rect;)V
