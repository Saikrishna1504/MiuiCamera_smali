...
# direct methods
.method public constructor <init>(Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/MiviInfo4EntityJsonAdapter;Lsg/a;)V
    .locals 1
    ...
    iput-object p1, p0, Lug/g;->a:Lgf/l;

    iput-object p2, p0, Lug/g;->b:Lgf/l;
...
.method public final fromJson(Lgf/q;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lgf/q;->p()Ljava/lang/Object;
    ...
    :cond_1
    iget-object p0, p0, Lug/g;->a:Lgf/l;

    invoke-virtual {p0, p1}, Lgf/l;->fromJsonValue(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0}, La0/m5;->i([Ljava/lang/Object;)Ljava/util/Set;

    move-result-object p0

    invoke-static {p0, p1}, Lhp/b0;->Q(Ljava/util/Set;Ljava/util/Map;)Ljava/util/Map;
...
.method public final toJson(Lgf/v;Ljava/lang/Object;)V
    ...
    invoke-static {v0}, Lhp/b0;->W(Ljava/util/Map;)Ljava/util/LinkedHashMap;
    ...
    :cond_4
    iget-object p0, p0, Lug/g;->b:Lgf/l;
