...
.method public final Jg(I)Z
    ...
    invoke-static {p1, p0, p0}, La5/s;->a(IZZ)Lcom/android/camera/ui/zoom/ZoomRatioToggleView$e;
...
.method public final W2(II)V
    ...
    invoke-static {p1, p2, p0, v0}, Ln8/a;->C0(IILjava/lang/String;Z)V

    return-void
.end method

.method public final f7()Ljava/util/ArrayList;
    .locals 9

    sget-object p0, Lb3/a;->a:[Ljava/lang/Class;

    const-class p0, Lb3/a;

    monitor-enter p0

    :try_start_0
    sget-object v0, Lb3/a;->c:Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-interface {v4}, Lcom/android/camera/module/entry/a;->getModeItem()Lo5/a;
    ...
    invoke-interface {v4}, Ld3/u;->getModuleId()I
    ...
    iget-boolean v8, v5, Lo5/a;->b:Z

    iget-object v5, v5, Lo5/a;->a:Lcom/android/camera/data/data/d;
    ...
    :cond_2
    sput-object v1, Lb3/a;->c:Ljava/util/ArrayList;
...
.method public final g7()Z
    ...
    invoke-static {v0, p0}, La0/x;->k(ILjava/util/Optional;)Ljava/util/Optional;
...
.method public final ib()Ljava/util/Map;
    .locals 0
...
.method public final o1(I)Ljava/util/ArrayList;
    .locals 0
...
.method public final u6()J
    ...
    invoke-virtual {p0, v1}, Ldh/b;->t(Ljava/lang/Class;)Ljava/util/Optional;
