...
.method public static a(III)I
    ...
    invoke-virtual {v3}, Li7/e;->M()Landroid/util/SparseArray;
    ...
    invoke-static {v3}, Lea/d;->m1(Lea/c;)Z
    ...
    :cond_2
    invoke-virtual {v3}, Lea/c;->D()Ljava/util/Set;
    ...
    invoke-static {v0, p0, v3, p1, v4}, Landroidx/appcompat/widget/b;->f(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-virtual {p0}, Li7/e;->M()Landroid/util/SparseArray;
    ...
    invoke-static {v1}, Lea/d;->i(Lea/c;)I
    ...
    invoke-static {p2, p1, v1, p0}, La0/c0;->g(Ljava/lang/String;ILjava/lang/String;I)Ljava/lang/String;
...
.method public static declared-synchronized b(IIZ)I
    ...
    invoke-virtual/range {v17 .. v17}, Li7/e;->u()I
    ...
    invoke-virtual/range {v17 .. v17}, Li7/e;->k()I
    ...
    invoke-virtual/range {v17 .. v17}, Li7/e;->isInitialized()Z
    ...
    :cond_1
    :try_start_1
    invoke-static {}, La1/a;->f()Lh1/v1;

    move-result-object v15

    invoke-virtual {v15}, Lh1/v1;->D()Z
    ...
    invoke-virtual {v15, v5, v14}, Ldh/a;->g(Ljava/lang/String;Z)Z
    ...
    invoke-static {}, Luc/b;->A()Luc/b;

    move-result-object v5

    iget-object v5, v5, Luc/b;->e:L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;

    invoke-virtual {v5}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->J5()Z
    ...
    invoke-static/range {p0 .. p1}, Lm1/c;->e(II)I

    move-result v3

    invoke-static {v1, v3, v2}, Lm1/c;->a(III)I
    ...
    invoke-virtual {v5}, Li7/e;->M()Landroid/util/SparseArray;
    ...
    invoke-static {v5}, Lea/d;->s2(Lea/c;)Z
    ...
    invoke-virtual {v4}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->T5()Z
    ...
    invoke-virtual {v4}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->S5()Z
    ...
    invoke-virtual {v3}, Li7/e;->w()Z

    move-result v3

    if-eqz v3, :cond_e

    invoke-static {}, Lm1/c;->f()I
    ...
    invoke-virtual {v5}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->g5()V

    const-string v5, "ultra_wide"

    invoke-virtual {v3, v5}, Ld1/n0;->j(Ljava/lang/String;)Z
    ...
    :cond_24
    invoke-static {}, La1/a;->d()Lf1/j;

    move-result-object v3

    invoke-virtual {v3}, Lf1/j;->B()I
    ...
    iget-object v4, v4, Lf1/c;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v4, v2}, Ld1/u0;->getPersistValue(I)Ljava/lang/String;
    ...
    :cond_26
    invoke-virtual {v4, v2}, Ld1/u0;->getPreferComponentValue(I)Ljava/lang/String;
    ...
    invoke-virtual {v4, v2, v12}, Lf1/g;->j(II)Z
    ...
    check-cast v3, Ld1/s0;

    if-eqz v3, :cond_38

    invoke-virtual {v3}, Ld1/s0;->r()Z
    ...
    :goto_5
    invoke-virtual {v5, v2, v6}, Lh1/h1;->D(IZ)Z
    ...
    invoke-virtual {v5, v2}, Ld1/u0;->getPreferComponentValue(I)Ljava/lang/String;
    ...
    invoke-static/range {p0 .. p2}, Lm1/c;->h(IIZ)I
    ...
    :cond_4c
    invoke-static/range {p1 .. p1}, Lcom/android/camera/data/data/f0;->P(I)Z
    ...
    invoke-static {v3}, Lea/d;->f4(Lea/c;)Z
    ...
    :cond_4d
    invoke-static/range {p1 .. p1}, Lcom/android/camera/data/data/f0;->o(I)Ljava/lang/String;
    ...
    invoke-direct {v8, v6, v9}, Lm1/a;-><init>(FI)V
    ...
    invoke-direct {v4, v5, v6}, Lm1/b;-><init>(FI)V
    ...
    invoke-virtual {v5, v2}, Ld1/u0;->getPersistValue(I)Ljava/lang/String;
    ...
    invoke-virtual {v5, v4}, Ld1/u0;->l(Ljava/lang/String;)I
    ...
    invoke-virtual {v5, v12, v4}, Ld1/u0;->t(ILjava/lang/String;)Z
    ...
    invoke-virtual {v6}, Luc/b;->E1()Z

    move-result v6

    if-eqz v6, :cond_5a

    invoke-virtual {v5, v3, v4}, Ld1/u0;->t(ILjava/lang/String;)Z
    ...
    invoke-static/range {p0 .. p0}, Lm1/c;->d(I)I
    ...
    :cond_68
    :goto_b
    invoke-static {v1, v12, v2}, Lm1/c;->a(III)I
    ...
    invoke-static/range {p0 .. p1}, Lm1/c;->c(II)I
...
.method public static c(II)I
    ...
    invoke-virtual {v0}, Li7/e;->Q()Lea/c;

    move-result-object v0

    invoke-static {v0}, Lea/d;->M2(Lea/c;)Z
    ...
    invoke-static {p1, v0}, Lkg/c;->h(FZ)F
    ...
    invoke-static {p1, v0}, Lea/f0;->d(FZ)I

    move-result v0

    invoke-virtual {v4, v0}, Li7/e;->z(I)I
...
.method public static h(IIZ)I
    ...
    invoke-virtual {v1, p1}, Ld1/u0;->getPersistValue(I)Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {v1, p1}, Ld1/u0;->getPreferComponentValue(I)Ljava/lang/String;
    ...
    invoke-static {v1}, Lea/d;->f4(Lea/c;)Z
    ...
    sget-object v5, Lea/f0;->f:Lea/f0$o;

    invoke-virtual {v5}, Ls/j;->d()Ljava/lang/Object;
    ...
    invoke-static {p0}, Lea/d;->w0(Lea/c;)Z
...
.method public static i(IIII)Z
    ...
    invoke-virtual {v1, p0}, Ld1/p1;->m(I)Z
    ...
    iget-object p0, v0, Lea/c;->k5:Ljava/lang/Boolean;

    if-nez p0, :cond_9

    sget-object p0, Lra/f;->r2:Lra/e;

    invoke-virtual {p0}, Lra/e;->c()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lea/c;->D0(Ljava/lang/String;)Z

    move-result v1

    if-eqz v1, :cond_8

    iget-object v1, v0, Lea/c;->c:Landroid/hardware/camera2/CameraCharacteristics;

    invoke-static {v1, p0}, Lra/b0;->a(Landroid/hardware/camera2/CameraCharacteristics;Lra/a0;)Ljava/lang/Object;
    ...
    iput-object p0, v0, Lea/c;->k5:Ljava/lang/Boolean;
    ...
    invoke-static {p0}, Lea/d;->P0(Lea/c;)Z

    move-result p0

    if-eqz p0, :cond_d

    invoke-static {p3}, Lcom/android/camera/data/data/f0;->Q(I)Z
    ...
    invoke-static {p0, v2}, Lkg/c;->h(FZ)F

    move-result p0

    invoke-static {p0, v2}, Lea/f0;->d(FZ)I
