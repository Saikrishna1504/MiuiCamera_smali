...
# direct methods
.method public constructor <init>(Ls6/h;Ljava/util/List;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Ls6/h$a;->a:Ljava/lang/String;

    iput-object p2, p0, Ls6/h$a;->b:Ljava/util/List;

    new-instance p1, Ljava/util/ArrayDeque;

    invoke-direct {p1}, Ljava/util/ArrayDeque;-><init>()V

    iput-object p1, p0, Ls6/h$a;->c:Ljava/util/ArrayDeque;
...
# virtual methods
.method public final a(Landroidx/fragment/app/FragmentActivity;Ls6/c;)Z
    .locals 17
    ...
    iget-object v2, v0, Ls6/h$a;->b:Ljava/util/List;
    ...
    :cond_2
    iget-object v4, v0, Ls6/h$a;->b:Ljava/util/List;
    ...
    iget-object v5, v0, Ls6/h$a;->b:Ljava/util/List;
    ...
    invoke-virtual {v5}, Lt6/d;->c()Z

    move-result v6

    if-eqz v6, :cond_3

    iput-boolean v2, v5, Lt6/d;->e:Z
    ...
    :goto_2
    iget-object v4, v0, Ls6/h$a;->a:Ljava/lang/String;
    ...
    new-instance v4, La0/l2;

    const/4 v5, 0x2

    move-object/from16 v6, p2

    invoke-direct {v4, v5, v0, v1, v6}, La0/l2;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {v6}, Lt6/d;->c()Z

    move-result v7

    if-eqz v7, :cond_5

    iget-object v7, v6, Lt6/d;->a:Ls6/i;

    iget v8, v7, Ls6/i;->b:I

    iget v9, v7, Ls6/i;->c:I

    iget v7, v7, Ls6/i;->d:I

    iget-object v10, v0, Ls6/h$a;->d:Ls6/h;

    invoke-virtual {v10, v8}, Ls6/h;->b(I)Ljava/util/List;
    ...
    invoke-static {v10, v11}, La0/x;->d(Ljava/util/List;I)Ljava/lang/Object;
    ...
    :goto_4
    iget-object v11, v6, Lt6/d;->a:Ls6/i;

    iget-object v11, v11, Ls6/i;->h:Ls6/y;

    iget-object v13, v0, Ls6/h$a;->d:Ls6/h;

    iget-object v13, v13, Ls6/h;->f:Ly7/b1;

    check-cast v13, Lh5/a;

    invoke-virtual {v13, v8}, Lh5/a;->a(I)I
    ...
    iget-object v7, v7, Ls6/h;->e:Ly7/d1;
    ...
    :goto_6
    invoke-static {v12, v9}, Lh5/b;->a(Lcom/xiaomi/camera/base/ui/fragments/BaseFragmentV2;I)V
    ...
    :goto_7
    const-string v15, "CameraFragmentFactory"
    ...
    invoke-static {v15, v12, v14}, Lcom/android/camera/log/Log;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    goto :goto_8

    :cond_1b
    iget-object v14, v7, Lh5/b;->a:Landroidx/fragment/app/FragmentActivity;
    ...
    invoke-virtual {v15}, Landroidx/fragment/app/FragmentManager;->getFragmentFactory()Landroidx/fragment/app/FragmentFactory;
    ...
    invoke-virtual {v15, v14, v12}, Landroidx/fragment/app/FragmentFactory;->instantiate(Ljava/lang/ClassLoader;Ljava/lang/String;)Landroidx/fragment/app/Fragment;
    ...
    invoke-direct {v3, v7, v12}, Lj3/g;-><init>(Ljava/lang/Object;I)V
    ...
    :pswitch_3c
    new-instance v12, Lcom/android/camera/fragment/modeselector/menu/FragmentBottomMenu2;

    invoke-direct {v12, v3}, Lcom/android/camera/fragment/modeselector/menu/FragmentBottomMenu2;-><init>(Lj3/g;)V

    const v3, 0x7f14059d

    iput v3, v12, Lcom/android/camera/fragment/modeselector/menu/FragmentBottomMenu2;->e:I
    ...
    const-class v14, Lh1/m0;

    invoke-virtual {v3, v14}, Ldh/b;->v(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lh1/m0;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget v3, Lxg/f;->fastmotion_pro_adjust_name:I
    ...
    :pswitch_3e
    new-instance v12, Lcom/android/camera/fragment/modeselector/menu/FragmentBottomMenu1;

    invoke-direct {v12, v3}, Lcom/android/camera/fragment/modeselector/menu/FragmentBottomMenu1;-><init>(Lcom/android/camera/fragment/modeselector/menu/FragmentBottomMenuBase$a;)V

    invoke-static {}, La1/a;->k()Lh1/v1;

    move-result-object v3

    const-class v14, Lh1/k0;

    invoke-virtual {v3, v14}, Ldh/b;->v(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lh1/k0;

    iget-object v14, v3, Lh1/k0;->a:Ljava/util/ArrayList;

    iget-object v3, v3, Lh1/k0;->b:Ljava/lang/String;

    const-class v15, La8/b;

    invoke-virtual {v12, v14, v3, v15}, Lcom/android/camera/fragment/modeselector/menu/FragmentBottomMenu1;->sd(Ljava/util/List;Ljava/lang/String;Ljava/lang/Class;)V
    ...
    invoke-virtual {v3}, Lh1/b1;->getDisplayTitleString()I
    ...
    iget-object v14, v3, Lh1/a;->d:Ljava/util/ArrayList;

    iget-object v3, v3, Lh1/a;->a:Ljava/lang/String;

    const-class v15, La8/g;
    ...
    iget-object v15, v3, Lh1/h1;->n0:Ljava/util/List;

    invoke-virtual {v3}, Lh1/h1;->x()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v12, v15, v3, v14}, Lcom/android/camera/fragment/modeselector/menu/FragmentBottomMenu1;->sd(Ljava/util/List;Ljava/lang/String;Ljava/lang/Class;)V
    ...
    const-class v14, Lh1/s1;

    invoke-virtual {v12, v14}, Ldh/b;->v(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v12

    check-cast v12, Lh1/s1;

    invoke-virtual {v12}, Lh1/s1;->g()Ljava/util/List;
    ...
    invoke-direct {v14, v3}, Lcom/android/camera/fragment/modeselector/menu/FragmentBottomMenu2;-><init>(Lj3/g;)V
    ...
    sget v3, Lxg/f;->pre_audio_gain_adjust:I
    ...
    invoke-virtual {v3}, Ld1/c;->getDisplayTitleString()I
    ...
    :pswitch_46
    new-instance v12, Lcom/android/camera/fragment/modeselector/menu/FragmentBottomMenu3;

    invoke-direct {v12, v3}, Lcom/android/camera/fragment/modeselector/menu/FragmentBottomMenu3;-><init>(Lj3/g;)V

    new-instance v3, Lu4/i;

    invoke-direct {v3}, Lu4/i;-><init>()V

    iput-object v3, v12, Lcom/android/camera/fragment/modeselector/menu/FragmentBottomMenu3;->e:Lu4/a;
    ...
    const-class v14, Lh1/j0;

    invoke-virtual {v3, v14}, Ldh/b;->v(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lh1/j0;

    invoke-virtual {v3}, Lh1/j0;->g()I
    ...
    iget-object v3, v3, Lh1/j1;->a:Ljava/util/ArrayList;

    const-string v14, "0"

    const-class v15, La8/f;

    invoke-virtual {v12, v3, v14, v15}, Lcom/android/camera/fragment/modeselector/menu/FragmentBottomMenu1;->sd(Ljava/util/List;Ljava/lang/String;Ljava/lang/Class;)V

    :goto_b
    const/16 v3, 0xf5

    invoke-static {v12, v3}, Lh5/b;->a(Lcom/xiaomi/camera/base/ui/fragments/BaseFragmentV2;I)V
    ...
    invoke-virtual {v12, v11}, Lcom/android/camera/fragment/AbstractFragment;->setUIType(Ls6/y;)V
    ...
    invoke-direct {v7, v0, v12, v6, v4}, Ls6/g;-><init>(Ls6/h$a;Lcom/xiaomi/camera/base/ui/fragments/BaseFragmentV2;Lt6/d;La0/l2;)V

    invoke-interface {v12, v1, v13, v7}, Ly7/c1;->asyncInflater(Landroid/content/Context;Landroid/view/ViewGroup;Ljava/lang/Runnable;)V
    ...
    invoke-static {v1, v9}, Landroid/support/v4/media/a;->c(Ljava/lang/String;I)Ljava/lang/String;
    ...
    :cond_2a
    invoke-virtual {v4}, La0/l2;->run()V
