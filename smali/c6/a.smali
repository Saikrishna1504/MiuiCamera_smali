...
.method public static b(IIIILik/d;)Landroid/util/Pair;
    .locals 3
...
.method public static c(II)Ljava/util/ArrayList;
    ...
    invoke-direct {v8, v7, v1, v12, v12}, Lv9/c;-><init>(Ljava/lang/String;Ljava/lang/String;ZZ)V

    move-object v1, v9

    move v7, p1

    invoke-direct/range {v1 .. v8}, Lx9/a;-><init>(IIIZZILv9/c;)V

    iget-object p1, v9, Lx9/a;->m:Lx9/b;

    invoke-virtual {p1}, Lta/d;->n()Landroid/graphics/Bitmap;
    ...
    :goto_0
    invoke-static {p0}, Lc6/a;->j(I)I

    move-result p0

    sget-object v2, Lik/d;->h:Lik/d;
    ...
    invoke-static {v1, p0, v3, v4, v2}, Lc6/a;->b(IIIILik/d;)Landroid/util/Pair;
    ...
    invoke-direct {v1, v2, p0, p1}, Lf6/a;-><init>(IILandroid/graphics/Bitmap;)V
...
.method public static d()Landroid/graphics/Bitmap;
    ...
    invoke-static {}, Le6/e;->a()Ljava/util/ArrayList;
...
.method public static e(II)Ljava/util/ArrayList;
    ...
    :goto_0
    invoke-static {}, Lc6/a;->d()Landroid/graphics/Bitmap;

    move-result-object v3

    invoke-static {v2}, Lc6/a;->j(I)I
    ...
    :goto_2
    invoke-direct {p0, p1, v4, v2}, Lf6/a;-><init>(IILandroid/graphics/Bitmap;)V
...
.method public static f(II)Ljava/util/ArrayList;
    ...
    :goto_3
    invoke-static {v8}, Lc6/a;->j(I)I

    move-result v8

    if-eqz v2, :cond_9

    invoke-static {v6}, Lcom/android/camera/data/data/x;->u(Z)Lik/d;
    ...
    invoke-direct/range {v9 .. v17}, Lv9/b;-><init>(IIILik/d;Ljava/lang/String;ZZZ)V

    iget-object v0, v0, Lv9/b;->n:Lta/n;

    invoke-virtual {v0}, Lta/d;->n()Landroid/graphics/Bitmap;
    ...
    invoke-direct {v4, v5, v2, v0}, Lf6/a;-><init>(IILandroid/graphics/Bitmap;)V
    ...
    invoke-static {v6}, Lcom/android/camera/data/data/x;->f(Z)Lik/d;
    ...
    invoke-virtual {v4}, Luc/b;->w()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v4}, Luc/b;->x()Ljava/lang/String;
    ...
    invoke-direct {v3, v5, v4, v6, v9}, Lv9/c;-><init>(Ljava/lang/String;Ljava/lang/String;ZZ)V
    ...
    invoke-direct/range {v9 .. v18}, Lv9/a;-><init>(IIILjava/lang/String;ZZLik/d;Lv9/c;Z)V

    iget-object v2, v2, Lv9/a;->m:Lta/d;
    ...
    invoke-static {v7, v8, v3, v4, v0}, Lc6/a;->b(IIIILik/d;)Landroid/util/Pair;
    ...
    invoke-direct {v3, v4, v0, v2}, Lf6/a;-><init>(IILandroid/graphics/Bitmap;)V
...
.method public static i(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v7, v1, v0, v2, v2}, Lv9/c;-><init>(Ljava/lang/String;Ljava/lang/String;ZZ)V
    ...
    invoke-direct/range {v0 .. v7}, Lx9/a;-><init>(IIIZZILv9/c;)V

    iget-object p3, v8, Lx9/a;->m:Lx9/b;

    invoke-virtual {p3}, Lta/d;->n()Landroid/graphics/Bitmap;
    ...
    sget-object v4, Lik/d;->h:Lik/d;

    invoke-static {p0, v2, p1, p2, v4}, Lc6/a;->l(IIIILik/d;)Landroid/util/Pair;
...
.method public static l(IIIILik/d;)Landroid/util/Pair;
    .locals 5
...
.method public final g(Ljava/lang/String;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    :sswitch_0
    const-string v5, "watermark_punch_in"
    ...
    :sswitch_3
    const-string v5, "watermark_film"
    ...
    :sswitch_6
    const-string v5, "watermark_westcoast3_evil_queen"
    ...
    iput-object v5, v0, Lc6/a;->a:Landroid/graphics/Paint;
    ...
    iget-object v10, v0, Lc6/a;->a:Landroid/graphics/Paint;
    ...
    sget-boolean v16, Luc/b;->i:Z

    sget-object v16, Luc/b$b;->a:Luc/b;

    invoke-virtual/range {v16 .. v16}, Luc/b;->w()Ljava/lang/String;

    move-result-object v11

    invoke-virtual/range {v16 .. v16}, Luc/b;->x()Ljava/lang/String;
    ...
    invoke-direct {v15, v11, v7, v3, v6}, Lv9/c;-><init>(Ljava/lang/String;Ljava/lang/String;ZZ)V
    ...
    invoke-direct/range {v22 .. v31}, Lv9/a;-><init>(IIILjava/lang/String;ZZLik/d;Lv9/c;Z)V

    iget-object v3, v5, Lv9/a;->m:Lta/d;

    invoke-virtual {v3}, Lta/d;->n()Landroid/graphics/Bitmap;
    ...
    invoke-static {v5, v6, v1, v4, v10}, Lc6/a;->l(IIIILik/d;)Landroid/util/Pair;
    ...
    iget-object v7, v0, Lc6/a;->a:Landroid/graphics/Paint;
    ...
    invoke-direct/range {v14 .. v22}, Lv9/b;-><init>(IIILik/d;Ljava/lang/String;ZZZ)V

    iget-object v2, v2, Lv9/b;->n:Lta/n;
    ...
    invoke-static {v3, v5, v1, v4, v6}, Lc6/a;->l(IIIILik/d;)Landroid/util/Pair;
    ...
    iget-object v0, v0, Lc6/a;->a:Landroid/graphics/Paint;
    ...
    :cond_5
    invoke-static {v2, v1, v4, v11}, Lc6/a;->i(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
    ...
    :cond_6
    invoke-static {v2, v1, v4, v6}, Lc6/a;->i(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
    ...
    invoke-static {v7, v8, v1, v4, v6}, Lc6/a;->l(IIIILik/d;)Landroid/util/Pair;
    ...
    invoke-virtual/range {v0 .. v5}, Lc6/a;->h(ILandroid/graphics/Bitmap;Ljava/lang/String;ZZ)Landroid/graphics/Bitmap;
...
.method public final h(ILandroid/graphics/Bitmap;Ljava/lang/String;ZZ)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v3, v4}, Lu9/b;->b(Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v4, v5, v0, v3}, Lrh/a;-><init>(IILandroid/graphics/Bitmap;)V

    iput-boolean p5, v4, Lrh/a;->k:Z

    iput-boolean p4, v4, Lrh/a;->l:Z

    sget-boolean p4, Luc/b;->i:Z

    sget-object p4, Luc/b$b;->a:Luc/b;

    invoke-virtual {p4}, Luc/b;->v()Ljava/lang/String;

    move-result-object p4

    iput-object p4, v4, Lrh/a;->m:Ljava/lang/String;

    iput-boolean v2, v4, Lrh/a;->r:Z

    iget-short p4, p0, Lc6/a;->b:S

    iput-short p4, v4, Lrh/a;->e:S

    iget p0, p0, Lc6/a;->c:F

    iput p0, v4, Lrh/a;->f:F

    const-wide/32 p4, 0xf4240

    iput-wide p4, v4, Lrh/a;->g:J

    const/16 p0, 0xc8

    iput p0, v4, Lrh/a;->h:I
    ...
    invoke-interface {p0, v4}, Lrh/e;->b(Lrh/a;)Landroid/graphics/Bitmap;

    move-result-object p0

    const p3, 0x40d947ae    # 6.79f

    invoke-static {p3, p1, p0}, Lc6/a;->a(FILandroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
...
.method public final k(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    :sswitch_4
    const-string v3, "watermark_westcoast3_snow_white"
    ...
    :sswitch_6
    const-string v3, "watermark_westcoast3_evil_queen"
    ...
    invoke-static {v10, v10}, Lc6/a;->f(II)Ljava/util/ArrayList;
    ...
    :cond_1
    invoke-static {v10, v10}, Lc6/a;->e(II)Ljava/util/ArrayList;
    ...
    :cond_2
    invoke-static {v10, v8}, Lc6/a;->c(II)Ljava/util/ArrayList;
    ...
    :cond_3
    invoke-static {v10, v9}, Lc6/a;->c(II)Ljava/util/ArrayList;
    ...
    invoke-virtual/range {p0 .. p0}, Lc6/a;->m()V
    ...
    invoke-virtual {v5, v6}, Lu9/b;->b(Landroid/content/Context;)Landroid/graphics/Bitmap;

    move-result-object v5

    new-instance v6, Lrh/a;

    invoke-direct {v6, v9, v10, v5}, Lrh/a;-><init>(IILandroid/graphics/Bitmap;)V
    ...
    iput-boolean v5, v6, Lrh/a;->k:Z

    invoke-static {}, Lcom/android/camera/data/data/x;->O()Z

    move-result v5

    iput-boolean v5, v6, Lrh/a;->l:Z

    sget-boolean v5, Luc/b;->i:Z

    sget-object v5, Luc/b$b;->a:Luc/b;

    invoke-virtual {v5}, Luc/b;->v()Ljava/lang/String;

    move-result-object v5

    iput-object v5, v6, Lrh/a;->m:Ljava/lang/String;

    iput-boolean v4, v6, Lrh/a;->r:Z

    iget-short v4, v0, Lc6/a;->b:S

    iput-short v4, v6, Lrh/a;->e:S

    iget v0, v0, Lc6/a;->c:F

    iput v0, v6, Lrh/a;->f:F

    iput-wide v14, v6, Lrh/a;->g:J

    iput v13, v6, Lrh/a;->h:I
    ...
    invoke-interface {v0, v6}, Lrh/e;->h(Lrh/a;)Landroid/graphics/Bitmap;

    move-result-object v0

    invoke-static {v12}, Lc6/a;->j(I)I

    move-result v4

    invoke-static {v11}, Lc6/a;->j(I)I
    ...
    invoke-static {v6, v4, v0}, Lc6/a;->a(FILandroid/graphics/Bitmap;)Landroid/graphics/Bitmap;

    move-result-object v0

    invoke-direct {v1, v10, v10, v0}, Lf6/a;-><init>(IILandroid/graphics/Bitmap;)V
    ...
    iget-short v5, v0, Lc6/a;->b:S

    iput-short v5, v6, Lrh/a;->e:S
    ...
    invoke-direct {v1, v10, v10, v3}, Lf6/a;-><init>(IILandroid/graphics/Bitmap;)V
...
.method public final m()V
    ...
    invoke-static {v0}, Lea/d;->p(Lea/c;)F
