...
.method public constructor <init>(Ld1/o2;)V
    ...
    invoke-virtual {p0, p1}, Ld1/q;->h(Ljava/util/List;)V
...
.method public static i(Ljava/util/ArrayList;)V
    ...
    sget v0, Lxg/c;->ic_new_config_flash_on_mm:I
    ...
    sget v0, Lxg/f;->pref_camera_flashmode_entry_on:I
...
.method public static j(Ljava/util/ArrayList;)V
    ...
    sget v0, Lxg/c;->ic_new_config_flash_fill_light_soft_halo:I
    ...
    sget v0, Lxg/f;->pref_camera_flashmode_entry_torch:I
...
.method public static p()I
    ...
    :cond_0
    sget v0, Lxg/c;->ic_new_config_flash_off_mm:I

    return v0

    :cond_1
    :goto_0
    sget v0, Lxg/c;->ic_new_config_flash_fill_light_off:I
...
.method public final A(I)Z
    ...
    invoke-virtual {v0, p1}, Ld1/y;->isSwitchOn(I)Z
...
.method public final B(I)V
    ...
    invoke-virtual {v0, v1}, Ld1/p1;->getComponentValue(I)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Ld1/p1;->p(ILjava/lang/String;)V
    ...
    invoke-virtual {p1, v1}, Ld1/w1;->getComponentValue(I)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {p1, v1, v6}, Ld1/w1;->h(ILjava/lang/String;)V

    iget-boolean p1, p1, Ld1/w1;->e:Z

    if-eqz p1, :cond_2

    iget-boolean p1, v0, Ld1/p1;->e:Z
...
.method public final C(Ljava/lang/String;Ld1/o2;)V
    .locals 1

    if-eqz p1, :cond_0

    iget-object p0, p0, Lcom/android/camera/data/data/c;->mParentDataItem:Ldh/a;

    const-string v0, "0"

    invoke-virtual {p0, p1, v0}, Ldh/a;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p2, p1}, Ldh/a;->r(Ljava/lang/String;)Ldh/a;
...
.method public final c(Ljava/lang/Object;)V
    ...
    iget v1, v1, Lcom/android/camera/data/data/c0;->e:I
    ...
    invoke-virtual {v5, v2}, Ld1/k0;->j(I)Z

    move-result v5

    iput-boolean v5, v0, Ld1/q;->e:Z

    iput-object v4, v0, Ld1/q;->h:Lea/c;

    invoke-static {v2, v3}, Ld1/q;->x(II)Z

    move-result v4

    iput-boolean v4, v0, Ld1/q;->f:Z
    ...
    iget-object v6, v0, Ld1/q;->h:Lea/c;

    invoke-static {v6}, Lea/d;->V0(Lea/c;)Z
    ...
    iget-object v7, v0, Ld1/q;->h:Lea/c;
    ...
    invoke-static {v11, v8}, La0/k0;->e(ILjava/util/Optional;)Ljava/util/Optional;
    ...
    iget-boolean v3, v0, Ld1/q;->b:Z

    if-eqz v3, :cond_b

    :cond_a
    invoke-virtual {v0, v4}, Ld1/q;->h(Ljava/util/List;)V

    :cond_b
    iget-boolean v3, v0, Ld1/q;->f:Z

    if-eqz v3, :cond_c

    invoke-virtual {v0, v13, v4}, Ld1/q;->g(Ljava/lang/String;Ljava/util/ArrayList;)V

    invoke-static {v4}, Ld1/q;->j(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v0, v4}, Ld1/q;->l(Ljava/util/ArrayList;)V

    goto/16 :goto_9

    :cond_d
    invoke-virtual {v0, v4}, Ld1/q;->m(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v3}, Ld1/e;->getItems()Ljava/util/List;
    ...
    invoke-static {v4}, Ld1/q;->i(Ljava/util/ArrayList;)V

    goto/16 :goto_9

    :cond_f
    :pswitch_1
    iget-boolean v11, v0, Ld1/q;->b:Z
    ...
    :cond_16
    invoke-static {v4}, Ld1/q;->k(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v3}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->U7()Z
    ...
    invoke-virtual {v0, v12, v4}, Ld1/q;->g(Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    iget-object v3, v0, Ld1/q;->h:Lea/c;
    ...
    invoke-virtual {v3}, Lq4/e;->d()Z

    move-result v3

    if-nez v3, :cond_20

    invoke-virtual {v0, v5, v4}, Ld1/q;->g(Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v3}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->Y3()Z
    ...
    invoke-virtual {v0, v2, v8}, Ld1/q;->setComponentValue(ILjava/lang/String;)V
    ...
    :cond_38
    invoke-virtual {v0, v2}, Ld1/q;->A(I)Z
    ...
    invoke-direct {v3, v2, v4}, Ld1/p;-><init>(II)V
...
.method public final checkValueValid(ILjava/lang/String;)Z
    ...
    iget-object v0, p0, Ld1/q;->h:Lea/c;
...
.method public final g(Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    :cond_0
    sget v0, Lxg/c;->ic_new_config_flash_auto_mm:I

    goto :goto_1

    :cond_1
    :goto_0
    sget v0, Lxg/c;->ic_new_config_flash_fill_light_auto:I
    ...
    sget p1, Lxg/f;->pref_camera_flashmode_entry_auto:I

    iput p1, v1, Lcom/android/camera/data/data/d;->i:I

    iget-boolean p0, p0, Ld1/q;->f:Z

    if-eqz p0, :cond_2

    sget p0, Lxg/c;->ic_new_config_flash_fill_light_auto_top_mm:I

    goto :goto_2

    :cond_2
    sget p0, Lxg/c;->ic_new_config_flash_auto_top_mm:I
...
.method public final getDisableReasonString()I
    ...
    iget-boolean v1, p0, Ld1/q;->d:Z

    if-eqz v1, :cond_1

    if-eqz v0, :cond_0

    sget p0, Lxg/f;->close_fill_light_toast_low_power:I

    goto :goto_0

    :cond_0
    sget p0, Lxg/f;->close_flash_toast:I

    :goto_0
    return p0

    :cond_1
    iget-boolean v1, p0, Ld1/q;->e:Z

    if-eqz v1, :cond_2

    sget p0, Lxg/f;->close_flash_by_ultra_raw_toast:I
    ...
    sget p0, Lxg/f;->ambient_lighting_not_adjust_ambient:I
    ...
    sget p0, Lxg/f;->pad_close_back_flash_toast:I

    goto :goto_1

    :cond_5
    sget p0, Lxg/f;->close_back_flash_toast:I
    ...
    :cond_7
    :goto_2
    sget p0, Lxg/f;->close_front_flash_toast:I
...
.method public final getDisplayTitleString()I
    ...
    sget p0, Lxg/f;->pref_camera_flashmode_title:I
...
.method public final getKey(I)Ljava/lang/String;
    ...
    invoke-static {p1}, Ld1/q;->q(I)Ljava/lang/String;
...
.method public final h(Ljava/util/List;)V
    ...
    sget p0, Lxg/c;->ic_new_config_flash_fill_light_off_top_mm:I

    goto :goto_0

    :cond_0
    sget p0, Lxg/c;->ic_new_config_flash_off_top_mm:I

    :goto_0
    iput p0, v1, Lcom/android/camera/data/data/d;->f:I

    sget p0, Lxg/f;->pref_camera_flashmode_entry_off:I
...
.method public final l(Ljava/util/ArrayList;)V
    ...
    iget-boolean v0, p0, Ld1/q;->c:Z

    if-eqz v0, :cond_0

    sget v0, Lxg/c;->ic_new_config_flash_fill_light_soft_light:I

    goto :goto_0

    :cond_0
    sget v0, Lxg/c;->ic_new_config_flash_torch_mm:I
    ...
    sget p0, Lxg/c;->ic_new_config_flash_fill_light_soft_light_top_mm:I

    goto :goto_1

    :cond_1
    sget p0, Lxg/c;->ic_new_config_flash_torch_top_mm:I

    :goto_1
    iput p0, v1, Lcom/android/camera/data/data/d;->f:I

    sget p0, Lxg/f;->pref_camera_flashmode_entry_softlight:I
...
.method public final m(Ljava/util/ArrayList;)V
    ...
    sget p0, Lxg/f;->pref_camera_flashmode_entry_torch:I
...
.method public final r(I)I
    ...
    :pswitch_0
    sget p0, Lxg/f;->tip_flash_on_but_not_adjust_ambient:I
    ...
    sget p0, Lxg/f;->tip_flash_soft_light_torch:I

    goto :goto_2

    :cond_a
    sget p0, Lxg/f;->tip_flash_screen_light_on:I

    :goto_2
    return p0

    :pswitch_2
    sget p0, Lxg/f;->tip_flash_fillin_torch:I

    return p0

    :pswitch_3
    sget p0, Lxg/f;->tip_flash_fillin_on:I
    ...
    sget p0, Lxg/f;->tip_flash_fillin_auto:I

    goto :goto_3

    :cond_b
    sget p0, Lxg/f;->tip_flash_auto:I
    ...
    sget p0, Lxg/f;->tip_flash_on:I

    goto :goto_4

    :cond_c
    sget p0, Lxg/f;->tip_flash_torch:I
    ...
    sget p0, Lxg/f;->tip_flash_fillin_off:I

    goto :goto_5

    :cond_d
    sget p0, Lxg/f;->tip_flash_off:I
...
.method public final resetComponentValue(I)V
    ...
    invoke-virtual {p0, p1, v0}, Ld1/q;->setComponentValue(ILjava/lang/String;)V
...
.method public final s(I)I
    ...
    :pswitch_0
    sget p0, Lxg/c;->ic_new_config_flash_fill_light_soft_halo:I
    ...
    :cond_b
    sget p0, Lxg/c;->ic_new_config_flash_auto_mm:I

    goto :goto_3

    :cond_c
    :goto_2
    sget p0, Lxg/c;->ic_new_config_flash_fill_light_auto:I

    :goto_3
    return p0

    :pswitch_3
    iget-boolean p0, p0, Ld1/q;->c:Z

    if-eqz p0, :cond_d

    sget p0, Lxg/c;->ic_new_config_flash_fill_light_soft_light:I

    goto :goto_4

    :cond_d
    sget p0, Lxg/c;->ic_new_config_flash_torch_mm:I

    :goto_4
    return p0

    :pswitch_4
    sget p0, Lxg/c;->ic_new_config_flash_on_mm:I
...
.method public final t(I)I
    ...
    :pswitch_0
    sget p0, Lxg/f;->accessibility_flash_on_but_not_adjust_ambient:I
    ...
    sget p0, Lxg/f;->accessibility_flash_soft_light_touch:I

    goto :goto_2

    :cond_a
    sget p0, Lxg/f;->accessibility_flash_back_soft_light:I

    :goto_2
    return p0

    :pswitch_2
    sget p0, Lxg/f;->accessibility_flash_fillin_touch:I

    return p0

    :pswitch_3
    sget p0, Lxg/f;->accessibility_flash_fillin_on:I
    ...
    sget p0, Lxg/f;->accessibility_flash_fillin_auto:I

    goto :goto_3

    :cond_b
    sget p0, Lxg/f;->accessibility_flash_auto:I
    ...
    sget p0, Lxg/f;->accessibility_flash_on:I

    goto :goto_4

    :cond_c
    sget p0, Lxg/f;->accessibility_flash_torch:I
    ...
    sget p0, Lxg/f;->accessibility_flash_fillin_off:I

    goto :goto_5

    :cond_d
    sget p0, Lxg/f;->accessibility_flash_off:I
...
.method public final v(I)Z
    ...
    iget-boolean v0, p1, Ld1/l0;->c:Z

    if-eqz v0, :cond_6

    iget v0, p0, Lcom/android/camera/data/data/c;->mCurrentMode:I

    invoke-virtual {p1, v0}, Ld1/l0;->h(I)Z
...
.method public final w(I)Z
    ...
    invoke-static {p1}, Ld1/q;->u(Ljava/lang/String;)Z

    move-result p1

    if-eqz p1, :cond_0

    iget-boolean p0, p0, Ld1/q;->g:Z
...
.method public final z(ILjava/lang/String;)Z
    ...
    invoke-virtual {p2}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->L6()I
    ...
    iget-object v4, p2, Luc/b;->e:L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;

    invoke-virtual {v4}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->L6()I
    ...
    :cond_12
    invoke-virtual {p0, p1, v2}, Ld1/q;->setComponentValue(ILjava/lang/String;)V
