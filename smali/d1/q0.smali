...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Ld1/q0;->f:Ljava/util/ArrayList;
...
.method public static g(F)Landroid/util/Range;
    ...
    invoke-virtual {v0, v1}, Lh1/h;->u(I)F
    ...
    iget-object v3, v0, Ld1/q0;->d:Ljava/util/HashMap;

    if-nez v3, :cond_2

    :cond_1
    invoke-virtual {v0}, Ld1/q0;->i()V
...
.method public final c(Ljava/lang/Object;)V
    ...
    invoke-static {p1}, Lea/d;->E2(Lea/c;)Z

    move-result p1

    iput-boolean p1, p0, Ld1/q0;->e:Z

    invoke-virtual {p0}, Ld1/q0;->getItems()Ljava/util/List;
...
.method public final getItems()Ljava/util/List;
    ...
    sget v4, Lxg/f;->street_auto_desc:I
    ...
    sget-object v2, Lea/f0;->q:Lea/f0$i;

    invoke-virtual {v2}, Ls/j;->d()Ljava/lang/Object;
    ...
    sget v2, Lxg/f;->street_near_desc:I
    ...
    sget v2, Lxg/f;->street_middle_desc:I
    ...
    sget v2, Lxg/f;->street_far_desc:I
...
.method public final i()V
    ...
    :cond_1
    iget-object v4, v0, Lea/c;->Q8:[F

    if-nez v4, :cond_5

    sget-object v4, Lra/f;->L3:Lra/e;
    ...
    :cond_6
    iput-object v0, p0, Ld1/q0;->c:[F

    array-length v4, v0

    if-le v4, v1, :cond_b

    iget-object v4, p0, Ld1/q0;->d:Ljava/util/HashMap;
    ...
    iput-object v4, p0, Ld1/q0;->d:Ljava/util/HashMap;
    ...
    iget-object v7, p0, Ld1/q0;->d:Ljava/util/HashMap;
    ...
    iget v1, p0, Ld1/q0;->a:I

    iget-object v0, v0, Luc/b;->e:L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;

    invoke-virtual {v0}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->b1()Landroid/util/SparseArray;
