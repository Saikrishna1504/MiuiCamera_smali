...
.method public constructor <init>(Lbq/j;)V
    ...
    iput-object p1, p0, Lru/m;->a:Lbq/i;
...
.method public final a(Lru/b;Ljava/lang/Throwable;)V
    ...
    iget-object p0, p0, Lru/m;->a:Lbq/i;
...
.method public final b(Lru/b;Lru/z;)V
    ...
    iget-object v0, p2, Lru/z;->a:Lokhttp3/Response;
    ...
    iget-object p2, p2, Lru/z;->b:Ljava/lang/Object;

    if-nez p2, :cond_1

    invoke-interface {p1}, Lru/b;->request()Lokhttp3/Request;

    move-result-object p1

    const-class p2, Lru/j;
    ...
    iget-object p1, p1, Lru/j;->a:Ljava/lang/reflect/Method;
    ...
    invoke-direct {p2, p1}, Lgp/b;-><init>(Ljava/lang/String;)V
