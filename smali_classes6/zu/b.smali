...
.method public static b()Lzu/b;
    ...
    :cond_1
    new-instance v2, Lzu/b$a;

    invoke-direct {v2, v0}, Lzu/b$a;-><init>(Landroid/os/IHwBinder;)V
...
# virtual methods
.method public abstract a(Lcom/xiaomi/camera/mivi/c;)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract d(ILzu/c;)I
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
