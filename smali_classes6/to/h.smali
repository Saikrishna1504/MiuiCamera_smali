...
.method public constructor <init>(Lio/reactivex/Scheduler;Z)V
    ...
    iput-object p1, p0, Lto/h;->a:Lio/reactivex/Scheduler;

    iput-boolean p2, p0, Lto/h;->b:Z

    return-void
.end method

.method public static d(Lio/reactivex/Scheduler;)Lto/h;
    .locals 2
    ...
    invoke-direct {v0, p0, v1}, Lto/h;-><init>(Lio/reactivex/Scheduler;Z)V
...
.method public a(Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;Lso/u;)Lso/c;
    ...
    iget-object v2, p0, Lto/h;->a:Lio/reactivex/Scheduler;

    iget-boolean v3, p0, Lto/h;->b:Z
    ...
    invoke-direct/range {v0 .. v9}, Lto/g;-><init>(Ljava/lang/reflect/Type;Lio/reactivex/Scheduler;ZZZZZZZ)V
    ...
    invoke-static {v1, p1}, Lso/c$a;->b(ILjava/lang/reflect/ParameterizedType;)Ljava/lang/reflect/Type;
    ...
    iget-object v4, p0, Lto/h;->a:Lio/reactivex/Scheduler;

    iget-boolean v5, p0, Lto/h;->b:Z

    const/4 v11, 0x0

    move-object v2, p1

    invoke-direct/range {v2 .. v11}, Lto/g;-><init>(Ljava/lang/reflect/Type;Lio/reactivex/Scheduler;ZZZZZZZ)V
