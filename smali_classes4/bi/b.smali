...
.field public final l:Lck/g;

.field public final m:Lbi/b$c;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lbi/b;->b:I

    const/16 v0, 0x500

    iput v0, p0, Lbi/b;->c:I
    ...
    iput-object v0, p0, Lbi/b;->d:[F

    new-instance v0, Lbi/b$b;

    invoke-direct {v0, p0}, Lbi/b$b;-><init>(Lbi/b;)V

    invoke-static {v0}, Lck/h;->a(Lok/a;)Lck/g;

    move-result-object v0

    iput-object v0, p0, Lbi/b;->g:Lck/g;

    new-instance v0, Lbi/b$a;

    invoke-direct {v0, p0}, Lbi/b$a;-><init>(Lbi/b;)V

    invoke-static {v0}, Lck/h;->a(Lok/a;)Lck/g;

    move-result-object v0

    iput-object v0, p0, Lbi/b;->l:Lck/g;

    new-instance v0, Lbi/b$c;

    invoke-direct {v0, p0}, Lbi/b$c;-><init>(Lbi/b;)V

    iput-object v0, p0, Lbi/b;->m:Lbi/b$c;

    return-void
.end method

.method public static synthetic a(Lbi/b;Ljava/util/concurrent/CountDownLatch;)V
    .locals 0

    invoke-static {p0, p1}, Lbi/b;->g(Lbi/b;Ljava/util/concurrent/CountDownLatch;)V

    return-void
.end method

.method public static final synthetic b(Lbi/b;)I
    .locals 0

    iget p0, p0, Lbi/b;->c:I

    return p0
.end method

.method public static final synthetic c(Lbi/b;)I
    .locals 0

    iget p0, p0, Lbi/b;->b:I

    return p0
.end method

.method public static final synthetic d(Lbi/b;)Lbi/b$c;
    .locals 0

    iget-object p0, p0, Lbi/b;->m:Lbi/b$c;

    return-object p0
.end method

.method public static final synthetic e(Lbi/b;Landroid/graphics/Bitmap;)V
    .locals 0

    iput-object p1, p0, Lbi/b;->h:Landroid/graphics/Bitmap;

    return-void
.end method

.method public static final g(Lbi/b;Ljava/util/concurrent/CountDownLatch;)V
    .locals 1
    ...
    iget-boolean v0, p0, Lbi/b;->f:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lbi/b;->cacheLastBitmap()V

    :cond_0
    invoke-virtual {p0}, Lbi/b;->releaseGLResource()V
...
.method public static synthetic i(Lbi/b;IIIILjava/lang/Object;)Lbi/b;
    .locals 0
    ...
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, Lbi/b;->h(III)Lbi/b;
...
.method public buildFURenderInputData()Lcom/faceunity/core/entity/FURenderInputData;
    ...
    invoke-virtual {p0}, Lbi/b;->getMEmptyTextureInputData()Lcom/faceunity/core/entity/FURenderInputData;
...
.method public final cacheLastBitmap()V
    ...
    :cond_0
    iget-object v1, p0, Lbi/b;->a:Lcom/faceunity/toolbox/program/FUProgramTexture2d;
    ...
    invoke-virtual {p0}, Lbi/b;->getMFUPhotoRecordHelper()Lcom/faceunity/core/media/photo/FUPhotoRecordHelper;
...
.method public final drawCacheBitmap()V
    ...
    iget-object v0, p0, Lbi/b;->h:Landroid/graphics/Bitmap;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lbi/b;->deleteCacheBitmapTexId()V

    invoke-static {v0}, Lcom/faceunity/toolbox/utils/FUGLUtils;->createImageTexture(Landroid/graphics/Bitmap;)I

    move-result v1

    iput v1, p0, Lbi/b;->i:I
...
.method public drawRenderFrame()V
    ...
    invoke-virtual {p0}, Lbi/b;->drawCacheBitmap()V
    ...
    iget-object v2, p0, Lbi/b;->a:Lcom/faceunity/toolbox/program/FUProgramTexture2d;
...
.method public final getMEmptyTextureInputData()Lcom/faceunity/core/entity/FURenderInputData;
    ...
    iget-object p0, p0, Lbi/b;->l:Lck/g;
...
.method public final getMFUPhotoRecordHelper()Lcom/faceunity/core/media/photo/FUPhotoRecordHelper;
    ...
    iget-object p0, p0, Lbi/b;->g:Lck/g;
...
.method public final h(III)Lbi/b;
    .locals 1
    ...
    iget p3, p0, Lbi/b;->b:I

    int-to-float p3, p3

    iget v0, p0, Lbi/b;->c:I
...
.method public isRenderEnvironmentPrepare()Z
    ...
    iget-object p0, p0, Lbi/b;->a:Lcom/faceunity/toolbox/program/FUProgramTexture2d;
...
.method public pauseRender()V
    ...
    invoke-direct {v3, p0, v0}, Lbi/a;-><init>(Lbi/b;Ljava/util/concurrent/CountDownLatch;)V
...
.method public release()V
    ...
    iput-object v0, p0, Lbi/b;->h:Landroid/graphics/Bitmap;
...
.method public releaseGLResource()V
    ...
    iget-object v0, p0, Lbi/b;->a:Lcom/faceunity/toolbox/program/FUProgramTexture2d;
    ...
    iput-object v0, p0, Lbi/b;->a:Lcom/faceunity/toolbox/program/FUProgramTexture2d;
...
.method public surfaceCreated(Landroid/opengl/EGLConfig;)V
    ...
    iput-object p1, p0, Lbi/b;->a:Lcom/faceunity/toolbox/program/FUProgramTexture2d;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lbi/b;->j:Z

    iput-boolean p1, p0, Lbi/b;->f:Z
