...
.method public constructor <init>(Lbd/e;Landroid/os/Looper;)V
    ...
    iput-object p2, p0, Lbd/k;->f:Ljava/util/LinkedList;

    iput-object p1, p0, Lbd/k;->a:Lbd/e;
    ...
    invoke-virtual {p2, v0, v1}, Lkd/a;->j(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lbd/k;->e:Ljava/lang/String;

    const-string v0, "asr.encoded_by_client"

    const/4 v1, 0x0

    invoke-virtual {p2, v0, v1}, Lkd/a;->c(Ljava/lang/String;Z)Z
    ...
    iget-object v0, p0, Lbd/k;->e:Ljava/lang/String;
    ...
    invoke-direct {v0, p1}, Lcom/xiaomi/ai/android/codec/AudioEncoder;-><init>(Lbd/a;)V

    iput-object v0, p0, Lbd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    iget-object p1, p0, Lbd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    invoke-virtual {p1}, Lcom/xiaomi/ai/android/codec/AudioEncoder;->d()V

    const/4 p1, 0x0

    iput-object p1, p0, Lbd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    :cond_2
    const-string p1, "asr.vad_type"

    invoke-virtual {p2, p1}, Lkd/a;->e(Ljava/lang/String;)I
    ...
    :cond_3
    iput-boolean v1, p0, Lbd/k;->d:Z

    if-eqz v1, :cond_5

    const-string p1, "asr.enable_new_vad"

    invoke-virtual {p2, p1}, Lkd/a;->b(Ljava/lang/String;)Z
    ...
    invoke-virtual {p2, v2}, Lkd/a;->e(Ljava/lang/String;)I

    move-result v2

    const-string v3, "asr.maxvoice"

    invoke-virtual {p2, v3}, Lkd/a;->e(Ljava/lang/String;)I
    ...
    iput-object p1, p0, Lbd/k;->c:Lgd/a;
...
.method public a()V
    ...
    :try_start_0
    iget-object v0, p0, Lbd/k;->f:Ljava/util/LinkedList;
    ...
    iget-object v2, p0, Lbd/k;->f:Ljava/util/LinkedList;
...
.method public b(Landroid/os/Message;)V
    ...
    iget-object v0, p0, Lbd/k;->a:Lbd/e;

    invoke-virtual {v0}, Lbd/e;->q()Lbd/h;
    ...
    invoke-virtual {v0, v1}, Lbd/h;->d(Lid/d;)V
...
.method public final c([BZ)V
    ...
    :cond_2
    iget-object v1, p0, Lbd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    invoke-virtual {v1, p1, p2}, Lcom/xiaomi/ai/android/codec/AudioEncoder;->a([BZ)I

    move-result p1

    iget-object p2, p0, Lbd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    invoke-virtual {p2}, Lcom/xiaomi/ai/android/codec/AudioEncoder;->c()[B

    move-result-object p2

    iget-object v1, p0, Lbd/k;->a:Lbd/e;

    invoke-virtual {v1}, Lbd/e;->n()Lkd/b;
    ...
    iget-object p0, p0, Lbd/k;->a:Lbd/e;

    invoke-virtual {p0}, Lbd/e;->l()Lbd/f;

    move-result-object p0

    invoke-virtual {p0}, Lbd/f;->f()Ljava/lang/String;

    move-result-object p0

    invoke-virtual {v0, p0}, Lbd/j;->j(Ljava/lang/String;)V

    const/4 p0, 0x0

    invoke-virtual {v1, p2, p0, p1}, Lkd/b;->t([BII)Z
...
.method public final f()V
    ...
    iget-object v1, p0, Lbd/k;->f:Ljava/util/LinkedList;
    ...
    :cond_0
    iget-object p0, p0, Lbd/k;->f:Ljava/util/LinkedList;
...
.method public final g()V
    ...
    invoke-virtual {v0}, Lid/j;->a()Ljava/lang/String;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :cond_1
    iget-object p1, p0, Lbd/k;->a:Lbd/e;
    ...
    invoke-virtual {p1, v0}, Lbd/e;->g(Lld/a;)V
    ...
    invoke-virtual {p0}, Lbd/e;->o()Lbd/b;

    move-result-object p0

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, Lbd/b;->w(Z)V
    ...
    iget-object v5, p0, Lbd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    invoke-virtual {p0, v2, p1}, Lbd/k;->c([BZ)V
    ...
    iget-object v4, p0, Lbd/k;->a:Lbd/e;

    invoke-virtual {v4}, Lbd/e;->l()Lbd/f;

    move-result-object v4

    invoke-virtual {v4}, Lbd/f;->f()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p1, v4}, Lbd/j;->j(Ljava/lang/String;)V

    invoke-virtual {v0, v2}, Lkd/b;->s([B)Z
    ...
    :goto_1
    iget-object p1, p0, Lbd/k;->c:Lgd/a;

    if-eqz p1, :cond_c

    if-eqz v2, :cond_c

    invoke-interface {p1, v2}, Lgd/a;->a([B)Z
    ...
    new-instance p1, Lhd/ub;

    invoke-direct {p1}, Lhd/ub;-><init>()V

    invoke-static {p1}, Lid/a;->c(Lid/i;)Lid/g;
    ...
    invoke-virtual {v1}, Lbd/f;->f()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lid/h;->g(Ljava/lang/String;)Lid/h;
    ...
    invoke-virtual {v0, p1}, Lbd/j;->u(Lid/g;)V

    iget-object v0, p0, Lbd/k;->a:Lbd/e;

    invoke-virtual {v0}, Lbd/e;->k()Lbd/d;
    ...
    iget-object p0, p0, Lbd/k;->c:Lgd/a;

    invoke-interface {p0}, Lgd/a;->release()V
    ...
    iget-object v2, p0, Lbd/k;->c:Lgd/a;

    invoke-interface {v2}, Lgd/a;->release()V

    iget-object v2, p0, Lbd/k;->c:Lgd/a;

    invoke-interface {v2}, Lgd/a;->init()Z

    :cond_8
    iget-object v2, p0, Lbd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    const-string v4, "SpeechRecognizer.RecognizeStreamFinished"

    if-eqz v2, :cond_a

    iget-object v2, p0, Lbd/k;->e:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v3}, Lbd/k;->c([BZ)V
    ...
    invoke-virtual {v1, p1}, Lbd/j;->n(Lid/d;)V
    ...
    const-class v1, Lad/c;

    invoke-virtual {p0, v1}, Lbd/e;->c(Ljava/lang/Class;)Lad/b;
    ...
    invoke-virtual {p0, v1}, Lad/c;->d(Ljava/lang/String;)V

    :cond_b
    invoke-virtual {v0, p1}, Lkd/b;->u(Lid/d;)Z
