...
.method public a(Lud/d;Lie/c;Lcom/xiaomi/engine/TaskSession;)V
    ...
    invoke-direct/range {v4 .. v9}, Lud/d$a;-><init>(IZLzj/c;ZZ)V
    ...
    invoke-static {v4, v0}, Lrd/e;->b(Ljava/lang/String;I)V
    ...
    invoke-virtual {v7}, Lud/d$a;->e()Landroid/media/Image;
    ...
    :cond_3
    invoke-static {v4, v10}, Lrd/e;->b(Ljava/lang/String;I)V
    ...
    :goto_2
    invoke-virtual {v3, v6, v0, v0}, Lud/d$a;->B(Landroid/media/Image;IZ)V
    ...
    invoke-interface {v6, v11}, Lud/e;->a(Landroid/media/Image;)V

    invoke-virtual {v8}, Lud/d$a;->k()Landroid/media/Image;
    ...
    invoke-interface {v6, v8}, Lud/e;->a(Landroid/media/Image;)V
    ...
    invoke-interface {v6, v1}, Lud/e;->a(Landroid/media/Image;)V

    invoke-virtual {v3, v5, v10}, Lud/d$a;->x(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    invoke-virtual {v4}, Lud/d$a;->m()Landroid/media/Image;

    move-result-object v1

    invoke-virtual {v4}, Lud/d$a;->v()Z

    move-result v5

    invoke-virtual {v3, v1, v9, v5}, Lud/d$a;->B(Landroid/media/Image;IZ)V
    ...
    invoke-virtual {v3, v1, v10, v0}, Lud/d$a;->B(Landroid/media/Image;IZ)V

    :cond_9
    invoke-virtual {v3}, Lud/d$a;->o()Z
    ...
    invoke-virtual {v1, v4, v3, v5}, Lie/a;->b(Lud/d;Lud/d$a;Lie/c;)V
...
.method public final b(Lud/d;Lud/d$a;Lie/c;)V
    .locals 0
