...
# virtual methods
.method public a(Lud/d;Lie/c;Lcom/xiaomi/engine/TaskSession;)V
    .locals 30
    .param p1    # Lud/d;
    ...
    new-instance v14, Lud/d$a;

    invoke-virtual/range {p1 .. p1}, Lud/d;->q()I

    move-result v9

    invoke-virtual/range {p1 .. p1}, Lud/d;->z()Z

    move-result v10

    invoke-virtual/range {p1 .. p1}, Lud/d;->p()Lzj/c;

    move-result-object v11

    const/4 v12, 0x1

    invoke-virtual/range {p1 .. p1}, Lud/d;->v()Z

    move-result v13

    move-object v8, v14

    invoke-direct/range {v8 .. v13}, Lud/d$a;-><init>(IZLzj/c;ZZ)V
    ...
    invoke-static {v9, v5}, Lrd/e;->b(Ljava/lang/String;I)V
    ...
    check-cast v15, Lud/d$a;

    invoke-virtual {v15}, Lud/d$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v16, Ll9/cs;->Q1:Ll9/ds;

    invoke-virtual/range {v16 .. v16}, Ll9/ds;->b()Ljava/lang/Object;
    ...
    invoke-virtual {v15}, Lud/d$a;->e()Landroid/media/Image;
    ...
    invoke-static {v9, v10}, Lrd/e;->b(Ljava/lang/String;I)V
    ...
    invoke-virtual {v1}, Lud/d$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v9, v8}, Lrd/e;->b(Ljava/lang/String;I)V
    ...
    check-cast v20, Lud/d$a;

    invoke-virtual/range {v20 .. v20}, Lud/d$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v21, Ll9/cs;->Q1:Ll9/ds;

    invoke-virtual/range {v21 .. v21}, Ll9/ds;->b()Ljava/lang/Object;
    ...
    invoke-virtual/range {v20 .. v20}, Lud/d$a;->k()Landroid/media/Image;
    ...
    invoke-virtual {v0}, Lud/d$a;->k()Landroid/media/Image;
    ...
    invoke-virtual {v14, v0, v2, v4}, Lud/d$a;->B(Landroid/media/Image;IZ)V
    ...
    :goto_e
    invoke-virtual {v14, v3, v2}, Lud/d$a;->x(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    invoke-virtual {v1}, Lud/d$a;->m()Landroid/media/Image;

    move-result-object v0

    const/4 v2, 0x2

    invoke-virtual {v1}, Lud/d$a;->v()Z

    move-result v3

    invoke-virtual {v14, v0, v2, v3}, Lud/d$a;->B(Landroid/media/Image;IZ)V
    ...
    invoke-virtual {v14, v0, v2, v2}, Lud/d$a;->B(Landroid/media/Image;IZ)V
    ...
    invoke-virtual/range {p1 .. p1}, Lud/d;->g()Lud/e;
    ...
    :cond_10
    invoke-virtual {v3}, Lud/d$a;->e()Landroid/media/Image;

    move-result-object v5

    invoke-virtual {v5}, Landroid/media/Image;->close()V

    invoke-interface {v0, v5}, Lud/e;->a(Landroid/media/Image;)V

    invoke-virtual {v3}, Lud/d$a;->k()Landroid/media/Image;
    ...
    :cond_11
    invoke-virtual {v3}, Lud/d$a;->m()Landroid/media/Image;
    ...
    invoke-interface {v0, v3}, Lud/e;->a(Landroid/media/Image;)V
    ...
    invoke-interface {v0, v2}, Lud/e;->a(Landroid/media/Image;)V

    invoke-virtual {v1}, Lud/d$a;->k()Landroid/media/Image;
    ...
    invoke-interface {v0, v1}, Lud/e;->a(Landroid/media/Image;)V
    ...
    invoke-virtual {v14, v1, v2, v3}, Lud/d$a;->B(Landroid/media/Image;IZ)V
    ...
    :goto_13
    invoke-virtual {v14}, Lud/d$a;->o()Z
    ...
    invoke-virtual {v1, v3}, Lud/d$a;->D(Z)V
    ...
    invoke-virtual {v1, v2, v4, v5}, Lie/d;->b(Lud/d;Ljava/util/List;Lie/c;)V
    ...
    invoke-virtual {v1, v2, v14, v5}, Lie/d;->c(Lud/d;Lud/d$a;Lie/c;)V
...
.method public final b(Lud/d;Ljava/util/List;Lie/c;)V
    .locals 0
    ...
    invoke-virtual {p1, p0}, Lud/d;->M(Lud/d$a;)V

    invoke-virtual {p1, p2}, Lud/d;->G(Ljava/util/List;)V

    invoke-virtual {p1}, Lud/d;->w()Z

    move-result p0

    xor-int/lit8 p0, p0, 0x1

    invoke-interface {p3, p1, p0}, Lie/c;->a(Lud/d;Z)V

    return-void
.end method

.method public final c(Lud/d;Lud/d$a;Lie/c;)V
    .locals 0

    invoke-virtual {p1, p2}, Lud/d;->M(Lud/d$a;)V
