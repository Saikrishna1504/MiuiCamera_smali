...
# direct methods
.method public constructor <init>(Lbl/c$c;)V
    .locals 8
    ...
    iput-object v0, p0, Lbl/c;->a:Ljava/lang/String;

    new-instance v1, Ljava/util/Stack;

    invoke-direct {v1}, Ljava/util/Stack;-><init>()V

    iput-object v1, p0, Lbl/c;->d:Ljava/util/Stack;

    new-instance v2, Lr2/e;

    invoke-direct {v2}, Lr2/e;-><init>()V

    iput-object v2, p0, Lbl/c;->e:Lr2/e;

    const/4 v2, 0x0

    iput v2, p0, Lbl/c;->s:I

    new-instance v3, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {v3}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object v3, p0, Lbl/c;->t:Ljava/util/concurrent/locks/ReentrantLock;

    const/4 v3, 0x1

    new-array v4, v3, [I

    iput-object v4, p0, Lbl/c;->v:[I

    const v4, 0xac44

    iput v4, p0, Lbl/c;->z:I

    const/4 v4, 0x2

    iput v4, p0, Lbl/c;->A:I

    const v5, 0x17700

    iput v5, p0, Lbl/c;->B:I

    new-instance v5, Lbl/c$b;

    invoke-direct {v5, p0}, Lbl/c$b;-><init>(Lbl/c;)V

    iput-object v5, p0, Lbl/c;->F:Lbl/c$b;

    const-string v5, "camera.debug.dump_milive"

    invoke-static {v5, v2}, Lbk/j;->c(Ljava/lang/String;Z)Z

    move-result v5

    iput-boolean v5, p0, Lbl/c;->w:Z

    iget-object v6, p1, Lbl/c$c;->a:Ljava/lang/ref/WeakReference;

    iput-object v6, p0, Lbl/c;->b:Ljava/lang/ref/WeakReference;

    iget v7, p1, Lbl/c$c;->b:I

    iput v7, p0, Lbl/c;->h:I

    iget-object v7, p1, Lbl/c$c;->c:Ljava/lang/String;

    iput-object v7, p0, Lbl/c;->i:Ljava/lang/String;

    iget-object v7, p1, Lbl/c$c;->d:Lcom/xiaomi/microfilm/milive/a$d;

    iput-object v7, p0, Lbl/c;->o:Lcom/xiaomi/microfilm/milive/a$d;

    iget-object v7, p1, Lbl/c$c;->f:Landroid/os/Handler;

    iput-object v7, p0, Lbl/c;->p:Landroid/os/Handler;

    iget-object p1, p1, Lbl/c$c;->e:Ljava/util/List;
    ...
    iput-object v0, p0, Lbl/c;->c:Lg9/f;
...
.method public final b(II)V
    ...
    iput v0, p0, Lbl/c;->f:I

    invoke-static {p1, p2}, Ljava/lang/Math;->max(II)I

    move-result p1

    iput p1, p0, Lbl/c;->g:I
...
.method public final c(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lbl/c;->a:Ljava/lang/String;

    invoke-static {v2, v0, v1}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iput-object p1, p0, Lbl/c;->j:Ljava/lang/String;
...
.method public final d(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lbl/c;->k:Ljava/lang/String;
...
.method public final e(I)V
    ...
    invoke-virtual {p0, v2}, Lbl/c;->a(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lbl/c;->a(I)Ljava/lang/String;
    ...
    iput p1, p0, Lbl/c;->s:I

    iget-object p1, p0, Lbl/c;->n:Lcom/xiaomi/microfilm/milive/a$c;

    if-eqz p1, :cond_0

    iget p0, p0, Lbl/c;->s:I
...
.method public final h(Lcom/xiaomi/microfilm/milive/a$d;)V
    ...
    invoke-direct/range {v1 .. v7}, Lbl/c$a;-><init>(Lbl/c;JJLcom/xiaomi/microfilm/milive/a$d;)V

    iput-object v0, p0, Lbl/c;->q:Lbl/c$a;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v0

    iput-wide v0, p0, Lbl/c;->r:J

    iget-object p1, p0, Lbl/c;->q:Lbl/c$a;
...
.method public final i()V
    ...
    iget-object v1, p0, Lbl/c;->c:Lg9/f;

    iget-object v1, v1, Lg9/f;->p:Lno/e;

    iget-object v1, v1, Lno/e;->p:Lap/a;

    invoke-virtual {v1, v0}, Lap/a;->b([F)V
    ...
    iget-object v3, p0, Lbl/c;->C:Lu2/c;

    iget-object v3, v3, Lu2/c;->b:Lta/j;

    iget v3, v3, Lta/b;->a:I
    ...
    iget-object v0, p0, Lbl/c;->y:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;
    ...
    iget-object v2, p0, Lbl/c;->j:Ljava/lang/String;

    invoke-static {v2}, Landroid/text/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z

    move-result v2

    iget v3, p0, Lbl/c;->h:I

    if-nez v2, :cond_2

    iget-object v2, p0, Lbl/c;->y:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    iget-object p0, p0, Lbl/c;->j:Ljava/lang/String;
    ...
    :cond_2
    iget-object p0, p0, Lbl/c;->y:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;
