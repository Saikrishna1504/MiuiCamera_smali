...
.field public final c:Lll/r;

.field public d:Z

.field public final e:[I

.field public f:Lpl/b;
...
.method public constructor <init>(Lql/f;)V
    ...
    iput-object v0, p0, Lql/g;->e:[I

    iput-object p1, p0, Lql/g;->a:Lql/f;
    ...
    iput-object p1, p0, Lql/g;->b:Lcom/android/camera/ActivityBase;
    ...
    iput-object p1, p0, Lql/g;->g:Landroid/os/Handler;
    ...
    iput-object p1, p0, Lql/g;->c:Lll/r;
...
.method public static c()Lik/b;
    ...
    :goto_1
    iput-object v0, v5, Lik/b;->d:Ljava/lang/String;
...
.method public final Q(Landroid/media/Image;)V
    ...
    iget-object v0, p0, Lql/g;->f:Lpl/b;

    if-eqz v0, :cond_2

    iget-object v1, p0, Lql/g;->a:Lql/f;
    ...
    :cond_1
    iput p1, p0, Lql/g;->h:I

    iget-object v0, p0, Lql/g;->g:Landroid/os/Handler;

    new-instance v1, Lcom/android/camera/module/pano/c;

    const/4 v2, 0x1

    invoke-direct {v1, p0, p1, v2}, Lcom/android/camera/module/pano/c;-><init>(Ljava/lang/Object;II)V
...
.method public final R()V
    ...
    iget-object v1, p0, Lql/g;->b:Lcom/android/camera/ActivityBase;
    ...
    invoke-virtual {v2}, Lcom/android/camera/ActivityBase;->Ii()Z

    move-result v2

    if-eqz v2, :cond_1

    iget-object v2, p0, Lql/g;->f:Lpl/b;
    ...
    iget-object p0, p0, Lql/g;->f:Lpl/b;

    invoke-interface {p0}, Lpl/b;->S2()Ljava/util/HashMap;

    move-result-object p0

    invoke-static {p0, v1, v2, v0}, Ln8/a;->a0(Ljava/util/Map;Ljava/lang/String;ZZ)V
...
.method public final a(Landroid/graphics/Rect;IIZZ)Z
    ...
    iget-object v1, v0, Lql/g;->f:Lpl/b;

    const/4 v10, 0x0

    if-eqz v1, :cond_5

    iget-object v2, v0, Lql/g;->b:Lcom/android/camera/ActivityBase;

    if-eqz v2, :cond_5

    iget-object v11, v0, Lql/g;->c:Lll/r;
    ...
    :cond_0
    iget-object v6, v0, Lql/g;->e:[I

    iget-boolean v8, v0, Lql/g;->d:Z
    ...
    :cond_1
    iget-boolean v1, v0, Lql/g;->d:Z

    if-eqz v1, :cond_3

    iput-boolean v10, v0, Lql/g;->d:Z
    ...
    iget-object v11, v0, Lql/g;->a:Lql/f;

    invoke-virtual {v11}, Lql/f;->m()Lkn/b;
    ...
    invoke-virtual {v1, v10}, Lrl/b;->b(I)V
    ...
    new-instance v3, Lg7/i1;

    invoke-direct {v3, p0, v2, v1}, Lg7/i1;-><init>(Lql/g;[BLandroid/graphics/Rect;)V

    iget-object v0, v11, Lql/f;->d:Ljava/util/concurrent/ExecutorService;
...
.method public final b()V
    ...
    iput-object v0, p0, Lql/g;->f:Lpl/b;

    const/4 v0, 0x0

    iput v0, p0, Lql/g;->h:I

    return-void
.end method

.method public final d()Ljg/f;
    .locals 3
    ...
    iget-object p0, p0, Lql/g;->a:Lql/f;

    iget-boolean v1, p0, Lql/f;->j:Z
    ...
    :goto_0
    invoke-virtual {v0, v1}, Ljg/f;->b(Z)V

    iget-boolean p0, p0, Lql/f;->j:Z

    invoke-virtual {v0, p0}, Ljg/f;->f(Z)V

    iput-boolean v2, v0, Ljg/f;->f:Z

    const-string p0, "off"

    invoke-virtual {v0, p0}, Ljg/f;->c(Ljava/lang/String;)V
