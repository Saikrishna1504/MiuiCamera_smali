...
# direct methods
.method public static a(Lkm/a;)V
    .locals 10
    ...
    sget-object v3, Lvm/b;->a:Ljava/lang/String;

    invoke-virtual {v2, v3}, Ltm/a;->j(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v1, v3}, Lcc/k;->y(ILjava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    :cond_0
    invoke-static {v4}, Lck/f;->l(Ljava/lang/String;)Z
    ...
    invoke-static {v7, v1, v3}, Lcc/k;->y(ILjava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v5, Lim/a;->a:Ljava/lang/String;
    ...
    sget-object v8, Lim/a;->b:Ljava/lang/String;
    ...
    invoke-static {v0, v4, v1}, Lcc/k;->y(ILjava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lul/g$a;->a:Lul/g;

    iget-object v1, v0, Lul/g;->Y:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v0}, Lul/g;->u()V

    goto :goto_2

    :cond_4
    iget-object v1, v0, Lul/g;->W:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v2}, Ltm/a;->h()I

    move-result v2

    invoke-direct {v1, v2}, Lam/l;-><init>(I)V

    iput-object v1, v0, Lul/g;->r:Lam/l;

    iget-object v1, v1, Lam/l;->a:Lam/k;

    iput-object v1, v0, Lul/g;->f0:Lam/k;
    ...
    iget-object v0, v0, Lul/g;->q:Lcom/faceunity/core/faceunity/FUAIKit;
    ...
    invoke-direct {v0, p0, v1}, Lcom/xiaomi/camera/mivi/b;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v2, v0}, Lg9/f;->u(Ljava/lang/Runnable;)V
    ...
    invoke-static {v6, v4, p0}, Lcc/k;->y(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6, v4, v0}, Lcc/k;->y(ILjava/lang/String;Ljava/lang/String;)V

    iget-object p0, p0, Lul/g$a;->a:Lul/g;

    const/4 v0, 0x0

    iput-object v0, p0, Lul/g;->t0:Lkm/a;
...
.method public static b(Ljava/lang/String;Lkm/a;)V
    .locals 13
    ...
    iput-object v4, v0, Lkn/c;->a:[B

    iput-object v5, v0, Lkn/c;->b:[B
    ...
    invoke-direct/range {v6 .. v11}, Lhm/a;-><init>(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lkm/a;Ljava/util/concurrent/atomic/AtomicBoolean;)V

    invoke-static {v12, v3}, Lbq/t;->F(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
    ...
    invoke-direct/range {v3 .. v9}, Lhm/b;-><init>([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lkm/a;Ljava/util/concurrent/atomic/AtomicInteger;)V

    invoke-static {v12, p0}, Lbq/t;->F(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
