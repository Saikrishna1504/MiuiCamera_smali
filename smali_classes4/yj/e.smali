...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lyj/e;->c:Lgp/i;

    sget-object v0, Lyj/e$b;->a:Lyj/e$b;

    invoke-static {v0}, Lrt/c;->g(Lsp/a;)Lgp/i;

    move-result-object v0

    sput-object v0, Lyj/e;->d:Lgp/i;
...
.method public static final a(Lcom/xiaomi/camera/upgrade/UpgradeBean;Landroidx/fragment/app/FragmentManager;Ljava/lang/String;Lcom/xiaomi/camera/upgrade/fragment/UpdateDialogFragment$a;)V
    ...
    sget-object v2, Lyj/e;->b:Lcom/xiaomi/camera/upgrade/fragment/UpdateDialogFragment;
    ...
    sput-object p0, Lyj/e;->b:Lcom/xiaomi/camera/upgrade/fragment/UpdateDialogFragment;
...
.method public static b(Landroid/app/Application;ILandroidx/fragment/app/FragmentManager;Ljava/lang/String;La0/m7;)V
    .locals 18
    ...
    invoke-static {v1, v5}, La0/z3;->h(ILjava/lang/String;)V
    ...
    sget-object v5, Lyj/e;->a:Lio/reactivex/disposables/Disposable;
    ...
    :cond_2
    new-instance v8, Lzj/a;

    invoke-direct {v8, v0, v6}, Lzj/a;-><init>(Landroid/app/Application;Z)V

    new-instance v6, Lyj/c;

    invoke-direct {v6, v1, v2, v0}, Lyj/c;-><init>(ILandroid/content/SharedPreferences;Landroid/app/Application;)V

    new-instance v9, Lyh/b;

    invoke-direct {v9, v7, v6}, Lyh/b;-><init>(ILsp/l;)V
    ...
    new-instance v8, Lyj/d;

    invoke-direct {v8, v2}, Lyj/d;-><init>(Landroid/content/SharedPreferences;)V

    new-instance v2, Lyh/c;

    invoke-direct {v2, v7, v8}, Lyh/c;-><init>(ILsp/l;)V
    ...
    invoke-direct {v2, v0, v5, v3, v4}, Lyj/a;-><init>(Landroid/app/Application;Ljava/lang/ref/WeakReference;Ljava/lang/String;La0/m7;)V

    new-instance v0, Lc5/g;

    const/4 v6, 0x6

    invoke-direct {v0, v2, v6}, Lc5/g;-><init>(Ljava/lang/Object;I)V

    new-instance v2, Lyj/b;

    invoke-direct {v2, v5, v3, v4}, Lyj/b;-><init>(Ljava/lang/ref/WeakReference;Ljava/lang/String;La0/m7;)V

    new-instance v3, Ln2/d1;

    const/4 v4, 0x5

    invoke-direct {v3, v2, v4}, Ln2/d1;-><init>(Ljava/lang/Object;I)V
    ...
    sput-object v0, Lyj/e;->a:Lio/reactivex/disposables/Disposable;
...
.method public static c(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lyj/e;->d(Landroid/content/Context;)Landroid/content/pm/PackageInfo;
...
.method public static e(Landroid/app/Application;Lcom/xiaomi/camera/upgrade/preference/DrawablePreference;)V
    ...
    invoke-static {p0}, Lyj/e;->c(Landroid/content/Context;)Z

    move-result p0

    if-eqz p0, :cond_0

    sget v0, Lk9/d;->update_new_version:I

    goto :goto_0

    :cond_0
    sget v0, Lk9/d;->update_latest_version:I
    ...
    sget p0, Lk9/a;->update_find_new_version_text_color:I

    goto :goto_1

    :cond_1
    sget p0, Lk9/a;->black_40_transparent_with_dark_mode:I
