...
.method public static synthetic a(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Luh/a;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lqh/d;->i(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Luh/a;Ljava/util/concurrent/atomic/AtomicBoolean;)V

    return-void
.end method

.method public static synthetic b([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Luh/a;Ljava/util/concurrent/atomic/AtomicInteger;)V
    .locals 0

    invoke-static/range {p0 .. p5}, Lqh/d;->k([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Luh/a;Ljava/util/concurrent/atomic/AtomicInteger;)V

    return-void
.end method

.method public static synthetic c(Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Luh/a;Ljava/util/concurrent/atomic/AtomicInteger;ILjava/lang/String;)V
    .locals 0

    invoke-static/range {p0 .. p5}, Lqh/d;->j(Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Luh/a;Ljava/util/concurrent/atomic/AtomicInteger;ILjava/lang/String;)V
...
.method public static e()Z
    ...
    sget-object v0, Lqh/d;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lxi/c;->a(Ljava/lang/String;Ljava/lang/String;)V

    return v4

    :cond_0
    invoke-static {v1}, Lxi/i;->i(Ljava/lang/String;)Z
...
.method public static f(Lcom/faceunity/core/avatar/model/Avatar;Ljava/util/List;)Z
    ...
    sget-object p0, Lqh/d;->a:Ljava/lang/String;
    ...
    invoke-static {v5}, Lxi/i;->i(Ljava/lang/String;)Z
    ...
    invoke-static {v1, v4}, Lqh/d;->d(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    sget-object p1, Lqh/d;->a:Ljava/lang/String;
    ...
    invoke-static {p1, p0}, Lxi/c;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static g(ZILuh/a;)V
    .locals 0
    ...
    invoke-static {}, Lqh/d;->e()Z

    move-result p0

    if-eqz p0, :cond_1

    invoke-static {}, Lqh/d;->l()V
    ...
    invoke-interface {p2, p0, p1}, Luh/a;->b(ILjava/lang/String;)V
    ...
    invoke-interface {p2, p0, p1}, Luh/a;->a(ILjava/lang/String;)V
...
.method public static h(Ljava/lang/String;Luh/a;)V
    .locals 13
    ...
    invoke-virtual {v0, v3, v4}, Lxi/f;->d([B[B)V
    ...
    invoke-direct/range {v5 .. v10}, Lqh/a;-><init>(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Luh/a;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    invoke-static {p0}, Lqh/d;->m(Lcom/faceunity/toolbox/utils/FULogger$LogLevel;)V

    sget-object p0, Lcom/faceunity/toolbox/utils/FULogger$LogLevel;->INFO:Lcom/faceunity/toolbox/utils/FULogger$LogLevel;

    invoke-static {p0}, Lqh/d;->n(Lcom/faceunity/toolbox/utils/FULogger$LogLevel;)V

    new-instance p0, Ljava/lang/Thread;

    new-instance v9, Lqh/b;
    ...
    invoke-direct/range {v2 .. v8}, Lqh/b;-><init>([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Luh/a;Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method public static synthetic i(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Luh/a;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 3
    ...
    invoke-virtual {v1, v2, p0}, Lei/e;->B(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p2, v1, p3}, Lqh/d;->g(ZILuh/a;)V
...
.method public static synthetic j(Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Luh/a;Ljava/util/concurrent/atomic/AtomicInteger;ILjava/lang/String;)V
    .locals 2
    ...
    invoke-static {v1, p4, p2}, Lqh/d;->g(ZILuh/a;)V
    ...
    invoke-interface {p2, p4, p5}, Luh/a;->a(ILjava/lang/String;)V
...
.method public static synthetic k([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Luh/a;Ljava/util/concurrent/atomic/AtomicInteger;)V
    .locals 2
    ...
    invoke-direct {v0, p2, p3, p4, p5}, Lqh/c;-><init>(Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Luh/a;Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method public static l()V
    ...
    sget-object v1, Lrh/a;->b:Ljava/lang/String;
    ...
    sget-object v2, Lrh/a;->c:Ljava/lang/String;
