...
.field private transient reflected:Lxp/b;
...
.method public varargs call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->getReflected()Lxp/b;

    move-result-object p0

    invoke-interface {p0, p1}, Lxp/b;->call([Ljava/lang/Object;)Ljava/lang/Object;
...
.method public callBy(Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-interface {p0, p1}, Lxp/b;->callBy(Ljava/util/Map;)Ljava/lang/Object;
...
.method public compute()Lxp/b;
    .locals 1

    iget-object v0, p0, Lkotlin/jvm/internal/c;->reflected:Lxp/b;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->computeReflected()Lxp/b;

    move-result-object v0

    iput-object v0, p0, Lkotlin/jvm/internal/c;->reflected:Lxp/b;

    :cond_0
    return-object v0
.end method

.method public abstract computeReflected()Lxp/b;
.end method
...
.method public getAnnotations()Ljava/util/List;
    ...
    invoke-interface {p0}, Lxp/a;->getAnnotations()Ljava/util/List;
...
.method public getParameters()Ljava/util/List;
    ...
    invoke-interface {p0}, Lxp/b;->getParameters()Ljava/util/List;
...
.method public getReflected()Lxp/b;
    .locals 1

    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->compute()Lxp/b;
...
.method public getReturnType()Lxp/j;
    .locals 0
    ...
    invoke-interface {p0}, Lxp/b;->getReturnType()Lxp/j;
...
.method public getTypeParameters()Ljava/util/List;
    ...
    invoke-interface {p0}, Lxp/b;->getTypeParameters()Ljava/util/List;
...
.method public getVisibility()Lxp/k;
    .locals 0
    ...
    invoke-interface {p0}, Lxp/b;->getVisibility()Lxp/k;
...
.method public isAbstract()Z
    ...
    invoke-interface {p0}, Lxp/b;->isAbstract()Z
...
.method public isFinal()Z
    ...
    invoke-interface {p0}, Lxp/b;->isFinal()Z
...
.method public isOpen()Z
    ...
    invoke-interface {p0}, Lxp/b;->isOpen()Z
...
.method public isSuspend()Z
    ...
    invoke-interface {p0}, Lxp/b;->isSuspend()Z
