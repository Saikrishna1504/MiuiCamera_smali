...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lnk/b;->e:Landroidx/profileinstaller/c;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lnk/b;->a:Ljava/lang/Object;

    sget-object v0, Lnk/b;->e:Landroidx/profileinstaller/c;

    iput-object v0, p0, Lnk/b;->c:Ljava/util/concurrent/Executor;

    sget-object v0, Lnk/b;->f:Landroid/os/Handler;
    ...
    sput-object v0, Lnk/b;->f:Landroid/os/Handler;

    :cond_0
    sget-object v0, Lnk/b;->f:Landroid/os/Handler;

    iput-object v0, p0, Lnk/b;->d:Landroid/os/Handler;
...
.method public static b(Ljava/util/function/BiConsumer;Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-static {p2, p1}, La0/x;->i(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, p0, p1, p2}, Lpk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public c(Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lnk/b;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lnk/b;->b:Ljava/util/function/BiConsumer;

    const/4 v2, 0x0

    iput-object v2, p0, Lnk/b;->b:Ljava/util/function/BiConsumer;
    ...
    iget-object p0, p0, Lnk/b;->c:Ljava/util/concurrent/Executor;

    sget-object v0, Lnk/b;->e:Landroidx/profileinstaller/c;

    if-ne p0, v0, :cond_0

    invoke-static {v1, p1, p2}, Lnk/b;->b(Ljava/util/function/BiConsumer;Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, v2, v1, p1, p2}, Lcom/android/camera/fragment/a;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public cancel(Z)Z
    ...
    invoke-virtual {p0, v1, v0}, Lnk/b;->c(Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method public final complete(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1, v1}, Lnk/b;->c(Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method public final completeExceptionally(Ljava/lang/Throwable;)Z
    ...
    invoke-virtual {p0, v1, p1}, Lnk/b;->c(Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method public final e(Ljava/util/function/Function;)Lnk/b$a;
    .locals 2
    ...
    invoke-direct {v1, p0, p1, v0}, Lnk/b$a;-><init>(Lnk/b;Ljava/util/function/Function;Ljava/util/concurrent/Executor;)V

    return-object v1
.end method

.method public final f(Ljava/util/function/Function;)Lnk/b$c;
    .locals 2

    sget-object v0, Lnk/b;->e:Landroidx/profileinstaller/c;

    new-instance v1, Lnk/b$c;

    invoke-direct {v1, p0, p1, v0}, Lnk/b$c;-><init>(Lnk/b;Ljava/util/function/Function;Ljava/util/concurrent/Executor;)V
...
.method public final g(Ljava/util/function/BiConsumer;Ljava/util/concurrent/Executor;)V
    ...
    iget-object v2, p0, Lnk/b;->c:Ljava/util/concurrent/Executor;
    ...
    :cond_0
    iput-object p2, p0, Lnk/b;->c:Ljava/util/concurrent/Executor;
    ...
    invoke-direct {p2, v1, p1}, Lnk/a;-><init>(Ljava/util/function/BiConsumer;Ljava/util/function/BiConsumer;)V

    move-object p1, p2

    :goto_0
    iput-object p1, p0, Lnk/b;->b:Ljava/util/function/BiConsumer;
    ...
    sget-object v1, Lnk/b;->e:Landroidx/profileinstaller/c;

    if-ne p0, v1, :cond_3

    invoke-static {p1, p2, v0}, Lnk/b;->b(Ljava/util/function/BiConsumer;Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v1, v2, p1, p2, v0}, Lcom/android/camera/fragment/a;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public bridge synthetic orTimeout(JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lnk/b;->d(JLjava/util/concurrent/TimeUnit;)V
...
.method public bridge synthetic thenApply(Ljava/util/function/Function;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-virtual {p0, p1}, Lnk/b;->e(Ljava/util/function/Function;)Lnk/b$a;
...
.method public thenApplyAsync(Ljava/util/function/Function;Ljava/util/concurrent/Executor;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-direct {v0, p0, p1, p2}, Lnk/b$a;-><init>(Lnk/b;Ljava/util/function/Function;Ljava/util/concurrent/Executor;)V
...
.method public thenCombine(Ljava/util/concurrent/CompletionStage;Ljava/util/function/BiFunction;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-direct {v0, p0, p1, p2}, Lnk/b$b;-><init>(Ljava/util/concurrent/CompletableFuture;Ljava/util/concurrent/CompletionStage;Ljava/util/function/BiFunction;)V
...
.method public bridge synthetic thenCompose(Ljava/util/function/Function;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-virtual {p0, p1}, Lnk/b;->f(Ljava/util/function/Function;)Lnk/b$c;
...
.method public thenComposeAsync(Ljava/util/function/Function;Ljava/util/concurrent/Executor;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-direct {v0, p0, p1, p2}, Lnk/b$c;-><init>(Lnk/b;Ljava/util/function/Function;Ljava/util/concurrent/Executor;)V
...
.method public whenComplete(Ljava/util/function/BiConsumer;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-virtual {p0, p1, v0}, Lnk/b;->g(Ljava/util/function/BiConsumer;Ljava/util/concurrent/Executor;)V
...
.method public bridge synthetic whenCompleteAsync(Ljava/util/function/BiConsumer;Ljava/util/concurrent/Executor;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-virtual {p0, p1, p2}, Lnk/b;->g(Ljava/util/function/BiConsumer;Ljava/util/concurrent/Executor;)V
