...
.field public m:Llj/b;

.field public n:I

.field public o:Lmj/b$b;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lmj/b;->c:Z

    iput-boolean v0, p0, Lmj/b;->d:Z

    new-instance v1, Lmj/a;

    invoke-direct {v1}, Lmj/a;-><init>()V

    iput-object v1, p0, Lmj/b;->i:Lmj/a;

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, Lmj/b;->j:Ljava/lang/Object;

    new-instance v1, Landroid/media/AudioTimestamp;

    invoke-direct {v1}, Landroid/media/AudioTimestamp;-><init>()V

    iput-object v1, p0, Lmj/b;->k:Landroid/media/AudioTimestamp;

    iput-boolean v0, p0, Lmj/b;->l:Z

    iput v0, p0, Lmj/b;->n:I

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lmj/b;->p:J

    return-void
.end method

.method public static a(Lmj/b;Ljava/lang/String;I)V
    .locals 4
    ...
    invoke-static {p1, v0, p2}, La0/y;->e(Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iput-wide p1, p0, Lmj/b;->p:J

    :cond_0
    return-void
.end method

.method public static b(Lmj/b;)V
    .locals 5
    ...
    iget-object v3, p0, Lmj/b;->a:Landroid/media/AudioRecord;
    ...
    iget-object v1, p0, Lmj/b;->j:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Lmj/b;->a:Landroid/media/AudioRecord;
...
.method public final c()V
    ...
    iget-object v0, p0, Lmj/b;->b:Ljava/lang/Thread;

    if-nez v0, :cond_2

    iget-boolean v0, p0, Lmj/b;->l:Z
    ...
    invoke-direct {v0, p0}, Lmj/d;-><init>(Lmj/b;)V

    iput-object v0, p0, Lmj/b;->b:Ljava/lang/Thread;
...
.method public final d(Landroid/media/AudioFormat;IIII)V
    ...
    iput-object p1, p0, Lmj/b;->e:Landroid/media/AudioFormat;

    iput p2, p0, Lmj/b;->g:I

    iput p3, p0, Lmj/b;->f:I

    iput p4, p0, Lmj/b;->h:I

    iput p5, p0, Lmj/b;->n:I
    ...
    invoke-direct {p3, p1}, Llj/b;-><init>(I)V

    iput-object p3, p0, Lmj/b;->m:Llj/b;

    new-instance p1, Lmj/b$a;

    invoke-direct {p1, p0}, Lmj/b$a;-><init>(Lmj/b;)V

    iput-object p1, p3, Llj/b;->g:Llj/a;

    goto :goto_0

    :cond_0
    iput-boolean p5, p0, Lmj/b;->l:Z
    ...
    invoke-static {p1, p2, p3}, La0/j0;->g(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-boolean p2, p0, Lmj/b;->l:Z
    ...
    iget-object p2, p0, Lmj/b;->e:Landroid/media/AudioFormat;
    ...
    iput-object p1, p0, Lmj/b;->a:Landroid/media/AudioRecord;
    :try_end_0
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_0 .. :try_end_0} :catch_0

    invoke-virtual {p0}, Lmj/b;->c()V
...
.method public final e()V
    ...
    iput-boolean v2, p0, Lmj/b;->c:Z

    iget-object v0, p0, Lmj/b;->j:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lmj/b;->a:Landroid/media/AudioRecord;
    ...
    iput-object v1, p0, Lmj/b;->a:Landroid/media/AudioRecord;

    iget-object v3, p0, Lmj/b;->i:Lmj/a;

    invoke-virtual {v3}, Lmj/a;->a()V

    monitor-exit v0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v0, p0, Lmj/b;->m:Llj/b;

    if-eqz v0, :cond_3

    iput-object v1, v0, Llj/b;->b:Ljava/nio/ByteBuffer;

    iput-object v1, v0, Llj/b;->c:Ljava/nio/ByteBuffer;

    iput-object v1, v0, Llj/b;->g:Llj/a;

    const-wide/16 v3, -0x1

    iput-wide v3, v0, Llj/b;->d:J

    const-wide/16 v3, 0x0

    iput-wide v3, v0, Llj/b;->e:J

    :cond_3
    iput-object v1, p0, Lmj/b;->m:Llj/b;

    iput-object v1, p0, Lmj/b;->b:Ljava/lang/Thread;

    iput-boolean v2, p0, Lmj/b;->l:Z
...
.method public final f()V
    ...
    iput-boolean v1, p0, Lmj/b;->c:Z

    iget-object v1, p0, Lmj/b;->i:Lmj/a;

    invoke-virtual {v1}, Lmj/a;->a()V

    iget-object v1, p0, Lmj/b;->b:Ljava/lang/Thread;
    ...
    :cond_0
    iget-object p0, p0, Lmj/b;->b:Ljava/lang/Thread;
...
.method public final g()V
    ...
    :try_start_1
    iget-object v3, p0, Lmj/b;->m:Llj/b;

    iget-object v4, v3, Llj/b;->b:Ljava/nio/ByteBuffer;
    ...
    :cond_1
    iput-object v1, v3, Llj/b;->b:Ljava/nio/ByteBuffer;

    iget-object v4, v3, Llj/b;->c:Ljava/nio/ByteBuffer;
