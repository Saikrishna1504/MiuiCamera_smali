...
.method public final b(Lxn/f;)Lcom/xiaomi/okdownload/core/connection/a$a;
    ...
    iget-object p0, p1, Lxn/f;->c:Lun/c;
    ...
    iget-object v2, v1, Lsn/b;->e:Ljava/util/Map;

    if-eqz v2, :cond_0

    invoke-static {v2, v0}, Ltn/d;->b(Ljava/util/Map;Lcom/xiaomi/okdownload/core/connection/a;)V
    ...
    :cond_2
    iget v2, p1, Lxn/f;->a:I

    invoke-virtual {p0, v2}, Lun/c;->b(I)Lun/a;
    ...
    iget-object v5, v3, Lun/a;->c:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iget-object v3, p0, Lun/c;->c:Ljava/lang/String;

    invoke-static {v3}, Ltn/d;->d(Ljava/lang/CharSequence;)Z
    ...
    :cond_3
    iget-object v3, p1, Lxn/f;->d:Lxn/d;

    invoke-virtual {v3}, Lxn/d;->b()Z
    ...
    invoke-virtual {v4, v1, v2, v0}, Lwn/b$a;->g(Lsn/b;ILjava/util/Map;)V
    ...
    invoke-virtual {v4, v1, v2, v5, v3}, Lwn/b$a;->i(Lsn/b;IILjava/util/Map;)V
    ...
    invoke-static {v2, v5, p0, v3}, Lxn/g;->a(IZLun/c;Ljava/lang/String;)Lvn/b;
    ...
    invoke-direct {p0, v2, v0, v1}, Lyn/i;-><init>(IJ)V
    ...
    invoke-direct {p1, p0}, Lyn/f;-><init>(Lvn/b;)V
