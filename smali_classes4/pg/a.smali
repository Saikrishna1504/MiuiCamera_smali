...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lpg/a;->a:Ljava/lang/Object;

    const/16 v0, 0x10e

    iput v0, p0, Lpg/a;->g:I
    ...
    iput-object v1, p0, Lpg/a;->h:Lcom/faceunity/wrapper/faceunity$AvatarInfo;

    const/16 v1, 0xa

    new-array v1, v1, [F

    iput-object v1, p0, Lpg/a;->i:[F

    const/4 v1, 0x4

    new-array v2, v1, [F

    iput-object v2, p0, Lpg/a;->j:[F

    const/4 v2, 0x0

    iput-boolean v2, p0, Lpg/a;->k:Z

    const/16 v2, 0x96

    new-array v2, v2, [F

    iput-object v2, p0, Lpg/a;->l:[F

    new-array v2, v1, [I

    iput-object v2, p0, Lpg/a;->m:[I

    const/4 v2, 0x1

    iput v2, p0, Lpg/a;->s:I

    iput-boolean v2, p0, Lpg/a;->t:Z

    iput v0, p0, Lpg/a;->u:I

    sget-object v0, Lpg/a$d;->d:Lpg/a$d;

    iput-object v0, p0, Lpg/a;->v:Lpg/a$d;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lpg/a;->b:Ljava/util/LinkedList;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lpg/a;->c:Ljava/util/LinkedList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lpg/a;->d:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lpg/a;->e:Ljava/util/List;

    iget-object p0, p0, Lpg/a;->h:Lcom/faceunity/wrapper/faceunity$AvatarInfo;
...
.method public final A()V
    ...
    iget-object v0, p0, Lpg/a;->b:Ljava/util/LinkedList;
    ...
    iput-object v1, p0, Lpg/a;->b:Ljava/util/LinkedList;

    :cond_0
    iget-object v0, p0, Lpg/a;->c:Ljava/util/LinkedList;
    ...
    iput-object v1, p0, Lpg/a;->c:Ljava/util/LinkedList;
    ...
    iput-object v1, p0, Lpg/a;->d:Ljava/util/List;

    :cond_2
    iget-object v0, p0, Lpg/a;->e:Ljava/util/List;

    if-eqz v0, :cond_3

    invoke-interface {v0}, Ljava/util/List;->clear()V

    iput-object v1, p0, Lpg/a;->e:Ljava/util/List;
...
.method public C([BIIII)I
    ...
    iput v1, p0, Lpg/a;->q:I

    :goto_0
    sget-boolean v1, Lpg/a;->M:Z
    ...
    :cond_2
    sget-object v1, Lpg/a$c;->a:[I

    iget-object v3, p0, Lpg/a;->v:Lpg/a$d;
    ...
    :cond_3
    invoke-virtual {p0, p1, p2, p3, p4}, Lpg/a;->q([BIII)I
    ...
    :cond_4
    invoke-virtual {p0, p1, p5, p3, p4}, Lpg/a;->s([BIII)I
    ...
    :cond_5
    invoke-virtual {p0, p1, p2, p3, p4}, Lpg/a;->p([BIII)I
    ...
    :cond_6
    invoke-virtual {p0, p1, p2, p3, p4}, Lpg/a;->r([BIII)I

    move-result p1

    :goto_1
    iget p2, p0, Lpg/a;->f:I
    ...
    :cond_7
    iget-boolean p2, p0, Lpg/a;->x:Z

    if-eqz p2, :cond_8

    iget-boolean p2, p0, Lpg/a;->w:Z

    if-eqz p2, :cond_8

    iput-boolean v2, p0, Lpg/a;->x:Z

    iput-boolean v2, p0, Lpg/a;->w:Z
...
.method public F(I)V
    ...
    iput p1, p0, Lpg/a;->u:I

    iget-boolean p1, p0, Lpg/a;->t:Z

    const/16 v0, 0x5a

    if-eqz p1, :cond_0

    iget p1, p0, Lpg/a;->u:I
    ...
    :goto_0
    iget v0, p0, Lpg/a;->s:I

    if-eq v0, p1, :cond_3

    new-instance v0, Lpg/a$a;

    invoke-direct {v0, p0}, Lpg/a$a;-><init>(Lpg/a;)V

    invoke-virtual {p0, v0}, Lpg/a;->x(Ljava/lang/Runnable;)V

    :cond_3
    iput p1, p0, Lpg/a;->s:I
...
.method public c()V
    ...
    invoke-virtual {p0, v1}, Lpg/a;->y(Ljava/util/List;)V

    iget-object v1, p0, Lpg/a;->e:Ljava/util/List;
    ...
    iget-object p0, p0, Lpg/a;->e:Ljava/util/List;
...
.method public final d()Ljava/lang/Runnable;
    ...
    iget-object p0, p0, Lpg/a;->b:Ljava/util/LinkedList;
...
.method public k()[F
    ...
    iget-object v0, p0, Lpg/a;->h:Lcom/faceunity/wrapper/faceunity$AvatarInfo;
...
.method public n(ZI)V
    ...
    iput-boolean p1, p0, Lpg/a;->t:Z

    new-instance p1, Lpg/a$b;

    invoke-direct {p1, p0, p2}, Lpg/a$b;-><init>(Lpg/a;I)V

    invoke-virtual {p0, p1}, Lpg/a;->x(Ljava/lang/Runnable;)V
...
.method public final p([BIII)I
    ...
    invoke-virtual {p0, p3, p4}, Lpg/a;->o(II)I
    ...
    iget-boolean v2, p0, Lpg/a;->k:Z

    if-eqz v2, :cond_1

    if-eqz p1, :cond_1

    iget v5, p0, Lpg/a;->q:I

    iget v8, p0, Lpg/a;->f:I

    add-int/lit8 v2, v8, 0x1

    iput v2, p0, Lpg/a;->f:I

    iget-object v9, p0, Lpg/a;->m:[I
    ...
    :cond_1
    iget-object v2, p0, Lpg/a;->h:Lcom/faceunity/wrapper/faceunity$AvatarInfo;

    const/4 v3, 0x1

    iget v6, p0, Lpg/a;->f:I

    add-int/lit8 p1, v6, 0x1

    iput p1, p0, Lpg/a;->f:I

    iget-object v7, p0, Lpg/a;->m:[I
    ...
    invoke-static {p2, p0}, Lug/c;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final r([BIII)I
    ...
    iget v4, p0, Lpg/a;->f:I

    add-int/lit8 p1, v4, 0x1

    iput p1, p0, Lpg/a;->f:I

    iget-object v5, p0, Lpg/a;->m:[I
...
.method public final w()V
    ...
    invoke-static {v1, v0}, Lug/c;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_0
    :try_start_0
    iget-object v1, p0, Lpg/a;->b:Ljava/util/LinkedList;
    ...
    invoke-virtual {p0}, Lpg/a;->d()Ljava/lang/Runnable;
    ...
    invoke-virtual {p0, v0}, Lpg/a;->y(Ljava/util/List;)V

    iget-object v0, p0, Lpg/a;->c:Ljava/util/LinkedList;

    if-eqz v0, :cond_3

    iget-object p0, p0, Lpg/a;->c:Ljava/util/LinkedList;
