...
.method public static synthetic a(Lmiuix/flexible/template/AbstractMarkTemplate;Lpr/d;Lpr/d;)I
    .locals 0

    invoke-direct {p0, p1, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->lambda$measureViewList$0(Lpr/d;Lpr/d;)I
...
.method private synthetic lambda$measureViewList$0(Lpr/d;Lpr/d;)I
    .locals 0

    invoke-virtual {p0, p1}, Lmiuix/flexible/template/AbstractMarkTemplate;->getViewNodePriority(Lpr/d;)I

    move-result p1

    invoke-virtual {p0, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->getViewNodePriority(Lpr/d;)I
...
.method private layoutViewList(Lpr/c;ZIII)V
    .locals 17
    ...
    iget v0, v9, Lpr/d;->c:I

    add-int v0, p4, v0

    iget v1, v9, Lpr/d;->d:I

    add-int v1, p5, v1

    new-instance v2, Ljava/util/ArrayList;

    iget-object v3, v9, Lpr/c;->g:Ljava/util/ArrayList;
    ...
    iget-object v7, v6, Lpr/d;->b:Landroid/view/View;
    ...
    check-cast v15, Lpr/c;

    iget-object v0, v15, Lpr/c;->g:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Lpr/d;->b:Landroid/view/View;
    ...
    iget v0, v9, Lpr/d;->d:I

    iget v1, v15, Lpr/d;->d:I

    const/4 v2, 0x2

    invoke-static {v0, v1, v2, v7}, La0/y;->a(IIII)I
    ...
    iget v1, v15, Lpr/d;->c:I

    const/4 v2, 0x2

    invoke-static {v0, v1, v2, v6}, La0/y;->a(IIII)I
    ...
    invoke-direct/range {v0 .. v5}, Lmiuix/flexible/template/AbstractMarkTemplate;->layoutViewList(Lpr/c;ZIII)V

    iget v0, v9, Lpr/c;->f:I

    if-ne v0, v14, :cond_7

    iget v0, v15, Lpr/d;->c:I
    ...
    :cond_8
    iget-object v1, v0, Lpr/d;->b:Landroid/view/View;
    ...
    iget v2, v9, Lpr/d;->d:I

    iget v0, v0, Lpr/d;->d:I

    const/4 v5, 0x2

    invoke-static {v2, v0, v5, v7}, La0/y;->a(IIII)I
    ...
    iget v2, v9, Lpr/d;->c:I

    iget v0, v0, Lpr/d;->c:I

    const/4 v4, 0x2

    invoke-static {v2, v0, v4, v6}, La0/y;->a(IIII)I
...
.method private measureChildView(Lpr/d;IIII)V
    .locals 7

    iget-object v0, p1, Lpr/d;->b:Landroid/view/View;
    ...
    iput p2, p1, Lpr/d;->c:I

    iput p3, p1, Lpr/d;->d:I

    :cond_8
    return-void
.end method

.method private measureViewList(Lpr/c;Lpr/c;IIII)V
    .locals 19
    ...
    iget-object v1, v9, Lpr/c;->g:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v0 .. v6}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureViewList(Lpr/c;Lpr/c;IIII)V

    iget v0, v9, Lpr/c;->f:I

    if-ne v0, v13, :cond_3

    iget v0, v12, Lpr/d;->c:I
    ...
    iget-object v0, v4, Lpr/d;->b:Landroid/view/View;
    ...
    invoke-direct/range {v0 .. v5}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureChildView(Lpr/d;IIII)V

    iget v0, v9, Lpr/c;->f:I

    if-ne v0, v13, :cond_5

    iget v0, v6, Lpr/d;->c:I
    ...
    :cond_b
    iget-object v0, v5, Lpr/d;->b:Landroid/view/View;
    ...
    :cond_14
    iput v15, v9, Lpr/d;->d:I

    iget-object v0, v9, Lpr/c;->g:Ljava/util/ArrayList;
    ...
    invoke-virtual {v7, v2, v10}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(Lpr/c;I)Z

    move-result v0

    if-eqz v0, :cond_16

    iget v3, v2, Lpr/d;->c:I

    iget v4, v9, Lpr/d;->d:I
    ...
    iget v0, v2, Lpr/d;->c:I

    iget v1, v9, Lpr/d;->c:I

    if-ge v0, v1, :cond_15

    invoke-virtual {v7, v2, v13}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(Lpr/c;I)Z

    move-result v0

    if-eqz v0, :cond_15

    iget v3, v9, Lpr/d;->c:I

    iget v4, v2, Lpr/d;->d:I
    ...
    iget-object v0, v1, Lpr/d;->b:Landroid/view/View;
    ...
    iget v2, v9, Lpr/c;->f:I

    if-ne v2, v13, :cond_19

    iget v2, v1, Lpr/d;->d:I

    iget v4, v9, Lpr/d;->d:I

    if-ge v2, v4, :cond_19

    iget v2, v1, Lpr/d;->c:I
    ...
    iget v0, v1, Lpr/d;->c:I

    iget v2, v9, Lpr/d;->c:I

    if-ge v0, v2, :cond_15

    iget v3, v1, Lpr/d;->d:I
...
.method public buildViewTree(Landroid/view/ViewGroup;)V
    ...
    invoke-direct {p1, p0}, Lpr/a;-><init>(Lpr/b$a;)V

    invoke-static {v1, p1}, Ljava/util/Arrays;->sort([Ljava/lang/Object;Ljava/util/Comparator;)V

    new-instance p1, Lpr/c;

    invoke-direct {p1}, Lpr/c;-><init>()V

    const/4 v0, 0x1

    iput v0, p1, Lpr/d;->a:I

    const/high16 v3, 0x3f800000    # 1.0f

    iput v3, p1, Lpr/d;->e:F

    iput v0, p1, Lpr/c;->f:I

    invoke-static {v1, v2, p1, p0}, Lpr/b;->a([Landroid/view/View;ILpr/c;Lpr/b$a;)I

    iput-object p1, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lpr/c;
...
.method public getViewNodePriority(Lpr/d;)I
    .locals 2
    ...
    iget-object p1, p1, Lpr/c;->g:Ljava/util/ArrayList;
...
.method public hasMatchParentChild(Lpr/c;I)Z
    .locals 4
    ...
    invoke-virtual {p0, v0, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(Lpr/c;I)Z
...
.method public init(Landroid/view/ViewGroup;Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p1, Lor/c;->HyperCellLayout:[I
    ...
    sget v2, Lor/c;->HyperCellLayout_android_gravity:I
    ...
    :cond_0
    sget v2, Lor/c;->HyperCellLayout_column_spacing:I
    ...
    :cond_1
    sget v2, Lor/c;->HyperCellLayout_row_spacing:I
...
.method public onLayout(Landroid/view/ViewGroup;ZIIII)V
    ...
    iget-object p2, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lpr/c;
    ...
    iget-object p5, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lpr/c;

    iget p5, p5, Lpr/d;->d:I

    const/4 v1, 0x2

    invoke-static {p6, p5, v1, p3}, La0/y;->a(IIII)I
    ...
    iget-object p3, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lpr/c;

    iget p3, p3, Lpr/d;->d:I
    ...
    iget-object p1, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lpr/c;

    iget p1, p1, Lpr/d;->c:I

    const/4 p4, 0x2

    invoke-static {p3, p1, p4, p2}, La0/y;->a(IIII)I
    ...
    :goto_2
    iget-object v2, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lpr/c;

    move-object v1, p0

    invoke-direct/range {v1 .. v6}, Lmiuix/flexible/template/AbstractMarkTemplate;->layoutViewList(Lpr/c;ZIII)V
...
.method public onMeasure(Landroid/view/ViewGroup;II)[I
    ...
    iget-object v4, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lpr/c;
    ...
    invoke-direct/range {v2 .. v8}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureViewList(Lpr/c;Lpr/c;IIII)V
    ...
    :cond_1
    iget-object p0, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lpr/c;

    iget p0, p0, Lpr/d;->d:I
