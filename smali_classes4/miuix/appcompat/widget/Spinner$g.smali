...
.method public constructor <init>(Lmiuix/appcompat/widget/Spinner;Landroid/content/Context;)V
    ...
    invoke-direct {p0, p2, p1}, Lus/f;-><init>(Landroid/content/Context;Landroid/view/View;)V
    ...
    iget-object p2, p0, Lus/f;->d:Lrs/a;

    sget v0, Lqq/a$f;->miuix_appcompat_drop_down_menu_padding_single_item:I
    ...
    sget v1, Lqq/a$f;->miuix_appcompat_drop_down_item_min_height:I
    ...
    iput p1, p2, Lrs/a;->d:I

    const p1, 0x800053

    invoke-super {p0, p1}, Lus/f;->c(I)V
...
.method public final i(Landroid/widget/ListAdapter;Landroid/content/Context;)[[I
    ...
    iget-object p0, p0, Lus/f;->f:Landroid/widget/ListView;
    ...
    iget-object p2, p0, Lus/f;->b:Landroid/view/View;
    ...
    iget-object p0, p0, Lus/f;->b:Landroid/view/View;
...
.method public final j(Landroid/view/View;)Z
    ...
    invoke-super {p0, p1}, Lus/f;->j(Landroid/view/View;)Z
...
.method public final setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-super {p0, p1}, Lus/f;->setAdapter(Landroid/widget/ListAdapter;)V
...
.method public final show(II)V
    ...
    invoke-interface {v1}, Lmiuix/appcompat/app/r;->R4()Z
    ...
    sget v5, Lqq/a$h;->action_bar_overlay_layout:I
    ...
    invoke-virtual {p0, v1}, Lus/f;->n(Landroid/view/View;)V
    ...
    invoke-virtual {v1}, Lrs/a;->toString()Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Lus/f;->l(Landroid/view/View;)V

    :cond_4
    iget-object v5, v1, Lrs/a;->q:Landroid/graphics/Rect;

    invoke-virtual {v5}, Landroid/graphics/Rect;->centerX()I

    move-result v5

    iget-object v6, v1, Lrs/a;->p:Landroid/graphics/Rect;
    ...
    invoke-super {p0, v5}, Lus/f;->c(I)V
    ...
    :goto_3
    iget-object v5, p0, Lus/f;->e:Lbk/h;

    invoke-virtual {v5, v1}, Lbk/h;->e(Lrs/a;)I

    move-result v6

    invoke-virtual {v5, v1}, Lbk/h;->f(Lrs/a;)I

    move-result v5

    iget v7, v1, Lrs/a;->g:I

    invoke-virtual {p0, v7}, Landroid/widget/PopupWindow;->setWidth(I)V

    iget v1, v1, Lrs/a;->h:I
    ...
    invoke-virtual {p0, v4, v3, v6, v5}, Lus/f;->showAtLocation(Landroid/view/View;III)V
    ...
    :goto_4
    iget-object v1, p0, Lus/f;->f:Landroid/widget/ListView;
