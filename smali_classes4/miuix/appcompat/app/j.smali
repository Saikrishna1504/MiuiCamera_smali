...
.method public constructor <init>(Lmiuix/appcompat/app/AppCompatActivity;Lmiuix/appcompat/app/AppCompatActivity$a;Lmiuix/appcompat/app/AppCompatActivity$b;)V
    ...
    iput-object p3, p0, Lmiuix/appcompat/app/j;->b0:Lsq/g;
...
# virtual methods
.method public final Ba()Lmiuix/appcompat/internal/app/widget/ActionBarImpl;
    .locals 2
...
.method public final m(Landroid/graphics/Rect;)V
    ...
    invoke-interface {v2}, Lmiuix/appcompat/app/t;->g9()Z
...
.method public final o()V
    ...
    invoke-direct {v4, p0, p0}, Lmiuix/appcompat/app/j$a;-><init>(Lmiuix/appcompat/app/j;Ldt/a;)V

    iput-object v4, p0, Lmiuix/appcompat/app/j;->l0:Lmiuix/appcompat/app/j$a;

    :cond_5
    sget v4, Lqq/a$m;->Window_windowLayoutMode:I
    ...
    :cond_6
    sget v4, Lqq/a$m;->Window_windowActionBar:I
    ...
    :cond_7
    sget v4, Lqq/a$m;->Window_windowActionBarOverlay:I
    ...
    :cond_8
    sget v4, Lqq/a$m;->Window_isMiuixFloatingTheme:I
    ...
    sget v4, Lqq/a$m;->Window_windowFloating:I
    ...
    sget v4, Lqq/a$m;->Window_windowTranslucentStatus:I
    ...
    invoke-static {v1}, Ltq/b;->a(Lmiuix/appcompat/app/AppCompatActivity;)I
    ...
    new-instance v4, Ltq/e;

    invoke-direct {v4, v1}, Ltq/e;-><init>(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    invoke-direct {v4, v1}, Ltq/c;-><init>(Lmiuix/appcompat/app/AppCompatActivity;)V

    goto :goto_2

    :cond_a
    new-instance v4, Ltq/d;

    invoke-direct {v4, v1}, Ltq/d;-><init>(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    :goto_2
    iput-object v4, p0, Lmiuix/appcompat/app/j;->g0:Ltq/a;
    ...
    sget v7, Lqq/a$c;->windowActionBar:I

    invoke-static {v4, v7, v5}, Las/d;->c(Landroid/content/Context;IZ)Z

    move-result v8

    if-eqz v8, :cond_d

    sget v8, Lqq/a$c;->windowActionBarMovable:I

    invoke-static {v4, v8, v5}, Las/d;->c(Landroid/content/Context;IZ)Z

    move-result v8

    if-eqz v8, :cond_c

    sget v8, Lqq/a$j;->miuix_appcompat_screen_action_bar_movable:I

    goto :goto_3

    :cond_c
    sget v8, Lqq/a$j;->miuix_appcompat_screen_action_bar:I

    goto :goto_3

    :cond_d
    sget v8, Lqq/a$j;->miuix_appcompat_screen_simple:I

    :goto_3
    sget v9, Lqq/a$c;->startingWindowOverlay:I

    invoke-static {v9, v4}, Las/d;->b(ILandroid/content/Context;)I
    ...
    invoke-static {v4, v7, v0}, Las/d;->c(Landroid/content/Context;IZ)Z
    ...
    sget v7, Lqq/a$c;->windowTranslucentStatus:I

    invoke-static {v7, v4, v5}, Las/d;->h(ILandroid/content/Context;I)I

    move-result v4

    invoke-static {v2, v4}, Llr/a;->a(Landroid/view/Window;I)Z
    ...
    iget-object v7, p0, Lmiuix/appcompat/app/j;->g0:Ltq/a;
    ...
    iget-object v8, p0, Lmiuix/appcompat/app/j;->g0:Ltq/a;

    invoke-virtual {v8, v7}, Ltq/a;->l(Z)V

    iget-object v7, p0, Lmiuix/appcompat/app/j;->g0:Ltq/a;

    iget-boolean v8, p0, Lmiuix/appcompat/app/j;->e0:Z

    invoke-virtual {v7, v4, v8}, Ltq/a;->j(Landroid/view/View;Z)Landroid/view/ViewGroup;
    ...
    sget v7, Lqq/a$h;->action_bar_overlay_layout:I
    ...
    iput-object v7, p0, Lmiuix/appcompat/app/j;->V:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;
    ...
    iget-object v7, p0, Lmiuix/appcompat/app/j;->V:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;
    ...
    iget-object v8, p0, Lmiuix/appcompat/app/c;->u:Lir/b;

    invoke-virtual {v7, v8}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingPolicy(Lir/b;)V
    ...
    iget-object v2, p0, Lmiuix/appcompat/app/j;->V:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;
    ...
    :cond_13
    iget-object v2, p0, Lmiuix/appcompat/app/j;->g0:Ltq/a;
    ...
    invoke-virtual {v2, v4, v6}, Ltq/a;->f(Landroid/view/ViewGroup;Z)V
    ...
    invoke-virtual {v2, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->a(Lir/a;)V
    ...
    sget v4, Lqq/a$h;->action_bar_container:I
    ...
    sget v6, Lqq/a$d;->abc_split_action_bar_is_narrow:I
    ...
    :cond_19
    sget v4, Lqq/a$m;->Window_windowSplitActionBar:I
    ...
    iget-object v4, p0, Lmiuix/appcompat/app/j;->V:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;

    invoke-virtual {p0, v0, v2, v4}, Lmiuix/appcompat/app/c;->c(ZZLmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;)V

    :cond_1a
    sget v0, Lqq/a$m;->Window_endActionMenuEnabled:I
    ...
    sget v0, Lqq/a$m;->Window_hyperActionMenuEnabled:I
...
.method public final p(Landroid/content/res/Configuration;)V
    ...
    iget-object v1, v0, Lmiuix/appcompat/app/AppCompatActivity;->a:Lkr/h;

    const/4 v2, 0x0

    invoke-static {v0, v1, p1, v2}, Lkr/a;->k(Landroid/content/Context;Lkr/h;Landroid/content/res/Configuration;Z)V
    ...
    iget-object v1, p0, Lmiuix/appcompat/app/c;->u:Lir/b;

    invoke-virtual {v0, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingPolicy(Lir/b;)V
    ...
    invoke-static {p0, p1}, Lmiuix/appcompat/app/AppCompatActivity;->gi(Lmiuix/appcompat/app/AppCompatActivity;Landroid/content/res/Configuration;)V
...
.method public final q(ILandroid/view/MenuItem;)Z
    ...
    invoke-static {v0, p1, p2}, Lmiuix/appcompat/app/AppCompatActivity;->mi(Lmiuix/appcompat/app/AppCompatActivity;ILandroid/view/MenuItem;)Z
...
.method public final r()V
    ...
    invoke-static {v0}, Lmiuix/appcompat/app/AppCompatActivity;->ki(Lmiuix/appcompat/app/AppCompatActivity;)V
...
.method public final s()V
    ...
    invoke-static {v0}, Lmiuix/appcompat/app/AppCompatActivity;->li(Lmiuix/appcompat/app/AppCompatActivity;)V
...
.method public final u(Z)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/app/c;->u:Lir/b;
...
.method public final w(Z)V
    ...
    invoke-static {v0}, La0/z6;->h(Landroid/view/Window;)V

    goto :goto_4

    :cond_5
    invoke-static {v0}, Landroidx/core/location/d;->d(Landroid/view/Window;)V
...
.method public final wd(Landroid/view/Menu;Landroid/view/Menu;)V
    .locals 0
