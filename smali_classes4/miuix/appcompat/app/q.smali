...
.method public constructor <init>(Landroidx/fragment/app/Fragment;)V
    ...
    iput-boolean v0, p0, Lmiuix/appcompat/app/q;->V:Z
...
.method public final Id()Landroid/graphics/Rect;
    ...
    invoke-interface {v0}, Lmiuix/appcompat/app/s;->Id()Landroid/graphics/Rect;
...
.method public final N5(Landroid/content/res/Configuration;Let/d;Z)V
    ...
    instance-of v0, p0, Ldt/a;

    if-eqz v0, :cond_0

    check-cast p0, Ldt/a;

    invoke-interface {p0, p1, p2, p3}, Ldt/a;->N5(Landroid/content/res/Configuration;Let/d;Z)V
...
.method public final R5(I)V
    ...
    invoke-interface {v2}, Lmiuix/appcompat/app/t;->D8()Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-interface {v2}, Lir/c;->se()Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-interface {v2, p1}, Lir/a;->R5(I)V
...
.method public final R7()Landroid/content/Context;
    .locals 1
...
.method public final X5(Landroid/content/res/Configuration;Let/d;Z)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lmiuix/appcompat/app/q;->N5(Landroid/content/res/Configuration;Let/d;Z)V
...
.method public final o(Landroid/content/res/Configuration;)V
    ...
    iget-object v2, p0, Lmiuix/appcompat/app/c;->u:Lir/b;

    invoke-virtual {v0, v2}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingPolicy(Lir/b;)V
...
.method public final p(IZI)Landroid/animation/Animator;
    ...
    sget p1, Lqq/a$a;->miuix_appcompat_fragment_transition_activity_open_enter:I
    ...
    invoke-direct {p1, p0, p2, p2}, Lxq/a;-><init>(Landroidx/fragment/app/Fragment;ZZ)V

    goto :goto_0

    :cond_0
    sget p1, Lqq/a$a;->miuix_appcompat_fragment_transition_activity_open_exit:I
    ...
    invoke-direct {p1, p0, p2, v0}, Lxq/a;-><init>(Landroidx/fragment/app/Fragment;ZZ)V

    goto :goto_0

    :cond_1
    sget p1, Lqq/a$a;->miuix_appcompat_fragment_transition_activity_close_enter:I

    if-ne p3, p1, :cond_2

    new-instance p1, Lxq/a;

    invoke-direct {p1, p0, v0, p2}, Lxq/a;-><init>(Landroidx/fragment/app/Fragment;ZZ)V

    goto :goto_0

    :cond_2
    sget p1, Lqq/a$a;->miuix_appcompat_fragment_transition_activity_close_exit:I

    if-ne p3, p1, :cond_3

    new-instance p1, Lxq/a;

    invoke-direct {p1, p0, v0, v0}, Lxq/a;-><init>(Landroidx/fragment/app/Fragment;ZZ)V
...
.method public final q(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-virtual {p0}, Lmiuix/appcompat/app/q;->R7()Landroid/content/Context;
    ...
    sget v2, Lqq/a$m;->Window_responsiveEnabled:I

    iget-boolean v3, p0, Lmiuix/appcompat/app/q;->V:Z
    ...
    :cond_0
    sget v2, Lqq/a$m;->Window_windowActionBar:I
    ...
    :cond_1
    sget v2, Lqq/a$m;->Window_windowActionBarOverlay:I
    ...
    :cond_2
    sget v2, Lqq/a$m;->Window_windowExtraPaddingHorizontalEnable:I
    ...
    iget-object v4, p0, Lmiuix/appcompat/app/c;->u:Lir/b;

    if-eqz v4, :cond_4

    iput-boolean v2, v4, Lir/b;->a:Z
    ...
    :cond_5
    sget v2, Lqq/a$m;->Window_windowExtraPaddingHorizontalInitEnable:I
    ...
    :cond_7
    sget v2, Lqq/a$m;->Window_windowExtraPaddingApplyToContentEnable:I
    ...
    :cond_9
    sget v2, Lqq/a$m;->Window_windowTranslucentStatus:I
    ...
    iget-object v8, v8, Lmiuix/appcompat/app/j;->V:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;
    ...
    invoke-virtual {p2, v9}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->a(Lir/a;)V
    ...
    sget v2, Lqq/a$d;->abc_split_action_bar_is_narrow:I
    ...
    sget v2, Lqq/a$m;->Window_windowSplitActionBar:I
    ...
    invoke-virtual {p2, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingPolicy(Lir/b;)V
    ...
    invoke-interface {v4, p1, p2, p3}, Lmiuix/appcompat/app/t;->Nd(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    :cond_15
    sget p1, Lqq/a$m;->Window_endActionMenuEnabled:I
    ...
    sget p1, Lqq/a$m;->Window_hyperActionMenuEnabled:I
    ...
    invoke-interface {v1, p1, p2, p3}, Lmiuix/appcompat/app/t;->Nd(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-interface {v1}, Lmiuix/appcompat/app/t;->D8()Z
    ...
    iget-object p2, p0, Lmiuix/appcompat/app/c;->u:Lir/b;
    ...
    invoke-virtual {p0, p1, p2, p3, p3}, Lmiuix/appcompat/app/q;->s(Landroid/content/Context;Lir/b;II)Z
...
.method public final s(Landroid/content/Context;Lir/b;II)Z
    .locals 11
    ...
    iget-object p1, v2, Lkr/h;->c:Landroid/graphics/Point;
    ...
    :cond_2
    invoke-virtual {p0, v3}, Lmiuix/appcompat/app/c;->D1(I)Z
...
.method public final wd(Landroid/view/Menu;Landroid/view/Menu;)V
    ...
    invoke-interface {p0}, Lmiuix/appcompat/app/t;->zb()V
