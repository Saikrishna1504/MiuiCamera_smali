...
.method private createListView(Lmiuix/appcompat/app/AlertController;)V
    ...
    iget v1, p1, Lmiuix/appcompat/app/AlertController;->Y:I
    ...
    iget v3, p1, Lmiuix/appcompat/app/AlertController;->Z:I
    ...
    iget v0, p1, Lmiuix/appcompat/app/AlertController;->a0:I

    goto :goto_0

    :cond_2
    iget v0, p1, Lmiuix/appcompat/app/AlertController;->b0:I
    ...
    :cond_5
    iput-object v9, p1, Lmiuix/appcompat/app/AlertController;->V:Landroid/widget/ListAdapter;
...
.method public apply(Lmiuix/appcompat/app/AlertController;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->m1(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->e1(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->d1(I)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->d0(I)I
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->n1(Z)V
    ...
    invoke-virtual {p1, v0, v1}, Lmiuix/appcompat/app/AlertController;->f1(II)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->h1(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->Z0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v2, v0, v3, v1}, Lmiuix/appcompat/app/AlertController;->V0(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;Landroid/os/Message;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->p1(Landroid/view/View;)V
    ...
    invoke-virtual {p1, v2, v0}, Lmiuix/appcompat/app/AlertController;->Y0(ZLjava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->c1(Z)V

    iget v0, p0, Lmiuix/appcompat/app/AlertController$AlertParams;->mNonImmersiveDialogHeight:I

    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->i1(I)V

    iget v0, p0, Lmiuix/appcompat/app/AlertController$AlertParams;->mLiteVersion:I

    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->g1(I)V
    ...
    invoke-virtual {p1, v1}, Lmiuix/appcompat/app/AlertController;->j1(Lmiuix/appcompat/app/AlertDialog$d;)V

    iget-boolean p0, p0, Lmiuix/appcompat/app/AlertController$AlertParams;->mEnableEnterAnim:Z

    invoke-virtual {p1, p0}, Lmiuix/appcompat/app/AlertController;->b1(Z)V
