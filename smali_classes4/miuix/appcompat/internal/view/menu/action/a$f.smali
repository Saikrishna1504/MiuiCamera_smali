...
# direct methods
.method public constructor <init>(Lmiuix/appcompat/internal/view/menu/action/a;Landroid/content/Context;Lmiuix/appcompat/internal/view/menu/c;Landroid/view/View;Landroid/view/View;Z)V
    .locals 6
    ...
    sget p3, Lgl/a$c;->overflowMenuMaxHeight:I

    invoke-static {p2, p3}, Lpm/d;->k(Landroid/content/Context;I)Landroid/util/TypedValue;
    ...
    invoke-virtual {p0, p2}, Lmiuix/appcompat/internal/view/menu/f;->q(I)V

    :cond_2
    iget-object p2, p1, Lmiuix/appcompat/internal/view/menu/action/a;->g0:Lmiuix/appcompat/internal/view/menu/action/a$g;

    invoke-virtual {p0, p2}, Lmiuix/appcompat/internal/view/menu/f;->n(Lmiuix/appcompat/internal/view/menu/g$a;)V

    sget p2, Lgl/a$j;->miuix_appcompat_overflow_popup_menu_item_layout:I

    invoke-virtual {p0, p2}, Lmiuix/appcompat/internal/view/menu/f;->p(I)V

    invoke-virtual {p1, p4}, Lmiuix/appcompat/internal/view/menu/action/a;->P(Landroid/view/View;)I
    ...
    invoke-virtual {p0, p1}, Lmiuix/appcompat/internal/view/menu/f;->m(I)V
...
.method public onDismiss()V
    ...
    invoke-static {v0}, Lmiuix/appcompat/internal/view/menu/action/a;->w(Lmiuix/appcompat/internal/view/menu/action/a;)Lmiuix/appcompat/internal/view/menu/c;
    ...
    invoke-static {p0, v0}, Lmiuix/appcompat/internal/view/menu/action/a;->x(Lmiuix/appcompat/internal/view/menu/action/a;Lmiuix/appcompat/internal/view/menu/action/a$e;)Lmiuix/appcompat/internal/view/menu/action/a$e;
