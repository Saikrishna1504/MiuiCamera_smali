...
.field public final c0:Lmiuix/view/j;

.field public d0:Lql/e;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->d0:Lql/e;

    iput-object v1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->e0:Landroid/view/View$OnLayoutChangeListener;

    iput v0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->i0:I

    iput-boolean v0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->k0:Z

    iput-boolean v0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->m0:Z
    ...
    iput-object v1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->o0:Landroid/view/ViewOutlineProvider;
    ...
    iput-object v1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->p0:Lmiuix/animation/base/AnimConfig;

    const/high16 v1, 0x41300000    # 11.0f

    invoke-static {p1, v1}, Lam/g;->d(Landroid/content/Context;F)I
    ...
    sget v3, Lgl/a$f;->miuix_appcompat_suspend_menu_bg_radius:I
    ...
    sget v3, Lgl/a$e;->miuix_appcompat_suspend_menu_mi_shadow:I
    ...
    sget v3, Lgl/a$f;->miuix_appcompat_suspend_menu_mi_shadow_radius:I
    ...
    sget v3, Lgl/a$f;->miuix_appcompat_suspend_menu_mi_shadow_radius_offset_x:I
    ...
    sget v3, Lgl/a$f;->miuix_appcompat_suspend_menu_mi_shadow_radius_offset_y:I
    ...
    iput v1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->f0:I

    iput-object p1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->f:Landroid/content/Context;

    iput-object p2, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->g0:Landroid/util/AttributeSet;
    ...
    iput-object p2, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->c0:Lmiuix/view/j;
...
.method private synthetic C(Landroid/view/View;IIIIIIII)V
    ...
    iget-object p1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->d0:Lql/e;
...
.method private getActionMenuItemCount()I
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->h0:Landroid/view/View;
...
.method private getCustomViewClipBounds()Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->j0:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->j0:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->h0:Landroid/view/View;

    invoke-virtual {v2}, Landroid/view/View;->getMeasuredHeight()I

    move-result v2

    iget v3, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->i0:I
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->j0:Landroid/graphics/Rect;
...
.method public static synthetic q(Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;I)I
    ...
    iput p1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->i0:I
...
.method public static synthetic s(Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->b0:Landroid/graphics/drawable/Drawable;
...
.method public static synthetic t(Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->y:Landroid/graphics/drawable/Drawable;
...
.method public static synthetic u(Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;Z)Z
    ...
    iput-boolean p1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->n0:Z
...
.method public final B()V
    ...
    invoke-static {p0}, Lpm/i;->b(Landroid/view/View;)I
...
.method public final D(IIZ)V
    ...
    :cond_2
    invoke-static {p0}, Lam/g;->o(Landroid/view/View;)Z
    ...
    invoke-static {v4}, Lam/g;->m(Landroid/content/Context;)Z
    ...
    invoke-static {v4}, Lam/g;->p(Landroid/content/Context;)Z
...
.method public final E(Landroid/util/AttributeSet;)V
    ...
    :try_start_0
    sget-object v2, Lgl/a$m;->ResponsiveActionMenuView:[I

    sget v3, Lgl/a$c;->responsiveActionMenuViewStyle:I
    ...
    sget p1, Lgl/a$m;->ResponsiveActionMenuView_bottomMenuBackground:I
    ...
    sget p1, Lgl/a$m;->ResponsiveActionMenuView_suspendMenuBackground:I
...
.method public final G(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->l0:[Z
    ...
    iget-object v3, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->l0:[Z
    ...
    iput-object p1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->l0:[Z
...
.method public final H()V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->o0:Landroid/view/ViewOutlineProvider;

    invoke-virtual {p0, v0}, Landroid/view/View;->setOutlineProvider(Landroid/view/ViewOutlineProvider;)V

    iget-boolean v0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->n0:Z
...
.method public c(Z)V
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->c0:Lmiuix/view/j;

    invoke-virtual {p0, p1}, Lmiuix/view/j;->c(Z)V
...
.method public getBottomMenuCustomViewOffset()I
    ...
    iget p0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->i0:I
...
.method public l()V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->d0:Lql/e;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lql/e;->b()V
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->d0:Lql/e;

    invoke-virtual {v0, v1}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    iget-object v1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->e0:Landroid/view/View$OnLayoutChangeListener;

    invoke-virtual {v0, v1}, Landroid/view/View;->removeOnLayoutChangeListener(Landroid/view/View$OnLayoutChangeListener;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->d0:Lql/e;
...
.method public onAttachedToWindow()V
    ...
    iget v2, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->q:F

    iget v3, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->m:I

    int-to-float v3, v3

    invoke-static {p0, v0, v1, v2, v3}, Lam/e;->b(Landroid/view/View;IFFF)V
    ...
    invoke-static {p0}, Lam/e;->a(Landroid/view/View;)V
    ...
    invoke-direct {v1, v2}, Lql/e;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->d0:Lql/e;

    iget v2, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->m:I

    invoke-virtual {v1, v2}, Lql/e;->setShadowHostViewRadius(I)V
    ...
    iget-object v2, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->d0:Lql/e;

    invoke-virtual {v1, v2, v0}, Landroid/view/ViewGroup;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    new-instance v0, Lsl/e;

    invoke-direct {v0, p0}, Lsl/e;-><init>(Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;)V

    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->e0:Landroid/view/View$OnLayoutChangeListener;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->c0:Lmiuix/view/j;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lmiuix/view/j;->h()V

    :cond_0
    iget p1, p1, Landroid/content/res/Configuration;->densityDpi:I

    iget v0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->f0:I
    ...
    sget v1, Lgl/a$f;->miuix_appcompat_suspend_menu_bg_radius:I
    ...
    sget v1, Lgl/a$f;->miuix_appcompat_suspend_menu_mi_shadow_radius:I
    ...
    sget v1, Lgl/a$f;->miuix_appcompat_suspend_menu_mi_shadow_radius_offset_x:I
    ...
    sget v0, Lgl/a$f;->miuix_appcompat_suspend_menu_mi_shadow_radius_offset_y:I
    ...
    iget p1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->n:I
    ...
    invoke-static {p0, p1, v0, v1, v2}, Lam/e;->b(Landroid/view/View;IFFF)V
    ...
    :cond_2
    :goto_0
    iget-object p1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->g0:Landroid/util/AttributeSet;
    ...
    invoke-virtual {p1, p0}, Lql/e;->setShadowHostViewRadius(I)V
...
.method public onLayout(ZIIII)V
    ...
    iget-object p1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->h0:Landroid/view/View;
    ...
    :cond_1
    iget-object p3, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->h0:Landroid/view/View;
    ...
    iget p4, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->i0:I
...
.method public onMeasure(II)V
    ...
    invoke-static {v6, v12}, Lam/g;->d(Landroid/content/Context;F)I

    move-result v6

    iput v6, v0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->r:I
    ...
    iget v9, v0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->x:I
    ...
    iget v6, v0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->r:I
    ...
    iput v5, v0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->r:I
    ...
    invoke-static {v5, v6}, Lam/g;->d(Landroid/content/Context;F)I
    ...
    invoke-virtual {v0, v6, v7, v9}, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->D(IIZ)V

    iput v5, v0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->t:I

    :goto_0
    iget v5, v0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->t:I
    ...
    :cond_3
    iget-object v3, v0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->h0:Landroid/view/View;
    ...
    iget-object v5, v0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->h0:Landroid/view/View;
    ...
    iget-object v1, v0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->h0:Landroid/view/View;
    ...
    iget v1, v0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->i0:I
    ...
    :cond_5
    :goto_1
    iput v2, v0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->t:I
    ...
    iget v4, v0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->i0:I
...
.method public setBottomMenuCustomViewTranslationYWithPx(I)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->h0:Landroid/view/View;
...
.method public setEnableBlur(Z)V
    ...
    invoke-virtual {v0, p1}, Lmiuix/view/j;->l(Z)V
...
.method public setSupportBlur(Z)V
    ...
    invoke-virtual {p0, p1}, Lmiuix/view/j;->n(Z)V
...
.method public setSuspendEnabled(Z)V
    ...
    iget-object p1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->c0:Lmiuix/view/j;

    invoke-virtual {p1}, Lmiuix/view/j;->j()V

    iget-object p1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->c0:Lmiuix/view/j;

    invoke-virtual {p1}, Lmiuix/view/j;->i()V
...
.method public setTranslationY(F)V
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->d0:Lql/e;
...
.method public w(Landroid/view/View;)V
    ...
    :cond_0
    iput-object p1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->h0:Landroid/view/View;
...
.method public x(Landroid/view/View;)V
    ...
    iput-object v1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->l0:[Z
    ...
    iget-object v4, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->l0:[Z
...
.method public final z(Landroid/view/View;)Z
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->h0:Landroid/view/View;
