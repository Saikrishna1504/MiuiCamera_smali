...
.method public constructor <init>(Lmiuix/appcompat/internal/view/menu/action/d;Landroid/content/Context;Lmiuix/appcompat/internal/view/menu/d;Landroid/view/View;Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;)V
    ...
    sget p3, Lqq/a$c;->overflowMenuMaxHeight:I

    invoke-static {p3, p2}, Las/d;->i(ILandroid/content/Context;)Landroid/util/TypedValue;
    ...
    :cond_2
    iget-object p1, p1, Lmiuix/appcompat/internal/view/menu/action/a;->y:Lmiuix/appcompat/internal/view/menu/action/a$f;
...
.method public final e(Z)V
    ...
    iget-object p1, p0, Lmiuix/appcompat/internal/view/menu/b;->b:Lfr/g;

    new-instance v0, Lbr/b;

    invoke-direct {v0, p0}, Lbr/b;-><init>(Lmiuix/appcompat/internal/view/menu/b;)V

    iput-object v0, p1, Lus/f;->w:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {p1}, Lus/f;->dismiss()V
