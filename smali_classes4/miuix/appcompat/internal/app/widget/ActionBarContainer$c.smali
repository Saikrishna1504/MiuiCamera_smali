...
.method public a(Lmiuix/view/j;)V
    ...
    sget-object v1, Lwn/b;->b:[I

    goto :goto_0

    :cond_0
    sget-object v1, Lwn/a;->b:[I
    ...
    invoke-static {v2, p0, v1}, Lmiuix/view/j;->d(Landroid/content/Context;Landroid/graphics/drawable/Drawable;[I)[I

    move-result-object p0

    if-eqz v0, :cond_1

    sget-object v0, Lwn/d;->a:[I

    goto :goto_1

    :cond_1
    sget-object v0, Lwn/c;->a:[I

    :goto_1
    const/16 v1, 0x42

    invoke-virtual {p1, p0, v0, v1}, Lmiuix/view/j;->k([I[II)V
