...
.field public final q1:Lcr/a;

.field public r0:Landroid/view/View;

.field public final r1:Lcr/a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v11, Lqq/a$f;->miuix_appcompat_action_bar_title_horizontal_padding:I
    ...
    sget v11, Lqq/a$f;->miuix_appcompat_action_bar_title_tab_horizontal_padding:I
    ...
    sget v11, Lqq/a$f;->miuix_appcompat_action_bar_title_top_padding:I
    ...
    sget v11, Lqq/a$f;->miuix_appcompat_action_bar_title_bottom_padding:I
    ...
    sget v11, Lqq/a$f;->miuix_appcompat_action_bar_subtitle_bottom_padding:I
    ...
    sget v11, Lqq/a$f;->miuix_appcompat_action_bar_secondary_tab_vertical_padding:I
    ...
    sget v11, Lqq/a$f;->miuix_appcompat_action_bar_up_view_margin_start:I
    ...
    sget v5, Lqq/a$h;->action_bar_collapse_container:I
    ...
    sget v7, Lqq/a$h;->action_bar_movable_container:I
    ...
    sget-object v1, Lqq/a$m;->ActionBar:[I
    ...
    sget v1, Lqq/a$m;->ActionBar_android_navigationMode:I
    ...
    sget v1, Lqq/a$m;->ActionBar_android_title:I
    ...
    sget v1, Lqq/a$m;->ActionBar_android_subtitle:I
    ...
    sget v1, Lqq/a$m;->ActionBar_titleCenter:I
    ...
    sget v1, Lqq/a$m;->ActionBar_android_logo:I
    ...
    sget v1, Lqq/a$m;->ActionBar_android_icon:I
    ...
    sget v4, Lqq/a$m;->ActionBar_navigatorSwitchLayout:I

    sget v5, Lqq/a$j;->miuix_appcompat_action_bar_navigator_switch:I
    ...
    sget v4, Lqq/a$m;->ActionBar_android_homeLayout:I

    sget v5, Lqq/a$j;->miuix_appcompat_action_bar_home:I
    ...
    sget v4, Lqq/a$m;->ActionBar_android_titleTextStyle:I

    invoke-virtual {p2, v4, v2}, Landroid/content/res/TypedArray;->getResourceId(II)I

    sget v4, Lqq/a$m;->ActionBar_android_subtitleTextStyle:I

    invoke-virtual {p2, v4, v2}, Landroid/content/res/TypedArray;->getResourceId(II)I

    sget v4, Lqq/a$m;->ActionBar_android_progressBarPadding:I
    ...
    sget v4, Lqq/a$m;->ActionBar_android_itemPadding:I

    invoke-virtual {p2, v4, v2}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    sget v4, Lqq/a$m;->ActionBar_android_displayOptions:I
    ...
    sget v4, Lqq/a$m;->ActionBar_android_customNavigationLayout:I
    ...
    :cond_2
    sget v0, Lqq/a$m;->ActionBar_android_minHeight:I
    ...
    sget v0, Lqq/a$m;->ActionBar_android_maxHeight:I
    ...
    sget v1, Lqq/a$f;->miuix_appcompat_action_bar_large_font_max_height:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    sget v1, Lqq/a$c;->actionBarTitleAdaptLargeFont:I

    invoke-static {p1, v1, v3}, Las/d;->c(Landroid/content/Context;IZ)Z

    move-result v1

    invoke-static {p1}, Lkr/e;->c(Landroid/content/Context;)I
    ...
    sget v0, Lqq/a$m;->ActionBar_showOptionIcons:I
    ...
    invoke-direct {p2, p1, v1, v0}, Lcr/a;-><init>(Landroid/content/Context;ILjava/lang/CharSequence;)V

    iput-object p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->q1:Lcr/a;
    ...
    iput-object p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->r1:Lcr/a;
...
.method private setTitleImpl(Ljava/lang/CharSequence;)V
    ...
    iget-object v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->q1:Lcr/a;

    if-eqz v4, :cond_3

    iput-object p1, v4, Lcr/a;->b:Ljava/lang/CharSequence;

    :cond_3
    iget-object v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->r1:Lcr/a;
    ...
    :cond_9
    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Lyq/a;

    if-eqz p1, :cond_a

    iget-object p1, p1, Lyq/a;->b:Landroid/widget/LinearLayout;
    ...
    :cond_a
    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Lyq/b;

    if-eqz p1, :cond_b

    if-nez v3, :cond_b

    iget-object p1, p1, Lyq/b;->b:Landroid/widget/LinearLayout;
...
.method private setTitleVisibility(Z)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Lyq/a;
    ...
    :goto_0
    iget-boolean v5, v0, Lyq/a;->e:Z

    if-nez v5, :cond_1

    if-nez v4, :cond_1

    iget-object v0, v0, Lyq/a;->b:Landroid/widget/LinearLayout;
    ...
    :cond_2
    :goto_1
    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Lyq/b;
    ...
    :goto_2
    invoke-virtual {v0, p1}, Lyq/b;->c(I)V
...
.method public final A(Z)V
    ...
    invoke-direct {v1, v0}, Lyq/b;-><init>(Landroid/content/Context;)V

    new-instance v2, Landroid/widget/LinearLayout;

    invoke-direct {v2, v0}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;)V

    iput-object v2, v1, Lyq/b;->b:Landroid/widget/LinearLayout;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, Landroid/view/View;->setImportantForAccessibility(I)V

    iget-object v2, v1, Lyq/b;->b:Landroid/widget/LinearLayout;
    ...
    new-instance v5, Lcom/xiaomi/microfilm/dualcam/mode/m;

    const/16 v6, 0x9

    invoke-direct {v5, v1, v6}, Lcom/xiaomi/microfilm/dualcam/mode/m;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v2, v5}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    new-instance v2, Lar/c;

    sget v5, Lqq/a$c;->expandTitleTheme:I

    invoke-direct {v2, v0, v5}, Lar/c;-><init>(Landroid/content/Context;I)V

    iput-object v2, v1, Lyq/b;->c:Lar/c;

    sget v5, Lqq/a$h;->action_bar_title_expand:I

    invoke-virtual {v2, v5}, Landroid/view/View;->setId(I)V

    iget-object v2, v1, Lyq/b;->c:Lar/c;
    ...
    invoke-static {v2}, Lck/g;->b(Landroid/widget/TextView;)V

    :cond_0
    iget-object v2, v1, Lyq/b;->b:Landroid/widget/LinearLayout;

    iget-object v6, v1, Lyq/b;->c:Lar/c;
    ...
    sget v6, Lqq/a$c;->expandSubtitleTheme:I

    invoke-direct {v2, v0, v6}, Lar/c;-><init>(Landroid/content/Context;I)V

    iput-object v2, v1, Lyq/b;->d:Lar/c;

    sget v6, Lqq/a$h;->action_bar_subtitle_expand:I

    invoke-virtual {v2, v6}, Landroid/view/View;->setId(I)V

    iget-object v2, v1, Lyq/b;->d:Lar/c;
    ...
    iget-object v7, v1, Lyq/b;->d:Lar/c;
    ...
    sget v7, Lqq/a$f;->action_bar_subtitle_top_margin:I
    ...
    sget v7, Lqq/a$f;->action_bar_subtitle_bottom_margin:I
    ...
    iput-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Lyq/b;

    iget-boolean v0, v1, Lyq/b;->e:Z

    iget-boolean v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->i1:Z

    if-eq v0, v2, :cond_2

    iput-boolean v2, v1, Lyq/b;->e:Z

    iget-object v0, v1, Lyq/b;->b:Landroid/widget/LinearLayout;
    ...
    iget-boolean v1, v0, Lyq/b;->h:Z

    if-eqz v1, :cond_3

    iget-object v1, v0, Lyq/b;->c:Lar/c;

    invoke-virtual {v1, v5}, Lar/c;->b(Z)V

    iput-boolean v5, v0, Lyq/b;->h:Z
    ...
    iget-object v2, v0, Lyq/b;->c:Lar/c;
    ...
    :cond_4
    iget-object v0, v0, Lyq/b;->d:Lar/c;
    ...
    sget v2, Lqq/a$h;->action_bar_expand_container:I
    ...
    :goto_2
    iget-object v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Lyq/b;

    invoke-virtual {v2, v0}, Lyq/b;->b(Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Lyq/b;

    iget-boolean v2, p0, Lmiuix/appcompat/internal/app/widget/a;->x:Z

    iget-object v7, v0, Lyq/b;->c:Lar/c;
    ...
    invoke-direct {v8, v0, v9}, Lcom/xiaomi/mimoji/common/module/e;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v7, v8}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    iget-object v0, v0, Lyq/b;->c:Lar/c;
    ...
    :goto_3
    iget-object v7, v0, Lyq/b;->d:Lar/c;
    ...
    iget-object v2, v0, Lyq/b;->d:Lar/c;

    iget-object v0, v0, Lyq/b;->i:Lyq/b$a;
    ...
    invoke-virtual {v0, v1}, Lyq/b;->a(Ljava/lang/CharSequence;)V
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Lyq/b;
...
.method public final H()V
    ...
    sget v2, Lqq/a$c;->actionBarIndeterminateProgressStyle:I
    ...
    sget v1, Lqq/a$h;->progress_circular:I
...
.method public final I()V
    ...
    sget v7, Lqq/a$f;->miuix_appcompat_action_bar_title_view_padding_horizontal:I
    ...
    invoke-direct {v8, v7, v6, v3}, La0/l1;-><init>(Ljava/lang/Object;II)V

    invoke-virtual {v7, v8}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    sget v6, Lqq/a$h;->up:I
    ...
    sget v8, Lqq/a$k;->actionbar_button_up_description:I
    ...
    invoke-direct {v8, v9, v6, v1}, Landroidx/room/j;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    iput-object v7, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->F0:Landroid/widget/FrameLayout;
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Lyq/b;
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Lyq/a;
...
.method public final L()Z
    ...
    sget v0, Lqq/a$c;->actionBarTightTitle:I

    iget-object p0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->o0:Landroid/content/Context;

    invoke-static {p0, v0, v1}, Las/d;->c(Landroid/content/Context;IZ)Z
...
.method public final Q()V
    ...
    sget v3, Lqq/a$c;->actionBarPaddingStart:I

    invoke-static {v3, v2}, Las/d;->e(ILandroid/content/Context;)I
    ...
    iget-object v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Lyq/a;

    iget-object v2, v2, Lyq/a;->b:Landroid/widget/LinearLayout;
...
.method public final Y()V
    ...
    iget-object v0, v0, Lyq/a;->c:Lar/b;
    ...
    invoke-virtual {v0, v1}, Lyq/a;->c(Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Lyq/a;

    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->j0:Ljava/lang/CharSequence;

    invoke-virtual {v0, v1}, Lyq/a;->b(Ljava/lang/CharSequence;)V

    new-instance v0, Lfl/o;

    const/16 v1, 0xa

    invoke-direct {v0, p0, v1}, Lfl/o;-><init>(Ljava/lang/Object;I)V
...
.method public final Z()V
    ...
    iget-object v2, v2, Lyq/b;->c:Lar/c;
    ...
    invoke-virtual {v0, v1}, Lyq/b;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p0}, Lyq/b;->a(Ljava/lang/CharSequence;)V
...
.method public final a0()Z
    ...
    sget v1, Lqq/a$h;->action_bar_expand_container:I
    ...
    invoke-virtual {v0, v2}, Lyq/b;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v2, v4}, Lyq/b;->b(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, v0, Lyq/b;->b:Landroid/widget/LinearLayout;
    ...
    invoke-virtual {v0, v1}, Lyq/b;->c(I)V

    :cond_2
    iget-object p0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Lyq/b;

    iget-object p0, p0, Lyq/b;->d:Lar/c;
...
.method public final d0()V
    ...
    :goto_1
    iget-object v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Lyq/a;

    if-eqz v4, :cond_3

    iget-object v4, v4, Lyq/a;->c:Lar/b;
...
.method public getCollapseTitle()Lyq/a;
    .locals 1
...
.method public getExpandTitle()Lyq/b;
    .locals 1
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    sget-object v0, Lqq/a$m;->ActionBar:[I
    ...
    sget v2, Lqq/a$f;->miuix_appcompat_action_bar_large_font_max_height:I

    invoke-virtual {v1, v2}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v1

    sget v2, Lqq/a$c;->actionBarTitleAdaptLargeFont:I

    const/4 v4, 0x1

    invoke-static {v0, v2, v4}, Las/d;->c(Landroid/content/Context;IZ)Z

    move-result v2

    invoke-static {v0}, Lkr/e;->c(Landroid/content/Context;)I
    ...
    iget-object v1, p1, Lyq/b;->c:Lar/c;

    iget v2, p1, Lyq/b;->f:I

    invoke-virtual {v1, v2}, Landroid/widget/TextView;->setTextAppearance(I)V

    iget-object v1, p1, Lyq/b;->d:Lar/c;

    iget v2, p1, Lyq/b;->g:I
    ...
    iget-object p1, p1, Lyq/b;->c:Lar/c;

    invoke-static {p1}, Lck/g;->b(Landroid/widget/TextView;)V
    ...
    sget v1, Lqq/a$f;->miuix_appcompat_action_bar_title_tab_horizontal_padding:I
    ...
    sget v1, Lqq/a$f;->miuix_appcompat_action_bar_title_top_padding:I
    ...
    sget v1, Lqq/a$f;->miuix_appcompat_action_bar_title_bottom_padding:I
    ...
    sget v1, Lqq/a$f;->miuix_appcompat_action_bar_subtitle_bottom_padding:I
    ...
    sget v0, Lqq/a$f;->miuix_appcompat_action_bar_up_view_margin_start:I
    ...
    sget v0, Lqq/a$f;->miuix_appcompat_action_bar_title_horizontal_padding:I
    ...
    sget v3, Lqq/a$f;->miuix_appcompat_action_bar_title_top_padding:I
    ...
    sget v0, Lqq/a$f;->miuix_appcompat_action_bar_secondary_tab_vertical_padding:I
    ...
    sget v0, Lqq/a$c;->actionBarPaddingStart:I

    invoke-static {v0, p1}, Las/d;->e(ILandroid/content/Context;)I
    ...
    sget v1, Lqq/a$c;->actionBarPaddingEnd:I

    invoke-static {v1, v0}, Las/d;->e(ILandroid/content/Context;)I
    ...
    invoke-direct {p1, p0, v0}, Lil/e;-><init>(Ljava/lang/Object;I)V
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v0, v0, Lmiuix/appcompat/internal/view/menu/action/a;->u:Lmiuix/appcompat/internal/view/menu/action/a$a;
...
.method public final onLayout(ZIIII)V
    ...
    :goto_8
    iget-object v0, v6, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Lyq/a;
    ...
    iget-object v3, v0, Lyq/a;->c:Lar/b;

    invoke-virtual {v3}, Landroid/widget/TextView;->getPaint()Landroid/text/TextPaint;

    move-result-object v3

    iget v4, v0, Lyq/a;->h:F
    ...
    iput v3, v0, Lyq/a;->h:F

    const/4 v3, 0x1

    iput-boolean v3, v0, Lyq/a;->g:Z
    ...
    iput-boolean v7, v0, Lyq/a;->g:Z

    :cond_13
    :goto_9
    iget-boolean v3, v0, Lyq/a;->g:Z
    ...
    iput v2, v0, Lyq/a;->i:F

    const/4 v2, 0x0

    iput-boolean v2, v0, Lyq/a;->g:Z

    :cond_14
    iget-object v2, v0, Lyq/a;->c:Lar/b;
    ...
    :goto_c
    sget v0, Lqq/a$c;->actionBarTitleEnableEllipsis:I

    iget-object v2, v6, Lmiuix/appcompat/internal/app/widget/ActionBarView;->o0:Landroid/content/Context;

    const/4 v3, 0x0

    invoke-static {v2, v0, v3}, Las/d;->c(Landroid/content/Context;IZ)Z
    ...
    invoke-static {v5, v0, v1, v3}, La0/y;->a(IIII)I
    ...
    invoke-static/range {v0 .. v5}, Las/f;->c(Landroid/view/ViewGroup;Landroid/view/View;IIII)V
...
.method public final onMeasure(II)V
    ...
    sget v2, Lqq/a$h;->miuix_appcompat_navigator_switch_presenter:I
    ...
    iget-object v11, v2, Lxq/b;->a:Landroid/view/View;

    iget v2, v2, Lxq/b;->b:I
    ...
    iget-object v11, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Lyq/a;
    ...
    iget-object v5, v11, Lyq/a;->c:Lar/b;
    ...
    iget-object v5, v11, Lyq/a;->d:Lar/c;
    ...
    iget-object v9, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->R0:Lir/b;

    if-eqz v9, :cond_32

    iget-boolean v10, v9, Lir/b;->a:Z

    if-eqz v10, :cond_32

    invoke-virtual {v9}, Lir/b;->a()I
...
.method public final s()V
    ...
    invoke-virtual {v0, v2}, Lyq/b;->c(I)V
    ...
    iget-object v2, v2, Lyq/b;->b:Landroid/widget/LinearLayout;
...
.method public setBottomMenuCustomView(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/action/a;->V:Landroid/view/View;
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/view/menu/action/a;->V:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    :cond_0
    iput-object p1, p0, Lmiuix/appcompat/internal/view/menu/action/a;->V:Landroid/view/View;
...
.method public setDisplayOptions(I)V
    ...
    :cond_e
    iget-object v9, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Lyq/a;

    if-eqz v9, :cond_f

    iget-object v11, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->x0:Landroid/widget/FrameLayout;

    iget-object v9, v9, Lyq/a;->b:Landroid/widget/LinearLayout;

    invoke-virtual {v11, v9}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    :cond_f
    iget-object v9, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Lyq/b;

    if-eqz v9, :cond_10

    iget-object v11, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->y0:Landroid/widget/FrameLayout;

    iget-object v9, v9, Lyq/b;->b:Landroid/widget/LinearLayout;

    invoke-virtual {v11, v9}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    :cond_10
    iput-object v5, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Lyq/a;

    iput-object v5, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Lyq/b;
    ...
    :goto_9
    iget-object v10, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Lyq/a;

    if-eqz v10, :cond_14

    iget-object v10, v10, Lyq/a;->b:Landroid/widget/LinearLayout;
    ...
    :goto_a
    iget-object v11, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Lyq/b;

    if-eqz v11, :cond_15

    iget-object v11, v11, Lyq/b;->b:Landroid/widget/LinearLayout;
    ...
    sget v1, Lqq/a$h;->miuix_appcompat_navigator_switch_presenter:I

    new-instance v2, Lxq/b;

    invoke-direct {v2, v0}, Lxq/b;-><init>(Landroid/view/View;)V
    ...
    sget v0, Lqq/a$k;->abc_action_bar_up_description:I
    ...
    sget v0, Lqq/a$k;->abc_action_bar_home_description:I
...
.method public setExtraPaddingPolicy(Lir/b;)V
    .locals 0

    iput-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->R0:Lir/b;
...
.method public setSplitActionBar(Z)V
    ...
    sget v1, Lqq/a$d;->abc_action_bar_expanded_action_views_exclusive:I
...
.method public setSubTitleClickListener(Landroid/view/View$OnClickListener;)V
    ...
    :goto_0
    iget-object v0, v0, Lyq/a;->d:Lar/c;
...
.method public setSubtitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, Lyq/a;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, Lyq/b;->a(Ljava/lang/CharSequence;)V
    ...
    new-instance p1, Lql/e;

    const/4 v0, 0x4

    invoke-direct {p1, p0, v0}, Lql/e;-><init>(Ljava/lang/Object;I)V
...
.method public setTitleClickable(Z)V
    ...
    iget-object p0, p0, Lyq/b;->c:Lar/c;
...
.method public final t()V
    ...
    sget v0, Lqq/a$h;->action_bar_collapse_tab_container:I
...
.method public final u()V
    ...
    sget v0, Lqq/a$h;->action_bar_movable_tab_container:I
...
.method public final v()V
    ...
    invoke-static {v5, v6}, Lkr/e;->b(Landroid/content/Context;F)I
    ...
    invoke-static {v4, v5}, Las/f;->d(ILmiuix/appcompat/internal/view/menu/action/b;)V
    ...
    invoke-static {v5, v6}, Las/f;->d(ILmiuix/appcompat/internal/view/menu/action/b;)V
    ...
    iget-object v5, v0, Lmiuix/appcompat/internal/app/widget/ActionBarContainer;->u:Ljava/lang/Boolean;
    ...
    sget v1, Lqq/a$h;->expanded_menu:I
...
.method public final w()V
    ...
    iget-object v3, v0, Lyq/b;->b:Landroid/widget/LinearLayout;
    ...
    iget-object v3, v0, Lyq/a;->b:Landroid/widget/LinearLayout;
    ...
    sget v7, Lqq/a$h;->action_bar_expand_container:I
    ...
    sget v3, Lqq/a$c;->actionBarTightTitle:I

    iget-object v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->o0:Landroid/content/Context;

    invoke-static {v4, v3, v6}, Las/d;->c(Landroid/content/Context;IZ)Z
...
.method public final z(Z)V
    ...
    invoke-direct {v1, v0}, Lyq/a;-><init>(Landroid/content/Context;)V

    invoke-virtual {v0}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v2

    invoke-static {v0}, Lkr/a;->d(Landroid/content/Context;)Lkr/h;

    sget v3, Lqq/a$f;->miuix_appcompat_subtitle_text_size:I
    ...
    iput v3, v1, Lyq/a;->f:F

    new-instance v3, Landroid/widget/LinearLayout;

    invoke-direct {v3, v0}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;)V

    iput-object v3, v1, Lyq/a;->b:Landroid/widget/LinearLayout;
    ...
    sget v5, Lqq/a$c;->collapseTitleTheme:I

    invoke-direct {v3, v0, v5}, Lar/b;-><init>(Landroid/content/Context;I)V

    iput-object v3, v1, Lyq/a;->c:Lar/b;

    const/4 v5, 0x0

    invoke-virtual {v3, v5}, Landroid/view/View;->setVerticalScrollBarEnabled(Z)V

    iget-object v3, v1, Lyq/a;->c:Lar/b;
    ...
    sget v3, Lqq/a$c;->actionBarTitleAdaptLargeFont:I

    const/4 v6, 0x1

    invoke-static {v0, v3, v6}, Las/d;->c(Landroid/content/Context;IZ)Z
    ...
    :goto_1
    iput-boolean v3, v1, Lyq/a;->k:Z

    if-eqz v3, :cond_2

    sget v3, Lqq/a$c;->collapseTitleLargeFontMaxLine:I

    invoke-static {v3, v0, v4}, Las/d;->h(ILandroid/content/Context;I)I

    move-result v3

    iput v3, v1, Lyq/a;->l:I
    ...
    iget v7, v1, Lyq/a;->l:I

    invoke-virtual {v3, v7}, Landroid/widget/TextView;->setMaxLines(I)V

    :cond_2
    sget v3, Lqq/a$c;->collapseSubtitleTheme:I

    new-instance v7, Lar/c;

    invoke-direct {v7, v0, v3}, Lar/c;-><init>(Landroid/content/Context;I)V

    iput-object v7, v1, Lyq/a;->d:Lar/c;

    invoke-virtual {v7, v5}, Landroid/view/View;->setVerticalScrollBarEnabled(Z)V

    iget-object v0, v1, Lyq/a;->d:Lar/c;

    invoke-virtual {v0, v5}, Landroid/view/View;->setHorizontalScrollBarEnabled(Z)V

    iget-object v0, v1, Lyq/a;->b:Landroid/widget/LinearLayout;
    ...
    invoke-direct {v3, v1, v7}, Lcom/uber/rxdogtag/m;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v0, v3}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    iget-object v0, v1, Lyq/a;->c:Lar/b;

    sget v3, Lqq/a$h;->action_bar_title:I
    ...
    sget v3, Lqq/a$h;->action_bar_subtitle:I
    ...
    iget-object v7, v1, Lyq/a;->d:Lar/c;
    ...
    iput-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Lyq/a;

    iget-boolean v0, v1, Lyq/a;->e:Z

    iget-boolean v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->h1:Z

    if-eq v0, v2, :cond_4

    iput-boolean v2, v1, Lyq/a;->e:Z
    ...
    iget-boolean v1, v0, Lyq/a;->j:Z

    if-eqz v1, :cond_5

    iget-object v1, v0, Lyq/a;->c:Lar/b;

    invoke-virtual {v1, v5}, Lar/c;->b(Z)V

    iput-boolean v5, v0, Lyq/a;->j:Z
    ...
    invoke-direct {v7, v0, v3}, Lzk/b;-><init>(Ljava/lang/Object;I)V
    ...
    :goto_3
    iget-object v2, v0, Lyq/a;->d:Lar/c;
    ...
    iget-object v1, v0, Lyq/a;->d:Lar/c;

    iget-object v0, v0, Lyq/a;->m:Lyq/a$a;
