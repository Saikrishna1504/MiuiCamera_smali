...
.method public static varargs createTimeInterpolator(I[D)Landroid/animation/TimeInterpolator;
    ...
    :pswitch_0
    new-instance p0, Lst/c;

    invoke-direct {p0, v1}, Lst/c;-><init>(I)V
    ...
    invoke-direct {p0, v1}, Lst/d;-><init>(I)V

    return-object p0

    :pswitch_2
    new-instance p0, Lst/b;

    invoke-direct {p0, v1}, Lst/b;-><init>(I)V
    ...
    :pswitch_7
    new-instance p0, Lst/i;

    invoke-direct {p0}, Lst/i;-><init>()V
    ...
    :pswitch_9
    new-instance p0, Lst/h;

    invoke-direct {p0}, Lst/h;-><init>()V
    ...
    invoke-direct {p0, v0}, Lst/d;-><init>(I)V

    return-object p0

    :pswitch_b
    new-instance p0, Lst/e;

    invoke-direct {p0, v0}, Lst/e;-><init>(I)V
    ...
    invoke-direct {p0, v0}, Lst/c;-><init>(I)V

    return-object p0

    :pswitch_d
    new-instance p0, Lst/r;

    invoke-direct {p0}, Lst/r;-><init>()V
    ...
    :pswitch_f
    new-instance p0, Lst/q;

    invoke-direct {p0}, Lst/q;-><init>()V

    return-object p0

    :pswitch_10
    new-instance p0, Lst/o;

    invoke-direct {p0}, Lst/o;-><init>()V

    return-object p0

    :pswitch_11
    new-instance p0, Lst/p;

    invoke-direct {p0}, Lst/p;-><init>()V
    ...
    :pswitch_13
    new-instance p0, Lst/f;

    invoke-direct {p0}, Lst/f;-><init>()V
    ...
    invoke-direct {p0, v1}, Lst/e;-><init>(I)V

    return-object p0

    :pswitch_16
    new-instance p0, Lst/l;

    invoke-direct {p0}, Lst/l;-><init>()V

    return-object p0

    :pswitch_17
    new-instance p0, Lst/m;

    invoke-direct {p0}, Lst/m;-><init>()V

    return-object p0

    :pswitch_18
    new-instance p0, Lst/k;

    invoke-direct {p0}, Lst/k;-><init>()V
