...
.method public static varargs createTimeInterpolator(I[F)Landroid/animation/TimeInterpolator;
    ...
    :pswitch_7
    new-instance p0, Lyn/h;

    invoke-direct {p0}, Lyn/h;-><init>()V
    ...
    :pswitch_c
    new-instance p0, Lyn/s;

    invoke-direct {p0}, Lyn/s;-><init>()V

    return-object p0

    :pswitch_d
    new-instance p0, Lyn/q;

    invoke-direct {p0}, Lyn/q;-><init>()V

    return-object p0

    :pswitch_e
    new-instance p0, Lyn/r;

    invoke-direct {p0}, Lyn/r;-><init>()V

    return-object p0

    :pswitch_f
    new-instance p0, Lyn/p;

    invoke-direct {p0}, Lyn/p;-><init>()V

    return-object p0

    :pswitch_10
    new-instance p0, Lyn/n;

    invoke-direct {p0}, Lyn/n;-><init>()V

    return-object p0

    :pswitch_11
    new-instance p0, Lyn/o;

    invoke-direct {p0}, Lyn/o;-><init>()V
    ...
    :pswitch_16
    new-instance p0, Lyn/k;

    invoke-direct {p0}, Lyn/k;-><init>()V

    return-object p0

    :pswitch_17
    new-instance p0, Lyn/l;
    ...
    :pswitch_18
    new-instance p0, Lyn/j;

    invoke-direct {p0}, Lyn/j;-><init>()V
