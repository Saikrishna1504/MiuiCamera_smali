...
.method public run()V
    ...
    iget-object v3, v2, Lmiuix/animation/controller/FolmeState;->mStateMgr:Lmiuix/animation/controller/StateManager;

    invoke-virtual {v2}, Lmiuix/animation/controller/FolmeState;->getTarget()Lmiuix/animation/IAnimTarget;

    move-result-object v2

    new-instance v4, Lmiuix/animation/base/AnimConfigLink;

    invoke-direct {v4}, Lmiuix/animation/base/AnimConfigLink;-><init>()V

    iget-object v5, p0, Lmiuix/animation/controller/FolmeState$4;->val$propertyAndValues:[Ljava/lang/Object;

    invoke-virtual {v3, v2, v1, v4, v5}, Lmiuix/animation/controller/StateManager;->setAnimState(Lmiuix/animation/IAnimTarget;Lmiuix/animation/controller/AnimState;Lmiuix/animation/base/AnimConfigLink;[Ljava/lang/Object;)V
