...
.method public constructor <init>(Lmn/a;)V
    ...
    iput-object p1, p0, Lmiuix/responsive/page/manager/BaseResponseStateManager;->d:Lmn/a;

    invoke-interface {p1}, Lmn/a;->Ue()Ljava/lang/Object;
    ...
    iget-object p1, p0, Lmiuix/responsive/page/manager/BaseResponseStateManager;->d:Lmn/a;
    ...
    invoke-static {p1, v0}, Lon/c;->a(Landroid/view/LayoutInflater;Landroid/view/LayoutInflater$Factory2;)V

    invoke-virtual {p0}, Lmiuix/responsive/page/manager/a;->a()Lnn/b;

    move-result-object p1

    iput-object p1, p0, Lmiuix/responsive/page/manager/a;->b:Lnn/b;
...
.method public i(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p0, p1}, Lmiuix/responsive/page/manager/a;->b(Landroid/content/res/Configuration;)Lnn/b;

    move-result-object v0

    iput-object v0, p0, Lmiuix/responsive/page/manager/a;->b:Lnn/b;

    invoke-virtual {p0, p1}, Lmiuix/responsive/page/manager/a;->f(Landroid/content/res/Configuration;)V

    iget-object v0, p0, Lmiuix/responsive/page/manager/a;->b:Lnn/b;

    iget-object v1, p0, Lmiuix/responsive/page/manager/a;->a:Lnn/b;

    invoke-virtual {p0, v0, v1}, Lmiuix/responsive/page/manager/a;->d(Lnn/b;Lnn/b;)Z

    move-result v0

    iget-object v1, p0, Lmiuix/responsive/page/manager/a;->b:Lnn/b;

    xor-int/lit8 v0, v0, 0x1

    invoke-virtual {p0, p1, v1, v0}, Lmiuix/responsive/page/manager/BaseResponseStateManager;->n(Landroid/content/res/Configuration;Lnn/b;Z)V
...
.method public j(Landroid/content/res/Configuration;)V
    ...
    iget-object v0, p0, Lmiuix/responsive/page/manager/a;->a:Lnn/b;

    iget-object v1, p0, Lmiuix/responsive/page/manager/a;->b:Lnn/b;

    invoke-virtual {v0, v1}, Lnn/b;->l(Lnn/b;)V
...
.method public final k(Landroid/view/View;)V
    ...
    invoke-direct {v0, v1}, Lnn/d;-><init>(I)V

    const/4 v1, 0x3

    invoke-virtual {v0, v1}, Lnn/d;->e(I)V
...
.method public l()V
    ...
    iput-object v0, p0, Lmiuix/responsive/page/manager/BaseResponseStateManager;->d:Lmn/a;
...
.method public n(Landroid/content/res/Configuration;Lnn/b;Z)V
    .locals 4
    .param p2    # Lnn/b;
    ...
    invoke-virtual {p2, v0}, Lnn/b;->q(Lnn/e;)V

    :cond_0
    iget-object p2, p0, Lmiuix/responsive/page/manager/BaseResponseStateManager;->d:Lmn/a;

    invoke-interface {p2, p1, v0, p3}, Lmn/a;->f5(Landroid/content/res/Configuration;Lnn/e;Z)V
    ...
    invoke-interface {v1, p1, v0, p3}, Lmn/a;->f5(Landroid/content/res/Configuration;Lnn/e;Z)V
    ...
    :cond_3
    invoke-interface {v2, p1, v0, p3}, Lmn/b;->l(Landroid/content/res/Configuration;Lnn/e;Z)Z
...
.method public o()V
    ...
    invoke-virtual {v0, p0}, Lnn/c;->c(Landroid/content/Context;)V
...
.method public final p(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;Ljava/lang/String;)V
    ...
    :cond_0
    sget-object v0, Lyl/c;->ResponsiveSpec:[I
    ...
    invoke-static {p4}, Lkn/b;->a(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object p3

    const-class p4, Lmn/b;
    ...
    sget p3, Lyl/c;->ResponsiveSpec_android_id:I
    ...
    :cond_1
    sget p3, Lyl/c;->ResponsiveSpec_effectiveScreenOrientation:I
    ...
    sget p2, Lyl/c;->ResponsiveSpec_android_id:I
    ...
    new-instance p4, Lnn/d;

    invoke-direct {p4, p2}, Lnn/d;-><init>(I)V

    invoke-virtual {p4, p3}, Lnn/d;->e(I)V
    ...
    :cond_2
    sget p3, Lyl/c;->ResponsiveSpec_hideInScreenMode:I
    ...
    :cond_3
    sget p0, Lyl/c;->ResponsiveSpec_android_id:I
    ...
    invoke-direct {p2, p0, p3}, Lnn/d;-><init>(II)V
