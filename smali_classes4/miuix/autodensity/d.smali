...
.method public final d(Landroid/content/Context;Landroid/content/res/Configuration;)V
    ...
    invoke-static {v11}, Lbq/m0;->k(Ljava/lang/String;)V
    ...
    invoke-static {v8}, Lbq/m0;->k(Ljava/lang/String;)V
    ...
    invoke-static {v10, v8, v4}, La0/w;->g(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-static {v10}, Lbq/m0;->k(Ljava/lang/String;)V
    ...
    invoke-static {v14}, Lbq/m0;->k(Ljava/lang/String;)V
    ...
    :cond_d
    sget-boolean v0, Lis/a;->f:Z

    if-eqz v0, :cond_e

    invoke-static/range {p1 .. p1}, Lis/b;->c(Landroid/content/Context;)Z
    ...
    sget-boolean v2, Lis/a;->e:Z

    sget v5, Lmiuix/autodensity/i;->b:F

    if-nez v2, :cond_2d

    sget-boolean v2, Lis/a;->g:Z

    if-eqz v2, :cond_2e

    :cond_2d
    invoke-static/range {p1 .. p1}, Lkr/a;->b(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-static {v4}, Lbq/m0;->k(Ljava/lang/String;)V
