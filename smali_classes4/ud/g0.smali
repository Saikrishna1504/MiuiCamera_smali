...
.method public X(Lud/h0;)V
    ...
    invoke-virtual {p0, v5}, Lud/k;->q(Landroid/media/Image;)Z
    ...
    invoke-static {v6, v1}, Lrd/e;->b(Ljava/lang/String;I)V

    invoke-virtual {v4}, Lud/d$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {p0, v6, v5, v1, v7}, Lud/g0;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    sget-object v9, Ll9/ek;->I:Ll9/ds;

    invoke-static {v8, v9}, Ll9/es;->k(Landroid/hardware/camera2/CaptureRequest;Ll9/ds;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v6, v5, v7, v8}, Lud/g0;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V

    :goto_3
    invoke-virtual {v4}, Lud/d$a;->k()Landroid/media/Image;

    move-result-object v4

    iget-object v5, p0, Lud/k;->j:Lud/k$a;

    invoke-virtual {p0, v4, v5}, Lud/b;->b0(Landroid/media/Image;Lud/k$a;)V
...
.method public b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/List;
    ...
    new-instance v2, Lud/g0$a;

    invoke-direct {v2, p0}, Lud/g0$a;-><init>(Lud/g0;)V
    ...
    new-instance v2, Lud/g0$b;

    invoke-direct {v2, p0}, Lud/g0$b;-><init>(Lud/g0;)V
    ...
    new-instance v1, Lud/g0$c;

    invoke-direct {v1, p0}, Lud/g0$c;-><init>(Lud/g0;)V
...
.method public final f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    :cond_0
    new-instance p1, Lud/g0$d;

    invoke-direct {p1, p0}, Lud/g0$d;-><init>(Lud/g0;)V
    ...
    :cond_2
    new-instance p1, Lud/g0$e;

    invoke-direct {p1, p0}, Lud/g0$e;-><init>(Lud/g0;)V
