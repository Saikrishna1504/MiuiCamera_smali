...
.method public constructor <init>(Lud/k$a;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {p0, p1, p2}, Lud/b;-><init>(Lud/k$a;Lcom/xiaomi/engine/BufferFormat;)V
...
.method public X(Lud/h0;)V
    ...
    invoke-virtual {p1}, Lud/h0;->f()Lzj/c;
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lud/f;->g0(Lud/h0;)V

    goto :goto_1

    :cond_2
    :goto_0
    invoke-virtual {p0, p1}, Lud/f;->h0(Lud/h0;)V
...
.method public b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/List;
    ...
    iput-object v1, p0, Lud/b;->x:Landroid/media/ImageReader;

    new-instance v2, Lud/f$a;

    invoke-direct {v2, p0}, Lud/f$a;-><init>(Lud/f;)V
    ...
    iget-object v2, p0, Lud/b;->x:Landroid/media/ImageReader;
    ...
    iput-object v1, p0, Lud/b;->y:Landroid/media/ImageReader;

    new-instance v2, Lud/f$b;

    invoke-direct {v2, p0}, Lud/f$b;-><init>(Lud/f;)V
    ...
    iget-object v2, p0, Lud/b;->y:Landroid/media/ImageReader;
    ...
    iput-object p1, p0, Lud/b;->z:Landroid/media/ImageReader;

    new-instance v1, Lud/f$c;

    invoke-direct {v1, p0}, Lud/f$c;-><init>(Lud/f;)V
    ...
    iget-object p0, p0, Lud/b;->z:Landroid/media/ImageReader;
...
.method public final f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    sget-object v0, Ll9/cs;->Q1:Ll9/ds;

    invoke-virtual {v0}, Ll9/ds;->b()Ljava/lang/Object;
    ...
    invoke-direct {p1, p0}, Lud/f$d;-><init>(Lud/f;)V
    ...
    iget-object p1, p0, Lud/b;->B:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object p2, p0, Lud/b;->v:Lcom/xiaomi/engine/TaskSession;

    goto :goto_2

    :cond_3
    iget-object p2, p0, Lud/b;->w:Lud/j0;

    invoke-virtual {p2}, Lud/j0;->b()Lcom/xiaomi/engine/TaskSession;
    ...
    :cond_4
    new-instance p1, Lud/f$e;

    invoke-direct {p1, p0}, Lud/f$e;-><init>(Lud/f;)V
...
.method public final g0(Lud/h0;)V
    .locals 9
    .param p1    # Lud/h0;
    ...
    invoke-virtual {p0, v2}, Lud/k;->q(Landroid/media/Image;)Z

    move-result v4

    invoke-virtual {p0, v3}, Lud/k;->q(Landroid/media/Image;)Z
    ...
    invoke-static {v8, v7}, Lrd/e;->b(Ljava/lang/String;I)V
    ...
    invoke-virtual {p1}, Lud/h0;->e()I

    move-result v4

    invoke-virtual {p0, v1, v2, v7, v4}, Lud/f;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-virtual {p0, v1, v3, v2, v4}, Lud/f;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public final h0(Lud/h0;)V
    .locals 7
    .param p1    # Lud/h0;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v4, v5}, Lrd/e;->b(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v1, v2, v5, v4}, Lud/f;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public p()Z
    ...
    iget-object v1, p0, Lud/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lud/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lud/k;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Lud/k;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v0, p0}, Lud/k$a;->b(Lud/k;)Z
    ...
    iget-object p0, p0, Lud/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
