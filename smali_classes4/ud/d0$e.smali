...
.method public constructor <init>(Lud/d0;)V
    ...
    iput-object p1, p0, Lud/d0$e;->a:Lud/d0;
...
.method public a(Landroid/media/Image;)V
    ...
    iget-object p0, p0, Lud/d0$e;->a:Lud/d0;

    invoke-static {p0}, Lud/d0;->i(Lud/d0;)Lud/e;

    move-result-object p0

    invoke-interface {p0, p1}, Lud/e;->a(Landroid/media/Image;)V

    return-void
.end method

.method public b(Lud/k;)Z
    .locals 0
    ...
    invoke-virtual {p0, p1}, Lud/r;->z(Lud/k;)Z
...
.method public c(ILjava/lang/Object;)V
    ...
    invoke-virtual {p0, p2}, Lud/d0$e;->i(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-virtual {p0, p2}, Lud/d0$e;->j(Lcom/xiaomi/engine/ResultData;)V

    :goto_0
    return-void
.end method

.method public d(Landroid/media/Image;IZ)V
    .locals 16
    ...
    invoke-static {v8, v13}, Lrd/e;->d(II)V

    invoke-static/range {p1 .. p1}, Lrd/d;->f(Landroid/media/Image;)[B

    move-result-object v0

    if-eqz v0, :cond_12

    iget-object v1, v1, Lud/d0$e;->a:Lud/d0;

    invoke-static {v1}, Lud/d0;->m(Lud/d0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    :cond_0
    invoke-virtual {v1, v9, v10}, Lud/d0$e;->g(J)Lud/w;
    ...
    invoke-virtual {v15}, Lud/w;->k()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {v15}, Lud/w;->q()Lud/x;

    move-result-object v3

    invoke-virtual {v3}, Lud/x;->p0()I
    ...
    invoke-static {v5}, Lrd/c;->d(I)Z

    move-result v4

    if-nez v4, :cond_8

    invoke-virtual {v3}, Lud/x;->W0()Z
    ...
    iget-object v2, v1, Lud/d0$e;->a:Lud/d0;
    ...
    invoke-static/range {v2 .. v7}, Lud/d0;->n(Lud/d0;Lud/w;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    ...
    invoke-static {v3, v0, v7}, Lrd/d;->j(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v3

    iget-object v4, v1, Lud/d0$e;->a:Lud/d0;

    invoke-static {v4}, Lud/d0;->i(Lud/d0;)Lud/e;

    move-result-object v4

    invoke-interface {v4, v0}, Lud/e;->a(Landroid/media/Image;)V
    ...
    iget-object v3, v1, Lud/d0$e;->a:Lud/d0;

    invoke-static {v3}, Lud/d0;->q(Lud/d0;)Lr7/h;

    move-result-object v3

    iget-object v4, v1, Lud/d0$e;->a:Lud/d0;

    invoke-static {v4}, Lud/d0;->o(Lud/d0;)Lr7/d$a;

    move-result-object v4

    invoke-virtual {v3, v0, v2, v15, v4}, Lr7/h;->p(Landroid/media/Image;Landroid/hardware/camera2/CaptureResult;Lud/w;Lr7/d$a;)V

    invoke-static {v5}, Lrd/c;->c(I)Z

    move-result v0

    if-eqz v0, :cond_7

    iget-object v0, v1, Lud/d0$e;->a:Lud/d0;

    invoke-static {v0}, Lud/d0;->r(Lud/d0;)Ljava/util/Map;
    ...
    invoke-static {v3}, Lud/d0;->s(Lud/d0;)Ljava/util/Map;
    ...
    invoke-static {v3, v5}, Lud/d0;->t(Lud/d0;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {v3}, Lud/d0;->u(Lud/d0;)Ljava/util/Map;
    ...
    invoke-static {v3, v5}, Lud/d0;->v(Lud/d0;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-virtual {v15}, Lud/w;->L()I

    move-result v5

    invoke-virtual {v15}, Lud/w;->K()I

    move-result v6

    invoke-virtual {v15}, Lud/w;->d()Landroid/graphics/Rect;

    move-result-object v7

    invoke-virtual {v15}, Lud/w;->R()F

    move-result v8

    invoke-static {v3, v5, v6, v7, v8}, Lcom/android/camera/g6;->M(Landroid/graphics/Rect;IILandroid/graphics/Rect;F)Z
    ...
    invoke-static {v0}, Lud/d0;->u(Lud/d0;)Ljava/util/Map;
    ...
    invoke-static {v0}, Lud/d0;->s(Lud/d0;)Ljava/util/Map;
    ...
    invoke-static {v2}, Lud/d0;->m(Lud/d0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    invoke-static {v2}, Lud/d0;->u(Lud/d0;)Ljava/util/Map;
    ...
    invoke-static {v1}, Lud/d0;->s(Lud/d0;)Ljava/util/Map;
    ...
    invoke-virtual/range {v1 .. v7}, Lud/d0$e;->h(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLud/w;J)V
    ...
    invoke-static {v2, v0, v3}, Lrd/d;->j(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v2

    iget-object v3, v1, Lud/d0$e;->a:Lud/d0;

    invoke-static {v3}, Lud/d0;->i(Lud/d0;)Lud/e;

    move-result-object v3

    invoke-interface {v3, v0}, Lud/e;->a(Landroid/media/Image;)V

    iget-object v0, v1, Lud/d0$e;->a:Lud/d0;

    invoke-static {v0, v9, v10, v2}, Lud/d0;->w(Lud/d0;JLandroid/media/Image;)V
    ...
    invoke-static {v1, v9, v10, v0}, Lud/d0;->w(Lud/d0;JLandroid/media/Image;)V
...
.method public f(JI)V
    ...
    iget-object v0, p0, Lud/d0$e;->a:Lud/d0;

    invoke-static {v0}, Lud/d0;->p(Lud/d0;)Lud/d0$j;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, p1, p2}, Lud/d0$e;->g(J)Lud/w;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lud/w;->k0()Z
    ...
    invoke-static {p0}, Lud/d0;->p(Lud/d0;)Lud/d0$j;

    move-result-object p0

    invoke-interface {p0, v0, p3}, Lud/d0$j;->b(Lud/w;I)V
...
.method public g(J)Lud/w;
    .locals 0

    iget-object p0, p0, Lud/d0$e;->a:Lud/d0;

    invoke-static {p0, p1, p2}, Lud/d0;->N(Lud/d0;J)Lud/w;
...
.method public final h(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLud/w;J)V
    .locals 6
    ...
    invoke-static {p2}, Lrd/d;->e(Landroid/media/Image;)[B
    ...
    invoke-virtual {p4, v3, v0}, Lud/w;->a([BI)V

    const-string p2, "JPEG"

    invoke-virtual {p4, p2}, Lud/w;->b0(Ljava/lang/String;)Z
    ...
    invoke-virtual {p4, p2}, Lud/w;->Z0(Z)V
    ...
    iget-object p2, p0, Lud/d0$e;->a:Lud/d0;

    invoke-static {p2}, Lud/d0;->q(Lud/d0;)Lr7/h;

    move-result-object p2

    const/4 p3, 0x0

    invoke-virtual {p2, p4, p1, p3, p3}, Lr7/h;->j(Lud/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z

    move-result p1

    iget-object p2, p0, Lud/d0$e;->a:Lud/d0;

    invoke-virtual {p4}, Lud/w;->Q()Landroid/media/Image;
    ...
    invoke-virtual {p4}, Lud/w;->v0()V

    :cond_3
    iget-object p1, p0, Lud/d0$e;->a:Lud/d0;

    invoke-static {p1, p4}, Lud/d0;->y(Lud/d0;Lud/w;)Z
    ...
    invoke-interface {p1, p4}, Lud/d0$j;->a(Lud/w;)V
    ...
    invoke-static {p1, p5, p6}, Lud/d0;->l(Lud/d0;J)Lud/w;
...
.method public final i(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-virtual {p0, v0, v1}, Lud/d0$e;->g(J)Lud/w;
    ...
    invoke-static {p1}, Lud/l;->a(Lcom/xiaomi/engine/ResultData;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1}, Lud/z;->F(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lud/x;->Y0(B)V

    invoke-virtual {v0, p1}, Lud/z;->c0(B)V
...
.method public final j(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-virtual {v1, v2, v3}, Lud/d0$e;->g(J)Lud/w;
    ...
    :goto_1
    iget-object v11, v1, Lud/d0$e;->a:Lud/d0;

    invoke-static {v11}, Lud/d0;->u(Lud/d0;)Ljava/util/Map;
    ...
    invoke-static {v11, v12}, Lud/d0;->v(Lud/d0;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {v0, v7}, Lud/d0;->t(Lud/d0;Ljava/util/Map;)Ljava/util/Map;
    ...
    iget-object v7, v1, Lud/d0$e;->a:Lud/d0;

    invoke-static {v7}, Lud/d0;->u(Lud/d0;)Ljava/util/Map;
    ...
    invoke-virtual {v4}, Lud/w;->L()I

    move-result v8

    invoke-virtual {v4}, Lud/w;->K()I

    move-result v11

    invoke-virtual {v4}, Lud/w;->d()Landroid/graphics/Rect;

    move-result-object v12

    invoke-virtual {v4}, Lud/w;->R()F

    move-result v4

    invoke-static {v7, v8, v11, v12, v4}, Lcom/android/camera/g6;->M(Landroid/graphics/Rect;IILandroid/graphics/Rect;F)Z
    ...
    invoke-static {v4}, Lud/d0;->m(Lud/d0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    invoke-static {v4}, Lud/d0;->s(Lud/d0;)Ljava/util/Map;
    ...
    invoke-static {v1}, Lud/d0;->u(Lud/d0;)Ljava/util/Map;
