...
.method public static constructor <clinit>()V
    ...
    sput-boolean v0, Lud/d0;->H:Z

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lud/d0$j;)V
    .locals 1
    ...
    iput p1, p0, Lud/d0;->a:I

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lud/d0;->c:Ljava/util/HashMap;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lud/d0;->d:Ljava/util/List;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, Lud/d0;->e:Landroid/util/SparseArray;

    const/4 p1, 0x0

    iput-object p1, p0, Lud/d0;->f:Landroid/os/HandlerThread;

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lud/d0;->j:Ljava/lang/Object;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lud/d0;->k:Ljava/util/HashMap;

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lud/d0;->l:Ljava/lang/Object;

    new-instance p1, Lud/d0$h;

    invoke-direct {p1, p0}, Lud/d0$h;-><init>(Lud/d0;)V

    iput-object p1, p0, Lud/d0;->m:Lud/d0$h;

    const/4 p1, -0x1

    iput p1, p0, Lud/d0;->o:I

    iput p1, p0, Lud/d0;->p:I

    const/4 p1, 0x0

    iput-boolean p1, p0, Lud/d0;->v:Z

    const/4 v0, 0x1

    iput v0, p0, Lud/d0;->x:I

    iput p1, p0, Lud/d0;->y:I

    new-instance p1, Lud/d0$a;

    invoke-direct {p1, p0}, Lud/d0$a;-><init>(Lud/d0;)V

    iput-object p1, p0, Lud/d0;->z:Lcom/xiaomi/engine/TaskSession$SessionStatusCallback;

    new-instance p1, Lud/d0$b;

    invoke-direct {p1, p0}, Lud/d0$b;-><init>(Lud/d0;)V

    iput-object p1, p0, Lud/d0;->A:Lud/r$e;

    new-instance p1, Lud/d0$c;

    invoke-direct {p1, p0}, Lud/d0$c;-><init>(Lud/d0;)V

    iput-object p1, p0, Lud/d0;->B:Lud/e;

    new-instance p1, Lud/d0$d;

    invoke-direct {p1, p0}, Lud/d0$d;-><init>(Lud/d0;)V

    iput-object p1, p0, Lud/d0;->C:Lcom/xiaomi/camera/imagecodec/ReprocessData$DataStatusCallback;

    new-instance p1, Lud/d0$e;

    invoke-direct {p1, p0}, Lud/d0$e;-><init>(Lud/d0;)V

    iput-object p1, p0, Lud/d0;->D:Lud/k$a;

    new-instance p1, Lud/d0$f;

    invoke-direct {p1, p0}, Lud/d0$f;-><init>(Lud/d0;)V

    iput-object p1, p0, Lud/d0;->E:Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    iget-object p1, p0, Lud/d0;->f:Landroid/os/HandlerThread;
    ...
    iput-object v0, p0, Lud/d0;->f:Landroid/os/HandlerThread;
    ...
    iput-object v0, p0, Lud/d0;->g:Landroid/os/Handler;

    iput-object p2, p0, Lud/d0;->h:Lud/d0$j;

    invoke-virtual {p0}, Lud/d0;->s0()V

    return-void
.end method

.method public static synthetic A(Lud/d0;I)I
    .locals 0
...
.method public static synthetic B(Lud/d0;)I
    .locals 2

    iget v0, p0, Lud/d0;->y:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, Lud/d0;->y:I

    return v0
.end method

.method public static synthetic C(Lud/d0;Lud/w;I)Z
    .locals 0

    invoke-virtual {p0, p1, p2}, Lud/d0;->F0(Lud/w;I)Z
...
.method public static synthetic C0(Lud/d$a;)Z
    .locals 1

    invoke-virtual {p0}, Lud/d$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
...
.method public static synthetic D(Lud/d0;)V
    .locals 0

    invoke-virtual {p0}, Lud/d0;->g0()V

    return-void
.end method

.method public static synthetic D0(ZLud/d$a;Lud/d$a;)Lud/d$a;
    .locals 0
...
.method public static synthetic E(Lud/d0;)Ljava/lang/ref/WeakReference;
    .locals 0

    iget-object p0, p0, Lud/d0;->w:Ljava/lang/ref/WeakReference;
...
.method private synthetic E0(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v0, v1}, Lud/d0;->o0(J)Lud/w;
    ...
    invoke-static {v0}, Lfe/a;->e(Ljava/lang/String;)V

    goto :goto_0

    :cond_1
    invoke-virtual {p0}, Lud/d0;->U()V

    return-void
.end method

.method public static synthetic F(Lud/d0;)V
    .locals 0

    invoke-virtual {p0}, Lud/d0;->c1()V

    return-void
.end method

.method public static synthetic G(Lud/d0;)Ljava/lang/Object;
    .locals 0

    iget-object p0, p0, Lud/d0;->l:Ljava/lang/Object;

    return-object p0
.end method

.method public static synthetic H(Lud/d0;)Ljava/util/HashMap;
    .locals 0

    iget-object p0, p0, Lud/d0;->k:Ljava/util/HashMap;

    return-object p0
.end method

.method public static synthetic I(Lud/d0;Lud/w;Landroid/media/Image;Ljava/lang/String;IZ)V
    .locals 0

    invoke-virtual/range {p0 .. p5}, Lud/d0;->M0(Lud/w;Landroid/media/Image;Ljava/lang/String;IZ)V

    return-void
.end method

.method public static synthetic J(Lud/d0;I)V
    .locals 0

    invoke-virtual {p0, p1}, Lud/d0;->Z0(I)V

    return-void
.end method

.method public static synthetic K(Lud/d0;JLud/w;)V
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, Lud/d0;->L0(JLud/w;)V

    return-void
.end method

.method public static synthetic L(Lud/d0;)Lud/k;
    .locals 0

    iget-object p0, p0, Lud/d0;->b:Lud/k;

    return-object p0
.end method

.method public static synthetic M(Lud/d0;)Lud/r$e;
    .locals 0

    iget-object p0, p0, Lud/d0;->A:Lud/r$e;

    return-object p0
.end method

.method public static synthetic N(Lud/d0;J)Lud/w;
    .locals 0

    invoke-virtual {p0, p1, p2}, Lud/d0;->o0(J)Lud/w;
...
.method public static synthetic O(Lud/d0;Lud/d;I)Lcom/xiaomi/protocol/ICustomCaptureResult;
    .locals 0

    invoke-virtual {p0, p1, p2}, Lud/d0;->S(Lud/d;I)Lcom/xiaomi/protocol/ICustomCaptureResult;
...
.method public static synthetic a(Lud/d$a;)Z
    .locals 0

    invoke-static {p0}, Lud/d0;->C0(Lud/d$a;)Z
...
.method public static synthetic b(Lud/d0;Ljava/util/List;)V
    .locals 0

    invoke-direct {p0, p1}, Lud/d0;->E0(Ljava/util/List;)V

    return-void
.end method

.method public static synthetic c(ZLud/d$a;Lud/d$a;)Lud/d$a;
    .locals 0

    invoke-static {p0, p1, p2}, Lud/d0;->D0(ZLud/d$a;Lud/d$a;)Lud/d$a;
...
.method public static synthetic d(Lud/d0;)Lud/k$a;
    .locals 0

    iget-object p0, p0, Lud/d0;->D:Lud/k$a;
...
.method public static synthetic e(Lud/d0;)Ljava/lang/ref/WeakReference;
    ...
    iget-object p0, p0, Lud/d0;->n:Ljava/lang/ref/WeakReference;
...
.method public static synthetic f(Lud/d0;)V
    ...
    invoke-virtual {p0}, Lud/d0;->d1()V

    return-void
.end method

.method public static synthetic g(Lud/d0;ILud/w;Lud/d;)V
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, Lud/d0;->R(ILud/w;Lud/d;)V

    return-void
.end method

.method public static synthetic h(Lud/d0;Lud/d;)V
    .locals 0

    invoke-virtual {p0, p1}, Lud/d0;->K0(Lud/d;)V

    return-void
.end method

.method public static synthetic i(Lud/d0;)Lud/e;
    .locals 0

    iget-object p0, p0, Lud/d0;->B:Lud/e;

    return-object p0
.end method

.method public static synthetic j(Lud/d0;)V
    .locals 0

    invoke-virtual {p0}, Lud/d0;->b1()V

    return-void
.end method

.method public static synthetic k(Lud/d0;Lud/d$a;Lud/e;)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lud/d0;->N0(Lud/d$a;Lud/e;)V

    return-void
.end method

.method public static synthetic l(Lud/d0;J)Lud/w;
    .locals 0

    invoke-virtual {p0, p1, p2}, Lud/d0;->P0(J)Lud/w;
...
.method public static synthetic m(Lud/d0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    .locals 0

    iget-object p0, p0, Lud/d0;->E:Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;

    return-object p0
.end method

.method public static synthetic n(Lud/d0;Lud/w;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    .locals 0

    invoke-virtual/range {p0 .. p5}, Lud/d0;->h0(Lud/w;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
...
.method public static synthetic o(Lud/d0;)Lr7/d$a;
    .locals 0

    iget-object p0, p0, Lud/d0;->r:Lr7/d$a;

    return-object p0
.end method

.method public static synthetic p(Lud/d0;)Lud/d0$j;
    .locals 0

    iget-object p0, p0, Lud/d0;->h:Lud/d0$j;

    return-object p0
.end method

.method public static synthetic q(Lud/d0;)Lr7/h;
    .locals 0

    iget-object p0, p0, Lud/d0;->i:Lr7/h;

    return-object p0
.end method

.method public static synthetic r(Lud/d0;)Ljava/util/Map;
    .locals 0

    iget-object p0, p0, Lud/d0;->u:Ljava/util/Map;

    return-object p0
.end method

.method public static synthetic s(Lud/d0;)Ljava/util/Map;
    .locals 0

    iget-object p0, p0, Lud/d0;->t:Ljava/util/Map;

    return-object p0
.end method

.method public static synthetic t(Lud/d0;Ljava/util/Map;)Ljava/util/Map;
    .locals 0

    iput-object p1, p0, Lud/d0;->t:Ljava/util/Map;

    return-object p1
.end method

.method public static synthetic u(Lud/d0;)Ljava/util/Map;
    .locals 0

    iget-object p0, p0, Lud/d0;->s:Ljava/util/Map;

    return-object p0
.end method

.method public static synthetic v(Lud/d0;Ljava/util/Map;)Ljava/util/Map;
    .locals 0

    iput-object p1, p0, Lud/d0;->s:Ljava/util/Map;

    return-object p1
.end method

.method public static synthetic w(Lud/d0;JLandroid/media/Image;)V
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, Lud/d0;->e0(JLandroid/media/Image;)V

    return-void
.end method

.method public static synthetic x(Lud/d0;Landroid/media/Image;)V
    .locals 0

    invoke-virtual {p0, p1}, Lud/d0;->V(Landroid/media/Image;)V

    return-void
.end method

.method public static synthetic y(Lud/d0;Lud/w;)Z
    .locals 0

    invoke-virtual {p0, p1}, Lud/d0;->x0(Lud/w;)Z
...
.method public static synthetic z(Lud/d0;)I
    .locals 0

    iget p0, p0, Lud/d0;->y:I
...
.method public A0()Z
    ...
    iget-object v0, p0, Lud/d0;->j:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget p0, p0, Lud/d0;->x:I
...
.method public final F0(Lud/w;I)Z
    .locals 1
...
.method public G0()Z
    ...
    iget-object v0, p0, Lud/d0;->b:Lud/k;

    invoke-virtual {p0, v0}, Lud/d0;->l0(Lud/k;)I
    ...
    invoke-virtual {p0, v0}, Lud/k;->t(I)Z
...
.method public I0()V
    ...
    iget-object v1, p0, Lud/d0;->j:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v3, p0, Lud/d0;->b:Lud/k;

    iget-object v4, p0, Lud/d0;->c:Ljava/util/HashMap;
    ...
    invoke-virtual {v5}, Lud/k;->u()Ljava/util/List;
    ...
    invoke-virtual {v3}, Lud/k;->u()Ljava/util/List;
    ...
    :cond_2
    iget-object v3, p0, Lud/d0;->c:Ljava/util/HashMap;
    ...
    invoke-virtual {p0, v0}, Lud/d0;->b0(Ljava/util/List;)V
...
.method public J0(J)Z
    ...
    :try_start_0
    iget-object v1, p0, Lud/d0;->b:Lud/k;

    const/4 v2, 0x1

    if-eqz v1, :cond_0

    invoke-virtual {v1, p1, p2}, Lud/k;->v(J)Z
    ...
    :cond_0
    iget-object p0, p0, Lud/d0;->c:Ljava/util/HashMap;
    ...
    invoke-virtual {v3, p1, p2}, Lud/k;->v(J)Z
...
.method public final K0(Lud/d;)V
    .locals 17
    .param p1    # Lud/d;
    ...
    invoke-virtual/range {p1 .. p1}, Lud/d;->f()Ljava/util/List;
    ...
    check-cast v4, Lud/d$a;

    invoke-virtual {v4}, Lud/d$a;->e()Landroid/media/Image;
    ...
    invoke-virtual {v1, v4, v5}, Lud/d0;->o0(J)Lud/w;
    ...
    check-cast v8, Lud/d$a;

    invoke-virtual {v8}, Lud/d$a;->e()Landroid/media/Image;

    move-result-object v10

    invoke-virtual {v9, v10}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v8}, Lud/d$a;->m()Landroid/media/Image;
    ...
    invoke-virtual {v8}, Lud/d$a;->p()Z

    move-result v10

    if-eqz v10, :cond_2

    invoke-virtual {v8}, Lud/d$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v0

    invoke-virtual {v7, v0}, Lud/w;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-virtual {v7}, Lud/w;->q()Lud/x;
    ...
    iget-object v10, v1, Lud/d0;->E:Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    invoke-virtual {v7}, Lud/w;->L()I

    move-result v0

    invoke-virtual {v7}, Lud/w;->K()I

    move-result v2

    invoke-virtual {v4, v0, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setRawInputSize(II)V

    iget-object v0, v1, Lud/d0;->C:Lcom/xiaomi/camera/imagecodec/ReprocessData$DataStatusCallback;
    ...
    :try_start_0
    invoke-static {}, Lcom/android/camera/y3;->k()Lcom/xiaomi/camera/imagecodec/Reprocessor;
    ...
    iget-object v1, v1, Lud/d0;->E:Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
...
.method public final L0(JLud/w;)V
    .locals 4

    iget-object v0, p0, Lud/d0;->l:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lud/d0;->k:Ljava/util/HashMap;
...
.method public final M0(Lud/w;Landroid/media/Image;Ljava/lang/String;IZ)V
    .locals 18
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isMTKPlatform"
    ...
    invoke-static {v1, v0, v15}, Lrd/d;->j(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v1

    iget-object v2, v7, Lud/d0;->B:Lud/e;

    invoke-interface {v2, v0}, Lud/e;->a(Landroid/media/Image;)V
    ...
    invoke-virtual/range {p1 .. p1}, Lud/w;->e()I
    ...
    invoke-virtual/range {p1 .. p1}, Lud/w;->i()I
    ...
    invoke-virtual/range {v0 .. v6}, Lud/d0;->P(Lud/w;Landroid/media/Image;Ljava/lang/String;IZZ)V
    ...
    invoke-virtual/range {p1 .. p1}, Lud/w;->j()Ljava/lang/String;

    move-result-object v2

    const/16 v16, 0x0

    invoke-virtual/range {p1 .. p1}, Lud/w;->A()Lud/k;
    ...
    invoke-direct/range {v9 .. v17}, Lud/d;-><init>(IIIJLjava/lang/String;ZLud/k;)V

    invoke-virtual/range {p1 .. p1}, Lud/w;->f()I

    move-result v2

    invoke-virtual {v0, v2}, Lud/d;->C(I)V

    iget-object v2, v7, Lud/d0;->A:Lud/r$e;

    invoke-virtual {v0, v2}, Lud/d;->F(Lud/r$e;)V

    invoke-static {}, Lud/r;->w()Lud/r;

    move-result-object v2

    invoke-virtual {v2, v0}, Lud/r;->G(Lud/d;)V

    invoke-virtual/range {p0 .. p1}, Lud/d0;->X(Lud/w;)V

    invoke-virtual/range {p1 .. p1}, Lud/w;->k()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v3, Ll9/ek;->e2:Ll9/ds;

    invoke-static {v1}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v9

    invoke-static {v2, v3, v9}, Ll9/es;->r(Landroid/hardware/camera2/impl/CameraMetadataNative;Ll9/ds;Ljava/lang/Object;)V
    ...
    invoke-static {v2, v3, v9}, Ll9/es;->q(Landroid/hardware/camera2/impl/CameraMetadataNative;Landroid/hardware/camera2/CaptureResult$Key;Ljava/lang/Object;)V

    invoke-static {}, Lud/r;->w()Lud/r;

    move-result-object v2

    invoke-virtual {v2, v0, v1}, Lud/r;->B(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V

    iget-object v0, v7, Lud/d0;->u:Ljava/util/Map;
    ...
    check-cast v0, Lud/d0$k;

    invoke-static {}, Lud/r;->w()Lud/r;

    move-result-object v2

    iget-object v0, v0, Lud/d0$k;->a:Lcom/xiaomi/camera/imagecodec/ReprocessData;
    ...
    invoke-virtual {v2, v0, v8, v1, v1}, Lud/r;->A(Landroid/media/Image;IIZ)V
    ...
    invoke-direct {v0, v9, v8, v12}, Lud/i;-><init>(Landroid/media/Image;IZ)V

    invoke-virtual/range {p1 .. p1}, Lud/w;->A()Lud/k;

    move-result-object v1

    invoke-virtual {v1, v0}, Lud/k;->d(Lud/i;)V
    ...
    invoke-virtual {v7, v13, v14, v9}, Lud/d0;->e0(JLandroid/media/Image;)V
...
.method public final N0(Lud/d$a;Lud/e;)V
    .locals 3
    .param p1    # Lud/d$a;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {p1}, Lud/d$a;->e()Landroid/media/Image;

    move-result-object v0

    invoke-virtual {p1}, Lud/d$a;->s()Z

    move-result v1

    invoke-virtual {p0, v0, v1, p2}, Lud/d0;->O0(Landroid/media/Image;ZLud/e;)V

    invoke-virtual {p1}, Lud/d$a;->k()Landroid/media/Image;

    move-result-object v0

    invoke-virtual {p1}, Lud/d$a;->u()Z

    move-result v1

    invoke-virtual {p0, v0, v1, p2}, Lud/d0;->O0(Landroid/media/Image;ZLud/e;)V

    invoke-virtual {p1}, Lud/d$a;->m()Landroid/media/Image;

    move-result-object v0

    invoke-virtual {p1}, Lud/d$a;->v()Z

    move-result v1

    invoke-virtual {p0, v0, v1, p2}, Lud/d0;->O0(Landroid/media/Image;ZLud/e;)V

    invoke-virtual {p1}, Lud/d$a;->f()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lud/y;->b()Landroid/media/Image;

    move-result-object v1

    invoke-virtual {v0}, Lud/y;->d()Z

    move-result v0

    invoke-virtual {p0, v1, v0, p2}, Lud/d0;->O0(Landroid/media/Image;ZLud/e;)V
...
.method public final O0(Landroid/media/Image;ZLud/e;)V
    .locals 0
    ...
    invoke-interface {p3, p1}, Lud/e;->a(Landroid/media/Image;)V
...
.method public final P(Lud/w;Landroid/media/Image;Ljava/lang/String;IZZ)V
    .locals 13
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isMTKPlatform"
    ...
    iget-object v1, v6, Lud/d0;->u:Ljava/util/Map;
    ...
    iput-object v1, v6, Lud/d0;->u:Ljava/util/Map;
    ...
    new-instance v12, Lud/d0$k;

    const/4 v1, 0x0

    invoke-direct {v12, v1}, Lud/d0$k;-><init>(Lud/d0$a;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lud/d0;->h0(Lud/w;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;

    move-result-object v0

    iput-boolean v11, v12, Lud/d0$k;->b:Z
    ...
    :cond_2
    invoke-virtual {p1, p2}, Lud/w;->x1(Landroid/media/Image;)V

    iput-boolean v11, v12, Lud/d0$k;->c:Z

    :goto_0
    iput-object v0, v12, Lud/d0$k;->a:Lcom/xiaomi/camera/imagecodec/ReprocessData;

    iget-object v0, v6, Lud/d0;->u:Ljava/util/Map;
    ...
    iput-boolean v11, v1, Lud/d0$k;->c:Z

    :goto_1
    iget-boolean v0, v1, Lud/d0$k;->b:Z

    if-eqz v0, :cond_8

    iget-boolean v0, v1, Lud/d0$k;->c:Z
    ...
    invoke-virtual {p1, v0}, Lud/w;->B0(I)V
...
.method public final P0(J)Lud/w;
    .locals 2
    ...
    invoke-interface {p0}, Lud/d0$j;->e()V
...
.method public Q()Z
    ...
    :cond_0
    iget-object v1, p0, Lud/d0;->e:Landroid/util/SparseArray;
...
.method public Q0()V
    ...
    iget-object v2, p0, Lud/d0;->k:Ljava/util/HashMap;
    ...
    iget-boolean v4, v3, Lud/w;->w:Z

    if-eqz v4, :cond_0

    invoke-virtual {v3}, Lud/w;->i0()Z
    ...
    new-instance v5, Lud/f0;

    invoke-virtual {v3}, Lud/w;->P()J

    move-result-wide v7

    iget-object v9, p0, Lud/d0;->A:Lud/r$e;

    invoke-direct {v5, v7, v8, v9, v6}, Lud/f0;-><init>(JLud/r$e;Z)V

    invoke-virtual {v4, v5}, Lud/r;->F(Lud/f0;)V
    ...
    invoke-virtual {p0, v2, v3}, Lud/d0;->P0(J)Lud/w;
...
.method public final R(ILud/w;Lud/d;)V
    .locals 10
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
    ...
    invoke-virtual {p2, v3}, Lud/w;->T0(Z)V
    ...
    invoke-virtual {p0, p3}, Lud/d0;->r0(Lud/d;)Z
    ...
    invoke-virtual {v6}, Lud/d$a;->m()Landroid/media/Image;

    move-result-object v7

    invoke-virtual {v6}, Lud/d$a;->v()Z

    move-result v8

    invoke-static {p1}, Lrd/c;->d(I)Z
    ...
    invoke-virtual {p2, v7}, Lud/w;->x1(Landroid/media/Image;)V
    ...
    invoke-static {v6, v7, v2}, Lrd/d;->j(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v6

    invoke-virtual {p2, v6}, Lud/w;->x1(Landroid/media/Image;)V

    goto :goto_7

    :cond_7
    :goto_5
    invoke-virtual {v6}, Lud/d$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {p0, p3, v6}, Lud/d0;->v0(ZLandroid/hardware/camera2/CaptureRequest;)Z
    ...
    invoke-static {v5, v7, v2}, Lrd/d;->j(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v5

    invoke-virtual {p2, v5}, Lud/w;->x1(Landroid/media/Image;)V
    ...
    iget-object v6, p0, Lud/d0;->B:Lud/e;

    invoke-interface {v6, v7}, Lud/e;->a(Landroid/media/Image;)V
...
.method public final S(Lud/d;I)Lcom/xiaomi/protocol/ICustomCaptureResult;
    .locals 5
    ...
    invoke-virtual {p2}, Lud/d$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v3, Ll9/cs;->n2:Ll9/ds;

    invoke-static {v2, v3}, Ll9/es;->l(Landroid/hardware/camera2/CaptureResult;Ll9/ds;)Ljava/lang/Object;
    ...
    new-instance v2, Lud/a0;

    invoke-direct {v2}, Lud/a0;-><init>()V
    ...
    invoke-direct {v2, v0}, Lud/b0;-><init>(Z)V
...
.method public S0(Lr7/h;)V
    ...
    iput-object p1, p0, Lud/d0;->i:Lr7/h;
...
.method public U0(Lcom/xiaomi/protocol/ISessionStatusCallBackListener;)V
    ...
    iput-object v0, p0, Lud/d0;->n:Ljava/lang/ref/WeakReference;
...
.method public W(Lcom/xiaomi/engine/BufferFormat;)V
    ...
    :try_start_0
    iget-object v1, p0, Lud/d0;->c:Ljava/util/HashMap;
    ...
    invoke-virtual {v1}, Lud/k;->r()Z

    move-result v3

    if-nez v3, :cond_2

    invoke-virtual {v1}, Lud/k;->J()Z

    move-result v3

    if-eqz v3, :cond_2

    iget-object p1, p0, Lud/d0;->b:Lud/k;

    if-eq p1, v1, :cond_1

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lud/k;->I()V

    :cond_0
    iput-object v1, p0, Lud/d0;->b:Lud/k;
    ...
    invoke-virtual {p0, v1}, Lud/d0;->d0(Ljava/util/List;)V
    ...
    iget-object v3, p0, Lud/d0;->D:Lud/k$a;

    invoke-direct {v1, v3, p1}, Lud/f;-><init>(Lud/k$a;Lcom/xiaomi/engine/BufferFormat;)V

    goto :goto_0

    :cond_5
    new-instance v1, Lud/g0;

    iget-object v3, p0, Lud/d0;->D:Lud/k$a;

    invoke-direct {v1, v3, p1}, Lud/g0;-><init>(Lud/k$a;Lcom/xiaomi/engine/BufferFormat;)V

    :goto_0
    iget v3, p0, Lud/d0;->a:I

    invoke-virtual {v1, v3}, Lud/k;->B(I)V

    iget v3, p0, Lud/d0;->a:I

    invoke-virtual {v1, v3}, Lud/k;->A(I)V

    invoke-virtual {v1}, Lud/k;->G()V

    invoke-virtual {v1, p1}, Lud/k;->b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/List;

    move-result-object v3

    iget-object v4, p0, Lud/d0;->z:Lcom/xiaomi/engine/TaskSession$SessionStatusCallback;
    ...
    invoke-virtual {v1, v3}, Lud/k;->E(Lcom/xiaomi/engine/TaskSession;)V
...
.method public W0(Lud/j;)V
    ...
    iput-object v0, p0, Lud/d0;->w:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public final X(Lud/w;)V
    .locals 6
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
    ...
    invoke-virtual {v1}, Lud/x;->s0()Landroid/util/Size;
    ...
    invoke-virtual {v2}, Lud/x;->s0()Landroid/util/Size;
    ...
    invoke-virtual {v1}, Lud/k;->l()Lud/j0;
    ...
    invoke-virtual {v1}, Lud/j0;->a()Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {v1, v0}, Lud/k;->c(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/List;

    move-result-object v1

    iget-object p0, p0, Lud/d0;->z:Lcom/xiaomi/engine/TaskSession$SessionStatusCallback;
    ...
    invoke-direct {v1, p0, v0}, Lud/j0;-><init>(Lcom/xiaomi/engine/TaskSession;Lcom/xiaomi/engine/BufferFormat;)V

    invoke-virtual {p1}, Lud/w;->A()Lud/k;

    move-result-object p0

    invoke-virtual {p0, v1}, Lud/k;->F(Lud/j0;)V
...
.method public Y(Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    iget-object v4, p0, Lud/d0;->d:Ljava/util/List;
    ...
    iget-object v4, p0, Lud/d0;->e:Landroid/util/SparseArray;
    ...
    invoke-virtual {p0, p1}, Lud/d0;->m0(Landroid/util/SparseArray;)I
    ...
    invoke-direct {v6, v7, v4}, Lud/d0$i;-><init>(II)V

    iget-object v4, p0, Lud/d0;->g:Landroid/os/Handler;
    ...
    iget-object p0, p0, Lud/d0;->e:Landroid/util/SparseArray;
...
.method public Z()Z
    ...
    iget-object v5, p0, Lud/d0;->e:Landroid/util/SparseArray;
...
.method public final Z0(I)V
    ...
    invoke-virtual {p0, v0, p1}, Lud/c;->h(II)Z
...
.method public final a0()V
    ...
    :goto_0
    iget-object v3, p0, Lud/d0;->e:Landroid/util/SparseArray;
    ...
    :cond_2
    iget-object v1, p0, Lud/d0;->d:Ljava/util/List;
    ...
    iput-object v1, p0, Lud/d0;->r:Lr7/d$a;
...
.method public final b0(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lud/d0;->g:Landroid/os/Handler;

    new-instance v1, Lud/c0;

    invoke-direct {v1, p0, p1}, Lud/c0;-><init>(Lud/d0;Ljava/util/List;)V
...
.method public final b1()V
    ...
    iget-object v0, p0, Lud/d0;->h:Lud/d0$j;

    if-eqz v0, :cond_4

    invoke-interface {v0, p0}, Lud/d0$j;->d(Lud/d0;)V

    :cond_4
    invoke-virtual {p0}, Lud/d0;->f0()V

    invoke-virtual {p0}, Lud/d0;->a0()V

    iget-object v0, p0, Lud/d0;->s:Ljava/util/Map;
    ...
    iput-object v1, p0, Lud/d0;->s:Ljava/util/Map;

    :cond_5
    iget-object v0, p0, Lud/d0;->t:Ljava/util/Map;

    if-eqz v0, :cond_6

    invoke-interface {v0}, Ljava/util/Map;->clear()V

    iput-object v1, p0, Lud/d0;->t:Ljava/util/Map;

    :cond_6
    iget-object v0, p0, Lud/d0;->u:Ljava/util/Map;

    if-eqz v0, :cond_7

    invoke-interface {v0}, Ljava/util/Map;->clear()V

    iput-object v1, p0, Lud/d0;->u:Ljava/util/Map;

    :cond_7
    invoke-virtual {p0}, Lud/d0;->a1()V
...
.method public final d0(Ljava/util/List;)V
    ...
    :goto_3
    iget-object v8, p0, Lud/d0;->e:Landroid/util/SparseArray;
...
.method public final d1()V
    ...
    invoke-virtual {p0, v7}, Lud/w;->d1(Z)V
...
.method public final e0(JLandroid/media/Image;)V
    ...
    iget-object v1, p0, Lud/d0;->u:Ljava/util/Map;
    ...
    iget-object v4, v1, Lud/d0$k;->a:Lcom/xiaomi/camera/imagecodec/ReprocessData;
    ...
    iget-object v1, v1, Lud/d0$k;->a:Lcom/xiaomi/camera/imagecodec/ReprocessData;
    ...
    :try_start_1
    iget-object v1, p0, Lud/d0;->E:Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
...
.method public final f0()V
    ...
    iget-object v3, p0, Lud/d0;->j:Ljava/lang/Object;
    ...
    iget-object v0, p0, Lud/d0;->c:Ljava/util/HashMap;
    ...
    invoke-virtual {v1}, Lud/k;->H()V

    goto :goto_0

    :cond_1
    iget-object v0, p0, Lud/d0;->f:Landroid/os/HandlerThread;
...
.method public final g0()V
    ...
    invoke-virtual {p0, v0}, Lud/d0;->d0(Ljava/util/List;)V
...
.method public final h0(Lud/w;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    .locals 14
    ...
    invoke-virtual {v2}, Lud/x;->O0()Z

    move-result v8

    invoke-virtual {v2}, Lud/x;->q0()Landroid/util/Size;
    ...
    invoke-virtual {v2}, Lud/x;->p0()I

    move-result v11

    iget-object v12, v0, Lud/d0;->E:Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    invoke-virtual {p1}, Lud/w;->L()I

    move-result v1

    invoke-virtual {p1}, Lud/w;->K()I

    move-result v2

    invoke-virtual {v13, v1, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setRawInputSize(II)V

    iget-object v0, v0, Lud/d0;->C:Lcom/xiaomi/camera/imagecodec/ReprocessData$DataStatusCallback;
    ...
    invoke-virtual {p1}, Lud/w;->w()Ljava/lang/String;
...
.method public j0()Lud/d0$h;
    .locals 0

    iget-object p0, p0, Lud/d0;->m:Lud/d0$h;
...
.method public final l0(Lud/k;)I
    .locals 4
    ...
    invoke-virtual {v2}, Lud/w;->A()Lud/k;

    move-result-object v3

    if-ne v3, p1, :cond_0

    iget-boolean v3, v2, Lud/w;->w:Z

    if-nez v3, :cond_1

    invoke-virtual {v2}, Lud/w;->l0()Z
...
.method public final o0(J)Lud/w;
    .locals 1
...
.method public p0()I
    ...
    iget-object v3, p0, Lud/d0;->k:Ljava/util/HashMap;
...
.method public final r0(Lud/d;)Z
    .locals 1
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "supportMtkIspHidl"
    ...
    invoke-virtual {p1}, Lud/d$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
...
.method public final s0()V
    ...
    new-instance v0, Lud/d0$g;

    invoke-direct {v0, p0}, Lud/d0$g;-><init>(Lud/d0;)V

    iput-object v0, p0, Lud/d0;->r:Lr7/d$a;
...
.method public t0()Z
    ...
    invoke-virtual {v2}, Lud/w;->e()I

    move-result v4

    invoke-virtual {p0, v4}, Lud/d0;->y0(I)Z

    move-result v4

    if-nez v4, :cond_0

    iget-boolean v4, v2, Lud/w;->w:Z
...
.method public final x0(Lud/w;)Z
    .locals 2
