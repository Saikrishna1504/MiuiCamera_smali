...
.method public constructor <init>(Lud/d0;)V
    ...
    iput-object p1, p0, Lud/d0$c;->a:Lud/d0;
...
.method public b(Lud/d;)V
    ...
    invoke-virtual {p0, p1, v0}, Lud/d0$c;->d(Lud/d;Ljava/lang/String;)V
...
.method public c(Lud/d;)V
    ...
    iget-object v5, p0, Lud/d0$c;->a:Lud/d0;

    invoke-virtual {v5}, Lud/d0;->z0()Z
    ...
    iget-object v6, p0, Lud/d0$c;->a:Lud/d0;

    invoke-static {v6, v7, v8}, Lud/d0;->N(Lud/d0;J)Lud/w;

    move-result-object v6

    invoke-virtual {v5}, Lud/d$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {v6, v9, v10}, Lud/w;->w1(J)V

    iget-object v11, p0, Lud/d0$c;->a:Lud/d0;

    invoke-static {v11, v7, v8}, Lud/d0;->l(Lud/d0;J)Lud/w;

    iget-object v11, p0, Lud/d0$c;->a:Lud/d0;

    invoke-static {v11, v9, v10, v6}, Lud/d0;->K(Lud/d0;JLud/w;)V

    :cond_1
    if-ne v1, v0, :cond_4

    iget-object v1, p0, Lud/d0$c;->a:Lud/d0;
    ...
    invoke-virtual {v0}, Lud/d$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v4, p0, Lud/d0$c;->a:Lud/d0;

    invoke-static {v4, v7, v8}, Lud/d0;->N(Lud/d0;J)Lud/w;

    move-result-object v4

    if-eqz v4, :cond_9

    invoke-virtual {v4, v1}, Lud/w;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V

    invoke-virtual {v4}, Lud/w;->q()Lud/x;

    move-result-object v1

    invoke-virtual {v1}, Lud/x;->Z0()Z
    ...
    invoke-virtual {v4}, Lud/w;->M()Lzj/c;
    ...
    invoke-direct/range {v0 .. v6}, Lud/h0;-><init>(Ljava/util/List;ZJZLzj/c;)V

    invoke-virtual {p1}, Lud/d;->c()I

    move-result v0

    invoke-virtual {p0, v0}, Lud/h0;->h(I)V
    ...
    iget-object v0, p1, Lud/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {p1, p0}, Lud/k;->e(Lud/h0;)I

    goto/16 :goto_1

    :cond_8
    iget-object p1, p0, Lud/d0$c;->a:Lud/d0;

    invoke-static {p1}, Lud/d0;->d(Lud/d0;)Lud/k$a;

    move-result-object p1

    invoke-interface {p1, v7, v8, v3}, Lud/k$a;->f(JI)V
    ...
    invoke-interface {p1, v0, v3, v3}, Lud/k$a;->d(Landroid/media/Image;IZ)V

    invoke-virtual {v0}, Landroid/media/Image;->close()V

    invoke-virtual {p0, v0}, Lud/d0$c;->a(Landroid/media/Image;)V
    ...
    :cond_a
    iget-object v0, p0, Lud/d0$c;->a:Lud/d0;

    invoke-static {v0, v7, v8}, Lud/d0;->N(Lud/d0;J)Lud/w;
    ...
    invoke-virtual {v5}, Lud/d$a;->e()Landroid/media/Image;

    move-result-object v1

    invoke-virtual {v0, v6}, Lud/w;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v5, v1, v4}, Lrd/d;->j(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v4

    new-instance v5, Lud/i;

    const/4 v6, 0x1

    invoke-direct {v5, v4, v3, v6}, Lud/i;-><init>(Landroid/media/Image;IZ)V

    invoke-virtual {v0, v5}, Lud/k;->d(Lud/i;)V
    ...
    :cond_b
    invoke-virtual {p0, v1}, Lud/d0$c;->a(Landroid/media/Image;)V

    goto :goto_1

    :cond_c
    invoke-virtual {p0, p1, v1}, Lud/d0$c;->d(Lud/d;Ljava/lang/String;)V
...
.method public final d(Lud/d;Ljava/lang/String;)V
    .locals 13
    .param p1    # Lud/d;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {v7}, Lud/d$a;->p()Z

    move-result v9

    if-eqz v9, :cond_2

    invoke-virtual {v7}, Lud/d$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v5, v9, v10}, Lud/d0;->N(Lud/d0;J)Lud/w;
    ...
    iget-object v7, p0, Lud/d0$c;->a:Lud/d0;

    invoke-virtual {p1}, Lud/d;->b()I

    move-result v9

    invoke-static {v7, p1, v9}, Lud/d0;->O(Lud/d0;Lud/d;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v7

    invoke-virtual {v5, v7}, Lud/w;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v7, v10, v11}, Lud/d0;->N(Lud/d0;J)Lud/w;
    ...
    iget-object v8, p0, Lud/d0$c;->a:Lud/d0;

    invoke-virtual {p1}, Lud/d;->b()I

    move-result v9

    invoke-static {v8, p1, v9}, Lud/d0;->O(Lud/d0;Lud/d;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v8

    invoke-virtual {v7, v8}, Lud/w;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v0, p2, p0}, Lud/d0;->k(Lud/d0;Lud/d$a;Lud/e;)V
    ...
    invoke-virtual {v0}, Lud/h0;->a()Z

    move-result v5

    if-eqz v5, :cond_9

    iget-object v5, v4, Lud/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v5}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    :cond_9
    iget-object p0, p0, Lud/d0$c;->a:Lud/d0;
    ...
    invoke-virtual {v0, v2}, Lud/h0;->i(I)V

    :cond_b
    if-eqz v4, :cond_c

    invoke-virtual {v4, v0}, Lud/k;->e(Lud/h0;)I
