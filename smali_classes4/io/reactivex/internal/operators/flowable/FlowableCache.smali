...
.method public replay(Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;)V
    ...
    iget-object v7, v1, Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;->downstream:Lpu/c;
    ...
    invoke-interface {v7, v0}, Lpu/c;->onError(Ljava/lang/Throwable;)V

    goto :goto_2

    :cond_3
    invoke-interface {v7}, Lpu/c;->onComplete()V
    ...
    invoke-interface {v7, v11}, Lpu/c;->onNext(Ljava/lang/Object;)V
...
.method public subscribeActual(Lpu/c;)V
    ...
    invoke-direct {v0, p1, p0}, Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;-><init>(Lpu/c;Lio/reactivex/internal/operators/flowable/FlowableCache;)V
