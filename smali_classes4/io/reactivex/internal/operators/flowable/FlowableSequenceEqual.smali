...
.method public constructor <init>(Lqo/b;Lqo/b;Lio/reactivex/functions/BiPredicate;I)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->first:Lqo/b;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->second:Lqo/b;
...
.method public subscribeActual(Lqo/c;)V
    ...
    invoke-direct {v0, p1, v1, v2}, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual$EqualCoordinator;-><init>(Lqo/c;ILio/reactivex/functions/BiPredicate;)V

    invoke-interface {p1, v0}, Lqo/c;->onSubscribe(Lqo/d;)V

    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->first:Lqo/b;

    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->second:Lqo/b;

    invoke-virtual {v0, p1, p0}, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual$EqualCoordinator;->subscribe(Lqo/b;Lqo/b;)V
