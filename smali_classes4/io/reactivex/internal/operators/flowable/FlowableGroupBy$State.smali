...
.method public checkTerminated(ZZLpu/c;ZJ)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    invoke-interface {p0, p5, p6}, Lpu/d;->request(J)V
...
.method public drainNormal()V
    ...
    invoke-virtual/range {v0 .. v6}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$State;->checkTerminated(ZZLpu/c;ZJ)Z
    ...
    iget-object v0, v0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Lpu/d;

    invoke-interface {v0, v5, v6}, Lpu/d;->request(J)V
...
.method public subscribe(Lpu/c;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
