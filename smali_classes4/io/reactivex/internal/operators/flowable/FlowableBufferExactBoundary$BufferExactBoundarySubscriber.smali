...
# direct methods
.method public constructor <init>(Lpu/c;Ljava/util/concurrent/Callable;Lpu/b;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferExactBoundary$BufferExactBoundarySubscriber;->boundary:Lpu/b;
...
.method public bridge synthetic accept(Lpu/c;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lio/reactivex/internal/operators/flowable/FlowableBufferExactBoundary$BufferExactBoundarySubscriber;->accept(Lpu/c;Ljava/util/Collection;)Z
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferExactBoundary$BufferExactBoundarySubscriber;->upstream:Lpu/d;
...
.method public onSubscribe(Lpu/d;)V
    ...
    :cond_0
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferExactBoundary$BufferExactBoundarySubscriber;->upstream:Lpu/d;
    ...
    invoke-interface {v1, p0}, Lpu/c;->onSubscribe(Lpu/d;)V
    ...
    invoke-interface {p1, v1, v2}, Lpu/d;->request(J)V

    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferExactBoundary$BufferExactBoundarySubscriber;->boundary:Lpu/b;

    invoke-interface {p0, v0}, Lpu/b;->subscribe(Lpu/c;)V
    ...
    invoke-static {v0, p0}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lpu/c;)V
