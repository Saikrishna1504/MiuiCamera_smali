...
# direct methods
.method public constructor <init>([Lpu/c;I)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->subscribers:[Lpu/c;
...
.method public cancel(I)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->upstream:Lpu/d;
...
.method public drainAsync()V
    ...
    iget-object v2, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->subscribers:[Lpu/c;
    ...
    invoke-interface {v1, v13}, Lpu/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v12, v11}, Lpu/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v11, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->upstream:Lpu/d;

    int-to-long v12, v7

    invoke-interface {v11, v12, v13}, Lpu/d;->request(J)V
    ...
    iget-object v0, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->upstream:Lpu/d;
    ...
    invoke-interface {v1, v3}, Lpu/c;->onError(Ljava/lang/Throwable;)V
...
.method public drainSync()V
    ...
    invoke-interface {v11, v10}, Lpu/c;->onNext(Ljava/lang/Object;)V
...
.method public onSubscribe(Lpu/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->upstream:Lpu/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->upstream:Lpu/d;
...
.method public setupSubscribers()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->subscribers:[Lpu/c;
    ...
    invoke-interface {v3, v5}, Lpu/c;->onSubscribe(Lpu/d;)V
