...
.method public static final b(Lgc/f$a;)Lso/u;
    .locals 7
    ...
    new-instance v3, Lso/u$b;

    invoke-direct {v3}, Lso/u$b;-><init>()V
    ...
    :goto_6
    invoke-virtual {v3, v2}, Lso/u$b;->g(Ljava/util/concurrent/Executor;)Lso/u$b;

    move-result-object v2

    invoke-virtual {v2, v1}, Lso/u$b;->a(Lso/c$a;)Lso/u$b;

    move-result-object v1

    invoke-virtual {p0}, Lgc/f$a;->g()Lso/f$a;
    ...
    :cond_b
    invoke-virtual {v1, v2}, Lso/u$b;->b(Lso/f$a;)Lso/u$b;
    ...
    invoke-virtual {v1, p0}, Lso/u$b;->c(Ljava/lang/String;)Lso/u$b;
    ...
    invoke-virtual {p0, v0}, Lso/u$b;->h(Lokhttp3/OkHttpClient;)Lso/u$b;

    move-result-object p0

    invoke-virtual {p0}, Lso/u$b;->e()Lso/u;
