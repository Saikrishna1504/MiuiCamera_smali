...
# instance fields
.field public V:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;
...
# direct methods
.method public constructor <init>(Lgl/f$c;)V
    .locals 7
    ...
    iput-object v0, p0, Lgl/f;->a:Ljava/lang/String;

    new-instance v1, Ljava/util/Stack;

    invoke-direct {v1}, Ljava/util/Stack;-><init>()V

    iput-object v1, p0, Lgl/f;->d:Ljava/util/Stack;

    new-instance v2, Lr2/e;

    invoke-direct {v2}, Lr2/e;-><init>()V

    iput-object v2, p0, Lgl/f;->e:Lr2/e;

    const/4 v2, 0x0

    iput v2, p0, Lgl/f;->w:I

    new-instance v3, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {v3}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object v3, p0, Lgl/f;->x:Ljava/util/concurrent/locks/ReentrantLock;

    const v3, 0xac44

    iput v3, p0, Lgl/f;->W:I

    const/4 v3, 0x2

    iput v3, p0, Lgl/f;->Y:I

    const v4, 0x17700

    iput v4, p0, Lgl/f;->Z:I

    new-instance v4, Lgl/f$b;

    invoke-direct {v4, p0}, Lgl/f$b;-><init>(Lgl/f;)V

    iput-object v4, p0, Lgl/f;->i0:Lgl/f$b;
    ...
    iget-object v5, p1, Lgl/f$c;->a:Ljava/lang/ref/WeakReference;

    iput-object v5, p0, Lgl/f;->f:Ljava/lang/ref/WeakReference;

    iget v6, p1, Lgl/f$c;->b:I

    iput v6, p0, Lgl/f;->i:I

    iget-object v6, p1, Lgl/f$c;->c:Lcom/xiaomi/microfilm/milive/a$c;

    iput-object v6, p0, Lgl/f;->p:Lcom/xiaomi/microfilm/milive/a$c;

    iget-object v6, p1, Lgl/f$c;->d:Lcom/xiaomi/microfilm/milive/a$d;

    iput-object v6, p0, Lgl/f;->q:Lcom/xiaomi/microfilm/milive/a$d;

    iget-object v6, p1, Lgl/f$c;->f:Landroid/os/Handler;

    iput-object v6, p0, Lgl/f;->r:Landroid/os/Handler;

    iget-object p1, p1, Lgl/f$c;->e:Ljava/util/List;
    ...
    iput-object v0, p0, Lgl/f;->b:Lg9/f;
    ...
    iput-object p1, p0, Lgl/f;->c:Lcom/xiaomi/milive/data/LiveMasterProcessing;
...
.method public final c(II)V
    ...
    iput v0, p0, Lgl/f;->g:I

    invoke-static {p1, p2}, Ljava/lang/Math;->max(II)I

    move-result p1

    iput p1, p0, Lgl/f;->h:I
...
.method public final d()V
    ...
    iget-object v1, v0, Ldp/a;->d:Lcom/xiaomi/milab/videosdk/XmsTimeline;
    ...
    :cond_0
    iget-object v2, p0, Lgl/f;->f:Ljava/lang/ref/WeakReference;
    ...
    iget-object v3, p0, Lgl/f;->c0:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;
    ...
    iget-object v4, p0, Lgl/f;->a:Ljava/lang/String;

    const-string v5, "initXms "

    invoke-static {v4, v5, v3}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v0, v0, Ldp/a;->c:Ljava/util/HashMap;
    ...
    iget-object v2, p0, Lgl/f;->i0:Lgl/f$b;
    ...
    iput-object v0, p0, Lgl/f;->c0:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;

    invoke-virtual {v1}, Lcom/xiaomi/milab/videosdk/XmsTimeline;->appendAudioTrack()Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    move-result-object v0

    iput-object v0, p0, Lgl/f;->V:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    invoke-virtual {v1}, Lcom/xiaomi/milab/videosdk/XmsTimeline;->appendVideoTrack()Lcom/xiaomi/milab/videosdk/XmsVideoTrack;

    move-result-object v0

    iput-object v0, p0, Lgl/f;->f0:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;

    iget-object v0, p0, Lgl/f;->V:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    iget-object v2, p0, Lgl/f;->l:Ljava/lang/String;

    iget v3, p0, Lgl/f;->i:I
...
.method public final f(Lcom/xiaomi/milive/data/EffectItem;)V
    ...
    invoke-direct {v3, v2, p0, v0, p1}, Le7/d2;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-virtual {v1, v3}, Lg9/f;->u(Ljava/lang/Runnable;)V
...
.method public final g(Lcom/xiaomi/milive/data/LiveWorkspaceItem;)V
    ...
    iget-object v0, p0, Lgl/f;->d:Ljava/util/Stack;
    ...
    invoke-virtual {p0, p1}, Lgl/f;->j(I)V
...
.method public final h(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lgl/f;->a:Ljava/lang/String;

    invoke-static {v2, v0, v1}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iput-object p1, p0, Lgl/f;->l:Ljava/lang/String;
...
.method public final i(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lgl/f;->m:Ljava/lang/String;
...
.method public final j(I)V
    ...
    iget v0, p0, Lgl/f;->w:I

    if-eq p1, v0, :cond_0

    iget-object v0, p0, Lgl/f;->a:Ljava/lang/String;
    ...
    iget v2, p0, Lgl/f;->w:I

    invoke-virtual {p0, v2}, Lgl/f;->b(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lgl/f;->b(I)Ljava/lang/String;
    ...
    iput p1, p0, Lgl/f;->w:I

    iget-object p1, p0, Lgl/f;->p:Lcom/xiaomi/microfilm/milive/a$c;

    if-eqz p1, :cond_0

    iget p0, p0, Lgl/f;->w:I

    invoke-interface {p1, p0}, Lcom/xiaomi/microfilm/milive/a$c;->r2(I)V
...
.method public final m(Lcom/xiaomi/microfilm/milive/a$d;)V
    ...
    iget-object v2, p0, Lgl/f;->g0:Lcom/xiaomi/milive/data/LiveWorkspaceItem;
    ...
    invoke-direct/range {v1 .. v7}, Lgl/f$a;-><init>(Lgl/f;JJLcom/xiaomi/microfilm/milive/a$d;)V

    iput-object v0, p0, Lgl/f;->t:Lgl/f$a;
...
.method public final n()V
    ...
    iput-boolean v0, p0, Lgl/f;->d0:Z

    :cond_0
    iget-object p0, p0, Lgl/f;->c0:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;
...
.method public final o()V
    ...
    :cond_0
    iget-object v0, p0, Lgl/f;->c:Lcom/xiaomi/milive/data/LiveMasterProcessing;

    invoke-virtual {v0}, Lcom/xiaomi/milive/data/LiveMasterProcessing;->getCurrentWorkspaceItem()Lcom/xiaomi/milive/data/LiveWorkspaceItem;

    move-result-object v0

    iput-object v0, p0, Lgl/f;->g0:Lcom/xiaomi/milive/data/LiveWorkspaceItem;

    iget-object v0, p0, Lgl/f;->l:Ljava/lang/String;

    invoke-static {v0}, Landroid/text/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z

    move-result v0

    iget v2, p0, Lgl/f;->i:I

    if-nez v0, :cond_1

    iget-object v0, p0, Lgl/f;->g0:Lcom/xiaomi/milive/data/LiveWorkspaceItem;
    ...
    iget-object v5, p0, Lgl/f;->l:Ljava/lang/String;
    ...
    iget-object p0, p0, Lgl/f;->l:Ljava/lang/String;
