...
.method public final subscribeActual(Lio/reactivex/SingleObserver;)V
    ...
    :cond_1
    iget-object v0, p0, Lzj/a;->a:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v0

    sput-object v0, Lbq/t;->e:Landroid/content/Context;

    invoke-static {}, Lbq/t;->m()Landroid/content/Context;

    move-result-object v0

    invoke-static {v1}, La0/w3;->b(I)Ljava/lang/String;

    invoke-static {v1}, La0/w3;->d(I)Z
    ...
    invoke-direct {v0, p1}, Lzj/a$a;-><init>(Lio/reactivex/SingleObserver;)V

    iget-boolean v3, p0, Lzj/a;->b:Z

    sget-boolean v4, Loc/i;->a:Z

    sput-boolean v3, Ltc/h;->a:Z

    sput-object v0, Loc/i;->g:Loc/k;

    invoke-interface {p1, v0}, Lio/reactivex/SingleObserver;->onSubscribe(Lio/reactivex/disposables/Disposable;)V

    iget-object p0, p0, Lzj/a;->a:Landroid/content/Context;

    const-class p1, Loc/i;

    monitor-enter p1

    :try_start_0
    sget-boolean v0, Loc/i;->b:Z
    :try_end_0
    ...
    sput-boolean v2, Loc/i;->h:Z

    sget-boolean p0, Loc/i;->a:Z

    if-nez p0, :cond_5

    const/4 p0, 0x0

    sput-object p0, Loc/i;->e:Loc/c;

    sput-object p0, Loc/i;->f:Loc/i$d;

    invoke-static {}, Ltc/c;->a()V

    sput-boolean v1, Loc/i;->a:Z
    ...
    invoke-static {p0}, Loc/i;->a(Ljava/lang/String;)V
    :try_end_1
