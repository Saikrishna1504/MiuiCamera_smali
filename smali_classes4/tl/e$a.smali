...
.method public constructor <init>(Ltl/e;)V
    ...
    iput-object p1, p0, Ltl/e$a;->b:Ltl/e;

    invoke-direct {p0}, Ltl/e$d;-><init>()V
...
.method public final OnConvertProgress(I)V
    ...
    iget-object v0, p0, Ltl/e$a;->b:Ltl/e;

    if-eqz p1, :cond_0

    iget-object p0, p0, Ltl/e$d;->a:Lt8/c;

    invoke-interface {p1, p0}, Ly7/y1;->P8(Lt8/c;)V

    goto :goto_0

    :cond_0
    invoke-virtual {v0, v2}, Ltl/e;->k(Z)V
