...
# direct methods
.method public constructor <init>(Lyo/u;)V
    .locals 0

    iput-object p1, p0, Lyo/u$b;->c:Lyo/u;
...
.method public final onImageAvailable(Landroid/media/ImageReader;)V
    ...
    iget-object v2, v0, Lyo/u$b;->c:Lyo/u;

    iget-object v2, v2, Lyo/r;->c:Lno/e;

    iget-boolean v2, v2, Lno/e;->b:Z
    ...
    iget-object v5, v0, Lyo/u$b;->c:Lyo/u;

    iget-object v5, v5, Lyo/u;->j:Lpo/c;
    ...
    iget-object v2, v2, Lyo/u;->e:Lno/h;
    ...
    iget-object v4, v0, Lyo/u$b;->c:Lyo/u;

    iget-object v15, v4, Lyo/u;->j:Lpo/c;

    check-cast v2, Lg9/i;

    iget-object v2, v2, Lg9/i;->a:Lg9/f;

    invoke-virtual {v2}, Lg9/f;->f()Lcom/android/camera/ui/w0;
    ...
    invoke-interface {v4}, Lcom/android/camera/ui/w0;->l()Lcom/android/camera/module/j0;
    ...
    :cond_7
    sget-object v5, Lpo/c;->e:Lpo/c;

    if-eq v15, v5, :cond_9

    sget-object v5, Lpo/c;->f:Lpo/c;
    ...
    :cond_8
    invoke-interface {v4}, Lcom/android/camera/module/j0;->getSurfaceTextureMgr()Lw6/i;

    move-result-object v11

    iget-boolean v2, v2, Lg9/f;->f:Z
    ...
    invoke-interface/range {v11 .. v16}, Lw6/i;->onPreviewPixelsRead([BIILpo/c;Z)V

    goto :goto_7

    :cond_9
    :goto_5
    iget-object v2, v2, Lg9/f;->e:Lg9/c;
    ...
    check-cast v4, Lcom/android/camera/module/n0;
    ...
    invoke-static {v2, v7, v8, v5}, Lck/b;->b(Ljava/nio/ByteBuffer;IILandroid/graphics/ColorSpace;)Landroid/graphics/Bitmap;

    move-result-object v6

    iget-object v2, v4, Lcom/android/camera/module/n0;->b:Lea/a;

    invoke-virtual {v2}, Lea/a;->J()Landroid/hardware/camera2/CaptureResult;

    move-result-object v5

    invoke-virtual/range {v4 .. v9}, Lcom/android/camera/module/n0;->a(Landroid/hardware/camera2/CaptureResult;Landroid/graphics/Bitmap;III)V

    :cond_c
    :goto_7
    invoke-virtual {v1}, Landroid/media/Image;->close()V

    iput-boolean v3, v0, Lyo/u$b;->a:Z

    iget-boolean v2, v0, Lyo/u$b;->b:Z

    if-eqz v2, :cond_d

    iget-object v2, v0, Lyo/u$b;->c:Lyo/u;

    invoke-virtual {v2}, Lyo/u;->i()V

    iput-boolean v3, v0, Lyo/u$b;->b:Z
