...
.method public final onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object v3, v4, Lcom/xiaomi/microfilm/vlogpro/vp/FragmentVlogProPreview;->b0:Lfl/c;

    iget-boolean v3, v3, Lfl/c;->n:Z
    ...
    iget-object v4, v4, Lcom/xiaomi/microfilm/vlogpro/vp/FragmentVlogProPreview;->b0:Lfl/c;
    ...
    iget v11, v4, Lfl/c;->f:I

    iget v14, v4, Lfl/c;->a:I

    sub-int/2addr v11, v14

    iget v15, v4, Lfl/c;->g:I
    ...
    iput v3, v4, Lfl/c;->e:I

    iget v3, v4, Lfl/c;->j:I

    sub-int/2addr v3, v14

    iget v11, v4, Lfl/c;->k:I
    ...
    iput v3, v4, Lfl/c;->i:I

    iget v3, v4, Lfl/c;->e:I

    int-to-float v3, v3

    iget-object v11, v4, Lfl/c;->t:Landroid/view/View;

    invoke-virtual {v11, v3}, Landroid/view/View;->setTranslationX(F)V

    iget v3, v4, Lfl/c;->i:I
    ...
    iget v11, v4, Lfl/c;->e:I

    int-to-float v11, v11

    aput v11, v3, v5

    iget v11, v4, Lfl/c;->i:I

    int-to-float v11, v11

    aput v11, v3, v6

    iget-object v11, v4, Lfl/c;->v:Lmiuix/animation/utils/VelocityMonitor;
    ...
    :cond_2
    iget-object v0, v4, Lcom/xiaomi/microfilm/vlogpro/vp/FragmentVlogProPreview;->b0:Lfl/c;

    iget-boolean v1, v0, Lfl/c;->n:Z

    if-eqz v1, :cond_e

    iput-boolean v5, v0, Lfl/c;->n:Z

    iget-object v1, v0, Lfl/c;->v:Lmiuix/animation/utils/VelocityMonitor;
    ...
    iget v12, v0, Lfl/c;->f:I

    goto :goto_0

    :cond_4
    iget v12, v0, Lfl/c;->e:I

    iget v15, v0, Lfl/c;->h:I
    ...
    iget v3, v0, Lfl/c;->j:I

    goto :goto_1

    :cond_7
    iget v3, v0, Lfl/c;->i:I

    iget v14, v0, Lfl/c;->l:I
    ...
    :goto_1
    const-string v14, "moveToEdge mSpeedX: "

    const-string v15, ", mSpeedY: "

    const-string v13, ", destX: "

    invoke-static {v14, v2, v15, v1, v13}, Landroidx/constraintlayout/core/parser/a;->f(Ljava/lang/String;FLjava/lang/String;FLjava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string v2, ", destY: "

    invoke-static {v1, v12, v2, v3}, Landroidx/constraintlayout/core/parser/a;->d(Ljava/lang/StringBuilder;ILjava/lang/String;I)Ljava/lang/String;
    ...
    iput-boolean v6, v0, Lfl/c;->b:Z

    iput-boolean v6, v0, Lfl/c;->c:Z
    ...
    invoke-interface {v1, v13, v14}, Lmiuix/animation/IStateStyle;->setFlags(J)Lmiuix/animation/IStateStyle;
    ...
    invoke-interface {v1, v10}, Lmiuix/animation/IStateStyle;->setTo([Ljava/lang/Object;)Lmiuix/animation/IStateStyle;
    ...
    invoke-virtual {v9, v14, v13}, Lmiuix/animation/base/AnimConfig;->setEase(I[F)Lmiuix/animation/base/AnimConfig;

    move-result-object v9

    new-array v13, v6, [Lmiuix/animation/listener/TransitionListener;

    new-instance v15, Lfl/a;

    invoke-direct {v15, v0}, Lfl/a;-><init>(Lfl/c;)V

    aput-object v15, v13, v5

    invoke-virtual {v9, v13}, Lmiuix/animation/base/AnimConfig;->addListeners([Lmiuix/animation/listener/TransitionListener;)Lmiuix/animation/base/AnimConfig;
    ...
    invoke-virtual {v7, v14, v10}, Lmiuix/animation/base/AnimConfig;->setEase(I[F)Lmiuix/animation/base/AnimConfig;

    move-result-object v7

    new-array v10, v6, [Lmiuix/animation/listener/TransitionListener;

    new-instance v13, Lfl/b;

    invoke-direct {v13, v0}, Lfl/b;-><init>(Lfl/c;)V

    aput-object v13, v10, v5

    invoke-virtual {v7, v10}, Lmiuix/animation/base/AnimConfig;->addListeners([Lmiuix/animation/listener/TransitionListener;)Lmiuix/animation/base/AnimConfig;
    ...
    invoke-virtual {v4, v0, v2, v3, v1}, Lcom/xiaomi/microfilm/vlogpro/vp/FragmentVlogProPreview;->Gd(ILjava/lang/String;Ljava/lang/String;Z)V
    ...
    iput-boolean v6, v3, Lfl/c;->n:Z

    iget-object v3, v3, Lfl/c;->v:Lmiuix/animation/utils/VelocityMonitor;
