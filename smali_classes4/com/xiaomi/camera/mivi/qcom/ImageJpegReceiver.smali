...
.method public static handleImageData(Lud/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    .locals 3
    ...
    invoke-virtual {p0}, Lud/w;->w()Ljava/lang/String;
    ...
    invoke-interface {v0, p0, p1, p2, p3}, Lud/n;->j(Lud/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z

    return-void
.end method

.method private static handleUltraRawImageDataIfNeed([BLandroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Lud/w;)V
    .locals 4
    ...
    invoke-direct {v0, p3}, Lud/w;-><init>(Lud/w;)V

    const/4 v3, 0x3

    .line 6
    invoke-virtual {v0, p0, v3}, Lud/w;->a([BI)V

    const/16 p0, 0x14

    .line 7
    invoke-virtual {v0, p0}, Lud/w;->g1(I)V
    ...
    .line 9
    invoke-virtual {p3}, Lud/w;->w()Ljava/lang/String;
    ...
    .line 11
    invoke-interface {v2, v0, p1, p2, p0}, Lud/n;->j(Lud/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method private handleUltraRawImageDataIfNeed([B[BLandroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Lud/w;)V
    .locals 3
    ...
    invoke-direct {v2, p5}, Lud/w;-><init>(Lud/w;)V

    .line 18
    invoke-virtual {v2, p2, p0}, Lud/w;->a([BI)V

    const/4 p0, 0x3

    .line 19
    invoke-virtual {v2, p1, p0}, Lud/w;->a([BI)V

    const/16 p0, 0x14

    .line 20
    invoke-virtual {v2, p0}, Lud/w;->g1(I)V
    ...
    .line 22
    invoke-virtual {p5}, Lud/w;->w()Ljava/lang/String;
    ...
    .line 24
    invoke-interface {v1, v2, p3, p4, p0}, Lud/n;->j(Lud/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method private static updatePictureInfoIfNeed(Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;Lud/w;)V
    .locals 7
    ...
    invoke-virtual {p1, v0}, Lud/w;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v0, v1}, Ll9/es;->l(Landroid/hardware/camera2/CaptureResult;Ll9/ds;)Ljava/lang/Object;
    ...
    invoke-static {v0, v3}, Ll9/es;->l(Landroid/hardware/camera2/CaptureResult;Ll9/ds;)Ljava/lang/Object;
    ...
    invoke-static {v0, v4}, Ll9/es;->l(Landroid/hardware/camera2/CaptureResult;Ll9/ds;)Ljava/lang/Object;
    ...
    :goto_0
    invoke-virtual {p1, v1}, Lud/z;->K(Z)V
    ...
    invoke-virtual {p1, v4}, Lud/z;->O(F)V
    ...
    invoke-virtual {p1, v0}, Lud/z;->U(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p0}, Lud/z;->F(Ljava/lang/String;)V
...
.method public onImageReceived(Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;)V
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;->getParallelTaskData()Lud/w;
    ...
    invoke-virtual {v1}, Lud/w;->w()Ljava/lang/String;

    move-result-object v3

    invoke-static {v0, v1}, Lcom/xiaomi/camera/mivi/qcom/ImageJpegReceiver;->updatePictureInfoIfNeed(Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;Lud/w;)V
    ...
    invoke-virtual {v6, v5}, Li6/g;->H(I)Lcom/android/camera2/f;
    ...
    invoke-static {v10, v8}, Lcom/android/camera/g6;->u1(II)I
    ...
    invoke-virtual {v1, v9, v10}, Lud/w;->u0([BI)V
    ...
    :cond_6
    invoke-static {v5}, Lcom/android/camera2/g;->F7(Lcom/android/camera2/f;)Z
    ...
    invoke-direct/range {v5 .. v10}, Lcom/xiaomi/camera/mivi/qcom/ImageJpegReceiver;->handleUltraRawImageDataIfNeed([B[BLandroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Lud/w;)V

    goto :goto_4

    :cond_7
    invoke-static {v8, v3, v11, v1}, Lcom/xiaomi/camera/mivi/qcom/ImageJpegReceiver;->handleUltraRawImageDataIfNeed([BLandroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Lud/w;)V
    ...
    :goto_4
    invoke-virtual {v1, v13}, Lud/w;->t0([B)V

    invoke-virtual {v1}, Lud/w;->B()I
    ...
    invoke-static {v1, v3, v11, v12}, Lcom/xiaomi/camera/mivi/qcom/ImageJpegReceiver;->handleImageData(Lud/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
