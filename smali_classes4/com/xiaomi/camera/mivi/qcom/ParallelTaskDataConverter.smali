...
.method private createParallelTaskData(Landroid/content/Context;Lorg/json/JSONObject;)Lud/w;
    .locals 3
...
.method private generateJpegWithXmp([BLcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter$ParallelItem;)[B
    ...
    invoke-interface {p0, v2, v3, v4}, Lc/d;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    :cond_0
    invoke-static {v1, p1, p0}, Lcom/android/camera/m6;->i(Ljava/io/InputStream;Ljava/io/OutputStream;Lc/d;)Z
...
.method private getThumbnailPath(Landroid/content/Context;Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    invoke-static {p1, p2}, Lfe/a;->h(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
...
.method private parallelTaskDataToBytes(Lud/w;)[B
    .locals 8
...
.method private stringToParallelTaskData(Landroid/content/Context;Ljava/lang/String;)Lud/w;
    .locals 6
    ...
    invoke-direct {p0, p1, p2}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->createParallelTaskData(Landroid/content/Context;Lorg/json/JSONObject;)Lud/w;
...
.method public combineParallelTaskDataToSmallJpeg([BLjava/lang/String;J)[B
    ...
    invoke-static {p2, p3, p4, v0}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->getParallelTaskData(Ljava/lang/String;JZ)Lud/w;

    move-result-object p2

    if-eqz p2, :cond_5

    invoke-virtual {p2}, Lud/w;->x()Z
    ...
    :cond_1
    invoke-virtual {p0, p2, v1}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->convertTaskDataItem(Lud/w;Z)Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter$ParallelItem;
...
.method public convertTaskDataItem(Lud/w;Z)Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter$ParallelItem;
    .locals 11
    ...
    invoke-direct {p0, p1}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->parallelTaskDataToBytes(Lud/w;)[B
    ...
    invoke-interface {p1, v3, v9, v10}, Lc/d;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
...
.method public readParallelTaskDataFromSmallJpeg(Landroid/content/Context;Ljava/lang/String;)Lud/w;
    .locals 8
    ...
    :cond_1
    new-instance p2, Lcom/android/camera/m6$c;

    invoke-direct {p2}, Lcom/android/camera/m6$c;-><init>()V

    const-string v6, "paralleldata"

    iput-object v6, p2, Lcom/android/camera/m6$c;->a:Ljava/lang/String;

    const/4 v6, 0x1

    new-array v7, v6, [Lcom/android/camera/m6$c;

    aput-object p2, v7, v1

    invoke-static {v2, v7}, Lcom/android/camera/m6;->b(Ljava/io/InputStream;[Lcom/android/camera/m6$c;)Lc/d;

    invoke-virtual {p0, v2}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->closeSilently(Ljava/io/Closeable;)V

    iget-object p2, p2, Lcom/android/camera/m6$c;->d:[B
    ...
    invoke-direct {p0, p1, p2}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->stringToParallelTaskData(Landroid/content/Context;Ljava/lang/String;)Lud/w;
...
.method public setImageReceived(Ljava/lang/String;JZ)V
    ...
    invoke-static {p1, p2, p3, p0}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->getParallelTaskData(Ljava/lang/String;JZ)Lud/w;
    ...
    invoke-virtual {p1, p0}, Lud/w;->W0(Z)V
