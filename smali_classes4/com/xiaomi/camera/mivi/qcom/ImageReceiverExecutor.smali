...
.method private static dumpImage(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;Lud/w;Ljava/lang/String;)V
    .locals 2
    ...
    invoke-static {p0, p1, p2}, Lrd/d;->d(Landroid/media/Image;Ljava/lang/String;Ljava/lang/String;)Z

    :cond_0
    return-void
.end method

.method private initReprocessProxy(Lud/w;Z)V
    .locals 2
...
.method private synthetic lambda$startReprocessLoop$1()V
    ...
    invoke-static {v6, v7, v8, v4}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->getParallelTaskData(Ljava/lang/String;JZ)Lud/w;
    ...
    invoke-virtual {v4, v6, v7}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->readParallelTaskDataFromSmallJpeg(Landroid/content/Context;Ljava/lang/String;)Lud/w;
    ...
    :cond_6
    invoke-virtual {v3, v6}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->setParallelTaskData(Lud/w;)V
    ...
    invoke-static {v3, v6, v4}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->dumpImage(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;Lud/w;Ljava/lang/String;)V
    ...
    :goto_4
    invoke-direct {p0, v6, v5}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->initReprocessProxy(Lud/w;Z)V
