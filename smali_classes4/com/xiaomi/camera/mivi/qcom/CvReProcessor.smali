...
.method public submit(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;Lcom/xiaomi/camera/mivi/qcom/IReProcessor$Callback;)V
    ...
    invoke-static {v4}, Lrd/d;->e(Landroid/media/Image;)[B
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getParallelTaskData()Lud/w;
    ...
    invoke-virtual/range {v16 .. v16}, Lud/w;->q()Lud/x;

    move-result-object v5

    invoke-virtual {v5}, Lud/x;->i0()I
