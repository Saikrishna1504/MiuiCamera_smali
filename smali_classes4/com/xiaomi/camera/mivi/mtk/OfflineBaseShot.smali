...
.field protected volatile mCurrentParallelTaskData:Lud/w;
...
.field private mQuickViewData:Lud/w;
...
.method public static synthetic access$1900(Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;Lud/w;I)Z
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->needFreeBuffers(Lud/w;I)Z
...
.method public static synthetic access$3400(Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;)Lud/w;
    .locals 0

    iget-object p0, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mQuickViewData:Lud/w;
...
.method private generateQuickViewPictureData()V
    ...
    iget-object v1, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lud/w;

    invoke-direct {v0, v1}, Lud/w;-><init>(Lud/w;)V

    iput-object v0, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mQuickViewData:Lud/w;

    new-instance v0, Lud/x$b;

    iget-object v1, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lud/w;

    invoke-virtual {v1}, Lud/w;->q()Lud/x;

    move-result-object v1

    invoke-direct {v0, v1}, Lud/x$b;-><init>(Lud/x;)V
    ...
    invoke-virtual {v0, v1}, Lud/x$b;->D(Landroid/util/Size;)Lud/x$b;

    iget-object v1, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mQuickViewData:Lud/w;
    ...
    iget-object v2, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mQuickViewData:Lud/w;

    invoke-virtual {v2}, Lud/w;->q()Lud/x;

    move-result-object v2

    invoke-virtual {v2}, Lud/x;->T0()Z
    ...
    invoke-virtual {v0, v1}, Lud/x$b;->u(I)Lud/x$b;

    move-result-object v7

    invoke-virtual {v7, v3}, Lud/x$b;->q(Z)Lud/x$b;

    move-result-object v7

    const-string v8, ""

    invoke-virtual {v7, v8}, Lud/x$b;->R(Ljava/lang/String;)Lud/x$b;

    move-result-object v7

    const/4 v8, 0x1

    invoke-virtual {v7, v8}, Lud/x$b;->c(Z)Lud/x$b;

    move-result-object v7

    invoke-virtual {v7, v1}, Lud/x$b;->g(I)Lud/x$b;

    move-result-object v1

    invoke-virtual {v1, v4}, Lud/x$b;->h(I)Lud/x$b;

    move-result-object v1

    invoke-virtual {v1, v2}, Lud/x$b;->n(I)Lud/x$b;

    move-result-object v1

    invoke-virtual {v1, v5}, Lud/x$b;->T(I)Lud/x$b;
    ...
    invoke-virtual {v1, v2}, Lud/x$b;->S(I)Lud/x$b;

    move-result-object v1

    invoke-virtual {v1, v6}, Lud/x$b;->B(Z)Lud/x$b;

    iget-object v1, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mQuickViewData:Lud/w;

    invoke-virtual {v1, v3}, Lud/w;->a1(Z)V
    ...
    invoke-virtual {v1, v0}, Lud/w;->b(Lud/x;)V

    iget-object v0, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mQuickViewData:Lud/w;

    invoke-virtual {v0}, Lud/w;->q()Lud/x;

    move-result-object v1

    invoke-virtual {v1}, Lud/x;->N0()Z

    move-result v1

    invoke-virtual {v0, v1}, Lud/w;->K0(Z)V
    ...
    invoke-virtual {v0, v1}, Lud/w;->e1(Z)V
    ...
    invoke-virtual {v0, v1}, Lud/w;->g1(I)V

    iget-object v0, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mQuickViewData:Lud/w;

    invoke-virtual {v0, v8}, Lud/w;->d1(Z)V

    iget-object p0, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mQuickViewData:Lud/w;

    invoke-virtual {p0, v3}, Lud/w;->Y0(Z)V
...
.method private isNeedGaussian()Z
    ...
    invoke-static {v0, v2, v3}, Lcom/android/camera2/g;->p2(Lcom/android/camera2/f;II)Z
...
.method private needFreeBuffers(Lud/w;I)Z
    .locals 0
...
.method private onFinalImageReceived([BLjava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lud/w;
    ...
    :cond_0
    iget-object v0, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lud/w;

    invoke-virtual {v0}, Lud/w;->S()Z
    ...
    iget-object v3, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lud/w;
    ...
    invoke-virtual {v0, p1, v1}, Lud/w;->u0([BI)V
    ...
    invoke-virtual {v0, p1, v2}, Lud/w;->u0([BI)V

    :goto_0
    iget-object v0, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lud/w;

    invoke-virtual {v0, v1}, Lud/w;->d1(Z)V
    ...
    iget-object p1, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lud/w;
    ...
    invoke-virtual {p0, p1, v0, v1, p2}, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->notifyResultData(Lud/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lud/w;
...
.method private onQuickViewJpegImageReady([BIZ)V
    ...
    invoke-virtual {v0, p1, p2}, Lud/w;->a([BI)V

    iget-object p1, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mQuickViewData:Lud/w;

    iget-object p1, p1, Lud/w;->o0:Lud/g;

    invoke-virtual {p1, p3}, Lud/g;->e(Z)V
    ...
    invoke-virtual {p0, p1, p2, p2, p2}, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->notifyResultData(Lud/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
...
.method public handleCaptureFinished()V
    ...
    invoke-virtual {p0, v2, v3, v3, v3}, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->notifyResultData(Lud/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
...
.method public notifyResultData(Lud/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    .locals 3
    ...
    invoke-virtual {p0}, Lcom/android/camera2/y4;->getParallelCallback()Lud/n;
    ...
    invoke-virtual {p1, v2}, Lud/w;->i1(I)V

    invoke-interface {v0, p1, p2, p3, p4}, Lud/n;->j(Lud/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method public onImageReceived(Landroid/media/Image;I)V
    ...
    invoke-virtual {v0, v5, v6}, Lud/w;->w1(J)V
    ...
    invoke-static {v0, p1, v9, v8}, Lrd/d;->k(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    iget-object v4, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lud/w;
    ...
    invoke-static {v0, p1, v4, v8}, Lrd/d;->k(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    iget-object v10, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lud/w;

    invoke-virtual {v10}, Lud/w;->v()J
...
.method public updatePictureInfoIfNeed(Landroid/hardware/camera2/TotalCaptureResult;Lud/w;)V
    .locals 7
    ...
    invoke-virtual {p2}, Lud/x;->r0()Lud/z;

    move-result-object p2

    const/4 v1, 0x4

    new-array v2, v1, [Ll9/ds;

    sget-object v3, Ll9/cs;->R0:Ll9/ds;
    ...
    sget-object v5, Ll9/cs;->T0:Ll9/ds;

    aput-object v5, v2, v3

    const/4 v3, 0x3

    sget-object v5, Ll9/cs;->U0:Ll9/ds;
    ...
    invoke-static {p1, v5}, Ll9/es;->l(Landroid/hardware/camera2/CaptureResult;Ll9/ds;)Ljava/lang/Object;
    ...
    :goto_1
    invoke-virtual {p2, v1}, Lud/z;->K(Z)V

    sget-object v2, Ll9/cs;->q1:Ll9/ds;

    invoke-static {p1, v2}, Ll9/es;->l(Landroid/hardware/camera2/CaptureResult;Ll9/ds;)Ljava/lang/Object;
    ...
    :cond_3
    invoke-virtual {p2, v2}, Lud/z;->U(Ljava/lang/String;)V
    ...
    sget-object v1, Ll9/cs;->G2:Ll9/ds;

    invoke-static {p1, v1}, Ll9/es;->l(Landroid/hardware/camera2/CaptureResult;Ll9/ds;)Ljava/lang/Object;
    ...
    invoke-virtual {p2, p1}, Lud/z;->F(Ljava/lang/String;)V
