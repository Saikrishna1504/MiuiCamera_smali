...
.method private doJpeg(Lud/w;Landroid/media/Image;I)V
    .locals 8
    ...
    invoke-direct/range {v2 .. v7}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->generateReprocessData(Lud/w;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;

    move-result-object p1

    const/4 p2, 0x0

    invoke-static {p3, p2}, Lrd/e;->d(II)V
...
.method private generateReprocessData(Lud/w;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    .locals 16
    ...
    invoke-virtual/range {p1 .. p1}, Lud/w;->m0()Z
    ...
    invoke-virtual/range {p1 .. p1}, Lud/w;->n0()Z
    ...
    invoke-virtual/range {p1 .. p1}, Lud/w;->Q()Landroid/media/Image;
    ...
    invoke-virtual/range {p1 .. p1}, Lud/w;->L()I

    move-result v1

    invoke-virtual/range {p1 .. p1}, Lud/w;->K()I
    ...
    invoke-virtual/range {p1 .. p1}, Lud/w;->w()Ljava/lang/String;
...
.method private handleDataBeanIfReady(Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;Z)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->getParallelTaskData(J)Lud/w;
    ...
    :cond_1
    invoke-virtual {p2}, Lud/w;->v()J

    move-result-wide v0

    invoke-virtual {p2}, Lud/w;->w()Ljava/lang/String;
    ...
    invoke-static {v0}, Lrd/d;->f(Landroid/media/Image;)[B
    ...
    invoke-virtual {p2, v0, v1}, Lud/w;->a([BI)V
    ...
    invoke-virtual {p2, v0}, Lud/w;->x1(Landroid/media/Image;)V
    ...
    invoke-direct {p0, v1, p2, v0}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->postCvWaterMark(Landroid/media/Image;Lud/w;I)V
    ...
    invoke-direct {p0, p2, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->doJpeg(Lud/w;Landroid/media/Image;I)V
...
.method private handleRawImageData([BLjava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->notifyFinish(Lud/w;Ljava/lang/String;)V
...
.method private postCvWaterMark(Landroid/media/Image;Lud/w;I)V
    .locals 5
    ...
    invoke-static {p1}, Lrd/d;->e(Landroid/media/Image;)[B
    ...
    invoke-virtual {p2, v0}, Lud/w;->d1(Z)V
...
.method public getParallelTaskData(J)Lud/w;
    .locals 3
...
.method public putParallelTaskData(JLud/w;)V
    .locals 4
