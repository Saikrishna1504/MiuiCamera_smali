...
.field private mService:Lmk/f;


# direct methods
.method private constructor <init>(Lmk/f;Landroid/content/Context;)V
    .locals 1
    ...
    iput-object p1, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mService:Lmk/f;
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->addServiceListener(Lmk/b;)V

    return-void
.end method

.method public static synthetic access$002(Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;Lmk/f;)Lmk/f;
    .locals 0
...
.method private checkApiFeatureStatusChanged()Z
    ...
    invoke-static {p0, v0}, Lbk/h;->g(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;
    ...
    invoke-static {p0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->getSystemService(Landroid/content/Context;)Lmk/f;
    ...
    invoke-direct {v2, v1, p0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;-><init>(Lmk/f;Landroid/content/Context;)V
...
.method private declared-synchronized getService()Lmk/f;
    .locals 3

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mService:Lmk/f;
    ...
    invoke-static {v0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->getSystemService(Landroid/content/Context;)Lmk/f;

    move-result-object v0

    iput-object v0, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mService:Lmk/f;
    ...
    invoke-static {v1, v2, v0}, Lpk/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static getSystemService(Landroid/content/Context;)Lmk/f;
    .locals 9

    invoke-static {p0}, Lmk/d;->a(Landroid/content/Context;)Lmk/d;
    ...
    :try_start_0
    iget-object v5, p0, Lmk/d;->b:Lmk/e;

    new-instance v6, Lmk/c;

    invoke-direct {v6}, Lmk/c;-><init>()V

    invoke-virtual {v5, v6}, Lnk/d;->j(Lmk/c;)Lnk/d$a;
    ...
    iget-object v5, p0, Lmk/d;->d:Ljava/util/ArrayList;

    monitor-enter v5

    :try_start_1
    iget-object v3, p0, Lmk/d;->d:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lmk/d;->d:Ljava/util/ArrayList;
    ...
    :cond_3
    new-instance p0, Lmk/f$a$a;

    invoke-direct {p0, v4}, Lmk/f$a$a;-><init>(Landroid/os/IBinder;)V
    ...
    invoke-static {v0, v1, p0}, Lpk/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
# virtual methods
.method public addServiceListener(Lmk/b;)V
    .locals 0
    ...
    iget-object p0, p0, Lmk/d;->c:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public confirmChannel(IILcom/xiaomi/continuity/channel/ChannelConfirmOptions;)I
    ...
    invoke-direct {p0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->getService()Lmk/f;
    ...
    invoke-interface {v0, p1, p2, p3}, Lmk/f;->a0(IILcom/xiaomi/continuity/channel/ChannelConfirmOptions;)V
    ...
    invoke-interface {v0, p1, p2, p0}, Lmk/f;->O(IILjava/lang/String;)V

    goto :goto_0

    :cond_1
    invoke-interface {v0, p1, p2}, Lmk/f;->M(II)V
    ...
    invoke-static {v1, p0, p1}, Lpk/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    ...
    invoke-static {p2, v1, p0, p3, p1}, Lpk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public createChannel(Lcom/xiaomi/continuity/netbus/LinkAddress;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ChannelInnerListener;Ljava/util/concurrent/Executor;)I
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0, p5}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->addServiceListener(Lmk/b;)V
    ...
    invoke-interface/range {v1 .. v6}, Lmk/f;->u(Ljava/lang/String;Lcom/xiaomi/continuity/netbus/LinkAddress;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$c;)I
    ...
    invoke-interface/range {v1 .. v6}, Lmk/f;->z(Ljava/lang/String;Lcom/xiaomi/continuity/netbus/LinkAddress;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptions;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$c;)I
    ...
    .line 3
    invoke-static {v0, p3, p1, p4, p2}, Lpk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 4
    invoke-virtual {p0, p5}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->removeServiceListener(Lmk/b;)V
...
.method public createChannel(Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ChannelInnerListener;Ljava/util/concurrent/Executor;)I
    ...
    invoke-interface/range {v1 .. v6}, Lmk/f;->b(Ljava/lang/String;Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$b;)I
    ...
    invoke-interface/range {v1 .. v6}, Lmk/f;->E(Ljava/lang/String;Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptions;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$b;)I
...
.method public destroyChannel(I)I
    ...
    :try_start_0
    invoke-interface {p0, p1}, Lmk/f;->D(I)V
    ...
    invoke-static {v2, p0, p1}, Lpk/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v1, v2, p0, v3, p1}, Lpk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public getApiFeature()Ljava/lang/String;
    ...
    :try_start_0
    invoke-interface {v0}, Lmk/f;->i()Ljava/lang/String;
...
.method public getChannelInfoExt(II)Landroid/os/Bundle;
    ...
    :try_start_0
    invoke-interface {p0, p1, p2}, Lmk/f;->Y(II)Landroid/os/Bundle;
    ...
    invoke-static {p2, v0, p0, v1, p1}, Lpk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public notifyChannelServerConnected(Lcom/xiaomi/continuity/ServiceName;I)V
    ...
    invoke-static {p0, v3}, Lbk/h;->g(Ljava/lang/String;Ljava/lang/String;)Z

    move-result p0

    if-eqz p0, :cond_1

    invoke-interface {v0, p1, p2}, Lmk/f;->m(Lcom/xiaomi/continuity/ServiceName;I)V
    ...
    invoke-static {p2, v2, p0, v0, p1}, Lpk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public notifyChannelServerCreateFailed(I)V
    ...
    :try_start_0
    invoke-interface {p0, p1, v1}, Lmk/f;->U(II)V
    ...
    invoke-static {v0, p0, p1}, Lpk/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v1, v0, p0, v2, p1}, Lpk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public notifyChannelServerCreated(II)V
    ...
    :try_start_0
    invoke-interface {p0, p1, p2}, Lmk/f;->U(II)V
    ...
    invoke-static {v0, p2, v1}, Lpk/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public registerChannelListener(Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ServerChannelOptions;Lcom/xiaomi/continuity/channel/ChannelInnerListener;Ljava/util/concurrent/Executor;)I
    ...
    invoke-virtual {p0, v1}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->addServiceListener(Lmk/b;)V
    ...
    invoke-interface {v0, p3, p1, p2, v1}, Lmk/f;->K(Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ServerChannelOptions;Lcom/xiaomi/continuity/channel/a;)I
    ...
    invoke-virtual {p0, v1}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->removeServiceListener(Lmk/b;)V
    ...
    invoke-static {p4, p2, p0, p3, p1}, Lpk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public removeServiceListener(Lmk/b;)V
    .locals 0
...
.method public send(I[BLandroid/os/Bundle;Lcom/xiaomi/continuity/channel/SendResultCallback;Ljava/util/concurrent/Executor;)I
    ...
    invoke-interface {p0, p1, p2, p3, v3}, Lmk/f;->v(I[BLandroid/os/Bundle;Lcom/xiaomi/continuity/channel/e;)I
    ...
    invoke-static {p2, v2, p0, p3, p1}, Lpk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public unbindService()V
    ...
    invoke-static {v1, v2, v0}, Lpk/a;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v0, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mContext:Landroid/content/Context;

    invoke-static {v0}, Lmk/d;->a(Landroid/content/Context;)Lmk/d;

    move-result-object v0

    const-string v1, "continuity_connection"

    iget-object v2, v0, Lmk/d;->d:Ljava/util/ArrayList;

    monitor-enter v2

    :try_start_0
    iget-object v3, v0, Lmk/d;->d:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v1, v0, Lmk/d;->d:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Lmk/d;->b:Lmk/e;

    iput-boolean v3, v0, Lnk/d;->n:Z

    iget-object v1, v0, Lnk/d;->i:Landroid/os/Handler;
...
.method public unregisterChannelListener(Lcom/xiaomi/continuity/ServiceName;)I
    ...
    invoke-virtual {p0, v3}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->removeServiceListener(Lmk/b;)V
    ...
    invoke-interface {p0, p1}, Lmk/f;->d0(Lcom/xiaomi/continuity/ServiceName;)I
    ...
    invoke-static {p0, p1, v3}, Lpk/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v3, v1, p0, v2, p1}, Lpk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
