...
.method public constructor <init>(Lrc/s;)V
    ...
    invoke-static {v0}, Lrc/k$a;->a([Ljava/lang/String;)Lrc/k$a;
    ...
    iput-object v0, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBeanJsonAdapter;->a:Lrc/k$a;
    ...
    invoke-virtual {p1, v2, v0, v1}, Lrc/s;->f(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)Lrc/f;
    ...
    iput-object v0, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBeanJsonAdapter;->b:Lrc/f;
    ...
    iput-object v0, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBeanJsonAdapter;->c:Lrc/f;
    ...
    invoke-static {v1, v0}, Lrc/v;->j(Ljava/lang/reflect/Type;[Ljava/lang/reflect/Type;)Ljava/lang/reflect/ParameterizedType;
    ...
    iput-object p1, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBeanJsonAdapter;->d:Lrc/f;
...
.method public bridge synthetic c(Lrc/k;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBeanJsonAdapter;->i(Lrc/k;)Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBean;
...
.method public bridge synthetic h(Lrc/p;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBeanJsonAdapter;->j(Lrc/p;Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBean;)V

    return-void
.end method

.method public i(Lrc/k;)Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBean;
    .locals 20
    ...
    invoke-virtual/range {p1 .. p1}, Lrc/k;->b()V
    ...
    :goto_0
    invoke-virtual/range {p1 .. p1}, Lrc/k;->f()Z

    move-result v5

    if-eqz v5, :cond_6

    iget-object v5, v0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBeanJsonAdapter;->a:Lrc/k$a;

    invoke-virtual {v1, v5}, Lrc/k;->s(Lrc/k$a;)I
    ...
    :pswitch_0
    iget-object v5, v0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBeanJsonAdapter;->b:Lrc/f;

    invoke-virtual {v5, v1}, Lrc/f;->c(Lrc/k;)Ljava/lang/Object;
    ...
    invoke-static {v0, v0, v1}, Lsc/b;->v(Ljava/lang/String;Ljava/lang/String;Lrc/k;)Lrc/h;
    ...
    :pswitch_1
    iget-object v5, v0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBeanJsonAdapter;->d:Lrc/f;
    ...
    :pswitch_4
    iget-object v2, v0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBeanJsonAdapter;->c:Lrc/f;

    invoke-virtual {v2, v1}, Lrc/f;->c(Lrc/k;)Ljava/lang/Object;
    ...
    :pswitch_6
    invoke-virtual/range {p1 .. p1}, Lrc/k;->w()V

    invoke-virtual/range {p1 .. p1}, Lrc/k;->x()V

    goto/16 :goto_0

    :cond_6
    invoke-virtual/range {p1 .. p1}, Lrc/k;->d()V
    ...
    sget-object v18, Lsc/b;->c:Ljava/lang/Class;
...
.method public j(Lrc/p;Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBean;)V
    .locals 3
    ...
    iget-object v0, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBeanJsonAdapter;->b:Lrc/f;
    ...
    iget-object v0, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBeanJsonAdapter;->c:Lrc/f;
    ...
    iget-object v0, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBeanJsonAdapter;->d:Lrc/f;
    ...
    iget-object p0, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBeanJsonAdapter;->b:Lrc/f;
