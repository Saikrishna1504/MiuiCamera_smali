...
.method public constructor <init>(Lrc/s;)V
    ...
    invoke-static {v2}, Lrc/k$a;->a([Ljava/lang/String;)Lrc/k$a;
    ...
    iput-object v2, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/RuleJsonAdapter;->a:Lrc/k$a;
    ...
    invoke-virtual {p1, v3, v2, v0}, Lrc/s;->f(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)Lrc/f;
    ...
    iput-object v0, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/RuleJsonAdapter;->b:Lrc/f;

    invoke-static {}, Ldk/i0;->d()Ljava/util/Set;

    move-result-object v0

    invoke-virtual {p1, v3, v0, v1}, Lrc/s;->f(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)Lrc/f;
    ...
    iput-object v0, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/RuleJsonAdapter;->c:Lrc/f;
    ...
    invoke-virtual {p1, v0, v1, v4}, Lrc/s;->f(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)Lrc/f;
    ...
    iput-object p1, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/RuleJsonAdapter;->d:Lrc/f;
...
.method public bridge synthetic c(Lrc/k;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/miui/camerainfra/cloudconfig/data/http/bean/RuleJsonAdapter;->i(Lrc/k;)Lcom/miui/camerainfra/cloudconfig/data/http/bean/Rule;
...
.method public bridge synthetic h(Lrc/p;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/miui/camerainfra/cloudconfig/data/http/bean/RuleJsonAdapter;->j(Lrc/p;Lcom/miui/camerainfra/cloudconfig/data/http/bean/Rule;)V

    return-void
.end method

.method public i(Lrc/k;)Lcom/miui/camerainfra/cloudconfig/data/http/bean/Rule;
    .locals 11
    ...
    iget-object v1, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/RuleJsonAdapter;->a:Lrc/k$a;
    ...
    :cond_0
    iget-object v0, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/RuleJsonAdapter;->d:Lrc/f;
    ...
    :cond_1
    invoke-static {v6, v6, p1}, Lsc/b;->v(Ljava/lang/String;Ljava/lang/String;Lrc/k;)Lrc/h;
    ...
    :cond_2
    iget-object v1, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/RuleJsonAdapter;->c:Lrc/f;
    ...
    :cond_3
    invoke-static {v7, v7, p1}, Lsc/b;->v(Ljava/lang/String;Ljava/lang/String;Lrc/k;)Lrc/h;
    ...
    :cond_5
    invoke-static {v8, v8, p1}, Lsc/b;->v(Ljava/lang/String;Ljava/lang/String;Lrc/k;)Lrc/h;
    ...
    :cond_7
    invoke-static {v9, v9, p1}, Lsc/b;->v(Ljava/lang/String;Ljava/lang/String;Lrc/k;)Lrc/h;
    ...
    :cond_8
    iget-object v1, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/RuleJsonAdapter;->b:Lrc/f;
    ...
    :cond_b
    invoke-static {v6, v6, p1}, Lsc/b;->n(Ljava/lang/String;Ljava/lang/String;Lrc/k;)Lrc/h;
    ...
    :cond_c
    invoke-static {v7, v7, p1}, Lsc/b;->n(Ljava/lang/String;Ljava/lang/String;Lrc/k;)Lrc/h;
    ...
    :cond_d
    invoke-static {v8, v8, p1}, Lsc/b;->n(Ljava/lang/String;Ljava/lang/String;Lrc/k;)Lrc/h;
    ...
    :cond_e
    invoke-static {v9, v9, p1}, Lsc/b;->n(Ljava/lang/String;Ljava/lang/String;Lrc/k;)Lrc/h;
...
.method public j(Lrc/p;Lcom/miui/camerainfra/cloudconfig/data/http/bean/Rule;)V
    .locals 2
    ...
    iget-object v0, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/RuleJsonAdapter;->b:Lrc/f;
    ...
    iget-object v0, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/RuleJsonAdapter;->c:Lrc/f;
    ...
    iget-object p0, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/RuleJsonAdapter;->d:Lrc/f;
