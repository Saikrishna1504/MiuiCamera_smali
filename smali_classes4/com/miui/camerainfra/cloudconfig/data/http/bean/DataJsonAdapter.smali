...
.method public constructor <init>(Lrc/s;)V
    ...
    iput-object v2, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/DataJsonAdapter;->a:Lrc/k$a;
    ...
    invoke-virtual {p1, v2, v3, v0}, Lrc/s;->f(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)Lrc/f;
    ...
    iput-object v0, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/DataJsonAdapter;->b:Lrc/f;
    ...
    invoke-static {v2, v0}, Lrc/v;->j(Ljava/lang/reflect/Type;[Ljava/lang/reflect/Type;)Ljava/lang/reflect/ParameterizedType;
    ...
    invoke-virtual {p1, v0, v2, v1}, Lrc/s;->f(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)Lrc/f;
    ...
    iput-object p1, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/DataJsonAdapter;->c:Lrc/f;
...
.method public bridge synthetic c(Lrc/k;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/miui/camerainfra/cloudconfig/data/http/bean/DataJsonAdapter;->i(Lrc/k;)Lcom/miui/camerainfra/cloudconfig/data/http/bean/Data;
...
.method public bridge synthetic h(Lrc/p;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/miui/camerainfra/cloudconfig/data/http/bean/DataJsonAdapter;->j(Lrc/p;Lcom/miui/camerainfra/cloudconfig/data/http/bean/Data;)V

    return-void
.end method

.method public i(Lrc/k;)Lcom/miui/camerainfra/cloudconfig/data/http/bean/Data;
    .locals 6
    ...
    iget-object v2, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/DataJsonAdapter;->a:Lrc/k$a;

    invoke-virtual {p1, v2}, Lrc/k;->s(Lrc/k$a;)I
    ...
    :cond_0
    iget-object v1, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/DataJsonAdapter;->c:Lrc/f;
    ...
    :cond_1
    invoke-static {v3, v3, p1}, Lsc/b;->v(Ljava/lang/String;Ljava/lang/String;Lrc/k;)Lrc/h;
    ...
    :cond_2
    iget-object v0, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/DataJsonAdapter;->b:Lrc/f;
    ...
    :cond_6
    invoke-static {v3, v3, p1}, Lsc/b;->n(Ljava/lang/String;Ljava/lang/String;Lrc/k;)Lrc/h;
...
.method public j(Lrc/p;Lcom/miui/camerainfra/cloudconfig/data/http/bean/Data;)V
    .locals 3
    ...
    iget-object p0, p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/DataJsonAdapter;->c:Lrc/f;
