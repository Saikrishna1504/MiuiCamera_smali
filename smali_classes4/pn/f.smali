...
# direct methods
.method public constructor <init>(Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;Lnm/f;Lkotlin/jvm/internal/v;)V
    .locals 0

    iput-object p1, p0, Lpn/f;->c:Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;

    iput-object p2, p0, Lpn/f;->a:Lnm/f;

    iput-object p3, p0, Lpn/f;->b:Lkotlin/jvm/internal/v;
...
.method public final convert(ILcom/xiaomi/mimoji/mimojifu2/ui/adapter/BaseViewHolder;Ljava/lang/Object;I)V
    ...
    iget v0, p3, Lnm/a;->d:I

    iget v1, p3, Lnm/a;->e:I

    iget v2, p3, Lnm/a;->c:I
    ...
    iget-object p1, p0, Lpn/f;->a:Lnm/f;

    iget-object p1, p1, Lnm/f;->d:Lnm/h;

    iget-object p1, p1, Lnm/h;->a:Lnm/a;

    if-eqz p1, :cond_0

    iget v0, p3, Lnm/a;->e:I

    iget v1, p3, Lnm/a;->c:I

    iget v2, p3, Lnm/a;->d:I
    ...
    iget v2, p1, Lnm/a;->c:I

    iget p1, p1, Lnm/a;->d:I
    ...
    iget-object p0, p0, Lpn/f;->b:Lkotlin/jvm/internal/v;
    ...
    iget-object p1, p3, Lnm/a;->b:Ljava/lang/String;
...
.method public final onItemClickListener(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    iget-object v3, v0, Lpn/f;->c:Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;

    invoke-static {v3}, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->jd(Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;)V

    iget-object v4, v0, Lpn/f;->b:Lkotlin/jvm/internal/v;
    ...
    iget-object v1, v3, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->a:Lmn/a;

    iget-object v0, v0, Lpn/f;->a:Lnm/f;

    iget-object v0, v0, Lnm/f;->a:Ljava/lang/String;
    ...
    invoke-direct {v3, v0, v2}, Lmn/g;-><init>(Ljava/lang/String;Lnm/a;)V

    const-string v4, "KIT_EditorViewModel"

    invoke-static {v4, v3}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Lsp/a;)V

    iget-object v3, v1, Lmn/a;->c:Lsm/a;

    if-eqz v3, :cond_d

    iget-object v6, v1, Lmn/a;->n:Lcom/faceunity/core/avatar/model/Scene;
    ...
    invoke-static {v6}, Lsm/a;->b(Lcom/faceunity/core/avatar/model/Scene;)Lcom/faceunity/core/avatar/model/Avatar;
    ...
    :cond_2
    iget-object v3, v3, Lsm/a;->a:Lsm/b;

    invoke-virtual {v3, v0}, Lsm/b;->l(Ljava/lang/String;)Lnm/f;
    ...
    iget-object v8, v0, Lnm/f;->c:Lnm/g;

    iget-object v8, v8, Lnm/g;->h:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v9}, Lsm/b;->d(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget v12, v2, Lnm/a;->c:I

    iget v13, v11, Lnm/a;->c:I

    if-ne v12, v13, :cond_6

    iget v12, v2, Lnm/a;->d:I

    iget v13, v11, Lnm/a;->d:I

    if-ne v12, v13, :cond_6

    iget v12, v2, Lnm/a;->e:I

    iget v13, v11, Lnm/a;->e:I
    ...
    invoke-virtual {v3, v9}, Lsm/b;->l(Ljava/lang/String;)Lnm/f;

    move-result-object v9

    if-eqz v9, :cond_7

    iget-object v9, v9, Lnm/f;->d:Lnm/h;
    ...
    :cond_8
    iput-object v11, v9, Lnm/h;->a:Lnm/a;
    ...
    iget-object v6, v5, Lnm/a;->a:Ljava/lang/String;

    sget-object v8, Llm/a;->a:Ljava/lang/String;

    const-string v8, "makeup_"

    invoke-static {v6, v8, v7}, Lzp/m;->A(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z

    move-result v6

    iget v7, v5, Lnm/a;->e:I

    iget v8, v5, Lnm/a;->d:I

    iget v9, v5, Lnm/a;->c:I

    if-eqz v6, :cond_a

    iget-object v10, v4, Lcom/faceunity/core/avatar/model/Avatar;->color:Lcom/faceunity/core/avatar/avatar/Color;

    iget-object v11, v5, Lnm/a;->a:Ljava/lang/String;
    ...
    iget-object v10, v5, Lnm/a;->a:Ljava/lang/String;
    ...
    iget-object v7, v5, Lnm/a;->a:Ljava/lang/String;
    ...
    iput-object v2, v0, Lnm/h;->a:Lnm/a;

    :goto_6
    iget-object v0, v1, Lmn/a;->u:Lnm/d;

    if-eqz v0, :cond_e

    iget-object v0, v0, Lnm/d;->a:Ljava/lang/String;

    if-eqz v0, :cond_e

    const/4 v1, 0x0

    invoke-static {v0, v1}, Lmn/a;->a(Ljava/lang/String;Ljava/lang/String;)V
