...
# instance fields
.field public final synthetic a:Lnm/g;
...
# direct methods
.method public constructor <init>(Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;Lnm/g;Lnm/f;Lkotlin/jvm/internal/v;)V
    .locals 0

    iput-object p1, p0, Lpn/d;->d:Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;

    iput-object p2, p0, Lpn/d;->a:Lnm/g;

    iput-object p3, p0, Lpn/d;->b:Lnm/f;

    iput-object p4, p0, Lpn/d;->c:Lkotlin/jvm/internal/v;
...
.method public final convert(ILcom/xiaomi/mimoji/mimojifu2/ui/adapter/BaseViewHolder;Ljava/lang/Object;I)V
    ...
    iget-object p1, p0, Lpn/d;->d:Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;

    iget-object v0, p1, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->i:Ljava/util/HashMap;

    iget-object v1, p3, Lnm/e;->g:Ljava/lang/String;
    ...
    iget-object v5, p0, Lpn/d;->a:Lnm/g;

    iget-wide v6, v5, Lnm/g;->b:D
    ...
    iget-object v3, p3, Lnm/e;->b:Ljava/lang/String;
    ...
    :cond_0
    iget-object v2, p3, Lnm/e;->c:Ljava/lang/String;
    ...
    iput-boolean v2, v5, Lnm/g;->d:Z

    goto :goto_2

    :cond_2
    iget-boolean v1, v5, Lnm/g;->d:Z
    ...
    :goto_2
    sget-object v3, Lsm/b;->n:Ljava/util/HashMap;

    iget-object v4, p0, Lpn/d;->b:Lnm/f;
    ...
    :cond_4
    iget-object v0, p1, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->a:Lmn/a;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v0, v0, Lmn/a;->i:Lpm/c;
    ...
    :cond_6
    :goto_3
    invoke-virtual {p1, p2, v0}, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->Ae(Lcom/xiaomi/mimoji/mimojifu2/ui/adapter/BaseViewHolder;Lnm/b;)V
    ...
    iget-object p2, v4, Lnm/f;->d:Lnm/h;

    iget-object p2, p2, Lnm/h;->b:Lnm/e;
    ...
    iget-object p0, p0, Lpn/d;->c:Lkotlin/jvm/internal/v;
...
.method public final onItemClickListener(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    invoke-static {p1}, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->jd(Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;)V

    iget-boolean v0, p2, Lnm/e;->f:Z

    if-eqz v0, :cond_11

    iget-object v0, p0, Lpn/d;->c:Lkotlin/jvm/internal/v;
    ...
    iget-object v6, p1, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->a:Lmn/a;

    iget-object p0, p0, Lpn/d;->b:Lnm/f;

    iget-object v8, p0, Lnm/f;->a:Ljava/lang/String;
    ...
    invoke-direct {p0, v8, p2}, Lmn/h;-><init>(Ljava/lang/String;Lnm/e;)V

    const-string p1, "KIT_EditorViewModel"

    invoke-static {p1, p0}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Lsp/a;)V

    iget-object p0, v6, Lmn/a;->v:Ljava/util/HashMap;

    iget-object p3, p2, Lnm/e;->g:Ljava/lang/String;

    invoke-virtual {p0, v8, p3}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object p0, Llm/a;->g:Llm/a$a;

    invoke-virtual {p0, v8}, Llm/a$a;->contains(Ljava/lang/Object;)Z
    ...
    iget-object p0, v6, Lmn/a;->i:Lpm/c;

    invoke-static {p0}, Lkotlin/jvm/internal/j;->c(Ljava/lang/Object;)V

    iget-object p0, p0, Lpm/c;->b:Ljava/util/HashMap;
    ...
    sget-object p0, Lnm/b;->a:Lnm/b;

    :cond_4
    sget-object v2, Lnm/b;->b:Lnm/b;
    ...
    :cond_5
    iget-object p0, v6, Lmn/a;->c:Lsm/a;

    if-eqz p0, :cond_c

    iget-object p3, p0, Lsm/a;->a:Lsm/b;

    invoke-virtual {p3, v8}, Lsm/b;->l(Ljava/lang/String;)Lnm/f;
    ...
    iget-object v0, v0, Lnm/f;->c:Lnm/g;

    iget-object v0, v0, Lnm/g;->f:Ljava/util/ArrayList;
    ...
    invoke-virtual {p3, v3}, Lsm/b;->l(Ljava/lang/String;)Lnm/f;
    ...
    :cond_8
    iget-object v4, v4, Lnm/f;->d:Lnm/h;

    iget-object v4, v4, Lnm/h;->b:Lnm/e;
    ...
    :cond_9
    iget-object v4, p0, Lsm/a;->c:Ljava/lang/String;

    invoke-virtual {p3, v3, v4}, Lsm/b;->k(Ljava/lang/String;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-object v5, v5, Lnm/e;->a:Ljava/util/ArrayList;
    ...
    :goto_2
    new-instance v9, Lmn/i;

    invoke-direct {v9, v6, v8, p2}, Lmn/i;-><init>(Lmn/a;Ljava/lang/String;Lnm/e;)V

    new-instance p0, Lmn/l;

    invoke-direct {p0, v8}, Lmn/l;-><init>(Ljava/lang/String;)V

    invoke-static {p1, p0}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Lsp/a;)V

    iget-object p0, v6, Lmn/a;->k:Lgp/i;
    ...
    invoke-direct/range {v4 .. v9}, Lic/b;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object p1, v6, Lmn/a;->n:Lcom/faceunity/core/avatar/model/Scene;

    if-eqz p1, :cond_f

    invoke-virtual {p0, p1, v8, p2}, Lsm/a;->c(Lcom/faceunity/core/avatar/model/Scene;Ljava/lang/String;Lnm/e;)V

    iget-object p0, v6, Lmn/a;->t:Lmm/b;

    if-eqz p0, :cond_e

    invoke-virtual {p0, v8}, Lmm/b;->b(Ljava/lang/String;)V

    :cond_e
    iget-object p0, v6, Lmn/a;->u:Lnm/d;

    if-eqz p0, :cond_11

    iget-object p0, p0, Lnm/d;->a:Ljava/lang/String;

    if-eqz p0, :cond_11

    invoke-static {p0, v8}, Lmn/a;->a(Ljava/lang/String;Ljava/lang/String;)V
