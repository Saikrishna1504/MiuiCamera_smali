...
.method public a(Ljava/lang/reflect/Type;Ljava/util/Set;Lrc/s;)Lrc/f;
    ...
    :cond_2
    invoke-static {v0}, Lsc/b;->i(Ljava/lang/Class;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lrc/c$a;->d(Ljava/lang/reflect/Type;Ljava/lang/Class;)V
    ...
    invoke-static {v0}, Lsc/b;->h(Ljava/lang/Class;)Z

    move-result p2

    if-nez p2, :cond_8

    invoke-static {v0}, Lrc/b;->a(Ljava/lang/Class;)Lrc/b;
    ...
    invoke-virtual {p0, p3, p1, v0}, Lrc/c$a;->b(Lrc/s;Ljava/lang/reflect/Type;Ljava/util/Map;)V

    invoke-static {p1}, Lrc/v;->f(Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;
    ...
    invoke-direct {p0, p2, v0}, Lrc/c;-><init>(Lrc/b;Ljava/util/Map;)V
...
.method public final b(Lrc/s;Ljava/lang/reflect/Type;Ljava/util/Map;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p2}, Lrc/v;->g(Ljava/lang/reflect/Type;)Ljava/lang/Class;
    ...
    invoke-virtual {p0, v1, v6}, Lrc/c$a;->c(ZI)Z
    ...
    invoke-interface {v6}, Lrc/e;->ignore()Z
    ...
    invoke-static {p2, v0, v7}, Lsc/b;->p(Ljava/lang/reflect/Type;Ljava/lang/Class;Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;

    move-result-object v7

    invoke-static {v5}, Lsc/b;->j(Ljava/lang/reflect/AnnotatedElement;)Ljava/util/Set;
    ...
    invoke-virtual {p1, v7, v8, v9}, Lrc/s;->f(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)Lrc/f;
    ...
    invoke-static {v9, v6}, Lsc/b;->m(Ljava/lang/String;Lrc/e;)Ljava/lang/String;

    move-result-object v6

    new-instance v8, Lrc/c$b;

    invoke-direct {v8, v6, v5, v7}, Lrc/c$b;-><init>(Ljava/lang/String;Ljava/lang/reflect/Field;Lrc/f;)V

    invoke-interface {p3, v6, v8}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lrc/c$b;
    ...
    iget-object p2, v5, Lrc/c$b;->b:Ljava/lang/reflect/Field;
    ...
    iget-object p2, v8, Lrc/c$b;->b:Ljava/lang/reflect/Field;
