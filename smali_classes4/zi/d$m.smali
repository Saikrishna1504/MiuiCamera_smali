...
.method public constructor <init>(Lzi/d;)V
    ...
    iput-object p1, p0, Lzi/d$m;->a:Lzi/d;
...
.method public onRecordSuccess(Landroid/graphics/Bitmap;Ljava/lang/String;)V
    ...
    invoke-static/range {v0 .. v5}, Lwk/o;->r0(Ljava/lang/CharSequence;[Ljava/lang/String;ZIILjava/lang/Object;)Ljava/util/List;
    ...
    iget-object p2, p0, Lzi/d$m;->a:Lzi/d;

    invoke-static {p2}, Lzi/d;->w(Lzi/d;)Lci/b;
    ...
    invoke-virtual {p2, v0}, Lci/b;->w(Ljava/lang/String;)Lxh/e;

    move-result-object p2

    if-eqz p2, :cond_2

    iget-object p0, p0, Lzi/d$m;->a:Lzi/d;
