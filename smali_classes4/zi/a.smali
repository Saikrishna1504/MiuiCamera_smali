...
.field public final e:Lzi/a$d;

.field public final f:Lzi/a$a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lzi/a;->f:Lzi/a$a;
    ...
    iput-object v0, p0, Lzi/a;->d:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Ljava/lang/Thread;->start()V

    new-instance v1, Lzi/a$d;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v0

    invoke-direct {v1, p0, v0}, Lzi/a$d;-><init>(Lzi/a;Landroid/os/Looper;)V

    iput-object v1, p0, Lzi/a;->e:Lzi/a$d;

    return-void
.end method

.method public static a(Lzi/a;Ljg/b$a;IZ)V
    .locals 17
    ...
    invoke-direct {v12, v1, v0, v2}, Lzi/b;-><init>(Lzi/a;Ljg/b$a;I)V

    const/4 v13, 0x1

    if-nez v2, :cond_0

    iget-object v3, v0, Ljg/b$a;->d:Landroid/media/Image;
    ...
    iget-object v3, v0, Ljg/b$a;->e:Landroid/media/Image;
    ...
    iget-object v5, v0, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v4, v5, v2}, La0/b0;->e(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {v4, v3, v6, v13}, Lgg/e;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    iget-object v3, v1, Lzi/a;->c:Ljava/lang/Object;
    ...
    iput-wide v6, v1, Lzi/a;->a:J

    iput-boolean v13, v1, Lzi/a;->b:Z
    ...
    iget-object v7, v0, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v4, v1, Lzi/a;->c:Ljava/lang/Object;
    ...
    :try_start_2
    iget-boolean v0, v1, Lzi/a;->b:Z

    if-eqz v0, :cond_1

    iget-object v0, v1, Lzi/a;->c:Ljava/lang/Object;
    ...
    invoke-static {v1, v2, v3}, La0/v;->b(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
# virtual methods
.method public final b(Ljg/b;Lcom/xiaomi/engine/TaskSession;)V
    .locals 33
    ...
    sget-boolean v0, Lya/b;->w:Z

    iget-object v4, v1, Ljg/b;->f:Ljava/util/ArrayList;

    move-object/from16 v6, p0

    iget-object v6, v6, Lzi/a;->f:Lzi/a$a;
    ...
    iget-object v2, v0, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-object v2, v0, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-boolean v7, v0, Ljg/b$a;->a:Z

    iget-boolean v2, v0, Ljg/b$a;->m:Z

    if-eqz v2, :cond_0

    invoke-virtual {v0}, Ljg/b$a;->b()V

    :cond_0
    iget-object v2, v1, Ljg/b;->p:Lyg/d;
    ...
    iget-object v8, v5, Ljg/b$a;->d:Landroid/media/Image;

    iget-object v9, v5, Ljg/b$a;->e:Landroid/media/Image;

    iget-object v5, v5, Ljg/b$a;->g:Landroid/media/Image;
    ...
    check-cast v10, Lyg/t$c;

    invoke-virtual {v10, v8}, Lyg/t$c;->b(Landroid/media/Image;)V
    ...
    check-cast v8, Lyg/t$c;

    invoke-virtual {v8, v9}, Lyg/t$c;->b(Landroid/media/Image;)V
    ...
    invoke-virtual {v8, v5}, Lyg/t$c;->b(Landroid/media/Image;)V
    ...
    invoke-virtual {v0}, Ljg/b$a;->c()Z

    move-result v2

    if-eqz v2, :cond_5

    iput-object v0, v1, Ljg/b;->i:Ljg/b$a;

    invoke-virtual {v6, v1, v3}, Lzi/a$a;->a(Ljg/b;Z)V
    ...
    iget v14, v1, Ljg/b;->b:I

    iget-boolean v15, v1, Ljg/b;->l:Z

    iget-object v10, v1, Ljg/b;->o:Ljg/d;

    const/16 v17, 0x1

    iget-boolean v11, v1, Ljg/b;->m:Z
    ...
    invoke-direct/range {v13 .. v18}, Ljg/b$a;-><init>(IZLjg/d;ZZ)V

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10, v9}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-static {v4, v10}, La0/x3;->c(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v12, v9, v10, v11}, La0/m0;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v14, v13, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v0, v0, Ljg/b$a;->d:Landroid/media/Image;
    ...
    iget-object v8, v5, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    :goto_3
    invoke-virtual {v2, v0, v3, v3}, Ljg/b$a;->d(Landroid/media/Image;IZ)V
    ...
    iget-object v0, v1, Ljg/b;->p:Lyg/d;
    ...
    iget-object v11, v10, Ljg/b$a;->d:Landroid/media/Image;

    invoke-virtual {v11}, Landroid/media/Image;->close()V

    move-object v13, v0

    check-cast v13, Lyg/t$c;

    invoke-virtual {v13, v11}, Lyg/t$c;->b(Landroid/media/Image;)V

    iget-object v11, v10, Ljg/b$a;->e:Landroid/media/Image;
    ...
    :cond_d
    iget-object v10, v10, Ljg/b$a;->g:Landroid/media/Image;

    if-eqz v10, :cond_c

    invoke-virtual {v10}, Landroid/media/Image;->close()V

    invoke-virtual {v13, v10}, Lyg/t$c;->b(Landroid/media/Image;)V
    ...
    iget-object v4, v5, Ljg/b$a;->d:Landroid/media/Image;

    invoke-virtual {v4}, Landroid/media/Image;->close()V

    check-cast v0, Lyg/t$c;

    invoke-virtual {v0, v4}, Lyg/t$c;->b(Landroid/media/Image;)V

    iput-object v8, v2, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    const/4 v0, 0x1

    iput-boolean v0, v2, Ljg/b$a;->a:Z

    iget-boolean v0, v2, Ljg/b$a;->m:Z

    if-eqz v0, :cond_f

    invoke-virtual {v2}, Ljg/b$a;->b()V

    :cond_f
    iget-boolean v0, v1, Ljg/b;->l:Z

    if-eqz v0, :cond_10

    iget-object v0, v5, Ljg/b$a;->g:Landroid/media/Image;

    iget-boolean v4, v5, Ljg/b$a;->l:Z

    const/4 v8, 0x2

    invoke-virtual {v2, v0, v8, v4}, Ljg/b$a;->d(Landroid/media/Image;IZ)V

    :cond_10
    iget-object v0, v5, Ljg/b$a;->e:Landroid/media/Image;

    const/4 v4, 0x1

    if-eqz v0, :cond_11

    invoke-virtual {v2, v0, v4, v3}, Ljg/b$a;->d(Landroid/media/Image;IZ)V

    :cond_11
    invoke-virtual {v2}, Ljg/b$a;->c()Z

    move-result v0

    if-eqz v0, :cond_12

    iput-object v2, v1, Ljg/b;->i:Ljg/b$a;

    invoke-virtual {v6, v1, v4}, Lzi/a$a;->a(Ljg/b;Z)V
    ...
    iget-object v0, v1, Ljg/b;->n:Landroid/util/Size;
    ...
    invoke-static {v13, v12, v14, v0}, La0/c0;->g(Ljava/lang/String;ILjava/lang/String;I)Ljava/lang/String;
    ...
    new-instance v10, Ljg/b$a;

    iget v15, v1, Ljg/b;->b:I

    iget-boolean v0, v1, Ljg/b;->l:Z

    iget-object v11, v1, Ljg/b;->o:Ljg/d;

    const/16 v18, 0x1

    iget-boolean v14, v1, Ljg/b;->m:Z
    ...
    invoke-direct/range {v14 .. v19}, Ljg/b$a;-><init>(IZLjg/d;ZZ)V

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0, v9}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-static {v4, v0}, La0/x3;->c(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v0, v3, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v17, Lra/z;->n1:Lra/y;

    invoke-virtual/range {v17 .. v17}, Lra/a0;->b()Ljava/lang/Object;
    ...
    iget-object v6, v3, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v3, v3, Ljg/b$a;->d:Landroid/media/Image;
    ...
    iget-object v11, v7, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v11}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getTimeStamp()J

    move-result-wide v12

    iget-object v0, v1, Ljg/b;->o:Ljg/d;
    ...
    check-cast v14, Ljg/b$a;

    iget-object v0, v14, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v18, Lra/z;->n1:Lra/y;

    invoke-virtual/range {v18 .. v18}, Lra/a0;->b()Ljava/lang/Object;
    ...
    invoke-static {v0, v3}, La0/k0;->a(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v3, v14, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v3, v14, Ljg/b$a;->e:Landroid/media/Image;
    ...
    iget-object v3, v3, Ljg/b$a;->e:Landroid/media/Image;
    ...
    invoke-virtual {v8, v0, v3, v2}, Ljg/b$a;->d(Landroid/media/Image;IZ)V
    ...
    :goto_13
    iput-object v11, v8, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-boolean v3, v8, Ljg/b$a;->a:Z

    iget-boolean v0, v8, Ljg/b$a;->m:Z

    if-eqz v0, :cond_24

    invoke-virtual {v8}, Ljg/b$a;->b()V
    ...
    iget-object v0, v7, Ljg/b$a;->g:Landroid/media/Image;

    iget-boolean v2, v7, Ljg/b$a;->l:Z
    ...
    invoke-virtual {v8, v0, v2, v2}, Ljg/b$a;->d(Landroid/media/Image;IZ)V
    ...
    :cond_28
    iget-object v9, v3, Ljg/b$a;->d:Landroid/media/Image;
    ...
    invoke-virtual {v10, v9}, Lyg/t$c;->b(Landroid/media/Image;)V

    iget-object v9, v3, Ljg/b$a;->e:Landroid/media/Image;
    ...
    :cond_29
    iget-object v3, v3, Ljg/b$a;->g:Landroid/media/Image;

    if-eqz v3, :cond_2a

    invoke-virtual {v3}, Landroid/media/Image;->close()V

    invoke-virtual {v10, v3}, Lyg/t$c;->b(Landroid/media/Image;)V
    ...
    iget-object v2, v7, Ljg/b$a;->d:Landroid/media/Image;

    invoke-virtual {v2}, Landroid/media/Image;->close()V

    check-cast v0, Lyg/t$c;

    invoke-virtual {v0, v2}, Lyg/t$c;->b(Landroid/media/Image;)V

    iget-object v2, v7, Ljg/b$a;->e:Landroid/media/Image;

    if-eqz v2, :cond_2d

    iget-object v3, v1, Ljg/b;->o:Ljg/d;
    ...
    invoke-virtual {v8, v2, v3, v0}, Ljg/b$a;->d(Landroid/media/Image;IZ)V
    ...
    iput-boolean v0, v3, Ljg/b$a;->i:Z
    ...
    iput-object v6, v1, Ljg/b;->g:Ljava/util/List;

    iget-boolean v0, v1, Ljg/b;->k:Z

    xor-int/lit8 v0, v0, 0x1

    move-object/from16 v2, v24

    invoke-virtual {v2, v1, v0}, Lzi/a$a;->a(Ljg/b;Z)V
    ...
    iput-object v8, v1, Ljg/b;->i:Ljg/b$a;
