...
.method public final onCompleted()V
    ...
    iget-object p0, p0, Lmn/p;->a:Lmn/a;
    ...
    iget-object v0, v0, Lsm/b;->k:Lorg/json/JSONObject;

    sget-object v3, Llm/a;->a:Ljava/lang/String;
    ...
    :cond_0
    sget-object v0, Lmn/a;->z:Lcom/faceunity/core/avatar/model/Avatar;

    if-eqz v0, :cond_4

    iget-object v4, p0, Lmn/a;->b:Lsm/b;

    if-eqz v4, :cond_3

    invoke-virtual {v4}, Lsm/b;->e()Ljava/util/ArrayList;

    move-result-object v4

    iget-object v5, p0, Lmn/a;->b:Lsm/b;

    if-eqz v5, :cond_2

    invoke-virtual {v5}, Lsm/b;->f()Ljava/util/HashMap;

    move-result-object v5

    iget-object v6, p0, Lmn/a;->b:Lsm/b;

    if-eqz v6, :cond_1

    invoke-virtual {v6}, Lsm/b;->g()Ljava/util/ArrayList;

    move-result-object v1

    new-instance v6, Lmm/b;

    invoke-direct {v6, v0}, Lmm/b;-><init>(Lcom/faceunity/core/avatar/model/Avatar;)V

    invoke-virtual {v6, v4, v5, v1}, Lmm/b;->a(Ljava/util/ArrayList;Ljava/util/HashMap;Ljava/util/ArrayList;)V

    iput-object v6, p0, Lmn/a;->t:Lmm/b;
    ...
    :cond_4
    iget-object v0, p0, Lmn/a;->g:Lnm/c;

    if-eqz v0, :cond_5

    iget-object v2, v0, Lnm/c;->a:Ljava/lang/String;

    :cond_5
    const-string v0, "head"

    invoke-static {v2, v0, v3}, Lzp/i;->s(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p0, v12}, Lmm/b;->c(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
