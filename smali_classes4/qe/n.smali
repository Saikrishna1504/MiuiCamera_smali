...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lqe/n;->a:Landroid/media/MediaRecorder;

    return-void
.end method

.method public static synthetic o(Lqe/n;Lqe/g$b;Landroid/media/MediaRecorder;II)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lqe/n;->r(Lqe/g$b;Landroid/media/MediaRecorder;II)V

    return-void
.end method

.method public static synthetic p(Lqe/n;Lqe/g$a;Landroid/media/MediaRecorder;II)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lqe/n;->q(Lqe/g$a;Landroid/media/MediaRecorder;II)V

    return-void
.end method

.method private synthetic q(Lqe/g$a;Landroid/media/MediaRecorder;II)V
    .locals 0

    if-eqz p1, :cond_0

    invoke-interface {p1, p0, p3, p4}, Lqe/g$a;->a(Lqe/g;II)V

    :cond_0
    return-void
.end method

.method private synthetic r(Lqe/g$b;Landroid/media/MediaRecorder;II)V
    .locals 0

    if-eqz p1, :cond_0

    invoke-interface {p1, p0, p3, p4}, Lqe/g$b;->b(Lqe/g;II)V
...
.method public static t(Landroid/media/MediaRecorder;Lqe/h;)Landroid/media/MediaRecorder;
    .locals 4
    ...
    :cond_3
    invoke-virtual {p1}, Lqe/h;->L()Landroid/util/Pair;
    ...
    :cond_5
    invoke-virtual {p1}, Lqe/h;->R()Z

    move-result v0

    if-eqz v0, :cond_9

    invoke-virtual {p1}, Lqe/h;->x()I
    ...
    :cond_d
    invoke-virtual {p1}, Lqe/h;->E()Landroid/util/Pair;
    ...
    :cond_e
    invoke-virtual {p1}, Lqe/h;->D()Ljava/util/List;
    ...
    invoke-static {p0, v1}, Lqe/n;->s(Landroid/media/MediaRecorder;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lqe/n;->s(Landroid/media/MediaRecorder;Ljava/lang/String;)V
...
.method public a()Landroid/media/MediaRecorder;
    ...
    iget-object p0, p0, Lqe/n;->a:Landroid/media/MediaRecorder;
...
.method public b(Lqe/h;)V
    ...
    invoke-static {p0, p1}, Lqe/n;->t(Landroid/media/MediaRecorder;Lqe/h;)Landroid/media/MediaRecorder;
...
.method public h(Lqe/g$a;)V
    ...
    iget-object v0, p0, Lqe/n;->a:Landroid/media/MediaRecorder;

    new-instance v1, Lqe/l;

    invoke-direct {v1, p0, p1}, Lqe/l;-><init>(Lqe/n;Lqe/g$a;)V
...
.method public m(Lqe/g$b;)V
    ...
    invoke-direct {v1, p0, p1}, Lqe/m;-><init>(Lqe/n;Lqe/g$b;)V
