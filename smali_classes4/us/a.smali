...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lus/a;->b:Landroid/content/Context;

    const/4 v2, 0x1

    iput-boolean v2, p0, Lus/a;->d:Z

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v3

    sget v4, Lqs/c;->miuix_appcompat_arrow_popup_window_list_max_height:I

    invoke-virtual {v3, v4}, Landroid/content/res/Resources;->getDimensionPixelOffset(I)I

    move-result v3

    iput v3, p0, Lus/a;->c:I

    invoke-static {p1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object p1

    sget v3, Lqs/f;->miuix_appcompat_arrow_popup_view:I
    ...
    iput-object p1, p0, Lus/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;
    ...
    invoke-virtual {p1, p0}, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->setArrowPopupWindow(Lus/a;)V
    ...
    invoke-direct {v4, p1}, Lts/a;-><init>(Lmiuix/popupwidget/internal/widget/ArrowPopupView;)V
    ...
    invoke-direct {v5, p1}, Lts/b;-><init>(Lmiuix/popupwidget/internal/widget/ArrowPopupView;)V
    ...
    iput v3, p1, Lus/c;->f:I

    invoke-virtual {p1, v2}, Landroid/widget/PopupWindow;->setFocusable(Z)V

    iget-object v3, p1, Lus/a;->b:Landroid/content/Context;

    invoke-static {v3}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v3

    sget v4, Lqs/f;->miuix_appcompat_guide_popup_content_view:I
    ...
    iput-object v0, p1, Lus/c;->e:Landroid/widget/LinearLayout;

    invoke-virtual {p1, v0}, Lus/a;->setContentView(Landroid/view/View;)V

    iget-object v0, p1, Lus/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;

    iput-boolean v1, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->m0:Z

    iget-object v0, p1, Lus/c;->e:Landroid/widget/LinearLayout;
    ...
    invoke-direct {v1, p1}, Lus/b;-><init>(Lus/c;)V
...
.method public final b(I)V
    ...
    iget-object v1, p0, Lus/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;
    ...
    :cond_1
    invoke-virtual {p0}, Lus/a;->getContentView()Landroid/view/View;
...
.method public final setHeight(I)V
    ...
    invoke-virtual {p0, p1}, Lus/a;->b(I)V
...
.method public final showAsDropDown(Landroid/view/View;II)V
    ...
    .line 1
    invoke-virtual {p0, p2, p1, p3}, Lus/a;->c(ILandroid/view/View;I)V
...
.method public final update(IIIIZ)V
    ...
    invoke-virtual {p0, p4}, Lus/a;->b(I)V
