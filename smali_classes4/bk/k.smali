...
.method public static constructor <clinit>()V
    ...
    :goto_0
    sput-object v1, Lbk/k;->b:[Ljava/lang/Float;
    ...
    :cond_1
    sget-object v1, Lca/j;->a:Landroid/util/Range;

    :goto_1
    iget-object v0, v0, Luc/b;->e:L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;

    invoke-virtual {v0}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->Z0()Landroid/util/Range;
    ...
    :goto_2
    sput-object v1, Lbk/k;->c:Landroid/util/Range;

    const/4 v0, 0x0

    sput-object v0, Lbk/k;->d:Ljava/lang/Boolean;
...
.method public static b()Ljava/util/List;
    ...
    invoke-virtual {v3, v2}, Li7/e;->N(I)Lea/c;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-static {v3}, Lea/d;->N3(Lea/c;)Z
...
.method public static c()F
    ...
    :cond_1
    invoke-virtual {v0}, Lea/c;->z()Ljava/lang/Float;
...
.method public static f(FI)F
    ...
    iget v3, v2, Lwc/a;->b:F

    cmpl-float v3, p0, v3

    if-nez v3, :cond_1

    iget p0, v2, Lwc/a;->c:F
...
.method public static g(Landroid/graphics/Rect;Landroid/hardware/camera2/CaptureResult;)F
    ...
    invoke-static {p0, p1}, Lfk/e;->Q(Landroid/graphics/Rect;Landroid/graphics/Rect;)F
...
.method public static j(Lea/a;Ljava/util/HashMap;F)Z
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, v7}, La0/v3;->e(Ljava/lang/String;Z)Ljava/lang/String;
...
.method public static k(ZIZ[Ljava/lang/Float;)[Ljava/lang/Float;
    ...
    invoke-virtual {p0}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->s1()Landroid/util/SparseArray;
...
.method public static l(Landroid/graphics/Rect;F)Landroid/graphics/Rect;
    ...
    invoke-static {v1}, Lea/d;->g4(Lea/c;)Z
