...
.field public final synthetic f:Loe/a;


# direct methods
.method public constructor <init>(Loe/a;Ljava/net/Socket;)V
    .locals 3
    ...
    iput-object p1, p0, Loe/a$g;->f:Loe/a;
    ...
    iput-object v0, p0, Loe/a$g;->a:Ljava/lang/String;

    iput-object p2, p0, Loe/a$g;->b:Ljava/net/Socket;
    ...
    invoke-static {p0, p1}, Lpe/a;->d(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public static synthetic a(Loe/a$g;)Lnet/majorkernelpanic/streaming/Session;
    .locals 0

    iget-object p0, p0, Loe/a$g;->e:Lnet/majorkernelpanic/streaming/Session;

    return-object p0
.end method

.method public static synthetic b(Loe/a$g;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
# virtual methods
.method public final c(Loe/a$b;)Z
    .locals 3

    iget-object p1, p1, Loe/a$b;->c:Ljava/util/HashMap;
    ...
    iget-object v0, p0, Loe/a$g;->f:Loe/a;

    invoke-static {v0}, Loe/a;->h(Loe/a;)Ljava/lang/String;
    ...
    invoke-static {v0}, Loe/a;->i(Loe/a;)Ljava/lang/String;
    ...
    iget-object v2, p0, Loe/a$g;->f:Loe/a;

    invoke-static {v2}, Loe/a;->h(Loe/a;)Ljava/lang/String;
    ...
    iget-object p0, p0, Loe/a$g;->f:Loe/a;

    invoke-static {p0}, Loe/a;->i(Loe/a;)Ljava/lang/String;
...
.method public d(Loe/a$b;)Loe/a$d;
    .locals 14
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    new-instance v0, Loe/a$d;

    invoke-direct {v0, p1}, Loe/a$d;-><init>(Loe/a$b;)V

    iget-object v1, p0, Loe/a$g;->f:Loe/a;

    invoke-static {v1}, Loe/a;->b(Loe/a;)Ljava/util/Map;
    ...
    :try_start_0
    iget-object v2, p0, Loe/a$g;->a:Ljava/lang/String;
    ...
    invoke-static {v2}, Loe/a;->b(Loe/a;)Ljava/util/Map;
    ...
    iget-object v6, p0, Loe/a$g;->a:Ljava/lang/String;
    ...
    invoke-static {v5}, Lpe/a;->g(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v6, v7}, Lpe/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v6, p0, Loe/a$g;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iput-object p1, v0, Loe/a$d;->c:Ljava/lang/String;
    ...
    iput-object p0, v0, Loe/a$d;->b:Ljava/lang/String;

    const-string p0, "400 Bad Request"

    iput-object p0, v0, Loe/a$d;->a:Ljava/lang/String;

    return-object v0

    :cond_2
    invoke-virtual {p0, p1}, Loe/a$g;->c(Loe/a$b;)Z

    move-result v1

    if-nez v1, :cond_3

    iget-object v1, p1, Loe/a$b;->a:Ljava/lang/String;
    ...
    iput-object p0, v0, Loe/a$d;->c:Ljava/lang/String;
    ...
    iget-object p1, p1, Loe/a$b;->b:Ljava/lang/String;

    iget-object v2, p0, Loe/a$g;->b:Ljava/net/Socket;

    invoke-virtual {v1, p1, v2}, Loe/a;->n(Ljava/lang/String;Ljava/net/Socket;)Lnet/majorkernelpanic/streaming/Session;

    move-result-object p1

    iput-object p1, p0, Loe/a$g;->e:Lnet/majorkernelpanic/streaming/Session;

    iget-object p1, p0, Loe/a$g;->a:Ljava/lang/String;
    ...
    iget-object v2, p0, Loe/a$g;->e:Lnet/majorkernelpanic/streaming/Session;

    invoke-static {v2}, Lpe/a;->g(Ljava/lang/Object;)Ljava/lang/String;
    ...
    iget-object p1, p0, Loe/a$g;->f:Loe/a;

    invoke-static {p1}, Loe/a;->b(Loe/a;)Ljava/util/Map;
    ...
    iget-object v3, p0, Loe/a$g;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object p1, p0, Loe/a$g;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object p0, p0, Loe/a$g;->b:Ljava/net/Socket;
    ...
    iput-object p1, v0, Loe/a$d;->b:Ljava/lang/String;
    ...
    iget-object v5, p1, Loe/a$b;->b:Ljava/lang/String;
    ...
    iget-object v5, p0, Loe/a$g;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v7, p0, Loe/a$g;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v8, p0, Loe/a$g;->e:Lnet/majorkernelpanic/streaming/Session;

    invoke-virtual {v8}, Lnet/majorkernelpanic/streaming/Session;->getDestination()Ljava/lang/String;

    move-result-object v8

    iget-object v9, p0, Loe/a$g;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v10, p0, Loe/a$g;->a:Ljava/lang/String;
    ...
    invoke-static {v10, v11}, Lpe/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v10, p0, Loe/a$g;->f:Loe/a;
    ...
    :try_start_4
    invoke-static {}, Loe/a;->e()Z

    move-result v11

    if-eqz v11, :cond_c

    iget-object v11, p0, Loe/a$g;->f:Loe/a;

    iget-object v12, v11, Loe/a;->k:Landroid/media/MediaCodec;

    if-nez v12, :cond_a

    iget-object v11, p0, Loe/a$g;->a:Ljava/lang/String;

    const-string v12, "create shared video codec"

    invoke-static {v11, v12}, Lpe/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v11, p0, Loe/a$g;->f:Loe/a;

    iget-object v12, p0, Loe/a$g;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v13, p0, Loe/a$g;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    invoke-virtual {v11, v12, v13}, Loe/a;->k(Landroid/content/SharedPreferences;Lnet/majorkernelpanic/streaming/video/VideoQuality;)V

    goto :goto_2

    :cond_a
    iget-object v11, v11, Loe/a;->j:Lnet/majorkernelpanic/streaming/video/VideoQuality;
    ...
    iget-object v10, p0, Loe/a$g;->e:Lnet/majorkernelpanic/streaming/Session;

    invoke-virtual {v10, v1}, Lnet/majorkernelpanic/streaming/Session;->syncStart(I)V

    iget-object v1, p0, Loe/a$g;->a:Ljava/lang/String;
    ...
    iget-object v11, p0, Loe/a$g;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    invoke-static {v1, v10}, Lpe/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    if-nez v9, :cond_e

    iget-object v1, p0, Loe/a$g;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    invoke-static {v1, v9}, Lpe/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Loe/a$g;->f:Loe/a;

    iget-object v9, p0, Loe/a$g;->e:Lnet/majorkernelpanic/streaming/Session;

    invoke-virtual {v1, v9, v4}, Loe/a;->p(Lnet/majorkernelpanic/streaming/Session;I)V
    ...
    iget-object p1, p0, Loe/a$g;->b:Ljava/net/Socket;
    ...
    invoke-static {p0}, Lpe/a;->g(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lpe/a;->g(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v1}, Loe/a;->g(Loe/a;)Loe/a$e;
    ...
    invoke-static {p0}, Loe/a;->g(Loe/a;)Loe/a$e;

    move-result-object p0

    iget-object p1, p1, Loe/a$b;->d:Ljava/lang/String;

    invoke-interface {p0, p1}, Loe/a$e;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_19
    iget-object p0, p0, Loe/a$g;->a:Ljava/lang/String;
...
.method public final declared-synchronized e()V
    ...
    iget-object v1, p0, Loe/a$g;->c:Ljava/io/OutputStream;
...
.method public run()V
    ...
    :try_start_0
    iget-object v4, p0, Loe/a$g;->d:Ljava/io/BufferedReader;

    invoke-static {v4}, Loe/a$b;->a(Ljava/io/BufferedReader;)Loe/a$b;
    ...
    invoke-static {v2, v4}, Lpe/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v2, Loe/a$d;

    invoke-direct {v2}, Loe/a$d;-><init>()V

    const-string v4, "400 Bad Request"

    iput-object v4, v2, Loe/a$d;->a:Ljava/lang/String;
    ...
    :try_start_1
    invoke-virtual {p0, v3}, Loe/a$g;->d(Loe/a$b;)Loe/a$d;
    ...
    iget-object v5, p0, Loe/a$g;->a:Ljava/lang/String;
    ...
    :goto_2
    invoke-static {v5, v2}, Lpe/a;->d(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, p0, Loe/a$g;->f:Loe/a;

    invoke-virtual {v2, v4}, Loe/a;->o(I)V

    new-instance v2, Loe/a$d;

    invoke-direct {v2, v3}, Loe/a$d;-><init>(Loe/a$b;)V
    ...
    iget-object v3, p0, Loe/a$g;->a:Ljava/lang/String;
    ...
    invoke-static {v3, v4}, Lpe/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_3
    iget-object v3, p0, Loe/a$g;->c:Ljava/io/OutputStream;

    invoke-virtual {v2, v3}, Loe/a$d;->a(Ljava/io/OutputStream;)V
    ...
    :catch_2
    iget-object v0, p0, Loe/a$g;->a:Ljava/lang/String;

    const-string v1, "Response was not sent properly"

    invoke-static {v0, v1}, Lpe/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, v4}, Lpe/a;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_5
    :goto_4
    iget-object v0, p0, Loe/a$g;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    invoke-virtual {v0, v1, v2}, Loe/a;->p(Lnet/majorkernelpanic/streaming/Session;I)V

    :cond_6
    iget-object v0, p0, Loe/a$g;->f:Loe/a;

    invoke-static {v0}, Loe/a;->b(Loe/a;)Ljava/util/Map;
    ...
    :try_start_6
    iget-object v0, p0, Loe/a$g;->b:Ljava/net/Socket;
    ...
    invoke-static {p0, v0}, Lpe/a;->f(Ljava/lang/String;Ljava/lang/String;)V
