...
.field public h:Loe/a$c;

.field public final i:Loe/a$e;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Loe/a;->o:Ljava/lang/String;
    ...
    sput-object v0, Loe/a;->p:Lnet/majorkernelpanic/streaming/video/VideoQuality;
    ...
    sput-boolean v0, Loe/a;->r:Z

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Loe/a$e;)V
    .locals 2
    ...
    iput-object v0, p0, Loe/a;->a:Ljava/util/Map;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Loe/a;->b:Ljava/util/LinkedList;

    new-instance v0, Loe/a$a;

    invoke-direct {v0, p0}, Loe/a$a;-><init>(Loe/a;)V

    iput-object v0, p0, Loe/a;->n:Landroid/media/MediaCodec$Callback;

    iput-object p2, p0, Loe/a;->i:Loe/a$e;
    ...
    iput-boolean p2, p0, Loe/a;->f:Z

    const/4 p2, 0x0

    iput-boolean p2, p0, Loe/a;->g:Z
    ...
    sget-object p1, Loe/a;->p:Lnet/majorkernelpanic/streaming/video/VideoQuality;
...
.method public static synthetic a()Ljava/lang/String;
    ...
    sget-object v0, Loe/a;->o:Ljava/lang/String;

    return-object v0
.end method

.method public static synthetic b(Loe/a;)Ljava/util/Map;
    .locals 0

    iget-object p0, p0, Loe/a;->a:Ljava/util/Map;
...
.method public static synthetic c(Ljava/io/BufferedReader;[CI)I
    ...
    invoke-static {p0, p1, p2}, Loe/a;->q(Ljava/io/BufferedReader;[CI)I
...
.method public static synthetic d(Loe/a;)I
    .locals 0

    iget p0, p0, Loe/a;->e:I
...
.method public static synthetic f()Z
    ...
    sget-boolean v0, Loe/a;->r:Z

    return v0
.end method

.method public static synthetic g(Loe/a;)Loe/a$e;
    .locals 0

    iget-object p0, p0, Loe/a;->i:Loe/a$e;

    return-object p0
.end method

.method public static synthetic h(Loe/a;)Ljava/lang/String;
    .locals 0

    iget-object p0, p0, Loe/a;->c:Ljava/lang/String;

    return-object p0
.end method

.method public static synthetic i(Loe/a;)Ljava/lang/String;
    .locals 0

    iget-object p0, p0, Loe/a;->d:Ljava/lang/String;
...
# virtual methods
.method public j(Loe/a$f;)V
    .locals 3

    iget-object v0, p0, Loe/a;->b:Ljava/util/LinkedList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Loe/a;->b:Ljava/util/LinkedList;
    ...
    :cond_1
    iget-object p0, p0, Loe/a;->b:Ljava/util/LinkedList;
...
.method public declared-synchronized k(Landroid/content/SharedPreferences;Lnet/majorkernelpanic/streaming/video/VideoQuality;)V
    ...
    :try_start_0
    invoke-virtual {p0, p2}, Loe/a;->l(Lnet/majorkernelpanic/streaming/video/VideoQuality;)Landroid/media/MediaFormat;

    move-result-object v0

    sget-object v1, Loe/a;->o:Ljava/lang/String;
    ...
    iput-object p1, p0, Loe/a;->k:Landroid/media/MediaCodec;
    ...
    iget-object p1, p0, Loe/a;->k:Landroid/media/MediaCodec;

    invoke-virtual {p1}, Landroid/media/MediaCodec;->createInputSurface()Landroid/view/Surface;

    move-result-object p1

    iput-object p1, p0, Loe/a;->l:Landroid/view/Surface;
    ...
    iput-object p1, p0, Loe/a;->m:Landroid/os/HandlerThread;

    invoke-virtual {p1}, Ljava/lang/Thread;->start()V

    iget-object p1, p0, Loe/a;->k:Landroid/media/MediaCodec;

    iget-object v0, p0, Loe/a;->n:Landroid/media/MediaCodec$Callback;

    new-instance v1, Landroid/os/Handler;

    iget-object v2, p0, Loe/a;->m:Landroid/os/HandlerThread;
    ...
    iput-object p1, p0, Loe/a;->j:Lnet/majorkernelpanic/streaming/video/VideoQuality;
    :try_end_0
    ...
    :try_start_1
    sget-object p2, Loe/a;->o:Ljava/lang/String;
    ...
    iget-object v1, p0, Loe/a;->j:Lnet/majorkernelpanic/streaming/video/VideoQuality;
    ...
    invoke-static {p2, v0, p1}, Lpe/a;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-virtual {p0}, Loe/a;->r()V
    :try_end_1
...
.method public m()Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v0, p0, Loe/a;->a:Ljava/util/Map;
    ...
    sget-object p0, Loe/a;->o:Ljava/lang/String;
...
.method public o(I)V
    ...
    iget-object v2, p0, Loe/a;->b:Ljava/util/LinkedList;
    ...
    invoke-static {v0, p0}, Lke/e;->t(Landroid/os/Bundle;I)V
    ...
    check-cast v1, Loe/a$f;

    sget-object v2, Loe/a;->o:Ljava/lang/String;
    ...
    invoke-interface {v1, p1, v0}, Loe/a$f;->a(ILandroid/os/Bundle;)V
...
.method public p(Lnet/majorkernelpanic/streaming/Session;I)V
    ...
    invoke-static {v2, v0}, Lke/e;->r(Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    iget-object p1, p0, Loe/a;->j:Lnet/majorkernelpanic/streaming/video/VideoQuality;
    ...
    iget-object p0, p0, Loe/a;->l:Landroid/view/Surface;
    ...
    :goto_0
    invoke-static {v2, v0, v3}, Lke/e;->v(Landroid/os/Bundle;II)V

    invoke-static {v2, p1}, Lke/e;->u(Landroid/os/Bundle;I)V

    invoke-static {v2, p0}, Lke/e;->m(Landroid/os/Bundle;Landroid/view/Surface;)V

    invoke-virtual {p0}, Ljava/lang/Object;->hashCode()I

    move-result p0

    invoke-static {v2, p0}, Lke/e;->n(Landroid/os/Bundle;I)V
    ...
    invoke-interface {p1, p2, v2}, Loe/a$f;->b(ILandroid/os/Bundle;)V
    ...
    invoke-static {v2, p0}, Lpe/a;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public declared-synchronized r()V
    ...
    :try_start_0
    iput-object v0, p0, Loe/a;->l:Landroid/view/Surface;

    iput-object v0, p0, Loe/a;->j:Lnet/majorkernelpanic/streaming/video/VideoQuality;

    iget-object v1, p0, Loe/a;->m:Landroid/os/HandlerThread;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Landroid/os/HandlerThread;->quit()Z

    iput-object v0, p0, Loe/a;->m:Landroid/os/HandlerThread;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :cond_0
    :try_start_1
    iget-object v1, p0, Loe/a;->k:Landroid/media/MediaCodec;

    iput-object v0, p0, Loe/a;->k:Landroid/media/MediaCodec;
...
.method public u()V
    ...
    iget-boolean v0, p0, Loe/a;->f:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Loe/a;->g:Z

    if-eqz v0, :cond_1

    :cond_0
    invoke-virtual {p0}, Loe/a;->v()V
    ...
    iget-object v0, p0, Loe/a;->h:Loe/a$c;

    if-nez v0, :cond_2

    :try_start_0
    new-instance v0, Loe/a$c;

    invoke-direct {v0, p0}, Loe/a$c;-><init>(Loe/a;)V

    iput-object v0, p0, Loe/a;->h:Loe/a$c;

    invoke-virtual {v0}, Loe/a$c;->b()V
    :try_end_0
...
.method public v()V
    ...
    :try_start_1
    iget-object v2, p0, Loe/a;->a:Ljava/util/Map;
    ...
    iput-object v1, p0, Loe/a;->h:Loe/a$c;
