...
.field public j:Lsd/s$a;

.field public k:Lsd/s$b;

.field public l:Lsd/s$c;

.field public m:Lsd/s$d;
...
.method public constructor <init>(Lsd/n;)V
    ...
    iput-object v0, p0, Lsd/s;->i:Ljava/lang/StringBuilder;

    iput-object p1, p0, Lsd/s;->g:Lsd/n;
    ...
    invoke-virtual {p1}, Lsd/n;->b()Ljava/lang/String;
    ...
    iput-object p1, p0, Lsd/s;->e:Ljava/lang/String;

    return-void
.end method

.method public static synthetic a(Lsd/s;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lsd/s;->f(Ljava/lang/String;)V

    return-void
.end method

.method public static synthetic b(Lsd/s;Ltv/danmaku/ijk/media/player/IjkMediaPlayer;Landroid/os/HandlerThread;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lsd/s;->g(Ltv/danmaku/ijk/media/player/IjkMediaPlayer;Landroid/os/HandlerThread;)V
...
.method private synthetic f(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lsd/s;->e:Ljava/lang/String;
    ...
    iput-object v0, p0, Lsd/s;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    invoke-virtual {p0, v0}, Lsd/s;->c(Ltv/danmaku/ijk/media/player/IjkMediaPlayer;)V
    ...
    iget-object p1, p0, Lsd/m;->d:Landroid/view/Surface;
    ...
    iget-object p0, p0, Lsd/s;->e:Ljava/lang/String;
...
.method private synthetic g(Ltv/danmaku/ijk/media/player/IjkMediaPlayer;Landroid/os/HandlerThread;)V
    ...
    iget-object v3, p0, Lsd/s;->g:Lsd/n;

    invoke-virtual {v3}, Lsd/n;->c()Ljava/lang/String;
    ...
    iget-object p1, p0, Lsd/s;->e:Ljava/lang/String;
    ...
    iget-object p0, p0, Lsd/s;->g:Lsd/n;

    invoke-virtual {p0}, Lsd/n;->c()Ljava/lang/String;
...
.method public d()Ljava/lang/String;
    ...
    iget-object v1, v0, Lsd/s;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    invoke-virtual {v1}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->getBitRate()J

    move-result-wide v1

    iget-object v3, v0, Lsd/s;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    invoke-virtual {v3}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->getVideoCachedBytes()J

    move-result-wide v3

    iget-object v5, v0, Lsd/s;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    invoke-virtual {v5}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->getVideoCachedPackets()J

    move-result-wide v5

    iget-object v7, v0, Lsd/s;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    invoke-virtual {v7}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->getVideoCachedDuration()J

    move-result-wide v7

    iget-object v9, v0, Lsd/s;->i:Ljava/lang/StringBuilder;

    const/4 v10, 0x0

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->setLength(I)V

    iget-object v9, v0, Lsd/s;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    ...
    iget-object v14, v0, Lsd/s;->i:Ljava/lang/StringBuilder;
    ...
    iget-object v15, v0, Lsd/s;->i:Ljava/lang/StringBuilder;
    ...
    iget-object v12, v0, Lsd/s;->i:Ljava/lang/StringBuilder;
    ...
    iget-object v12, v0, Lsd/s;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    ...
    :goto_0
    iget-object v5, v0, Lsd/s;->i:Ljava/lang/StringBuilder;
    ...
    iget-object v1, v0, Lsd/s;->i:Ljava/lang/StringBuilder;
    ...
    invoke-static {v7, v8}, Lsd/t;->b(J)Ljava/lang/String;

    move-result-object v5

    aput-object v5, v2, v10

    invoke-static {v3, v4}, Lsd/t;->c(J)Ljava/lang/String;
    ...
    iget-object v0, v0, Lsd/s;->i:Ljava/lang/StringBuilder;
...
.method public e()Z
    ...
    iget-object p0, p0, Lsd/s;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
...
.method public j()V
    ...
    iget-object v0, p0, Lsd/s;->g:Lsd/n;

    invoke-virtual {v0}, Lsd/n;->c()Ljava/lang/String;
    ...
    iput-wide v1, p0, Lsd/s;->h:J

    invoke-virtual {p0}, Lsd/s;->k()V
    ...
    iput-object v1, p0, Lsd/m;->a:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Ljava/lang/Thread;->start()V

    new-instance v1, Landroid/os/Handler;

    iget-object v2, p0, Lsd/m;->a:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Lsd/m;->b:Landroid/os/Handler;
    ...
    iput-object v1, p0, Lsd/m;->c:Landroid/os/Handler;

    iget-object v1, p0, Lsd/m;->b:Landroid/os/Handler;

    new-instance v2, Lsd/p;

    invoke-direct {v2, p0, v0}, Lsd/p;-><init>(Lsd/s;Ljava/lang/String;)V
...
.method public k()V
    ...
    iget-object v0, p0, Lsd/m;->a:Landroid/os/HandlerThread;

    if-eqz v0, :cond_0

    iget-object v1, p0, Lsd/s;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    if-eqz v1, :cond_0

    iget-object v2, p0, Lsd/m;->b:Landroid/os/Handler;

    new-instance v3, Lsd/r;

    invoke-direct {v3, p0, v1, v0}, Lsd/r;-><init>(Lsd/s;Ltv/danmaku/ijk/media/player/IjkMediaPlayer;Landroid/os/HandlerThread;)V
...
.method public l(Lsd/s$a;)V
    .locals 0

    iput-object p1, p0, Lsd/s;->j:Lsd/s$a;

    return-void
.end method

.method public m(Lsd/s$b;)V
    .locals 0

    iput-object p1, p0, Lsd/s;->k:Lsd/s$b;

    return-void
.end method

.method public n(Lsd/s$c;)V
    .locals 0

    iput-object p1, p0, Lsd/s;->l:Lsd/s$c;

    return-void
.end method

.method public o(Lsd/s$d;)V
    .locals 0

    iput-object p1, p0, Lsd/s;->m:Lsd/s$d;
...
.method public onInfo(Ltv/danmaku/ijk/media/player/IMediaPlayer;II)Z
    ...
    invoke-direct {p2, p0}, Lsd/q;-><init>(Lsd/s;)V
...
.method public p(Landroid/view/Surface;)V
    ...
    :cond_0
    iput-object p1, p0, Lsd/m;->d:Landroid/view/Surface;
