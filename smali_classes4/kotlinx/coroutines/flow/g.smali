...
# direct methods
.method public static final synthetic a(Lkotlinx/coroutines/flow/d;Lzk/r;ZLgk/d;)Ljava/lang/Object;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lkotlinx/coroutines/flow/g;->c(Lkotlinx/coroutines/flow/d;Lzk/r;ZLgk/d;)Ljava/lang/Object;
...
.method public static final b(Lkotlinx/coroutines/flow/d;Lzk/r;Lgk/d;)Ljava/lang/Object;
    .locals 1
    ...
    invoke-static {p0, p1, v0, p2}, Lkotlinx/coroutines/flow/g;->c(Lkotlinx/coroutines/flow/d;Lzk/r;ZLgk/d;)Ljava/lang/Object;
...
.method public static final c(Lkotlinx/coroutines/flow/d;Lzk/r;ZLgk/d;)Ljava/lang/Object;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p3}, Lkotlinx/coroutines/flow/g$a;-><init>(Lgk/d;)V
    ...
    :try_start_0
    invoke-static {p3}, Lck/l;->b(Ljava/lang/Object;)V
    :try_end_0
    ...
    invoke-virtual {p3}, Lzk/i;->j()Ljava/lang/Object;
    ...
    invoke-interface {p1, v0}, Lzk/r;->c(Lgk/d;)Ljava/lang/Object;
    ...
    :goto_2
    :try_start_3
    invoke-static {p3}, Lzk/i;->h(Ljava/lang/Object;)Z

    move-result v2

    if-eqz v2, :cond_8

    invoke-static {p3}, Lzk/i;->e(Ljava/lang/Object;)Ljava/lang/Throwable;
    ...
    invoke-static {p1, p0}, Lzk/j;->a(Lzk/r;Ljava/lang/Throwable;)V
    ...
    :cond_8
    invoke-static {p3}, Lzk/i;->f(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {p2, p3, v0}, Lkotlinx/coroutines/flow/d;->emit(Ljava/lang/Object;Lgk/d;)Ljava/lang/Object;
    ...
    invoke-static {p1, p2}, Lzk/j;->a(Lzk/r;Ljava/lang/Throwable;)V
