...
.field public final synthetic c:Lxk/q0;
...
# direct methods
.method public constructor <init>(Lxk/f0;I)V
    .locals 0

    invoke-direct {p0}, Lxk/f0;-><init>()V

    iput-object p1, p0, Lkotlinx/coroutines/internal/k;->a:Lxk/f0;

    iput p2, p0, Lkotlinx/coroutines/internal/k;->b:I

    instance-of p2, p1, Lxk/q0;

    if-eqz p2, :cond_0

    check-cast p1, Lxk/q0;
    ...
    :cond_1
    iput-object p1, p0, Lkotlinx/coroutines/internal/k;->c:Lxk/q0;
...
.method public dispatch(Lgk/g;Ljava/lang/Runnable;)V
    ...
    iget-object p1, p0, Lkotlinx/coroutines/internal/k;->a:Lxk/f0;

    invoke-virtual {p1, p0, p0}, Lxk/f0;->dispatch(Lgk/g;Ljava/lang/Runnable;)V
...
.method public dispatchYield(Lgk/g;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p1, p0, p0}, Lxk/f0;->dispatchYield(Lgk/g;Ljava/lang/Runnable;)V
...
.method public e(JLxk/n;)V
    ...
    iget-object p0, p0, Lkotlinx/coroutines/internal/k;->c:Lxk/q0;

    invoke-interface {p0, p1, p2, p3}, Lxk/q0;->e(JLxk/n;)V
...
.method public limitedParallelism(I)Lxk/f0;
    ...
    :cond_0
    invoke-super {p0, p1}, Lxk/f0;->limitedParallelism(I)Lxk/f0;
...
.method public run()V
    ...
    sget-object v3, Lgk/h;->a:Lgk/h;

    invoke-static {v3, v2}, Lxk/i0;->a(Lgk/g;Ljava/lang/Throwable;)V
    ...
    iget-object v2, p0, Lkotlinx/coroutines/internal/k;->a:Lxk/f0;

    invoke-virtual {v2, p0}, Lxk/f0;->isDispatchNeeded(Lgk/g;)Z

    move-result v2

    if-eqz v2, :cond_0

    iget-object v0, p0, Lkotlinx/coroutines/internal/k;->a:Lxk/f0;

    invoke-virtual {v0, p0, p0}, Lxk/f0;->dispatch(Lgk/g;Ljava/lang/Runnable;)V
