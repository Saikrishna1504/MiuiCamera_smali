...
.method public constructor <init>(Lso/b;)V
    ...
    iput-object v0, p0, Lso/b$b;->a:Ljava/lang/ref/WeakReference;
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    iget-object p0, p0, Lso/b$b;->a:Ljava/lang/ref/WeakReference;
    ...
    iget-object p1, p0, Lso/b;->d:Lso/b$a;
    ...
    check-cast p1, Lyo/e$b;

    iget-object p1, p1, Lyo/e$b;->a:Lyo/e$a;
    ...
    :try_start_0
    iget-object v2, p1, Lcom/android/camera/module/video/h;->b:Lso/f;
    ...
    iput-object v0, p1, Lcom/android/camera/module/video/h;->b:Lso/f;
    ...
    :cond_3
    :goto_0
    iput-object v0, p0, Lso/b;->d:Lso/b$a;

    :cond_4
    iget p1, p0, Lso/b;->e:I
    ...
    :cond_8
    iget p1, p0, Lso/b;->t:I

    const-string v2, "ComputeRenderThread"

    invoke-static {p1, v2}, Lcom/xiaomi/gl/MIGL;->glDeleteProgram(ILjava/lang/String;)V

    iput v1, p0, Lso/b;->t:I

    iget p1, p0, Lso/b;->u:I

    const-string v2, "ComputeRenderThread"

    invoke-static {p1, v2}, Lcom/xiaomi/gl/MIGL;->glDeleteProgram(ILjava/lang/String;)V

    iput v1, p0, Lso/b;->u:I

    iget-object p1, p0, Lso/b;->b:Landroid/graphics/SurfaceTexture;
    ...
    iput-object v0, p0, Lso/b;->b:Landroid/graphics/SurfaceTexture;

    :cond_9
    iget-object p1, p0, Lso/b;->l:Lso/d;
    ...
    invoke-virtual {p1}, Lso/e;->d()Z

    iget-object p1, p0, Lso/b;->m:Lso/c;

    iget-object p1, p1, Lso/c;->a:Landroid/opengl/EGLDisplay;

    iget-object v2, p0, Lso/b;->l:Lso/d;

    iget-object v2, v2, Lso/e;->b:Landroid/opengl/EGLSurface;

    invoke-static {p1, v2}, Landroid/opengl/EGL14;->eglDestroySurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;)Z

    iput-object v0, p0, Lso/b;->l:Lso/d;
    ...
    invoke-virtual {p1}, Lso/c;->a()V

    iput-object v0, p0, Lso/b;->m:Lso/c;

    :cond_b
    iget-object p1, p0, Lso/b;->a:Lso/b$b;
