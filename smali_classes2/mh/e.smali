...
# direct methods
.method public varargs constructor <init>(Ljava/lang/String;Lpj/a$a;Lpj/a$a;Z[Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lmh/c;-><init>(Ljava/lang/String;Lpj/a$a;)V

    new-instance p2, Ljava/util/HashSet;

    invoke-direct {p2}, Ljava/util/HashSet;-><init>()V

    iput-object p2, p0, Lmh/e;->f:Ljava/util/HashSet;

    iput-boolean p4, p0, Lmh/e;->g:Z

    new-instance p4, Llh/d;

    invoke-direct {p4, p3}, Llh/d;-><init>(Lpj/a$a;)V

    iput-object p4, p0, Lmh/e;->e:Llh/d;
...
.method public final a()Lmh/b;
    ...
    iget-object p0, p0, Lmh/c;->c:Ljava/lang/String;
    ...
    invoke-direct {v0, p0}, Lmh/b;-><init>(Ljava/lang/Exception;)V
    ...
    iget-object v2, p0, Lmh/c;->c:Ljava/lang/String;

    invoke-virtual {v0, v2}, Llh/a$b;->a(Ljava/lang/String;)Llh/a$a;

    move-result-object v0

    iget-object v2, v0, Llh/a$a;->e:Lea/n0;

    const/4 v3, 0x1

    if-eqz v2, :cond_6

    iget-object v2, p0, Lmh/c;->a:Ljava/lang/String;
    ...
    iget-object v5, v0, Llh/a$a;->e:Lea/n0;
    ...
    invoke-virtual {v2, v4}, Lea/n0;->J2(Lea/a$f;)V

    iget-object v2, v0, Llh/a$a;->d:Lea/c;

    invoke-static {v2}, Lea/d;->Z2(Lea/c;)Z
    ...
    iget-object v7, v2, Lea/n0;->U:Ljava/lang/Object;
    ...
    invoke-virtual {v2}, Lea/n0;->l2()I

    move-result v8

    iput v8, v2, Lea/n0;->L:I

    iput-boolean v3, v2, Lea/n0;->w:Z

    iget-object v3, v2, Lea/n0;->v:Landroid/hardware/camera2/CameraCaptureSession;

    iget v8, v2, Lea/n0;->o0:I

    const-string v9, "cancelSession"

    invoke-static {v3, v8, v9}, Lea/n0;->r2(Landroid/hardware/camera2/CameraCaptureSession;ILjava/lang/String;)Z
    ...
    iget-object v6, v2, Lea/n0;->v:Landroid/hardware/camera2/CameraCaptureSession;
    ...
    iput-object v4, v2, Lea/n0;->v:Landroid/hardware/camera2/CameraCaptureSession;
    ...
    invoke-virtual {v2, v3, v4, v1}, Lea/n0;->n2(Ljava/lang/Exception;Ljava/lang/String;Z)V
    ...
    :cond_5
    :goto_3
    iget-object p0, p0, Lmh/e;->e:Llh/d;

    iget-object v0, v0, Llh/a$a;->e:Lea/n0;

    iget-object v0, v0, Lea/n0;->u:Landroid/hardware/camera2/CameraDevice;

    invoke-virtual {p0, v0}, Llh/d;->onOpened(Landroid/hardware/camera2/CameraDevice;)V
    ...
    check-cast v2, Llh/a$a;

    iget-object v4, v2, Llh/a$a;->e:Lea/n0;

    const/4 v5, 0x2

    if-eqz v4, :cond_8

    iget-object v4, p0, Lmh/e;->f:Ljava/util/HashSet;

    iget-object v6, v2, Llh/a$a;->g:Ljava/lang/String;
    ...
    iget-object v2, v2, Llh/a$a;->g:Ljava/lang/String;
    ...
    iget-object v0, p0, Lmh/e;->f:Ljava/util/HashSet;
    ...
    invoke-static {v0}, Llh/c;->b([Ljava/lang/String;)V

    invoke-static {v3, p0}, Llh/c;->a(ILmh/c;)V
    ...
    :cond_8
    iget-boolean v4, v2, Llh/a$a;->a:Z
    ...
    iget-object v1, p0, Lmh/c;->c:Ljava/lang/String;
    ...
    :cond_9
    iget-boolean v4, v2, Llh/a$a;->b:Z
    ...
    iget-object v4, p0, Lmh/c;->c:Ljava/lang/String;
    ...
    iget-object v2, v2, Llh/a$b;->a:Landroid/hardware/camera2/CameraManager;

    invoke-static {}, Llh/c;->d()Llh/c;

    move-result-object v4

    iget-object v4, v4, Llh/c;->a:Landroid/os/Handler;

    iget-object v5, p0, Lmh/c;->a:Ljava/lang/String;
    ...
    iget-object v7, p0, Lmh/c;->c:Ljava/lang/String;
    ...
    iget-object v5, p0, Lmh/c;->c:Ljava/lang/String;

    iget-object v6, p0, Lmh/e;->e:Llh/d;
    ...
    invoke-virtual {v2, v4}, Llh/a$b;->a(Ljava/lang/String;)Llh/a$a;
    ...
    iget-object v4, p0, Lmh/c;->a:Ljava/lang/String;
    ...
    iget-object v6, p0, Lmh/c;->c:Ljava/lang/String;
    ...
    invoke-direct {p0, v2}, Lmh/b;-><init>(Ljava/lang/Exception;)V
    ...
    invoke-direct {p0, v0}, Lmh/b;-><init>(Ljava/lang/Exception;)V
