...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lv8/c;->a:Ljava/lang/Long;

    return-void
.end method

.method public static a(Lyg/q;)V
    .locals 22
    ...
    :cond_0
    iget-object v1, v0, Lyg/q;->h:Landroid/hardware/camera2/TotalCaptureResult;
    ...
    sget-object v10, Lv8/c;->a:Ljava/lang/Long;
    ...
    :cond_3
    sget-object v7, Lra/z;->L:Lra/y;

    invoke-static {v1, v7}, Lra/b0;->c(Landroid/hardware/camera2/CaptureResult;Lra/a0;)Ljava/lang/Object;
    ...
    iget-object v6, v0, Lyg/q;->p0:Lyg/w;
    ...
    invoke-direct/range {v10 .. v21}, Lyg/w;-><init>(ZILjava/lang/String;ZZZZIZZI)V

    iput-object v6, v0, Lyg/q;->p0:Lyg/w;
    ...
    :cond_6
    iget-object v0, v0, Lyg/q;->p0:Lyg/w;

    iget v6, v0, Lyg/w;->h:I

    const-string v10, "none"

    if-eqz v6, :cond_10

    sget-boolean v6, Luc/c;->i:Z

    iget-boolean v11, v0, Lyg/w;->f:Z

    if-eqz v6, :cond_c

    sget-object v6, Lra/z;->z1:Lra/y;

    invoke-static {v1, v6}, Lra/b0;->c(Landroid/hardware/camera2/CaptureResult;Lra/a0;)Ljava/lang/Object;
    ...
    iget-boolean v6, v0, Lyg/w;->g:Z

    if-eqz v6, :cond_c

    :cond_9
    sget-object v6, Lra/z;->w1:Lra/y;
    ...
    invoke-static {v1, v12}, Lra/b0;->c(Landroid/hardware/camera2/CaptureResult;Lra/a0;)Ljava/lang/Object;

    move-result-object v12

    check-cast v12, Ljava/lang/Integer;

    sget-object v13, Lra/z;->A1:Lra/y;

    invoke-static {v1, v13}, Lra/b0;->c(Landroid/hardware/camera2/CaptureResult;Lra/a0;)Ljava/lang/Object;
    ...
    sget-object v5, Lra/z;->p2:Lra/y;

    invoke-static {v1, v5}, Lra/b0;->c(Landroid/hardware/camera2/CaptureResult;Lra/a0;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Ljava/lang/Integer;

    sget-object v6, Lra/z;->S:Lra/y;
    ...
    :goto_7
    sget-object v5, Lra/z;->W1:Lra/y;

    invoke-static {v1, v5}, Lra/b0;->e(Landroid/hardware/camera2/CaptureResult;Lra/a0;)Ljava/lang/Object;
    ...
    invoke-static {v5}, Lea/d;->k(Lea/c;)I

    move-result v6

    invoke-static {v5}, Lea/d;->l(Lea/c;)I

    move-result v11

    invoke-static {v1, v6, v11}, Lea/b0;->a(Landroid/hardware/camera2/CaptureResult;II)Lsa/a;

    move-result-object v6

    if-eqz v6, :cond_17

    iget v6, v6, Lsa/a;->b:F
    ...
    :cond_17
    invoke-static {v5}, Lea/d;->a2(Lea/c;)Z

    move-result v6

    if-eqz v6, :cond_1a

    iget-boolean v6, v0, Lyg/w;->d:Z

    const-string v11, "attr_wide_ldc_status"

    if-eqz v6, :cond_19

    iget-boolean v6, v0, Lyg/w;->e:Z
    ...
    iget v6, v0, Lyg/w;->k:I

    invoke-static {v6, v5}, Lea/d;->O2(ILea/c;)Z

    move-result v6

    if-eqz v6, :cond_1d

    iget-boolean v6, v0, Lyg/w;->j:Z
    ...
    invoke-static {v1, v6}, Lra/b0;->e(Landroid/hardware/camera2/CaptureResult;Lra/a0;)Ljava/lang/Object;
    ...
    :goto_11
    iget-boolean v6, v0, Lyg/w;->a:Z

    if-eqz v6, :cond_26

    sget-object v6, Ltj/a;->a:Ljava/lang/Object;

    iget v6, v0, Lyg/w;->b:I
    ...
    iget-object v0, v0, Lyg/w;->c:Ljava/lang/String;
    ...
    iget-object v0, v5, Lea/c;->e6:Ljava/lang/Boolean;

    if-nez v0, :cond_27

    sget-object v0, Lra/z;->z2:Lra/y;

    invoke-static {v0, v5}, La0/c0;->e(Lra/y;Lea/c;)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, v5, Lea/c;->e6:Ljava/lang/Boolean;
    ...
    invoke-static {v1, v0}, Lra/b0;->e(Landroid/hardware/camera2/CaptureResult;Lra/a0;)Ljava/lang/Object;
    ...
    invoke-static {v0, v3}, Ltj/a;->l(Ljava/lang/String;Ljava/util/Map;)V
