...
.method public constructor <init>(Lcom/android/camera/module/Camera2Module;)V
    ...
    iput-object v0, p0, Lz6/d;->a:Ljava/lang/ref/WeakReference;
...
.method public final b(Landroid/graphics/Bitmap;IIZ)V
    ...
    invoke-virtual/range {v0 .. v5}, Lz6/d;->d(Ljava/lang/Object;IIZZ)V

    return-void
.end method

.method public final c([BIIZLjg/a;)V
    .locals 11
    ...
    iget-object v2, v1, Lz6/d;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-direct/range {v5 .. v10}, Lz6/d$a;-><init>(Lz6/d;[BIIZ)V

    new-instance v1, Landroidx/core/widget/b;

    const/16 v4, 0xc

    invoke-direct {v1, v2, v4}, Landroidx/core/widget/b;-><init>(Ljava/lang/Object;I)V

    sget-object v2, Lcom/xiaomi/camera/rx/CameraSchedulers;->sCameraWorkScheduler:Lio/reactivex/Scheduler;

    invoke-virtual {v0, v3, v1, v2}, Ljg/a;->a(Ljava/lang/Runnable;Ljava/lang/Runnable;Lio/reactivex/Scheduler;)V
...
.method public final d(Ljava/lang/Object;IIZZ)V
    ...
    iget-object v4, v0, Lz6/d;->a:Ljava/lang/ref/WeakReference;
    ...
    :cond_0
    invoke-virtual {v12}, Lcom/android/camera/module/BaseModule;->getCameraManager()Lw6/k;
    ...
    invoke-interface {v13}, Lw6/k;->M()Lea/w;

    move-result-object v5

    iget-object v5, v5, Lea/w;->a:Lea/x;

    invoke-virtual {v5}, Lea/x;->b()Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lcom/android/camera/b$b;->c()Lyg/t;

    move-result-object v5

    if-eqz v5, :cond_7

    iget-object v7, v5, Lyg/t;->l:Ljava/lang/Object;

    monitor-enter v7

    :try_start_0
    iget-object v5, v5, Lyg/t;->k:Ljava/util/HashMap;
    ...
    iget-object v8, v8, Lyg/q;->p:Ljava/lang/String;
    ...
    :cond_a
    invoke-virtual {v12}, Lcom/android/camera/module/BaseModule;->getAppStateMgr()Lw6/b;
    ...
    :goto_4
    invoke-interface {v4, v5, v7}, Ly7/a3;->Dg(IZ)I
    ...
    invoke-virtual {v4}, Lcom/android/camera/effect/r;->isFilterDarkNeeded()Z

    invoke-static {}, Lcom/android/camera/effect/r;->getInstance()Lcom/android/camera/effect/r;

    move-result-object v4

    invoke-virtual {v4}, Lcom/android/camera/effect/r;->getToneEffectForPreview()I
    ...
    invoke-static/range {v16 .. v16}, Lcom/android/camera/data/data/f0;->z(I)Z
    ...
    invoke-static {v4, v8}, Lgq/c;->k(II)I
    ...
    iget-object v6, v6, Lea/x;->g:Landroid/util/Size;
    ...
    invoke-direct {v2, v6, v7, v8, v4}, Lpa/c;-><init>(IIII)V
    ...
    :cond_11
    iget-object v0, v0, Lz6/d;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-static/range {v4 .. v9}, Lgg/e;->b(Landroid/graphics/Bitmap;ZFZZZ)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v1, v5}, La0/e5;->a(Z)I

    move-result v1

    invoke-static {v4, v1}, Lck/b;->e(Landroid/graphics/Bitmap;I)[B
    ...
    :cond_17
    sget-object v5, La0/e5;->c:La0/e5;

    const/4 v6, 0x0

    invoke-virtual {v5, v6}, La0/e5;->a(Z)I

    move-result v5

    invoke-static {v4, v5}, Lck/b;->e(Landroid/graphics/Bitmap;I)[B
    ...
    invoke-static {v9, v8}, Lo8/d;->c(Lce/b;[B)V

    invoke-static {v9, v1}, Lce/a;->f(Lce/b;[B)[B
    ...
    invoke-static {v9, v5, v14}, La0/y;->g(Ljava/lang/String;ZLjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v8, v12, Lcom/android/camera/module/Camera2Module;->mParalManager:Lc7/c;

    iget-boolean v8, v8, Lc7/c;->e:Z
    ...
    invoke-virtual {v12}, Lcom/xiaomi/camera/module/PhotoBase;->getImageModuleState()Lz6/g;

    move-result-object v7

    iget-wide v7, v7, Lz6/g;->y:J
    ...
    invoke-direct/range {v16 .. v23}, Lyg/q;-><init>(Ljava/lang/String;JJII)V

    iget-object v4, v12, Lcom/android/camera/module/Camera2Module;->mParalManager:Lc7/c;
    ...
    :goto_15
    iput-boolean v4, v6, Lyg/q;->C:Z

    const/4 v4, 0x0

    invoke-virtual {v6, v4, v1}, Lyg/q;->a(I[B)V

    iput-boolean v11, v6, Lyg/q;->M:Z

    iput-boolean v15, v6, Lyg/q;->X:Z

    iput-boolean v2, v6, Lyg/q;->W:Z
    ...
    invoke-direct {v2, v1, v9, v11, v5}, Lyg/r;-><init>(Landroid/util/Size;Landroid/util/Size;Landroid/util/Size;I)V

    invoke-interface {v13}, Lw6/k;->getCapabilities()Lea/c;

    move-result-object v1

    invoke-static {v1}, Lea/d;->K3(Lea/c;)Z
    ...
    invoke-static {v1}, Lea/d;->K0(Lea/c;)Z
    ...
    :goto_16
    iput-boolean v1, v2, Lyg/r;->y:Z

    sget-object v1, La0/e5;->c:La0/e5;

    const/4 v4, 0x0

    invoke-virtual {v1, v4}, La0/e5;->a(Z)I

    move-result v1

    iput v1, v2, Lyg/r;->L:I

    iput v3, v2, Lyg/r;->u:I

    move/from16 v4, v29

    iput v4, v2, Lyg/r;->v:I
    ...
    iput-object v1, v2, Lyg/r;->z:Landroid/location/Location;

    move/from16 v1, v28

    iput v1, v2, Lyg/r;->m:I

    iput v0, v2, Lyg/r;->n:I

    iput v8, v2, Lyg/r;->o:I

    move/from16 v1, v25

    iput v1, v2, Lyg/r;->p:I

    invoke-static {}, Lcom/android/camera/effect/r;->getInstance()Lcom/android/camera/effect/r;

    move-result-object v3

    invoke-virtual {v3, v0}, Lcom/android/camera/effect/r;->getDegree(I)I

    move-result v0

    iput v0, v2, Lyg/r;->q:I

    invoke-static {}, Lcom/android/camera/effect/r;->getInstance()Lcom/android/camera/effect/r;

    move-result-object v0

    invoke-virtual {v0, v8}, Lcom/android/camera/effect/r;->getVibranceDegree(I)I

    move-result v0

    iput v0, v2, Lyg/r;->r:I

    invoke-static {}, Lcom/android/camera/effect/r;->getInstance()Lcom/android/camera/effect/r;

    move-result-object v0

    invoke-virtual {v0, v1}, Lcom/android/camera/effect/r;->getPortraitStyleDegree(I)I

    move-result v0

    iput v0, v2, Lyg/r;->s:I

    iput v7, v2, Lyg/r;->k:I

    move/from16 v0, v27

    iput v0, v2, Lyg/r;->l:I

    move-object/from16 v0, v26

    iget-object v1, v0, Lpa/c;->d:Ljava/util/ArrayList;

    iput-object v1, v2, Lyg/r;->e0:Ljava/util/ArrayList;

    iget-object v0, v0, Lpa/c;->e:Ljava/util/ArrayList;

    iput-object v0, v2, Lyg/r;->g0:Ljava/util/ArrayList;

    iput-boolean v10, v2, Lyg/r;->S:Z

    const/4 v0, 0x1

    invoke-virtual {v12, v0}, Lcom/android/camera/module/Camera2Module;->getPictureInfo(Z)Ljg/f;

    move-result-object v0

    iput-object v0, v2, Lyg/r;->H:Ljg/f;

    move/from16 v5, v31

    iput-boolean v5, v2, Lyg/r;->f:Z

    invoke-static {}, Lu1/d;->v()Z

    move-result v0

    iput-boolean v0, v2, Lyg/r;->g:Z

    invoke-static {}, Lcom/android/camera/module/Camera2Module;->getTiltShiftMode()Ljava/lang/String;

    move-result-object v0

    iput-object v0, v2, Lyg/r;->J:Ljava/lang/String;

    invoke-interface {v13}, Lw6/k;->w0()Z

    move-result v0

    iput-boolean v0, v2, Lyg/r;->B:Z

    iget-object v0, v12, Lcom/android/camera/module/Camera2Module;->mParalManager:Lc7/c;

    invoke-virtual {v0}, Lc7/c;->c()Lik/b;

    move-result-object v0

    iput-object v0, v2, Lyg/r;->K:Lik/b;
    ...
    iput-boolean v0, v2, Lyg/r;->a:Z

    move/from16 v3, p0

    iput v3, v2, Lyg/r;->t:I
    ...
    iput-boolean v0, v2, Lyg/r;->X:Z

    invoke-static {}, Lcom/android/camera/data/data/x;->G()Z

    move-result v0

    iput-boolean v0, v2, Lyg/r;->Y:Z
    ...
    iget-object v1, v6, Lyg/q;->q0:Lyg/i;
    ...
    iput-boolean v0, v6, Lyg/q;->J:Z

    :cond_24
    invoke-virtual {v12}, Lcom/android/camera/module/BaseModule;->getModuleCallback()Lcom/android/camera/module/k0;
    ...
    invoke-virtual {v0, v6, v1, v1, v1}, Lo8/k;->l(Lyg/q;Landroid/hardware/camera2/TotalCaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
