...
.method public constructor <init>(Lcom/android/camera/module/Camera2Module;)V
    ...
    iput v0, p0, Lz6/s;->a:I

    const/4 v1, 0x0

    iput v1, p0, Lz6/s;->b:I

    iput-boolean v1, p0, Lz6/s;->d:Z

    iput-boolean v1, p0, Lz6/s;->f:Z

    iput-boolean v0, p0, Lz6/s;->g:Z

    new-instance v0, Ljava/lang/ref/WeakReference;

    invoke-direct {v0, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Lz6/s;->j:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static a(Lz6/s;Ljava/lang/String;)Ljava/lang/String;
    .locals 3
    ...
    :try_start_0
    sget-object v1, La0/q5;->a:La0/q5$a;
    ...
    iget-object p0, v1, La0/q5$a;->b:Ljava/text/SimpleDateFormat;
...
# virtual methods
.method public final b()Lz6/s$c;
    .locals 2

    iget-object v0, p0, Lz6/s;->k:Lz6/s$c;
    ...
    new-instance v0, Lz6/s$c;

    invoke-static {}, Landroid/os/Looper;->getMainLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lz6/s$c;-><init>(Lz6/s;Landroid/os/Looper;)V

    iput-object v0, p0, Lz6/s;->k:Lz6/s$c;

    :cond_0
    iget-object p0, p0, Lz6/s;->k:Lz6/s$c;
...
.method public final c()V
    ...
    iput-boolean v0, p0, Lz6/s;->c:Z

    invoke-virtual {p0}, Lz6/s;->d()V

    :cond_0
    iget-boolean v0, p0, Lz6/s;->d:Z

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lz6/s;->b()Lz6/s$c;
    ...
    :cond_1
    iget-object v0, p0, Lz6/s;->e:Ljava/lang/Boolean;
...
.method public final d()V
    ...
    iget-object p0, p0, Lz6/s;->j:Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {p0, v0}, Lca/a;->V2(Z)V
...
.method public final e()V
    ...
    iget-object v1, p0, Lz6/s;->j:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {v2}, Lcom/android/camera/data/data/x;->l0(I)Z
    ...
    invoke-direct {v3, v4}, Lcom/android/camera/features/mode/cinematic/i;-><init>(I)V

    invoke-static {v2, v3}, Lbq/t;->F(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;

    :cond_0
    iget-object v2, p0, Lz6/s;->i:Lio/reactivex/ObservableEmitter;
    ...
    :cond_1
    iget-object v2, p0, Lz6/s;->l:Lio/reactivex/disposables/Disposable;
    ...
    iput-object v3, p0, Lz6/s;->l:Lio/reactivex/disposables/Disposable;

    :cond_2
    iget-boolean v2, p0, Lz6/s;->d:Z
    ...
    invoke-virtual {v2}, Lea/a;->G0()I

    iput-boolean v0, p0, Lz6/s;->d:Z

    :cond_4
    iput-object v3, p0, Lz6/s;->e:Ljava/lang/Boolean;
