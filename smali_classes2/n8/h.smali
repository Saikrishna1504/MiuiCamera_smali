...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Ln8/h;->a:Ljava/util/HashMap;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    sput-object v1, Ln8/h;->b:Ljava/util/HashMap;

    new-instance v2, Ljava/util/HashMap;

    invoke-direct {v2}, Ljava/util/HashMap;-><init>()V

    sput-object v2, Ln8/h;->c:Ljava/util/HashMap;

    new-instance v3, Ljava/util/HashMap;

    invoke-direct {v3}, Ljava/util/HashMap;-><init>()V

    sput-object v3, Ln8/h;->d:Ljava/util/HashMap;

    new-instance v4, Ljava/util/HashMap;

    invoke-direct {v4}, Ljava/util/HashMap;-><init>()V

    sput-object v4, Ln8/h;->e:Ljava/util/HashMap;

    new-instance v5, Ljava/util/HashMap;

    invoke-direct {v5}, Ljava/util/HashMap;-><init>()V

    sput-object v5, Ln8/h;->f:Ljava/util/HashMap;

    new-instance v6, Ljava/util/HashMap;

    invoke-direct {v6}, Ljava/util/HashMap;-><init>()V

    sput-object v6, Ln8/h;->g:Ljava/util/HashMap;
    ...
    const-string v7, "pref_camera_edge_wide_ldc_key"
    ...
    const-string v7, "pref_camera_image_format_key"
    ...
    const-string v7, "pref_metering_weight"
    ...
    const-string v7, "pref_camera_track_focus_key_capture"

    const-string v8, "attr_track_focus_photo"

    invoke-virtual {v1, v7, v8}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v7, "pref_camera_tap_shoot_key"
    ...
    const-string v0, "pref_camera_center_mark_key"
    ...
    const-string v0, "pref_retain_portrait_zoom_key"
    ...
    const-string v0, "pref_retain_street_params_key"
