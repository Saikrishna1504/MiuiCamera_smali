...
# direct methods
.method public constructor <init>(Lo8/q$a;)V
    .locals 3

    invoke-direct {p0, p1}, Lo8/b;-><init>(Lo8/b$a;)V

    iget-object v0, p1, Lo8/q$a;->q:[B

    iput-object v0, p0, Lo8/q;->u:[B

    iget-object v1, p1, Lo8/q$a;->r:Ljava/nio/ByteBuffer;

    iput-object v1, p0, Lo8/q;->w:Ljava/nio/ByteBuffer;

    iget-boolean v1, p1, Lo8/q$a;->s:Z

    iput-boolean v1, p0, Lo8/q;->x:Z

    iget-object v1, p1, Lo8/q$a;->t:Landroid/util/Size;

    iput-object v1, p0, Lo8/q;->y:Landroid/util/Size;

    iget-object v1, p1, Lo8/q$a;->A:Landroid/hardware/camera2/CaptureResult;

    iput-object v1, p0, Lo8/q;->d0:Landroid/hardware/camera2/CaptureResult;

    iget-object v1, p1, Lo8/q$a;->z:Landroid/hardware/camera2/CameraCharacteristics;

    iput-object v1, p0, Lo8/q;->c0:Landroid/hardware/camera2/CameraCharacteristics;

    iget-wide v1, p1, Lo8/q$a;->u:J

    iput-wide v1, p0, Lo8/q;->V:J

    iget-object v1, p1, Lo8/q$a;->v:Ljava/lang/String;

    iput-object v1, p0, Lo8/q;->W:Ljava/lang/String;

    iget v1, p1, Lo8/q$a;->w:I

    iput v1, p0, Lo8/q;->Y:I

    iget v1, p1, Lo8/q$a;->x:I

    iput v1, p0, Lo8/q;->Z:I

    iget v1, p1, Lo8/q$a;->y:I

    iput v1, p0, Lo8/q;->b0:I
    ...
    :goto_0
    iput v0, p0, Lo8/q;->a0:I

    iget-wide v0, p1, Lo8/q$a;->B:J

    iput-wide v0, p0, Lo8/q;->e0:J

    iget v0, p1, Lo8/q$a;->C:I

    iput v0, p0, Lo8/q;->f0:I

    iget-object p1, p1, Lo8/q$a;->D:Lo8/p;

    iput-object p1, p0, Lo8/q;->g0:Lo8/p;
...
.method public final d()V
    ...
    iget-object v3, v1, Lo8/q;->W:Ljava/lang/String;

    iget-object v14, v1, Lo8/q;->c0:Landroid/hardware/camera2/CameraCharacteristics;

    iget-object v13, v1, Lo8/q;->u:[B

    iget-object v12, v1, Lo8/q;->y:Landroid/util/Size;

    iget-wide v5, v1, Lo8/q;->V:J

    iget v9, v1, Lo8/q;->Y:I

    iget v8, v1, Lo8/q;->Z:I

    iget v4, v1, Lo8/q;->b0:I

    iget v2, v1, Lo8/q;->f0:I

    iget-boolean v15, v1, Lo8/q;->x:Z

    sget-object v7, Lo8/y;->a:Ljava/lang/String;
    ...
    sget-object v4, Lo8/y;->f:Ljava/lang/String;
    ...
    iget-object v15, v1, Lo8/q;->d0:Landroid/hardware/camera2/CaptureResult;
    ...
    invoke-static {v4}, Lo8/y;->C(Ljava/lang/String;)Z
    ...
    invoke-static {v3}, Lo8/y;->t(Ljava/lang/String;)Z
    ...
    invoke-static/range {v2 .. v18}, Lo8/y;->m(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;ILjava/lang/String;JIILandroid/location/Location;ZZJ)Landroid/net/Uri;
    ...
    iget-object v0, v14, Lo8/q;->w:Ljava/nio/ByteBuffer;
    ...
    invoke-static {v9, v0, v4, v5}, Lo8/y;->D(Landroid/hardware/camera2/DngCreator;Ljava/nio/ByteBuffer;II)V
    ...
    invoke-static {v9, v10, v4}, Lo8/y;->E(Landroid/hardware/camera2/DngCreator;Ljava/io/BufferedOutputStream;Ljava/nio/ByteBuffer;)V
    ...
    :cond_9
    iget-object v0, v14, Lo8/q;->g0:Lo8/p;
    ...
    invoke-static/range {v2 .. v13}, Lo8/y;->y(IJJJLandroid/content/Context;Landroid/location/Location;Ljava/lang/String;ZZ)V
    ...
    :goto_12
    iget-object v0, v14, Lo8/b;->a:Landroid/content/Context;
...
.method public final run()V
    ...
    invoke-static {v2, v3, v4}, La0/x;->h(Ljava/lang/String;J)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lo7/j;->e([Ljava/lang/String;)V
