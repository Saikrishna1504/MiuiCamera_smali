...
# direct methods
.method public constructor <init>(Lo8/g$a;)V
    .locals 2

    invoke-direct {p0, p1}, Lo8/b;-><init>(Lo8/b$a;)V

    iget-object p1, p1, Lo8/g$a;->q:Landroid/hardware/camera2/CaptureResult;

    iput-object p1, p0, Lo8/g;->u:Landroid/hardware/camera2/CaptureResult;

    const/4 p1, 0x0

    iput-object p1, p0, Lo8/g;->w:Landroid/media/ImageWriter;

    iget-object p1, p0, Lo8/b;->d:Lyg/q;

    iget-object p1, p1, Lyg/q;->q:Lyg/r;

    iget-object p1, p1, Lyg/r;->D:Landroid/util/Size;
    ...
    iput p1, p0, Lo8/b;->j:I

    goto :goto_0

    :cond_0
    iget-object p1, p0, Lo8/b;->g:Landroid/media/Image;
...
.method public static d(Landroid/media/Image;Landroid/util/Size;)[B
    ...
    sget-object p1, Lgg/e;->a:Ljava/lang/String;
    ...
    invoke-static {v0, p1}, La0/z;->e([ILjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v11, v4, v12}, La0/j0;->g(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v5, v2, v4}, Lo8/j;->a(Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v0, v2, v4}, Lo8/j;->a(Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
...
.method public final e(Landroid/media/Image;[BZLjava/lang/String;JILjava/lang/String;IILandroid/location/Location;I)Landroid/net/Uri;
    ...
    invoke-static {v3, v15}, La0/z;->c(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v3, v1, Lo8/b;->a:Landroid/content/Context;

    const-string v4, ".HEIC"

    invoke-static {v15, v4}, La0/m0;->c(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v3 .. v19}, Lo8/y;->m(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;ILjava/lang/String;JIILandroid/location/Location;ZZJ)Landroid/net/Uri;
    ...
    iget-object v15, v1, Lo8/b;->m:Landroid/os/Handler;
    ...
    :try_start_3
    invoke-direct {v0, v5, v13, v14, v4}, Ldi/g$a;-><init>(Ljava/io/FileDescriptor;III)V
    ...
    new-instance v5, Ldi/g$a;

    invoke-direct {v5, v0, v13, v14, v4}, Ldi/g$a;-><init>(Ljava/lang/String;III)V

    move-object v0, v5

    :goto_3
    iget-object v4, v1, Lo8/b;->d:Lyg/q;

    iget-object v4, v4, Lyg/q;->q:Lyg/r;

    iget v4, v4, Lyg/r;->v:I

    iput-object v15, v0, Ldi/g$a;->h:Landroid/os/Handler;

    move/from16 v15, p12

    invoke-virtual {v0, v15}, Ldi/g$a;->b(I)V

    invoke-virtual {v0, v4}, Ldi/g$a;->c(I)V

    invoke-virtual {v0}, Ldi/g$a;->a()Ldi/g;

    move-result-object v0

    const/4 v4, 0x0

    invoke-virtual {v0, v4}, Ldi/i;->b(Z)V

    iget v4, v0, Ldi/i;->a:I

    const/4 v5, 0x1

    if-ne v4, v5, :cond_5

    iget-object v4, v0, Ldi/i;->i:Ldi/f;

    iget v13, v4, Ldi/d;->i:I

    if-ne v13, v5, :cond_4

    iget-object v4, v4, Ldi/d;->c0:Landroid/view/Surface;
    ...
    iput-object v4, v1, Lo8/g;->w:Landroid/media/ImageWriter;
    ...
    iput-boolean v4, v0, Ldi/i;->m:Z

    iget-object v4, v0, Ldi/i;->i:Ldi/f;

    iget-object v4, v4, Ldi/d;->e:Landroid/media/MediaCodec;
    ...
    iget-object v4, v1, Lo8/g;->w:Landroid/media/ImageWriter;
    ...
    invoke-virtual {v0, v4, v2}, Ldi/i;->a(I[B)V
    ...
    invoke-virtual {v0}, Ldi/i;->close()V
    ...
    :goto_7
    iget-object v2, v1, Lo8/g;->w:Landroid/media/ImageWriter;
    ...
    iput-object v2, v1, Lo8/g;->w:Landroid/media/ImageWriter;
    ...
    iget-object v7, v1, Lo8/b;->d:Lyg/q;

    iget-object v7, v7, Lyg/q;->q:Lyg/r;

    iget-object v7, v7, Lyg/r;->D:Landroid/util/Size;

    move-object/from16 p6, v8

    iget-object v8, v1, Lo8/b;->m:Landroid/os/Handler;
    ...
    invoke-direct {v0, v5, v13, v14, v12}, Ldi/g$a;-><init>(Ljava/io/FileDescriptor;III)V
    ...
    new-instance v12, Ldi/g$a;

    invoke-direct {v12, v0, v13, v14, v5}, Ldi/g$a;-><init>(Ljava/lang/String;III)V

    move-object v0, v12

    :goto_9
    iget-object v1, v1, Lo8/b;->d:Lyg/q;

    iget-object v1, v1, Lyg/q;->q:Lyg/r;

    iget v1, v1, Lyg/r;->v:I

    iput-object v8, v0, Ldi/g$a;->h:Landroid/os/Handler;

    invoke-virtual {v0, v15}, Ldi/g$a;->b(I)V

    invoke-virtual {v0, v1}, Ldi/g$a;->c(I)V
    ...
    invoke-virtual {v1, v0}, Ldi/i;->b(Z)V

    const/4 v0, 0x1

    iput-boolean v0, v1, Ldi/i;->m:Z

    iget-object v0, v1, Ldi/i;->i:Ldi/f;

    iget-object v0, v0, Ldi/d;->e:Landroid/media/MediaCodec;
    ...
    invoke-static {v4, v7}, Lo8/g;->d(Landroid/media/Image;Landroid/util/Size;)[B
    ...
    invoke-virtual {v1, v7}, Ldi/i;->b(Z)V

    iget v7, v1, Ldi/i;->a:I
    ...
    :try_start_6
    iget-object v7, v1, Ldi/i;->i:Ldi/f;

    if-eqz v7, :cond_9

    invoke-virtual {v7, v0}, Ldi/d;->a([B)V
    ...
    invoke-virtual {v1, v0, v2}, Ldi/i;->a(I[B)V
    ...
    invoke-virtual {v1}, Ldi/i;->close()V
    ...
    :goto_c
    invoke-static/range {p3 .. p3}, Lkr/b;->a(Landroid/os/ParcelFileDescriptor;)V
...
.method public final f()V
    ...
    iget-object v0, v14, Lo8/b;->d:Lyg/q;

    iget-object v15, v0, Lyg/q;->p:Ljava/lang/String;
    ...
    iget-wide v6, v0, Lyg/q;->I:J

    iget-object v0, v0, Lyg/q;->q:Lyg/r;

    iget v12, v0, Lyg/r;->L:I

    iget v11, v0, Lyg/r;->v:I

    iget-object v10, v0, Lyg/r;->z:Landroid/location/Location;

    iget v9, v0, Lyg/r;->h0:I
    ...
    iget-object v2, v14, Lo8/g;->u:Landroid/hardware/camera2/CaptureResult;

    iget v3, v14, Lo8/b;->i:I

    iget v4, v14, Lo8/b;->j:I
    ...
    sget-object v17, Lo8/d;->b:Ljava/lang/Long;

    move/from16 v17, v9

    new-instance v9, Lo8/d$a;

    invoke-direct {v9, v5}, Lo8/d$a;-><init>(Lce/b;)V

    invoke-virtual {v9, v11, v3, v4}, Lo8/d$a;->b(III)V

    iput-wide v6, v9, Lo8/d$a;->c:J

    iput-object v10, v9, Lo8/d$a;->j:Landroid/location/Location;

    const-wide/16 v3, 0x0

    iput-wide v3, v9, Lo8/d$a;->d:J

    invoke-virtual {v9, v2}, Lo8/d$a;->a(Landroid/hardware/camera2/CaptureResult;)V

    sget-object v2, Ljava/lang/Boolean;->FALSE:Ljava/lang/Boolean;

    sget-object v3, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    iput-object v2, v9, Lo8/d$a;->o:Ljava/lang/Boolean;

    iput-object v3, v9, Lo8/d$a;->p:Ljava/lang/Boolean;

    invoke-virtual {v9}, Lo8/d$a;->c()V
    ...
    invoke-static {v5, v2}, Lce/a;->e(Lce/b;Ljava/lang/Boolean;)[B
    ...
    invoke-virtual {v0, v15}, Lq1/c;->m(Ljava/lang/String;)Lo1/b;
    ...
    :cond_1
    invoke-static {v13}, Lo8/y;->n(Ljava/lang/String;)Z
    ...
    invoke-static {v13}, Lo8/y;->o(Ljava/lang/String;)Z
    ...
    sget-object v2, Lo8/y;->e:Ljava/lang/String;

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    sget-object v2, Ljava/io/File;->separator:Ljava/lang/String;

    invoke-static {v0, v2, v13, v1}, La0/v3;->f(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v2, Lo8/y;->h:Ljava/lang/String;
    ...
    iget-object v1, v9, Lo1/b;->c:Ljava/lang/Long;

    invoke-virtual {v1}, Ljava/lang/Long;->longValue()J

    move-result-wide v1

    iget-object v4, v14, Lo8/b;->a:Landroid/content/Context;

    move-object/from16 v19, v5

    const/4 v5, 0x0

    invoke-static {v4, v15, v5}, Lo8/y;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    invoke-static {v15}, Lo8/y;->C(Ljava/lang/String;)Z

    move-result v4

    iget-object v2, v14, Lo8/b;->g:Landroid/media/Image;

    iget v1, v14, Lo8/b;->i:I

    move/from16 v20, v12

    iget v12, v14, Lo8/b;->j:I
    ...
    invoke-virtual/range {v1 .. v13}, Lo8/g;->e(Landroid/media/Image;[BZLjava/lang/String;JILjava/lang/String;IILandroid/location/Location;I)Landroid/net/Uri;
    ...
    :try_start_0
    invoke-static {v0, v15}, Lt8/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    :goto_4
    iget-object v8, v12, Lo8/b;->a:Landroid/content/Context;

    iget v0, v12, Lo8/b;->i:I

    iget v1, v12, Lo8/b;->j:I
    ...
    invoke-static {v8, v15, v2}, Lo8/y;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    invoke-static/range {v1 .. v12}, Lo8/y;->y(IJJJLandroid/content/Context;Landroid/location/Location;Ljava/lang/String;ZZ)V
    ...
    invoke-static {v0, v15}, La0/z;->c(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_b
    iget-object v1, v13, Lo8/b;->a:Landroid/content/Context;

    move-object/from16 v10, v24

    invoke-static {v1, v10}, Ls1/a;->c(Landroid/content/Context;Lo1/b;)V
    ...
    iget-object v2, v13, Lo8/b;->g:Landroid/media/Image;

    iget v0, v13, Lo8/b;->i:I

    iget v9, v13, Lo8/b;->j:I
    ...
    iget-object v1, v15, Lo8/b;->d:Lyg/q;

    iget-boolean v1, v1, Lyg/q;->C:Z

    if-eqz v1, :cond_10

    iget-object v1, v15, Lo8/b;->a:Landroid/content/Context;

    invoke-static {v1, v0}, La0/h7;->e(Landroid/content/Context;Landroid/net/Uri;)La0/h7;

    move-result-object v1

    if-eqz v1, :cond_f

    iget-object v2, v15, Lo8/b;->b:Lo8/t;
    ...
    :cond_f
    iget-object v1, v15, Lo8/b;->b:Lo8/t;
    ...
    invoke-virtual/range {v1 .. v6}, Lo8/k;->k(Landroid/net/Uri;ZLjava/lang/String;IZ)V
    ...
    iput-object v1, v2, Lo1/b;->c:Ljava/lang/Long;

    iget-object v1, v15, Lo8/b;->a:Landroid/content/Context;

    invoke-static {v1, v2}, Ls1/a;->c(Landroid/content/Context;Lo1/b;)V
...
.method public final run()V
    ...
    invoke-virtual {p0}, Lo8/g;->f()V

    iget-object v0, p0, Lo8/b;->t:Lo8/b$b;

    iget-object v1, p0, Lo8/b;->g:Landroid/media/Image;

    iget-object v2, p0, Lo8/b;->d:Lyg/q;
    ...
    iget-object v0, v0, Lyg/u;->a:Lyg/t;
    ...
    iget-object v1, v2, Lyg/q;->K:Landroid/media/Image;

    invoke-static {v0, v1}, Lyg/t;->d(Lyg/t;Landroid/media/Image;)V

    invoke-virtual {v2}, Lyg/q;->l()V

    invoke-static {v0, v2}, Lyg/t;->e(Lyg/t;Lyg/q;)Z

    move-result v1

    if-eqz v1, :cond_0

    iget-object v1, v0, Lyg/t;->h:Lyg/t$i;

    if-eqz v1, :cond_0

    check-cast v1, Lcom/android/camera/b$a;

    invoke-virtual {v1, v2}, Lcom/android/camera/b$a;->a(Lyg/q;)V

    :cond_0
    iget-wide v1, v2, Lyg/q;->e:J

    invoke-virtual {v0, v1, v2}, Lyg/t;->v(J)Lyg/q;
    ...
    iget-object v5, p0, Lo8/b;->d:Lyg/q;

    iget-wide v5, v5, Lyg/q;->f:J
    ...
    invoke-static {v4, v0, v1}, La0/x;->h(Ljava/lang/String;J)Ljava/lang/String;
    ...
    invoke-virtual {v2, v3}, Lo7/j;->e([Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lo8/g;->u:Landroid/hardware/camera2/CaptureResult;
