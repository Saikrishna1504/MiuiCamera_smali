...
# direct methods
.method public constructor <init>(Lo8/b0$a;)V
    .locals 1

    invoke-direct {p0, p1}, Lo8/b;-><init>(Lo8/b$a;)V

    iget-object v0, p1, Lo8/b0$a;->q:Ljava/lang/String;

    iput-object v0, p0, Lo8/b0;->u:Ljava/lang/String;

    iget-object v0, p1, Lo8/b0$a;->s:Landroid/content/ContentValues;

    iput-object v0, p0, Lo8/b0;->w:Landroid/content/ContentValues;

    iget-boolean v0, p1, Lo8/b0$a;->t:Z

    iput-boolean v0, p0, Lo8/b0;->x:Z

    iget-boolean v0, p1, Lo8/b0$a;->u:Z

    iput-boolean v0, p0, Lo8/b0;->y:Z

    iget v0, p1, Lo8/b0$a;->v:I

    iput v0, p0, Lo8/b0;->V:I

    iget-object v0, p1, Lo8/b$a;->k:Landroid/os/Handler;

    iput-object v0, p0, Lo8/b;->m:Landroid/os/Handler;

    iget-object p1, p1, Lo8/b0$a;->w:Ljava/util/List;

    iput-object p1, p0, Lo8/b0;->W:Ljava/util/List;
...
.method public final d()V
    ...
    const-string v4, "recording_save"

    invoke-virtual {v3, v4}, Lo7/j;->o(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v5, v6}, Lyg/c;->f(II)I

    move-result v5

    iget-object v0, v1, Lo8/b0;->u:Ljava/lang/String;
    ...
    iget-object v8, v1, Lo8/b;->c:Landroid/net/Uri;

    invoke-static {v0, v8}, Ls8/a;->i(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljava/lang/String;
    ...
    iput-object v0, v1, Lo8/b0;->u:Ljava/lang/String;

    :cond_0
    iget-object v0, v1, Lo8/b0;->u:Ljava/lang/String;

    invoke-static {v0, v7}, Lck/f;->q(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v8, v9}, La0/x3;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-object v9, v1, Lo8/b;->c:Landroid/net/Uri;
    ...
    iget-boolean v10, v1, Lo8/b0;->x:Z

    invoke-virtual {v0, v10}, Lo8/k;->j(Z)Z
    ...
    iget-object v14, v1, Lo8/b0;->w:Landroid/content/ContentValues;

    if-eqz v10, :cond_c

    iget-object v0, v1, Lo8/b0;->W:Ljava/util/List;
    ...
    iput-object v0, v1, Lo8/b0;->W:Ljava/util/List;
    ...
    :cond_4
    :goto_0
    iget-object v0, v1, Lo8/b;->c:Landroid/net/Uri;

    move-object/from16 v19, v15

    invoke-static {v0, v8}, Lt8/b;->b(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;

    move-result-object v15

    invoke-static {v8}, Ln6/b;->d(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    :try_start_1
    invoke-static {v14}, Lck/w;->b(Landroid/content/ContentValues;)Landroid/util/Size;

    move-result-object v0

    invoke-static {v9, v15, v8, v0, v6}, Ln6/b;->a(Landroid/media/MediaMetadataRetriever;Landroid/os/ParcelFileDescriptor;Ljava/lang/String;Landroid/util/Size;[Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v9, v0}, La0/k0;->a(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v5, v0}, La0/k0;->a(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v3, v0}, La0/k0;->a(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v2, v5}, Lgg/e;->a(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    invoke-static {v0, v2}, Lck/b;->e(Landroid/graphics/Bitmap;I)[B
    ...
    invoke-direct {v2, v9, v5, v15}, Ln6/b$a;-><init>(Ljava/lang/String;Ljava/lang/String;[B)V
    ...
    invoke-static {v8}, Lck/w;->a(Ljava/lang/String;)J
    ...
    iget-object v9, v1, Lo8/b;->m:Landroid/os/Handler;
    ...
    iget-object v0, v1, Lo8/b;->m:Landroid/os/Handler;
    ...
    iget-object v1, v1, Lo8/b;->b:Lo8/t;
    ...
    invoke-interface {v1}, Lo8/k$a;->i0()V
    ...
    sget-object v9, Ln6/b;->a:Ljava/lang/String;
    ...
    invoke-static {v6, v8}, La0/z;->c(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v6, v0}, Ln6/a;-><init>(Ljava/util/List;)V

    invoke-static {v9, v6}, Lnu/e;->a(Ljava/io/File;Lnu/b;)V
    :try_end_7
    ...
    invoke-static {v4, v5, v0}, La0/w3;->j(JLjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v15, v1, Lo8/b;->c:Landroid/net/Uri;
    ...
    iget-object v4, v1, Lo8/b;->c:Landroid/net/Uri;
    ...
    invoke-static {v3, v8, v5}, Lo8/y;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    :try_start_b
    iput-object v3, v1, Lo8/b;->c:Landroid/net/Uri;
    ...
    invoke-static {v13, v4}, La0/a0;->c(Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;
    ...
    :goto_16
    iput-object v0, v1, Lo8/b;->c:Landroid/net/Uri;
    ...
    iget-object v2, v1, Lo8/b;->c:Landroid/net/Uri;

    invoke-static {v0, v2}, Ls8/a;->i(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lck/f;->q(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    const-string/jumbo v0, "save video: query update, path -> "

    invoke-static {v0, v8}, La0/z;->c(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v8}, Lo8/l;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/net/Uri;
    ...
    iget-object v5, v1, Lo8/b;->a:Landroid/content/Context;
    ...
    invoke-static {v13, v2}, La0/a0;->c(Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {v8}, Lo8/y;->u(Ljava/lang/String;)Z

    move-result v0

    sget-object v3, Lo8/y;->a:Ljava/lang/String;

    sget-object v4, Lo8/y;->d:Ljava/lang/String;
    ...
    invoke-static {v4, v3, v0, v0}, La0/h7;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)La0/h7;
    ...
    iput-boolean v3, v0, La0/h7;->h:Z

    iget-object v4, v1, Lo8/b;->b:Lo8/t;

    check-cast v4, Lo8/k;

    invoke-virtual {v4, v0, v3}, Lo8/k;->q(La0/h7;Z)V
    ...
    invoke-direct {v3, v4}, Lh1/x;-><init>(I)V
    ...
    invoke-interface {v0, v2}, Lo8/k$a;->k0(Z)V
    ...
    iget-object v3, v1, Lo8/b;->c:Landroid/net/Uri;
    ...
    iget-object v2, v1, Lo8/b;->n:Landroid/location/Location;

    const/16 v34, 0x0

    const-wide/16 v28, 0x0

    iget v1, v1, Lo8/b0;->V:I
    ...
    invoke-static/range {v23 .. v34}, Lo8/y;->y(IJJJLandroid/content/Context;Landroid/location/Location;Ljava/lang/String;ZZ)V
    ...
    invoke-virtual {v1, v0}, Lo7/j;->r([Lo7/a;)J
    ...
    invoke-virtual {v0, v1}, Lyg/c;->i(I)V
...
.method public final run()V
    ...
    iget-object p0, p0, Lo8/b;->b:Lo8/t;

    check-cast p0, Lo8/k;

    invoke-virtual {p0, v0}, Lo8/k;->m(I)V
