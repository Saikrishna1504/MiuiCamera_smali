...
.method public static f(Landroid/app/Activity;)Z
    ...
    invoke-static {v0}, Lck/c;->k(Landroid/content/Intent;)Z
    ...
    invoke-static {v0}, Lck/c;->u(Landroid/content/Intent;)Z

    move-result v1

    if-nez v1, :cond_1

    invoke-static {v0}, Lck/c;->v(Landroid/content/Intent;)Z
    ...
    instance-of v5, v5, L㱻㱷㱵㰶㱵㱱㰶㱼㱽㱮㱱㱻㱽㰶㱠㱱㱹㱷㱵㱱㰶㱛㱷㱵㱵㱷㱶㱞㱷㱴㱼;
    ...
    invoke-static {v0}, Lkr/e;->g(Landroid/content/Context;)Z
    ...
    :cond_2
    iget-object v0, v4, Luc/b;->e:L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;
    ...
    invoke-static {v0, v4}, Lbj/a;->e(II)Z
    ...
    invoke-static {v0}, Lu1/d;->m(Landroid/content/Context;)Z
...
.method public static i()I
    ...
    invoke-static {v2, v2, v0, v1}, Lu1/b;->X(ZIIF)Z
    ...
    invoke-static {v3, v0, v2}, Landroidx/appcompat/widget/b;->a(III)I
    ...
    invoke-static {v3, v0, v2}, La0/d0;->a(III)I
...
.method public static n(ILandroid/content/Context;)I
    ...
    invoke-static {v0, p1}, Li9/c;->m(ILandroid/content/Context;)I
...
.method public static o(Landroid/view/View;Z)V
    ...
    invoke-direct {v0, p1}, Li9/b;-><init>(Z)V
...
.method public static p(Ld9/b;ZZ)V
    .locals 11
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
    ...
    invoke-virtual {v5, v7, v6}, Lz0/d;->a(IZ)I
    ...
    iget-object v8, p0, Ld9/b;->u:Landroid/animation/ValueAnimator;
    ...
    :cond_3
    iget-object v8, p0, Ld9/b;->d:Ld9/x;

    iget-object v9, v8, Ld9/x;->T:Ld9/y;
    ...
    :cond_4
    iget-object v9, v9, Ld9/y;->b:Landroid/graphics/Bitmap;
    ...
    iget-object v8, v8, Ld9/x;->T:Ld9/y;
    ...
    invoke-virtual {v4}, Ld9/x;->o()V

    iget-object v4, p0, Ld9/b;->d:Ld9/x;

    iput p1, v4, Ld9/x;->V:I

    iput-boolean v6, v4, Ld9/x;->U:Z
    ...
    iget v7, v4, La9/d;->A:F

    const/high16 v9, 0x40000000    # 2.0f

    mul-float/2addr v7, v9

    iget v9, v4, Ld9/x;->Y:F

    iget v10, v4, La9/d;->g:F
    ...
    :cond_c
    :goto_5
    invoke-static {v8}, Ld9/r;->o(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v7, v4, p1, v5}, Ld9/y;-><init>(Ld9/x;Landroid/graphics/Bitmap;I)V

    iput-object v7, v4, Ld9/x;->T:Ld9/y;

    iput v9, v7, Ld9/y;->l:F

    iget-object p1, p0, Ld9/b;->d:Ld9/x;

    iget-object p1, p1, Ld9/x;->T:Ld9/y;
    ...
    :cond_d
    iput v6, p1, Ld9/y;->h:I

    iput v3, p1, Ld9/y;->j:I
    ...
    invoke-direct {p2, p0}, Ld9/h;-><init>(Ld9/b;)V
    ...
    invoke-direct {p2, p0}, Ld9/i;-><init>(Ld9/b;)V

    invoke-virtual {p1, p2}, Landroid/animation/ValueAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    iget-object p0, p0, Ld9/b;->u:Landroid/animation/ValueAnimator;
    ...
    iget-object v5, p1, Ld9/x;->T:Ld9/y;
    ...
    :cond_14
    iput v3, p1, Ld9/y;->h:I

    iput v4, p1, Ld9/y;->j:I
    ...
    invoke-direct {p2, p0}, Ld9/j;-><init>(Ld9/b;)V
    ...
    invoke-direct {p2, p0}, Ld9/k;-><init>(Ld9/b;)V
