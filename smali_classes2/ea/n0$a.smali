...
.method public constructor <init>(Lea/n0;)V
    ...
    iput-object p1, p0, Lea/n0$a;->a:Lea/n0;
...
.method public final onImageAvailable(Landroid/media/ImageReader;)V
    ...
    :cond_1
    iget-object v2, p0, Lea/n0$a;->a:Lea/n0;

    iget-object v2, v2, Lea/n0;->b0:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-object v3, p0, Lea/n0$a;->a:Lea/n0;

    invoke-virtual {v3}, Lea/n0;->u2()Z
    ...
    iget-object v3, v3, Lea/n0;->W:Ljava/util/concurrent/ConcurrentLinkedDeque;

    invoke-virtual {v3}, Ljava/util/concurrent/ConcurrentLinkedDeque;->peek()Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lea/x0;

    instance-of v4, v3, Lea/r1;

    if-eqz v4, :cond_7

    move-object v0, v3

    check-cast v0, Lea/r1;

    invoke-virtual {p1}, Landroid/media/Image;->getTimestamp()J

    move-result-wide v4

    iget-object v0, v0, Lea/r1;->v:Lyg/q;
    ...
    iget-object v0, p0, Lea/n0$a;->a:Lea/n0;

    iget-object v0, v0, Lea/n0;->W:Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    check-cast v4, Lea/x0;

    instance-of v5, v4, Lea/r1;

    if-eqz v5, :cond_3

    move-object v5, v4

    check-cast v5, Lea/r1;

    iget-object v5, v5, Lea/r1;->v:Lyg/q;
    ...
    :cond_8
    instance-of v4, v3, Lea/o0;

    if-eqz v4, :cond_c

    move-object v0, v3

    check-cast v0, Lea/o0;

    invoke-virtual {v0}, Lea/o0;->F()J
    ...
    invoke-static {v3, p1}, Lea/n0;->N1(Lea/n0;Landroid/media/Image;)Lea/x0;
    ...
    :cond_e
    :goto_3
    iget-object p0, p0, Lea/n0$a;->a:Lea/n0;
    ...
    iget-object v3, p0, Lea/n0;->V:Lea/x0;
    ...
    invoke-virtual {v3, p1, v1}, Lea/x0;->j(Landroid/media/Image;I)V
