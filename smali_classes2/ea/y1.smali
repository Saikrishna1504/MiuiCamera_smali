...
.field public final Q:Lea/y1$a;

.field public final R:Lea/y1$b;
...
.method public constructor <init>(Lea/n0;Ljg/a;)V
    .locals 0
    ...
    iput-boolean p1, p0, Lea/y1;->I:Z

    iput-boolean p1, p0, Lea/y1;->L:Z

    iput p1, p0, Lea/y1;->M:I

    const/16 p2, 0xa0

    iput p2, p0, Lea/y1;->N:I

    new-instance p2, Ljava/lang/Object;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lea/y1;->O:Ljava/lang/Object;

    new-instance p2, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {p2, p1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object p2, p0, Lea/y1;->P:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Lea/y1$a;

    invoke-direct {p1, p0}, Lea/y1$a;-><init>(Lea/y1;)V

    iput-object p1, p0, Lea/y1;->Q:Lea/y1$a;

    new-instance p1, Lea/y1$b;

    invoke-direct {p1, p0}, Lea/y1$b;-><init>(Lea/y1;)V

    iput-object p1, p0, Lea/y1;->R:Lea/y1$b;
    ...
    iput p1, p0, Lea/y1;->N:I

    return-void
.end method

.method public static y(Lea/y1;J)V
    .locals 6

    iget-object v0, p0, Lea/x0;->b:Lea/a;

    invoke-virtual {v0}, Lea/a;->D()Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    check-cast v4, Lea/y1;

    invoke-virtual {v4}, Lea/x0;->c()J
    ...
    invoke-direct {p1, v1, p2}, Landroidx/room/c;-><init>(Ljava/lang/Object;I)V
...
.method public static z(Lea/y1;[BLjava/lang/String;)V
    .locals 5
    ...
    iget-object v2, p0, Lea/y1;->C:Lyg/q;
    ...
    :cond_0
    iget-object v0, p0, Lea/y1;->C:Lyg/q;
    ...
    iget-object v3, p0, Lea/y1;->C:Lyg/q;
    ...
    invoke-virtual {v0, v1, p1}, Lyg/q;->j(I[B)V
    ...
    invoke-virtual {v0, v2, p1}, Lyg/q;->j(I[B)V

    :goto_0
    iget-object v0, p0, Lea/y1;->C:Lyg/q;

    iput-boolean v1, v0, Lyg/q;->C:Z
    ...
    iget-object p1, p0, Lea/y1;->C:Lyg/q;

    iget-wide v3, p1, Lyg/q;->e:J
    ...
    iget-object v0, p0, Lea/y1;->K:Landroid/hardware/camera2/TotalCaptureResult;
    ...
    invoke-virtual {p0, p1, v0, v1, p2}, Lea/y1;->H(Lyg/q;Landroid/hardware/camera2/TotalCaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lea/y1;->H:Ljava/lang/String;
    ...
    iget-object p0, p0, Lea/y1;->C:Lyg/q;
...
.method public final A(I)V
    ...
    iget-object v0, p0, Lea/y1;->O:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lea/y1;->P:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final B()V
    ...
    iget-object v0, p0, Lea/y1;->D:Landroid/media/Image;
...
.method public final C()V
    ...
    iput-object v0, p0, Lea/y1;->H:Ljava/lang/String;
    ...
    iget-object v1, p0, Lea/y1;->H:Ljava/lang/String;
...
.method public final E()V
    ...
    iget-object v0, p0, Lea/y1;->P:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Lea/y1;->H:Ljava/lang/String;
    ...
    invoke-virtual {v1, p0, v2}, Lea/a;->v0(Lea/x0;Z)V
    ...
    iget-boolean v1, p0, Lea/y1;->G:Z

    if-eqz v1, :cond_3

    iget-object v1, p0, Lea/y1;->F:Lyg/q;

    if-eqz v1, :cond_3

    const/4 v4, 0x0

    invoke-virtual {p0, v1, v4, v4, v4}, Lea/y1;->H(Lyg/q;Landroid/hardware/camera2/TotalCaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V

    :cond_3
    invoke-virtual {p0}, Lea/y1;->D()J

    move-result-wide v4

    invoke-interface {v0, v2, v4, v5, v3}, Lea/a$k;->onPictureTakenFinished(ZJI)V
...
.method public final F()V
    ...
    iget-object v3, p0, Lea/y1;->H:Ljava/lang/String;
    ...
    iget-object v3, p0, Lea/y1;->D:Landroid/media/Image;
    ...
    new-instance v0, Lea/y1$c;

    invoke-direct {v0, p0}, Lea/y1$c;-><init>(Lea/y1;)V
    ...
    :cond_5
    invoke-virtual {v0}, Lea/y1$c;->run()V
...
.method public final G()Z
    ...
    invoke-static {v4, v1, v5, v0}, La0/a0;->e(Ljava/lang/String;ZLjava/lang/String;Z)Ljava/lang/String;
...
.method public final H(Lyg/q;Landroid/hardware/camera2/TotalCaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    .locals 3
    ...
    iget-object p4, p0, Lea/y1;->H:Ljava/lang/String;
...
.method public final I(Ljava/util/concurrent/ConcurrentLinkedDeque;J)V
    ...
    instance-of v2, v1, Lea/y1;

    if-eqz v2, :cond_0

    move-object v2, v1

    check-cast v2, Lea/y1;

    invoke-virtual {v2}, Lea/y1;->D()J
...
.method public final J(Landroid/hardware/camera2/TotalCaptureResult;Lyg/q;)V
    .locals 7
    ...
    :cond_0
    iget-object p2, p2, Lyg/q;->q:Lyg/r;

    iget-object p2, p2, Lyg/r;->H:Ljg/f;

    const/4 v2, 0x4

    new-array v3, v2, [Lra/a0;

    sget-object v4, Lra/z;->o0:Lra/y;

    aput-object v4, v3, v1

    sget-object v4, Lra/z;->p0:Lra/y;

    const/4 v5, 0x1

    aput-object v4, v3, v5

    sget-object v4, Lra/z;->q0:Lra/y;
    ...
    invoke-static {p1, v6}, Lra/b0;->e(Landroid/hardware/camera2/CaptureResult;Lra/a0;)Ljava/lang/Object;
    ...
    :goto_1
    iput-boolean v2, p2, Ljg/f;->C:Z

    sget-object v3, Lra/z;->N0:Lra/y;

    invoke-static {p1, v3}, Lra/b0;->e(Landroid/hardware/camera2/CaptureResult;Lra/a0;)Ljava/lang/Object;
    ...
    iget-object v4, v4, Lea/q2$a;->L:Lsa/l$a;
    ...
    iget-object p0, p0, Lea/q2$a;->L:Lsa/l$a;

    iget-object v3, p0, Lsa/l$a;->h:Ljava/lang/String;
    ...
    :cond_3
    iput-object v3, p2, Ljg/f;->E:Ljava/lang/String;
    ...
    iput-object p0, p2, Ljg/f;->A:Ljava/lang/String;
...
.method public j(Landroid/media/Image;I)V
    ...
    iget-object v6, v1, Lea/y1;->C:Lyg/q;
    ...
    iget-object v0, v1, Lea/y1;->C:Lyg/q;

    invoke-virtual {p1}, Landroid/media/Image;->getTimestamp()J

    move-result-wide v6

    iput-wide v6, v0, Lyg/q;->e:J

    iget-wide v6, v1, Lea/y1;->J:J
    ...
    iget-object v0, v1, Lea/x0;->a:Ljava/lang/String;
    ...
    iget-object v1, v1, Lea/y1;->H:Ljava/lang/String;
    ...
    iget-object v5, v1, Lea/y1;->H:Ljava/lang/String;
    ...
    invoke-static {v0, p1, v11, v10}, Lgg/e;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    iget-object v6, v1, Lea/y1;->H:Ljava/lang/String;
    ...
    iget-object v5, v1, Lea/x0;->a:Ljava/lang/String;

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6, v4}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v4, v1, Lea/y1;->H:Ljava/lang/String;
    ...
    iput-object v9, v1, Lea/y1;->D:Landroid/media/Image;
    ...
    iget-object v4, v1, Lea/y1;->D:Landroid/media/Image;
    ...
    iget-object v4, v1, Lea/y1;->C:Lyg/q;
    ...
    :cond_2
    iget-object v4, v1, Lea/x0;->a:Ljava/lang/String;
    ...
    invoke-static {v4, p1, v5, v10}, Lgg/e;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    invoke-static {v5, v0}, La0/y3;->b(Ljava/lang/String;Ljava/lang/Exception;)Ljava/lang/String;
    ...
    iget-object v0, v1, Lea/y1;->H:Ljava/lang/String;
    ...
    iget-object v0, v1, Lea/y1;->Q:Lea/y1$a;

    iget-object v4, v1, Lea/y1;->H:Ljava/lang/String;

    iget-object v5, v1, Lea/y1;->C:Lyg/q;

    iget-wide v5, v5, Lyg/q;->a0:J

    const-string/jumbo v12, "{\"smallPicture\":\"true\",\"type\":\"app\",\"reason\":\"ImagePool get image failed\",\"imageName\":\"%s\"}"

    invoke-virtual {v0, v4, v5, v6, v12}, Lea/y1$a;->onCaptureFailed(Ljava/lang/String;JLjava/lang/String;)V
    ...
    invoke-static {v9, v0}, Lgg/e;->c(Landroid/media/Image;Ljava/lang/String;)V

    :cond_4
    iget-object v0, v1, Lea/x0;->b:Lea/a;
