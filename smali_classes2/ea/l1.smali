...
.method public constructor <init>(Lea/n0;Landroid/view/Surface;)V
    .locals 1
    ...
    iput-boolean p1, p0, Lea/l1;->D:Z

    sget-object p1, Ljg/d;->b:Ljg/d;

    iput-object p1, p0, Lea/l1;->E:Ljg/d;

    iput-object p2, p0, Lea/l1;->F:Landroid/view/Surface;

    return-void
.end method

.method public static y(Lea/l1;ZI)V
    .locals 5
...
.method public final m()V
    ...
    invoke-virtual {v2, v3}, Lo7/j;->d(Ljava/lang/String;)J

    :cond_0
    :try_start_0
    new-instance v2, Lea/k1;

    invoke-direct {v2, p0}, Lea/k1;-><init>(Lea/l1;)V

    invoke-virtual {p0}, Lea/l1;->z()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v3

    iget-object v5, p0, Lea/l1;->F:Landroid/view/Surface;
...
.method public final z()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-static {v0}, Lea/d;->F0(Lea/c;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {v5}, Lea/a;->q()Landroid/hardware/camera2/CameraDevice;
    ...
    invoke-virtual {v6}, Lea/v1;->o()Landroid/util/SparseArray;

    move-result-object v6

    invoke-static {v6}, Lna/d;->c(Landroid/util/SparseArray;)Ljava/util/ArrayList;
    ...
    :cond_6
    :goto_2
    invoke-virtual {v5}, Lea/a;->P()I

    move-result v6

    iput v6, p0, Lea/x0;->t:I
    ...
    invoke-virtual {v5}, Lea/a;->m0()Z

    move-result v10

    invoke-virtual {v6, v9, v10}, Lea/v1;->m(IZ)Landroid/view/Surface;

    move-result-object v6

    invoke-static {v6}, Lck/r;->d(Landroid/view/Surface;)Landroid/util/Size;
    ...
    invoke-virtual {v1, v4}, Lea/v1;->q(I)Landroid/view/Surface;
    ...
    invoke-virtual {p0, v9, v6, v1}, Lea/c1;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    :cond_9
    invoke-virtual {v5}, Lea/a;->K()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-virtual {v5, v0, v8}, Lea/a;->c(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-boolean v7, v6, Lea/x;->x1:Z

    if-eqz v7, :cond_a

    iput-boolean v4, v6, Lea/x;->x1:Z
    ...
    invoke-static {v8, v0, v1, v6}, Lea/z;->N(ILandroid/hardware/camera2/CaptureRequest$Builder;Lea/c;Lea/x;)V

    new-instance v6, Lcom/android/camera/fragment/beauty/q;

    invoke-direct {v6}, Lcom/android/camera/fragment/beauty/q;-><init>()V

    const-string v7, "i:0"

    iput-object v7, v6, Lcom/android/camera/fragment/beauty/q;->a:Ljava/lang/String;

    sget-object v7, Lbk/a;->a:Ljava/util/Map;

    iget-object v8, v1, Lea/c;->e:Ljava/util/HashSet;

    invoke-static {v0, v7, v8, v6}, Lcom/android/camera2/compat/MiCameraCompat;->applyBeautyParameter(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/util/Map;Ljava/util/HashSet;Lcom/android/camera/fragment/beauty/q;)V

    invoke-virtual {v5}, Lea/a;->s()Lea/c;

    move-result-object v5

    invoke-static {v5}, Lea/d;->F0(Lea/c;)Z
    ...
    invoke-static {v0, v1, v4}, Lea/z;->t0(Landroid/hardware/camera2/CaptureRequest$Builder;Lea/c;Z)V
