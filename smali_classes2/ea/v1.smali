...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lea/v1;->i:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lea/v1;->j:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lea/v1;->k:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public static l(Lea/x;I)Landroid/util/Size;
    .locals 2
    ...
    iget-object p0, p0, Lea/x;->p:Landroid/util/Size;
    ...
    iget-object p0, p0, Lea/x;->q:Landroid/util/Size;
    ...
    iget-object p0, p0, Lea/x;->r:Landroid/util/Size;
    ...
    iget-object p0, p0, Lea/x;->u:Landroid/util/Size;
    ...
    iget-object p0, p0, Lea/x;->v:Landroid/util/Size;
...
# virtual methods
.method public final A(Landroid/util/Size;Lea/n0$g;Landroid/os/Handler;)V
    .locals 5
    ...
    iput-object p1, p0, Lea/v1;->p:Landroid/media/ImageReader;
    ...
    :goto_0
    iget-object p1, p0, Lea/v1;->p:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, Lea/v1;->p:Landroid/media/ImageReader;

    invoke-static {p0}, Lea/v1;->z(Landroid/media/ImageReader;)V

    return-void
.end method

.method public final B(Lea/x;Lea/n0$a;Landroid/os/Handler;)V
    .locals 3

    invoke-virtual {p0}, Lea/v1;->e()V

    iget-object v0, p1, Lea/x;->i:Landroid/util/Size;
    ...
    iget v2, p1, Lea/x;->U:I

    iget p1, p1, Lea/x;->X:I

    invoke-static {v1, v0, v2, p1}, Landroid/media/ImageReader;->newInstance(IIII)Landroid/media/ImageReader;

    move-result-object p1

    iput-object p1, p0, Lea/v1;->a:Landroid/media/ImageReader;

    invoke-virtual {p1, p2, p3}, Landroid/media/ImageReader;->setOnImageAvailableListener(Landroid/media/ImageReader$OnImageAvailableListener;Landroid/os/Handler;)V

    iget-object p0, p0, Lea/v1;->a:Landroid/media/ImageReader;
...
.method public final C(Lea/x;Landroid/media/ImageReader$OnImageAvailableListener;Landroid/os/Handler;)V
    .locals 4

    iget-object v0, p0, Lea/v1;->g:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, Lea/v1;->g:Landroid/media/ImageReader;

    :cond_0
    iget-object v0, p1, Lea/x;->h:Landroid/util/Size;
    ...
    invoke-static {v3, v0}, La0/a0;->d(Ljava/lang/String;Landroid/util/Size;)Ljava/lang/String;
    ...
    iget v2, p1, Lea/x;->T:I

    iget p1, p1, Lea/x;->W:I

    invoke-static {v1, v0, v2, p1}, Landroid/media/ImageReader;->newInstance(IIII)Landroid/media/ImageReader;

    move-result-object p1

    iput-object p1, p0, Lea/v1;->g:Landroid/media/ImageReader;
...
.method public final a()V
    ...
    iput-object v1, p0, Lea/v1;->g:Landroid/media/ImageReader;

    :cond_0
    invoke-virtual {p0}, Lea/v1;->f()V

    iget-object v0, p0, Lea/v1;->o:Landroid/media/ImageReader;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, Lea/v1;->o:Landroid/media/ImageReader;

    :cond_1
    invoke-virtual {p0}, Lea/v1;->c()V

    invoke-virtual {p0}, Lea/v1;->g()V

    iget-object v0, p0, Lea/v1;->q:Landroid/media/ImageReader;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, Lea/v1;->q:Landroid/media/ImageReader;

    :cond_2
    iget-object v0, p0, Lea/v1;->h:Landroid/media/ImageReader;

    if-eqz v0, :cond_3

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, Lea/v1;->h:Landroid/media/ImageReader;

    :cond_3
    invoke-virtual {p0}, Lea/v1;->b()V

    invoke-virtual {p0}, Lea/v1;->d()V

    iget-object v0, p0, Lea/v1;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, p0, Lea/v1;->j:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :goto_2
    iget-object v1, p0, Lea/v1;->k:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final b()V
    ...
    iget-object v0, p0, Lea/v1;->e:Landroid/media/ImageReader;

    if-eqz v0, :cond_1

    iget-boolean v1, p0, Lea/v1;->x:Z
    ...
    invoke-static {v0}, Lea/v1;->y(Landroid/media/ImageReader;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lea/v1;->e:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, Lea/v1;->e:Landroid/media/ImageReader;

    invoke-static {p0}, Lea/v1;->x(Landroid/media/ImageReader;)V
...
.method public final c()V
    ...
    iget-object v0, p0, Lea/v1;->p:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, Lea/v1;->p:Landroid/media/ImageReader;
...
.method public final d()V
    ...
    iget-object v0, p0, Lea/v1;->d:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, Lea/v1;->d:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, Lea/v1;->d:Landroid/media/ImageReader;
...
.method public final e()V
    ...
    iget-object v0, p0, Lea/v1;->a:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, Lea/v1;->a:Landroid/media/ImageReader;
...
.method public final f()V
    ...
    iget-object v0, p0, Lea/v1;->l:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, Lea/v1;->l:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, Lea/v1;->l:Landroid/media/ImageReader;
...
.method public final g()V
    ...
    iget-object v0, p0, Lea/v1;->f:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, Lea/v1;->f:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, Lea/v1;->f:Landroid/media/ImageReader;
...
.method public final h()Landroid/view/Surface;
    ...
    invoke-virtual {p0, v0}, Lea/v1;->q(I)Landroid/view/Surface;
...
.method public final j(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {p0, p1}, Lea/v1;->q(I)Landroid/view/Surface;
...
.method public final m(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {p0, v1}, Lea/v1;->q(I)Landroid/view/Surface;
    ...
    :cond_1
    invoke-virtual {p0, p2}, Lea/v1;->q(I)Landroid/view/Surface;
    ...
    :cond_3
    invoke-virtual {p0, v2}, Lea/v1;->q(I)Landroid/view/Surface;
...
.method public final o()Landroid/util/SparseArray;
    ...
    iget-object p0, p0, Lea/v1;->v:Landroid/util/SparseArray;
...
.method public final q(I)Landroid/view/Surface;
    ...
    iget-object p0, p0, Lna/e;->e:Landroid/media/ImageReader;
