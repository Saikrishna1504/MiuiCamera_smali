...
.method public constructor <init>(Lea/y1;)V
    ...
    iput-object p1, p0, Lea/y1$b;->a:Lea/y1;
...
.method public final onDataReady(J)V
    ...
    invoke-static {v0, p1, p2}, Lea/y1;->y(Lea/y1;J)V

    iget-object p1, p0, Lea/y1$b;->a:Lea/y1;
    ...
    invoke-virtual {p2}, Lea/a;->D()Ljava/util/concurrent/ConcurrentLinkedDeque;

    move-result-object p2

    iget-object v0, p0, Lea/y1$b;->a:Lea/y1;

    iget-object v0, v0, Lea/y1;->C:Lyg/q;

    iget-wide v0, v0, Lyg/q;->e:J

    invoke-virtual {p1, p2, v0, v1}, Lea/y1;->I(Ljava/util/concurrent/ConcurrentLinkedDeque;J)V

    iget-object p1, p0, Lea/y1$b;->a:Lea/y1;

    iget-object p2, p1, Lea/x0;->b:Lea/a;

    invoke-virtual {p2}, Lea/a;->C()Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    iget-object v0, v0, Lea/x0;->b:Lea/a;

    invoke-virtual {v0}, Lea/a;->C()Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    invoke-virtual {p0}, Lea/a;->D()Ljava/util/concurrent/ConcurrentLinkedDeque;
...
.method public final onImageReceived(Lyg/q;[BLjava/lang/String;)V
    ...
    iget-object v2, v1, Lea/x0;->r:Ljg/a;
    ...
    :goto_0
    iget-object v2, p0, Lea/y1$b;->a:Lea/y1;

    iget-object v2, v2, Lea/x0;->r:Ljg/a;

    new-instance v4, Le7/d2;

    invoke-direct {v4, v0, p0, p2, p3}, Le7/d2;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {v2, v4, p2, v1}, Ljg/a;->a(Ljava/lang/Runnable;Ljava/lang/Runnable;Lio/reactivex/Scheduler;)V

    goto :goto_1

    :cond_2
    invoke-static {v1, p2, p3}, Lea/y1;->z(Lea/y1;[BLjava/lang/String;)V

    :goto_1
    iget-object p2, p0, Lea/y1$b;->a:Lea/y1;

    iget p3, p2, Lea/y1;->M:I

    add-int/2addr p3, v0

    iput p3, p2, Lea/y1;->M:I
    ...
    iget-object p1, p1, Lea/x0;->b:Lea/a;

    invoke-virtual {p1}, Lea/a;->U()Lea/v1;

    move-result-object p2

    iget-object p2, p2, Lea/v1;->a:Landroid/media/ImageReader;
    ...
    iget-object p2, p2, Lea/v1;->f:Landroid/media/ImageReader;
    ...
    iget-object p2, p2, Lea/v1;->e:Landroid/media/ImageReader;
    ...
    iget-object p2, p2, Lea/v1;->p:Landroid/media/ImageReader;
    ...
    iget-object p2, p2, Lea/v1;->l:Landroid/media/ImageReader;
    ...
    iget-object p2, p1, Lea/v1;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_a
    iget-object p1, p1, Lea/v1;->j:Ljava/util/concurrent/ConcurrentHashMap;
