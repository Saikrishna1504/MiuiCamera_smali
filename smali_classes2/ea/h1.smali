...
.method public constructor <init>(Lea/n0;ILandroid/view/Surface;)V
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Lea/c1;-><init>(Lea/n0;Ljg/a;)V

    const/4 p1, 0x1

    iput-boolean p1, p0, Lea/h1;->D:Z

    iput p2, p0, Lea/h1;->G:I

    sget-object p1, Ljg/d;->b:Ljg/d;

    iput-object p1, p0, Lea/h1;->I:Ljg/d;

    iput-object p3, p0, Lea/h1;->J:Landroid/view/Surface;

    return-void
.end method

.method public static y(Lea/h1;ZI)V
    .locals 5
    ...
    invoke-interface {p2, p1, v3, v4, v2}, Lea/a$k;->onPictureTakenFinished(ZJI)V
...
.method public final m()V
    ...
    iget v0, p0, Lea/h1;->H:I

    iget v1, p0, Lea/h1;->G:I
    ...
    invoke-static {v3}, Lea/d;->H2(Lea/c;)Z
    ...
    invoke-static {v0}, Lea/d;->H2(Lea/c;)Z
    ...
    :cond_2
    :try_start_0
    new-instance v0, Lea/g1;

    invoke-direct {v0, p0}, Lea/g1;-><init>(Lea/h1;)V

    invoke-virtual {p0}, Lea/h1;->z()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v4

    iget-object v5, p0, Lea/h1;->J:Landroid/view/Surface;
    ...
    iget-object v11, p0, Lea/x0;->c:Landroid/os/Handler;
    ...
    iget v10, p0, Lea/h1;->H:I

    add-int/2addr v10, v6

    iput v10, p0, Lea/h1;->H:I

    iput v9, p0, Lea/h1;->E:I

    if-ne v10, v1, :cond_5

    iput v9, p0, Lea/h1;->F:I
...
.method public final z()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    :cond_1
    invoke-virtual {v3}, Lea/a;->U()Lea/v1;

    move-result-object v4

    invoke-virtual {v4}, Lea/v1;->o()Landroid/util/SparseArray;

    move-result-object v4

    invoke-static {v4}, Lna/d;->c(Landroid/util/SparseArray;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v10}, Lea/v1;->u()Landroid/view/Surface;
    ...
    invoke-static {v9}, Lck/r;->d(Landroid/view/Surface;)Landroid/util/Size;
    ...
    iput-object v1, p0, Lea/c1;->v:Landroid/util/Size;
    ...
    invoke-virtual {v3}, Lea/a;->m0()Z

    move-result v10

    invoke-virtual {v4, v9, v10}, Lea/v1;->m(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v1, v8}, Lea/v1;->q(I)Landroid/view/Surface;
    ...
    invoke-virtual {p0, v9, v4, v1}, Lea/c1;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v1

    iput-object v1, p0, Lea/c1;->B:Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-static {v1}, Lea/d;->H2(Lea/c;)Z
    ...
    invoke-virtual {v1}, Lea/v1;->w()Landroid/view/Surface;
    ...
    invoke-static {v1}, Lck/r;->d(Landroid/view/Surface;)Landroid/util/Size;
    ...
    :cond_8
    invoke-virtual {v3}, Lea/a;->K()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-virtual {v3, v0, v6}, Lea/a;->c(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    invoke-static {v6, v0, v1, v4}, Lea/z;->N(ILandroid/hardware/camera2/CaptureRequest$Builder;Lea/c;Lea/x;)V
    ...
    iget-object v6, v1, Lea/c;->e:Ljava/util/HashSet;

    invoke-static {v0, v5, v6, v4}, Lcom/android/camera2/compat/MiCameraCompat;->applyBeautyParameter(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/util/Map;Ljava/util/HashSet;Lcom/android/camera/fragment/beauty/q;)V
    ...
    invoke-static {v0, v1, v8}, Lea/z;->A0(Landroid/hardware/camera2/CaptureRequest$Builder;Lea/c;Z)V

    invoke-static {v0, v1, v8}, Lea/z;->t0(Landroid/hardware/camera2/CaptureRequest$Builder;Lea/c;Z)V
    ...
    invoke-static {v1}, Lea/d;->N1(Lea/c;)Z
    ...
    sget-object p0, Lra/x;->q3:Lra/w;

    invoke-static {v2}, Ljava/lang/Byte;->valueOf(B)Ljava/lang/Byte;

    move-result-object v1

    invoke-static {v0, p0, v1}, Lra/b0;->h(Landroid/hardware/camera2/CaptureRequest$Builder;Lra/a0;Ljava/lang/Object;)V
