...
.method public synthetic constructor <init>(Lea/w;I)V
    ...
    iput p2, p0, Lea/t;->a:I

    iput-object p1, p0, Lea/t;->b:Lea/w;
...
.method public final accept(Ljava/lang/Object;)V
    ...
    iget-object p0, p0, Lea/t;->b:Lea/w;
    ...
    invoke-static {v0, p1, p0}, Lea/z;->j0(Landroid/hardware/camera2/CaptureRequest$Builder;Lea/c;Lea/x;)V
    ...
    iget p0, p0, Lea/x;->l0:I

    invoke-virtual {p1}, Lea/a;->s()Lea/c;

    move-result-object p1

    invoke-static {v0, p0, p1}, Lea/z;->g(Landroid/hardware/camera2/CaptureRequest$Builder;ILea/c;)V
    ...
    iget-boolean p0, p0, Lea/x;->Z1:Z

    const-string v4, "applyVideoHdrMode: "

    invoke-static {v4, p0}, La0/v3;->e(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    sget-object p0, Lra/x;->y2:[I

    goto :goto_0

    :cond_1
    sget-object p0, Lra/x;->x2:[I
    ...
    iget-object v2, p1, Lea/c;->f6:Ljava/lang/Boolean;

    if-nez v2, :cond_3

    sget-object v2, Lra/x;->y3:Lra/w;

    invoke-static {v2, p1}, La0/b0;->b(Lra/w;Lea/c;)Ljava/lang/Boolean;

    move-result-object v2

    iput-object v2, p1, Lea/c;->f6:Ljava/lang/Boolean;
    ...
    iget-object v2, p1, Lea/c;->g6:Ljava/lang/Boolean;

    if-nez v2, :cond_6

    sget-object v2, Lra/x;->x3:Lra/w;

    invoke-static {v2, p1}, La0/b0;->b(Lra/w;Lea/c;)Ljava/lang/Boolean;

    move-result-object v2

    iput-object v2, p1, Lea/c;->g6:Ljava/lang/Boolean;
    ...
    invoke-static {v0, p0}, Lea/z;->n(Landroid/hardware/camera2/CaptureRequest$Builder;Lea/x;)V
    ...
    iget-object v4, p0, Lea/w;->a:Lea/x;

    iget-boolean v4, v4, Lea/x;->a3:Z
    ...
    :cond_a
    iget-object v4, p1, Lea/c;->S5:Ljava/lang/Boolean;

    if-nez v4, :cond_b

    sget-object v4, Lra/x;->a4:Lra/w;

    invoke-static {v4, p1}, La0/b0;->b(Lra/w;Lea/c;)Ljava/lang/Boolean;

    move-result-object v4

    iput-object v4, p1, Lea/c;->S5:Ljava/lang/Boolean;

    :cond_b
    iget-object p1, p1, Lea/c;->S5:Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Luc/b;->k()S

    move-result p1

    sget-object v4, L鞴鞸鞺韹鞺鞾韹鞴鞸鞹鞱鞾鞰鞳鞶鞣鞶韹鞄鞻鞸鞠鞚鞸鞣鞾鞸鞹鞒鞹鞢鞺;->g:L鞴鞸鞺韹鞺鞾韹鞴鞸鞹鞱鞾鞰鞳鞶鞣鞶韹鞄鞻鞸鞠鞚鞸鞣鞾鞸鞹鞒鞹鞢鞺;

    iget-short v4, v4, L鞴鞸鞺韹鞺鞾韹鞴鞸鞹鞱鞾鞰鞳鞶鞣鞶韹鞄鞻鞸鞠鞚鞸鞣鞾鞸鞹鞒鞹鞢鞺;->a:S
