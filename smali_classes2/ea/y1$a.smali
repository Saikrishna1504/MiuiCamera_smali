...
.method public constructor <init>(Lea/y1;)V
    ...
    iput-object p1, p0, Lea/y1$a;->a:Lea/y1;
...
.method public final onCaptureCompleted(Ljava/lang/String;J)V
    ...
    iget-object p1, p0, Lea/y1$a;->a:Lea/y1;
    ...
    iget-object v1, p1, Lea/y1;->H:Ljava/lang/String;

    aput-object v1, p3, v0

    invoke-virtual {p1}, Lea/y1;->D()J
    ...
    invoke-virtual {p1, p2}, Lea/y1;->A(I)V
    ...
    invoke-interface {p2}, Lea/a$k;->onAllHalFrameReceived()V

    :cond_0
    iget-object p0, p0, Lea/y1$a;->a:Lea/y1;

    invoke-virtual {p0}, Lea/y1;->E()V
...
.method public final onCaptureFailed(Ljava/lang/String;JLjava/lang/String;)V
    ...
    iget-object v0, p0, Lea/y1$a;->a:Lea/y1;
    ...
    invoke-static {v0, v2, v3}, Lea/y1;->y(Lea/y1;J)V
    ...
    iget-object v4, v0, Lea/x0;->b:Lea/a;

    invoke-virtual {v4}, Lea/a;->C()Ljava/util/concurrent/ConcurrentLinkedDeque;

    move-result-object v4

    invoke-virtual {v0, v4, v2, v3}, Lea/y1;->I(Ljava/util/concurrent/ConcurrentLinkedDeque;J)V

    iget-object v0, p0, Lea/y1$a;->a:Lea/y1;

    iget-object v4, v0, Lea/x0;->b:Lea/a;

    invoke-virtual {v4}, Lea/a;->D()Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    iget-object v3, p0, Lea/y1$a;->a:Lea/y1;

    iget-object v3, v3, Lea/x0;->b:Lea/a;

    invoke-virtual {v3}, Lea/a;->C()Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    invoke-virtual {v3}, Lea/a;->D()Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    iget-boolean v2, v0, Lea/y1;->I:Z

    if-nez v2, :cond_2

    const/4 v2, 0x1

    iput-boolean v2, v0, Lea/y1;->I:Z

    iget-object v2, v0, Lea/x0;->b:Lea/a;

    invoke-virtual {v2, v0, v1}, Lea/a;->v0(Lea/x0;Z)V
    ...
    iget-object v2, p0, Lea/y1$a;->a:Lea/y1;
    ...
    invoke-virtual {v0, v1, p0, p4}, Lq1/c;->i(ILjava/lang/String;Ljava/lang/String;)V
