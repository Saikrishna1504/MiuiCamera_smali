...
.method public constructor <init>(Landroid/hardware/camera2/CaptureResult;Lea/n0;Ljg/a;)V
    ...
    invoke-direct {p0, p2, p3}, Lea/c1;-><init>(Lea/n0;Ljg/a;)V

    const/16 p3, 0xb

    iput p3, p0, Lea/j1;->J:I

    const/4 p3, -0x1

    iput p3, p0, Lea/j1;->O:I

    iput-object p1, p0, Lea/c1;->x:Landroid/hardware/camera2/CaptureResult;

    iget-object p1, p2, Lea/n0;->m0:Lea/q2;

    iput-object p1, p0, Lea/j1;->C:Lea/q2;
...
.method public final A()Z
    ...
    invoke-static {v0}, Lea/b0;->k(Landroid/hardware/camera2/CaptureResult;)Z
    ...
    :cond_0
    iget-boolean v0, p0, Lea/j1;->I:Z

    if-nez v0, :cond_1

    invoke-virtual {p0}, Lea/j1;->z()V

    :cond_1
    iget-object p0, p0, Lea/j1;->H:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
...
.method public final k()V
    ...
    iget-object v1, p0, Lea/j1;->H:Lcom/xiaomi/camera/imagecodec/FeatureSetting;

    invoke-virtual {v1}, Lcom/xiaomi/camera/imagecodec/FeatureSetting;->getFrameCount()I

    move-result v1

    iput v1, p0, Lea/j1;->E:I
    ...
    iget-boolean v5, p0, Lea/j1;->D:Z

    if-eqz v5, :cond_4

    const/16 v5, 0x9

    invoke-static {v0, v5, v2}, Lea/d;->D0(IILea/c;)Z
    ...
    :goto_2
    iput-boolean v0, p0, Lea/x0;->m:Z

    iget v0, p0, Lea/j1;->J:I
    ...
    iput-object v0, p0, Lea/x0;->o:Landroid/util/Size;
...
.method public final m()V
    ...
    :try_start_0
    new-instance v3, Lea/i1;

    invoke-direct {v3, p0}, Lea/i1;-><init>(Lea/j1;)V

    invoke-virtual {p0}, Lea/j1;->y()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v4

    iget-object v5, p0, Lea/j1;->H:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
    ...
    iget-object v9, p0, Lea/j1;->N:Landroid/util/Size;

    invoke-virtual {v9}, Landroid/util/Size;->getWidth()I

    move-result v9

    iget-object v10, p0, Lea/j1;->N:Landroid/util/Size;
    ...
    invoke-virtual {p0, v4, v8, v5}, Lea/c1;->r(Landroid/hardware/camera2/CaptureRequest;Lcom/xiaomi/engine/BufferFormat;I)Lcom/xiaomi/engine/PreProcessData;

    move-result-object v4

    if-eqz v4, :cond_4

    invoke-virtual {p0, v4}, Lea/c1;->w(Lcom/xiaomi/engine/PreProcessData;)V
    ...
    invoke-virtual {v4, v5}, Lo7/j;->d(Ljava/lang/String;)J
    ...
    invoke-virtual {v4, v5}, Lo7/j;->o(Ljava/lang/String;)V
    ...
    invoke-static {v4, v5}, Lq2/a;->a(Ljava/lang/String;Landroid/hardware/camera2/CaptureRequest;)V

    invoke-virtual {v1}, Lea/a;->t()Landroid/hardware/camera2/CameraCaptureSession;

    move-result-object v4

    iget-object v5, p0, Lea/x0;->c:Landroid/os/Handler;
    ...
    iput-object v3, p0, Lea/c1;->y:Ljava/lang/String;

    invoke-virtual {v1}, Ljava/lang/Object;->hashCode()I

    move-result v3

    iget p0, p0, Lea/j1;->E:I

    invoke-static {v3, p0}, La0/u5;->a(II)V
    :try_end_0
...
.method public final y()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-object v6, v3, Lea/c;->a7:Ljava/lang/Boolean;

    if-nez v6, :cond_2

    sget-object v6, Lra/f;->W2:Lra/e;
    ...
    iput-object v6, v3, Lea/c;->a7:Ljava/lang/Boolean;
    ...
    :cond_2
    :goto_1
    iget-object v3, v3, Lea/c;->a7:Ljava/lang/Boolean;
    ...
    :cond_4
    iget-object v3, p0, Lea/j1;->L:Landroid/view/Surface;

    invoke-virtual {v1, v3}, Landroid/hardware/camera2/CaptureRequest$Builder;->addTarget(Landroid/view/Surface;)V

    iget v3, v0, Lea/a;->a:I

    invoke-static {v3}, Lgg/b;->a(I)I
    ...
    iget-object v3, p0, Lea/j1;->K:Landroid/view/Surface;

    invoke-virtual {v0}, Lea/a;->U()Lea/v1;

    move-result-object v8

    invoke-virtual {v8, v5}, Lea/v1;->q(I)Landroid/view/Surface;
    ...
    iget-object v11, p0, Lea/j1;->M:Landroid/util/Size;

    invoke-virtual {p0, v3, v11, v8, v7}, Lea/c1;->o(ILandroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v3

    iput-object v3, p0, Lea/c1;->B:Lcom/xiaomi/engine/BufferFormat;

    goto :goto_5

    :cond_9
    iget-object v3, p0, Lea/j1;->M:Landroid/util/Size;

    invoke-virtual {p0, v3, v8, v7}, Lea/c1;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {v7}, Lea/v1;->p()Landroid/view/Surface;
    ...
    iget-object v7, v7, Lea/v1;->g:Landroid/media/ImageReader;
    ...
    invoke-static {v1, v10, v7}, Lea/z;->i(Landroid/hardware/camera2/CaptureRequest$Builder;ILea/x;)V

    invoke-virtual {v0, v1, v10}, Lea/a;->c(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget v7, v7, Lea/x;->Y2:I

    if-eq v7, v10, :cond_e

    if-eq v7, v9, :cond_d

    iget-boolean v8, p0, Lea/j1;->D:Z
    ...
    invoke-static {v8, v7, v9, v2}, La0/c0;->g(Ljava/lang/String;ILjava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v8, v2, Lea/c;->Q6:Ljava/lang/Boolean;

    if-nez v8, :cond_12

    sget-object v8, Lra/f;->T2:Lra/e;

    invoke-virtual {v8}, Lra/e;->c()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v2, v9}, Lea/c;->D0(Ljava/lang/String;)Z

    move-result v9

    if-eqz v9, :cond_11

    iget-object v9, v2, Lea/c;->c:Landroid/hardware/camera2/CameraCharacteristics;

    invoke-static {v9, v8}, Lra/b0;->d(Landroid/hardware/camera2/CameraCharacteristics;Lra/a0;)Ljava/lang/Object;
    ...
    iput-object v8, v2, Lea/c;->Q6:Ljava/lang/Boolean;
    ...
    :cond_12
    :goto_8
    iget-object v2, v2, Lea/c;->Q6:Ljava/lang/Boolean;
    ...
    :cond_16
    iget-object v2, p0, Lea/j1;->C:Lea/q2;

    if-eqz v2, :cond_18

    iget-object v2, v2, Lea/q2;->g:Lea/q2$a;

    iget-boolean v2, v2, Lea/q2$a;->a:Z
    ...
    iget v2, v2, Lea/x;->a0:F

    iget-object v3, p0, Lea/c1;->w:Landroid/graphics/Rect;

    invoke-static {v3, v2}, Lbk/e;->w(Landroid/graphics/Rect;F)Landroid/graphics/Rect;
    ...
    sget-object v2, Lra/x;->W3:Lra/w;

    invoke-virtual {v0}, Lea/a;->v()Lea/x;

    move-result-object v3

    iget v3, v3, Lea/x;->Z2:I

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    invoke-static {v1, v2, v3}, Lra/b0;->h(Landroid/hardware/camera2/CaptureRequest$Builder;Lra/a0;Ljava/lang/Object;)V
    ...
    invoke-static {v1, v0, p0}, Lea/z;->q0(Landroid/hardware/camera2/CaptureRequest$Builder;Lea/c;Ljava/lang/String;)V
...
.method public final z()V
    ...
    iput-object v2, p0, Lea/j1;->L:Landroid/view/Surface;
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0

    :catch_0
    iget-object v2, p0, Lea/j1;->L:Landroid/view/Surface;

    const/4 v3, 0x1

    if-nez v2, :cond_0

    iput-boolean v3, p0, Lea/j1;->I:Z
    ...
    :cond_2
    invoke-virtual {v0}, Lea/a;->g0()Z

    move-result v6

    if-nez v6, :cond_4

    invoke-virtual {v0}, Lea/a;->h0()Z
    ...
    invoke-virtual {v7, v6, v8}, Lea/v1;->m(IZ)Landroid/view/Surface;

    move-result-object v7

    iput-object v7, p0, Lea/j1;->K:Landroid/view/Surface;
    ...
    iget-object v7, v5, Lea/x;->L:Landroid/util/Size;

    goto :goto_4

    :cond_7
    iget-object v7, v5, Lea/x;->N:Landroid/util/Size;

    goto :goto_4

    :cond_8
    iget-object v7, v5, Lea/x;->M:Landroid/util/Size;
    ...
    :cond_a
    iget-object v7, v5, Lea/x;->K:Landroid/util/Size;
    ...
    invoke-static {v12, v7}, La0/a0;->d(Ljava/lang/String;Landroid/util/Size;)Ljava/lang/String;
    ...
    :goto_5
    iput-object v7, p0, Lea/j1;->N:Landroid/util/Size;

    iget-object v7, p0, Lea/j1;->K:Landroid/view/Surface;

    invoke-static {v7}, Lck/r;->d(Landroid/view/Surface;)Landroid/util/Size;

    move-result-object v7

    iput-object v7, p0, Lea/j1;->M:Landroid/util/Size;
    ...
    iget-object v11, p0, Lea/j1;->N:Landroid/util/Size;
    ...
    iget-object v7, v5, Lea/x;->j:Landroid/util/Size;
    ...
    iget-object v12, p0, Lea/j1;->M:Landroid/util/Size;
    ...
    :goto_7
    iget-object v13, p0, Lea/j1;->M:Landroid/util/Size;
    ...
    invoke-static {v13, v7}, La0/a0;->d(Ljava/lang/String;Landroid/util/Size;)Ljava/lang/String;
    ...
    sget-object v12, Ln7/a;->b:Ln7/a;

    invoke-virtual {v12}, Ln7/a;->a()Lcom/android/camera/b$b;
    ...
    iget v12, v5, Lea/x;->Y2:I

    if-eq v12, v8, :cond_13

    if-eq v12, v9, :cond_12

    invoke-static {v11}, Lea/b0;->l(Landroid/hardware/camera2/CaptureResult;)Ljava/lang/Integer;

    move-result-object v2

    iget v9, v5, Lea/x;->g0:I
    ...
    invoke-static {v9, v12, v10, v3, v13}, Landroidx/appcompat/widget/b;->f(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v11}, Lgg/a;->b(Landroid/hardware/camera2/CaptureResult;)Landroid/os/Parcelable;

    move-result-object v2

    iget-wide v9, v5, Lea/x;->r0:J

    const-string v13, "default exposureTime: "

    invoke-static {v13, v9, v10}, La0/x;->h(Ljava/lang/String;J)Ljava/lang/String;
    ...
    sget-object v12, Lra/z;->r1:Lra/y;

    invoke-static {v8, v12}, Lra/b0;->e(Landroid/hardware/camera2/CaptureResult;Lra/a0;)Ljava/lang/Object;
    ...
    :cond_16
    iget-object v12, p0, Lea/c1;->x:Landroid/hardware/camera2/CaptureResult;

    sget-object v13, Lra/z;->q1:Lra/y;
    ...
    invoke-static {v8, v9, v10}, La0/x;->h(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget-object v8, p0, Lea/j1;->M:Landroid/util/Size;
    ...
    iput-object v0, p0, Lea/j1;->H:Lcom/xiaomi/camera/imagecodec/FeatureSetting;

    const-string v0, "featureType "

    const-string v1, ", initFeatureSetting: "

    invoke-static {v0, v3, v1}, La0/j0;->g(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
