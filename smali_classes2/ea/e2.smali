...
.method public constructor <init>(Landroid/hardware/camera2/CaptureResult;Lea/n0;Ljg/a;)V
    ...
    invoke-direct {p0, p2, p3}, Lea/y1;-><init>(Lea/n0;Ljg/a;)V
...
.method public final K()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-object v2, v2, Lea/v1;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v4, v5}, Lea/x;->f(Landroid/util/Size;)V
    ...
    iget-object v2, v2, Lea/v1;->w:Landroid/media/ImageReader;
    ...
    iget-object v2, v2, Lea/v1;->c:Landroid/media/ImageReader;
    ...
    iget-object v2, v2, Lea/v1;->h:Landroid/media/ImageReader;
    ...
    iget-object v2, v2, Lea/v1;->l:Landroid/media/ImageReader;
    ...
    iget-object v2, v2, Lea/v1;->f:Landroid/media/ImageReader;
    ...
    iget-object v2, p0, Lea/c;->o8:Ljava/lang/Boolean;
    ...
    iget-object v5, p0, Lea/c;->c:Landroid/hardware/camera2/CameraCharacteristics;

    invoke-static {v5, v2}, Lra/b0;->a(Landroid/hardware/camera2/CameraCharacteristics;Lra/a0;)Ljava/lang/Object;
    ...
    iput-object v2, p0, Lea/c;->o8:Ljava/lang/Boolean;
    ...
    invoke-static {p0}, Lck/r;->a(Landroid/view/Surface;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, p0}, Lea/a;->c(Landroid/hardware/camera2/CaptureRequest$Builder;I)V

    invoke-virtual {v0}, Lea/a;->v()Lea/x;

    move-result-object v2

    invoke-static {v1, p0, v2}, Lea/z;->i(Landroid/hardware/camera2/CaptureRequest$Builder;ILea/x;)V
...
.method public final m()V
    ...
    :try_start_0
    invoke-virtual {p0}, Lea/e2;->K()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iput-object v4, p0, Lea/y1;->C:Lyg/q;

    invoke-virtual {p0}, Lea/y1;->C()V
    ...
    invoke-static {v4}, Lea/d;->J2(Lea/c;)Z
    ...
    iget-object v5, p0, Lea/y1;->H:Ljava/lang/String;

    invoke-static {v3, v4, v5}, Lea/z;->q0(Landroid/hardware/camera2/CaptureRequest$Builder;Lea/c;Ljava/lang/String;)V
    ...
    new-instance v4, Lea/d2;

    invoke-direct {v4, p0}, Lea/d2;-><init>(Lea/e2;)V
    ...
    invoke-static {v1, v3}, Lq2/a;->a(Ljava/lang/String;Landroid/hardware/camera2/CaptureRequest;)V
    ...
    invoke-virtual {v1, v5}, Lo7/j;->d(Ljava/lang/String;)J
    ...
    invoke-virtual {v1, v5}, Lo7/j;->o(Ljava/lang/String;)V

    iget-object v1, p0, Lea/y1;->H:Ljava/lang/String;

    iget-object v5, p0, Lea/y1;->Q:Lea/y1$a;
    ...
    invoke-static {v0, v1}, La0/u5;->a(II)V
    :try_end_0
