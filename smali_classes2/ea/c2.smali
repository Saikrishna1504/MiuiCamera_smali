...
# direct methods
.method public constructor <init>(Lea/n0;ZLandroid/view/Surface;)V
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Lea/y1;-><init>(Lea/n0;Ljg/a;)V

    iput-object p3, p0, Lea/c2;->T:Landroid/view/Surface;

    iput-boolean p2, p0, Lea/c2;->V:Z

    return-void
.end method

.method public static K(Lea/c2;ZI)V
    .locals 4
    ...
    invoke-virtual {v2, v3}, Lea/w;->h(Z)V
    ...
    invoke-interface {p2, p1, v1, v2, v3}, Lea/a$k;->onPictureTakenFinished(ZJI)V
...
.method public final L()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-object v4, v4, Lea/v1;->j:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v8, p0, Lea/c1;->v:Landroid/util/Size;
    ...
    invoke-virtual {v8, v9}, Lea/x;->f(Landroid/util/Size;)V
    ...
    iget-object v4, v4, Lea/v1;->d:Landroid/media/ImageReader;
    ...
    invoke-static {v4}, Lck/r;->a(Landroid/view/Surface;)Ljava/lang/String;
    ...
    iget-object v4, v4, Lea/v1;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v4, v4, Lea/v1;->a:Landroid/media/ImageReader;
    ...
    iget-object v4, v4, Lea/v1;->f:Landroid/media/ImageReader;
    ...
    iget-boolean v5, v4, Lea/x;->x1:Z

    if-eqz v5, :cond_4

    iput-boolean v7, v4, Lea/x;->x1:Z

    :cond_4
    new-instance v4, Lcom/android/camera/fragment/beauty/q;

    invoke-direct {v4}, Lcom/android/camera/fragment/beauty/q;-><init>()V

    const-string v5, "i:0"

    iput-object v5, v4, Lcom/android/camera/fragment/beauty/q;->a:Ljava/lang/String;

    sget-object v5, Lbk/a;->a:Ljava/util/Map;

    iget-object v8, v3, Lea/c;->e:Ljava/util/HashSet;

    invoke-static {v1, v5, v8, v4}, Lcom/android/camera2/compat/MiCameraCompat;->applyBeautyParameter(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/util/Map;Ljava/util/HashSet;Lcom/android/camera/fragment/beauty/q;)V
    ...
    sget-object v4, Lra/x;->v4:Lra/w;

    invoke-static {v5}, Ljava/lang/Byte;->valueOf(B)Ljava/lang/Byte;

    move-result-object v5

    invoke-static {v1, v4, v5}, Lra/b0;->i(Landroid/hardware/camera2/CaptureRequest$Builder;Lra/a0;Ljava/lang/Object;)V
    ...
    invoke-static {v3}, Lea/d;->N1(Lea/c;)Z
    ...
    :cond_5
    iget-object v3, p0, Lea/x0;->g:Lea/a$k;

    iget-object v4, p0, Lea/c2;->U:Ljava/lang/String;

    if-nez v4, :cond_6

    if-eqz v3, :cond_6

    instance-of v4, v3, Lz6/s$b;

    if-eqz v4, :cond_6

    check-cast v3, Lz6/s$b;

    invoke-virtual {v3}, Lz6/s$b;->a()Ljava/lang/String;
    ...
    iput-object v3, p0, Lea/c2;->U:Ljava/lang/String;

    invoke-virtual {v0}, Lea/a;->s()Lea/c;

    move-result-object v0

    iget-object v3, p0, Lea/c2;->U:Ljava/lang/String;

    invoke-static {v1, v0, v3}, Lea/z;->q0(Landroid/hardware/camera2/CaptureRequest$Builder;Lea/c;Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lea/c2;->U:Ljava/lang/String;
...
.method public final M(Lyg/q;)V
    ...
    invoke-virtual {p0, v0, p1}, Lea/y1;->J(Landroid/hardware/camera2/TotalCaptureResult;Lyg/q;)V
    ...
    iget-object v2, p1, Lyg/q;->p:Ljava/lang/String;
    ...
    invoke-virtual {p1, v0}, Lyg/q;->k([B)V

    iget-object p0, p0, Lea/x0;->h:Lyg/o;
    ...
    invoke-virtual {p0, p1, v0, v1, v1}, Lo8/k;->l(Lyg/q;Landroid/hardware/camera2/TotalCaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    ...
    iget-object p0, p1, Lyg/q;->V:Ljava/lang/String;
...
.method public final j(Landroid/media/Image;I)V
    ...
    iget-boolean v0, p0, Lea/c2;->W:Z

    if-nez v0, :cond_0

    invoke-super {p0, p1, p2}, Lea/y1;->j(Landroid/media/Image;I)V
    ...
    invoke-virtual {v0, v2, v3}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->getParallelTaskData(J)Lyg/q;
    ...
    invoke-virtual {v0, p2, v4}, Lyg/q;->a(I[B)V

    iget-boolean p1, v0, Lyg/q;->G:Z
    ...
    :cond_3
    invoke-virtual {p0, v0}, Lea/c2;->M(Lyg/q;)V
...
.method public final k()V
    ...
    iget-boolean v2, v1, Lea/x;->G0:Z

    const/4 v3, 0x1

    if-eq v2, v3, :cond_0

    iput-boolean v3, v1, Lea/x;->G0:Z
    ...
    invoke-static {v0}, Lea/d;->B2(Lea/c;)Z

    move-result v0

    iput-boolean v0, p0, Lea/c2;->W:Z
...
.method public final m()V
    ...
    invoke-virtual {v3}, Lea/a;->A0()V

    :try_start_0
    new-instance v5, Lea/b2;

    invoke-direct {v5, p0}, Lea/b2;-><init>(Lea/c2;)V

    invoke-virtual {p0}, Lea/c2;->L()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v6

    iget-object v7, p0, Lea/c2;->T:Landroid/view/Surface;
    ...
    invoke-virtual {v3}, Lea/a;->q()Landroid/hardware/camera2/CameraDevice;
    ...
    invoke-static {v2, v7}, Lq2/a;->a(Ljava/lang/String;Landroid/hardware/camera2/CaptureRequest;)V

    invoke-static {}, Lo7/j;->h()Lo7/j;

    move-result-object v2

    invoke-virtual {v2, v0}, Lo7/j;->d(Ljava/lang/String;)J
    ...
    invoke-virtual {v3}, Lea/a;->t()Landroid/hardware/camera2/CameraCaptureSession;
    ...
    invoke-virtual {v3, p0}, Lea/a;->q0(I)V
