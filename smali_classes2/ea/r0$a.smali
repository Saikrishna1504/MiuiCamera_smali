...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lea/r0;->onCaptureStarted(Landroid/hardware/camera2/CameraCaptureSession;Landroid/hardware/camera2/CaptureRequest;JJ)V
.end annotation
...
# instance fields
.field public final synthetic a:Lyg/q;

.field public final synthetic b:Lea/r0;


# direct methods
.method public constructor <init>(Lea/r0;Lyg/q;)V
    .locals 0

    iput-object p1, p0, Lea/r0$a;->b:Lea/r0;

    iput-object p2, p0, Lea/r0$a;->a:Lyg/q;
...
.method public final onCaptureCompleted()V
    ...
    iget-object p0, p0, Lea/r0$a;->b:Lea/r0;
...
.method public final onCaptureFailed(Ljava/lang/String;)V
    ...
    iget-object p1, p0, Lea/r0;->a:Lea/s0;
...
.method public final onImageReceived(Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;)V
    ...
    iget-object v0, p0, Lea/r0$a;->b:Lea/r0;

    iget-object v0, v0, Lea/r0;->a:Lea/s0;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object p0, p0, Lea/r0$a;->a:Lyg/q;
    ...
    iget-object v3, v0, Lea/x0;->g:Lea/a$k;

    instance-of v5, v3, Lz6/s$b;

    if-eqz v5, :cond_2

    check-cast v3, Lz6/s$b;

    iget-boolean v5, p0, Lyg/q;->C:Z

    iget-object v3, v3, Lz6/s$b;->e:Lz6/s;

    iget-boolean v6, v3, Lz6/s;->g:Z
    ...
    :cond_0
    iput-boolean v5, v3, Lz6/s;->g:Z

    invoke-virtual {v3}, Lz6/s;->b()Lz6/s$c;
    ...
    iput-object v3, p0, Lyg/q;->h:Landroid/hardware/camera2/TotalCaptureResult;

    invoke-virtual {v0, p1, p0}, Lea/o0;->P(Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;Lyg/q;)V
    ...
    iget-object v6, v0, Lea/x0;->a:Ljava/lang/String;
    ...
    invoke-static {v2, v5}, La0/z3;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v7, v1}, Lea/o0;->E(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v3}, Lyg/q;->k([B)V

    iget-object v0, v0, Lea/x0;->h:Lyg/o;

    if-nez v0, :cond_4

    const-string p0, "notifyResultData: null parallel callback"

    invoke-static {v2, p0}, La0/m0;->c(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5, v1}, Lea/o0;->E(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lyg/q;->p:Ljava/lang/String;
    ...
    iget-object v1, p0, Lyg/q;->h:Landroid/hardware/camera2/TotalCaptureResult;

    check-cast v0, Lo8/k;

    const/4 v3, 0x0

    invoke-virtual {v0, p0, v1, v3, v3}, Lo8/k;->l(Lyg/q;Landroid/hardware/camera2/TotalCaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
