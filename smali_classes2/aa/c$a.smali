...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Laa/c;-><init>(Landroid/content/Context;ILaa/c$e;)V
.end annotation
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    :goto_1
    iget-object v5, p0, Laa/c;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-boolean p1, p0, Laa/c;->t:Z

    if-nez p1, :cond_7

    iput-boolean v1, p0, Laa/c;->t:Z

    goto/16 :goto_2

    :cond_5
    iget-object p1, p0, Laa/c;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Laa/c;->r:Ljava/lang/ref/WeakReference;

    invoke-virtual {v0}, Ljava/lang/ref/Reference;->get()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Laa/c$e;

    if-eqz v0, :cond_6

    invoke-interface {v0}, Laa/c$e;->onWideSelfCompleted()V
