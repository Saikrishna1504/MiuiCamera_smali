...
# direct methods
.method public constructor <init>(Landroid/os/Looper;Lyg/b;)V
    .locals 0
    ...
    iput-object p1, p0, Lyg/n$b;->a:Ljava/lang/ref/WeakReference;
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    iget-object p0, p0, Lyg/n$b;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {p0, v0, v1}, Lyg/n;->f(J)V
    ...
    invoke-virtual {p0, v0, v1}, Lyg/n;->a(J)V
    ...
    iget-object v0, p1, Ljg/c;->a:Landroid/media/Image;

    invoke-virtual {v0}, Landroid/media/Image;->getTimestamp()J

    move-result-wide v5

    iget v11, p1, Ljg/c;->b:I

    iget-object v7, p0, Lyg/n;->j:Lyg/n$a;

    iget-boolean v12, p1, Ljg/c;->c:Z

    if-eqz v7, :cond_b

    check-cast v7, Lyg/t$e;

    invoke-virtual {v7, v5, v6}, Lyg/t$e;->a(J)Lyg/q;
    ...
    :goto_2
    iget-object v5, p0, Lyg/n;->k:Lyg/k;

    iget-object v10, p1, Ljg/c;->e:Lyg/m;
    ...
    invoke-virtual/range {v5 .. v10}, Lyg/k;->a(Lyg/q;Landroid/media/Image;IZLyg/m;)V
    ...
    invoke-virtual {v5, v0, v11, v12}, Lyg/t$e;->d(Landroid/media/Image;IZ)V
    ...
    :cond_d
    iget-object p1, p0, Lyg/n;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_e
    iget-object p1, p0, Lyg/n;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_f
    iget-object p1, p0, Lyg/n;->b:Ljava/util/concurrent/atomic/AtomicInteger;
