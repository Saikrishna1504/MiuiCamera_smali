...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lyg/p;->c:Landroid/util/LongSparseArray;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0, v1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>(I)V

    iput-object v0, p0, Lyg/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v0, p0, Lyg/p;->a:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Lyg/p;->a:Landroid/os/HandlerThread;

    iget-object v0, v0, Lo7/g;->b:Landroid/os/Looper;

    :goto_0
    new-instance v1, Lyg/p$a;

    invoke-direct {v1, p0, v0}, Lyg/p$a;-><init>(Lyg/p;Landroid/os/Looper;)V

    iput-object v1, p0, Lyg/p;->b:Lyg/p$a;

    return-void
.end method

.method public static a(Lyg/p;)V
    .locals 9
    ...
    iget-object v3, p0, Lyg/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p0, p0, Lyg/p;->c:Landroid/util/LongSparseArray;
    ...
    invoke-virtual {v2}, Ljg/b;->toString()Ljava/lang/String;
...
.method public static b(Lyg/p;J)J
    .locals 7

    iget-object p0, p0, Lyg/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p0, p1, p2}, La0/x;->h(Ljava/lang/String;J)Ljava/lang/String;
...
# virtual methods
.method public final c(JLjg/b;Z)Ljava/util/ArrayList;
    .locals 17
    .param p3    # Ljg/b;
    ...
    iget-object v2, v2, Ljg/b;->u:Ljava/lang/String;
    ...
    :goto_1
    iget-object v10, v5, Lyg/p;->c:Landroid/util/LongSparseArray;
    ...
    check-cast v10, Ljg/b$a;

    iget-wide v11, v10, Ljg/b$a;->o:J
    ...
    iget-object v11, v10, Ljg/b$a;->p:Ljava/lang/String;
    ...
    iget-wide v11, v10, Ljg/b$a;->q:J

    sub-long v11, v7, v11

    sget-boolean v13, Lya/b;->h:Z
    ...
    check-cast v1, Ljg/b$a;

    iget-wide v1, v1, Ljg/b$a;->o:J
    ...
    invoke-static {v3, v0}, La0/x3;->c(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public final d(Ljg/b$a;)V
    .locals 14

    invoke-virtual {p1}, Ljg/b$a;->c()Z
    ...
    iget-object v0, p0, Lyg/p;->c:Landroid/util/LongSparseArray;

    iget-wide v4, p1, Ljg/b$a;->o:J

    invoke-virtual {v0, v4, v5}, Landroid/util/LongSparseArray;->remove(J)V

    iget-object v0, p1, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v0}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getSequenceId()I

    move-result v0

    iget-object v2, p1, Ljg/b$a;->p:Ljava/lang/String;

    iget-object v4, p1, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v4}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getTimeStamp()J

    move-result-wide v4

    iget-wide v7, p1, Ljg/b$a;->n:J

    iget-object v9, p0, Lyg/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v11, v2, v3}, Ln2/h0;-><init>(Ljava/lang/String;I)V

    invoke-interface {v9, v11}, Ljava/util/stream/Stream;->filter(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object v2

    new-instance v9, Le7/s0;

    const/4 v11, 0x5

    invoke-direct {v9, v11}, Le7/s0;-><init>(I)V
    ...
    iget-wide v7, v9, Ljg/b;->d:J

    iput-wide v7, p1, Ljg/b$a;->n:J

    const-string v2, "ParallelDataZipper"

    const-string/jumbo v11, "update data bean\'s first timestamp to "

    invoke-static {v11, v7, v8}, La0/x;->h(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget-object v0, v9, Ljg/b;->f:Ljava/util/ArrayList;

    iget v1, v9, Ljg/b;->a:I

    if-ne v1, v3, :cond_1

    iget-wide v1, p1, Ljg/b$a;->o:J

    iget-wide v4, p1, Ljg/b$a;->n:J
    ...
    :goto_0
    iget p1, v9, Ljg/b;->h:I

    add-int/2addr p1, v3

    iput p1, v9, Ljg/b;->h:I
    ...
    iget-object p1, v9, Ljg/b;->v:Ljg/a;

    if-eqz p1, :cond_3

    invoke-virtual {v9}, Ljg/b;->b()Z
    ...
    iget-object p1, v9, Ljg/b;->q:Lyg/p$e;

    check-cast p1, Lyg/t$b;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget v0, v9, Ljg/b;->a:I

    invoke-static {v0}, Lgg/c;->c(I)Z
    ...
    iget-object p1, p1, Lyg/t$b;->a:Lyg/t;

    iget-object p1, p1, Lyg/t;->C:Lyg/t$e;

    invoke-virtual {p1, v3, v1, v2}, Lyg/t$e;->c(IJ)V

    :cond_2
    iget-object p1, v9, Ljg/b;->v:Ljg/a;

    new-instance v0, Lyg/p$g;

    invoke-direct {v0, p0, v9}, Lyg/p$g;-><init>(Lyg/p;Ljg/b;)V

    new-instance v1, Lyg/p$d;

    invoke-direct {v1, p0, v9}, Lyg/p$d;-><init>(Lyg/p;Ljg/b;)V

    iget-object p0, p0, Lyg/p;->b:Lyg/p$a;
    ...
    invoke-virtual {p1, v0, v1, p0}, Ljg/a;->a(Ljava/lang/Runnable;Ljava/lang/Runnable;Lio/reactivex/Scheduler;)V
    :try_end_0
    ...
    :cond_3
    iget-wide v0, v9, Ljg/b;->d:J

    iget-boolean p1, v9, Ljg/b;->s:Z
    ...
    iget-object v2, p1, Lyg/t$b;->a:Lyg/t;

    iget-object v2, v2, Lyg/t;->A:Lyg/t$c;

    const-string v3, "onPartialDataAvailable"

    invoke-virtual {v2, v9, v3}, Lyg/t$c;->c(Ljg/b;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v0, v1}, Lyg/t;->s(J)Lyg/q;

    move-result-object v2

    if-eqz v2, :cond_4

    iput-boolean v6, v2, Lyg/q;->x:Z
    ...
    invoke-virtual {v2, v6, v0, v1}, Lyg/t$e;->c(IJ)V

    iget-object p1, p1, Lyg/t$b;->a:Lyg/t;

    invoke-virtual {p1}, Lyg/t;->w()V
    ...
    iget-object p1, p0, Lyg/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p1, v9, Ljg/b;->w:Ljg/b$b;

    invoke-virtual {p0, p1}, Lyg/p;->j(Ljg/b$b;)V
    ...
    invoke-virtual {p0, v9}, Lyg/p;->l(Ljg/b;)V
...
.method public final declared-synchronized e(Landroid/media/Image;IIZ)V
    ...
    invoke-direct/range {v1 .. v6}, Lyg/p$c;-><init>(Lyg/p;Landroid/media/Image;IIZ)V
...
.method public final declared-synchronized f(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lyg/p$b;-><init>(Lyg/p;Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
...
.method public final g(Lyg/v;)V
    ...
    invoke-virtual {p0, p1}, Lyg/p;->i(Lyg/v;)V

    :goto_0
    return-void
.end method

.method public final declared-synchronized h(Ljg/b;)V
    .locals 3
    .param p1    # Ljg/b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    :try_start_0
    iget-object v1, p0, Lyg/p;->a:Landroid/os/HandlerThread;
    ...
    iget-object v1, p0, Lyg/p;->b:Lyg/p$a;
...
.method public final i(Lyg/v;)V
    ...
    invoke-static {v0, v1, v2}, La0/x;->h(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget-object v8, p0, Lyg/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {p0, v1, v2, v0, v6}, Lyg/p;->c(JLjg/b;Z)Ljava/util/ArrayList;

    move-result-object v4

    iget-boolean v3, p1, Lyg/v;->c:Z

    if-eqz v0, :cond_4

    iget-object v5, v0, Ljg/b;->q:Lyg/p$e;

    iget-object v9, v0, Ljg/b;->r:Lyg/n;

    iget-object v10, v0, Ljg/b;->f:Ljava/util/ArrayList;

    if-eqz v3, :cond_1

    iget-boolean v11, v0, Ljg/b;->s:Z

    if-eqz v11, :cond_0

    iget v10, v0, Ljg/b;->t:I

    invoke-virtual {v0}, Ljg/b;->a()Ljg/h;

    move-result-object v11

    if-eqz v11, :cond_2

    iget-object v11, v11, Ljg/h;->a:Ljava/util/List;
    ...
    iget-object v0, v0, Ljg/b;->w:Ljg/b$b;

    invoke-virtual {p0, v0}, Lyg/p;->j(Ljg/b$b;)V
    ...
    iget-object v5, p1, Lyg/v;->a:Lyg/p$e;
    ...
    invoke-virtual/range {v0 .. v5}, Lyg/t$b;->b(JILjava/util/ArrayList;Lyg/n;)V

    goto :goto_3

    :cond_7
    check-cast v5, Lyg/t$b;

    invoke-virtual {v5, v1, v2, v4}, Lyg/t$b;->a(JLjava/util/ArrayList;)V
...
.method public final j(Ljg/b$b;)V
    .locals 1
...
.method public final k(Ljg/b;)V
    ...
    iget-wide v2, p1, Ljg/b;->d:J

    iget-object v0, p0, Lyg/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v3, p1, Ljg/b;->w:Ljg/b$b;

    invoke-virtual {v0, v2, v3}, Landroid/os/Handler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v2

    sget-boolean v3, Lya/b;->h:Z
    ...
    :goto_1
    iget-object v4, p0, Lyg/p;->c:Landroid/util/LongSparseArray;

    invoke-virtual {v4}, Landroid/util/LongSparseArray;->size()I

    move-result v5

    iget-wide v6, p1, Ljg/b;->d:J
    ...
    check-cast v4, Ljg/b$a;

    iget-boolean v5, v4, Ljg/b$a;->m:Z

    if-nez v5, :cond_3

    iget-wide v8, v4, Ljg/b$a;->n:J

    cmp-long v5, v8, v6

    if-eqz v5, :cond_2

    iget-object v5, v4, Ljg/b$a;->p:Ljava/lang/String;

    iget-object v6, p1, Ljg/b;->u:Ljava/lang/String;
    ...
    check-cast v3, Ljg/b$a;

    iget-wide v4, v3, Ljg/b$a;->o:J
    ...
    :cond_7
    iget-wide v4, v3, Ljg/b$a;->n:J

    :goto_3
    iput-wide v6, v3, Ljg/b$a;->n:J

    iget v8, p1, Ljg/b;->b:I

    iput v8, v3, Ljg/b$a;->b:I

    iget-boolean v8, p1, Ljg/b;->l:Z

    iput-boolean v8, v3, Ljg/b$a;->f:Z

    iget-object v8, p1, Ljg/b;->o:Ljg/d;

    iput-object v8, v3, Ljg/b$a;->h:Ljg/d;

    iget-boolean v8, v3, Ljg/b$a;->m:Z

    const/4 v9, 0x1

    if-nez v8, :cond_8

    iput-boolean v9, v3, Ljg/b$a;->m:Z

    :cond_8
    iget-boolean v8, p1, Ljg/b;->m:Z

    iput-boolean v8, v3, Ljg/b$a;->i:Z
    ...
    invoke-virtual {v3}, Ljg/b$a;->b()V

    invoke-virtual {p0, v3}, Lyg/p;->d(Ljg/b$a;)V
...
.method public final l(Ljg/b;)V
    ...
    iget-wide v3, v2, Ljg/b;->d:J

    const-string/jumbo v0, "tryToConfirm: "

    invoke-static {v0, v3, v4}, La0/x;->h(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget-object v6, v2, Ljg/b;->q:Lyg/p$e;
    ...
    :try_start_0
    iget-object v0, v2, Ljg/b;->f:Ljava/util/ArrayList;
    ...
    check-cast v9, Ljg/b$a;

    iget-object v9, v9, Ljg/b$a;->d:Landroid/media/Image;
    ...
    invoke-virtual {v7, v9}, Lo7/j;->d(Ljava/lang/String;)J

    iget-boolean v7, v2, Ljg/b;->e:Z

    if-nez v7, :cond_2e

    if-eqz v0, :cond_2e

    check-cast v6, Lyg/t$b;
    ...
    invoke-static {v9, v10, v11, v12}, La0/m0;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-object v7, v7, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    :goto_4
    iget-object v11, v6, Lyg/t$b;->a:Lyg/t;

    iget-wide v12, v2, Ljg/b;->d:J

    invoke-virtual {v11, v12, v13}, Lyg/t;->s(J)Lyg/q;

    move-result-object v11

    if-eqz v11, :cond_6

    iget-object v12, v2, Ljg/b;->r:Lyg/n;

    if-eqz v12, :cond_5

    iput-boolean v8, v12, Lyg/n;->f:Z

    :cond_5
    iput-boolean v5, v11, Lyg/q;->x:Z

    if-eqz v7, :cond_6

    iput v8, v11, Lyg/q;->Q:I

    iput-object v12, v11, Lyg/q;->P:Ljava/lang/Object;
    ...
    iget-object v13, v2, Ljg/b;->f:Ljava/util/ArrayList;

    invoke-virtual {v13, v5}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v13

    check-cast v13, Ljg/b$a;

    iget-object v13, v13, Ljg/b$a;->d:Landroid/media/Image;
    ...
    :cond_9
    iget-object v13, v12, Lyg/n;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v13}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    iget-boolean v13, v12, Lyg/n;->m:Z

    if-eqz v13, :cond_a

    iget-object v13, v12, Lyg/n;->c:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v13}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    iget-object v12, v12, Lyg/n;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v12, v2, Ljg/b;->v:Ljg/a;

    if-nez v12, :cond_b

    iget-object v12, v6, Lyg/t$b;->a:Lyg/t;

    iget-object v12, v12, Lyg/t;->C:Lyg/t$e;

    iget-wide v13, v2, Ljg/b;->d:J

    invoke-virtual {v12, v5, v13, v14}, Lyg/t$e;->c(IJ)V
    ...
    iget-boolean v10, v11, Lyg/q;->J:Z

    if-eqz v10, :cond_1d

    iget-object v8, v2, Ljg/b;->f:Ljava/util/ArrayList;
    ...
    iget-object v13, v13, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    check-cast v15, Ljg/b$a;

    move-object/from16 v16, v8

    iget-object v8, v15, Ljg/b$a;->g:Landroid/media/Image;

    move-wide/from16 v17, v3

    iget-boolean v3, v15, Ljg/b$a;->l:Z
    ...
    iput-object v8, v11, Lyg/q;->K:Landroid/media/Image;
    ...
    invoke-static {v4, v8, v15, v15}, Lgg/e;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;

    move-result-object v4

    iput-object v4, v11, Lyg/q;->K:Landroid/media/Image;
    ...
    :cond_16
    :goto_c
    iget-object v4, v15, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v4, v8, v10, v10}, Lgg/e;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    iget-object v4, v12, Lyg/t;->A:Lyg/t$c;

    invoke-virtual {v4, v8}, Lyg/t$c;->b(Landroid/media/Image;)V
    ...
    iget-object v3, v6, Lyg/t$b;->a:Lyg/t;

    iget-boolean v3, v3, Lyg/t;->p:Z
    ...
    iget-object v0, v6, Lyg/t$b;->a:Lyg/t;
    ...
    iget-object v4, v2, Ljg/b;->f:Ljava/util/ArrayList;
    ...
    iget-object v5, v5, Ljg/b$a;->d:Landroid/media/Image;
    ...
    invoke-static {v5, v10, v3}, La0/b0;->e(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v0, v7, v8}, Lyg/t;->s(J)Lyg/q;
    ...
    check-cast v12, Ljg/b$a;

    iget-object v13, v12, Ljg/b$a;->d:Landroid/media/Image;

    invoke-virtual {v10, v13}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v12, v12, Ljg/b$a;->g:Landroid/media/Image;
    ...
    iget-boolean v13, v12, Ljg/b$a;->a:Z

    if-eqz v13, :cond_21

    iget-object v4, v12, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-object v4, v5, Lyg/q;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v4, v5, Lyg/q;->q:Lyg/r;

    new-instance v7, Lcom/xiaomi/camera/imagecodec/ReprocessData;

    iget-boolean v8, v4, Lyg/r;->B:Z

    iget-object v12, v4, Lyg/r;->D:Landroid/util/Size;
    ...
    iget-object v8, v4, Lyg/r;->i:Landroid/util/Size;

    invoke-virtual {v8}, Landroid/util/Size;->getWidth()I

    move-result v8

    iget-object v4, v4, Lyg/r;->i:Landroid/util/Size;
    ...
    invoke-virtual {v13, v0, v3}, Lyg/t$f;->onError(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v7, v8}, La0/x;->h(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget-object v0, v2, Ljg/b;->r:Lyg/n;

    iput-object v0, v11, Lyg/q;->P:Ljava/lang/Object;

    :cond_28
    iget-object v0, v6, Lyg/t$b;->a:Lyg/t;

    iget-object v0, v0, Lyg/t;->A:Lyg/t$c;

    invoke-virtual {v0, v2}, Lyg/t$c;->a(Ljg/b;)V
    ...
    iget-object v3, v0, Lyg/t;->A:Lyg/t$c;

    iput-object v3, v2, Ljg/b;->p:Lyg/d;

    if-eqz v11, :cond_2a

    iget-object v3, v11, Lyg/q;->q:Lyg/r;

    iget-boolean v4, v3, Lyg/r;->M:Z

    iput-boolean v4, v2, Ljg/b;->k:Z

    iget-boolean v4, v11, Lyg/q;->O:Z

    iput-boolean v4, v2, Ljg/b;->m:Z

    iget-boolean v4, v3, Lyg/r;->B:Z

    iput-boolean v4, v2, Ljg/b;->j:Z
    ...
    iput-object v4, v2, Ljg/b;->n:Landroid/util/Size;

    :cond_2a
    sget-object v3, Lzi/a$b;->a:Lzi/a;

    iget-object v0, v0, Lyg/t;->b:Lyg/n;

    invoke-virtual {v0}, Lyg/n;->i()Lcom/xiaomi/engine/TaskSession;
    ...
    iget v7, v2, Ljg/b;->c:I

    if-ne v7, v5, :cond_2d

    iget-object v4, v3, Lzi/a;->d:Landroid/os/HandlerThread;
    ...
    iget-object v4, v3, Lzi/a;->e:Lzi/a$d;
    ...
    new-instance v3, Lzi/a$c;

    invoke-direct {v3, v2, v0}, Lzi/a$c;-><init>(Ljg/b;Lcom/xiaomi/engine/TaskSession;)V
    ...
    invoke-virtual {v3, v2, v0}, Lzi/a;->b(Ljg/b;Lcom/xiaomi/engine/TaskSession;)V

    :cond_2c
    :goto_19
    iget-object v0, v6, Lyg/t$b;->a:Lyg/t;

    invoke-virtual {v0}, Lyg/t;->w()V
    ...
    invoke-static {v1, v7, v2}, La0/j0;->g(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    invoke-static {v4, v1}, La0/x3;->c(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-virtual {v6, v3, v4, v0}, Lyg/t$b;->a(JLjava/util/ArrayList;)V
    ...
    :goto_1a
    iget-object v0, v1, Lyg/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, v2, Ljg/b;->w:Ljg/b$b;

    invoke-virtual {v1, v0}, Lyg/p;->j(Ljg/b$b;)V
