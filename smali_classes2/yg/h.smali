...
.method public final C(Ljg/h;)V
    ...
    :cond_1
    iget-object v1, p1, Ljg/h;->g:Ljg/d;
    ...
    iget-object v4, v1, Ljg/b$a;->d:Landroid/media/Image;

    iget-object v6, v1, Ljg/b$a;->e:Landroid/media/Image;

    invoke-static {v4}, Lyg/n;->m(Landroid/media/Image;)Z

    move-result v7

    invoke-static {v6}, Lyg/n;->m(Landroid/media/Image;)Z
    ...
    :cond_4
    iget-object v1, v1, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {p0, v1, v4, v2, v7}, Lyg/h;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    iget v4, p1, Ljg/h;->d:I

    invoke-virtual {p0, v1, v6, v5, v4}, Lyg/h;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public final K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-static {v1, v2, v3, v5}, La0/m0;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p2, v0}, La0/k0;->a(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    :cond_2
    new-instance p1, Lyg/h$a;

    invoke-direct {p1, p0}, Lyg/h$a;-><init>(Lyg/h;)V
    ...
    :cond_4
    new-instance p1, Lyg/h$b;

    invoke-direct {p1}, Lyg/h$b;-><init>()V
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;
    ...
    invoke-direct {v2, p0}, Lyg/e;-><init>(Lyg/h;)V
    ...
    invoke-direct {v2, p0}, Lyg/f;-><init>(Lyg/h;)V
    ...
    iget-object v2, p0, Lyg/b;->t:Landroid/os/Handler;
...
.method public final l()Z
    ...
    iget-object v4, p0, Lyg/n;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {v0, p0}, Lyg/t$e;->b(Lyg/n;)Z
