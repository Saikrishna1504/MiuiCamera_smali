...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lyg/p;->f(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
.end annotation
...
# direct methods
.method public constructor <init>(Lyg/p;Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    .locals 0

    iput-object p1, p0, Lyg/p$b;->c:Lyg/p;

    iput-object p2, p0, Lyg/p$b;->a:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-boolean p3, p0, Lyg/p$b;->b:Z
...
.method public final run()V
    ...
    iget-object v1, v0, Lyg/p$b;->a:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v6, Ljg/d;->b:Ljg/d;

    iget-object v7, v0, Lyg/p$b;->c:Lyg/p;

    iget-object v8, v7, Lyg/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    new-instance v13, Landroidx/window/embedding/d;

    const/4 v14, 0x4

    invoke-direct {v13, v5, v14}, Landroidx/window/embedding/d;-><init>(Ljava/lang/Object;I)V

    invoke-interface {v12, v13}, Ljava/util/stream/Stream;->filter(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object v12

    new-instance v13, La0/i1;

    const/16 v14, 0x1c

    invoke-direct {v13, v14}, La0/i1;-><init>(I)V
    ...
    invoke-static {v7, v2, v3}, Lyg/p;->b(Lyg/p;J)J
    ...
    invoke-static {v8, v12, v13}, La0/x;->h(Ljava/lang/String;J)Ljava/lang/String;
    ...
    :cond_2
    iget v11, v8, Ljg/b;->b:I

    iget-boolean v6, v8, Ljg/b;->l:Z

    iget-object v9, v8, Ljg/b;->o:Ljg/d;

    iget-boolean v12, v8, Ljg/b;->m:Z

    iget-wide v13, v8, Ljg/b;->d:J
    ...
    :goto_1
    iget-object v15, v7, Lyg/p;->c:Landroid/util/LongSparseArray;
    ...
    iput-object v5, v8, Ljg/b$a;->p:Ljava/lang/String;
    ...
    iput-object v5, v15, Ljg/b$a;->p:Ljava/lang/String;

    iget v5, v15, Ljg/b$a;->b:I
    ...
    iput v8, v15, Ljg/b$a;->b:I

    :cond_4
    iget-boolean v5, v15, Ljg/b$a;->f:Z

    if-eq v5, v9, :cond_5

    iput-boolean v9, v15, Ljg/b$a;->f:Z

    :cond_5
    iget-object v5, v15, Ljg/b$a;->h:Ljg/d;

    if-eq v5, v6, :cond_6

    iput-object v6, v15, Ljg/b$a;->h:Ljg/d;

    :cond_6
    iget-boolean v5, v15, Ljg/b$a;->i:Z

    if-eq v5, v12, :cond_7

    iput-boolean v12, v15, Ljg/b$a;->i:Z

    :cond_7
    :goto_2
    iput-wide v13, v15, Ljg/b$a;->n:J

    const-string/jumbo v5, "setResult: timestamp = "

    const-string v7, ", firstTimestamp = "

    invoke-static {v5, v2, v3, v7}, La0/m0;->d(Ljava/lang/String;JLjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-boolean v0, v0, Lyg/p$b;->b:Z
    ...
    iget-boolean v2, v15, Ljg/b$a;->m:Z

    if-nez v2, :cond_8

    iput-boolean v11, v15, Ljg/b$a;->m:Z

    :cond_8
    iput-object v1, v15, Ljg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-boolean v0, v15, Ljg/b$a;->a:Z

    iget-boolean v0, v15, Ljg/b$a;->m:Z

    if-eqz v0, :cond_9

    invoke-virtual {v15}, Ljg/b$a;->b()V

    :cond_9
    move-object/from16 v0, v21

    invoke-virtual {v0, v15}, Lyg/p;->d(Ljg/b$a;)V
