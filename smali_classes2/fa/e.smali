...
.method public constructor <init>(Lea/n0;Ljg/a;Lea/q2;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lfa/a;-><init>(Lea/n0;Ljg/a;Lea/q2;)V
...
.method public A(Lfa/a$c;)V
    ...
    iget-boolean v3, v1, Lea/q2$a;->h:Z
    ...
    iget-object v1, p0, Lea/c1;->u:Landroid/util/Size;
    ...
    iget-object v3, p0, Lfa/a;->G:Landroid/util/Size;
    ...
    invoke-virtual {p0, v1}, Lea/c1;->p(Landroid/util/Size;)Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {p0, p1}, Lea/c1;->p(Landroid/util/Size;)Lcom/xiaomi/engine/BufferFormat;
    ...
    :cond_2
    iget-object p1, v1, Lea/q2$a;->f:Ljg/d;
    ...
    iget-object v1, p0, Lfa/a;->G:Landroid/util/Size;
...
.method public C()Z
    ...
    iget-object v6, p0, Lea/q2;->g:Lea/q2$a;

    iget-boolean v6, v6, Lea/q2$a;->h:Z
    ...
    invoke-static {v3, p0, v1}, Lea/d;->D0(IILea/c;)Z
    ...
    iget-boolean p0, p0, Lea/x;->c1:Z

    if-eqz p0, :cond_4

    invoke-static {v3, v7, v1}, Lea/d;->D0(IILea/c;)Z
    ...
    :cond_4
    invoke-static {v3, v8, v1}, Lea/d;->D0(IILea/c;)Z
    ...
    :cond_8
    invoke-static {v3, v4, v1}, Lea/d;->D0(IILea/c;)Z
...
.method public G()Lfa/a$d;
    ...
    invoke-virtual {v2, v7}, Lea/v1;->q(I)Landroid/view/Surface;
    ...
    invoke-virtual {v3, v9, v7}, Lea/v1;->j(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v3, v9, v7}, Lea/v1;->m(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v10}, Lea/v1;->h()Landroid/view/Surface;
    ...
    invoke-virtual {v10}, Lea/v1;->i()Landroid/view/Surface;
    ...
    invoke-virtual {v3}, Lea/x;->c()Z

    move-result v3

    invoke-virtual {v8, v3}, Lea/a;->G(Z)I

    move-result v3

    iput v3, p0, Lfa/a;->D:I
    ...
    invoke-virtual {v8, v3}, Lea/a;->H(Z)I

    move-result v3

    iput v3, p0, Lfa/a;->E:I

    :cond_a
    iget p0, v2, Lea/q2;->d:I
...
.method public final J(Lfa/a$c;)V
    ...
    iget-object v1, p1, Lfa/a$c;->a:Landroid/hardware/camera2/CaptureRequest$Builder;

    iget-object v2, p0, Lfa/a;->C:Lea/q2;

    iget-object v2, v2, Lea/q2;->g:Lea/q2$a;

    iget-boolean v3, v2, Lea/q2$a;->h:Z
    ...
    iget-boolean v5, v5, Lea/q2$a;->i:Z
    ...
    iget-boolean v2, v2, Lea/q2$a;->i:Z
    ...
    :cond_0
    iget-boolean v3, p1, Lfa/a$c;->c:Z
    ...
    invoke-virtual {v2}, Lea/a;->K()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-virtual {v7}, Lea/a;->F()I

    move-result v7

    iget v8, p0, Lfa/a;->K:I
    ...
    :goto_2
    iget-object v9, p0, Lea/x0;->a:Ljava/lang/String;
    ...
    invoke-static {v5, v7}, Landroid/support/v4/media/a;->c(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {v1, v3, v2}, Lea/z;->i(Landroid/hardware/camera2/CaptureRequest$Builder;ILea/x;)V
    ...
    iget-boolean p1, p1, Lfa/a$c;->b:Z
    ...
    invoke-static {v1, p0, v0}, Lea/z;->A0(Landroid/hardware/camera2/CaptureRequest$Builder;Lea/c;Z)V
...
.method public final y(Z)V
    ...
    invoke-super {p0, p1}, Lfa/a;->y(Z)V
...
.method public final z(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-object p2, p0, Lea/q2;->g:Lea/q2$a;

    iget-object p2, p2, Lea/q2$a;->R:Lea/q2$a$a;

    if-eqz p2, :cond_3

    iget v0, p2, Lea/q2$a$a;->a:I
    ...
    iget-boolean p2, p2, Lea/q2$a$a;->b:Z
    ...
    iget-object p0, p0, Lea/q2$a;->R:Lea/q2$a$a;

    iget p0, p0, Lea/q2$a$a;->a:I
