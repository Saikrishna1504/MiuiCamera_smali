...
.method public constructor <init>(Lea/n0;Ljg/a;Lea/q2;)V
    ...
    iput-object p3, p0, Lfa/a;->C:Lea/q2;

    iget p1, p3, Lea/q2;->a:I

    iput p1, p0, Lfa/a;->K:I

    iget p1, p3, Lea/q2;->d:I

    iput p1, p0, Lea/x0;->d:I
...
# virtual methods
.method public abstract A(Lfa/a$c;)V
.end method

.method public final B(Lfa/a$c;)V
    .locals 6
    ...
    :cond_0
    iget-object v1, p0, Lea/c1;->B:Lcom/xiaomi/engine/BufferFormat;

    if-nez v1, :cond_1

    new-instance v1, Lcom/xiaomi/engine/BufferFormat;

    iget-object v3, p0, Lea/c1;->v:Landroid/util/Size;
    ...
    invoke-virtual {p0, p1, v1, v0}, Lea/c1;->r(Landroid/hardware/camera2/CaptureRequest;Lcom/xiaomi/engine/BufferFormat;I)Lcom/xiaomi/engine/PreProcessData;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p0, p1}, Lea/c1;->w(Lcom/xiaomi/engine/PreProcessData;)V
    ...
    invoke-virtual {p0, p1}, Lo7/j;->o(Ljava/lang/String;)V
...
.method public final D()Lfa/a$c;
    ...
    invoke-virtual {p0}, Lfa/a;->G()Lfa/a$d;
    ...
    iget-object v3, v1, Lfa/a$d;->a:Ljava/util/ArrayList;
    ...
    iget-object v2, v1, Lfa/a$d;->a:Ljava/util/ArrayList;
    ...
    :cond_0
    new-instance p0, Lfa/a$c;

    invoke-direct {p0}, Lfa/a$c;-><init>()V

    iput-object v0, p0, Lfa/a$c;->a:Landroid/hardware/camera2/CaptureRequest$Builder;

    iget-boolean v0, v1, Lfa/a$d;->c:Z

    iput-boolean v0, p0, Lfa/a$c;->c:Z

    iget-boolean v0, v1, Lfa/a$d;->b:Z

    iput-boolean v0, p0, Lfa/a$c;->b:Z

    return-object p0
.end method

.method public final E(Lfa/a$c;)V
    .locals 2
    ...
    invoke-virtual {v1}, Lea/x;->a()Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lea/x0;->l:Ljava/lang/String;

    invoke-virtual {v0}, Lea/a;->s()Lea/c;

    move-result-object v1

    invoke-static {v1}, Lea/d;->J2(Lea/c;)Z
    ...
    invoke-static {p1, v0, p0}, Lea/z;->q0(Landroid/hardware/camera2/CaptureRequest$Builder;Lea/c;Ljava/lang/String;)V

    :cond_0
    return-void
.end method

.method public abstract F()Lfa/a$b;
.end method

.method public abstract G()Lfa/a$d;
.end method

.method public abstract H()Z
.end method

.method public I(Lyg/q;)V
    .locals 1
...
.method public abstract J(Lfa/a$c;)V
.end method
...
.method public final h()Z
    ...
    iget v1, v0, Lea/q2;->f:I

    const/4 v2, 0x1

    if-ne v1, v2, :cond_0

    iget-boolean p0, p0, Lea/c1;->z:Z
...
.method public final k()V
    ...
    iput-boolean v0, p0, Lea/x0;->p:Z

    iget v0, p0, Lfa/a;->K:I
    ...
    invoke-static {v1}, Lea/d;->Y(Lea/c;)I
...
.method public final m()V
    ...
    iget-object v3, p0, Lfa/a;->C:Lea/q2;

    iget v4, v3, Lea/q2;->f:I
    ...
    invoke-virtual {p0}, Lfa/a;->F()Lfa/a$b;

    move-result-object v7

    invoke-direct {v4, p0, v7}, Lfa/a$a;-><init>(Lfa/a;Lfa/a$b;)V

    invoke-virtual {p0}, Lfa/a;->D()Lfa/a$c;

    move-result-object v7

    invoke-virtual {p0, v7}, Lfa/a;->A(Lfa/a$c;)V

    iget-object v8, v7, Lfa/a$c;->a:Landroid/hardware/camera2/CaptureRequest$Builder;

    const/4 v9, 0x3

    invoke-virtual {v0, v8, v9}, Lea/a;->c(Landroid/hardware/camera2/CaptureRequest$Builder;I)V

    invoke-virtual {p0, v7}, Lfa/a;->J(Lfa/a$c;)V

    invoke-virtual {p0, v7}, Lfa/a;->E(Lfa/a$c;)V

    iget v8, v3, Lea/q2;->f:I
    :try_end_0
    ...
    iget v10, v0, Lea/a;->a:I

    const-string v11, "_"

    iget-object v12, p0, Lea/x0;->c:Landroid/os/Handler;
    ...
    iget-object v2, v3, Lea/q2;->g:Lea/q2$a;
    ...
    :goto_0
    iget-object v5, v3, Lea/q2;->g:Lea/q2$a;

    iget v5, v5, Lea/q2$a;->c:I

    if-ge v2, v5, :cond_1

    iget-object v5, v7, Lfa/a$c;->a:Landroid/hardware/camera2/CaptureRequest$Builder;

    invoke-virtual {p0, v5, v2}, Lfa/a;->z(Landroid/hardware/camera2/CaptureRequest$Builder;I)V

    sget-object v8, Landroid/hardware/camera2/CaptureRequest;->CONTROL_ENABLE_ZSL:Landroid/hardware/camera2/CaptureRequest$Key;

    iget-boolean v13, v3, Lea/q2;->c:Z
    ...
    invoke-static {v5, v3}, Lq2/a;->a(Ljava/lang/String;Landroid/hardware/camera2/CaptureRequest;)V

    goto :goto_1

    :cond_2
    invoke-virtual {p0, v7}, Lfa/a;->B(Lfa/a$c;)V

    invoke-virtual {v0}, Lea/a;->t()Landroid/hardware/camera2/CameraCaptureSession;
    ...
    iput-object v1, p0, Lea/c1;->y:Ljava/lang/String;
    ...
    iget-object v2, v7, Lfa/a$c;->a:Landroid/hardware/camera2/CaptureRequest$Builder;

    invoke-virtual {p0, v2, v6}, Lfa/a;->z(Landroid/hardware/camera2/CaptureRequest$Builder;I)V

    sget-object v5, Landroid/hardware/camera2/CaptureRequest;->CONTROL_ENABLE_ZSL:Landroid/hardware/camera2/CaptureRequest$Key;

    iget-boolean v3, v3, Lea/q2;->c:Z
    ...
    invoke-static {v1, v2}, Lq2/a;->a(Ljava/lang/String;Landroid/hardware/camera2/CaptureRequest;)V
    ...
    :goto_2
    invoke-virtual {p0, v9}, Lfa/a;->y(Z)V
    :try_end_1
    ...
    :catch_1
    invoke-virtual {p0, v6}, Lfa/a;->y(Z)V

    const/16 p0, 0x100

    invoke-virtual {v0, p0}, Lea/a;->q0(I)V
...
.method public y(Z)V
    ...
    invoke-static {p1, p0}, La0/u5;->a(II)V
