...
.method public final A(Lfa/a$c;)V
    ...
    invoke-super {p0, p1}, Lfa/d;->A(Lfa/a$c;)V

    iget-object v0, p0, Lfa/a;->C:Lea/q2;

    iget-object v0, v0, Lea/q2;->g:Lea/q2$a;

    iget-boolean v0, v0, Lea/q2$a;->h:Z
    ...
    :cond_0
    iget-boolean p1, p1, Lfa/a$c;->c:Z
    ...
    iget-object v0, p0, Lfa/a;->G:Landroid/util/Size;
    ...
    iget-object p1, p0, Lfa/a;->G:Landroid/util/Size;

    iget v0, p0, Lfa/a;->H:I

    const v2, 0xef06

    invoke-virtual {p0, v2, p1, v1, v0}, Lea/c1;->o(ILandroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;

    move-result-object p1

    iput-object p1, p0, Lea/c1;->B:Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {p0, p1, v1, v0}, Lea/c1;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
...
.method public final G()Lfa/a$d;
    ...
    invoke-virtual {v7}, Lea/a;->U()Lea/v1;
    ...
    iget-object p0, p0, Lfa/a;->G:Landroid/util/Size;
    ...
    iget-boolean v8, v1, Lfa/a$d;->b:Z
    ...
    iget-boolean v10, v3, Lea/q2$a;->e:Z
    ...
    iget v6, p0, Lea/x0;->t:I

    invoke-virtual {v3, v6, v9}, Lea/v1;->j(IZ)Landroid/view/Surface;

    move-result-object v3

    invoke-virtual {v7}, Lea/a;->y()Landroid/util/Size;

    move-result-object v6

    iput-object v6, p0, Lfa/a;->G:Landroid/util/Size;
    ...
    invoke-static {v10}, Lea/v1;->k(I)I

    move-result v6

    iput v6, p0, Lfa/a;->F:I
    ...
    invoke-virtual {v3, v12, v9}, Lea/v1;->v(IZ)Landroid/view/Surface;
    ...
    invoke-static {v6, v13}, Landroid/support/v4/media/a;->c(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-virtual {v3, v12, v9}, Lea/v1;->m(IZ)Landroid/view/Surface;
    ...
    invoke-static {v13}, Lea/v1;->n(I)I

    move-result v12

    iput v12, p0, Lfa/a;->F:I
    ...
    iput-object v12, p0, Lfa/a;->G:Landroid/util/Size;

    if-eqz v6, :cond_a

    new-instance v6, Landroid/util/Size;

    iget-object v12, p0, Lfa/a;->G:Landroid/util/Size;
    ...
    iget-object v10, p0, Lfa/a;->G:Landroid/util/Size;
    ...
    :cond_a
    :goto_4
    invoke-virtual {v7}, Lea/a;->Q()I

    move-result v6

    iput v6, p0, Lfa/a;->D:I
    ...
    invoke-virtual {v3, v11}, Lea/v1;->q(I)Landroid/view/Surface;
    ...
    :cond_e
    iget-object v6, v2, Lea/q2;->g:Lea/q2$a;

    iget-boolean v6, v6, Lea/q2$a;->n:Z
...
.method public final J(Lfa/a$c;)V
    ...
    iget-boolean v0, v0, Lea/q2$a;->n:Z
...
.method public final K()V
    ...
    invoke-super {p0}, Lfa/d;->K()V

    const/4 v0, 0x0

    iput-boolean v0, p0, Lfa/g;->L:Z
...
.method public final z(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-object v1, v0, Lea/q2$a;->q:[I
    ...
    instance-of v4, v4, Lᅡᅭᅯᄬᅯᅫᄬᅦᅧᅴᅫᅡᅧᄬᅏᅭᅬᅦᅰᅫᅣᅬ;
    ...
    :cond_3
    iget-object v4, p0, Lfa/a;->C:Lea/q2;

    iget-object v4, v4, Lea/q2;->g:Lea/q2$a;

    iget v4, v4, Lea/q2$a;->c:I
    ...
    iget v4, v4, Lea/q2$a;->r:I

    invoke-static {v4}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v4

    iget-object v5, p0, Lfa/a;->C:Lea/q2;

    iget-object v5, v5, Lea/q2;->g:Lea/q2$a;

    iget v5, v5, Lea/q2$a;->s:I
    ...
    invoke-static {v4}, Lea/d;->f3(Lea/c;)Z
    ...
    iget-object v4, v4, Lea/q2$a;->A:[B
    ...
    invoke-virtual {v4}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->q6()Z
    ...
    iget-object v4, v4, Lea/q2$a;->u:[I
    ...
    invoke-virtual {v5}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->X5()Z
    ...
    invoke-virtual {v5}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->a6()Z
    ...
    invoke-static {v7}, Lea/d;->i(Lea/c;)I
    ...
    invoke-virtual {v7}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->i2()Z
    ...
    iget-boolean v8, v8, Lea/a;->m:Z

    if-eqz v8, :cond_10

    iget-object v8, v0, Luc/b;->e:L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;

    invoke-virtual {v8}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->s7()Z
    ...
    :cond_10
    iget-object v8, p0, Lfa/a;->C:Lea/q2;

    iget-object v8, v8, Lea/q2;->g:Lea/q2$a;

    iget-boolean v8, v8, Lea/q2$a;->B:Z
    ...
    iget-object v7, p0, Lfa/a;->C:Lea/q2;

    iget-object v7, v7, Lea/q2;->g:Lea/q2$a;

    iget v7, v7, Lea/q2$a;->c:I
    ...
    :cond_12
    iget-object v6, p0, Lfa/a;->C:Lea/q2;

    iget-object v6, v6, Lea/q2;->g:Lea/q2$a;

    iget-boolean v6, v6, Lea/q2$a;->x:Z
    ...
    iget-boolean v4, v4, Lea/q2$a;->n:Z
    ...
    invoke-static {v1}, Lea/d;->l2(Lea/c;)Z

    move-result v1

    if-eqz v1, :cond_17

    iget-object v1, p0, Lfa/a;->C:Lea/q2;

    iget-object v1, v1, Lea/q2;->g:Lea/q2$a;

    iget-boolean v1, v1, Lea/q2$a;->n:Z
    ...
    invoke-static {v3}, Lea/d;->N0(Lea/c;)Z
    ...
    iget-object v4, v4, Lea/v1;->g:Landroid/media/ImageReader;
    ...
    :cond_1a
    invoke-static {v3}, Lea/d;->L0(Lea/c;)Z
    ...
    iget-object v5, v4, Lea/q2;->g:Lea/q2$a;

    iget-object v5, v5, Lea/q2$a;->q:[I
    ...
    :cond_1c
    invoke-static {v3}, Lea/d;->M0(Lea/c;)Z

    move-result v3

    if-eqz v3, :cond_1f

    iget-object v3, v4, Lea/q2;->g:Lea/q2$a;
    ...
    iget-object v1, v1, Lea/v1;->n:Landroid/view/Surface;
