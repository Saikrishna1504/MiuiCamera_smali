...
.method public A(Lfa/a$c;)V
    ...
    iget-boolean v1, v1, Lea/q2$a;->h:Z
    ...
    iget-object v0, p0, Lea/c1;->u:Landroid/util/Size;
    ...
    invoke-virtual {p0, v0}, Lea/c1;->p(Landroid/util/Size;)Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {p1, v4}, Lea/v1;->q(I)Landroid/view/Surface;
    ...
    iget-object p1, v0, Lea/q2;->g:Lea/q2$a;

    iget-boolean p1, p1, Lea/q2$a;->o:Z
    ...
    invoke-virtual {p0, v1, p1, v4, v0}, Lea/c1;->o(ILandroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {p0, p1, v4, v0}, Lea/c1;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
...
.method public G()Lfa/a$d;
    ...
    invoke-virtual {p0}, Lfa/d;->L()Lfa/a$d;
    ...
    iget-boolean v2, v2, Lea/q2$a;->h:Z

    if-nez v2, :cond_0

    iget v1, v1, Lea/q2;->d:I
    ...
    iget-object p0, v0, Lfa/a$d;->a:Ljava/util/ArrayList;
...
.method public final I(Lyg/q;)V
    ...
    iput-boolean p0, p1, Lyg/q;->d0:Z

    return-void
.end method

.method public J(Lfa/a$c;)V
    .locals 5
    ...
    invoke-static {v1, p1, v0}, Lea/z;->A0(Landroid/hardware/camera2/CaptureRequest$Builder;Lea/c;Z)V

    invoke-virtual {p0}, Lea/a;->s()Lea/c;

    move-result-object p1

    invoke-static {v1, p1, v0}, Lea/z;->t0(Landroid/hardware/camera2/CaptureRequest$Builder;Lea/c;Z)V

    :cond_2
    iget-object p1, v2, Lea/q2;->g:Lea/q2$a;

    iget-boolean v3, p1, Lea/q2$a;->e:Z
    ...
    :cond_3
    invoke-virtual {p0}, Lea/a;->O()Lea/c;
    ...
    iget-boolean p1, p1, Lea/q2$a;->e:Z
    ...
    invoke-static {v1, p1, p0}, Lea/z;->i(Landroid/hardware/camera2/CaptureRequest$Builder;ILea/x;)V
...
.method public final L()Lfa/a$d;
    ...
    invoke-virtual {v3, v9, v6}, Lea/v1;->j(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v3, v9, v6}, Lea/v1;->m(IZ)Landroid/view/Surface;
    ...
    invoke-static {v10}, Lea/v1;->n(I)I
    ...
    iput-object v0, p0, Lea/c1;->v:Landroid/util/Size;
