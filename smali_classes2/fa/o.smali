...
.method public final A(Lfa/a$c;)V
    ...
    invoke-virtual {p0, p1, v0, v1}, Lea/c1;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
...
.method public final G()Lfa/a$d;
    ...
    iget v4, p0, Lea/x0;->t:I

    invoke-virtual {v3, v4}, Lea/v1;->r(I)Landroid/view/Surface;
    ...
    iput-object v4, p0, Lfa/a;->G:Landroid/util/Size;
    ...
    invoke-virtual {v4, v8, v9}, Lea/v1;->m(IZ)Landroid/view/Surface;
    ...
    iget-object v11, p0, Lfa/a;->G:Landroid/util/Size;
    ...
    iput-object v8, p0, Lfa/a;->G:Landroid/util/Size;

    const-string v8, "[SAT]override output size to "

    invoke-static {v8, v4}, La0/a0;->d(Ljava/lang/String;Landroid/util/Size;)Ljava/lang/String;
    ...
    invoke-static {v8}, Lea/v1;->s(I)I

    move-result v4

    iput v4, p0, Lfa/a;->F:I
    ...
    invoke-virtual {v3, v8, v9}, Lea/v1;->j(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v3, v8, v9}, Lea/v1;->m(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v11}, Lea/v1;->t()Landroid/view/Surface;
    ...
    invoke-virtual {v11}, Lea/v1;->p()Landroid/view/Surface;
    ...
    invoke-virtual {v11}, Lea/v1;->w()Landroid/view/Surface;
    ...
    iget-boolean p0, p0, Lh1/w1;->n:Z

    if-nez p0, :cond_10

    :cond_f
    iget-object p0, v2, Lea/q2;->g:Lea/q2$a;
...
.method public final H()Z
    ...
    iget-boolean v0, v0, Lea/q2$a;->D:Z
...
.method public final J(Lfa/a$c;)V
    ...
    iget-object v0, p1, Lfa/a$c;->a:Landroid/hardware/camera2/CaptureRequest$Builder;

    iget-boolean v1, p1, Lfa/a$c;->c:Z

    if-eqz v1, :cond_4

    iget-object v1, p0, Lfa/a;->C:Lea/q2;

    iget v1, v1, Lea/q2;->e:I
    ...
    invoke-static {v0, p1, v3}, Lea/z;->A0(Landroid/hardware/camera2/CaptureRequest$Builder;Lea/c;Z)V

    invoke-virtual {p0}, Lea/a;->s()Lea/c;

    move-result-object p1

    invoke-static {v0, p1, v3}, Lea/z;->t0(Landroid/hardware/camera2/CaptureRequest$Builder;Lea/c;Z)V
    ...
    invoke-static {v0, p1, p0}, Lea/z;->i(Landroid/hardware/camera2/CaptureRequest$Builder;ILea/x;)V
...
.method public final z(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-object v4, v0, Lea/q2;->g:Lea/q2$a;

    iget-object v4, v4, Lea/q2$a;->J:Lsa/t;

    iget-object v4, v4, Lsa/t;->b:[I
    ...
    iget v3, v0, Lea/q2;->e:I

    const/16 v4, 0x10

    if-ne v4, v3, :cond_3

    sget-object v3, Lra/x;->U0:Lra/w;

    sget v4, Lra/b0;->a:I

    :try_start_0
    invoke-virtual {v3}, Lra/a0;->b()Ljava/lang/Object;
    ...
    invoke-static {v4, v3, v7}, Lra/b0;->f(Ljava/lang/Exception;Ljava/lang/Object;I)V
