...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Le6/ee;->O:[F

    new-array v0, v0, [F

    fill-array-data v0, :array_1

    sput-object v0, Le6/ee;->P:[F
...
.method public constructor <init>(Lcom/xiaomi/inceptionmediaprocess/OpenGlRender;)V
    ...
    iput v0, p0, Le6/ee;->a:I

    iput v0, p0, Le6/ee;->b:I

    iput v0, p0, Le6/ee;->c:I

    iput v0, p0, Le6/ee;->d:I

    const/4 v1, 0x0

    iput-object v1, p0, Le6/ee;->k:Ljava/nio/ByteBuffer;

    iput-object v1, p0, Le6/ee;->l:Ljava/nio/ByteBuffer;

    const/16 v2, 0x10

    new-array v2, v2, [F

    iput-object v2, p0, Le6/ee;->o:[F

    iput-boolean v0, p0, Le6/ee;->r:Z

    const/4 v2, 0x1

    iput-boolean v2, p0, Le6/ee;->s:Z

    iput-object v1, p0, Le6/ee;->B:Ljava/nio/ByteBuffer;

    iput-boolean v0, p0, Le6/ee;->C:Z

    const/16 v1, 0x200

    iput v1, p0, Le6/ee;->D:I

    new-array v1, v2, [I

    iput-object v1, p0, Le6/ee;->E:[I

    iput v0, p0, Le6/ee;->H:I

    iput-boolean v0, p0, Le6/ee;->K:Z

    new-array v0, v2, [I

    iput-object v0, p0, Le6/ee;->L:[I

    new-array v0, v2, [I

    iput-object v0, p0, Le6/ee;->M:[I

    new-instance v0, Le6/ee$a;

    invoke-direct {v0, p0}, Le6/ee$a;-><init>(Le6/ee;)V

    iput-object v0, p0, Le6/ee;->N:Landroid/graphics/SurfaceTexture$OnFrameAvailableListener;

    iput-object p1, p0, Le6/ee;->m:Lcom/xiaomi/inceptionmediaprocess/OpenGlRender;

    return-void
.end method

.method public static synthetic h(Le6/ee;)Landroid/opengl/GLSurfaceView;
    .locals 0

    iget-object p0, p0, Le6/ee;->j:Landroid/opengl/GLSurfaceView;
...
.method public b(IIIII)V
    ...
    iget-object v8, p0, Le6/ee;->B:Ljava/nio/ByteBuffer;

    invoke-static/range {v0 .. v8}, Landroid/opengl/GLES20;->glTexImage2D(IIIIIIIILjava/nio/Buffer;)V

    iget p1, p0, Le6/ee;->G:I

    iget-object p4, p0, Le6/ee;->B:Ljava/nio/ByteBuffer;
    ...
    iget p4, p0, Le6/ee;->H:I

    invoke-static {p1, p4}, Landroid/opengl/GLES20;->glUniform1i(II)V

    invoke-static {}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit()V

    iget p1, p0, Le6/ee;->u:I

    iget-boolean p4, p0, Le6/ee;->K:Z
    ...
    iget-boolean p1, p0, Le6/ee;->s:Z

    iget-boolean p4, p0, Le6/ee;->r:Z

    if-eq p1, p4, :cond_2

    iput-boolean p4, p0, Le6/ee;->s:Z

    :cond_2
    iget p1, p0, Le6/ee;->t:I

    invoke-static {p1, p4}, Landroid/opengl/GLES20;->glUniform1i(II)V

    invoke-static {}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit()V

    iget-boolean p1, p0, Le6/ee;->r:Z

    if-eqz p1, :cond_3

    iget-object p1, p0, Le6/ee;->o:[F

    invoke-static {p1, p2}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    iget-object v0, p0, Le6/ee;->o:[F
    ...
    iget p1, p0, Le6/ee;->x:I

    iget-object p4, p0, Le6/ee;->o:[F
    ...
    iget-object v5, p0, Le6/ee;->k:Ljava/nio/ByteBuffer;
    ...
    iget-object v5, p0, Le6/ee;->l:Ljava/nio/ByteBuffer;
...
.method public d()V
    ...
    iput-object v1, v0, Le6/ee;->k:Ljava/nio/ByteBuffer;
    ...
    iget-object v1, v0, Le6/ee;->k:Ljava/nio/ByteBuffer;

    invoke-virtual {v1}, Ljava/nio/ByteBuffer;->asFloatBuffer()Ljava/nio/FloatBuffer;

    move-result-object v1

    sget-object v2, Le6/ee;->O:[F
    ...
    iput-object v1, v0, Le6/ee;->l:Ljava/nio/ByteBuffer;
    ...
    iget-object v1, v0, Le6/ee;->l:Ljava/nio/ByteBuffer;

    invoke-virtual {v1}, Ljava/nio/ByteBuffer;->asFloatBuffer()Ljava/nio/FloatBuffer;

    move-result-object v1

    sget-object v3, Le6/ee;->P:[F
    ...
    invoke-virtual {v0, v3, v1}, Le6/ee;->j(Ljava/lang/String;Ljava/lang/String;)I

    move-result v1

    iput v1, v0, Le6/ee;->e:I
    ...
    iput v1, v0, Le6/ee;->v:I

    iget-object v1, v0, Le6/ee;->L:[I
    ...
    invoke-virtual {v0, v3, v10}, Le6/ee;->j(Ljava/lang/String;Ljava/lang/String;)I

    move-result v10

    iput v10, v0, Le6/ee;->f:I

    invoke-static {v10, v4}, Landroid/opengl/GLES20;->glGetAttribLocation(ILjava/lang/String;)I

    move-result v4

    iput v4, v0, Le6/ee;->c:I
    ...
    iget-object v5, v0, Le6/ee;->I:[I

    aget v5, v5, v2

    iput v5, v0, Le6/ee;->y:I
    ...
    iget-object v5, v0, Le6/ee;->J:[I

    aget v5, v5, v2

    iput v5, v0, Le6/ee;->z:I
    ...
    invoke-virtual {v0, v3, v4}, Le6/ee;->j(Ljava/lang/String;Ljava/lang/String;)I

    move-result v3

    iput v3, v0, Le6/ee;->h:I

    invoke-static {v3}, Landroid/opengl/GLES20;->glUseProgram(I)V

    iget v3, v0, Le6/ee;->h:I
    ...
    iget-object v12, v0, Le6/ee;->B:Ljava/nio/ByteBuffer;

    invoke-static/range {v4 .. v12}, Landroid/opengl/GLES20;->glTexImage2D(IIIIIIIILjava/nio/Buffer;)V

    iget v1, v0, Le6/ee;->G:I

    iget-object v4, v0, Le6/ee;->B:Ljava/nio/ByteBuffer;
...
.method public final g()V
    ...
    iget v0, p0, Le6/ee;->y:I

    invoke-static {v0}, Lcom/xiaomi/gl/MIGL;->glBindFramebuffer(I)V

    iget v0, p0, Le6/ee;->e:I
    ...
    iget v1, p0, Le6/ee;->p:I

    invoke-static {v0, v1}, Landroid/opengl/GLES20;->glBindTexture(II)V

    invoke-static {}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit()V

    iget v0, p0, Le6/ee;->q:I

    invoke-static {v0, v2}, Landroid/opengl/GLES20;->glUniform1i(II)V

    invoke-static {}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit()V

    iget v0, p0, Le6/ee;->v:I

    iget-boolean v1, p0, Le6/ee;->r:Z
    ...
    iget-boolean v0, p0, Le6/ee;->r:Z

    if-eqz v0, :cond_0

    iget-object v3, p0, Le6/ee;->o:[F
    ...
    iget v0, p0, Le6/ee;->a:I

    invoke-static {v0}, Landroid/opengl/GLES20;->glEnableVertexAttribArray(I)V

    invoke-static {}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit()V

    iget v3, p0, Le6/ee;->a:I
    ...
    iget-object v8, p0, Le6/ee;->k:Ljava/nio/ByteBuffer;

    invoke-static/range {v3 .. v8}, Landroid/opengl/GLES20;->glVertexAttribPointer(IIIZILjava/nio/Buffer;)V

    invoke-static {}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit()V

    iget v0, p0, Le6/ee;->b:I

    invoke-static {v0}, Landroid/opengl/GLES20;->glEnableVertexAttribArray(I)V

    invoke-static {}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit()V

    iget v3, p0, Le6/ee;->b:I

    iget-object v8, p0, Le6/ee;->l:Ljava/nio/ByteBuffer;
...
.method public i(Landroid/graphics/Rect;II)V
    ...
    invoke-virtual {p0}, Le6/ee;->g()V

    iget-object p0, p0, Le6/ee;->M:[I
...
.method public j(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v0, p1}, Le6/ee;->m(ILjava/lang/String;)I

    move-result v0

    const v1, 0x8b30

    invoke-virtual {p0, v1, p2}, Le6/ee;->m(ILjava/lang/String;)I
...
.method public l(Landroid/graphics/SurfaceTexture;)V
    ...
    invoke-virtual {p0}, Le6/ee;->d()V

    iget-object v1, p0, Le6/ee;->k:Ljava/nio/ByteBuffer;
    ...
    iget-object v1, p0, Le6/ee;->l:Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Le6/ee;->m:Lcom/xiaomi/inceptionmediaprocess/OpenGlRender;

    iget v3, p0, Le6/ee;->f:I

    iget v4, p0, Le6/ee;->z:I

    iget v5, p0, Le6/ee;->A:I

    iget v6, p0, Le6/ee;->c:I

    iget v7, p0, Le6/ee;->d:I

    invoke-virtual/range {v2 .. v9}, Lcom/xiaomi/inceptionmediaprocess/OpenGlRender;->SetOpengGlRenderParams(IIIII[B[B)V

    iget-object v0, p0, Le6/ee;->m:Lcom/xiaomi/inceptionmediaprocess/OpenGlRender;

    iget v1, p0, Le6/ee;->z:I

    invoke-virtual {v0, v1}, Lcom/xiaomi/inceptionmediaprocess/OpenGlRender;->SetCurrentGLContext(I)V

    iput-object p1, p0, Le6/ee;->n:Landroid/graphics/SurfaceTexture;

    iget p0, p0, Le6/ee;->p:I
...
.method public n()V
    ...
    iget-object v0, p0, Le6/ee;->L:[I

    const-string v1, "MiFilmDreamGLSurfaceViewRender"

    invoke-static {v0, v1}, Lcom/xiaomi/gl/MIGL;->glDeleteTextures([ILjava/lang/String;)V

    iget-object v0, p0, Le6/ee;->E:[I

    invoke-static {v0, v1}, Lcom/xiaomi/gl/MIGL;->glDeleteTextures([ILjava/lang/String;)V

    iget-object v0, p0, Le6/ee;->J:[I

    invoke-static {v0, v1}, Lcom/xiaomi/gl/MIGL;->glDeleteTextures([ILjava/lang/String;)V

    iget-object v0, p0, Le6/ee;->I:[I
    ...
    iget-object v2, p0, Le6/ee;->L:[I

    const/4 v3, 0x0

    aput-object v2, v0, v3

    iget-object v2, p0, Le6/ee;->E:[I

    const/4 v4, 0x1

    aput-object v2, v0, v4

    iget-object v2, p0, Le6/ee;->J:[I

    const/4 v5, 0x2

    aput-object v2, v0, v5

    iget-object v2, p0, Le6/ee;->I:[I
    ...
    iput v3, p0, Le6/ee;->e:I

    iput v3, p0, Le6/ee;->f:I

    iput v3, p0, Le6/ee;->h:I
...
.method public o(I)V
    ...
    iget-object v0, p0, Le6/ee;->n:Landroid/graphics/SurfaceTexture;

    invoke-virtual {v0}, Landroid/graphics/SurfaceTexture;->updateTexImage()V

    iget-object v0, p0, Le6/ee;->n:Landroid/graphics/SurfaceTexture;

    iget-object v1, p0, Le6/ee;->o:[F
