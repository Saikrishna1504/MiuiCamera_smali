...
.method public static synthetic r(Lr7/g;Lcom/android/camera/o5;)V
    .locals 0

    invoke-direct {p0, p1}, Lr7/g;->v(Lcom/android/camera/o5;)V

    return-void
.end method

.method public static synthetic s(Lr7/g;Landroid/net/Uri;Lcom/android/camera/o5;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lr7/g;->u(Landroid/net/Uri;Lcom/android/camera/o5;)V

    return-void
.end method

.method private synthetic u(Landroid/net/Uri;Lcom/android/camera/o5;)V
    .locals 3
    ...
    :cond_0
    invoke-virtual {p2, p1}, Lcom/android/camera/o5;->V(Landroid/net/Uri;)V
...
.method private synthetic v(Lcom/android/camera/o5;)V
    .locals 3
    ...
    invoke-virtual {p1, p0}, Lcom/android/camera/o5;->V(Landroid/net/Uri;)V
...
.method public y()V
    ...
    iget-object v12, v0, Lr7/a;->i:Lud/z;
    ...
    invoke-static/range {v7 .. v16}, Lcom/android/camera/o3;->A(Lud/g;[BJLjava/lang/String;Lud/z;IIILandroid/location/Location;)[B
    ...
    invoke-static {v2, v4, v1, v8, v5}, Lcom/android/camera/o5;->e([BIILandroid/net/Uri;Z)Lcom/android/camera/o5;
    ...
    invoke-virtual {v1, v4, v5}, Lcom/android/camera/o5;->M(J)V

    iget-object v2, v0, Lr7/b;->b:Lr7/q;

    const/4 v4, 0x1

    invoke-interface {v2, v1, v4}, Lr7/q;->c(Lcom/android/camera/o5;Z)V
    ...
    :cond_8
    invoke-virtual {v1}, Lcom/android/camera/o5;->m()Landroid/graphics/Bitmap;
    ...
    iget-object v3, v0, Lr7/a;->d:Lud/w;

    if-eqz v3, :cond_e

    invoke-virtual {v3}, Lud/w;->l()J
    ...
    invoke-static {v1, v2}, Lq7/a;->W3(J)V
