...
.method public x()V
    ...
    invoke-static {v1}, Lfe/a;->e(Ljava/lang/String;)V
    ...
    invoke-static {v5, v6, v1, v2, v3}, Lcom/android/camera/o5;->e([BIILandroid/net/Uri;Z)Lcom/android/camera/o5;

    move-result-object v2

    if-eqz v2, :cond_5

    invoke-virtual {v2}, Lcom/android/camera/o5;->W()V

    iget-object v1, p0, Lr7/a;->d:Lud/w;

    invoke-virtual {v1}, Lud/w;->G()Z

    move-result v1

    invoke-virtual {v2, v1}, Lcom/android/camera/o5;->S(Z)V

    iget-object v1, p0, Lr7/b;->b:Lr7/q;

    invoke-interface {v1, v2, v4}, Lr7/q;->c(Lcom/android/camera/o5;Z)V
    ...
    invoke-direct {v1, p0, v2}, Lr7/n$b;-><init>(Lr7/n;Lcom/android/camera/o5;)V
