...
.method public final f(Ljava/lang/Object;IIZZ)V
    ...
    invoke-interface {v1, v2, v3}, La7/x2;->Q9(ZI)I
    ...
    invoke-static/range {v16 .. v16}, Lcom/android/camera/e3;->h3(I)Z
    ...
    invoke-static {v0, v5, v7}, Lcom/android/camera/o3;->F([BLac/d;[B)[B
    ...
    invoke-direct/range {v27 .. v34}, Lud/w;-><init>(IJILjava/lang/String;J)V
    ...
    :goto_9
    invoke-virtual {v4, v6}, Lud/w;->d1(Z)V

    const/4 v2, 0x0

    invoke-virtual {v4, v0, v2}, Lud/w;->a([BI)V

    invoke-virtual {v4, v11}, Lud/w;->e1(Z)V

    move/from16 v0, v25

    invoke-virtual {v4, v0}, Lud/w;->v1(Z)V

    move/from16 v0, v20

    invoke-virtual {v4, v0}, Lud/w;->a1(Z)V
    ...
    invoke-direct {v0, v2, v5, v6, v3}, Lud/x$b;-><init>(Landroid/util/Size;Landroid/util/Size;Landroid/util/Size;I)V

    invoke-interface {v15}, Lx5/m;->getCapabilities()Lcom/android/camera2/f;

    move-result-object v2

    invoke-static {v2}, Lcom/android/camera2/g;->H8(Lcom/android/camera2/f;)Z
    ...
    invoke-static {v2}, Lcom/android/camera2/g;->S2(Lcom/android/camera2/f;)Z
    ...
    :goto_a
    invoke-virtual {v0, v6}, Lud/x$b;->P(Z)Lud/x$b;

    invoke-virtual {v0, v1}, Lud/x$b;->C(I)Lud/x$b;
    ...
    invoke-virtual {v0, v1}, Lud/x$b;->M(F)Lud/x$b;
    ...
    invoke-virtual {v0, v1}, Lud/x$b;->L(I)Lud/x$b;
    ...
    invoke-virtual {v0, v1}, Lud/x$b;->w(Landroid/location/Location;)Lud/x$b;

    move-result-object v0

    move/from16 v1, v24

    invoke-virtual {v0, v1}, Lud/x$b;->h(I)Lud/x$b;

    move-result-object v0

    move/from16 v1, v18

    invoke-virtual {v0, v1}, Lud/x$b;->T(I)Lud/x$b;

    move-result-object v0

    move/from16 v2, v19

    invoke-virtual {v0, v2}, Lud/x$b;->V(I)Lud/x$b;
    ...
    invoke-virtual {v0, v1}, Lud/x$b;->S(I)Lud/x$b;
    ...
    invoke-virtual {v0, v1}, Lud/x$b;->F(I)Lud/x$b;

    move-result-object v0

    invoke-virtual {v0, v12}, Lud/x$b;->n(I)Lud/x$b;

    move-result-object v0

    move/from16 v1, v17

    invoke-virtual {v0, v1}, Lud/x$b;->B(Z)Lud/x$b;

    move-result-object v0

    invoke-virtual {v0, v10}, Lud/x$b;->c(Z)Lud/x$b;

    move-result-object v0

    const/4 v1, 0x1

    invoke-virtual {v14, v1}, Lcom/android/camera/module/Camera2Module;->getPictureInfo(Z)Lud/z;

    move-result-object v2

    invoke-virtual {v0, v2}, Lud/x$b;->E(Lud/z;)Lud/x$b;

    move-result-object v0

    move/from16 v12, v26

    invoke-virtual {v0, v12}, Lud/x$b;->z(Z)Lud/x$b;
    ...
    invoke-virtual {v0, v2}, Lud/x$b;->Q(Ljava/lang/String;)Lud/x$b;
    ...
    invoke-virtual {v0, v2}, Lud/x$b;->o(Z)Lud/x$b;
    ...
    invoke-virtual {v0, v2}, Lud/x$b;->k(Lcom/android/camera/effect/renders/f;)Lud/x$b;
    ...
    invoke-virtual {v0, v2}, Lud/x$b;->p(Z)Lud/x$b;

    move-result-object v0

    invoke-virtual {v0, v7}, Lud/x$b;->g(I)Lud/x$b;
    ...
    invoke-virtual {v0, v2}, Lud/x$b;->i(Z)Lud/x$b;
    ...
    invoke-virtual {v0, v2}, Lud/x$b;->j(Z)Lud/x$b;
    ...
    invoke-virtual {v0, v2, v3}, Lud/x$b;->f(J)Lud/x$b;
    ...
    invoke-virtual {v4, v0}, Lud/w;->b(Lud/x;)V
    ...
    invoke-virtual {v4, v1}, Lud/w;->p1(Z)V
    ...
    invoke-virtual {v0, v4, v1, v1, v1}, Lr7/h;->j(Lud/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method public final g(Landroid/graphics/Bitmap;ZZZIZ)[B
    ...
    invoke-virtual {p0, p2}, Lcom/android/camera/n3;->b(Z)I

    move-result p0

    invoke-static {p1, p0}, Lze/b;->g(Landroid/graphics/Bitmap;I)[B
...
.method public final h([BZZZIZZ)[B
    ...
    invoke-static/range {v1 .. v7}, Lcom/android/camera/g6;->Z(Landroid/graphics/Bitmap;FZFZZZ)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v0, v8}, Lcom/android/camera/n3;->b(Z)I

    move-result v0

    invoke-static {v1, v0}, Lze/b;->g(Landroid/graphics/Bitmap;I)[B
