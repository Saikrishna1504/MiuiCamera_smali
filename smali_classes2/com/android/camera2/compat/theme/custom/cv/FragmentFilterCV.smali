...
.method public initView(Landroid/view/View;)V
    ...
    iput-object v2, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lw0/q0;
    ...
    invoke-virtual {v2, v0, v4}, Lw0/q0;->d(Ljava/util/ArrayList;I)V
    ...
    invoke-virtual {v2, v4}, Lw0/q0;->getComponentValue(I)Ljava/lang/String;
    ...
    invoke-direct {v3, p1, v0, v4, v2}, Lcom/android/camera2/compat/theme/custom/cv/EffectItemAdapterCV;-><init>(Landroid/content/Context;Lcom/android/camera/data/data/a;ZLnj/b;)V
...
.method public onFilterStatsTracked(IZ)V
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lw0/q0;

    invoke-virtual {p0}, Lw0/q0;->getItems()Ljava/util/List;
    ...
    invoke-static {p0, p2}, Lq7/a;->G1(IZ)V
    :try_end_0
...
.method public onItemSelected(IZ)V
    ...
    iget-object v3, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lw0/q0;
    ...
    :cond_0
    :try_start_0
    invoke-virtual {v3}, Lw0/q0;->getItems()Ljava/util/List;
    ...
    invoke-virtual {v5, v2, v4}, Lw0/q0;->e(ZI)V
    ...
    invoke-virtual {p1}, Lbb/c;->Xa()Z

    move-result p1

    if-eqz p1, :cond_2

    invoke-static {v3}, Lj9/c;->d(I)V
    ...
    invoke-interface {p2, v2, v0, v0, v2}, La7/b0;->ea(ZLjava/lang/String;Ljava/lang/String;Z)V

    :cond_3
    invoke-interface {p2, v3}, La7/b0;->cg(I)V
    :try_end_0
    .catch Ljava/lang/NumberFormatException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {p2, p0}, La7/b0;->cg(I)V
...
.method public bridge synthetic oneKeyCloseMutex()V
    ...
    invoke-super {p0}, Lcom/android/camera/fragment/beauty/d0;->oneKeyCloseMutex()V
...
.method public updateLayout4GalleryMode(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p1, p2}, Lw0/q0;->getComponentValue(I)Ljava/lang/String;

    move-result-object p1

    iget-object p2, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lw0/q0;
