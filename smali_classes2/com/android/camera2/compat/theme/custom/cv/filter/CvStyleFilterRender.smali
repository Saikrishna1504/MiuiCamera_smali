...
.method public constructor <init>(Lta/g;ILx2/f;Landroid/content/Context;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/effect/renders/s;-><init>(Lta/g;I)V
    ...
    iput-object p3, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:Lx2/f;
...
.method private updateVertexData(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lcom/android/camera/effect/renders/o;->mGLCanvas:Lta/g;

    check-cast v0, Lta/a;

    iget-object v0, v0, Lta/a;->c:Lcom/android/camera/effect/v;

    invoke-virtual {v0}, Lcom/android/camera/effect/v;->d()V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/camera/effect/v;->g(FF)V
    ...
    invoke-virtual {v0, v1, p1}, Lcom/android/camera/effect/v;->f(FF)V

    iget-object v2, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mConvertedVertex:[F

    const/4 v3, 0x0

    iget-object p1, p0, Lcom/android/camera/effect/renders/o;->mGLCanvas:Lta/g;

    check-cast p1, Lta/a;

    iget-object p1, p1, Lta/a;->c:Lcom/android/camera/effect/v;

    invoke-virtual {p1}, Lcom/android/camera/effect/v;->a()[F
    ...
    iget-object v5, v0, Lcom/android/camera/effect/v;->e:[F
    ...
    iget-object p0, p0, Lcom/android/camera/effect/renders/o;->mGLCanvas:Lta/g;

    check-cast p0, Lta/a;

    iget-object p0, p0, Lta/a;->c:Lcom/android/camera/effect/v;
...
.method public draw(Lr2/b;)Z
    .locals 4

    iget v0, p1, Lr2/b;->a:I
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:Lx2/f;
    ...
    iget-object p1, p1, Lr2/g;->b:Landroid/graphics/Rect;

    sget-object v1, Leg/b;->a:Landroid/content/Context;
    ...
    iget-object v0, p1, Lr2/c;->c:Lta/b;

    iget-object p1, p1, Lr2/n;->b:Landroid/graphics/Rect;

    sget-object v1, Leg/b;->a:Landroid/content/Context;

    invoke-virtual {p0, v0, p1, v1}, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->drawTexture(Lta/b;Landroid/graphics/Rect;Landroid/content/Context;)V
...
.method public drawTexture(ILandroid/graphics/Rect;Landroid/content/Context;)V
    ...
    .line 17
    iget-object p0, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:Lx2/f;

    invoke-virtual {p0, p1, p2, v0, p3}, Lx2/f;->b(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)V

    :cond_1
    return-void
.end method

.method public drawTexture(Lta/b;Landroid/graphics/Rect;Landroid/content/Context;)V
    .locals 1
    ...
    invoke-virtual {p1, v0}, Lta/b;->f(Lta/g;)Z
    ...
    .line 4
    invoke-virtual {p0, p1, v0}, Lcom/android/camera/effect/renders/s;->bindTexture(Lta/b;I)Z
    ...
    .line 9
    iget-object p2, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:Lx2/f;

    invoke-virtual {p1}, Lta/b;->b()I
    ...
    invoke-virtual {p2, p1, v0, p0, p3}, Lx2/f;->b(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)V
...
.method public initFilter(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1}, Lx2/f;->a(Landroid/content/Context;)V
