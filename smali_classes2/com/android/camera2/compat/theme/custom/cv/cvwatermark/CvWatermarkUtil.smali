...
.method private static buildExif(Lac/d;Landroid/hardware/camera2/CaptureResult;IILcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkParam;)Lac/d;
    ...
    invoke-static/range {v0 .. v10}, Lcom/android/camera/o3;->h(IIIJLandroid/location/Location;Landroid/hardware/camera2/CaptureResult;JLac/d;Z)V
    ...
    invoke-static {p0, p2, p3, v0, p4}, Lcom/android/camera/o3;->e(Lac/d;JIS)V

    invoke-static {p1, p0}, Lcom/android/camera/o3;->g(Landroid/hardware/camera2/CaptureResult;Lac/d;)V

    invoke-static {p0, p1}, Lcom/android/camera/o3;->c(Lac/d;Landroid/hardware/camera2/CaptureResult;)V
...
.method private static composeXmpMeta(Lcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkParam;)Lc/d;
    ...
    invoke-static {v0, v2, v3, v4, p0}, Lcom/android/camera/o6;->c(Lorg/xmlpull/v1/XmlSerializer;ILandroid/graphics/Rect;ZZ)V
    ...
    invoke-interface {v0, v1, v2, p0}, Lc/d;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static dumpYuv(Ljava/lang/String;Ljava/lang/String;[BII)V
    ...
    invoke-static {p2, v3}, Lcom/android/camera/g6;->l4([BLjava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lcom/android/camera/g6;->l4([BLjava/lang/String;)V
...
.method public static processPreviewWatermark(Lud/w;)V
    .locals 9
    ...
    invoke-virtual {v2}, Lud/x;->l0()Landroid/location/Location;
    ...
    invoke-virtual {p0}, Lud/w;->o()I

    move-result v5

    invoke-virtual {v4, v5}, Lbb/c;->z8(I)Z
    ...
    sget-object v1, Lcom/android/camera/n3;->d:Lcom/android/camera/n3;

    invoke-virtual {v1, v3}, Lcom/android/camera/n3;->b(Z)I

    move-result v1

    invoke-static {v0, v1}, Lze/b;->g(Landroid/graphics/Bitmap;I)[B
    ...
    invoke-virtual {v2, v3, v0}, Lud/x;->a1(II)V

    invoke-virtual {p0, v1}, Lud/w;->t0([B)V

    iget-object p0, p0, Lud/w;->o0:Lud/g;

    invoke-virtual {p0, v4}, Lud/g;->e(Z)V

    return-void
.end method

.method public static processWatermark(Lud/w;)V
    .locals 22

    move-object/from16 v6, p0

    invoke-virtual/range {p0 .. p0}, Lud/w;->q()Lud/x;
    ...
    invoke-virtual {v0}, Lud/x;->g0()J

    move-result-wide v0

    invoke-virtual/range {p0 .. p0}, Lud/w;->k()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {v4}, Lud/x;->l0()Landroid/location/Location;
    ...
    invoke-virtual/range {p0 .. p0}, Lud/w;->o()I

    move-result v9

    invoke-virtual {v8, v9}, Lbb/c;->z8(I)Z
    ...
    invoke-virtual {v10}, Lud/x;->s0()Landroid/util/Size;
    ...
    invoke-virtual/range {p0 .. p0}, Lud/w;->y()[B

    move-result-object v11

    invoke-virtual/range {p0 .. p0}, Lud/w;->w()Ljava/lang/String;
    ...
    invoke-virtual {v14}, Lud/x;->q0()Landroid/util/Size;
    ...
    invoke-virtual/range {p0 .. p0}, Lud/w;->r()J
    ...
    invoke-virtual {v1, v3, v4}, Lud/x;->X0(ILandroid/graphics/Rect;)V
    ...
    invoke-static/range {v0 .. v5}, Lcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkUtil;->saveHeifFile(Lud/w;[B[BIII)[B
    ...
    invoke-virtual {v5, v11}, Lud/w;->u([B)Lac/d;
    ...
    invoke-virtual/range {p0 .. p0}, Lud/w;->B()I
    ...
    invoke-virtual {v5, v0}, Lud/w;->t0([B)V
    ...
    :goto_6
    invoke-virtual {v5, v7}, Lud/w;->c1(Z)V

    return-void
.end method

.method private static saveHeifFile(Lud/w;[B[BIII)[B
    .locals 10
    ...
    invoke-virtual {p0}, Lud/w;->N()Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {v5}, Lcom/android/camera/g6;->U0(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p3, p4}, Lbb/c;->z8(I)Z
    ...
    invoke-static {p0}, Lug/b;->h(Ljava/lang/String;)[B
