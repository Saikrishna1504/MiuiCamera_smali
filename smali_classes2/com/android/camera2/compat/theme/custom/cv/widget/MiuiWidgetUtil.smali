...
.method public static synthetic a(Ljava/util/concurrent/atomic/AtomicBoolean;Landroid/content/Intent;Ly7/c0;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/android/camera2/compat/theme/custom/cv/widget/MiuiWidgetUtil;->lambda$setWidgetCameraMasterFilter$1(Ljava/util/concurrent/atomic/AtomicBoolean;Landroid/content/Intent;Ly7/c0;)V

    return-void
.end method

.method public static synthetic b(ILy7/c0;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/cv/widget/MiuiWidgetUtil;->lambda$setWidgetCameraFilter$2(ILy7/c0;)V

    return-void
.end method

.method public static synthetic c(ILjava/util/concurrent/atomic/AtomicBoolean;Ly7/c0;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/android/camera2/compat/theme/custom/cv/widget/MiuiWidgetUtil;->lambda$setWidgetCameraMasterFilter$0(ILjava/util/concurrent/atomic/AtomicBoolean;Ly7/c0;)V
...
.method private static checkMasterFilterId(Ljava/util/ArrayList;I)I
    ...
    iget v1, v0, Lcom/android/camera/effect/t;->c:I

    if-ne v1, p1, :cond_0

    iget p0, v0, Lcom/android/camera/effect/t;->h:I
...
.method private static initFilterComponent(ILjava/util/ArrayList;)V
    ...
    invoke-virtual {v1, p1, p0, v0}, Lh1/t0;->m(Ljava/util/ArrayList;II)V

    const/4 p0, 0x0

    invoke-virtual {v1, v0, p0}, Lh1/t0;->n(IZ)V
...
.method private static is75mmLensSupported()Z
    ...
    invoke-static {}, Lea/d;->g()Ljava/util/HashMap;
...
.method private static synthetic lambda$setWidgetCameraFilter$2(ILy7/c0;)V
    .locals 0
...
.method private static synthetic lambda$setWidgetCameraMasterFilter$0(ILjava/util/concurrent/atomic/AtomicBoolean;Ly7/c0;)V
    .locals 0

    invoke-interface {p2, p0}, Ly7/c0;->C8(I)V
...
.method private static lambda$setWidgetCameraMasterFilter$1(Ljava/util/concurrent/atomic/AtomicBoolean;Landroid/content/Intent;Ly7/c0;)V
    .locals 0
...
.method private static mutexByCclockWidget(I)V
    ...
    invoke-virtual {v0, p0}, Ld1/u0;->getPersistValue(I)Ljava/lang/String;
    ...
    iget-object v3, v2, Ld1/h;->g:Ljava/util/ArrayList;
    ...
    iget-object v2, v2, Ld1/h;->g:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, p0}, Lh1/z0;->isSwitchOn(I)Z

    move-result v2

    if-eqz v2, :cond_4

    invoke-virtual {v1, p0}, Lh1/z0;->h(I)V
    ...
    invoke-static {p0, v4}, Lcom/android/camera/data/data/f0;->r0(IZ)V

    invoke-virtual {v0, p0}, Lcom/android/camera/data/data/c;->reset(I)V

    :cond_5
    invoke-static {p0, v4}, Lcom/android/camera/data/data/f0;->q0(IZ)V
...
.method private static mutexByCvLensWidget(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p0, v0}, Ld1/b0;->toSwitch(IZ)V
...
.method private static mutexByMasterFilterWidget(I)V
    ...
    invoke-virtual {v0, p0}, Lh1/z0;->h(I)V
    ...
    invoke-static {p0, v0}, Lcom/android/camera/data/data/f0;->r0(IZ)V
    ...
    invoke-virtual {p0, v0}, Ld1/s;->o(I)Z
    ...
    invoke-virtual {p0, v0, v1}, Ld1/s;->setComponentValue(ILjava/lang/String;)V
...
.method public static setCameraWidget(Landroid/content/pm/PackageManager;Landroid/content/Context;)V
    ...
    invoke-virtual {v1}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->H5()Z
    ...
    invoke-virtual {v0}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->a5()Z
...
.method private static setWidgetCameraCcLock(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, v1}, Ld1/h;->m(Z)V
    ...
    invoke-virtual {v0, v1}, Le1/d;->n(Z)V

    const/16 v0, 0xa2

    invoke-static {v0, v1}, Lcom/android/camera/data/data/n;->t0(IZ)V
...
.method private static setWidgetCameraCvType(Landroid/content/Intent;)V
    ...
    iput-boolean v1, v0, Ld1/k;->c:Z

    const/16 v1, 0xab

    const-string v2, "0"

    invoke-virtual {v0, v1, v2}, Ld1/k;->setComponentValue(ILjava/lang/String;)V
...
.method private static setWidgetCameraFilter(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, v3}, Lcom/android/camera/effect/r;->getFilterInfo(I)Ljava/util/ArrayList;
    ...
    invoke-direct {v4, p0, v1}, Lcom/android/camera/features/mode/capture/o;-><init>(II)V
    ...
    invoke-static {v1, v0, p0}, Ltj/a;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
...
.method private static setWidgetCameraLens(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    :goto_1
    :pswitch_4
    invoke-static {p0}, Lcom/android/camera/data/data/f0;->n0(Ljava/lang/String;)V
    ...
    invoke-static {v2, v1, p0}, Ltj/a;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
...
.method private static setWidgetCameraMasterFilter(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/camera/effect/r;->getFilterInfo(I)Ljava/util/ArrayList;
    ...
    invoke-direct {v2, p0, v0}, Ld5/d;-><init>(ILjava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    invoke-direct {v1, v2, v0, p1}, Lv4/x;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method private static setWidgetProStyleMode(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, v1, v2}, Ld1/k0;->setComponentValue(ILjava/lang/String;)V
...
.method private static updateDefaultWidget(Landroid/content/Context;Landroid/content/pm/PackageManager;)V
    ...
    invoke-virtual {v1}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->a5()Z
    ...
    invoke-virtual {v0}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->H5()Z
