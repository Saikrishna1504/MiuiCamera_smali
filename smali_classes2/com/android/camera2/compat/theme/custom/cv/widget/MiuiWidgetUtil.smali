...
.method public static synthetic a(ILa7/b0;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/cv/widget/MiuiWidgetUtil;->lambda$setWidgetCameraFilter$0(ILa7/b0;)V
...
.method private static initFilterComponent(Ljava/util/ArrayList;)V
    ...
    :goto_0
    invoke-virtual {v1, p0, v0}, Lw0/q0;->d(Ljava/util/ArrayList;I)V

    const/4 p0, 0x0

    invoke-virtual {v1, p0, v0}, Lw0/q0;->e(ZI)V

    return-void
.end method

.method private static synthetic lambda$setWidgetCameraFilter$0(ILa7/b0;)V
    .locals 0

    invoke-interface {p1, p0}, La7/b0;->cg(I)V
...
.method private static mutexByCclockWidget(I)V
    ...
    invoke-virtual {v2}, Lt0/m1;->w()Lt0/f;
    ...
    invoke-virtual {v1, p0}, Lw0/t0;->isSwitchOn(I)Z

    move-result v2

    if-eqz v2, :cond_3

    invoke-virtual {v1, p0}, Lw0/t0;->d(I)V
    ...
    invoke-static {p0, v2}, Lcom/android/camera/e3;->A9(IZ)V

    invoke-virtual {v0, p0}, Lcom/android/camera/data/data/a;->reset(I)V

    :cond_4
    invoke-static {p0, v2}, Lcom/android/camera/e3;->z9(IZ)V
...
.method private static mutexByCvLensWidget(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lw0/k1;->J1(Ljava/lang/String;)V

    const/16 p0, 0xab

    invoke-static {p0, v0}, Lcom/android/camera/e3;->P7(IZ)V
...
.method private static mutexByMasterFilterWidget(I)V
    ...
    invoke-virtual {v0, p0}, Lw0/t0;->d(I)V
    ...
    invoke-static {p0, v0}, Lcom/android/camera/e3;->A9(IZ)V
    ...
    invoke-virtual {p0, v1, v0}, Lt0/n;->z(ZI)V
...
.method private static setWidgetCameraCcLock(Landroid/content/Intent;)V
    ...
    invoke-static {v1, v0}, Lcom/android/camera/e3;->d8(IZ)V
    ...
    invoke-virtual {v0, v1, v2}, Lw0/y0;->W(IZ)V
    ...
    invoke-virtual {p0, v2}, Lw0/k1;->o1(Z)V
...
.method private static setWidgetCameraCvType(Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, v0}, Lw0/k1;->o1(Z)V
...
.method private static setWidgetCameraFilter(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-static {p0, v0}, Lq7/a;->G4(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lw0/k1;->o1(Z)V
...
.method private static setWidgetCameraLens(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-static {p0, v1}, Lq7/a;->G4(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static setWidgetIntentInfo(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0}, Lcom/android/camera/b3;->m()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/android/camera/b3;->p()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/android/camera/b3;->r()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lcom/android/camera/b3;->i()Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lcom/android/camera/b3;->h()Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lcom/android/camera/b3;->q()Ljava/lang/String;
...
.method private static setWidgetProStyleMode(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, v1}, Lw0/k1;->x1(Ljava/lang/String;)V
