...
.method public static synthetic C(La8/f;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;->lambda$alertFlashFrontAdjustSwitchLayout$2(La8/f;)V
...
.method public static synthetic l(Ly7/c0;Ly7/e3;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;->lambda$reInitAlertAction$6(Ly7/c0;Ly7/e3;)V
...
.method private static synthetic lambda$alertFlashFrontAdjustSwitchLayout$2(La8/f;)V
    .locals 2
...
.method private static synthetic lambda$alertFlashFrontAdjustSwitchLayout$3(Ly7/c0;)V
    .locals 1
...
.method private static synthetic lambda$reInitAlertAction$6(Ly7/c0;Ly7/e3;)V
    .locals 1

    const/4 v0, 0x1

    invoke-interface {p1, p0, v0}, Ly7/e3;->showTips(Ly7/c0;Z)V
...
.method private reInitAlertAction(Z)V
    ...
    invoke-direct {v0, p0, v3}, Lq0/a;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p1, v0}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    invoke-interface {p0}, Ly7/c0;->Qf()V

    invoke-interface {p0}, Ly7/c0;->Mh()V

    invoke-interface {p0}, Ly7/c0;->u7()V

    invoke-interface {p0}, Ly7/c0;->b2()V

    invoke-interface {p0}, Ly7/c0;->qf()V

    invoke-interface {p0}, Ly7/c0;->e6()V

    invoke-interface {p0, v1}, Ly7/c0;->hh(Z)V

    invoke-interface {p0}, Ly7/c0;->dc()V

    invoke-interface {p0}, Ly7/c0;->mb()V

    invoke-interface {p0}, Ly7/c0;->F0()V

    new-array p1, v2, [Z

    invoke-interface {p0, p1}, Ly7/c0;->rd([Z)V

    invoke-interface {p0}, Ly7/c0;->k8()V

    invoke-interface {p0}, Ly7/c0;->s9()V

    invoke-interface {p0}, Ly7/c0;->s3()V
    ...
    invoke-virtual {p1}, Lh1/h1;->B()Z

    move-result p1

    invoke-interface {p0, p1}, Ly7/c0;->t4(Z)V

    invoke-interface {p0}, Ly7/c0;->bh()V

    invoke-interface {p0}, Ly7/c0;->pa()V

    invoke-interface {p0}, Ly7/c0;->Ta()V

    invoke-interface {p0}, Ly7/c0;->r5()V

    invoke-interface {p0}, Ly7/c0;->Uc()V

    invoke-interface {p0}, Ly7/c0;->H7()V

    invoke-interface {p0}, Ly7/c0;->J0()V

    invoke-interface {p0}, Ly7/c0;->q8()V

    invoke-interface {p0}, Ly7/c0;->L3()V

    :cond_1
    return-void
.end method

.method public static synthetic u(Ly7/c0;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;->lambda$alertFlashFrontAdjustSwitchLayout$3(Ly7/c0;)V

    return-void
.end method

.method public static synthetic z(Landroid/view/View;IILcom/android/camera/fragment/top/FragmentTopAlert;)V
    .locals 0
...
.method public alert960FpsDirectOverheatHint(I)V
    ...
    invoke-virtual {v1, v2}, Ld1/n0;->getComponentValue(I)Ljava/lang/String;
...
.method public alertAiDetectTipHint(IIJ)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/camera2/compat/theme/custom/mm/top/g;-><init>(Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;IIJ)V
...
.method public alertFlashFrontAdjustSwitchLayout(ZZ)V
    ...
    invoke-direct {p1, p2}, Le7/w1;-><init>(I)V
...
.method public bridge synthetic getVideoTag()Ly7/g1;
    .locals 0

    .line 1
    invoke-virtual {p0}, Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;->getVideoTag()Lcom/android/camera/ui/x1;
...
.method public initLandscapeTopTipLayout(Landroid/view/View;II)V
    ...
    invoke-direct {v0, p1, p2, p3}, Lcom/android/camera2/compat/theme/custom/mm/top/h;-><init>(Landroid/view/View;II)V
...
.method public registerProtocol()V
    ...
    invoke-virtual {v0, v1, v2}, Lv7/e;->b(Ljava/lang/Class;Lv7/a;)V
...
.method public updateLyingDirectHint(ZZ)V
    ...
    invoke-interface {v0, p1}, Ly7/e3;->setIsShowTopLyingDirectHint(Z)V
    ...
    invoke-interface {v0}, Ly7/e3;->isShowTopLyingDirectHint()Z
