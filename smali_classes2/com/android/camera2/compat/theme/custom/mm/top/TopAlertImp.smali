...
.method public static synthetic I(La7/b0;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;->lambda$alertFlashFrontAdjustSwitchLayout$2(La7/b0;)V
...
.method public static synthetic d(La7/b0;La7/b3;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;->lambda$reInitAlertAction$4(La7/b0;La7/b3;)V
...
.method private static synthetic lambda$alertFlashFrontAdjustSwitchLayout$2(La7/b0;)V
    .locals 1
...
.method private static synthetic lambda$reInitAlertAction$4(La7/b0;La7/b3;)V
    .locals 1

    const/4 v0, 0x1

    invoke-interface {p1, p0, v0}, La7/b3;->showTips(La7/b0;Z)V
...
.method private reInitAlertAction(Z)V
    ...
    invoke-direct {v2, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/x1;-><init>(La7/b0;)V

    invoke-virtual {v0, v2}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    invoke-interface {p1}, La7/b0;->rf()V

    invoke-interface {p1}, La7/b0;->fh()V

    invoke-interface {p1}, La7/b0;->P1()V

    invoke-interface {p1}, La7/b0;->Qe()V

    invoke-interface {p1, v1}, La7/b0;->Ag(Z)V

    invoke-interface {p1}, La7/b0;->gb()V

    invoke-interface {p1}, La7/b0;->xa()V

    invoke-interface {p1}, La7/b0;->t0()V

    invoke-interface {p1, v1}, La7/b0;->N3(Z)V

    invoke-interface {p1}, La7/b0;->w7()V

    invoke-interface {p1}, La7/b0;->D8()V
    ...
    invoke-interface {p1, v0}, La7/b0;->M3(Z)V

    invoke-interface {p1}, La7/b0;->rg()V

    invoke-interface {p1}, La7/b0;->E9()V

    invoke-interface {p1}, La7/b0;->ga()V

    invoke-interface {p1}, La7/b0;->L4()V

    invoke-interface {p1}, La7/b0;->dc()V

    invoke-interface {p1}, La7/b0;->Y6()V

    invoke-interface {p1}, La7/b0;->x0()V

    invoke-interface {p1}, La7/b0;->B7()V
...
.method public alert960FpsDirectOverheatHint(I)V
    ...
    invoke-virtual {v1}, Lt0/m1;->P()Lt0/y;
...
.method public alertSlowMotionDisableRecordTip(I)V
    ...
    invoke-virtual {v3}, Lcom/android/camera/m5;->g()I
    ...
    invoke-static {v3}, Lcom/android/camera/g6;->w2(I)Z
...
.method public alertSuperNightSeTip(I)V
    ...
    invoke-static {}, Lcom/android/camera/g6;->y3()Z
...
.method public registerProtocol()V
    ...
    invoke-virtual {v2, v1, v0}, Lw6/e;->a(Ljava/lang/Class;Lw6/a;)V
...
.method public updateLyingDirectHint(ZZ)V
    ...
    invoke-interface {v0, p1}, La7/b3;->setIsShowTopLyingDirectHint(Z)V
    ...
    invoke-interface {v0}, La7/b3;->isShowTopLyingDirectHint()Z
