...
.method public static synthetic a(Lr5/n;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/StartExtraTopBarSecondPartLayout;->lambda$updateData$1(Lr5/n;Landroid/view/View;)V

    return-void
.end method

.method public static synthetic b(Ljava/util/List;Lr5/n;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/StartExtraTopBarSecondPartLayout;->lambda$updateData$0(Ljava/util/List;Lr5/n;)V

    return-void
.end method

.method public static synthetic c(Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/StartExtraTopBarSecondPartLayout;ILr5/n;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/StartExtraTopBarSecondPartLayout;->lambda$updateData$2(ILr5/n;)V

    return-void
.end method

.method private static lambda$updateData$0(Ljava/util/List;Lr5/n;)V
    .locals 2

    iget v0, p1, Lr5/n;->a:I
...
.method private static lambda$updateData$1(Lr5/n;Landroid/view/View;)V
    .locals 1
    ...
    :cond_0
    iget-object p0, p0, Lr5/n;->i:Landroid/view/View$OnClickListener;
...
.method private lambda$updateData$2(ILr5/n;)V
    .locals 3
    ...
    iget-object v1, p2, Lr5/n;->g:Lr5/n$c;

    invoke-interface {v1, p1}, Lr5/n$c;->updateResource(I)Lr5/o;
    ...
    invoke-virtual {v1, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/ExtraTopBarImageViewHolder;->updateView(Lr5/o;)V

    new-instance v1, Lt1/e;

    const/16 v2, 0x8

    invoke-direct {v1, p2, v2}, Lt1/e;-><init>(Ljava/lang/Object;I)V
...
.method public notifyItemChanged(I)V
    ...
    iget-object v2, v2, Lr5/n;->g:Lr5/n$c;

    invoke-interface {v2, v3}, Lr5/n$c;->updateResource(I)Lr5/o;
    ...
    invoke-virtual {v3, v2}, Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/ExtraTopBarImageViewHolder;->updateView(Lr5/o;)V

    iget v2, v2, Lr5/o;->j:I
...
.method public updateData(ILjava/util/List;Landroid/view/View$OnClickListener;Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/IExtraTopBarUIConfig;)V
    ...
    new-instance p4, La0/w0;

    const/16 v0, 0x12

    invoke-direct {p4, p3, v0}, La0/w0;-><init>(Ljava/lang/Object;I)V
    ...
    new-instance p3, Lcom/android/camera/fragment/i0;

    const/4 p4, 0x3

    invoke-direct {p3, p0, p1, p4}, Lcom/android/camera/fragment/i0;-><init>(Ljava/lang/Object;II)V
