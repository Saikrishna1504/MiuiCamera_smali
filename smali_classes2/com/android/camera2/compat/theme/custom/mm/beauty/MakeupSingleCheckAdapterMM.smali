...
# instance fields
.field private mComponentRunningShine:Lw0/y0;
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;Ljava/util/List;III)V
    ...
    .line 4
    invoke-interface {p1}, La7/p1;->u0()Lw0/y0;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/MakeupSingleCheckAdapterMM;->mComponentRunningShine:Lw0/y0;
...
.method public onBindViewHolder(Lcom/android/camera/fragment/beauty/MakeupSingleCheckAdapter$SingleCheckViewHolder;I)V
    ...
    .line 23
    iget-boolean v2, v0, Lcom/android/camera/data/data/f;->e:Z

    if-eqz v2, :cond_5

    iget-object p0, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/MakeupSingleCheckAdapterMM;->mComponentRunningShine:Lw0/y0;

    invoke-virtual {p0}, Lw0/y0;->f0()Z
