...
.method public constructor <init>(Lcom/android/camera/module/AmbilightModule;[BJLcom/android/camera/module/AmbilightModule$j;)V
    ...
    iput-object v0, p0, Lcom/android/camera/module/AmbilightModule$i;->l:Landroid/util/SparseArray;
    ...
    invoke-static {p1}, Lcom/android/camera/module/AmbilightModule;->access$2500(Lcom/android/camera/module/AmbilightModule;)Landroid/util/SparseArray;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/module/AmbilightModule$i;->l:Landroid/util/SparseArray;
...
.method public final a(Lac/d;[BLandroid/location/Location;S)[B
    ...
    :try_start_1
    invoke-static/range {v1 .. v11}, Lcom/android/camera/o3;->h(IIIJLandroid/location/Location;Landroid/hardware/camera2/CaptureResult;JLac/d;Z)V

    invoke-static {v12, v14}, Lcom/android/camera/o3;->f(Lac/d;S)V
    ...
    invoke-static {v13, v12, v0}, Lcom/android/camera/o3;->F([BLac/d;[B)[B
...
.method public final b(F)F
    ...
    :goto_0
    iget-object v2, p0, Lcom/android/camera/module/AmbilightModule$i;->l:Landroid/util/SparseArray;
    ...
    :cond_1
    :goto_1
    iget-object v0, p0, Lcom/android/camera/module/AmbilightModule$i;->l:Landroid/util/SparseArray;
    ...
    iget-object p0, p0, Lcom/android/camera/module/AmbilightModule$i;->l:Landroid/util/SparseArray;
...
.method public final c([B[BLac/d;)V
    ...
    invoke-static {v2, v5, p0, v6, v7}, Lcom/android/camera/o6;->c(Lorg/xmlpull/v1/XmlSerializer;ILandroid/graphics/Rect;ZZ)V
    ...
    invoke-interface {p2, v4, v5, p0}, Lc/d;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    invoke-static {v2, v3, p2}, Lcom/android/camera/m6;->i(Ljava/io/InputStream;Ljava/io/OutputStream;Lc/d;)Z
...
.method public varargs d([Ljava/lang/Void;)Ljava/lang/Integer;
    ...
    invoke-static {p1}, Lcom/android/camera/e3;->e0(Z)Lcom/android/camera/n3;

    move-result-object v0

    invoke-virtual {v0, p1}, Lcom/android/camera/n3;->b(Z)I
    ...
    invoke-direct/range {v6 .. v13}, Lud/w;-><init>(IJILjava/lang/String;J)V

    invoke-virtual {v2, v0, p1}, Lud/w;->a([BI)V

    iget-object v0, v2, Lud/w;->o0:Lud/g;

    invoke-virtual {v0, v5}, Lud/g;->d(Lac/d;)V

    new-instance v0, Lud/x$b;

    const/16 v3, 0x100

    invoke-direct {v0, v1, v1, v1, v3}, Lud/x$b;-><init>(Landroid/util/Size;Landroid/util/Size;Landroid/util/Size;I)V
    ...
    invoke-static {v5}, Lcom/android/camera/e3;->T(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, Lud/x$b;->q(Z)Lud/x$b;

    move-result-object v0

    iget v3, p0, Lcom/android/camera/module/AmbilightModule$i;->g:I

    invoke-virtual {v0, v3}, Lud/x$b;->u(I)Lud/x$b;
    ...
    invoke-virtual {v3, p1}, Lcom/android/camera/n3;->b(Z)I

    move-result v3

    invoke-virtual {v0, v3}, Lud/x$b;->t(I)Lud/x$b;

    move-result-object v0

    sget v3, Lcom/android/camera/effect/q;->Y:I

    invoke-virtual {v0, v3}, Lud/x$b;->h(I)Lud/x$b;

    move-result-object v0

    sget v3, Lcom/android/camera/effect/q;->x:I

    invoke-virtual {v0, v3}, Lud/x$b;->n(I)Lud/x$b;
    ...
    invoke-virtual {v0, v3}, Lud/x$b;->V(I)Lud/x$b;

    move-result-object v0

    sget v3, Lcom/android/camera/effect/q;->b0:I

    invoke-virtual {v0, v3}, Lud/x$b;->G(I)Lud/x$b;

    move-result-object v0

    invoke-virtual {v0, p1}, Lud/x$b;->S(I)Lud/x$b;

    move-result-object v0

    invoke-virtual {v0, p1}, Lud/x$b;->U(I)Lud/x$b;

    move-result-object v0

    invoke-virtual {v0, p1}, Lud/x$b;->F(I)Lud/x$b;
    ...
    :goto_2
    invoke-virtual {p1, v0}, Lud/x$b;->R(Ljava/lang/String;)Lud/x$b;

    move-result-object p1

    invoke-virtual {p1, v1}, Lud/x$b;->k(Lcom/android/camera/effect/renders/f;)Lud/x$b;
    ...
    invoke-static {v0}, Lcom/android/camera/module/AmbilightModule;->access$2600(Lcom/android/camera/module/AmbilightModule;)Lud/z;
    ...
    invoke-virtual {p1, v0}, Lud/x$b;->E(Lud/z;)Lud/x$b;

    move-result-object p1

    invoke-virtual {p1}, Lud/x$b;->a()Lud/x;

    move-result-object p1

    invoke-virtual {v2, p1}, Lud/w;->b(Lud/x;)V

    invoke-virtual {v2, v6}, Lud/w;->d1(Z)V
    ...
    invoke-virtual {p0, v2, v4, v4, v4}, Lr7/h;->j(Lud/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method public final e(SLandroid/location/Location;I)[B
    ...
    invoke-static {p1, p2, p0, p3}, Lcom/android/camera/w3;->c([BIII)[B
...
.method public final g(SLandroid/location/Location;I)[B
    ...
    invoke-static {v6, v7}, Lcom/android/camera/g6;->V(J)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/android/camera/g6;->c1(I)I
