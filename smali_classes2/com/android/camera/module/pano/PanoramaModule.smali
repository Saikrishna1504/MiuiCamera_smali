...
.method public static synthetic F3(Lcom/android/camera/module/pano/PanoramaModule;ZLa7/j2;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$onStopShooting$6(ZLa7/j2;)V

    return-void
.end method

.method public static synthetic V3(Lcom/android/camera/module/pano/PanoramaModule;)V
    .locals 0
...
.method public static synthetic Y3(Ljava/util/concurrent/atomic/AtomicReference;)V
    .locals 0
...
.method private addImageAsApplication(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;II)V
    ...
    iput-object v2, v1, Lq7/a$c;->j:Lcom/android/camera/fragment/beauty/c0;
    ...
    invoke-virtual/range {v8 .. v13}, Lcom/android/camera/ActivityBase;->yh(Landroid/net/Uri;ZLjava/lang/String;IZ)V

    invoke-static {v1, v14, v15}, Lcom/android/camera/o5;->f(Landroid/content/Context;Landroid/net/Uri;Z)Lcom/android/camera/o5;

    move-result-object v3

    invoke-static {v1, v14}, Lcom/android/camera/g6;->v(Landroid/content/Context;Landroid/net/Uri;)V

    invoke-virtual {v1}, Lcom/android/camera/ActivityBase;->sd()Lcom/android/camera/ThumbnailUpdater;

    move-result-object v1

    invoke-virtual {v1, v3, v15, v15}, Lcom/android/camera/ThumbnailUpdater;->u(Lcom/android/camera/o5;ZZ)V
    ...
    :cond_5
    invoke-virtual {v3}, Lcom/android/camera/o5;->m()Landroid/graphics/Bitmap;
...
.method public static synthetic b4(La7/b3;)V
    ...
    invoke-static {p0}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$onSaveCompleted$8(La7/b3;)V
...
.method private createEngine(D)Z
    ...
    invoke-static {v3}, Lcom/android/camera/e3;->Z4(Landroid/content/Context;)Z
...
.method public static synthetic e3(Lcom/android/camera/module/pano/PanoramaModule;)V
    .locals 0
...
.method public static synthetic f3(Lcom/android/camera/module/pano/PanoramaModule;)V
    .locals 0
...
.method private getQuality()I
    ...
    invoke-static {p0}, Lcom/android/camera/e3;->e0(Z)Lcom/android/camera/n3;

    move-result-object v0

    invoke-virtual {v0, p0}, Lcom/android/camera/n3;->b(Z)I
...
.method public static synthetic h3(Lcom/android/camera/module/pano/PanoramaModule;La7/j2;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$startShooting$0(La7/j2;)V
...
.method private static synthetic lambda$onSaveCompleted$8(La7/b3;)V
    .locals 0
...
.method private synthetic lambda$onStopShooting$6(ZLa7/j2;)V
    .locals 1
    ...
    invoke-interface {p2, p1}, La7/j2;->c2(I)V

    goto :goto_0

    :cond_0
    invoke-interface {p2}, La7/j2;->E()V
    ...
    invoke-interface {p2}, La7/j2;->Ff()V
...
.method private synthetic lambda$startShooting$0(La7/j2;)V
    .locals 2
...
.method private static synthetic lambda$stopShooting$5(La7/d2;)V
    .locals 3
    ...
    invoke-interface {p0, v0}, La7/d2;->vb(Landroid/graphics/Bitmap;)V
...
.method private onSaveCompleted()V
    ...
    invoke-static {v3}, Lcom/android/camera/s;->d(Landroid/content/Context;)Lcom/android/camera/s;

    move-result-object v4

    invoke-virtual {v4}, Lcom/android/camera/s;->f()V
    ...
    invoke-virtual {v3}, Lcom/android/camera/ActivityBase;->sd()Lcom/android/camera/ThumbnailUpdater;
...
.method public static synthetic r3(La7/d2;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$stopShooting$5(La7/d2;)V
...
.method public static synthetic s3(Lcom/android/camera/module/pano/PanoramaModule;Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex/FlowableEmitter;)V
    .locals 0
...
.method private savePanoramaFile([Landroid/net/Uri;Ljava/lang/String;II)Z
    ...
    invoke-static {v12, v1}, Lcom/android/camera/g6;->i5(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
...
.method private savePanoramaPicture()V
    ...
    invoke-virtual {v0, v2, v5}, Lud/c;->h(II)Z
...
.method private startBurstRequest(Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex/FlowableEmitter;)V
    ...
    invoke-virtual {v3, v2}, Lcom/android/camera/n3;->b(Z)I
    ...
    invoke-static {v3}, Lz5/g0;->b(Lx5/m;)Lcom/android/camera/f3;

    move-result-object v3

    invoke-virtual {v1, v3}, Lcom/android/camera2/k3;->q5(Lcom/android/camera/f3;)V
    ...
    invoke-virtual {v1, p1, v2, p0}, Lcom/android/camera2/a;->f(ILcom/android/camera2/a$l;Lud/n;)V
...
.method public static synthetic t3(Lcom/android/camera/module/pano/PanoramaModule;)V
    .locals 0
