...
.method public static synthetic C9(Lcom/android/camera/module/pano/PanoramaModule;Lio/reactivex/FlowableEmitter;Ljava/util/concurrent/atomic/AtomicReference;)V
    .locals 0
...
.method public static synthetic Ca(Ljava/util/concurrent/atomic/AtomicReference;)V
    .locals 0
...
.method public static synthetic T9(Lcom/android/camera/module/pano/PanoramaModule;Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Boolean;)V
    .locals 0
...
.method public static synthetic Ua(Ly7/e3;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$onSaveCompleted$8(Ly7/e3;)V
...
.method private addImageAsApplication(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;II)V
    ...
    sget-object v10, Lo8/d;->b:Ljava/lang/Long;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    :try_start_2
    sget-object v10, Lce/a;->a:Ljava/nio/charset/Charset;
    :try_end_2
    ...
    invoke-direct {v10, v0}, Lce/b;-><init>(Ljava/io/FileDescriptor;)V
    :try_end_3
    ...
    invoke-static/range {v9 .. v14}, Lo8/d;->h(Lce/b;Landroid/location/Location;JI[B)V

    invoke-virtual {v0}, Lce/b;->J()V
    :try_end_4
    ...
    sget-object v0, Lo8/d;->b:Ljava/lang/Long;
    ...
    invoke-static/range {p2 .. p2}, La0/w;->j(Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v2}, Lce/b;-><init>(Ljava/lang/String;)V
    :try_end_9
    ...
    invoke-static {v0, v2, v9}, La0/d0;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v0, Lo8/y;->a:Ljava/lang/String;
    ...
    invoke-static/range {v9 .. v25}, Lo8/y;->m(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;ILjava/lang/String;JIILandroid/location/Location;ZZJ)Landroid/net/Uri;
    ...
    invoke-static {v0, v2}, La0/z;->c(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lo8/l;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/net/Uri;
    ...
    iput-wide v2, v1, Ljg/g;->i:J

    iput v11, v1, Ljg/g;->a:I

    iput-boolean v12, v1, Ljg/g;->b:Z

    iput v12, v1, Ljg/g;->c:I

    iput-object v9, v1, Ljg/g;->g:Lcom/android/camera/fragment/beauty/q;

    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/module/BaseModule;->getModuleIndex()I

    move-result v2

    iput v2, v1, Ljg/g;->l:I
    ...
    iput-boolean v2, v1, Ljg/g;->m:Z

    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/module/BaseModule;->getCameraManager()Lw6/k;

    move-result-object v2

    invoke-interface {v2}, Lw6/k;->i()I

    move-result v2

    iput v2, v1, Ljg/g;->n:I

    invoke-static {}, Lcom/android/camera/effect/r;->getInstance()Lcom/android/camera/effect/r;

    move-result-object v2

    invoke-virtual {v2}, Lcom/android/camera/effect/r;->getEffectForSaving()I

    move-result v2

    iput v2, v1, Ljg/g;->o:I

    invoke-virtual {v8, v1}, Lcom/android/camera/module/BaseModule;->trackPictureTaken(Ljg/g;)V

    iget-object v1, v8, Lcom/android/camera/module/BaseModule;->mCallback:Lcom/android/camera/module/k0;
    ...
    invoke-direct {v3, v1, v4}, Landroidx/fragment/app/j;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v2, v3}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    if-eqz v0, :cond_d

    invoke-interface {v1, v0, v12, v13, v12}, Lcom/android/camera/module/k0;->la(Landroid/net/Uri;ZLjava/lang/String;Z)V

    invoke-static {}, Lcom/xiaomi/camera/basic/Global;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-static {v2, v0}, La0/h7;->e(Landroid/content/Context;Landroid/net/Uri;)La0/h7;
    ...
    invoke-interface {v1, v2, v12, v12}, Lcom/android/camera/module/k0;->gf(La0/h7;ZZ)V
...
.method public static synthetic ba(Lcom/android/camera/module/pano/PanoramaModule;ZLy7/o2;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$onStopShooting$6(ZLy7/o2;)V
...
.method private createEngine(D)Z
    ...
    invoke-static {v3}, Lcom/android/camera/data/data/f0;->K(Landroid/content/Context;)Z
    ...
    const-wide v6, 0x3fe40c49ba5e353fL    # 0.6265
    ...
    invoke-virtual {v0, v5}, Lcom/android/camera/panorama/SensorFusion;->setRotation(I)I
...
.method private getQuality()I
    ...
    invoke-virtual {p0, v0}, La0/e5;->a(Z)I
...
.method public static synthetic l9(Lcom/android/camera/module/k0;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$addImageAsApplication$9(Lcom/android/camera/module/k0;)V
...
.method private static synthetic lambda$addImageAsApplication$9(Lcom/android/camera/module/k0;)V
    .locals 0
...
.method private static synthetic lambda$launchShootingTask$4(Ljava/lang/Throwable;)V
    ...
    invoke-static {p0, v0}, La0/y3;->d(Ljava/lang/Throwable;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method private static synthetic lambda$onSaveCompleted$8(Ly7/e3;)V
    .locals 0
...
.method private synthetic lambda$onStopShooting$6(ZLy7/o2;)V
    .locals 1
    ...
    invoke-interface {p2, p1}, Ly7/o2;->B2(I)V

    goto :goto_0

    :cond_0
    invoke-interface {p2}, Ly7/o2;->De()V
    ...
    invoke-interface {p2}, Ly7/o2;->hg()V
...
.method private synthetic lambda$startShooting$0(Ly7/o2;)V
    .locals 2
...
.method private static synthetic lambda$stopShooting$5(Ly7/h2;)V
    .locals 3
    ...
    invoke-interface {p0, v0}, Ly7/h2;->pc(Landroid/graphics/Bitmap;)V
...
.method private launchShootingTask()Lio/reactivex/disposables/Disposable;
    ...
    invoke-virtual {v1, v3, v2, v4}, Lio/reactivex/Flowable;->observeOn(Lio/reactivex/Scheduler;ZI)Lio/reactivex/Flowable;
    ...
    invoke-direct {v2, v4, p0, v0}, Lz6/j;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    new-instance p0, Lh2/e;

    invoke-direct {p0, v5}, Lh2/e;-><init>(I)V
...
.method private onSaveCompleted()V
    ...
    invoke-static {v4, v1}, La0/v3;->n(ILjava/util/Optional;)V
    ...
    iget-object v5, p0, Lcom/android/camera/module/BaseModule;->mModuleStateMgr:Lw6/g;

    invoke-interface {v5}, Lw6/g;->isPaused()Z
    ...
    invoke-static {v1, p0}, La0/y3;->j(ILjava/util/Optional;)V
    ...
    invoke-interface {v4}, Lcom/android/camera/module/k0;->Z6()V
...
.method private onStopShooting(Z)V
    ...
    invoke-direct {v1, p0, p1, v2}, La0/d3;-><init>(Ljava/lang/Object;ZI)V
...
.method private savePanoramaFile([Landroid/net/Uri;Ljava/lang/String;II)Z
    ...
    invoke-static {v12, v1}, Lck/f;->q(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private savePanoramaPicture()V
    ...
    invoke-static {v4, v9}, Lo8/y;->e(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-virtual {v1, v0}, Lyg/c;->i(I)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0
...
.method private startBurstRequest(Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex/FlowableEmitter;)V
    ...
    invoke-virtual {v1}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->c2()Z
    ...
    iput-object v3, v1, Lea/x;->a:Landroid/location/Location;
    ...
    invoke-virtual {v1, v2}, Lea/w;->J(I)V
    ...
    invoke-static {v2}, Lz6/o;->a(Lw6/k;)Landroid/util/Size;

    move-result-object v2

    iget-object v1, v1, Lea/w;->a:Lea/x;

    iget-object v4, v1, Lea/x;->H:Landroid/util/Size;
    ...
    iput-object v2, v1, Lea/x;->H:Landroid/util/Size;
    ...
    invoke-virtual {v1, v2}, Lea/w;->A(Z)V
    ...
    iget-boolean v2, v1, Lea/x;->n1:Z

    if-eqz v2, :cond_3

    iput-boolean v3, v1, Lea/x;->n1:Z
    ...
    invoke-virtual {v1, v2}, Lea/w;->U(I)V
    ...
    invoke-virtual {p0, p2, v1, p1}, Lea/a;->h(ILea/a$k;Lo8/k;)V
...
.method private startSaveTask()Lio/reactivex/disposables/Disposable;
    ...
    invoke-direct {v1, p0, v2}, Lg7/p0;-><init>(Ljava/lang/Object;I)V
...
.method public static synthetic x9(Lcom/android/camera/module/pano/PanoramaModule;Ly7/o2;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$startShooting$0(Ly7/o2;)V

    return-void
.end method

.method public static synthetic z9(Ly7/h2;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$stopShooting$5(Ly7/h2;)V
...
.method public stopShooting(ZZ)V
    ...
    invoke-interface {p1}, Lw6/k;->N0()Ljava/lang/Object;
    ...
    invoke-virtual {v0, p2}, Lea/a;->z1(Z)V
