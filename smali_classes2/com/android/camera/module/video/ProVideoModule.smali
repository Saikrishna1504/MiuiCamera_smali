...
# instance fields
.field private mComponentRunningVideoLogLut:Lw0/i1;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/camera/module/video/ProVideoModule;->mComponentRunningVideoLogLut:Lw0/i1;
...
.method public static synthetic P7(Lcom/android/camera/module/video/ProVideoModule;Lcom/android/camera/module/VideoBase$f;Ljava/util/List;)V
    .locals 0
...
.method public static synthetic Q7(La7/b0;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/module/video/ProVideoModule;->lambda$setProVideoLogLut$1(La7/b0;)V
...
.method private importFile(Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Lcom/android/camera/module/video/ProVideoModule;->mComponentRunningVideoLogLut:Lw0/i1;

    invoke-virtual {p0}, Lcom/android/camera/module/j0;->getModuleIndex()I

    move-result v1

    invoke-virtual {v0, v1}, Lw0/i1;->i(I)Ljava/lang/String;
    ...
    invoke-static {v5, v6}, Lcom/android/camera/g6;->S(Ljava/io/FileInputStream;Ljava/io/FileOutputStream;)V
    :try_end_3
    ...
    iget-object v3, p0, Lcom/android/camera/module/video/ProVideoModule;->mComponentRunningVideoLogLut:Lw0/i1;

    iget v5, p0, Lcom/android/camera/module/j0;->mModuleIndex:I

    invoke-virtual {v3, v0, v5}, Lw0/i1;->e(Lcom/android/camera2/compat/theme/custom/mm/beauty/VideoLogLutWorkspaceItem;I)Z
    ...
    iget-object p1, p0, Lcom/android/camera/module/video/ProVideoModule;->mComponentRunningVideoLogLut:Lw0/i1;

    invoke-virtual {p1, v0}, Lw0/i1;->d(Lcom/android/camera2/compat/theme/custom/mm/beauty/VideoLogLutWorkspaceItem;)Z
...
.method private static synthetic lambda$setProVideoLogLut$1(La7/b0;)V
    .locals 1

    const/4 v0, 0x2

    invoke-interface {p0, v0}, La7/b0;->c0(I)V

    return-void
.end method

.method private setLogLut(Lw0/i1;)V
    .locals 4

    invoke-virtual {p1}, Lw0/i1;->g()I

    move-result v0

    iget v1, p0, Lcom/android/camera/module/j0;->mModuleIndex:I

    invoke-virtual {p1, v1}, Lw0/i1;->h(I)Lcom/android/camera2/compat/theme/custom/mm/beauty/VideoLogLutWorkSpace;
...
.method private setProVideoLogLut(I)V
    ...
    iget-object p0, p0, Lcom/android/camera/module/video/ProVideoModule;->mComponentRunningVideoLogLut:Lw0/i1;

    invoke-virtual {p0, p1}, Lw0/i1;->q(I)V
...
.method private trackLogLutClick(Ljava/lang/String;)V
    ...
    invoke-static {p1, p0}, Lq7/a;->a2(Ljava/lang/String;Ljava/util/Map;)V
...
.method public dealProVideoLutResult(Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, p1}, Lw0/i1;->p(Z)V
...
.method public onCreate(II)V
    ...
    invoke-static {p1, p0}, Lcom/android/camera/e3;->f0(ILcom/android/camera2/f;)[F
    ...
    invoke-direct {v0, v1, p0}, Lmj/j;-><init>(FF)V

    invoke-interface {p2, p1, v0}, Lcom/android/camera/ui/h1;->A(Lkj/e;Lmj/d;)V
    ...
    invoke-interface {p2, p0}, Lcom/android/camera/ui/h1;->e(Lkj/e;)V
    ...
    invoke-interface {p2, p0}, Lcom/android/camera/ui/h1;->i(Lkj/e;)Lrj/s;
...
.method public onDestroy()V
    ...
    invoke-interface {v0, p0}, Lcom/android/camera/ui/h1;->z(Lkj/e;)V
...
.method public onGLAndCameraReady(II)V
    ...
    invoke-virtual {p2}, Lw0/k1;->o0()Lw0/i1;

    move-result-object p2

    invoke-virtual {p2, p1}, Lw0/i1;->isSwitchOn(I)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-direct {p0, p2}, Lcom/android/camera/module/video/ProVideoModule;->setLogLut(Lw0/i1;)V
...
.method public updateFilter()V
    ...
    invoke-virtual {v0, v1}, Lw0/i1;->isSwitchOn(I)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-direct {p0, v0}, Lcom/android/camera/module/video/ProVideoModule;->setLogLut(Lw0/i1;)V
