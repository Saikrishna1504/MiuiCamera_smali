...
# direct methods
.method public constructor <init>(Lcom/android/camera/module/video/SlowMotionModule;Lcom/android/camera/module/j0;)V
    .locals 0
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/camera/module/VideoModule$k;-><init>(Lcom/android/camera/module/VideoModule;Lcom/android/camera/module/j0;)V
...
# virtual methods
.method public final B6(Landroid/util/Range;)V
    .locals 0
    ...
    invoke-super {p0, p1}, Lcom/android/camera/module/VideoModule$k;->B6(Landroid/util/Range;)V
...
.method public final M2()V
    ...
    invoke-super {p0}, Lcom/android/camera/module/VideoModule$k;->M2()V
...
.method public final T5(FFI)Z
    ...
    iget v3, v1, Ld1/n0;->a:I

    const/4 v4, 0x3

    if-gt v3, v4, :cond_2

    invoke-super {p0, p1, p2, p3}, Lcom/android/camera/module/VideoModule$k;->T5(FFI)Z
    ...
    invoke-virtual {v1, p3}, Ld1/n0;->j(Ljava/lang/String;)Z

    move-result p3

    const-string/jumbo v3, "tele"

    invoke-virtual {v1, v3}, Ld1/n0;->j(Ljava/lang/String;)Z

    move-result v3

    const-string/jumbo v4, "ultra_tele"

    invoke-virtual {v1, v4}, Ld1/n0;->j(Ljava/lang/String;)Z
    ...
    iget-object v6, p0, Lca/i;->c:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {p0, v2}, Lca/i;->L6(Lcom/android/camera/module/j0;Z)V
