...
.field public u:Lcom/android/camera/fragment/beauty/q;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/camera/module/video/y;->b:I

    const-string v0, "normal"

    iput-object v0, p0, Lcom/android/camera/module/video/y;->e:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/camera/module/video/y;->g:Landroid/util/Range;

    iput v1, p0, Lcom/android/camera/module/video/y;->k:I

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Lcom/android/camera/module/video/y;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/android/camera/module/video/y;->q:J

    iput-wide v0, p0, Lcom/android/camera/module/video/y;->v:J

    iput-wide v0, p0, Lcom/android/camera/module/video/y;->w:J
...
.method public final a()V
    ...
    iget-object v0, p0, Lcom/android/camera/module/video/y;->r:Ljava/lang/String;

    if-eqz v0, :cond_1

    new-instance v0, Ljava/io/File;

    iget-object v1, p0, Lcom/android/camera/module/video/y;->r:Ljava/lang/String;
    ...
    iput-object v2, p0, Lcom/android/camera/module/video/y;->r:Ljava/lang/String;
...
.method public final b()V
    ...
    iget-object p0, p0, Lcom/android/camera/module/video/y;->r:Ljava/lang/String;
...
.method public final c()V
    ...
    iget-object v0, p0, Lcom/android/camera/module/video/y;->i:Ls8/a;
    ...
    :cond_0
    :try_start_0
    invoke-virtual {v0}, Ls8/a;->f()Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/android/camera/module/video/a0;->d(Ljava/lang/String;)V
    :try_end_0
...
.method public final d()I
    ...
    iget-object p0, p0, Lcom/android/camera/module/video/y;->j:Landroid/media/CamcorderProfile;
...
.method public final e(IJ)J
    ...
    iget-wide v5, p0, Lcom/android/camera/module/video/y;->s:J
...
.method public final f(I)V
    ...
    iput p1, p0, Lcom/android/camera/module/video/y;->t:I
    ...
    iget p0, p0, Lcom/android/camera/module/video/y;->t:I
...
.method public final i()Z
    ...
    iget v0, p0, Lcom/android/camera/module/video/y;->b:I
...
.method public final l(Lea/c;ILw6/k;)Z
    .locals 4
    ...
    :cond_0
    invoke-static {p2}, Lcom/android/camera/data/data/f0;->J(I)Z
    ...
    invoke-static {p2, p0}, Lcom/android/camera/data/data/j;->k0(ILcom/android/camera/fragment/beauty/q;)Z
    ...
    invoke-virtual {p1, p2, p0}, Lh1/h1;->D(IZ)Z
...
.method public final m(IILck/c;I)V
    .locals 16
    ...
    :goto_0
    iget-object v9, v3, Lck/c;->a:Landroid/content/Intent;

    invoke-static {v9}, Lck/c;->f(Landroid/content/Intent;)I
    ...
    invoke-virtual {v9, v12}, Ldh/b;->v(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v9

    check-cast v9, Ld1/u0;

    invoke-virtual {v9, v2, v8, v6}, Ld1/u0;->n(ILjava/lang/String;Z)Ljava/lang/String;
    ...
    const-string v10, "pref_video_speed_fast_key"
    ...
    :goto_2
    iput-object v9, v0, Lcom/android/camera/module/video/y;->e:Ljava/lang/String;
    ...
    iput-object v13, v0, Lcom/android/camera/module/video/y;->h:Ljava/lang/String;
    ...
    iput-object v13, v0, Lcom/android/camera/module/video/y;->e:Ljava/lang/String;

    :goto_3
    iput v6, v0, Lcom/android/camera/module/video/y;->k:I

    iput-boolean v6, v0, Lcom/android/camera/module/video/y;->d:Z

    iget-object v6, v0, Lcom/android/camera/module/video/y;->e:Ljava/lang/String;
    ...
    iput v7, v0, Lcom/android/camera/module/video/y;->b:I

    sget-object v6, Lcom/android/camera/module/video/z;->c:Landroid/util/Size;

    invoke-static {}, La1/a;->a()Ld1/o2;

    move-result-object v7

    const-class v8, Ld1/o0;
    ...
    invoke-virtual {v7, v4}, Ld1/o0;->getComponentValue(I)Ljava/lang/String;
    ...
    sget-object v6, Lcom/android/camera/module/video/z;->b:Landroid/util/Size;

    iput v8, v0, Lcom/android/camera/module/video/y;->b:I

    :cond_8
    if-ne v8, v10, :cond_9

    sget-object v6, Lcom/android/camera/module/video/z;->d:Landroid/util/Size;
    ...
    check-cast v7, Ld1/n0;

    invoke-virtual {v7, v4}, Ld1/n0;->getComponentValue(I)Ljava/lang/String;

    move-result-object v7

    iput-object v7, v0, Lcom/android/camera/module/video/y;->h:Ljava/lang/String;
    ...
    iget-object v7, v0, Lcom/android/camera/module/video/y;->h:Ljava/lang/String;
    ...
    invoke-virtual {v0, v6, v7}, Lcom/android/camera/module/video/y;->n(Landroid/util/Size;I)V
    ...
    :cond_10
    :goto_6
    invoke-virtual {v0, v6, v15}, Lcom/android/camera/module/video/y;->n(Landroid/util/Size;I)V
    ...
    invoke-virtual {v6}, Luc/b;->M0()Z

    move-result v7

    if-nez v7, :cond_15

    invoke-virtual {v6}, Luc/b;->N0()Z
    ...
    invoke-virtual {v6, v9, v7}, Ldh/a;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-class v9, Lh1/n0;

    invoke-virtual {v7, v9}, Ldh/b;->v(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v7

    check-cast v7, Lh1/n0;

    const/16 v9, 0xa0

    invoke-virtual {v7, v9}, Lh1/n0;->getDefaultValue(I)Ljava/lang/String;
    ...
    :goto_9
    iget v6, v0, Lcom/android/camera/module/video/y;->k:I
    ...
    invoke-virtual {v6}, Ldh/a;->f()Ldh/a;

    const-string v7, "pref_video_speed_key"

    invoke-virtual {v6, v7, v11}, Ldh/a;->q(Ljava/lang/String;Ljava/lang/String;)Ldh/a;

    invoke-virtual {v6}, Ldh/a;->b()V

    iput-object v11, v0, Lcom/android/camera/module/video/y;->e:Ljava/lang/String;

    :cond_18
    rem-int/lit16 v6, v8, 0x3e8

    iput v6, v0, Lcom/android/camera/module/video/y;->b:I

    :cond_19
    :goto_b
    if-eq v2, v4, :cond_1a

    invoke-virtual/range {p0 .. p1}, Lcom/android/camera/module/video/y;->g(I)Z
    ...
    invoke-virtual {v6, v1}, Li7/e;->X(I)Z
    ...
    invoke-virtual {v7, v6}, Li7/e;->X(I)Z
    ...
    invoke-virtual {v7, v6}, Li7/e;->N(I)Lea/c;
    ...
    :goto_c
    iput-object v6, v0, Lcom/android/camera/module/video/y;->j:Landroid/media/CamcorderProfile;
    ...
    iget-object v6, v0, Lcom/android/camera/module/video/y;->j:Landroid/media/CamcorderProfile;
    ...
    sget v7, Lcom/android/camera/module/video/z$b;->a:I
    ...
    iput v6, v0, Lcom/android/camera/module/video/y;->p:I
    ...
    invoke-static/range {p1 .. p1}, Lcom/android/camera/module/video/a0;->i(I)I
    ...
    :cond_22
    iget-object v9, v0, Lcom/android/camera/module/video/y;->j:Landroid/media/CamcorderProfile;
    ...
    iget-object v6, v0, Lcom/android/camera/module/video/y;->g:Landroid/util/Range;
    ...
    iput v6, v0, Lcom/android/camera/module/video/y;->f:I

    goto :goto_10

    :cond_23
    sget v6, Lcom/android/camera/module/l0;->a:I
    ...
    iget-object v4, v0, Lcom/android/camera/module/video/y;->g:Landroid/util/Range;
    ...
    iput v4, v0, Lcom/android/camera/module/video/y;->x:I
    ...
    invoke-virtual {v4, v12}, Ldh/b;->v(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-virtual {v4, v2}, Ld1/v0;->getComponentValue(I)Ljava/lang/String;
    ...
    :goto_12
    iget-object v4, v0, Lcom/android/camera/module/video/y;->h:Ljava/lang/String;
    ...
    iput v8, v0, Lcom/android/camera/module/video/y;->a:I

    iget-object v8, v0, Lcom/android/camera/module/video/y;->h:Ljava/lang/String;
    ...
    :cond_28
    iget-object v4, v3, Lck/c;->a:Landroid/content/Intent;
    ...
    iget-object v2, v3, Lck/c;->a:Landroid/content/Intent;
    ...
    iput v2, v0, Lcom/android/camera/module/video/y;->a:I

    goto/16 :goto_1c

    :cond_2b
    iget v3, v0, Lcom/android/camera/module/video/y;->b:I
    ...
    invoke-static {v3}, Lea/d;->k0(Lea/c;)I
    ...
    invoke-virtual {v6}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->f3()Z
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/module/video/y;->j()Z

    move-result v6

    if-eqz v6, :cond_2d

    iput v7, v0, Lcom/android/camera/module/video/y;->a:I
    ...
    invoke-static {v3}, Lea/d;->i(Lea/c;)I

    move-result v2

    invoke-virtual {v0, v2}, Lcom/android/camera/module/video/y;->g(I)Z
    ...
    invoke-virtual {v2}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->e3()Z
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/module/video/y;->i()Z

    move-result v2

    if-eqz v2, :cond_37

    iput v6, v0, Lcom/android/camera/module/video/y;->a:I
    ...
    invoke-virtual {v0, v2}, Lcom/android/camera/module/video/y;->h(I)Z
    ...
    :cond_3a
    :goto_1c
    iget v2, v0, Lcom/android/camera/module/video/y;->a:I
    ...
    iput v3, v0, Lcom/android/camera/module/video/y;->a:I
    ...
    invoke-virtual {v3}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->X0()I
    ...
    invoke-virtual {v2}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->C6()I

    move-result v4

    mul-int/lit16 v4, v4, 0x3e8

    invoke-virtual {v2}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->A6()I
    ...
    invoke-virtual {v2}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->B6()I
    ...
    :cond_40
    :goto_1f
    iget-object v2, v0, Lcom/android/camera/module/video/y;->j:Landroid/media/CamcorderProfile;
    ...
    invoke-virtual {v4, v1}, Li7/e;->N(I)Lea/c;
    ...
    :cond_41
    invoke-static {v1}, Lea/d;->g0(Lea/c;)Ljava/util/List;
    ...
    invoke-static {v1, v6, v7, v3, v2}, Lz6/o;->f(Ljava/util/List;DII)Landroid/util/Size;

    move-result-object v1

    iput-object v1, v0, Lcom/android/camera/module/video/y;->c:Landroid/util/Size;
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera/module/video/y;->f(I)V
...
.method public final n(Landroid/util/Size;I)V
    ...
    invoke-virtual {v1, p1}, Lea/c;->X(Landroid/util/Size;)[Landroid/util/Range;
    ...
    :cond_2
    iput-object v2, p0, Lcom/android/camera/module/video/y;->g:Landroid/util/Range;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {p0, p1}, La0/k0;->a(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
