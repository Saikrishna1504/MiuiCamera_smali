...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v0, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->w:I

    iput p2, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->x:I

    new-instance p2, Landroid/graphics/Point;

    invoke-direct {p2}, Landroid/graphics/Point;-><init>()V

    iput-object p2, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->V:Landroid/graphics/Point;
    ...
    iput p1, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->y:I

    new-instance p1, Lh9/a;

    invoke-direct {p1}, Lh9/a;-><init>()V

    iput-object p1, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->b0:Lh9/a;
...
.method private getBorderCompensate()I
    ...
    iget-object v0, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->p:Ld9/h0;
...
.method public static o(I)Z
    ...
    invoke-static {p0}, Lcom/android/camera/data/data/x;->g0(I)Z
...
.method public final b(Landroid/view/MotionEvent;Z)Z
    ...
    iget v10, v0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->t:I
    ...
    :cond_5
    iget-object v1, v0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->p:Ld9/h0;

    if-eqz v1, :cond_7

    iget-object v1, v1, Ld9/h0;->f0:Landroid/animation/ValueAnimator;
    ...
    invoke-virtual {v1, v12, v13}, Ld9/h0;->D(J)V
    ...
    iget-object v1, v1, Ld9/b;->f:Ld9/q;
    ...
    iget v5, v0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->u:I
    ...
    :cond_19
    iget-object v5, v0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->p:Ld9/h0;

    if-eqz v5, :cond_1a

    invoke-virtual {v5, v12, v13}, Ld9/h0;->D(J)V
    ...
    invoke-virtual {v5, v4, v4}, Ld9/h0;->C(ZZ)V

    const-wide/16 v4, 0xbb8

    invoke-virtual {v14, v3, v4, v5}, Landroid/os/Handler;->sendEmptyMessageDelayed(IJ)Z

    invoke-virtual {v0, v3}, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->k(Z)V

    iget-object v4, v0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->e:Lcom/android/camera/ui/d1;

    if-eqz v4, :cond_1b

    invoke-interface {v4}, Lcom/android/camera/ui/d1;->onSnapCancelOut()V

    :cond_1b
    const-string v4, "attr_suspend_shutter_out"

    const-string/jumbo v5, "slide"

    if-eqz v1, :cond_1c

    iget v6, v0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->d:I
    ...
    invoke-static {v4, v5, v1}, Ltj/a;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v2, v1}, La0/z3;->l(ILjava/util/Optional;)Ljava/util/Optional;
    ...
    iget-object v1, v0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->b0:Lh9/a;

    iget v2, v1, Lh9/a;->e:F
    ...
    iput v4, v0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->x:I
    ...
    iput v1, v0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->x:I
    ...
    iget-object v5, v1, Ld9/h0;->g0:Landroid/animation/ValueAnimator;
    ...
    iput-object v5, v1, Ld9/h0;->g0:Landroid/animation/ValueAnimator;

    :cond_29
    iget-boolean v5, v1, Ld9/h0;->l0:Z

    const v6, 0x3f733333    # 0.95f

    if-eqz v5, :cond_2b

    iget-object v5, v1, Ld9/b;->d:Ld9/x;

    iput-boolean v4, v5, Ld9/x;->g0:Z

    iget-boolean v9, v5, Ld9/x;->R:Z

    if-eqz v9, :cond_2a

    const v9, 0x3e4c49ba    # 0.1995f

    invoke-virtual {v5, v9}, Ld9/x;->m(F)La9/d;

    goto :goto_e

    :cond_2a
    iget v9, v5, La9/d;->g:F
    ...
    iget v9, v5, Ld9/x;->Y:F

    mul-float/2addr v9, v6

    invoke-virtual {v5, v9}, Ld9/x;->t(F)V

    goto :goto_f

    :cond_2b
    iget-object v5, v1, Ld9/b;->c:Ld9/s;

    iget v9, v5, La9/d;->g:F

    mul-float/2addr v9, v6

    invoke-virtual {v5, v9}, La9/d;->m(F)La9/d;

    iget-object v5, v1, Ld9/b;->f:Ld9/q;

    iget v9, v5, La9/d;->o:I
    ...
    iput-object v2, v1, Ld9/h0;->f0:Landroid/animation/ValueAnimator;

    iget-boolean v5, v1, Ld9/h0;->h0:Z
    ...
    iget-object v2, v1, Ld9/h0;->f0:Landroid/animation/ValueAnimator;

    new-instance v5, Ld9/f0;

    invoke-direct {v5, v1}, Ld9/f0;-><init>(Ld9/h0;)V
...
.method public final c(IZ)V
    ...
    iget-object p1, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->b0:Lh9/a;
    ...
    invoke-static {v3}, Lbq/t;->s(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {v3, v6}, Lhp/s;->f0(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    iput v3, p1, Lh9/a;->e:F

    aget v3, v5, p2

    iput v3, p1, Lh9/a;->f:F
    ...
    :cond_e
    iget-object p1, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->p:Ld9/h0;

    iget-object p1, p1, Ld9/b;->f:Ld9/q;

    iget p1, p1, La9/d;->o:I
...
.method public final f(II)Z
    ...
    invoke-static {p1, p2, v0, v2}, Lcd/b;->f(FFFF)F

    move-result p1

    float-to-int p1, p1

    iget p2, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->y:I
...
.method public final g(II)V
    ...
    iget-object v2, v0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->p:Ld9/h0;

    invoke-virtual {v2}, Ld9/h0;->h()V

    iget-object v2, v0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->l:Lh9/b;
    ...
    iget-object v7, v2, Lcom/android/camera/ui/CameraSnapView;->d:Ld9/b;
    ...
    invoke-virtual/range {v7 .. v14}, Ld9/b;->s(ZFFFZZZ)V
    ...
    :cond_1
    iget-object v3, v0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->p:Ld9/h0;

    invoke-virtual {v3}, Ld9/h0;->q()V
    ...
    :cond_6
    iget-object v10, v0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->p:Ld9/h0;

    invoke-virtual {v10, v3, v1}, Ld9/h0;->E(FZ)V
    ...
    invoke-direct {v3, p0}, Lh9/d;-><init>(Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;)V
    ...
    iget v3, v0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->w:I
    ...
    invoke-virtual {v2, v1, v3}, Ld9/h0;->E(FZ)V
...
.method public bridge synthetic getSuspendShutterAnimateDrawable()Landroid/graphics/drawable/Drawable;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->getSuspendShutterAnimateDrawable()Ld9/h0;
...
.method public getSuspendShutterAnimateDrawable()Ld9/h0;
    .locals 0
...
.method public final h(II)V
    ...
    :cond_1
    iget-object v2, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->p:Ld9/h0;

    iget-object v2, v2, Ld9/b;->f:Ld9/q;

    iget v2, v2, La9/d;->o:I
...
.method public final i()V
    ...
    invoke-static {v3, v1}, Landroidx/core/app/v;->d(Landroid/graphics/Rect;I)V

    iget-object p0, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->b0:Lh9/a;

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v1, p0, Lh9/a;->c:Landroid/graphics/Rect;

    invoke-virtual {v1, v4}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iget-object v4, p0, Lh9/a;->b:Landroid/graphics/Rect;

    invoke-virtual {v4, v3}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iget-object p0, p0, Lh9/a;->a:Landroid/graphics/Rect;
...
.method public final j()V
    ...
    :goto_0
    iget-object v1, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->b0:Lh9/a;
    ...
    iget-object v4, v1, Lh9/a;->c:Landroid/graphics/Rect;
    ...
    iget v2, v1, Lh9/a;->g:I

    int-to-float v2, v2

    sub-float/2addr v6, v2

    iput v3, v1, Lh9/a;->h:F

    iput v6, v1, Lh9/a;->i:F
    ...
    iget v3, v1, Lh9/a;->g:I

    int-to-float v3, v3

    sub-float/2addr v2, v3

    iput v6, v1, Lh9/a;->h:F

    iput v2, v1, Lh9/a;->i:F
    ...
    :cond_5
    iput v2, v1, Lh9/a;->h:F

    iput v3, v1, Lh9/a;->i:F

    :goto_1
    iget v2, v1, Lh9/a;->h:F
    ...
    iput v2, v1, Lh9/a;->e:F

    iget v2, v1, Lh9/a;->i:F
...
.method public final l()V
    ...
    iget-object v0, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->l:Lh9/b;
    ...
    :cond_2
    iput v1, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->x:I
...
.method public final n(II)V
    ...
    iget-object v1, p1, Lh9/a;->b:Landroid/graphics/Rect;
    ...
    :cond_4
    iget-object p1, p1, Lh9/a;->a:Landroid/graphics/Rect;
    ...
    :cond_9
    invoke-static {v10, p2, p1}, Lh9/a;->c(ILandroid/graphics/Rect;Landroid/graphics/Rect;)V

    goto :goto_1

    :cond_a
    invoke-static {v9, p2, p1}, Lh9/a;->c(ILandroid/graphics/Rect;Landroid/graphics/Rect;)V

    goto :goto_1

    :cond_b
    invoke-static {v8, p2, p1}, Lh9/a;->c(ILandroid/graphics/Rect;Landroid/graphics/Rect;)V

    goto :goto_1

    :cond_c
    invoke-static {v7, p2, p1}, Lh9/a;->c(ILandroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0, p1}, Ld9/h0;->draw(Landroid/graphics/Canvas;)V
...
.method public final onMeasure(II)V
    ...
    iput p1, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->w:I

    iget p1, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->t:I

    iget p2, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->u:I
    ...
    iget-object p2, p0, Ld9/b;->c:Ld9/s;

    invoke-virtual {p2, v1, v2, p1}, La9/d;->g(FFF)V

    iget-object p2, p0, Ld9/b;->d:Ld9/x;

    invoke-virtual {p2, v1, v2, p1}, La9/d;->g(FFF)V

    iget-object p2, p0, Ld9/b;->e:Ld9/z;

    invoke-virtual {p2, v1, v2, p1}, La9/d;->g(FFF)V

    iget-object p2, p0, Ld9/b;->f:Ld9/q;

    invoke-virtual {p2, v1, v2, p1}, La9/d;->g(FFF)V

    iget-object p2, p0, Ld9/h0;->b0:Ld9/s;

    invoke-virtual {p2, v1, v2, p1}, La9/d;->g(FFF)V

    iget-object p2, p0, Ld9/h0;->c0:Ld9/s;

    invoke-virtual {p2, v1, v2, p1}, La9/d;->g(FFF)V

    iget-object p2, p0, Ld9/h0;->d0:Ld9/s;

    invoke-virtual {p2, v1, v2, p1}, La9/d;->g(FFF)V

    iget-object p0, p0, Ld9/h0;->e0:Ld9/d0;

    invoke-virtual {p0, v1, v2, p1}, La9/d;->g(FFF)V
...
.method public final p(II)Z
    ...
    iget v0, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->w:I
    ...
    iget p0, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->w:I
...
.method public final q(II)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->V:Landroid/graphics/Point;
...
.method public final r()V
    ...
    iget-object v2, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->l:Lh9/b;

    check-cast v2, Lcom/android/camera/ui/CameraSnapView;

    iget-object v2, v2, Lcom/android/camera/ui/CameraSnapView;->d:Ld9/b;

    iget-object v2, v2, Ld9/b;->d:Ld9/x;

    iget v2, v2, La9/d;->g:F
    ...
    iget v3, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->t:I
    ...
    iget-object v4, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->l:Lh9/b;
    ...
    iget-object v5, v5, Ld9/b;->c:Ld9/s;

    if-eqz v6, :cond_0

    iget v5, v5, La9/d;->y:F

    goto :goto_0

    :cond_0
    iget v5, v5, La9/d;->z:F
    ...
    invoke-virtual {p0, v2, v0, v1}, Ld9/h0;->p(FII)V
...
.method public setParameters(Lh1/y1;)V
    ...
    iget-object v1, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->p:Ld9/h0;
    ...
    invoke-direct {v0, v1}, Ld9/h0;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->p:Ld9/h0;
    ...
    iput-boolean v1, v0, Ld9/h0;->l0:Z
    ...
    iput-boolean v1, v0, Ld9/h0;->h0:Z

    iget-object p0, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->p:Ld9/h0;

    invoke-virtual {p0, p1}, Ld9/h0;->j(Lh1/y1;)V

    goto :goto_0

    :cond_0
    iput-boolean v0, v1, Ld9/h0;->l0:Z

    invoke-virtual {v1}, Ld9/h0;->o()V

    iget-object v0, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->p:Ld9/h0;

    invoke-virtual {v0, p1}, Ld9/h0;->j(Lh1/y1;)V
...
.method public setSnapAnimateListener(Lh9/b;)V
    .locals 0

    iput-object p1, p0, Lcom/android/camera/ui/suspendshutter/V9SuspendShutterButton;->l:Lh9/b;
