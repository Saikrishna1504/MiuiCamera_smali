...
# interfaces
.implements Lcom/android/camera/ui/p1$e$a;
...
.method public final a(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/ui/p1$b;->e(Landroid/view/MotionEvent;)Z
...
.method public final b()Z
    ...
    invoke-direct {v2, p0, v1}, Lh1/p;-><init>(II)V
...
.method public final c(Landroid/view/MotionEvent;)Z
    ...
    invoke-interface {p0, v0, p1, v1}, Lw6/j;->onSingleTapUp(IIZ)V
...
.method public final d()Z
    ...
    invoke-interface {p0}, Lw6/j;->isReceiveDoubleTap()Z
    ...
    invoke-static {v3, p0}, La0/z3;->l(ILjava/util/Optional;)Ljava/util/Optional;
...
.method public final e(Landroid/view/MotionEvent;)Z
    ...
    new-instance v2, Le7/s0;

    const/4 v3, 0x3

    invoke-direct {v2, v3}, Le7/s0;-><init>(I)V
...
.method public final onDoubleTap(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, v0, Lcom/android/camera/ui/p1;->h:Lcom/android/camera/module/j0;
    ...
    invoke-interface {v1}, Lcom/android/camera/module/j0;->isDoingAction()Z
    ...
    invoke-direct {v3, v1}, Ld8/a;-><init>(I)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/r;->getInvertFlag()I
    ...
    :goto_0
    invoke-virtual {v3, p0}, Lcom/android/camera/effect/r;->setInvertFlag(I)V
    ...
    :cond_3
    iget-object p0, v0, Lcom/android/camera/ui/p1;->h:Lcom/android/camera/module/j0;

    invoke-interface {p0}, Lcom/android/camera/module/j0;->getUserEventMgr()Lw6/j;

    move-result-object p0

    invoke-interface {p0, p1}, Lw6/j;->onDoubleTap(Landroid/view/MotionEvent;)Z
...
.method public final onLongPress(Landroid/view/MotionEvent;)V
    ...
    invoke-interface {p0, v0, p1}, Lw6/j;->onLongPress(FF)V
...
.method public final onScroll(Landroid/view/MotionEvent;Landroid/view/MotionEvent;FF)Z
    ...
    iget-boolean v1, v0, Lcom/android/camera/ui/p1;->j:Z

    const/4 v2, 0x0

    if-nez v1, :cond_17

    iget-boolean v1, v0, Lcom/android/camera/ui/p1;->c:Z
    ...
    iget v1, v0, Lcom/android/camera/ui/p1;->a:I
    ...
    iput p3, v0, Lcom/android/camera/ui/p1;->k:F
    ...
    iget-object p3, v0, Lcom/android/camera/ui/p1;->n:Landroid/view/VelocityTracker;

    if-eqz p3, :cond_7

    invoke-virtual {p3, v4}, Landroid/view/VelocityTracker;->computeCurrentVelocity(I)V

    :cond_7
    const p3, 0x4191745d

    invoke-static {p3}, Lu1/d;->b(F)I
    ...
    iget v5, v0, Lcom/android/camera/ui/p1;->l:F
    ...
    iget v5, v0, Lcom/android/camera/ui/p1;->k:F
    ...
    :cond_8
    invoke-virtual {p0, p2}, Lcom/android/camera/ui/p1$b;->e(Landroid/view/MotionEvent;)Z
    ...
    :cond_9
    iget p2, v0, Lcom/android/camera/ui/p1;->l:F
    ...
    invoke-static {v6, p2}, La0/k0;->e(ILjava/util/Optional;)Ljava/util/Optional;
    ...
    invoke-static {v1, p2, v6}, Lcom/android/camera/log/Log;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    new-instance v7, Lcom/android/camera/ui/s1;

    invoke-direct {v7, p0, p1}, Lcom/android/camera/ui/s1;-><init>(Lcom/android/camera/ui/p1$b;Landroid/view/MotionEvent;)V
    ...
    iput-boolean v4, v0, Lcom/android/camera/ui/p1;->c:Z
    ...
    invoke-direct {p3, v2, p0, p1}, Lcom/android/camera/ui/r1;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    :cond_10
    iget p2, v0, Lcom/android/camera/ui/p1;->k:F
    ...
    invoke-direct {p2, v3}, Le7/x1;-><init>(I)V
    ...
    :cond_14
    iget-object p1, v0, Lcom/android/camera/ui/p1;->n:Landroid/view/VelocityTracker;
    ...
    invoke-direct {p3, p0, v4}, Ll5/a;-><init>(Ljava/lang/Object;I)V
    ...
    iget p1, v0, Lcom/android/camera/ui/p1;->k:F
...
.method public final onSingleTapConfirmed(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/camera/ui/p1$b;->d()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0, p1}, Lcom/android/camera/ui/p1$b;->c(Landroid/view/MotionEvent;)Z
...
.method public final onSingleTapUp(Landroid/view/MotionEvent;)Z
    ...
    invoke-interface {v2}, La8/a;->isShowing()Z
    ...
    invoke-interface {v2, p0, p1}, La8/a;->dismiss(II)Z
