...
.field public final d:Lta/i;

.field public final e:Lta/i;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lta/a;->c:Lcom/android/camera/effect/v;

    new-instance v0, Lta/i;

    invoke-direct {v0}, Lta/i;-><init>()V

    iput-object v0, p0, Lta/a;->d:Lta/i;

    new-instance v0, Lta/i;

    invoke-direct {v0}, Lta/i;-><init>()V

    iput-object v0, p0, Lta/a;->e:Lta/i;

    new-instance v0, Lta/i;

    invoke-direct {v0}, Lta/i;-><init>()V

    iput-object v0, p0, Lta/a;->f:Lta/i;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lta/a;->g:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lta/a;->h:Ljava/util/ArrayList;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lta/a;->k:Z
...
.method public a(Lr2/b;)V
    ...
    iget-object p0, p0, Lta/a;->b:Lcom/android/camera/effect/renders/p;

    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/p;->draw(Lr2/b;)Z
...
.method public final e()V
    ...
    iget-object v0, p0, Lta/a;->d:Lta/i;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lta/a;->d:Lta/i;

    iget v2, v1, Lta/i;->b:I
    ...
    iput v4, v1, Lta/i;->b:I

    iget-object v2, v1, Lta/i;->a:[I
    ...
    iget-object v1, p0, Lta/a;->e:Lta/i;

    monitor-enter v1

    :try_start_1
    iget-object v0, p0, Lta/a;->e:Lta/i;

    iget v2, v0, Lta/i;->b:I

    if-lez v2, :cond_1

    invoke-virtual {v0}, Lta/i;->a()[I
    ...
    iput v4, v0, Lta/i;->b:I

    iget-object v2, v0, Lta/i;->a:[I
    ...
    iget-object v0, p0, Lta/a;->f:Lta/i;

    monitor-enter v0

    :try_start_2
    iget-object v1, p0, Lta/a;->f:Lta/i;
    ...
    iget-object v1, p0, Lta/a;->h:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_3
    iget-object v0, p0, Lta/a;->h:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lta/a;->g:Ljava/util/ArrayList;

    monitor-enter v0

    :goto_4
    :try_start_4
    iget-object v1, p0, Lta/a;->g:Ljava/util/ArrayList;
...
.method public f(II)V
    ...
    :goto_0
    sget-object v1, Lta/p;->a:[J

    if-eqz v0, :cond_1

    iput p1, p0, Lta/a;->i:I

    iput p2, p0, Lta/a;->j:I

    iget-object v0, p0, Lta/a;->b:Lcom/android/camera/effect/renders/p;
