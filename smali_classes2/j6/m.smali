...
.method public static synthetic e(Ljava/util/concurrent/atomic/AtomicInteger;La7/b3;)V
    .locals 0

    invoke-static {p0, p1}, Lj6/m;->j(Ljava/util/concurrent/atomic/AtomicInteger;La7/b3;)V

    return-void
.end method

.method public static synthetic f(Lj6/m;Lnj/b;ILandroid/content/Context;IFLa7/z2;)V
    .locals 0

    invoke-direct/range {p0 .. p6}, Lj6/m;->k(Lnj/b;ILandroid/content/Context;IFLa7/z2;)V

    return-void
.end method

.method public static synthetic j(Ljava/util/concurrent/atomic/AtomicInteger;La7/b3;)V
    .locals 0

    invoke-interface {p1}, La7/b3;->getDeviceDegree()I
...
.method private synthetic k(Lnj/b;ILandroid/content/Context;IFLa7/z2;)V
    .locals 3

    invoke-interface {p6}, La7/z2;->getMishotTopSurface()Landroid/graphics/SurfaceTexture;
    ...
    iget-object v0, p0, Lj6/m;->b:Lnj/e;
    ...
    iput-object v0, p0, Lj6/m;->b:Lnj/e;
    ...
    invoke-direct {v0, p1, p6, v2}, Lnj/e;-><init>(Lnj/b;Landroid/graphics/SurfaceTexture;[I)V
    ...
    :cond_1
    iget-object p1, p0, Lj6/m;->b:Lnj/e;
    ...
    iget-object p0, p0, Lj6/m;->b:Lnj/e;
...
.method public c(ILnj/b;IFLandroid/content/Context;)V
    .locals 9
    ...
    invoke-direct/range {v1 .. v7}, Lj6/j;-><init>(Lj6/m;Lnj/b;ILandroid/content/Context;IF)V
...
.method public g(Lcom/android/camera/ui/h1;)V
    ...
    sget-object v0, Lkj/e;->l:Lkj/e;

    invoke-interface {p1, v0}, Lcom/android/camera/ui/h1;->z(Lkj/e;)V
    ...
    invoke-virtual {p1}, Lnj/d;->a()V

    iget-object p1, p0, Lj6/m;->b:Lnj/e;

    invoke-virtual {p1}, Lnj/e;->i()Z
...
.method public getComputeMode()I
    ...
    invoke-interface {p0}, La7/z2;->getComputeMode()I
...
.method public h(Lcom/android/camera/ui/h1;I)V
    ...
    sget-object p2, Lkj/e;->l:Lkj/e;

    invoke-interface {p1, p2}, Lcom/android/camera/ui/h1;->i(Lkj/e;)Lrj/s;
    ...
    invoke-virtual {v0, p0}, Lrj/e;->j(Lrj/e$a;)V

    :cond_0
    const/4 p0, 0x1

    invoke-interface {p1, p2, p0}, Lcom/android/camera/ui/h1;->B(Lkj/e;Z)V
