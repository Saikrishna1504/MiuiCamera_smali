...
.method public C(Lcom/android/camera2/a;Lcom/android/camera/module/Camera2Module;Lf6/h;)V
    ...
    :goto_0
    invoke-virtual {p2, p3}, Lzd/b;->e(I)V
    ...
    :goto_1
    invoke-virtual {p2, v0}, Lzd/b;->f(I)V
    ...
    :goto_2
    invoke-virtual {p2, v0, v1}, Lzd/b;->i(J)V

    invoke-interface {p1}, Lcom/android/camera2/a$k;->d()Z

    move-result p0

    invoke-virtual {p2, p0}, Lzd/b;->h(Z)V

    invoke-interface {p1}, Lcom/android/camera2/a$k;->c()I

    move-result p0

    invoke-virtual {p2, p0}, Lzd/b;->g(I)V

    invoke-interface {p1, p2}, Lcom/android/camera2/a$k;->b(Lzd/b;)V
