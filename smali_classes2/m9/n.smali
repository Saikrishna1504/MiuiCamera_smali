...
.method public constructor <init>(Landroid/hardware/camera2/CaptureResult;ZILcom/android/camera2/f;)V
    ...
    :cond_0
    invoke-static {p4}, Lcom/android/camera2/g;->G8(Lcom/android/camera2/f;)Z
    ...
    invoke-static {p4, v5}, Lcom/android/camera/e3;->t1(Lcom/android/camera2/f;I)I

    move-result v5

    invoke-static {p4, v5}, Lcom/android/camera2/g;->U4(Lcom/android/camera2/f;I)Z

    move-result v5

    iput-boolean v5, p0, Lm9/n;->q:Z

    invoke-static {p4}, Lcom/android/camera2/g;->n3(Lcom/android/camera2/f;)Z
    ...
    :cond_3
    invoke-static {p4}, Lcom/android/camera2/g;->N4(Lcom/android/camera2/f;)Z
    ...
    :cond_5
    :goto_1
    invoke-static {p4}, Lcom/android/camera2/g;->J6(Lcom/android/camera2/f;)Z

    move-result p3

    if-eqz p3, :cond_6

    invoke-static {p4}, Lcom/android/camera2/g;->H1(Lcom/android/camera2/f;)I
    ...
    sget-object p3, Ll9/cs;->p1:Ll9/ds;

    invoke-static {p1, p3}, Ll9/es;->g(Landroid/hardware/camera2/CaptureResult;Ll9/ds;)Ljava/lang/Object;
    ...
    invoke-static {p4}, Lcom/android/camera2/g;->F2(Lcom/android/camera2/f;)Z

    move-result p3

    if-eqz p3, :cond_8

    sget-object p3, Ll9/cs;->W1:Ll9/ds;

    invoke-static {p1, p3}, Ll9/es;->l(Landroid/hardware/camera2/CaptureResult;Ll9/ds;)Ljava/lang/Object;
    ...
    :cond_8
    sget-object p3, Ll9/cs;->V1:Ll9/ds;
    ...
    :cond_c
    invoke-static {p4}, Lcom/android/camera2/g;->Y5(Lcom/android/camera2/f;)Z

    move-result p2

    if-eqz p2, :cond_e

    sget-object p2, Ll9/cs;->X1:Ll9/ds;

    invoke-static {p1, p2}, Ll9/es;->l(Landroid/hardware/camera2/CaptureResult;Ll9/ds;)Ljava/lang/Object;
...
.method public final n()Z
    ...
    invoke-static {v0, p0}, Lcom/android/camera/e3;->L6(Lcom/android/camera2/f;I)Z
