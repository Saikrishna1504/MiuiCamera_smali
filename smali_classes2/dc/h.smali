...
# direct methods
.method public constructor <init>(Ldc/h;Lpb/c;Lzb/g;Lpb/m;Ljava/lang/Boolean;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final f(Lgb/e;Lpb/b0;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p3, p1, p2}, Ldc/h;->t(Ljava/util/Iterator;Lgb/e;Lpb/b0;)V
...
.method public final o(Lzb/g;)Lcc/h;
    ...
    invoke-direct/range {v0 .. v5}, Ldc/h;-><init>(Ldc/h;Lpb/c;Lzb/g;Lpb/m;Ljava/lang/Boolean;)V
...
.method public final t(Ljava/util/Iterator;Lgb/e;Lpb/b0;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lec/b;->h:Lpb/m;

    if-nez v1, :cond_6

    iget-object v1, p0, Lec/b;->i:Ldc/l;
    ...
    invoke-virtual {v1, v3}, Ldc/l;->c(Ljava/lang/Class;)Lpb/m;

    move-result-object v4

    if-nez v4, :cond_4

    iget-object v4, p0, Lec/b;->c:Lpb/h;
    ...
    invoke-virtual {p0, v1, v3, p3}, Lec/b;->q(Ldc/l;Lpb/h;Lpb/b0;)Lpb/m;
    ...
    :cond_3
    invoke-virtual {p0, v1, v3, p3}, Lec/b;->p(Ldc/l;Ljava/lang/Class;Lpb/b0;)Lpb/m;
    ...
    :cond_5
    invoke-virtual {v4, v2, p2, p3, v0}, Lpb/m;->g(Ljava/lang/Object;Lgb/e;Lpb/b0;Lzb/g;)V
    ...
    invoke-virtual {v1, p2, p3, p0}, Lpb/m;->f(Lgb/e;Lpb/b0;Ljava/lang/Object;)V

    goto :goto_2

    :cond_8
    invoke-virtual {v1, p0, p2, p3, v0}, Lpb/m;->g(Ljava/lang/Object;Lgb/e;Lpb/b0;Lzb/g;)V
