...
# direct methods
.method public constructor <init>(Ldc/f;Lpb/c;Lzb/g;Lpb/m;Ljava/lang/Boolean;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final f(Lgb/e;Lpb/b0;Ljava/lang/Object;)V
    ...
    :cond_1
    invoke-virtual {p0, p3, p1, p2}, Ldc/f;->t(Ljava/util/List;Lgb/e;Lpb/b0;)V
...
.method public final o(Lzb/g;)Lcc/h;
    ...
    invoke-direct/range {v0 .. v5}, Ldc/f;-><init>(Ldc/f;Lpb/c;Lzb/g;Lpb/m;Ljava/lang/Boolean;)V
...
.method public final t(Ljava/util/List;Lgb/e;Lpb/b0;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v3, p2, p3, v4}, Lpb/m;->f(Lgb/e;Lpb/b0;Ljava/lang/Object;)V

    goto :goto_1

    :cond_2
    invoke-virtual {v3, v4, p2, p3, v2}, Lpb/m;->g(Ljava/lang/Object;Lgb/e;Lpb/b0;Lzb/g;)V
    :try_end_0
    ...
    :goto_2
    invoke-static {p3, p0, p1, v1}, Lec/s0;->m(Lpb/b0;Ljava/lang/Exception;Ljava/lang/Object;I)V
    ...
    :cond_4
    iget-object v3, p0, Lec/b;->c:Lpb/h;
    ...
    invoke-virtual {v3}, Lpb/h;->s()Z

    move-result v8

    if-eqz v8, :cond_7

    invoke-virtual {p3, v3, v7}, Lpb/d;->c(Lpb/h;Ljava/lang/Class;)Lpb/h;
    ...
    :cond_b
    :try_start_2
    iget-object v4, p0, Lec/b;->i:Ldc/l;
    ...
    invoke-virtual {v4, v6}, Ldc/l;->c(Ljava/lang/Class;)Lpb/m;
    ...
    invoke-virtual {p3, v3, v6}, Lpb/d;->c(Lpb/h;Ljava/lang/Class;)Lpb/h;

    move-result-object v6

    invoke-virtual {p0, v4, v6, p3}, Lec/b;->q(Ldc/l;Lpb/h;Lpb/b0;)Lpb/m;
    ...
    :cond_d
    invoke-virtual {p0, v4, v6, p3}, Lec/b;->p(Ldc/l;Ljava/lang/Class;Lpb/b0;)Lpb/m;
    ...
    :cond_e
    invoke-virtual {v7, p2, p3, v5}, Lpb/m;->f(Lgb/e;Lpb/b0;Ljava/lang/Object;)V
    :try_end_2
