...
.method public final j(Landroid/hardware/camera2/CaptureResult;Lea/a;Lcom/android/camera/module/j0;Lf7/b;Z)Z
    ...
    :cond_2
    iget-object p5, p0, Lf7/h;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, p1}, Lf7/c;->a(Landroid/hardware/camera2/CaptureResult;)V

    goto :goto_0

    :cond_3
    iget-object p5, p0, Lf7/h;->d:Ljava/util/ArrayList;
    ...
    iget-object v2, v0, Lf7/i;->b:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    iput-object v1, v0, Lf7/i;->a:Ljava/lang/Object;

    goto :goto_1

    :cond_4
    invoke-virtual {p0}, Lf7/h;->t()V
...
.method public final l(Lcom/android/camera/module/j0;Lea/c;)Z
    ...
    iput-object v0, p0, Lf7/h;->c:Ljava/util/ArrayList;

    invoke-virtual {p0}, Lf7/h;->r()V

    invoke-virtual {p0}, Lf7/h;->q()V
    ...
    :cond_0
    iput-boolean v0, p0, Lf7/d;->a:Z

    iget-object p1, p0, Lf7/h;->c:Ljava/util/ArrayList;
    ...
    iget-boolean v2, v1, Lf7/c;->d:Z

    const/4 v3, 0x1

    if-eqz v2, :cond_1

    iput-boolean v3, v1, Lf7/c;->e:Z

    goto :goto_2

    :cond_1
    iget-object v2, v1, Lf7/c;->b:Lra/a0;

    invoke-virtual {v2}, Lra/a0;->c()Ljava/lang/String;
    ...
    :cond_4
    :goto_3
    iput-boolean v3, p0, Lf7/d;->a:Z

    goto :goto_0

    :cond_5
    iget-boolean p0, p0, Lf7/d;->a:Z

    return p0
.end method

.method public final n(Lra/y;)Lf7/c;
    .locals 1

    new-instance v0, Lf7/c;

    invoke-direct {v0, p1}, Lf7/c;-><init>(Lra/a0;)V

    iget-object p0, p0, Lf7/h;->c:Ljava/util/ArrayList;
...
.method public final o(Landroid/hardware/camera2/CaptureResult$Key;)V
    ...
    invoke-direct {v0, p1}, Lf7/c;-><init>(Landroid/hardware/camera2/CaptureResult$Key;)V
...
.method public final p(Lra/a0;)V
    .locals 1
