...
# static fields
.field public static final i:Li7/i$a;
...
.field public g:Li7/i$c;

.field public h:Li7/i$b;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0}, Li7/i$a;-><init>()V

    sput-object v0, Li7/i;->i:Li7/i$a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Li7/i;->d:Lio/reactivex/disposables/CompositeDisposable;

    return-void
.end method

.method public static c()Li7/i;
    .locals 1

    sget-object v0, Li7/i;->i:Li7/i$a;

    invoke-virtual {v0}, Lbk/g;->b()Ljava/lang/Object;
...
.method public final a()V
    ...
    iget-object v1, p0, Li7/i;->e:Lio/reactivex/ObservableEmitter;
    ...
    invoke-direct {v2, v4, v5}, Li7/k;-><init>(ILlh/a$b;)V
    ...
    iput-object v5, p0, Li7/i;->e:Lio/reactivex/ObservableEmitter;
...
.method public final b(Li7/k;)V
    ...
    iget-object v0, p0, Li7/i;->e:Lio/reactivex/ObservableEmitter;
    ...
    iget-object p0, p0, Li7/i;->e:Lio/reactivex/ObservableEmitter;
...
.method public final d(IILio/reactivex/Observer;[Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v1, v0, Li7/e;->a:Li7/b;
    ...
    invoke-static {v0, v1, v2, p1, v3}, La0/k0;->h(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V

    iget v1, p0, Li7/i;->b:I

    const-string v3, ", exclusions: "

    invoke-static {v0, v1, v2, p2, v3}, La0/k0;->h(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    :cond_1
    iget-object v0, p0, Li7/i;->d:Lio/reactivex/disposables/CompositeDisposable;
    ...
    iget-object v2, v2, Llh/c;->a:Landroid/os/Handler;

    const/4 v4, 0x1

    invoke-virtual {v2, v4}, Landroid/os/Handler;->removeMessages(I)V

    invoke-static {p4}, Llh/c;->b([Ljava/lang/String;)V
    ...
    iget-object v2, p0, Li7/i;->e:Lio/reactivex/ObservableEmitter;
    ...
    :cond_2
    iget-object v2, p0, Li7/i;->f:Lio/reactivex/observables/ConnectableObservable;
    ...
    invoke-static {v6, v5}, La0/v;->d(ILjava/util/Optional;)Ljava/util/Optional;
    ...
    iput-object v2, p0, Li7/i;->f:Lio/reactivex/observables/ConnectableObservable;

    invoke-virtual {v2, p3}, Lio/reactivex/Observable;->subscribe(Lio/reactivex/Observer;)V

    iget-object p3, p0, Li7/i;->f:Lio/reactivex/observables/ConnectableObservable;
    ...
    iget-object p2, p0, Li7/i;->c:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p3, Ljava/lang/StringBuilder;

    const-string v5, "dual video openCamera: "
    ...
    invoke-static {v1, p3, v5}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p3}, L䬐䬜䬞䭝䬞䬚䭝䬗䬖䬅䬚䬐䬖䭝䬐䬜䬞䬞䬜䬝䭝䬰䬜䬞䬞䬜䬝;->O1()Z
    ...
    invoke-virtual {v5}, Li7/e;->O()Lea/c;

    move-result-object v5

    if-eqz v5, :cond_8

    iget-object v6, v5, Lea/c;->O:Ljava/lang/Boolean;

    if-nez v6, :cond_7

    sget-object v6, Lra/f;->i1:Lra/e;
    ...
    iput-object v6, v5, Lea/c;->O:Ljava/lang/Boolean;
    ...
    :cond_7
    :goto_4
    iget-object v5, v5, Lea/c;->O:Ljava/lang/Boolean;
    ...
    invoke-direct {p2, p3, p1, v5}, Lpj/a;-><init>(Ljava/lang/String;[Ljava/lang/String;Z)V

    new-instance p3, Li7/g;

    invoke-direct {p3, v1, p1, v5}, Li7/g;-><init>(Ljava/lang/String;[Ljava/lang/String;Z)V
    ...
    invoke-direct {p2, p0, p3}, La0/t0;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {p2, p1, p4, v3}, Lpj/a;-><init>(Ljava/lang/String;[Ljava/lang/String;Z)V

    new-instance p1, Lq6/i;

    invoke-direct {p1, p0, v4}, Lq6/i;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {p1, p2, p3}, Li7/k;-><init>(ILlh/a$b;)V
    ...
    invoke-direct {p1, p0, v2}, Lv4/s;-><init>(Ljava/lang/Object;I)V
...
.method public final e(La0/v2;)V
    .locals 8

    invoke-static {}, Lcom/xiaomi/camera/rx/CameraSchedulers;->assertCameraSetupThread()V

    iput-object p1, p0, Li7/i;->g:Li7/i$c;

    const/4 p1, -0x1

    iput p1, p0, Li7/i;->a:I

    iget-object p1, p0, Li7/i;->d:Lio/reactivex/disposables/CompositeDisposable;

    invoke-virtual {p1}, Lio/reactivex/disposables/CompositeDisposable;->clear()V

    const/4 p1, 0x0

    iput-object p1, p0, Li7/i;->f:Lio/reactivex/observables/ConnectableObservable;

    invoke-static {}, Llh/c;->d()Llh/c;

    move-result-object p1

    iget-object p1, p1, Llh/c;->a:Landroid/os/Handler;
    ...
    invoke-direct {p1}, Lmh/g;-><init>()V

    invoke-static {}, Llh/c;->d()Llh/c;

    move-result-object v1

    iget-object v1, v1, Llh/c;->a:Landroid/os/Handler;
    ...
    invoke-direct {v3, p1, v0}, Lcom/android/camera/module/w0;-><init>(Ljava/lang/Object;I)V
    ...
    :try_start_0
    invoke-virtual {v3}, Lcom/android/camera/module/w0;->call()Ljava/lang/Object;
    ...
    invoke-direct {p1}, Lck/u;-><init>()V

    new-instance v4, Lck/t;

    invoke-direct {v4}, Lck/t;-><init>()V

    new-instance v5, Ljava/util/concurrent/CountDownLatch;

    invoke-direct {v5, v0}, Ljava/util/concurrent/CountDownLatch;-><init>(I)V

    new-instance v6, Lck/s;

    invoke-direct {v6, p1, v3, v4, v5}, Lck/s;-><init>(Lck/u;Lcom/android/camera/module/w0;Lck/t;Ljava/util/concurrent/CountDownLatch;)V
    ...
    invoke-direct {v1, v5, v3}, Ld5/a;-><init>(Ljava/lang/Object;I)V

    move v3, p0

    :goto_0
    :try_start_1
    iget-object v5, v1, Ld5/a;->b:Ljava/lang/Object;
    ...
    :cond_2
    iget-object v0, v4, Lck/t;->a:Ljava/lang/Exception;

    if-nez v0, :cond_3

    iget-object p1, p1, Lck/u;->a:Ljava/lang/Object;
...
.method public final subscribe(Lio/reactivex/ObservableEmitter;)V
    ...
    iput-object p1, p0, Li7/i;->e:Lio/reactivex/ObservableEmitter;
