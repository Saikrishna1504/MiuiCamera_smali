...
.method public static a(Lpa/c$b;Ljava/util/HashMap;Lcom/android/camera/effect/s;Lcom/android/camera/data/data/runing/ComponentRunningTiltValue;)V
    .locals 4
    ...
    iget v2, p2, Lcom/android/camera/effect/s;->d:I
    ...
    iget-object p0, p0, Lpa/c$b;->a:Lpa/c;
    ...
    iget-object p2, p2, Lcom/android/camera/effect/s;->a:Landroid/graphics/RectF;

    invoke-direct {v0, p2}, Landroid/graphics/RectF;-><init>(Landroid/graphics/RectF;)V

    iget p2, p0, Lpa/c;->f:I

    iget v1, p0, Lpa/c;->g:I

    sub-int/2addr p2, v1

    invoke-static {p0, v0, p2}, Lpa/c;->d(Lpa/c;Landroid/graphics/RectF;I)V
    ...
    iget-object v0, p2, Lcom/android/camera/effect/s;->b:Landroid/graphics/PointF;
    ...
    invoke-static {p0, p3, v0}, Lpa/c;->e(Lpa/c;Landroid/graphics/PointF;I)V

    new-instance v0, Landroid/graphics/PointF;

    iget-object v3, p2, Lcom/android/camera/effect/s;->c:Landroid/graphics/PointF;

    invoke-direct {v0, v3}, Landroid/graphics/PointF;-><init>(Landroid/graphics/PointF;)V

    iget v3, p0, Lpa/c;->f:I

    sub-int/2addr v3, v2

    invoke-static {p0, v0, v3}, Lpa/c;->e(Lpa/c;Landroid/graphics/PointF;I)V
    ...
    iget p0, p2, Lcom/android/camera/effect/s;->e:F
