...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    new-instance v0, Le7/s1$a;

    invoke-direct {v0, p0}, Le7/s1$a;-><init>(Le7/s1;)V

    iput-object v0, p0, Le7/s1;->l:Le7/s1$a;

    iput-object p1, p0, Le7/s1;->a:Lcom/android/camera/ActivityBase;

    invoke-virtual {p1}, Landroid/app/Activity;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Le7/s1;->b:Landroid/content/Context;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Le7/s1;->c:Ljava/util/ArrayList;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Le7/s1;->d:Ljava/util/ArrayList;
...
.method public final B4()Z
    ...
    instance-of v0, v0, L㕁㕍㕏㔌㕏㕋㔌㕆㕇㕔㕋㕁㕇㔌㕐㕇㕆㕏㕋㔌㕡㕍㕏㕏㕍㕌㕶㕃㕀㕎㕇㕖;
    ...
    :cond_2
    iget-object v0, p0, Le7/s1;->i:Lcom/android/camera/data/observeable/d;
    ...
    :cond_4
    iget-object v0, p0, Le7/s1;->c:Ljava/util/ArrayList;
    ...
    new-instance v3, Le7/p1;

    invoke-direct {v3, v0}, Le7/p1;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {v3, v4}, Lr5/b;-><init>(I)V
    ...
    invoke-direct {v1, p0, v3}, Lc5/g;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v0, v1}, Lio/reactivex/Observable;->subscribe(Lio/reactivex/functions/Consumer;)Lio/reactivex/disposables/Disposable;

    move-result-object v0

    iput-object v0, p0, Le7/s1;->j:Lio/reactivex/disposables/Disposable;
...
.method public final C(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, Le7/s1;->a1(Ljava/lang/String;)Z
    ...
    :cond_0
    iget-object v0, p0, Le7/s1;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v0, p0, Le7/s1;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {p0}, Le7/s1;->init()V

    const/4 v0, 0x0

    iput-object v0, p0, Le7/s1;->k:Lcom/google/android/play/core/splitinstall/SplitInstallStateUpdatedListener;
    ...
    iget-object p0, p0, Le7/s1;->i:Lcom/android/camera/data/observeable/d;
    ...
    iget-object p0, p0, Le7/s1;->e:Lcom/google/android/play/core/splitinstall/SplitInstallManager;
...
.method public final C0(Ljava/lang/String;ZLandroid/content/Context;ZLjava/lang/Runnable;)Lmiuix/appcompat/app/AlertDialog;
    ...
    invoke-virtual {p0, p1, p5}, Le7/s1;->u(Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0, p2, p4}, Lg1/n;->k(IZ)Ljava/lang/String;
    ...
    new-instance v5, Le7/s1$b;

    invoke-direct {v5, p0, p1, p5}, Le7/s1$b;-><init>(Le7/s1;Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    invoke-static {p1}, Ln8/a;->J(Ljava/lang/String;)V
...
.method public final id(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Le7/s1;->b:Landroid/content/Context;
...
.method public final init()V
    ...
    iget-object v0, p0, Le7/s1;->e:Lcom/google/android/play/core/splitinstall/SplitInstallManager;
    ...
    iget-object v5, p0, Le7/s1;->b:Landroid/content/Context;

    invoke-direct {v4, v5}, Ll7/c;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v4, v5}, Ll7/b;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v4, v5}, Ll7/d;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v4, v5}, Ll7/e;-><init>(Landroid/content/Context;)V
    ...
    iget-object v4, p0, Le7/s1;->b:Landroid/content/Context;
    ...
    invoke-static {v0, v1, v2, v4}, La0/b0;->d(JLjava/lang/StringBuilder;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, Le7/s1;->b:Landroid/content/Context;
    ...
    iput-object v0, p0, Le7/s1;->e:Lcom/google/android/play/core/splitinstall/SplitInstallManager;

    iget-object v1, p0, Le7/s1;->l:Le7/s1$a;
    ...
    iput-object v1, p0, Le7/s1;->i:Lcom/android/camera/data/observeable/d;
    ...
    iget-object v2, p0, Le7/s1;->c:Ljava/util/ArrayList;
...
.method public final l(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Le7/s1;->f:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final m()V
    ...
    :cond_2
    iget-object v1, p0, Le7/s1;->i:Lcom/android/camera/data/observeable/d;
    ...
    invoke-virtual {p0, v0}, Le7/s1;->C(Ljava/lang/String;)Z
...
.method public final u(Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p1}, Le7/s1;->l(Ljava/lang/String;)V
    ...
    invoke-static {p0}, Ln8/a;->J(Ljava/lang/String;)V
...
.method public final unRegisterProtocol()V
    ...
    iput-object v0, p0, Le7/s1;->b:Landroid/content/Context;

    iput-object v0, p0, Le7/s1;->a:Lcom/android/camera/ActivityBase;

    iget-object v1, p0, Le7/s1;->j:Lio/reactivex/disposables/Disposable;
    ...
    invoke-virtual {p0, v1}, Le7/s1;->l(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Le7/s1;->d:Ljava/util/ArrayList;
...
.method public final vd(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, Le7/s1;->c:Ljava/util/ArrayList;
...
.method public final ve(Ljava/lang/String;Landroid/content/Context;ZLjava/lang/Runnable;)Lmiuix/appcompat/app/AlertDialog;
    .locals 16
    ...
    invoke-static {v0, v4}, La0/z;->c(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, v2, Le7/s1;->a:Lcom/android/camera/ActivityBase;

    const-string v1, "activity"

    invoke-static {v0, v1}, Lkotlin/jvm/internal/j;->f(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static {v0, v3}, Lcom/xiaomi/camera/cta/requester/a;->a(Landroidx/fragment/app/FragmentActivity;Lzg/a;)V
    ...
    invoke-static {v6, v0, v1}, La0/l7;->b(Landroid/content/Context;IZ)V
    ...
    invoke-virtual/range {p0 .. p1}, Le7/s1;->z(Ljava/lang/String;)J
    ...
    invoke-static {v10, v4}, Landroid/support/v4/media/a;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/util/HashMap;
    ...
    const-string v9, "attr_feature_install_use_wifi"
    ...
    const-string v9, "key_feature"

    invoke-static {v9, v10}, Ltj/a;->l(Ljava/lang/String;Ljava/util/Map;)V

    const v9, 0x7f140e63

    const v10, 0x7f14056a

    const v11, 0x7f140575
    ...
    invoke-static {v5, v0, v15}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v15, "pref_camera_download_hint_check_on_wifi_checked_key"

    invoke-virtual {v5, v15, v3}, Ldh/a;->g(Ljava/lang/String;Z)Z
    ...
    const v11, 0x7f14056c

    goto :goto_0

    :cond_2
    const v11, 0x7f14056d
    ...
    invoke-virtual {v8, v11, v3}, Landroid/content/res/Resources;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    new-instance v8, Le7/q1;

    move-object/from16 v3, p4

    invoke-direct {v8, v2, v6, v4, v3}, Le7/q1;-><init>(Le7/s1;Landroid/content/Context;Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    new-instance v13, Landroidx/activity/l;

    const/16 v3, 0xd

    invoke-direct {v13, v2, v3}, Landroidx/activity/l;-><init>(Ljava/lang/Object;I)V
    ...
    new-instance v14, Landroidx/activity/m;

    invoke-direct {v14, v2, v3}, Landroidx/activity/m;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static/range {v3 .. v14}, La0/t6;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/Runnable;Ljava/lang/CharSequence;Lml/a;Ljava/lang/String;Ljava/lang/Runnable;Ljava/lang/String;ZLjava/lang/Runnable;)Lmiuix/appcompat/app/AlertDialog;

    move-result-object v0

    iput-object v0, v2, Le7/s1;->m:Lmiuix/appcompat/app/AlertDialog;

    const-string v0, "attr_feature_install_wifi_show"

    invoke-static {v0}, Ln8/a;->J(Ljava/lang/String;)V

    iget-object v0, v2, Le7/s1;->m:Lmiuix/appcompat/app/AlertDialog;
    ...
    invoke-virtual/range {p0 .. p1}, Le7/s1;->C(Ljava/lang/String;)Z
    ...
    invoke-virtual {v5, v8, v3}, Landroid/content/res/Resources;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v5}, Le7/r1;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {v1}, Ln8/a;->J(Ljava/lang/String;)V
...
.method public final z(Ljava/lang/String;)J
    ...
    iget-object v0, p0, Le7/s1;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v0, p0, Le7/s1;->g:Ljava/util/concurrent/ConcurrentHashMap;

    :cond_0
    iget-object v0, p0, Le7/s1;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v0, p0, Le7/s1;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Le7/s1;->b:Landroid/content/Context;
    ...
    iget-object v1, p0, Le7/s1;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Le7/s1;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    iget-object p0, p0, Le7/s1;->g:Ljava/util/concurrent/ConcurrentHashMap;
