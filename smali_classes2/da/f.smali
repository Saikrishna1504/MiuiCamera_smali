...
.field public final synthetic c:Lda/i;
...
.method public constructor <init>(Lda/i;)V
    ...
    iput-object p1, p0, Lda/f;->c:Lda/i;
...
.method public final onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object v4, v0, Lda/f;->c:Lda/i;
    ...
    :cond_0
    iget-object v3, v4, Lda/i;->w:Lda/c;

    iget-boolean v3, v3, Lda/c;->g:Z

    if-eqz v3, :cond_1

    iget v3, v0, Lda/f;->a:I

    sub-int v3, v1, v3

    iget v11, v0, Lda/f;->b:I
    ...
    iget-object v4, v4, Lda/i;->w:Lda/c;
    ...
    iput v3, v4, Lda/c;->a:I

    sget v3, Lda/c;->m:I

    rsub-int/lit8 v10, v3, 0x0

    iget v14, v4, Lda/c;->e:I
    ...
    iput v3, v4, Lda/c;->d:I

    iget v3, v4, Lda/c;->a:I

    int-to-float v3, v3

    iget-object v10, v4, Lda/c;->i:Landroid/view/View;

    invoke-virtual {v10, v3}, Landroid/view/View;->setTranslationX(F)V

    iget v3, v4, Lda/c;->d:I
    ...
    iget v10, v4, Lda/c;->a:I

    int-to-float v10, v10

    aput v10, v3, v13

    iget v10, v4, Lda/c;->d:I

    int-to-float v10, v10

    aput v10, v3, v5

    iget-object v10, v4, Lda/c;->l:Lmiuix/animation/utils/VelocityMonitor;
    ...
    iput v1, v0, Lda/f;->a:I

    iput v2, v0, Lda/f;->b:I
    ...
    :cond_2
    iget-object v0, v4, Lda/i;->w:Lda/c;

    iget-boolean v1, v0, Lda/c;->g:Z

    if-eqz v1, :cond_11

    iput-boolean v13, v0, Lda/c;->g:Z

    iget-object v1, v0, Lda/c;->l:Lmiuix/animation/utils/VelocityMonitor;
    ...
    iget-boolean v3, v0, Lda/c;->k:Z

    if-eqz v3, :cond_3

    invoke-static {v13}, Lgq/c;->i(Z)I
    ...
    :goto_0
    iget v5, v0, Lda/c;->a:I

    iget v11, v0, Lda/c;->b:I
    ...
    iget-object v15, v0, Lda/c;->h:Landroid/util/Size;
    ...
    invoke-static {v14, v11, v5, v3}, La0/z;->a(IIII)I
    ...
    :cond_7
    iget v3, v0, Lda/c;->a:I

    iget v5, v0, Lda/c;->c:I
    ...
    :cond_a
    iget v11, v0, Lda/c;->d:I

    iget v14, v0, Lda/c;->f:I
    ...
    const-string v12, ", destX: "

    invoke-static {v14, v2, v15, v1, v12}, Landroidx/constraintlayout/core/parser/a;->f(Ljava/lang/String;FLjava/lang/String;FLjava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string v2, ", destY: "

    invoke-static {v1, v5, v2, v11}, Landroidx/constraintlayout/core/parser/a;->d(Ljava/lang/StringBuilder;ILjava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {v1}, Ln8/a;->E0(Ljava/lang/String;)V
    ...
    invoke-interface {v9, v12}, Lmiuix/animation/IStateStyle;->setTo([Ljava/lang/Object;)Lmiuix/animation/IStateStyle;
    ...
    invoke-virtual {v5, v14, v12}, Lmiuix/animation/base/AnimConfig;->setEase(I[F)Lmiuix/animation/base/AnimConfig;
    ...
    invoke-direct {v15, v0, v1}, Lda/a;-><init>(Lda/c;Ljava/lang/Boolean;)V
    ...
    invoke-virtual {v6, v14, v8}, Lmiuix/animation/base/AnimConfig;->setEase(I[F)Lmiuix/animation/base/AnimConfig;
    ...
    invoke-direct {v8, v0}, Lda/b;-><init>(Lda/c;)V
    ...
    iget-object v0, v4, Lda/i;->x:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    iget-object v0, v4, Lda/i;->j:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v3, v3, Lda/c;->l:Lmiuix/animation/utils/VelocityMonitor;
