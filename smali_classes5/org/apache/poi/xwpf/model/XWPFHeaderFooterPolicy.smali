...
.method private getWatermarkParagraph(Ljava/lang/String;I)Lorg/apache/poi/xwpf/usermodel/XWPFParagraph;
    ...
    sget-object p1, Lyu/c;->O:Lorg/apache/xmlbeans/SchemaType;
    ...
    invoke-interface {p0}, Lyu/c;->i()Lyu/e;

    move-result-object p0

    const-string p1, "_x0000_t136"

    invoke-interface {p0, p1}, Lyu/e;->setId(Ljava/lang/String;)V

    invoke-interface {p0}, Lyu/e;->f()V

    invoke-interface {p0}, Lyu/e;->a()V

    invoke-interface {p0}, Lyu/e;->k()V

    invoke-interface {p0}, Lyu/e;->l()V

    invoke-interface {p0}, Lyu/e;->d()Lyu/b;
