...
.method public constructor <init>(Lorg/jcodec/containers/mp4/boxes/TrakBox;)V
    ...
    iput v0, p0, Llo/f;->d:I

    iput v0, p0, Llo/f;->e:I

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Llo/f;->f:J
    ...
    iput-object v0, p0, Llo/f;->j:[Lorg/jcodec/containers/mp4/boxes/TimeToSampleBox$a;
    ...
    iput-object v2, p0, Llo/f;->i:Lorg/jcodec/containers/mp4/boxes/SampleSizesBox;
    ...
    iput-object v0, p0, Llo/f;->h:[Lorg/jcodec/containers/mp4/boxes/SampleToChunkBox$a;
    ...
    iput-object p1, p0, Llo/f;->k:Lorg/jcodec/containers/mp4/boxes/SampleDescriptionBox;
...
.method public final a()I
    ...
    iget-object v0, p0, Llo/f;->i:Lorg/jcodec/containers/mp4/boxes/SampleSizesBox;

    invoke-virtual {v0}, Lorg/jcodec/containers/mp4/boxes/SampleSizesBox;->getDefaultSize()I

    move-result v0

    iget-object v1, p0, Llo/f;->k:Lorg/jcodec/containers/mp4/boxes/SampleDescriptionBox;

    invoke-virtual {v1}, Lorg/jcodec/containers/mp4/boxes/NodeBox;->getBoxes()Ljava/util/List;

    move-result-object v1

    iget-object v2, p0, Llo/f;->h:[Lorg/jcodec/containers/mp4/boxes/SampleToChunkBox$a;

    iget p0, p0, Llo/f;->c:I
...
.method public b()Llo/e;
    .locals 14

    iget v0, p0, Llo/f;->a:I

    iget-object v1, p0, Llo/f;->g:[J
    ...
    iget-object v4, p0, Llo/f;->h:[Lorg/jcodec/containers/mp4/boxes/SampleToChunkBox$a;
    ...
    iget v0, p0, Llo/f;->c:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Llo/f;->c:I

    :cond_1
    iget-object v0, p0, Llo/f;->h:[Lorg/jcodec/containers/mp4/boxes/SampleToChunkBox$a;
    ...
    iget-object v3, p0, Llo/f;->j:[Lorg/jcodec/containers/mp4/boxes/TimeToSampleBox$a;

    iget v4, p0, Llo/f;->d:I
    ...
    iget-object v1, p0, Llo/f;->j:[Lorg/jcodec/containers/mp4/boxes/TimeToSampleBox$a;

    iget v3, p0, Llo/f;->d:I
    ...
    iget v5, p0, Llo/f;->e:I

    iget-object v6, p0, Llo/f;->j:[Lorg/jcodec/containers/mp4/boxes/TimeToSampleBox$a;

    iget v7, p0, Llo/f;->d:I
    ...
    iput v4, p0, Llo/f;->e:I

    add-int/lit8 v5, v5, 0x1

    iput v5, p0, Llo/f;->d:I

    :cond_3
    iget-object v5, p0, Llo/f;->j:[Lorg/jcodec/containers/mp4/boxes/TimeToSampleBox$a;

    iget v6, p0, Llo/f;->d:I
    ...
    :goto_1
    iget-object v1, p0, Llo/f;->i:Lorg/jcodec/containers/mp4/boxes/SampleSizesBox;
    ...
    iget v2, p0, Llo/f;->b:I

    add-int v3, v2, v0

    invoke-static {v1, v2, v3}, Lpo/a;->c([III)[I
    ...
    :goto_2
    iget-object v1, p0, Llo/f;->h:[Lorg/jcodec/containers/mp4/boxes/SampleToChunkBox$a;

    iget v2, p0, Llo/f;->c:I
    ...
    iget-object v2, p0, Llo/f;->g:[J

    iget v3, p0, Llo/f;->a:I

    aget-wide v4, v2, v3

    iget-wide v6, p0, Llo/f;->f:J

    move-object v3, v1

    move v8, v0

    invoke-direct/range {v3 .. v13}, Llo/e;-><init>(JJII[II[II)V

    iget-wide v2, p0, Llo/f;->f:J

    invoke-virtual {v1}, Llo/e;->a()I
    ...
    iput-wide v2, p0, Llo/f;->f:J

    iget v2, p0, Llo/f;->b:I

    add-int/2addr v2, v0

    iput v2, p0, Llo/f;->b:I

    iget v0, p0, Llo/f;->a:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Llo/f;->a:I
