...
# direct methods
.method public static final collectRecursively(Lyp/i;Lokio/FileSystem;Lhp/g;Lokio/Path;ZZLkp/d;)Ljava/lang/Object;
    .locals 17
    ...
    invoke-direct {v4, v3}, Lokio/internal/_FileSystemKt$collectRecursively$1;-><init>(Lkp/d;)V

    :goto_0
    iget-object v3, v4, Lokio/internal/_FileSystemKt$collectRecursively$1;->result:Ljava/lang/Object;

    sget-object v5, Llp/a;->a:Llp/a;
    ...
    invoke-static {v3}, Lb/a;->m(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1, v4}, Lyp/i;->a(Ljava/lang/Object;Lkp/d;)V
    ...
    invoke-virtual {v6, v13}, Lhp/g;->contains(Ljava/lang/Object;)Z
    ...
    :cond_9
    invoke-virtual {v6, v13}, Lhp/g;->addLast(Ljava/lang/Object;)V
    ...
    invoke-static/range {p0 .. p6}, Lokio/internal/_FileSystemKt;->collectRecursively(Lyp/i;Lokio/FileSystem;Lhp/g;Lokio/Path;ZZLkp/d;)Ljava/lang/Object;
    ...
    :cond_c
    invoke-virtual {v11}, Lhp/g;->removeLast()Ljava/lang/Object;
    ...
    :goto_7
    invoke-virtual {v6}, Lhp/g;->removeLast()Ljava/lang/Object;
    ...
    invoke-virtual {v12, v1, v4}, Lyp/i;->a(Ljava/lang/Object;Lkp/d;)V
...
.method public static final commonCopy(Lokio/FileSystem;Lokio/Path;Lokio/Path;)V
    ...
    :cond_3
    invoke-static {v0, p1}, Lbq/t;->e(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static final commonCreateDirectories(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-virtual {v0, v1}, Lhp/g;->addFirst(Ljava/lang/Object;)V
...
.method public static final commonDeleteRecursively(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-direct {v0, p0, p1, v1}, Lokio/internal/_FileSystemKt$commonDeleteRecursively$sequence$1;-><init>(Lokio/FileSystem;Lokio/Path;Lkp/d;)V

    new-instance p1, Lyp/h;

    invoke-direct {p1}, Lyp/h;-><init>()V

    invoke-static {p1, p1, v0}, Lbk/e;->h(Ljava/lang/Object;Lkp/d;Lsp/p;)Lkp/d;

    move-result-object v0

    iput-object v0, p1, Lyp/h;->d:Lkp/d;

    :goto_0
    invoke-virtual {p1}, Lyp/h;->hasNext()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p1}, Lyp/h;->next()Ljava/lang/Object;
...
.method public static final commonListRecursively(Lokio/FileSystem;Lokio/Path;Z)Lyp/g;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p0, p2, v1}, Lokio/internal/_FileSystemKt$commonListRecursively$1;-><init>(Lokio/Path;Lokio/FileSystem;ZLkp/d;)V
