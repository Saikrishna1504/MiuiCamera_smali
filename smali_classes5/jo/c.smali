...
.method public static a(Ljava/lang/String;)[B
    ...
    invoke-static {p0}, Lpo/a;->e(Ljava/lang/String;)[B
...
.method public static c(Ljava/nio/channels/ReadableByteChannel;I)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, p1}, Ljo/c;->g(Ljava/nio/channels/ReadableByteChannel;Ljava/nio/ByteBuffer;)I
...
.method public static d(Ljava/io/File;I)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v0, p1}, Ljo/c;->c(Ljava/nio/channels/ReadableByteChannel;I)Ljava/nio/ByteBuffer;

    move-result-object p0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-static {v0}, Ljo/c;->b(Ljava/io/Closeable;)V
...
.method public static h(Ljava/nio/ByteBuffer;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Ljo/c;->i(Ljava/nio/ByteBuffer;Ljava/lang/String;)Ljava/lang/String;
...
.method public static i(Ljava/nio/ByteBuffer;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    invoke-static {v0}, Ljo/c;->p(Ljava/nio/ByteBuffer;)[B

    move-result-object p0

    invoke-static {p0, p1}, Lpo/a;->k([BLjava/lang/String;)Ljava/lang/String;
...
.method public static j(Ljava/nio/ByteBuffer;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Ljo/c;->l(Ljava/nio/ByteBuffer;I)Ljava/lang/String;
...
.method public static k(Ljava/nio/ByteBuffer;I)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Ljo/c;->e(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, p1}, Ljo/c;->e(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;

    move-result-object p0

    invoke-static {p0}, Ljo/c;->p(Ljava/nio/ByteBuffer;)[B

    move-result-object p0

    invoke-static {p0}, Lpo/a;->j([B)Ljava/lang/String;
...
.method public static m(Ljava/io/File;)Ljo/a;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-direct {v0, p0}, Ljo/a;-><init>(Ljava/nio/channels/FileChannel;)V

    return-object v0
.end method

.method public static n(Ljava/io/File;)Ljo/a;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/FileNotFoundException;
...
.method public static r(Ljava/io/File;)Ljo/a;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/FileNotFoundException;
...
.method public static s(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p1, v0}, Ljo/c;->q(Ljava/nio/ByteBuffer;I)[B
...
.method public static t(Ljava/nio/ByteBuffer;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Ljo/c;->a(Ljava/lang/String;)[B
...
.method public static u(Ljava/nio/ByteBuffer;Ljava/lang/String;I)V
    ...
    invoke-static {p0, p2}, Ljo/c;->o(Ljava/nio/ByteBuffer;I)I
