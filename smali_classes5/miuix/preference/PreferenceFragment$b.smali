...
.method public final run()V
    ...
    :cond_2
    iget-object v2, v1, Lvs/i;->l:Lvs/l;

    if-nez v2, :cond_3

    new-instance v2, Lvs/l;

    invoke-direct {v2, v1}, Lvs/l;-><init>(Lvs/i;)V

    iput-object v2, v1, Lvs/i;->l:Lvs/l;

    :cond_3
    iget-object v2, v1, Lvs/i;->m:Lvs/m;

    if-nez v2, :cond_4

    new-instance v2, Lvs/m;

    invoke-direct {v2, v1}, Lvs/m;-><init>(Lvs/i;)V

    iput-object v2, v1, Lvs/i;->m:Lvs/m;
    ...
    iput p0, v1, Lvs/i;->i:I

    iget-object p0, v1, Lvs/i;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object p0, v1, Lvs/i;->f:Landroidx/recyclerview/widget/RecyclerView$ItemAnimator;
    ...
    new-instance v2, Lvs/n;

    invoke-direct {v2, v1, p0}, Lvs/n;-><init>(Lvs/i;I)V
