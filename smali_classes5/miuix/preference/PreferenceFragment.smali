...
.method public final Nd(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    .locals 0
...
.method public final Ua()V
    ...
    sget v3, Lvs/p;->preferenceCardPageBackground:I

    invoke-static {v3, v2}, Las/d;->f(ILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    sget v4, Lvs/p;->preferenceCardPageNoFloatingBackground:I

    invoke-static {v4, v3}, Las/d;->f(ILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0}, Lkr/a;->g(Landroid/content/Context;)Z
...
.method public final getActionBar()Lmiuix/appcompat/app/ActionBar;
    ...
    invoke-virtual {p0}, Lmiuix/appcompat/app/AppCompatActivity;->qi()Lmiuix/appcompat/app/ActionBar;
...
.method public final he(Landroid/view/Menu;)V
    .locals 0
...
.method public final nb(Landroid/content/Context;Lir/b;II)Z
    .locals 11
    ...
    :cond_3
    invoke-virtual {p0, v3}, Lmiuix/preference/PreferenceFragment;->D1(I)Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p0}, Lmiuix/preference/PreferenceFragment;->Ua()V
    ...
    invoke-static {v1}, Lir/b$a;->a(I)Lir/b;

    move-result-object v1

    iput-object v1, p0, Lmiuix/preference/PreferenceFragment;->k:Lir/b;

    if-eqz v1, :cond_3

    iget-boolean v2, p0, Lmiuix/preference/PreferenceFragment;->i:Z

    iput-boolean v2, v1, Lir/b;->a:Z
    ...
    invoke-virtual {p0, p1, v1, v2, v2}, Lmiuix/preference/PreferenceFragment;->nb(Landroid/content/Context;Lir/b;II)Z
    ...
    iget-object v1, p0, Lmiuix/preference/PreferenceFragment;->k:Lir/b;

    iget-boolean v2, v1, Lir/b;->a:Z

    if-eqz v2, :cond_2

    invoke-virtual {v1}, Lir/b;->a()I
    ...
    :goto_0
    invoke-virtual {p0, p1}, Lmiuix/preference/PreferenceFragment;->D1(I)Z
    ...
    iget-object v1, p0, Lmiuix/preference/PreferenceFragment;->e:Lvs/i;

    if-eqz v1, :cond_3

    invoke-virtual {v1, p1}, Lvs/i;->D1(I)Z
    ...
    iget-object v0, p0, Lmiuix/preference/PreferenceFragment;->e:Lvs/i;
    ...
    invoke-virtual {v0, p1}, Lvs/i;->e(Landroid/content/Context;)V

    iget-object p1, p0, Lmiuix/preference/PreferenceFragment;->e:Lvs/i;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v3, p0, Lmiuix/preference/PreferenceFragment;->k:Lir/b;

    if-eqz v3, :cond_0

    iput-boolean v2, v3, Lir/b;->a:Z
    ...
    sget v1, Lvs/p;->preferenceCardStyleEnable:I

    invoke-static {v1, v0, p1}, Las/d;->h(ILandroid/content/Context;I)I
...
.method public final onCreateAdapter(Landroidx/preference/PreferenceScreen;)Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    invoke-direct {v0, p1, v1, v2}, Lvs/i;-><init>(Landroidx/preference/PreferenceGroup;ZI)V

    iput-object v0, p0, Lmiuix/preference/PreferenceFragment;->e:Lvs/i;

    const/4 p1, 0x0

    iput-boolean p1, v0, Lvs/i;->p:Z

    iget v1, p0, Lmiuix/preference/PreferenceFragment;->l:I

    invoke-virtual {v0, v1}, Lvs/i;->D1(I)Z
    ...
    iput p1, v0, Lvs/i;->x:I

    :cond_1
    iget-object p0, p0, Lmiuix/preference/PreferenceFragment;->e:Lvs/i;
...
.method public final onCreateRecyclerView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroidx/recyclerview/widget/RecyclerView;
    ...
    sget p3, Lvs/u;->miuix_preference_recyclerview:I
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-interface {v1}, Lmiuix/appcompat/app/t;->g9()Z
    ...
    invoke-interface {v1}, Lmiuix/appcompat/app/t;->R7()Landroid/content/Context;
    ...
    sget v2, Lvs/p;->windowActionBarOverlay:I

    invoke-static {v0, v2, v1}, Las/d;->c(Landroid/content/Context;IZ)Z
    ...
    invoke-static {v0}, Lir/b$a;->a(I)Lir/b;

    move-result-object v0

    iput-object v0, p0, Lmiuix/preference/PreferenceFragment;->k:Lir/b;

    if-eqz v0, :cond_5

    iget-boolean v2, p0, Lmiuix/preference/PreferenceFragment;->i:Z

    iput-boolean v2, v0, Lir/b;->a:Z
    ...
    iget-object v2, p0, Lmiuix/preference/PreferenceFragment;->k:Lir/b;

    iget-boolean v3, v2, Lir/b;->a:Z

    if-eqz v3, :cond_4

    invoke-virtual {v2}, Lir/b;->a()I
    ...
    iget-object v0, p0, Lmiuix/preference/PreferenceFragment;->k:Lir/b;
    ...
    invoke-virtual {p0, v0, v3, v2, v1}, Lmiuix/preference/PreferenceFragment;->nb(Landroid/content/Context;Lir/b;II)Z
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lmiuix/preference/PreferenceFragment;->Id()Landroid/graphics/Rect;
