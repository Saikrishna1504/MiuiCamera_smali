...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 8
    sget v0, Lvs/p;->stretchablePickerPreferenceStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Lmiuix/preference/StretchablePickerPreference;->n:Lms/a;
    ...
    .line 5
    sget-object v0, Lvs/x;->StretchablePickerPreference:[I
    ...
    .line 6
    sget p2, Lvs/x;->StretchablePickerPreference_show_lunar:I
...
.method public final g(JZ)V
    ...
    iget-object p3, p0, Lmiuix/preference/StretchablePickerPreference;->n:Lms/a;

    const/4 v1, 0x1

    invoke-virtual {p3, v1}, Lms/a;->v(I)I

    move-result v1

    const/4 v2, 0x5

    invoke-virtual {p3, v2}, Lms/a;->v(I)I

    move-result v2

    const/16 v3, 0x9

    invoke-virtual {p3, v3}, Lms/a;->v(I)I
    ...
    invoke-static {v0, v1, p1, p2}, Lms/c;->a(Landroid/content/Context;IJ)Ljava/lang/String;

    move-result-object p1

    const-string p2, " "

    invoke-static {p3, p2, p1}, La0/k0;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, p3, p1, p2}, Lms/c;->a(Landroid/content/Context;IJ)Ljava/lang/String;
...
.method public final onBindViewHolder(Landroidx/preference/PreferenceViewHolder;)V
    ...
    sget v2, Lvs/t;->datetime_picker:I
    ...
    invoke-direct {v4, p0, v3, v2}, Lvs/a0;-><init>(Lmiuix/preference/StretchablePickerPreference;Lmiuix/slidingwidget/widget/SlidingButton;Lmiuix/pickerwidget/widget/DateTimePicker;)V
    ...
    invoke-direct {p1, p0, v2}, Lvs/c0;-><init>(Lmiuix/preference/StretchablePickerPreference;Lmiuix/pickerwidget/widget/DateTimePicker;)V
    ...
    invoke-virtual {p0, v0, v1, p1}, Lmiuix/preference/StretchablePickerPreference;->g(JZ)V

    new-instance p1, Lvs/b0;

    invoke-direct {p1, p0}, Lvs/b0;-><init>(Lmiuix/preference/StretchablePickerPreference;)V
