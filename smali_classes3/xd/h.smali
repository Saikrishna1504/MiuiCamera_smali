...
# direct methods
.method public constructor <init>(Lae/a;Lzd/d;Lzd/c;)V
    .locals 1
    ...
    iput-object p1, p0, Lxd/h;->a:Lae/a;

    iput-object p3, p0, Lxd/h;->b:Lzd/c;

    new-instance p1, Lxd/h$a;

    new-instance p3, Ljava/lang/ref/WeakReference;

    invoke-direct {p3, p2}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    invoke-direct {p1, p3}, Lxd/h$a;-><init>(Ljava/lang/ref/WeakReference;)V

    iput-object p1, p0, Lxd/h;->c:Lxd/h$a;

    iget-object p1, p2, Lzd/d;->c:Ljava/lang/String;

    iput-object p1, p0, Lxd/h;->d:Ljava/lang/String;

    iget-object p1, p2, Lzd/d;->b:Ljava/lang/String;

    iput-object p1, p0, Lxd/h;->e:Ljava/lang/String;

    iget-object p1, p2, Lzd/d;->e:Ljava/util/Locale;

    iput-object p1, p0, Lxd/h;->f:Ljava/util/Locale;

    iget-object p1, p2, Lzd/d;->d:Ljava/lang/String;

    iput-object p1, p0, Lxd/h;->g:Ljava/lang/String;
...
.method public final call()Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v1, p0, Lxd/h;->b:Lzd/c;

    iget-object v2, p0, Lxd/h;->d:Ljava/lang/String;
    ...
    iget-object v3, v1, Lzd/c;->c:Landroid/util/LruCache;
    ...
    iget-object v1, p0, Lxd/h;->a:Lae/a;

    iget-object v2, p0, Lxd/h;->e:Ljava/lang/String;

    invoke-interface {v1, v2}, Lae/a;->a(Ljava/lang/String;)Lru/b;

    move-result-object v1

    invoke-interface {v1}, Lru/b;->execute()Lru/z;

    move-result-object v1

    iget-object v1, v1, Lru/z;->b:Ljava/lang/Object;
    ...
    iget-object v3, p0, Lxd/h;->b:Lzd/c;
    ...
    iget-object v5, v3, Lzd/c;->c:Landroid/util/LruCache;
    ...
    :cond_1
    :goto_1
    iget-object v1, p0, Lxd/h;->f:Ljava/util/Locale;
    ...
    iget-object v3, p0, Lxd/h;->f:Ljava/util/Locale;
    ...
    invoke-static {v1, v3, v2}, Lxd/c;->a(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Ljava/lang/String;
    ...
    sget-object v2, Lwd/a;->c:Landroid/content/Context;
    ...
    iget-object v3, p0, Lxd/h;->d:Ljava/lang/String;
    ...
    iget-object v1, p0, Lxd/h;->g:Ljava/lang/String;

    :cond_4
    iget-object p0, p0, Lxd/h;->c:Lxd/h$a;
