...
.method public constructor <init>(Lqf/e;)V
    ...
    iput-object p1, p0, Lqf/g;->b:Lqf/e;

    iget-object v0, p1, Lqf/e;->b:Lzf/a;
    ...
    :cond_0
    iput-boolean v2, p0, Lqf/g;->a:Z

    new-instance v0, Lrf/a;

    invoke-direct {v0, p1}, Lrf/a;-><init>(Lqf/e;)V

    iput-object v0, p0, Lqf/g;->c:Lrf/a;
...
.method public final a(Lxf/f;)V
    ...
    :cond_0
    iget-object p0, p0, Lqf/g;->b:Lqf/e;

    iget-object p1, p0, Lqf/e;->b:Lzf/a;

    const/4 v0, 0x0

    const-string v1, "connection.keep_alive_type"

    invoke-virtual {p1, v1, v0}, Lzf/a;->c(Ljava/lang/String;I)I
    ...
    iget-object p1, p0, Lqf/e;->i:Lqf/k;
    ...
    iget-object p0, p0, Lqf/e;->f:Lzf/b;

    if-eqz p0, :cond_1

    invoke-virtual {p0}, Lzf/b;->m()V
...
.method public final b(Lxf/f;)V
    ...
    :cond_0
    iget-object p0, p0, Lqf/g;->c:Lrf/a;

    if-eqz p0, :cond_14

    invoke-virtual {p0, v3, v2}, Lrf/a;->a([BZ)V
    ...
    iget-object v1, p1, Lxf/h;->b:Ljava/lang/Object;

    check-cast v1, Lwf/vb;

    iget-object v4, v1, Lwf/vb;->a:Ljk/a;
    ...
    :goto_0
    iget-object v5, p0, Lqf/g;->b:Lqf/e;

    iget-object v5, v5, Lqf/e;->b:Lzf/a;

    const-string v6, "tts.enable_internal_player"

    invoke-virtual {v5, v6, v2}, Lzf/a;->b(Ljava/lang/String;Z)Z
    ...
    iget-object p1, p1, Lxf/h;->a:Lxf/i;
    ...
    :cond_6
    iget-object p1, p0, Lqf/g;->b:Lqf/e;

    iget-object p1, p1, Lqf/e;->d:Lqf/f;

    const/4 v6, 0x0

    if-eqz v5, :cond_7

    iget-object p1, p1, Lqf/f;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_b
    iget-object p1, v1, Lwf/vb;->b:Ljk/a;
    ...
    iget-object v3, p0, Lqf/g;->b:Lqf/e;

    iget-object v3, v3, Lqf/e;->b:Lzf/a;

    const-string v7, "tts.enable_internal_player"

    invoke-virtual {v3, v7, v2}, Lzf/a;->b(Ljava/lang/String;Z)Z
    ...
    :cond_d
    iget-object v3, p0, Lqf/g;->c:Lrf/a;

    if-nez v3, :cond_e

    new-instance v3, Lrf/a;

    iget-object v7, p0, Lqf/g;->b:Lqf/e;

    invoke-direct {v3, v7, p1, v5}, Lrf/a;-><init>(Lqf/e;ILjava/lang/String;)V

    iput-object v3, p0, Lqf/g;->c:Lrf/a;
    ...
    invoke-virtual {v3}, Lrf/a;->f()V

    new-instance p1, Landroid/media/MediaPlayer;

    invoke-direct {p1}, Landroid/media/MediaPlayer;-><init>()V

    iput-object p1, v3, Lrf/a;->l:Landroid/media/MediaPlayer;
    ...
    :try_start_1
    iget-object v0, v3, Lrf/a;->l:Landroid/media/MediaPlayer;
    ...
    iget-object v0, p0, Lqf/g;->c:Lrf/a;
    ...
    iget v1, v0, Lrf/a;->m:I

    if-ne v1, p1, :cond_10

    iget-object p1, v0, Lrf/a;->l:Landroid/media/MediaPlayer;
    ...
    invoke-static {p1, v1}, Lbg/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget v3, v0, Lrf/a;->a:I

    if-ne p1, v3, :cond_13

    iput p1, v0, Lrf/a;->a:I
    ...
    invoke-direct {v0, v3, p1, v5}, Lrf/a;-><init>(Lqf/e;ILjava/lang/String;)V
    ...
    iget-object p1, p0, Lrf/a;->o:Landroid/os/Handler;

    if-eqz p1, :cond_14

    invoke-virtual {p1, v2}, Landroid/os/Handler;->removeMessages(I)V

    iget-object p0, p0, Lrf/a;->o:Landroid/os/Handler;
