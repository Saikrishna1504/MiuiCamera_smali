...
.method public constructor <init>(Lqf/e;)V
    ...
    iput-object v0, p0, Lqf/j;->f:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v0, p0, Lqf/j;->g:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lqf/j;->h:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lqf/j;->i:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v0, p0, Lqf/j;->j:Ljava/util/concurrent/CopyOnWriteArraySet;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lqf/j;->k:J

    const/4 v0, 0x0

    iput-boolean v0, p0, Lqf/j;->l:Z

    iput-object p1, p0, Lqf/j;->c:Lqf/e;

    new-instance v1, Ltf/a;

    invoke-direct {v1, p1}, Ltf/a;-><init>(Lqf/e;)V

    iput-object v1, p0, Lqf/j;->d:Ltf/a;

    new-instance v2, Lqf/j$a;

    invoke-direct {v2, p0}, Lqf/j$a;-><init>(Lqf/j;)V

    new-instance v3, Ltf/c;

    invoke-direct {v3, p1, v1, v2}, Ltf/c;-><init>(Lqf/e;Ltf/a;Lqf/j$a;)V

    iput-object v3, p0, Lqf/j;->e:Ltf/c;
    ...
    iput-object p1, p0, Lqf/j;->a:Landroid/os/HandlerThread;
    ...
    new-instance v1, Lqf/j$b;

    invoke-direct {v1, p0}, Lqf/j$b;-><init>(Lqf/j;)V

    invoke-direct {v0, p1, v1}, Landroid/os/Handler;-><init>(Landroid/os/Looper;Landroid/os/Handler$Callback;)V

    iput-object v0, p0, Lqf/j;->b:Landroid/os/Handler;

    invoke-virtual {p0}, Lqf/j;->c()V
...
.method public final a(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lqf/j;->c:Lqf/e;
    ...
    :cond_0
    iget-object v0, p0, Lqf/j;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {p1, v0}, Lcg/a;->b(Ljava/lang/String;)J
    ...
    invoke-virtual {p1, p0}, Lcg/a;->b(Ljava/lang/String;)J
    ...
    invoke-virtual {p1, v0, v1, p0}, Lcg/a;->e(JLjava/lang/String;)V
    ...
    invoke-virtual {p1, v5, v6, v0}, Lcg/a;->e(JLjava/lang/String;)V

    iget-wide v0, p0, Lqf/j;->k:J
    ...
    iput-wide v3, p0, Lqf/j;->k:J

    iget-boolean v3, p0, Lqf/j;->l:Z
    ...
    :goto_2
    invoke-virtual {p1, v3}, Lcg/a;->b(Ljava/lang/String;)J
    ...
    invoke-virtual {p1, v0, v1, v3}, Lcg/a;->e(JLjava/lang/String;)V

    :cond_7
    iput-boolean v2, p0, Lqf/j;->l:Z
...
.method public final b(Z)V
    ...
    :try_start_0
    iget-object v2, p0, Lqf/j;->c:Lqf/e;
    ...
    iget-object p0, p0, Lqf/j;->b:Landroid/os/Handler;
...
.method public final c()V
    ...
    iget-object v0, v0, Lqf/e;->l:Landroid/content/Context;
...
.method public final d(Lxf/f;)V
    .locals 8

    iget-object v0, p0, Lqf/j;->c:Lqf/e;

    iget-object v1, v0, Lqf/e;->b:Lzf/a;
    ...
    :cond_0
    iget-object v2, p1, Lxf/h;->a:Lxf/i;
    ...
    invoke-static {v2}, Ljk/a;->c(Ljava/lang/Object;)Ljk/a;

    move-result-object v4

    iget-object v5, p0, Lqf/j;->j:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    invoke-direct {v7, p0}, Lcg/a;-><init>(Leb/f;)V
    ...
    iget-object p0, v0, Lqf/e;->l:Landroid/content/Context;
    ...
    invoke-virtual {v7, v6, v0}, Lcg/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v0, p0}, Lcg/a;->c(Ljava/lang/String;I)V
    ...
    invoke-virtual {v7, v0, p0}, Lcg/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v7, p0, v0}, Lcg/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6, v0}, Lbg/a;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2, v3, p1}, Lcg/a;->e(JLjava/lang/String;)V
    ...
    :pswitch_4
    check-cast p1, Lwf/vb;

    const-wide/16 v0, 0x0

    if-eqz p1, :cond_d

    iget-object p1, p1, Lwf/vb;->a:Ljk/a;
    ...
    invoke-virtual {p0, p1}, Lcg/a;->b(Ljava/lang/String;)J
    ...
    invoke-virtual {p0, v0, v1, p1}, Lcg/a;->e(JLjava/lang/String;)V
