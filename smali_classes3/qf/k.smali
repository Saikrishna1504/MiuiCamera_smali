...
.method public constructor <init>(Lqf/e;Landroid/os/Looper;)V
    ...
    iput-object p2, p0, Lqf/k;->f:Ljava/util/LinkedList;

    iput-object p1, p0, Lqf/k;->a:Lqf/e;
    ...
    invoke-virtual {p2, v0, v1}, Lzf/a;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lqf/k;->e:Ljava/lang/String;
    ...
    invoke-direct {v0, p1}, Lcom/xiaomi/ai/android/codec/AudioEncoder;-><init>(Lqf/a;)V

    iput-object v0, p0, Lqf/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    iput-object p1, p0, Lqf/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    :cond_2
    const-string p1, "asr.vad_type"

    invoke-virtual {p2, p1, v2}, Lzf/a;->c(Ljava/lang/String;I)I
    ...
    :goto_1
    iput-boolean v3, p0, Lqf/k;->d:Z

    if-eqz v3, :cond_5

    const-string p1, "asr.enable_new_vad"

    invoke-virtual {p2, p1, v2}, Lzf/a;->b(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p2, v3, v2}, Lzf/a;->c(Ljava/lang/String;I)I

    move-result v3

    const-string v4, "asr.max_length_reset"

    invoke-virtual {p2, v4, v2}, Lzf/a;->c(Ljava/lang/String;I)I

    move-result p2

    invoke-direct {p1, v0, v1, v3, p2}, Lcom/xiaomi/ai/android/vad/Vad2;-><init>(IIII)V

    iput-object p1, p0, Lqf/k;->c:Lvf/a;
    ...
    invoke-static {p1, p0}, Lbg/a;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final a([BZ)V
    ...
    iget-object v0, p0, Lqf/k;->e:Ljava/lang/String;
    ...
    :cond_2
    iget-object v1, p0, Lqf/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    iget-object p0, p0, Lqf/k;->a:Lqf/e;

    iget-object v1, p0, Lqf/e;->f:Lzf/b;
    ...
    iget-object v0, p0, Lqf/e;->p:Lqf/j;

    iget-object p0, p0, Lqf/e;->d:Lqf/f;

    iget-object p0, p0, Lqf/f;->b:Ljava/lang/String;

    invoke-virtual {v0, p0}, Lqf/j;->a(Ljava/lang/String;)V

    invoke-virtual {v1, p1, p2}, Lzf/b;->h(I[B)Z
...
.method public final b()V
    ...
    :try_start_0
    iget-object v1, p0, Lqf/k;->f:Ljava/util/LinkedList;
    ...
    iget-object v0, p0, Lqf/k;->f:Ljava/util/LinkedList;
...
.method public final c()V
    ...
    iget-object p0, p0, Lqf/k;->f:Ljava/util/LinkedList;
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    iget-object v1, p0, Lqf/k;->a:Lqf/e;

    iget-object v2, v1, Lqf/e;->f:Lzf/b;
    ...
    iget-object v6, p0, Lqf/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    iget-object v7, p0, Lqf/k;->c:Lvf/a;
    ...
    :cond_1
    iget-object p1, v1, Lqf/e;->l:Landroid/content/Context;
    ...
    invoke-static {v3, p1}, Lbg/a;->d(Ljava/lang/String;Ljava/lang/String;)V

    const-class p1, Lpf/d;

    invoke-virtual {v1, p1}, Lqf/e;->a(Ljava/lang/Class;)Lpf/b;
    ...
    :cond_3
    iget-object p0, v1, Lqf/e;->e:Lqf/b;
    ...
    invoke-virtual {p0, v1}, Lqf/b;->D(Z)V
    ...
    invoke-virtual {p0, v0, p1}, Lqf/k;->a([BZ)V
    ...
    :cond_7
    iget-object p0, v1, Lqf/e;->p:Lqf/j;

    iget-object p1, v1, Lqf/e;->d:Lqf/f;

    iget-object p1, p1, Lqf/f;->b:Ljava/lang/String;

    invoke-virtual {p0, p1}, Lqf/j;->a(Ljava/lang/String;)V

    invoke-virtual {v2, v0}, Lzf/b;->i([B)Z
    ...
    invoke-interface {v7, v0}, Lvf/a;->a([B)Z
    ...
    new-instance p0, Lwf/lb;

    invoke-direct {p0}, Lwf/lb;-><init>()V

    invoke-static {}, Lxf/a;->b()Ljava/lang/String;

    move-result-object p1

    const-class v0, Lwf/lb;
    ...
    invoke-interface {v0}, Lxf/j;->namespace()Ljava/lang/String;

    move-result-object v4

    invoke-interface {v0}, Lxf/j;->name()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v3, v4, v0}, Lxf/g;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iput-object p1, v3, Lxf/g;->c:Ljava/lang/String;

    invoke-direct {v2, v3, p0}, Lxf/f;-><init>(Lxf/g;Ljava/lang/Object;)V

    iget-object p0, v1, Lqf/e;->d:Lqf/f;
    ...
    iput-object p0, v3, Lxf/g;->d:Ljk/a;

    iget-object p0, v1, Lqf/e;->p:Lqf/j;

    invoke-virtual {p0, v2}, Lqf/j;->d(Lxf/f;)V

    iget-object p0, v1, Lqf/e;->h:Lqf/d;
    ...
    invoke-interface {v7}, Lvf/a;->release()V
    ...
    invoke-interface {v7}, Lvf/a;->init()Z
    ...
    iget-object v6, p0, Lqf/k;->e:Ljava/lang/String;
    ...
    :cond_b
    invoke-virtual {p0, v4, v5}, Lqf/k;->a([BZ)V
    ...
    :cond_d
    iget-object v6, p0, Lqf/j;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v4, v5, v6, p0}, Lcg/a;->e(JLjava/lang/String;)V
    ...
    const-class p0, Lpf/c;

    invoke-virtual {v1, p0}, Lqf/e;->a(Ljava/lang/Class;)Lpf/b;
    ...
    :cond_13
    invoke-virtual {v2, p1}, Lzf/b;->j(Lxf/d;)Z
