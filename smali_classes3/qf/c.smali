...
.method public constructor <init>(Lqf/e;)V
    ...
    iput v0, p0, Lqf/c;->h:I

    new-instance v1, Ljava/security/SecureRandom;

    invoke-direct {v1}, Ljava/security/SecureRandom;-><init>()V

    iput-object v1, p0, Lqf/c;->j:Ljava/security/SecureRandom;

    iput-object p1, p0, Lqf/c;->a:Lqf/e;

    iget-object v1, p1, Lqf/e;->l:Landroid/content/Context;

    iput-object v1, p0, Lqf/c;->b:Landroid/content/Context;

    iget-object v1, p1, Lqf/e;->b:Lzf/a;

    const-string v2, "auth.client_id"

    invoke-virtual {v1, v2}, Lzf/a;->d(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, Lqf/c;->d:Ljava/lang/String;
    ...
    iput-object v2, p0, Lqf/c;->f:Ljava/lang/String;

    iget-object v2, p1, Lqf/e;->o:Lwf/ga;
    ...
    iget-object p1, p1, Lqf/e;->o:Lwf/ga;
    ...
    :goto_0
    iput-object p1, p0, Lqf/c;->e:Ljava/lang/String;
    ...
    iput-object p1, p0, Lqf/c;->g:Lokhttp3/OkHttpClient;

    new-instance p1, Lqf/c$a;

    invoke-direct {p1, p0}, Lqf/c$a;-><init>(Lqf/c;)V

    iput-object p1, p0, Lqf/c;->c:Lqf/c$a;

    return-void
.end method

.method public static b(Lqf/c;J)V
    .locals 5
    ...
    iget-object v0, p0, Lqf/c;->c:Lqf/c$a;
    ...
    :cond_0
    iget-object v2, p0, Lqf/c;->i:Ljava/util/concurrent/ScheduledFuture;
    ...
    sget-object v3, Lyf/b;->a:Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    invoke-static {v2, v3}, Lbg/a;->c(Ljava/lang/String;Ljava/lang/String;)V

    :cond_2
    :goto_0
    :try_start_0
    invoke-static {v0, p1, p2}, Lyf/b;->a(Ljava/lang/Runnable;J)Ljava/util/concurrent/ScheduledFuture;

    move-result-object p1

    iput-object p1, p0, Lqf/c;->i:Ljava/util/concurrent/ScheduledFuture;
    :try_end_0
...
.method public static c(Lqf/c;I)J
    .locals 6

    const-string v0, "cloud_config_last_request_time"

    invoke-virtual {p0, v0}, Lqf/c;->a(Ljava/lang/String;)J
    ...
    invoke-static {p1, v1}, Lbg/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p0, p0, Lqf/c;->b:Landroid/content/Context;

    const-string p1, "aivs_cloud_control"

    invoke-static {p0, p1, v0}, Luf/b;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    :goto_1
    return-wide v4
.end method

.method public static d(Lqf/c;)V
    .locals 6
    ...
    iget-object v2, p0, Lqf/c;->b:Landroid/content/Context;

    const-string v3, "aivs_cloud_control"

    const-string v4, "cloud_config_last_request_time"

    invoke-static {v2, v3, v4, v1}, Luf/b;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "parse error"

    const-string v2, "getCloudConfigFromNet body: "

    iget-object v3, p0, Lqf/c;->a:Lqf/e;
    ...
    invoke-virtual {v3, v5, v4}, Lzf/a;->c(Ljava/lang/String;I)I
    ...
    iget-object v5, p0, Lqf/c;->d:Ljava/lang/String;
    ...
    iget-object v5, p0, Lqf/c;->e:Ljava/lang/String;

    invoke-virtual {v3, v4, v5}, Lokhttp3/HttpUrl$Builder;->addQueryParameter(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;

    const-string v4, "uid"

    iget-object v5, p0, Lqf/c;->f:Ljava/lang/String;
    ...
    :try_start_0
    iget-object v4, p0, Lqf/c;->g:Lokhttp3/OkHttpClient;
    ...
    invoke-static {v1, v4}, Lpb/s;->b(Ljava/lang/Object;Ljava/lang/String;)V

    iget-object v4, v2, Lpb/s;->b:Lfc/n;

    invoke-virtual {v4, v3}, Lfc/n;->k(Ljava/lang/reflect/Type;)Lpb/h;
    ...
    :try_start_1
    iget-object v4, v2, Lpb/s;->a:Lgb/c;

    invoke-virtual {v4, v1}, Lgb/c;->k(Ljava/lang/String;)Lgb/h;

    move-result-object v1

    invoke-virtual {v2, v1, v3}, Lpb/s;->e(Lgb/h;Lpb/h;)Ljava/lang/Object;
    ...
    invoke-static {v1}, Lpb/j;->e(Ljava/io/IOException;)Lpb/j;
    ...
    iget-object p0, p0, Lqf/c;->c:Lqf/c$a;
...
.method public final a(Ljava/lang/String;)J
    ...
    invoke-static {p0, v0, p1}, Luf/b;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, p1, v3}, La0/x3;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p1, p0}, Lbg/a;->c(Ljava/lang/String;Ljava/lang/String;)V
