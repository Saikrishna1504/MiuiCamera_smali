...
# instance fields
.field public final synthetic c:Ldi/f;
...
.method public constructor <init>(Ldi/f;)V
    ...
    iput-object p1, p0, Ldi/f$a;->c:Ldi/f;
...
.method public final onOutputFormatChanged(Landroid/media/MediaCodec;Landroid/media/MediaFormat;)V
    ...
    iget-object p0, p0, Ldi/f$a;->c:Ldi/f;
    ...
    iget-boolean p1, p0, Ldi/i$c;->a:Z
    ...
    :cond_2
    iget-object p1, p0, Ldi/i$c;->b:Ldi/i;

    iget-object v0, p1, Ldi/i;->k:[I
    ...
    :catch_0
    iput p0, p1, Ldi/i;->c:I

    :goto_0
    iget v0, p1, Ldi/i;->e:I

    new-array v0, v0, [I

    iput-object v0, p1, Ldi/i;->k:[I

    iget v0, p1, Ldi/i;->d:I
    ...
    invoke-static {v1, v0, v2}, La0/a0;->i(Ljava/lang/String;ILjava/lang/String;)V

    iget-object v1, p1, Ldi/i;->h:Landroid/media/MediaMuxer;
    ...
    :goto_1
    iget-object v2, p1, Ldi/i;->k:[I

    array-length v2, v2

    if-ge v1, v2, :cond_6

    iget v2, p1, Ldi/i;->f:I
    ...
    iget-object v3, p1, Ldi/i;->h:Landroid/media/MediaMuxer;
    ...
    :cond_6
    iget-object p2, p1, Ldi/i;->h:Landroid/media/MediaMuxer;

    invoke-virtual {p2}, Landroid/media/MediaMuxer;->start()V

    iget-object p2, p1, Ldi/i;->j:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {p2, p0}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    invoke-virtual {p1}, Ldi/i;->d()V
