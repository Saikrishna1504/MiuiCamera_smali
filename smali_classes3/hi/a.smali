...
.method public static constructor <clinit>()V
    ...
    sput-boolean v0, Lhi/a;->G:Z

    const/4 v0, 0x1

    sput-boolean v0, Lhi/a;->H:Z
...
.method public constructor <init>(Landroid/media/MediaFormat;JJLjava/util/concurrent/LinkedBlockingQueue;)V
    ...
    invoke-direct/range {p0 .. p6}, Lhi/c;-><init>(Landroid/media/MediaFormat;JJLjava/util/concurrent/LinkedBlockingQueue;)V

    const/4 p1, 0x0

    iput-boolean p1, p0, Lhi/a;->E:Z

    const/4 p2, 0x0

    iput-object p2, p0, Lhi/a;->F:Landroid/media/AudioFormat;

    iget-object p2, p0, Lhi/c;->b:Landroid/media/MediaFormat;
    ...
    iput p2, p0, Lhi/a;->z:I

    iget-object p3, p0, Lhi/c;->b:Landroid/media/MediaFormat;
    ...
    iput p3, p0, Lhi/a;->A:I

    iget-object p4, p0, Lhi/c;->b:Landroid/media/MediaFormat;
    ...
    iput v2, p0, Lhi/a;->C:I

    invoke-static {p2, p3}, Lkj/u;->i(II)Z
    ...
    iget-object p3, p0, Lhi/a;->F:Landroid/media/AudioFormat;
    ...
    iget-object p2, p0, Lhi/a;->F:Landroid/media/AudioFormat;

    invoke-virtual {p0, p2}, Lhi/a;->w(Landroid/media/AudioFormat;)V

    iget-object p2, p0, Lhi/c;->b:Landroid/media/MediaFormat;

    const-string p3, "max-input-size"

    iget p4, p0, Lhi/a;->C:I
    ...
    iget-object p3, p0, Lhi/a;->D:Lmj/b;

    iget-object p3, p3, Lmj/b;->a:Landroid/media/AudioRecord;
...
.method public final f()V
    ...
    :try_start_0
    iget-object v1, p0, Lhi/a;->D:Lmj/b;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Lmj/b;->e()V
    :try_end_0
...
.method public final g()V
    ...
    :cond_2
    iget-object v2, p0, Lhi/c;->m:Lhi/c$a;

    invoke-virtual {v2}, Lhi/c$a;->a()V

    iget-boolean v2, p0, Lhi/a;->E:Z
    ...
    :cond_3
    iput-boolean v1, p0, Lhi/c;->r:Z

    iput-boolean v1, p0, Lhi/c;->s:Z

    invoke-virtual {p0}, Lhi/c;->t()V

    :try_start_0
    iget-object v2, p0, Lhi/a;->D:Lmj/b;

    if-nez v2, :cond_4

    iget-object v2, p0, Lhi/a;->F:Landroid/media/AudioFormat;

    invoke-virtual {p0, v2}, Lhi/a;->w(Landroid/media/AudioFormat;)V

    :cond_4
    iget-object v2, p0, Lhi/a;->D:Lmj/b;

    invoke-virtual {v2}, Lmj/b;->f()V
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :try_start_1
    iput-boolean v3, p0, Lhi/c;->r:Z

    const-string v2, "audio/mp4a-latm"

    iget v4, p0, Lhi/a;->z:I

    iget v5, p0, Lhi/a;->A:I
    ...
    iget v5, p0, Lhi/a;->z:I

    iget v6, p0, Lhi/a;->A:I

    invoke-static {v5, v6}, Lkj/u;->a(II)Ljava/nio/ByteBuffer;

    move-result-object v5

    invoke-virtual {v2, v4, v5}, Landroid/media/MediaFormat;->setByteBuffer(Ljava/lang/String;Ljava/nio/ByteBuffer;)V

    iget-object v2, p0, Lhi/c;->l:Landroid/media/MediaFormat;

    const-string v4, "bitrate"

    iget v5, p0, Lhi/a;->y:I
...
.method public final h()V
    ...
    :cond_3
    :try_start_0
    iget-object v0, p0, Lhi/a;->D:Lmj/b;
    ...
    iput-object v0, p0, Lhi/a;->D:Lmj/b;
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v3, p0, Lhi/c;->f:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lhi/c;->f:Ljava/util/ArrayList;
    ...
    check-cast v0, Lhi/c$d;

    :try_start_2
    invoke-virtual {v0}, Lhi/c$d;->c()V
    :try_end_2
...
.method public final onInputBufferAvailable(Landroid/media/MediaCodec;I)V
    ...
    :try_start_0
    iget-object v0, v0, Lmj/a;->a:Ljava/util/concurrent/ArrayBlockingQueue;
    ...
    iget-object v4, v0, Lnj/f;->a:Ljava/nio/ByteBuffer;
    ...
    iget p1, p0, Lhi/a;->B:I

    div-int p1, v7, p1

    iget-wide v8, v0, Lnj/f;->c:J

    iget-boolean p1, p0, Lhi/c;->n:Z
...
.method public final w(Landroid/media/AudioFormat;)V
    ...
    iget v4, p0, Lhi/a;->y:I

    const/4 v5, 0x1

    move-object v1, p1

    invoke-virtual/range {v0 .. v5}, Lmj/b;->d(Landroid/media/AudioFormat;IIII)V

    iget-object p1, p0, Lhi/a;->D:Lmj/b;

    iget-object p1, p1, Lmj/b;->a:Landroid/media/AudioRecord;
    ...
    iput-object v0, p1, Lmj/b;->o:Lmj/b$b;

    :cond_0
    return-void

    :cond_1
    iget-object p0, p0, Lhi/a;->D:Lmj/b;
