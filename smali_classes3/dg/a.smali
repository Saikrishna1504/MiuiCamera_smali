...
.method public constructor <init>(Lzf/b;)V
    ...
    iput-object p1, p0, Ldg/a;->a:Lzf/b;

    new-instance p1, Lokhttp3/OkHttpClient;

    invoke-direct {p1}, Lokhttp3/OkHttpClient;-><init>()V

    iput-object p1, p0, Ldg/a;->d:Lokhttp3/OkHttpClient;
...
.method public static c(Ljava/lang/String;)Ljava/security/PublicKey;
    ...
    invoke-static {v2, p0}, Lyf/a;->a(I[B)[B
...
.method public final a()Ldg/a$b;
    ...
    :try_start_0
    new-instance v3, Ldg/a$b;

    invoke-direct {v3}, Ldg/a$b;-><init>()V

    iget-object v4, p0, Ldg/a;->a:Lzf/b;

    iget-object v4, v4, Lzf/b;->c:Lcc/k;

    const-string v5, "aes_key"

    invoke-virtual {v4, v5}, Lcc/k;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v5, p0, Ldg/a;->a:Lzf/b;

    iget-object v5, v5, Lzf/b;->c:Lcc/k;

    const-string v6, "aes_token"

    invoke-virtual {v5, v6}, Lcc/k;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    iget-object v6, p0, Ldg/a;->a:Lzf/b;

    iget-object v6, v6, Lzf/b;->c:Lcc/k;

    const-string v7, "aes_expire_at"

    invoke-virtual {v6, v7}, Lcc/k;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    invoke-static {v6}, Lbk/e;->e(Ljava/lang/String;)Z
    ...
    invoke-static {}, Ldg/a;->l()[B

    move-result-object v0

    iput-object v0, v3, Ldg/a$b;->a:[B

    invoke-virtual {p0}, Ldg/a;->h()V

    iget-object p0, p0, Ldg/a;->a:Lzf/b;

    iget-object p0, p0, Lzf/b;->c:Lcc/k;

    const-string v0, "aes_key"

    iget-object v1, v3, Ldg/a$b;->a:[B

    invoke-static {v8, v1}, Lyf/a;->b(I[B)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lcc/k;->h(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v8, p0}, Lyf/a;->a(I[B)[B

    move-result-object p0

    iput-object p0, v3, Ldg/a$b;->a:[B

    iput-object v5, v3, Ldg/a$b;->b:Ljava/lang/String;
    :try_end_0
...
.method public final d(Lokhttp3/Request;Ljava/lang/String;)Lokhttp3/Request;
    ...
    iget-object v0, p0, Ldg/a;->b:Ldg/a$b;

    iget-object v0, v0, Ldg/a$b;->a:[B
    ...
    invoke-static {v6, v3}, La0/z3;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    invoke-virtual {p0, v2}, Ldg/a;->g(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Ldg/a;->b:Ldg/a$b;

    iget-object v1, v1, Ldg/a$b;->b:Ljava/lang/String;

    if-nez v1, :cond_1

    invoke-static {v0}, Ldg/a;->b([B)Ljava/lang/String;

    move-result-object v0

    const-string v1, "AIVS-Encryption-Key"

    invoke-virtual {p0}, Ldg/a;->j()Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Ldg/a;->g(Ljava/lang/String;)Ljava/lang/String;
...
.method public final e(Lokhttp3/Response;)Lokhttp3/Response;
    ...
    invoke-virtual {p0, v4, v5, v3}, Ldg/a;->m(JLjava/lang/String;)V
    ...
    invoke-static {v2, v1}, Lyf/a;->a(I[B)[B
    ...
    invoke-virtual {p0, v3, v1}, Ldg/a;->f(I[B)[B
...
.method public final f(I[B)[B
    ...
    iget-object v2, p0, Ldg/a;->b:Ldg/a$b;

    iget-object v2, v2, Ldg/a$b;->a:[B
...
.method public final g(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, p1}, Ldg/a;->f(I[B)[B
...
.method public final h()V
    ...
    :try_start_0
    iget-object v1, p0, Ldg/a;->a:Lzf/b;

    iget-object v1, v1, Lzf/b;->c:Lcc/k;

    const-string v2, "aes_key"

    invoke-virtual {v1, v2}, Lcc/k;->l(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lcc/k;->l(Ljava/lang/String;)V
...
.method public final intercept(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    invoke-virtual {p0}, Ldg/a;->a()Ldg/a$b;

    move-result-object v1

    iput-object v1, p0, Ldg/a;->b:Ldg/a$b;
    ...
    invoke-static {v2}, Lbg/a;->e(Ljava/lang/Throwable;)Ljava/lang/String;

    move-result-object v2

    invoke-static {v0, v2}, Lbg/a;->d(Ljava/lang/String;Ljava/lang/String;)V

    const/4 v2, 0x0

    :goto_0
    iput-object v2, p0, Ldg/a;->c:[B
    ...
    invoke-virtual {p0, v2, v1}, Ldg/a;->d(Lokhttp3/Request;Ljava/lang/String;)Lokhttp3/Request;
    ...
    invoke-virtual {p0, p1}, Ldg/a;->e(Lokhttp3/Response;)Lokhttp3/Response;
...
.method public final j()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v2, p0, Ldg/a;->a:Lzf/b;

    iget-object v2, v2, Lzf/b;->c:Lcc/k;

    const-string v3, "pubkey_info"

    invoke-virtual {v2, v3}, Lcc/k;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v3, Lxf/a;->a:Lpb/s;

    invoke-virtual {v3, v2}, Lpb/s;->n(Ljava/lang/String;)Lpb/k;
    ...
    invoke-virtual {v2, v3}, Lpb/k;->s(Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v3}, Lpb/k;->x(Ljava/lang/String;)Lpb/k;

    move-result-object v3

    invoke-virtual {v3}, Lpb/k;->g()J
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0}, Ldg/a;->k()Lpb/k;
    ...
    :goto_2
    iget-object p0, p0, Ldg/a;->b:Ldg/a$b;

    iget-object p0, p0, Ldg/a$b;->a:[B

    const-string v1, "public_key"

    invoke-virtual {v0, v1}, Lpb/k;->x(Ljava/lang/String;)Lpb/k;

    move-result-object v1

    invoke-virtual {v1}, Lpb/k;->i()Ljava/lang/String;

    move-result-object v1

    invoke-static {v1}, Ldg/a;->c(Ljava/lang/String;)Ljava/security/PublicKey;
    ...
    invoke-static {v1, p0}, Lyf/a;->b(I[B)Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Lpb/k;->x(Ljava/lang/String;)Lpb/k;
...
.method public final k()Lpb/k;
    ...
    iget-object v3, p0, Ldg/a;->a:Lzf/b;

    iget-object v4, v3, Lzf/b;->a:Lzf/a;

    const-string v5, "aivs.env"

    const/4 v6, 0x0

    invoke-virtual {v4, v5, v6}, Lzf/a;->c(Ljava/lang/String;I)I
    ...
    iget-object v8, v3, Lzf/b;->a:Lzf/a;

    invoke-virtual {v8, v4}, Lzf/a;->d(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v3, v3, Lzf/b;->e:Lwf/ga;

    iget-object v9, v3, Lwf/ga;->a:Ljk/a;

    invoke-virtual {v9}, Ljk/a;->b()Z

    move-result v9

    if-eqz v9, :cond_2

    iget-object v3, v3, Lwf/ga;->a:Ljk/a;

    invoke-virtual {v3}, Ljk/a;->a()Ljava/lang/Object;
    ...
    iget-object v2, p0, Ldg/a;->d:Lokhttp3/OkHttpClient;
    ...
    invoke-direct {v2, p0}, Ldg/a$a;-><init>(Ldg/a;)V

    invoke-interface {v0, v2}, Lokhttp3/Call;->enqueue(Lokhttp3/Callback;)V

    :try_start_0
    invoke-virtual {v8, v5, v6}, Lzf/a;->c(Ljava/lang/String;I)I

    move-result p0

    if-ne p0, v7, :cond_1

    sget-object p0, Lxf/a;->a:Lpb/s;
    ...
    invoke-virtual {p0, v0}, Lpb/s;->n(Ljava/lang/String;)Lpb/k;
...
.method public final m(JLjava/lang/String;)V
    ...
    invoke-virtual {v1, v2, p3}, Lcc/k;->h(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p3, p1}, Lcc/k;->h(Ljava/lang/String;Ljava/lang/String;)Z
