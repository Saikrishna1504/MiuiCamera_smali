...
.method private registerCallback()V
    ...
    invoke-static {}, Lzu/b;->b()Lzu/b;

    move-result-object v3

    iput-object v3, p0, Lcom/xiaomi/camera/mivi/MIVIParallelService;->mService:Lzu/b;
    ...
    iget-object v3, p0, Lcom/xiaomi/camera/mivi/MIVIParallelService;->mService:Lzu/b;
    ...
    invoke-interface {v3, v4, v5}, Lzu/b;->d(ILzu/c;)I
    ...
    iget-object v1, p0, Lcom/xiaomi/camera/mivi/MIVIParallelService;->mService:Lzu/b;
    ...
    invoke-interface {v1, v3}, Lzu/b;->a(Lcom/xiaomi/camera/mivi/c;)Z
...
.method public static setCapabilities(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p0}, Lzu/b;->c(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/util/NoSuchElementException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onDestroy()V
    ...
    invoke-interface {v1, v4, v5}, Lzu/b;->d(ILzu/c;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
