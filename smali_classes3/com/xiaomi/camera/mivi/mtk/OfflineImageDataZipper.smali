...
.method public static synthetic a(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Lyg/q;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->lambda$getParallelTaskSize$0(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Lyg/q;)V
...
.method private doJpeg(Lyg/q;Landroid/media/Image;I)V
    .locals 9
    ...
    invoke-static {v1, v2, p3}, La0/b0;->e(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->generateReprocessData(Lyg/q;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
...
.method private generateReprocessData(Lyg/q;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    .locals 18
    ...
    iget-object v13, v1, Lyg/q;->q:Lyg/r;

    iget-object v2, v1, Lyg/q;->h:Landroid/hardware/camera2/TotalCaptureResult;

    iget-boolean v5, v1, Lyg/q;->g0:Z
    ...
    invoke-static {v2, v4}, Lgg/a;->a(Landroid/hardware/camera2/CaptureResult;Ljava/lang/String;)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v7

    iget-boolean v8, v13, Lyg/r;->B:Z

    iget-object v2, v13, Lyg/r;->D:Landroid/util/Size;
    ...
    iget-object v4, v1, Lyg/q;->K:Landroid/media/Image;
    ...
    :cond_1
    iget-boolean v2, v13, Lyg/r;->U:Z

    if-eqz v2, :cond_2

    iget v2, v13, Lyg/r;->v:I

    invoke-virtual {v14, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setOrientation(I)V

    :cond_2
    iget-byte v2, v13, Lyg/r;->V:B

    invoke-virtual {v14, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setSiqeType(B)V

    iget-object v2, v13, Lyg/r;->i:Landroid/util/Size;

    invoke-virtual {v2}, Landroid/util/Size;->getWidth()I

    move-result v2

    iget-object v3, v13, Lyg/r;->i:Landroid/util/Size;
...
.method private handTimeoutTask(J)V
    ...
    invoke-static {v1, p1, p2, v2}, La0/m0;->d(Ljava/lang/String;JLjava/lang/String;)Ljava/lang/StringBuilder;
...
.method private handleDataBeanIfReady(Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;Z)V
    ...
    invoke-virtual {p2, v0}, Lo7/j;->d(Ljava/lang/String;)J

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;->getTimestamp()J

    move-result-wide v0

    invoke-virtual {p0, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->getParallelTaskData(J)Lyg/q;
    ...
    :cond_1
    iget-wide v0, p2, Lyg/q;->a0:J

    iget-object v3, p2, Lyg/q;->V:Ljava/lang/String;

    iget-wide v4, p2, Lyg/q;->e:J
    ...
    invoke-virtual {p2, v1, v0}, Lyg/q;->a(I[B)V
    ...
    invoke-static {v1, v3, v4}, La0/b0;->e(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iput-object v0, p2, Lyg/q;->K:Landroid/media/Image;
    ...
    iget-object v1, p2, Lyg/q;->q:Lyg/r;

    iget-boolean v1, v1, Lyg/r;->a:Z
    ...
    invoke-direct {p0, v1, p2, v0}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->postCvWaterMark(Landroid/media/Image;Lyg/q;I)V
    ...
    invoke-direct {p0, p2, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->doJpeg(Lyg/q;Landroid/media/Image;I)V
...
.method private handleRawImageData([BLjava/lang/String;)V
    ...
    invoke-virtual {p0, p2, p1}, Lyg/q;->a(I[B)V
    ...
    invoke-static {p0, p1}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->notifyFinish(Lyg/q;Ljava/lang/String;)V
...
.method private static synthetic lambda$getParallelTaskSize$0(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Lyg/q;)V
    .locals 0

    invoke-virtual {p2}, Lyg/q;->c()I
...
.method private postCvWaterMark(Landroid/media/Image;Lyg/q;I)V
    .locals 4
    ...
    invoke-static {p1, v2}, Lgg/e;->g(Landroid/media/Image;Z)[B

    move-result-object v2

    const-string v3, ""

    invoke-static {p3, v3}, La0/j0;->a(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, p1, v3}, La0/b0;->d(JLjava/lang/StringBuilder;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2, p3}, La0/b0;->e(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
...
.method public getParallelTaskData(J)Lyg/q;
    .locals 3
...
.method public getParallelTaskSize()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->mTaskLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->mParallelTaskHashMap:Ljava/util/HashMap;

    new-instance v3, Lf1/i;

    const/4 v4, 0x1

    invoke-direct {v3, v0, v4}, Lf1/i;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v2, v3}, Ljava/util/HashMap;->forEach(Ljava/util/function/BiConsumer;)V

    sget-object v2, Ljava/util/Locale;->ENGLISH:Ljava/util/Locale;

    const-string v3, "{\"mParallelTaskHashMap\": %d, \"byteSize\": %d}"
...
.method public putParallelTaskData(JLyg/q;)V
    .locals 5
