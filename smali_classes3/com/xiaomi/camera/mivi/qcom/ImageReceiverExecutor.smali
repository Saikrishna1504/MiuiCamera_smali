...
.method private static dumpImage(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;Lyg/q;Ljava/lang/String;)V
    .locals 2
    ...
    iget-object p1, p1, Lyg/q;->V:Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2}, Lgg/e;->d(Landroid/media/Image;Ljava/lang/String;Ljava/lang/String;)Z

    :cond_0
    return-void
.end method

.method private initReprocessProxy(Lyg/q;ZLjava/lang/String;)V
    .locals 2
    ...
    iget-object p2, p1, Lyg/q;->q:Lyg/r;

    iget-boolean p2, p2, Lyg/r;->a:Z
    ...
    invoke-static {p3, p0}, La0/m0;->c(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p3, p1}, La0/m0;->c(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private lambda$startReprocessLoop$1()V
    ...
    invoke-virtual {v5, v6}, Lq1/c;->n(Ljava/lang/String;)V
    ...
    invoke-static {v7, v8, v9, v5}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->getParallelTaskData(Ljava/lang/String;JZ)Lyg/q;
    ...
    invoke-virtual {v5, v7, v8}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->readParallelTaskDataFromSmallJpeg(Landroid/content/Context;Ljava/lang/String;)Lyg/q;
    ...
    :cond_9
    invoke-virtual {v3, v7}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->setParallelTaskData(Lyg/q;)V
    ...
    sget-boolean v5, Lgg/e;->d:Z

    if-eqz v5, :cond_a

    const-string v5, "algo_done"

    invoke-static {v3, v7, v5}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->dumpImage(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;Lyg/q;Ljava/lang/String;)V
    ...
    :goto_5
    invoke-direct {p0, v7, v6, v4}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->initReprocessProxy(Lyg/q;ZLjava/lang/String;)V
...
.method public submit(Lcom/xiaomi/camera/mivi/qcom/bean/RequestData;Ljava/lang/String;)V
    ...
    invoke-static {p2, p1}, La0/z3;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
