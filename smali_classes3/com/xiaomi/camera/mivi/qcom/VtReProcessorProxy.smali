...
.method private execute(Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getParallelTaskData()Lyg/q;
    ...
    invoke-static {v8, v9, v7}, La0/b0;->e(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {v8, v10}, Lgg/a;->a(Landroid/hardware/camera2/CaptureResult;Ljava/lang/String;)Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v9, v2, Lyg/q;->q:Lyg/r;

    iget-boolean v9, v9, Lyg/r;->y:Z
    ...
    iget-object v10, v2, Lyg/q;->q:Lyg/r;

    iget-boolean v10, v10, Lyg/r;->U:Z

    if-eqz v10, :cond_6

    const-string v10, "process[3]: setOrientation "

    invoke-static {v1, v10}, La0/z3;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-object v12, v2, Lyg/q;->q:Lyg/r;

    iget v12, v12, Lyg/r;->v:I
