...
.method public static a(Ljava/lang/String;)Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBean;
    ...
    invoke-static {p0}, Ldd/k;->d([B)Ldd/k;

    move-result-object p0

    invoke-virtual {p0}, Ldd/k;->b()Lcom/google/protobuf/ByteString;
    ...
    invoke-virtual {p0}, Ldd/k;->c()Lcom/google/protobuf/ByteString;
    ...
    sget-object v3, Lrd/b;->a:Ljava/nio/charset/CharsetDecoder;
    ...
    sget-object p0, Lrd/b;->a:Ljava/nio/charset/CharsetDecoder;
    ...
    :try_start_3
    sget-object v4, Lrd/b;->a:Ljava/nio/charset/CharsetDecoder;
    ...
    sget-object v4, Lrd/b;->b:Ljava/nio/charset/CharsetDecoder;
    ...
    :try_start_7
    sget-object p0, Lrd/b;->b:Ljava/nio/charset/CharsetDecoder;
    ...
    new-instance v3, Lgf/y;

    invoke-direct {v3, p0}, Lgf/y;-><init>(Lgf/y$a;)V

    const-class p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBean;

    invoke-virtual {v3, p0}, Lgf/y;->a(Ljava/lang/Class;)Lgf/l;
    ...
    invoke-direct {p0, v0}, Lgf/n;-><init>(Ljava/lang/String;)V
    ...
    :goto_6
    :try_start_8
    sget-object v0, Lrd/b;->b:Ljava/nio/charset/CharsetDecoder;
    ...
    :goto_7
    :try_start_9
    sget-object v1, Lrd/b;->a:Ljava/nio/charset/CharsetDecoder;
