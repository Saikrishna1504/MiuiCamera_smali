...
.method public constructor <init>(Landroid/media/MediaMuxer;Lhi/c$d;ILki/c$a;)V
    ...
    iput-object p1, p0, Lki/a;->a:Landroid/media/MediaMuxer;

    iput-object p2, p0, Lki/a;->b:Lhi/c$d;

    iput p3, p0, Lki/a;->c:I

    iput-object p4, p0, Lki/a;->d:Lki/c$a;
...
.method public final b()J
    ...
    iget-object v3, v1, Lki/a;->d:Lki/c$a;
    ...
    :try_start_0
    iget-object v0, v3, Lki/c$a;->a:Ljava/util/concurrent/CountDownLatch;
    ...
    :goto_0
    iget-object v0, v3, Lki/c$a;->b:Ljava/lang/Object;
    ...
    :goto_1
    iget-object v0, v1, Lki/a;->b:Lhi/c$d;

    iget-wide v9, v0, Lhi/c$d;->d:J
    ...
    invoke-static {v4, v3, v12, v13}, La0/m0;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-wide v12, v0, Lhi/c$d;->e:J
    ...
    :goto_3
    :try_start_1
    invoke-virtual/range {p0 .. p0}, Lki/a;->c()Lhi/c$c;
    ...
    :cond_3
    invoke-virtual {v1, v2}, Lki/c;->a(Lhi/c$c;)Z
    ...
    :cond_4
    iget-object v3, v2, Lhi/c$c;->a:Ljava/nio/ByteBuffer;

    iget-object v2, v2, Lhi/c$c;->b:Landroid/media/MediaCodec$BufferInfo;
    ...
    iput-wide v11, v0, Lhi/c$d;->g:J

    if-eqz v6, :cond_5

    const-string v5, "writeAudioSamples: first audio sample timestamp: "

    invoke-static {v5, v7, v8}, La0/x;->h(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget-object v9, v1, Lki/a;->a:Landroid/media/MediaMuxer;

    iget v10, v1, Lki/a;->c:I
    ...
    invoke-static {v1, v13, v14, v2}, La0/m0;->d(Ljava/lang/String;JLjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :goto_9
    iget-object v1, v0, Lhi/c$d;->m:Ljava/util/concurrent/LinkedBlockingQueue;
    ...
    check-cast v1, Lhi/c$c;

    iget-object v1, v1, Lhi/c$c;->a:Ljava/nio/ByteBuffer;
...
.method public c()Lhi/c$c;
    ...
    iget-object p0, p0, Lki/a;->b:Lhi/c$d;
