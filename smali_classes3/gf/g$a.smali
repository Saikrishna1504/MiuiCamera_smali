...
.method public static b(Ljava/lang/reflect/Type;Ljava/lang/Class;)V
    ...
    invoke-static {p0}, Lgf/b0;->c(Ljava/lang/reflect/Type;)Ljava/lang/Class;
...
.method public final a(Ljava/lang/reflect/Type;Ljava/util/Set;Lgf/y;)Lgf/l;
    ...
    :cond_0
    invoke-static/range {p1 .. p1}, Lgf/b0;->c(Ljava/lang/reflect/Type;)Ljava/lang/Class;
    ...
    :cond_2
    invoke-static {v2}, Lhf/c;->d(Ljava/lang/Class;)Z
    ...
    invoke-static {v0, v1}, Lgf/g$a;->b(Ljava/lang/reflect/Type;Ljava/lang/Class;)V
    ...
    sget-object v4, Lhf/c;->d:Ljava/lang/Class;
    ...
    invoke-direct {v10, v9, v2}, Lgf/b;-><init>(Ljava/lang/reflect/Constructor;Ljava/lang/Class;)V
    :try_end_0
    ...
    invoke-direct {v11, v9, v10, v2}, Lgf/c;-><init>(Ljava/lang/reflect/Method;Ljava/lang/Object;Ljava/lang/Class;)V
    :try_end_1
    ...
    invoke-direct {v11, v7, v2, v10}, Lgf/d;-><init>(Ljava/lang/reflect/Method;Ljava/lang/Class;I)V
    :try_end_2
    ...
    new-instance v10, Lgf/e;

    invoke-direct {v10, v4, v2}, Lgf/e;-><init>(Ljava/lang/reflect/Method;Ljava/lang/Class;)V
    :try_end_3
    ...
    invoke-static {v0}, Lgf/b0;->c(Ljava/lang/reflect/Type;)Ljava/lang/Class;

    move-result-object v4

    invoke-static {v4}, Lhf/c;->d(Ljava/lang/Class;)Z
    ...
    invoke-interface {v6}, Lgf/k;->ignore()Z
    ...
    invoke-static {v0, v4, v11, v13}, Lhf/c;->f(Ljava/lang/reflect/Type;Ljava/lang/Class;Ljava/lang/reflect/Type;Ljava/util/LinkedHashSet;)Ljava/lang/reflect/Type;
    ...
    :cond_10
    sget-object v1, Lhf/c;->a:Ljava/util/Set;
    ...
    invoke-virtual {v4, v11, v1, v3}, Lgf/y;->c(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)Lgf/l;
    ...
    :cond_11
    invoke-interface {v6}, Lgf/k;->name()Ljava/lang/String;
    ...
    :goto_a
    new-instance v6, Lgf/g$b;

    invoke-direct {v6, v3, v12, v1}, Lgf/g$b;-><init>(Ljava/lang/String;Ljava/lang/reflect/Field;Lgf/l;)V

    invoke-virtual {v2, v3, v6}, Ljava/util/TreeMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lgf/g$b;
    ...
    iget-object v1, v1, Lgf/g$b;->b:Ljava/lang/reflect/Field;
    ...
    invoke-static {v0, v1, v3, v5}, Lhf/c;->f(Ljava/lang/reflect/Type;Ljava/lang/Class;Ljava/lang/reflect/Type;Ljava/util/LinkedHashSet;)Ljava/lang/reflect/Type;
    ...
    invoke-direct {v0, v10, v2}, Lgf/g;-><init>(Lgf/f;Ljava/util/TreeMap;)V

    invoke-virtual {v0}, Lgf/l;->nullSafe()Lgf/l;
    ...
    invoke-static {v0}, Lhf/c;->g(Ljava/lang/reflect/InvocationTargetException;)V
