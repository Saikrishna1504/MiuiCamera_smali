...
.field public final i:Lqf/e;

.field public j:Lrf/a$c;

.field public k:Lrf/a$d;
...
.method public constructor <init>(Lqf/e;)V
    ...
    iput-object v0, p0, Lrf/a;->f:Ljava/lang/Object;

    const/4 v0, 0x1

    iput v0, p0, Lrf/a;->m:I

    iput-object p1, p0, Lrf/a;->i:Lqf/e;

    invoke-virtual {p0}, Lrf/a;->c()V

    return-void
.end method

.method public constructor <init>(Lqf/e;ILjava/lang/String;)V
    .locals 0
    ...
    iput-object p3, p0, Lrf/a;->e:Ljava/lang/Object;

    new-instance p3, Ljava/lang/Object;

    invoke-direct {p3}, Ljava/lang/Object;-><init>()V

    iput-object p3, p0, Lrf/a;->f:Ljava/lang/Object;

    const/4 p3, 0x1

    iput p3, p0, Lrf/a;->m:I
...
.method public final a([BZ)V
    ...
    :try_start_0
    iget-object v1, p0, Lrf/a;->o:Landroid/os/Handler;
    ...
    iget-object p2, p0, Lrf/a;->o:Landroid/os/Handler;
...
.method public final b()V
    ...
    :try_start_0
    iget-object v0, p0, Lrf/a;->o:Landroid/os/Handler;
    ...
    :cond_0
    iget-object v0, p0, Lrf/a;->k:Lrf/a$d;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lrf/a$d;->a()V

    iput-object v1, p0, Lrf/a;->k:Lrf/a$d;

    :cond_1
    iget-object v0, p0, Lrf/a;->j:Lrf/a$c;
    ...
    iput-boolean v2, v0, Lrf/a$c;->c:Z

    const/4 v2, 0x1

    invoke-virtual {v0, v1, v2}, Lrf/a$c;->b([BZ)V

    iput-object v1, p0, Lrf/a;->j:Lrf/a$c;

    :cond_2
    invoke-virtual {p0}, Lrf/a;->f()V
...
.method public final c()V
    ...
    :try_start_0
    invoke-virtual {p0}, Lrf/a;->e()V

    monitor-exit p0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v0, p0, Lrf/a;->i:Lqf/e;
    ...
    iput-object v0, p0, Lrf/a;->n:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Ljava/lang/Thread;->start()V

    new-instance v0, Landroid/os/Handler;

    iget-object v1, p0, Lrf/a;->n:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v1

    new-instance v2, Lrf/a$a;

    invoke-direct {v2, p0}, Lrf/a$a;-><init>(Lrf/a;)V

    invoke-direct {v0, v1, v2}, Landroid/os/Handler;-><init>(Landroid/os/Looper;Landroid/os/Handler$Callback;)V

    iput-object v0, p0, Lrf/a;->o:Landroid/os/Handler;
...
.method public final d()V
    ...
    invoke-virtual {p0}, Lrf/a;->g()Z

    move-result v0

    iput-boolean v0, p0, Lrf/a;->q:Z

    iget-boolean v0, p0, Lrf/a;->q:Z
    ...
    invoke-static {v1, v5}, Lbg/a;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v5}, Lbg/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v5, p0, Lrf/a;->c:Landroid/media/MediaCodec;
    :try_end_1
    ...
    :goto_3
    iget-object v5, p0, Lrf/a;->c:Landroid/media/MediaCodec;
    ...
    iget-object v0, p0, Lrf/a;->c:Landroid/media/MediaCodec;
    ...
    invoke-static {v0, v2}, La0/k0;->a(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public final e()V
    ...
    iput-object v2, p0, Lrf/a;->o:Landroid/os/Handler;
    ...
    iput-object v2, p0, Lrf/a;->n:Landroid/os/HandlerThread;

    :cond_1
    iget-object v1, p0, Lrf/a;->j:Lrf/a$c;
    ...
    iput-boolean v0, v1, Lrf/a$c;->c:Z

    const/4 v0, 0x1

    invoke-virtual {v1, v2, v0}, Lrf/a$c;->b([BZ)V

    iput-object v2, p0, Lrf/a;->j:Lrf/a$c;
    ...
    iput-object v2, p0, Lrf/a;->k:Lrf/a$d;

    :cond_3
    iget-boolean v0, p0, Lrf/a;->p:Z

    if-eqz v0, :cond_5

    iget-object v0, p0, Lrf/a;->f:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lrf/a;->b:Landroid/media/AudioTrack;

    if-eqz v1, :cond_4

    invoke-virtual {v1}, Landroid/media/AudioTrack;->release()V

    iput-object v2, p0, Lrf/a;->b:Landroid/media/AudioTrack;
    ...
    :try_start_2
    iget-object v1, p0, Lrf/a;->c:Landroid/media/MediaCodec;
    ...
    iput-object v2, p0, Lrf/a;->c:Landroid/media/MediaCodec;
...
.method public final f()V
    ...
    iget-object v0, p0, Lrf/a;->l:Landroid/media/MediaPlayer;
    ...
    iput-object v0, p0, Lrf/a;->l:Landroid/media/MediaPlayer;
...
.method public final g()Z
    ...
    iput-object v0, p0, Lrf/a;->b:Landroid/media/AudioTrack;
    ...
    iget-object v0, p0, Lrf/a;->b:Landroid/media/AudioTrack;
    ...
    :cond_0
    iget-object p0, p0, Lrf/a;->b:Landroid/media/AudioTrack;
