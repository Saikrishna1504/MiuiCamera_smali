...
.method public constructor <init>(Lqf/a;)V
    ...
    invoke-direct {p0, p1}, Lpf/h;-><init>(Lqf/a;)V
    ...
    iget-object v0, p0, Lpf/h;->a:Lqf/e;
    ...
    iput-object p1, p0, Lrf/c;->f:Lokhttp3/OkHttpClient;

    iget-object p1, p0, Lpf/h;->a:Lqf/e;
    ...
    invoke-virtual {p1, v3}, Lpf/g;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v5, Lxf/a;->a:Lpb/s;

    invoke-virtual {v5, v4}, Lpb/s;->n(Ljava/lang/String;)Lpb/k;
    ...
    invoke-virtual {v4, v1}, Lbc/r;->x(Ljava/lang/String;)Lpb/k;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Lpb/k;->u()Z

    move-result v4

    if-eqz v4, :cond_1

    invoke-virtual {v1}, Lpb/k;->e()I

    move-result p1

    iput p1, p0, Lrf/c;->e:I

    goto :goto_1

    :cond_1
    invoke-virtual {p1, v3}, Lpf/g;->b(Ljava/lang/String;)V
    :try_end_0
...
.method public final e(Ljava/lang/String;)Z
    ...
    iget v1, p0, Lrf/c;->e:I

    iget-object v2, v0, Lqf/e;->b:Lzf/a;

    const-string v5, "track.max_track_times"

    invoke-virtual {v2, v5, v4}, Lzf/a;->c(Ljava/lang/String;I)I
    ...
    iget-object p1, v0, Lqf/e;->b:Lzf/a;

    invoke-virtual {p1, v5, v4}, Lzf/a;->c(Ljava/lang/String;I)I
    ...
    invoke-virtual {v0, v5, v4}, Lzf/a;->c(Ljava/lang/String;I)I
    ...
    iget-object v1, p0, Lrf/c;->f:Lokhttp3/OkHttpClient;
    ...
    invoke-direct {v1, p0, p1}, Lrf/c$a;-><init>(Lrf/c;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, p1, v1}, Lpf/h;->c(Ljava/lang/String;Ljava/lang/String;Lbc/a;)Z

    move-result p1

    if-eqz p1, :cond_5

    iput-boolean v2, p0, Lpf/h;->d:Z
